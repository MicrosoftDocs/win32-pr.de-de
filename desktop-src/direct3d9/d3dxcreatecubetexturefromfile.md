...
Wenn die Funktion erfolgreich ausgeführt wird, ist der Rückgabewert D3D \_ OK. Wenn die Funktion fehlschlägt, kann der Rückgabewert einer der folgenden Werte sein: D3DERR \_ invalidcallcenter, D3DERR \_ NotAvailable, D3DERR \_ oudefvideomemory, D3DXERR \_ InvalidData, E \_ ouyfmemory.

## <a name="remarks"></a>Bemerkungen

Die Compilereinstellung bestimmt auch die Funktions Version. Wenn Unicode definiert ist, wird der Funktions aufrufin **D3DXCreateCubeTextureFromFileW** aufgelöst. Andernfalls wird der Funktions Aufruhe in **D3DXCreateCubeTextureFromFileA** aufgelöst, da ANSI-Zeichen folgen verwendet werden.
