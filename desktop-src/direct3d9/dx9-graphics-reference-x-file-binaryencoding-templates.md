---
description: Eine Vorlage weist die folgende Syntax Definition auf.
ms.assetid: 77eb739d-8da3-4481-8dd1-f9f2f0eda136
title: Vorlagen (X-Dateiformat)
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106343137"
---
# <a name="templates-x-file-format-binary-encoding"></a><span data-ttu-id="c56ff-103">Vorlagen (X-Dateiformat, binäre Codierung)</span><span class="sxs-lookup"><span data-stu-id="c56ff-103">Templates (X file format, binary encoding)</span></span>

<span data-ttu-id="c56ff-104">Eine Vorlage weist die folgende Syntax Definition auf.</span><span class="sxs-lookup"><span data-stu-id="c56ff-104">A template has the following syntax definition.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="c56ff-105">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="c56ff-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="c56ff-106">Binärcodierung</span><span class="sxs-lookup"><span data-stu-id="c56ff-106">Binary Encoding</span></span>](binary-encoding.md)
</dt> </dl>
