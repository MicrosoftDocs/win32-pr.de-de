---
description: Eine Vorlage verfügt über die folgende Syntaxdefinition.
...
ms.locfileid: "118523401"
---
# <a name="templates-x-file-format-binary-encoding"></a>Vorlagen (X-Dateiformat, binäre Codierung)

Eine Vorlage verfügt über die folgende Syntaxdefinition.
