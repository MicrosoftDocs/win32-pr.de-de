...
Erstellt ein Mesh-Objekt mithilfe eines FVF-Codes (Flexible Vertex-Format).
...
Anzahl der Flächen für das Mesh. Der gültige Bereich für diese Zahl ist größer als 0 (null) und ein kleiner als der Max DWORD-Wert (in der Regel 2 ³ ²-1), da der letzte Index reserviert ist.
...
Eine Kombination aus [D3DFVF](d3dfvf.md) , die das Vertex-Format für das zurückgegebene Mesh beschreibt. Diese Funktion unterstützt D3DFVF \_ xyzrhw nicht.
