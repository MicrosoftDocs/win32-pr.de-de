---
description: Dieser Abschnitt enthält Informationen zu den Strukturen, die in der D3DX-Hilfsprogrammbibliothek in Direct3D 9 Graphics enthalten sind.
...
-   [**D3DXKEY-RÜCKRUF \_**](d3dxkey-callback.md)
...
-   [D3DXMATRIX-Erweiterungen](d3dxmatrix-extensions.md)
...
-   [D3DXVECTOR2-Erweiterungen](d3dxvector2-extensions.md)
-   [**D3DXVECTOR3**](d3dxvector3.md)
-   [D3DXVECTOR3-Erweiterungen](d3dxvector3-extensions.md)
-   [**D3DXVECTOR4**](d3dxvector4.md)
-   [D3DXVECTOR4-Erweiterungen](d3dxvector4-extensions.md)
