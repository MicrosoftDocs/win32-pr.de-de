...
Verwendet ein Links händiges Koordinatensystem zum Erstellen eines Netzes, das eine "Teapot" enthält.
...
Zeiger auf eine [**IDirect3DDevice9**](/windows/win32/api/d3d9helper/nn-d3d9helper-idirect3ddevice9) -Schnittstelle, die das Gerät darstellt, das dem erstellten Teekanne-Mesh zugeordnet ist.
