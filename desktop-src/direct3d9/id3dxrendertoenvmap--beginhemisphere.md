...
---
# <a name="id3dxrendertoenvmapbeginhemisphere-method"></a>ID3DXRenderToEnvMap:: beginhemisphäre-Methode

Initiieren Sie das Rendering einer Hemispheric-Umgebungs Zuordnung.
...
Zeiger auf eine [**IDirect3DTexture9**](/windows/win32/api/d3d9helper/nn-d3d9helper-idirect3dtexture9) -Schnittstelle, die die positive Textur Renderoberfläche darstellt.
...
Zeiger auf eine [**IDirect3DTexture9**](/windows/win32/api/d3d9helper/nn-d3d9helper-idirect3dtexture9) -Schnittstelle, die die negative Textur Renderoberfläche darstellt.
