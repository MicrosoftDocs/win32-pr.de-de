...
---
# <a name="d3dxfunction_desc-structure"></a>D3DXFUNCTION- \_ Struktur
...
Nicht verwendet. Dieser Member wird von [**getfunctiondebug**](id3dxbaseeffect--getfunctiondesc.md)immer auf 0 (null) festgelegt.
