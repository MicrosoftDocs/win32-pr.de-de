---
description: Lädt ein Skin mesh aus einem DirectX.x-Dateidatenobjekt.
...
Kombination aus einem oder mehreren Flags aus der [**D3DXMESH-Enumeration,**](./d3dxmesh.md) die Erstellungsoptionen für das Gitternetz angibt.
...
Adresse eines Zeigers auf eine [**ID3DXBuffer-Schnittstelle.**](id3dxbuffer.md) Wenn diese Methode zurückgegeben wird, wird dieser Parameter mit einem Array von drei DWORDs pro Gesicht gefüllt, die die drei Nachbarn für jedes Gesicht im Netz angeben.
...
Adresse eines Zeigers auf eine [**ID3DXSkinInfo-Schnittstelle,**](id3dxskininfo.md) die die Skinninginformationen darstellt.
