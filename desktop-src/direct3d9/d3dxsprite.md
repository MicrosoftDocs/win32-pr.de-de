...
| D3DXSPRITE \_ SORT \_ DEPTH \_ FRONTTOBACK | Sprites werden vor dem Zeichnen nach Tiefe in der Reihenfolge vor dem Zeichnen sortiert. Dieses Verfahren wird empfohlen, wenn Sie nicht transparente Sprites unterschiedlicher Tiefe zeichnen. Sie können D3DXSPRITE \_ SORT \_ DEPTH \_ FRONTTOBACK mit D3DXSPRITE \_ SORT TEXTURE \_ kombinieren, um zuerst nach Tiefe und dann nach Textur zu sortieren.<br/>                                                                                                                                   |
...
| D3DXSPRITE \_ \_ NICHT \_ \_ HINZUFÜGENREF-TEXTUR | Deaktiviert den Aufruf von AddRef() bei jedem Zeichnen und Release() für Flush(), um eine bessere Leistung zu erzielen.                                                                                                                                                                                                                                                                                                                                         |
