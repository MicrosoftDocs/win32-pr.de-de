---
description: Erstellt die zweite Konstante (im Register src3) für die Anweisung sincos - ps pixel shader.
...
ms.locfileid: "120096300"
---
# <a name="d3dsincosconst2"></a>D3DSINCOSCONST2

Erstellt die zweite Konstante (im Register src3) für die [Anweisung sincos - ps](../direct3dhlsl/sincos---ps.md) pixel shader.
...
Gibt die zweite konstante zurück, die von [sincos](../direct3dhlsl/sincos---ps.md)benötigt wird: ps .
