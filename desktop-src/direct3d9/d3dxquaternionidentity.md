...
Ein Zeiger auf die [**D3DXQUATERNION**](d3dxquaternion.md) -Struktur, die die Identitäts-Quaternion ist.

## <a name="remarks"></a>Bemerkungen

Wenn eine Quaternion (x, y, z, w) angegeben wird, gibt die **D3DXQuaternionIdentity** -Funktion die Quaternion (0,0) zurück.

Der Rückgabewert für diese Funktion ist derselbe Wert, der im *Pout* -Parameter zurückgegeben wird. Auf diese Weise kann die **D3DXQuaternionIdentity** -Funktion als Parameter für eine andere Funktion verwendet werden.
