...
Der Index Puffer enthält die Scheitelpunkt Reihenfolge im Scheitelpunkt Puffer. Der Index Puffer wird für den Zugriff auf den Scheitelpunkt Puffer verwendet, wenn das Mesh gerendert wird.
