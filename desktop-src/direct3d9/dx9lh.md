...
title: Featurezusammenfassung (Direct3D 9 für Windows Vista)
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="feature-summary-direct3d-9-for-windows-vista"></a>Featurezusammenfassung (Direct3D 9 für Windows Vista)
...
-   [Deaktivieren der Multithread-Softwarevertexverarbeitung](#disabling-multithreaded-software-vertex-processing)
...
## <a name="disabling-multithreaded-software-vertex-processing"></a>Deaktivieren der Multithread-Softwarevertexverarbeitung
...
Wenn eine 1-Bit-Oberfläche gelesen wird, kann die Runtime entweder Punktbeispiele oder Konvolutionsfilterung durchführen. Der Konvolutionsfilter ist anpassbar (siehe [**SetConvolutionMonoKernel**](/windows/desktop/api/d3d9/nf-d3d9-idirect3ddevice9ex-setconvolutionmonokernel)).
