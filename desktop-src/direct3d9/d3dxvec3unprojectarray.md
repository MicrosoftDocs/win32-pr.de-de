...
Zeiger auf eine [**D3DXVECTOR3-Struktur,**](d3dxvector3.md) bei der es sich um das Array handelt, das vom Bildschirmbereich in den Objektbereich projiziert wird.
