...
Zeiger auf eine [**D3DXVECTOR3**](d3dxvector3.md) -Struktur, bei der es sich um das Array handelt, das vom Bildschirmbereich zum Objekt Raum projiziert

## <a name="remarks"></a>Bemerkungen

Der Rückgabewert für diese Funktion ist derselbe Wert, der im *Pout* -Parameter zurückgegeben wird. Auf diese Weise kann die [**D3DXVec3Unproject**](d3dxvec3unproject.md) -Funktion als Parameter für eine andere Funktion verwendet werden.
