---
description: 'D3DXMatrixRotationAxis-Funktion (D3dx9math.h): Erstellt eine Matrix, die sich um eine beliebige Achse dreht.'
...
ms.locfileid: "119750210"
---
# <a name="d3dxmatrixrotationaxis-function-d3dx9mathh"></a>D3DXMatrixRotationAxis-Funktion (D3dx9math.h)
...
Zeiger auf die beliebige Achse. Siehe [**D3DXVECTOR3.**](d3dxvector3.md)
...
Zeiger auf eine um die angegebene Achse gedrehte [**D3DXMATRIX-Struktur.**](d3dxmatrix.md)
