...
Gibt unter Verwendung der angegebenen 3D-Vektoren einen Punkt in der unter-/codezentrierten Koordinaten zurück.
...
Zeiger auf eine [**D3DXVECTOR3**](d3dxvector3.md) -Struktur in den baryzentrierten Koordinaten.
...
Der Rückgabewert für diese Funktion ist derselbe Wert, der im *Pout* -Parameter zurückgegeben wird. Auf diese Weise kann die **D3DXVec3BaryCentric** -Funktion als Parameter für eine andere Funktion verwendet werden.
