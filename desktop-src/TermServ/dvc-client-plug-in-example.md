---
title: Beispiel für DVC-Client-Plug-in
description: C++-Codebeispiel, das veranschaulicht, wie Remotedesktopverbindung ein RDC-Client (Dynamic Virtual Channel)-Plug-in für Clients erstellt wird.
...
ms.locfileid: "103947581"
---
# <a name="dvc-client-plug-in-example"></a><span data-ttu-id="cfc20-103">Beispiel für DVC-Client-Plug-in</span><span class="sxs-lookup"><span data-stu-id="cfc20-103">DVC Client Plug-in Example</span></span>

<span data-ttu-id="cfc20-104">Im folgenden Codebeispiel für C++ finden Sie ein Beispiel für die Erstellung eines Remotedesktopverbindung (RDC)-Client-DVC-Plug-ins (Dynamic Virtual Channel).</span><span class="sxs-lookup"><span data-stu-id="cfc20-104">The following C++ code sample provides an example of how to create a Remote Desktop Connection (RDC) client dynamic virtual channel (DVC) plug-in.</span></span>
