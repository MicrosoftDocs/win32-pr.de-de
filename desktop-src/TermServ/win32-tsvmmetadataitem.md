...
Die **Win32 \_ TSVmMetadataItem-Klasse** verfügt über folgende Typen von Membern:
...
Gibt den Abschnitt in den Metadaten an, in dem sich dieses Element befindet.
...
Abschnitt "Einstellungen für Die Einstellung wird eingestellt".
