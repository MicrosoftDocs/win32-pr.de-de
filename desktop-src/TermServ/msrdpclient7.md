...
description: 'Microsoft RDP-Clientsteuerung (verteilbar): Version 8.'
...
ms.locfileid: "117756596"
---
# <a name="msrdpclient7-class"></a>MsRdpClient7-Klasse

Microsoft RDP-Clientsteuerung (redistributable) – Version 8
...
**MsRdpClient7** verfügt über diese Typen von Membern:
...
Die **MsRdpClient7-Klasse** verfügt über diese Methoden.
...
Die **MsRdpClient7-Klasse** verfügt über diese Eigenschaften.
...
<td style="text-align: left;">Das Remotedesktop ActiveX-Steuerelement im Klartextformat.<br/></td>
</tr>
<tr class="odd">
...
| CLSID<br/>                    | CLSID \_ MsRdpClient7 ist als A9D7038D-B5ED-472E-9C47-94BEA90A5910 definiert.<br/>      |
