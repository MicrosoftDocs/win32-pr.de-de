...
---
# <a name="activateserverautomatic-method-of-the-win32_tslicenseserver-class"></a>Activateserverautomatic-Methode der Win32- \_ Klasse "zlicenseserver"

Aktiviert den Remotedesktop Lizenzserver automatisch über das Internet.
...
Diese Methode schlägt fehl, es sei denn, die Eigenschaften **FirstName**, **LastName**, **Company** und **CountryRegion** sind festgelegt.
