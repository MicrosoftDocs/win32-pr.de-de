...
---
# <a name="setname-method-of-the-win32_tsgatewayradiusserver-class"></a>SetName-Methode der Win32- \_ Klasse "tgatewayradiusserver"

Legt die **Name** -Eigenschaft für diesen Remote Authentication Dial-in User Service Server (RADIUS) fest.
