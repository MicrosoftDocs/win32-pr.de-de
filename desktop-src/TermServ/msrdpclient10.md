...
description: 'Microsoft RDP-Clientsteuerung (verteilbar): Version 11.'
ms.assetid: 9D0F2312-0D85-402D-874D-9FA477435210
ms.tgt_platform: multiple
keywords:
- MsRdpClient10-Remotedesktopdienste
...
ms.locfileid: "122465467"
---
# <a name="msrdpclient10-class"></a>MsRdpClient10-Klasse

Microsoft RDP-Clientsteuerung (verteilbar): Version 11
...
**MsRdpClient10 verfügt** über die folgenden Membertypen:
...
Die **MsRdpClient10-Klasse** verfügt über diese Methoden.
...
Die **MsRdpClient10-Klasse** verfügt über diese Eigenschaften.
...
| <a href="imsrdpclientnonscriptable4-launchedviaclientshellinterface.md"><strong>LaunchedViaClientShellInterface</strong></a><br /> | Lesen/Schreiben<br /> | Gibt an, ob der Benutzer das Clientsteuerelement mithilfe der RD-Webzugriff-Schnittstelle gestartet hat.<br /> | 
...
| <a href="imsrdpclient10-remoteprogram3.md"><strong>RemoteProgram3</strong></a><br /> | Schreibgeschützt<br /> | Ein Objekt, das die <a href="itsremoteprogram3.md"><strong>ITSRemoteProgram3-Schnittstelle</strong></a> unterstützt.<br /> | 
...
| CLSID<br/>                    | CLSID \_ MsRdpClient10 ist als C0EFA91A-EEB7-41C7-97FA-F0ED645EFB24 definiert.<br/>     |
