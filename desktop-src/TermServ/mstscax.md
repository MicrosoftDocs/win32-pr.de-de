...
description: 'Microsoft Terminal Services-Clientsteuerung (verteilbar): Version 1.'
ms.assetid: 8B8FEF40-89A5-47C0-94EE-4F4B2B5738AB
ms.tgt_platform: multiple
keywords:
- MsTscAx-Remotedesktopdienste
...
Microsoft Terminal Services-Clientsteuerung (verteilbar): Version 1
...
| [**Beim Herstellen einer Verbindung**](imstscaxevents-onconnecting.md)                                         | Wird aufgerufen, wenn das Clientsteuerelemente als Reaktion auf einen Aufruf von [**IMsTscAx::Verbinden eine Verbindung mit einem Server beginnt.**](imstscax-connect.md)<br/>                                                                                                                                               |
