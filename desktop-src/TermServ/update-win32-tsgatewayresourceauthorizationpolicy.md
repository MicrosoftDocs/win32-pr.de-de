---
title: Aktualisieren der Methode der Win32_TSGatewayResourceAuthorizationPolicy-Klasse
description: Aktualisiert die aktuelle Remotedesktop-Ressourcenautorisierungsrichtlinie (RD \ 160; HIER WIRD DER 16.
ms.assetid: af997bb8-6027-4f37-80fb-e89622840a2b
ms.tgt_platform: multiple
keywords:
- Aktualisieren der Methode Remotedesktopdienste
- Aktualisieren der Methode Remotedesktopdienste , Win32_TSGatewayResourceAuthorizationPolicy-Klasse
...
ms.locfileid: "119868920"
---
# <a name="update-method-of-the-win32_tsgatewayresourceauthorizationpolicy-class"></a>Update-Methode der Win32 \_ TSGatewayResourceAuthorizationPolicy-Klasse

Aktualisiert die aktuelle Remotedesktop-Ressourcenautorisierungsrichtlinie (RD-RD-AUTORISIERUNGsrichtlinie).
...
Gibt an, ob RD-CSV aktiviert werden soll.
...
Ressourcengruppenname, der diesem RD-DOMÄNENNAMEN zugeordnet ist.
