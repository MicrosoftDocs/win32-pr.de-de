...
Die **Win32 \_ terminalterminalsetting** -WMI-Klasse stellt die Zuordnung zwischen einem Terminal und seinen Konfigurationseinstellungen dar.
...
Die **Win32 \_ terminalterminalsetting** -Klasse verfügt über diese Typen von Membern:
...
Stellt das Terminal dar, das über die **Setting** -Eigenschaft konfiguriert werden kann.
