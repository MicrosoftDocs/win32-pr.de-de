...
Gibt die Codierungsqualität an (Bitrate).
...
Einer der folgenden **cameraredirencodingquality** -Enumerationswerte, der die Codierungsqualität angibt (Bitrate).

| Enum-Elementname | Wert |
|-----------------|--------|
