...
---
# <a name="embedding-the-remote-desktop-activex-control-in-a-webpage"></a><span data-ttu-id="c4f66-103">Einbetten des Remotedesktop ActiveX-Steuer Elements in eine Webseite</span><span class="sxs-lookup"><span data-stu-id="c4f66-103">Embedding the Remote Desktop ActiveX control in a webpage</span></span>

<span data-ttu-id="c4f66-104">Sie können das Remotedesktop ActiveX-Steuerelement in eine Webseite einbetten, indem Sie Code verwenden, der dem folgenden ähnelt.</span><span class="sxs-lookup"><span data-stu-id="c4f66-104">You can embed the Remote Desktop ActiveX control in a web page by using code that is similar to the following.</span></span>
...
<span data-ttu-id="c4f66-105">Die CLSID ist für das ActiveX-Steuerelement, das von Remotedesktopverbindung (RDP) 6,0 gehostet wird.</span><span class="sxs-lookup"><span data-stu-id="c4f66-105">The CLSID is for the ActiveX control that is hosted by Remote Desktop Connection (RDP) 6.0.</span></span> <span data-ttu-id="c4f66-106">Dieses ActiveX-Steuerelement implementiert [**imsrdpclient**](imsrdpclient-interface.md).</span><span class="sxs-lookup"><span data-stu-id="c4f66-106">This ActiveX control implements [**IMsRdpClient**](imsrdpclient-interface.md).</span></span>

## <a name="related-topics"></a><span data-ttu-id="c4f66-107">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="c4f66-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="c4f66-108">Verwenden des Remotedesktop ActiveX-Steuer Elements</span><span class="sxs-lookup"><span data-stu-id="c4f66-108">Using the Remote Desktop ActiveX control</span></span>](using-remote-desktop-web-connection.md)
</dt> </dl>
