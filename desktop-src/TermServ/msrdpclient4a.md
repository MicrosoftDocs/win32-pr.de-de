---
title: MsRdpClient4a-Klasse
description: 'Microsoft RDP-Clientsteuerung (redistributable): Version 5a.'
ms.assetid: D025E5A2-9A04-44BC-BE6C-581E6B34ABCF
ms.tgt_platform: multiple
keywords:
- MsRdpClient4a-Klasse Remotedesktopdienste
- MsRdpClient4a-Klasse Remotedesktopdienste beschrieben
topic_type:
- apiref
api_name:
- MsRdpClient4a
...
ms.locfileid: "117756552"
---
# <a name="msrdpclient4a-class"></a>MsRdpClient4a-Klasse
...
**MsRdpClient4a** verfügt über diese Typen von Membern:
...
Die **MsRdpClient4a-Klasse** verfügt über diese Methoden.
...
Die **MsRdpClient4a-Klasse** verfügt über diese Eigenschaften.
...
| [**StartConnected**](imstscax-startconnected.md)<br/>                               | Lesen/Schreiben<br/> | Gibt an, ob das Steuerelement die RD-Sitzungshost Serververbindung sofort nach dem Start herstellt.<br/>                                                                                      |
...
| CLSID<br/>                    | CLSID \_ MsRdpClient4a ist als 54CE37E0-9834-41AE-9896-4DAB69DC022B definiert.<br/>     |
