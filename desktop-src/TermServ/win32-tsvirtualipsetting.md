...
description: Stellt die Zuordnung zwischen einer Win32 \_ TerminalService-Elementklasse und einer Win32 \_ TSVirtualIP-Einstellungsklasse dar.
ms.assetid: 06a78b4d-973a-4912-b7e6-bc490197c4a6
ms.tgt_platform: multiple
keywords:
- Win32_TSVirtualIPSetting-Klassen-Remotedesktopdienste
...
ms.locfileid: "119769030"
---
# <a name="win32_tsvirtualipsetting-class"></a>Win32 \_ TSVirtualIPSetting-Klasse
...
Die **Win32 \_ TSVirtualIPSetting-Klasse** verfügt über folgende Typen von Membern:

-   [Eigenschaften](#properties)

### <a name="properties"></a>Eigenschaften

Die **Win32 \_ TSVirtualIPSetting-Klasse** verfügt über diese Eigenschaften.
...
Ein Verweis auf ein [**Win32 \_ TerminalService-Objekt,**](win32-terminalservice.md) das die Elementklasse für die Zuordnung ist.
...
Datentyp: **[ **Win32 \_ TSVirtualIP**](win32-tsvirtualip.md)**
</dt> <dt>
...
Ein Verweis auf ein [**Win32 \_ TSVirtualIP-Objekt,**](win32-tsvirtualip.md) das die Einstellungsklasse für die Zuordnung ist.
