...
description: Stellt die Methoden und Eigenschaften zur Konfiguration und Verwendung des Clientsteuer steuerelements zur Anwendung. Wird von der IMsRdpClient7-Schnittstelle ableiten.
ms.assetid: 5ff54392-48f2-49a9-a264-88db08ec1770
ms.tgt_platform: multiple
keywords:
- IMsRdpClient8-Remotedesktopdienste
- IMsRdpClient8-Schnittstelle Remotedesktopdienste , beschrieben
topic_type:
- apiref
api_name:
- IMsRdpClient8
...
Die **IMsRdpClient8-Schnittstelle** erbt von [**IMsRdpClient7**](imsrdpclient7.md). **IMsRdpClient8** verfügt auch über diese Membertypen:
...
| [**SendOnVirtualChannel**](imstscax-sendonvirtualchannel.md)             | Sendet Daten über einen RD-Sitzungshost, der zuvor mithilfe der [**CreateVirtualChannels-Methode**](imstscax-createvirtualchannels.md) erstellt wurde, an den serverseitigen Server.<br/> |
...
| [**DesktopWidth**](imstscax-desktopwidth.md)<br/>                             | Lesen/Schreiben<br/> | Gibt die Breite des aktuellen Steuerelements auf dem ursprünglichen Remotedesktop in Pixel an.<br/>                                                                                                                                                            |
| [**DisconnectedText**](imstscax-disconnectedtext.md)<br/>                     | Lesen/Schreiben<br/> | Gibt den Text an, der zentriert im -Steuerelement angezeigt wird, bevor eine Verbindung beendet wird.<br/>                                                                                                                                                  |
