...
---
# <a name="peap-profile-sample"></a>Beispiel für ein Peer-Profil

Dieses Profil Beispiel zeigt ein Kabelnetzwerk Profil, das zum Herstellen einer Verbindung mit einem Netzwerk verwendet wird, das Protected Extensible Authentication Protocol with Microsoft Challenge Handshake Authentication Protocol Version 2 (Peer-MSCHAPv2) mit * username * **/** _Password_ für 802.1 x-Authentifizierung verwendet. Der Benutzer wird aufgefordert, Anmelde Informationen einzugeben.
