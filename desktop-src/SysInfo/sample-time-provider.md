...
---
# <a name="sample-time-provider"></a>Beispiel Zeit Anbieter

Im folgenden Beispiel wird veranschaulicht, wie ein Zeit Anbieter strukturiert wird. In diesem Beispiel unterstützt die dll zwei Hardware Zeit Anbieter.
