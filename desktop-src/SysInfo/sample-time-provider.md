---
description: Im folgenden Beispiel wird veranschaulicht, wie ein Zeit Anbieter strukturiert wird. In diesem Beispiel unterstützt die dll zwei Hardware Zeit Anbieter.
ms.assetid: 6be08c49-be68-4b75-b740-fc1d5a2ff592
title: Beispiel Zeit Anbieter
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104529633"
---
# <a name="sample-time-provider"></a><span data-ttu-id="e61d2-104">Beispiel Zeit Anbieter</span><span class="sxs-lookup"><span data-stu-id="e61d2-104">Sample Time Provider</span></span>

<span data-ttu-id="e61d2-105">Im folgenden Beispiel wird veranschaulicht, wie ein Zeit Anbieter strukturiert wird.</span><span class="sxs-lookup"><span data-stu-id="e61d2-105">The following example demonstrates how to structure a time provider.</span></span> <span data-ttu-id="e61d2-106">In diesem Beispiel unterstützt die dll zwei Hardware Zeit Anbieter.</span><span class="sxs-lookup"><span data-stu-id="e61d2-106">In this example, the DLL supports two hardware time providers.</span></span>
