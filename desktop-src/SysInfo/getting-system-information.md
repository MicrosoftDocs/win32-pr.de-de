---
description: Im folgenden Beispiel werden die Funktionen GetComputerName, GetUserName, GetSystemDirectory, GetWindowsDirectory und expandumgebstrings verwendet, um Informationen zu erhalten, die die Systemkonfiguration beschreiben.
ms.assetid: 965bd14b-be93-4084-bce8-642f5704cef1
title: System Informationen werden erhalten.
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106354027"
---
# <a name="getting-system-information"></a><span data-ttu-id="4b87e-103">System Informationen werden erhalten.</span><span class="sxs-lookup"><span data-stu-id="4b87e-103">Getting System Information</span></span>

<span data-ttu-id="4b87e-104">Im folgenden Beispiel werden die Funktionen [**GetComputerName**](/windows/desktop/api/Winbase/nf-winbase-getcomputernamea), [**GetUsername**](/windows/desktop/api/Winbase/nf-winbase-getusernamea), [**GetSystemDirectory**](/windows/win32/api/sysinfoapi/nf-sysinfoapi-getsystemdirectorya), [**GetWindowsDirectory**](/windows/win32/api/sysinfoapi/nf-sysinfoapi-getwindowsdirectorya)und [**expandumgebstrings**](/windows/win32/api/processenv/nf-processenv-expandenvironmentstringsa) verwendet, um Informationen zu erhalten, die die Systemkonfiguration beschreiben.</span><span class="sxs-lookup"><span data-stu-id="4b87e-104">The following example uses the [**GetComputerName**](/windows/desktop/api/Winbase/nf-winbase-getcomputernamea), [**GetUserName**](/windows/desktop/api/Winbase/nf-winbase-getusernamea), [**GetSystemDirectory**](/windows/win32/api/sysinfoapi/nf-sysinfoapi-getsystemdirectorya), [**GetWindowsDirectory**](/windows/win32/api/sysinfoapi/nf-sysinfoapi-getwindowsdirectorya), and [**ExpandEnvironmentStrings**](/windows/win32/api/processenv/nf-processenv-expandenvironmentstringsa) functions to get information that describes the system configuration.</span></span>
