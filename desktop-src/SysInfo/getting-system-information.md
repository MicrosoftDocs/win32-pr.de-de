...
---
# <a name="getting-system-information"></a>System Informationen werden erhalten.

Im folgenden Beispiel werden die Funktionen [**GetComputerName**](/windows/desktop/api/Winbase/nf-winbase-getcomputernamea), [**GetUsername**](/windows/desktop/api/Winbase/nf-winbase-getusernamea), [**GetSystemDirectory**](/windows/win32/api/sysinfoapi/nf-sysinfoapi-getsystemdirectorya), [**GetWindowsDirectory**](/windows/win32/api/sysinfoapi/nf-sysinfoapi-getwindowsdirectorya)und [**expandumgebstrings**](/windows/win32/api/processenv/nf-processenv-expandenvironmentstringsa) verwendet, um Informationen zu erhalten, die die Systemkonfiguration beschreiben.
