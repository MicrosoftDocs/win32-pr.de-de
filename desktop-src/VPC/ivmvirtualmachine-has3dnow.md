...
---
# <a name="ivmvirtualmachinehas3dnow-property"></a>Ivmvirtualmachine:: Has3DNow-Eigenschaft

\[Windows Virtual PC ist nicht mehr für die Verwendung ab Windows 8 verfügbar. Verwenden Sie stattdessen den [Hyper-V-WMI-Anbieter (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Bestimmt, ob der Prozessor den 3DNow-Anweisungs Satz unterstützt.
...
**True** , wenn der Prozessor den 3DNow-Anweisungs Satz unterstützt, andernfalls **false** .
