...
---
# <a name="ivmhostinfonetworkadapters-property"></a>Ivmhostinfo:: NetworkAdapters (Eigenschaft)

\[Windows Virtual PC ist nicht mehr für die Verwendung ab Windows 8 verfügbar. Verwenden Sie stattdessen den [Hyper-V-WMI-Anbieter (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Ruft eine Aufzähl Bare Auflistung von NICs auf dem Host Computer ab.
...
Eine Auflistung von Netzwerkschnittstellenkarten. Dies ist ein Array von **BSTR** -Werten.
