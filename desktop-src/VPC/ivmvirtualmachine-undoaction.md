...
- IVMVirtualMachine-Schnittstelle Virtueller PC, UndoAction-Eigenschaft
topic_type:
- apiref
api_name:
...
Ruft die Standardaktion ab, die auf allen Rückgängig-Laufwerken ausgeführt werden soll, wenn der virtuelle Computer (VM) mit der [**TurnOff-Methode**](ivmvirtualmachine-turnoff.md) deaktiviert oder mithilfe der [**Shutdown-Methode**](ivmguestos-shutdown.md) heruntergefahren oder innerhalb des Gastbetriebssystems ausgeschaltet wird, und legt diese fest.
...
Gibt die Standardaktion an, die auf allen Rückgängig-Laufwerken ausgeführt werden soll, wenn der virtuelle Computer aus dem Gastbetriebssystem heruntergefahren wird. Eine Liste der Werte finden Sie unter [**VMUndoAction**](vmundoaction.md).
