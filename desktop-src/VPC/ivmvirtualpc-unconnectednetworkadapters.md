...
description: Ruft eine aufzählbare Auflistung nicht verbundener Netzwerkschnittstellen ab.
ms.assetid: 2d95f289-083a-4388-b842-0a11b4e1a06f
keywords:
- UnconnectedNetworkAdapters-Eigenschaft Virtueller PC
- UnconnectedNetworkAdapters-Eigenschaft Virtueller PC, IVMVirtualPC-Schnittstelle
- IVMVirtualPC-Schnittstelle Virtueller PC, UnconnectedNetworkAdapters (Eigenschaft)
topic_type:
- apiref
api_name:
...
Ruft eine aufzählbare Auflistung nicht verbundener Netzwerkschnittstellen ab.
...
Eine Auflistung von nicht verbundenen [**IVMNetworkAdapter-Objekten.**](ivmnetworkadapter.md) Siehe [**IVMNetworkAdapterCollection**](ivmnetworkadaptercollection.md).
