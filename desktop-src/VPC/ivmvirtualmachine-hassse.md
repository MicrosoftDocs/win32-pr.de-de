...
---
# <a name="ivmvirtualmachinehassse-property"></a>Ivmvirtualmachine:: hassse-Eigenschaft
...
**True** , wenn der Prozessor den SSE-Anweisungs Satz unterstützt, andernfalls **false** .
