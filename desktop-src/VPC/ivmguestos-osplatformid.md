...
---
# <a name="ivmguestososplatformid-property"></a>Ivmguestos:: OSPlatformID-Eigenschaft

\[Windows Virtual PC ist nicht mehr für die Verwendung ab Windows 8 verfügbar. Verwenden Sie stattdessen den [Hyper-V-WMI-Anbieter (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Ruft den Platt Form Bezeichner des Gast Betriebssystems ab, das auf dem virtuellen Computer ausgeführt wird.
...
Der unterstützte Zeichen folgen Wert ist "2".
