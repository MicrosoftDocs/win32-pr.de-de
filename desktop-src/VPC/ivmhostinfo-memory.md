...
Ruft die Gesamtmenge an physischem Arbeitsspeicher auf dem Host Computer (in Megabyte) ab.
...
Die Gesamtmenge des physischen Speichers in Megabyte. Dieser Wert ist eine **Variante** vom Typ VT \_ Decimal.
