---
title: Beispiel "enumall"
description: Legt alle Eigenschaften in allen Eigenschafts Sätzen einer Speicherdatei ab.
ms.assetid: 40dd62b8-f76a-4cd8-9a9f-6ac344389b6c
keywords:
- Strukturierter Speicherplatz Halter-STG, Beispiele, enumeraturen
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104309815"
---
# <a name="enumall-sample"></a><span data-ttu-id="48412-104">Beispiel "enumall"</span><span class="sxs-lookup"><span data-stu-id="48412-104">EnumAll Sample</span></span>

<span data-ttu-id="48412-105">Die Beispielanwendung "enumall. cpp" fügt alle Eigenschaften in allen Eigenschafts Sätzen einer Speicherdatei ein.</span><span class="sxs-lookup"><span data-stu-id="48412-105">The EnumAll.cpp sample application puts all properties in all property sets of a storage file.</span></span>
