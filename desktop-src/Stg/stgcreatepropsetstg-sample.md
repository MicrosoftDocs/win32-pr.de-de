---
title: Stgkreatepropsetstg-Beispiel
description: Zeigt, wie die stganatepropsetstg-Funktion verwendet werden kann, um eine IPropertySetStorage-Schnittstelle auf einer beliebigen IStorage-Schnittstelle zu erstellen.
ms.assetid: f0d0664a-2cfd-4eb0-b1d5-47d1545394fd
keywords:
- Strukturierter Speicherplatz Halter-STG, Beispiele, stgkreatepropsetstg
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104388620"
---
# <a name="stgcreatepropsetstg-sample"></a><span data-ttu-id="91e33-104">Stgkreatepropsetstg-Beispiel</span><span class="sxs-lookup"><span data-stu-id="91e33-104">StgCreatePropSetStg Sample</span></span>

<span data-ttu-id="91e33-105">Das Beispiel stgkreatepropsetstg. cpp zeigt, wie die [**stganatepropsetstg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) -Funktion verwendet werden kann, um eine [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) -Schnittstelle auf einer beliebigen [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) -Schnittstelle zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="91e33-105">The StgCreatePropSetStg.cpp sample shows how the [**StgCreatePropSetStg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) function can be used to create an [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) interface on top of any given [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) interface.</span></span>
