...
Die **iPaper:: Redraw** -Methode basiert auf der Verbindungspunkt Technologie.

Der folgende Beispielcode ist die **Redraw** -Methode von Paper. cpp.
...
Weitere Informationen finden Sie unter [**ipapersink**](ipapersink-methods.md) -Methode.
