---
title: Funktionen (STG)
description: Funktionen sind Routinen oder Unterroutinen, die einen bestimmten Wert oder bestimmte Werte zurückgeben. Strukturierte Storage Funktionen werden in den folgenden Abschnitten beschrieben.
ms.assetid: 5fbb05ae-594d-4fa5-97d2-a2371e94c054
keywords:
- Strukturierte Storage Strctd Stg , Referenz, Funktionen
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "120034900"
---
# <a name="structured-storage-functions"></a>Strukturierte Storage-Funktionen

Funktionen sind Routinen oder Unterroutinen, die einen bestimmten Wert oder bestimmte Werte zurückgeben. Strukturierte Storage Funktionen werden in den folgenden Abschnitten beschrieben:
