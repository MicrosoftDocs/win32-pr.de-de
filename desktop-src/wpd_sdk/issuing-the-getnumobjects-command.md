---
description: Ausgeben des getnumubjects-Befehls
ms.assetid: d06690e4-f592-4b17-a5f1-baec2accc8dd
title: Ausgeben des getnumubjects-Befehls
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106348132"
---
# <a name="issuing-the-getnumobjects-command"></a><span data-ttu-id="79a18-103">Ausgeben des getnumubjects-Befehls</span><span class="sxs-lookup"><span data-stu-id="79a18-103">Issuing the GetNumObjects Command</span></span>

<span data-ttu-id="79a18-104">Das Beispiel in diesem Abschnitt Ruft den **getnumubjects** MTP-Befehl auf.</span><span class="sxs-lookup"><span data-stu-id="79a18-104">The example in this section invokes the **GetNumObjects** MTP command.</span></span> <span data-ttu-id="79a18-105">(Eine ausführliche Beschreibung dieses Befehls und seiner Parameter finden Sie in der [MTP-Spezifikation](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span><span class="sxs-lookup"><span data-stu-id="79a18-105">(For a complete description of this command and its parameters, see the [MTP specification](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span></span>

<span data-ttu-id="79a18-106">Bevor Sie diesen Befehl aufrufen, müssen Sie zuerst die Befehlsparameter einrichten.</span><span class="sxs-lookup"><span data-stu-id="79a18-106">Before you invoke this command, you must first set up the command parameters.</span></span>
...
<span data-ttu-id="79a18-107">Nachdem die Parameter eingerichtet wurden, ruft die Anwendung den Befehl auf.</span><span class="sxs-lookup"><span data-stu-id="79a18-107">After the parameters are set up, the application invokes the command.</span></span>
...
<span data-ttu-id="79a18-108">Nachdem die Anwendung den Befehl aufgerufen hat, wird die Antwort vom MTP-Treiber verarbeitet.</span><span class="sxs-lookup"><span data-stu-id="79a18-108">After the application invokes the command, it processes the response from the MTP driver.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="79a18-109">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="79a18-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="79a18-110">Unterstützen von MTP-Erweiterungen</span><span class="sxs-lookup"><span data-stu-id="79a18-110">Supporting MTP Extensions</span></span>](supporting-mtp-extensions.md)
</dt> </dl>
