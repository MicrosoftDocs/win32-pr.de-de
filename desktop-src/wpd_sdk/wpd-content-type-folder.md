...
---
# <a name="wpd_content_type_folder"></a>Ordner für WPD- \_ \_ Inhaltstyp \_

Ein-Objekt, das den Typ als Ordner des WPD- \_ Inhaltstyp beschreibt, der \_ \_ einen Ordner darstellt.
...
| [\_ \_ \_ \_ Anzeige \_ Name des WPD-Objekt Hinweis Speicher Orts](miscellaneous-properties.md)      | Empfohlen, wenn das Objekt als Hinweis Speicherort identifiziert wird.                                                                                                                   |
...
| [Inhaltstypen für WPD- \_ Ordner sind \_ \_ \_ zulässig.](miscellaneous-properties.md)                 | Dies ist optional. Wenn Sie nicht eingeschlossen ist, kann der Ordner beliebige Inhaltstypen akzeptieren. Wenn Sie enthalten sind und die Auflistung leer ist, kann die Anwendung keine untergeordneten Objekte innerhalb dieses Ordners erstellen. |
