...
---
# <a name="issuing-the-getdevicepropvalue-command"></a><span data-ttu-id="e7bb1-103">Ausgeben des getdevicepropvalue-Befehls</span><span class="sxs-lookup"><span data-stu-id="e7bb1-103">Issuing the GetDevicePropValue Command</span></span>

<span data-ttu-id="e7bb1-104">Im Beispiel in diesem Abschnitt wird der **getdevicepropvalue** -MTP-Befehl aufgerufen, um die Geräte Eigenschaft " **Akku Level** " abzurufen.</span><span class="sxs-lookup"><span data-stu-id="e7bb1-104">The example in this section invokes the **GetDevicePropValue** MTP command to retrieve the **BatteryLevel** device property.</span></span> <span data-ttu-id="e7bb1-105">(Eine ausführliche Beschreibung dieses Befehls und seiner Parameter finden Sie in der [MTP-Spezifikation](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span><span class="sxs-lookup"><span data-stu-id="e7bb1-105">(For a complete description of this command and its parameters, see the [MTP specification](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span></span>

<span data-ttu-id="e7bb1-106">Im Fall von **getdevicepropvalue** verwendet der Beispielcode die folgende Sequenz:</span><span class="sxs-lookup"><span data-stu-id="e7bb1-106">In the case of **GetDevicePropValue**, the sample code uses the following sequence:</span></span>

1.  <span data-ttu-id="e7bb1-107">WPD- \_ Befehl \_ MTP \_ ext Execute- \_ \_ Befehl \_ mit \_ \_ zu \_ lesenden Daten</span><span class="sxs-lookup"><span data-stu-id="e7bb1-107">WPD\_COMMAND\_MTP\_EXT\_EXECUTE\_COMMAND\_WITH\_DATA\_TO\_READ</span></span>
2.  <span data-ttu-id="e7bb1-108">WPD- \_ Befehl \_ MTP \_ Ext \_ \_ Daten lesen</span><span class="sxs-lookup"><span data-stu-id="e7bb1-108">WPD\_COMMAND\_MTP\_EXT\_READ\_DATA</span></span>
3.  <span data-ttu-id="e7bb1-109">WPD- \_ Befehl \_ MTP \_ Ext \_ Ende \_ Daten \_ Übertragung</span><span class="sxs-lookup"><span data-stu-id="e7bb1-109">WPD\_COMMAND\_MTP\_EXT\_END\_DATA\_TRANSFER</span></span>

<span data-ttu-id="e7bb1-110">Im folgenden Codebeispiel wird veranschaulicht, wie die Anwendung die Befehlssequenz initiert.</span><span class="sxs-lookup"><span data-stu-id="e7bb1-110">The following code example shows how the application initates the command sequence.</span></span>
...
<span data-ttu-id="e7bb1-111">Das folgende Codebeispiel zeigt, wie die Anwendung die Eigenschaften Daten abruft.</span><span class="sxs-lookup"><span data-stu-id="e7bb1-111">The following code example shows how the application retrieves the property data.</span></span>
...
<span data-ttu-id="e7bb1-112">Im folgenden Codebeispiel wird gezeigt, wie die Anwendung die Geräte Antwort an den Befehl abruft.</span><span class="sxs-lookup"><span data-stu-id="e7bb1-112">The following code example shows how the application retrieves the device response to the command.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="e7bb1-113">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="e7bb1-113">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="e7bb1-114">Unterstützen von MTP-Erweiterungen</span><span class="sxs-lookup"><span data-stu-id="e7bb1-114">Supporting MTP Extensions</span></span>](supporting-mtp-extensions.md)
</dt> </dl>
