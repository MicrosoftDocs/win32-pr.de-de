...
---
# <a name="cc-tracelogging-examples"></a><span data-ttu-id="be4c2-103">C/C++ tracelogging-Beispiele</span><span class="sxs-lookup"><span data-stu-id="be4c2-103">C/C++ Tracelogging Examples</span></span>

<span data-ttu-id="be4c2-104">Dieses Thema enthält Beispiele für C/C++ tracelogging.</span><span class="sxs-lookup"><span data-stu-id="be4c2-104">This topic contains C/C++ Tracelogging examples.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="be4c2-105">Verknüpfen Sie advapi32. lib beim Kompilieren dieser Beispiele.</span><span class="sxs-lookup"><span data-stu-id="be4c2-105">Link advapi32.lib when compiling these examples.</span></span>

 

-   [<span data-ttu-id="be4c2-106">Systeminterne Datentypen protokollieren</span><span class="sxs-lookup"><span data-stu-id="be4c2-106">Log intrinsic data types</span></span>](#log-intrinsic-data-types)
-   [<span data-ttu-id="be4c2-107">Namens Ereignis Felder</span><span class="sxs-lookup"><span data-stu-id="be4c2-107">Name event fields</span></span>](#name-event-fields)
-   [<span data-ttu-id="be4c2-108">Ausführlichkeits Grad der Protokollereignisse</span><span class="sxs-lookup"><span data-stu-id="be4c2-108">Log events verbosity level</span></span>](#log-event-verbosity-level)
-   [<span data-ttu-id="be4c2-109">Schlüsselwörter für Protokollereignisse</span><span class="sxs-lookup"><span data-stu-id="be4c2-109">Log events keywords</span></span>](#log-event-keywords)
-   [<span data-ttu-id="be4c2-110">Protokollieren von Array Ereignisdaten</span><span class="sxs-lookup"><span data-stu-id="be4c2-110">Log array event data</span></span>](#log-array-event-data)
-   [<span data-ttu-id="be4c2-111">Protokoll Struktur-Ereignisdaten</span><span class="sxs-lookup"><span data-stu-id="be4c2-111">Log structure event data</span></span>](#log-structure-event-data)

### <a name="log-intrinsic-data-types"></a><span data-ttu-id="be4c2-112">Systeminterne Datentypen protokollieren</span><span class="sxs-lookup"><span data-stu-id="be4c2-112">Log intrinsic data types</span></span>

<span data-ttu-id="be4c2-113">Dieses Beispiel zeigt, wie systeminterne Datentypen (z. b. ganze Zahlen, boolesche Werte usw.) protokolliert werden.</span><span class="sxs-lookup"><span data-stu-id="be4c2-113">This example shows how to log intrinsic data types such as integers, booleans, and so on.</span></span>
...
### <a name="name-event-fields"></a><span data-ttu-id="be4c2-114">Namens Ereignis Felder</span><span class="sxs-lookup"><span data-stu-id="be4c2-114">Name event fields</span></span>

<span data-ttu-id="be4c2-115">Das Beispiel zeigt, wie Sie Ereignis Felder benennen können.</span><span class="sxs-lookup"><span data-stu-id="be4c2-115">The example shows how to name event fields.</span></span>
...
### <a name="log-event-verbosity-level"></a><span data-ttu-id="be4c2-116">Ausführlichkeits Grad der Protokollierung</span><span class="sxs-lookup"><span data-stu-id="be4c2-116">Log event verbosity level</span></span>

<span data-ttu-id="be4c2-117">Dieses Beispiel zeigt, wie Ereignisse nach ausführlichkeits Grad protokolliert werden.</span><span class="sxs-lookup"><span data-stu-id="be4c2-117">This example shows how to log events by verbosity level.</span></span>
...
### <a name="log-event-keywords"></a><span data-ttu-id="be4c2-118">Protokoll Ereignis Schlüsselwörter</span><span class="sxs-lookup"><span data-stu-id="be4c2-118">Log event keywords</span></span>

<span data-ttu-id="be4c2-119">Dieses Beispiel veranschaulicht, wie Ereignis Schlüsselwörter festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="be4c2-119">This example illustrates how to set event keywords.</span></span> <span data-ttu-id="be4c2-120">Die Ereignis Filterung kann nach Ebene und Schlüsselwort durchgeführt werden.</span><span class="sxs-lookup"><span data-stu-id="be4c2-120">Event filtering can be done by level and keyword.</span></span> <span data-ttu-id="be4c2-121">Beispielsweise können szenariovervollständigungs-oder Fehlerereignisse unter separaten Schlüsselwörtern gruppiert werden, damit Sie diese Ereignisse leicht filtern können.</span><span class="sxs-lookup"><span data-stu-id="be4c2-121">For example, scenario completion events or failure events might be grouped under separate keywords so that you can easily filter those events.</span></span>
...
### <a name="log-array-event-data"></a><span data-ttu-id="be4c2-122">Protokollieren von Array Ereignisdaten</span><span class="sxs-lookup"><span data-stu-id="be4c2-122">Log array event data</span></span>

<span data-ttu-id="be4c2-123">Dieses Beispiel zeigt, wie Arrays als Ereignisdaten protokolliert werden.</span><span class="sxs-lookup"><span data-stu-id="be4c2-123">This example shows how to log arrays as event data.</span></span>
...
### <a name="log-structure-event-data"></a><span data-ttu-id="be4c2-124">Protokoll Struktur-Ereignisdaten</span><span class="sxs-lookup"><span data-stu-id="be4c2-124">Log structure event data</span></span>

<span data-ttu-id="be4c2-125">Dieses Beispiel zeigt, wie Struktur Ereignisdaten protokolliert werden.</span><span class="sxs-lookup"><span data-stu-id="be4c2-125">This example shows how to log structure event data.</span></span>
...
### <a name="how-to-fix-tracelogging-cc-build-errors"></a><span data-ttu-id="be4c2-126">Beheben von Fehlern beim Laden von tracelogging-C/C++-Builds</span><span class="sxs-lookup"><span data-stu-id="be4c2-126">How to fix TraceLogging C/C++ build errors</span></span>

<span data-ttu-id="be4c2-127">Buildfehler</span><span class="sxs-lookup"><span data-stu-id="be4c2-127">Build Error</span></span>
...
<span data-ttu-id="be4c2-128">Fix</span><span class="sxs-lookup"><span data-stu-id="be4c2-128">Fix</span></span>

<span data-ttu-id="be4c2-129">Beheben Sie diesen Fehler, indem Sie advapi32. lib in Ihrem Projekt verknüpfen.</span><span class="sxs-lookup"><span data-stu-id="be4c2-129">Fix this error by linking advapi32.lib in your project.</span></span>
