...
---
# <a name="ntgdidddestroymocomp-function"></a>Ntgdidddestroymucomp-Funktion
...
Benachrichtigt den Treiber, dass dieses Bewegungs Kompensations Objekt nicht mehr verwendet wird. Der Treiber muss nun alle notwendigen Bereinigungs Vorgänge ausführen.
...
Handle für eine [**\_ \_ lokale DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_motioncomp_local) -Struktur, die eine Beschreibung des zu zerstörenden Bewegungs Kompensations Objekts enthält.
...
Zeiger auf eine [**DD \_ destroymucompdata**](/windows/win32/api/ddrawint/ns-ddrawint-dd_destroymocompdata) -Struktur, die die zum Abschließen der Bewegungskompensation erforderlichen Informationen enthält.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

**Ntgdidddestroymucomp** gibt einen der folgenden Rückruf Codes zurück.
