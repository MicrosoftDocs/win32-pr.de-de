---
description: Benachrichtigt den Treiber, dass dieses Bewegungskompensierungsobjekt nicht mehr verwendet wird. Der Treiber muss jetzt alle erforderlichen Bereinigungen ausführen.
ms.assetid: 1d86a564-efe1-4971-99ec-2c9a6aa59c89
title: NtGdiDdDestroyMoComp-Funktion (Ntgdi.h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119824920"
---
# <a name="ntgdidddestroymocomp-function"></a>NtGdiDdDestroyMoComp-Funktion
...
Benachrichtigt den Treiber, dass dieses Bewegungskompensierungsobjekt nicht mehr verwendet wird. Der Treiber muss jetzt alle erforderlichen Bereinigungen ausführen.
...
Handle für eine [**DD \_ MOTIONCOMP \_ LOCAL-Struktur,**](/windows/win32/api/ddrawint/ns-ddrawint-dd_motioncomp_local) die eine Beschreibung des zu zerstörenden Bewegungskompensierungsobjekts enthält.
...
Zeiger auf eine [**DD \_ DESTROYMOCOMPDATA-Struktur,**](/windows/win32/api/ddrawint/ns-ddrawint-dd_destroymocompdata) die die Informationen enthält, die zum Beenden der Bewegungskompensierung erforderlich sind.
