...
Zeiger auf eine [**D3DNTHAL \_ CONTEXTDESTROYDATA-Struktur,**](/windows-hardware/drivers/ddi/) die die Informationen enthält, die der Treiber zum Zerstören des Kontexts benötigt.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

**NtGdiD3DContextDestroy** gibt einen der folgenden Rückrufcodes zurück.
