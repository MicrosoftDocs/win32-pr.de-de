...
---
# <a name="ntgdiddgetmocompformats-function"></a>Ntgdiddgetmucompformats-Funktion
...
Gibt die nicht komprimierten Formate an, in denen die Daten von der Hardware decodiert werden können.
...
*pugetmucompformatsdata* \[ in, out\]
</dt> <dd>

Zeiger auf eine [**DD \_ getmucompformatsdata**](/windows/win32/api/ddrawint/ns-ddrawint-dd_getmocompformatsdata) -Struktur, die die unkomprimierten Formatierungsinformationen für die Hardware enthält.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

**Ntgdiddgetmucompformats** gibt einen der folgenden Rückruf Codes zurück.
