---
description: Im folgenden Beispiel wird gezeigt, wie die verifierenumerateresource-Funktion und verwandte Programmier Elemente verwendet werden, um prozessspezifische Ressourcen Informationen zu abstrahieren und zu kategorisieren.
ms.assetid: e0c2c795-2960-44f9-8b63-2329f5b42e15
title: Verwenden der ressourcenenumeration
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103958165"
---
# <a name="using-resource-enumeration"></a><span data-ttu-id="9da0a-103">Verwenden der ressourcenenumeration</span><span class="sxs-lookup"><span data-stu-id="9da0a-103">Using Resource Enumeration</span></span>

<span data-ttu-id="9da0a-104">Im folgenden Beispiel wird gezeigt, wie die [**verifierenumerateresource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) -Funktion und verwandte Programmier Elemente verwendet werden, um prozessspezifische Ressourcen Informationen zu abstrahieren und zu kategorisieren.</span><span class="sxs-lookup"><span data-stu-id="9da0a-104">The following example shows how to use the [**VerifierEnumerateResource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) function and related programming elements to abstract and categorize process-specific resource information.</span></span>
