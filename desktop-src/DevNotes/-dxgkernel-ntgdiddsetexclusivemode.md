...
---
# <a name="ntgdiddsetexclusivemode-function"></a>Ntgdiddabtexclusivemode-Funktion
...
Benachrichtigt den Treiber, wenn eine Microsoft DirectDraw-Anwendung zum oder aus dem exklusiven Modus wechselt.
...
*puabtexclusivemodedata* \[ in, out\]
</dt> <dd>

Zeiger auf eine [**DD- \_ texclusivemodedata**](/windows/win32/api/ddrawint/ns-ddrawint-dd_setexclusivemodedata) -Struktur, die die Benachrichtigungs Informationen enthält.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

**Ntgdiddabtexclusivemode** gibt einen der folgenden Rückruf Codes zurück.
