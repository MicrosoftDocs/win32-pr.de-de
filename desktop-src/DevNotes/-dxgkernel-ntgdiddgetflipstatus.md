---
description: Bestimmt, ob der zuletzt angeforderte Flip auf einer Oberfläche aufgetreten ist.
...
ms.locfileid: "118956339"
---
# <a name="ntgdiddgetflipstatus-function"></a>NtGdiDdGetFlipStatus-Funktion
...
Bestimmt, ob der zuletzt angeforderte Flip auf einer Oberfläche aufgetreten ist.
...
Handle für eine [DD \_ SURFACE \_ LOCAL-Struktur,](https://msdn.microsoft.com/library/ms793861.aspx) die die Oberfläche beschreibt, deren Flip-Status abgefragt wird.
...
Zeiger auf eine [DD \_ GETFLIPSTATUSDATA-Struktur,](https://msdn.microsoft.com/library/ms793859.aspx) die die informationen enthält, die zum Ausführen der Flip-Statusabfrage erforderlich sind.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

**NtGdiDdGetFlipStatus gibt** einen der folgenden Rückrufcodes zurück.
