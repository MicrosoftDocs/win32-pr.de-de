...
Bestimmt, ob das zuletzt angeforderte kippen auf einer-Oberfläche aufgetreten ist.
...
Handle für eine [ \_ \_ lokale DD-Oberflächen](https://msdn.microsoft.com/library/ms793861.aspx) Struktur, die die-Oberfläche beschreibt, deren Flip-Status abgefragt wird.

</dd> <dt>

*pugetflipstatus Data* \[ in, out\]
</dt> <dd>

Zeiger auf eine [DD \_ getflipstatusdata](https://msdn.microsoft.com/library/ms793859.aspx) -Struktur, die die zum Ausführen der Flip Status-Abfrage erforderlichen Informationen enthält.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

**Ntgdiddgetflipstatus** gibt einen der folgenden Rückruf Codes zurück.
