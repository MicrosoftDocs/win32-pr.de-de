...
Zeiger auf eine [**DD \_ WAITFORVERTICALBLANKDATA-Struktur,**](/windows/win32/api/ddrawi/ns-ddrawi-ddhal_waitforverticalblankdata) die die informationen enthält, die zum Abrufen des vertikalen Leerstellenstatus erforderlich sind.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

**NtGdiDdWaitForVerticalBlank** gibt einen der folgenden Rückrufcodes zurück.
