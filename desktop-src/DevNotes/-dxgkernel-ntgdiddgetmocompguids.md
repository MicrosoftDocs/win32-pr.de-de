---
description: Ruft die Anzahl der GUIDs ab, die der Treiber unterstützt.
ms.assetid: ed6b81bc-3f83-4983-97b6-32fdeb1c901e
title: NtGdiDdGetMoCompGuids-Funktion (Ntgdi.h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "117828021"
---
# <a name="ntgdiddgetmocompguids-function"></a>NtGdiDdGetMoCompGuids-Funktion
...
Ruft die Anzahl der GUIDs ab, die der Treiber unterstützt.
...
Zeiger auf eine [**DD \_ GETMOCOMPGUIDSDATA-Struktur,**](/windows/win32/api/ddrawint/ns-ddrawint-dd_getmocompguidsdata) die die **GUID-Informationen** enthält.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

**NtGdiDdGetMoCompGuids** gibt einen der folgenden Rückrufcodes zurück.
