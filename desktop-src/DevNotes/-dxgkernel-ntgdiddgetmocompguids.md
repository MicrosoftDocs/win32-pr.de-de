...
---
# <a name="ntgdiddgetmocompguids-function"></a>Ntgdiddgetmucompguids-Funktion
...
Ruft die Anzahl von GUIDs ab, die vom Treiber unterstützt werden.
...
*pugetmucompguidsdata* \[ in, out\]
</dt> <dd>

Zeiger auf eine [**DD \_ getmucompguidsdata**](/windows/win32/api/ddrawint/ns-ddrawint-dd_getmocompguidsdata) -Struktur, die die **GUID** -Informationen enthält.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

**Ntgdiddgetmucompguids** gibt einen der folgenden Rückruf Codes zurück.
