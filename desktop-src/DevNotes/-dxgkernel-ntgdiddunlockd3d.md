...
---
# <a name="ntgdiddunlockd3d-function"></a>NtGdiDdUnlockD3D-Funktion
...
Wird verwendet, um eine Sperre freizugeben, die in einem angegebenen Bereich des Pufferspeichers aufbewahrt wird.
...
Ein Zeiger auf eine TT- [**\_ Oberflächen \_ lokale**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local) Struktur, die die zu entsperrende Fläche beschreibt.
...
**NtGdiDdUnlockD3D** gibt einen der folgenden Rückruf Codes zurück.
