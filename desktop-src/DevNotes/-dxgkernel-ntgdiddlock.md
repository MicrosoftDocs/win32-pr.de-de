...
---
# <a name="ntgdiddlock-function"></a>Ntgdiddlock-Funktion
...
Sperrt einen angegebenen Bereich des Oberflächen Speichers und stellt einen gültigen Zeiger auf einen Speicherblock bereit, der einer Oberfläche zugeordnet ist.
...
Handle für eine [**\_ \_ lokale DD-Oberflächen**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local) Struktur, die die Oberfläche beschreibt, die der zu Sperr enden Speicher Region zugeordnet ist.
...
Zeiger auf eine TT- [**\_ Sperr Daten**](/windows/win32/api/ddrawint/ns-ddrawint-dd_lockdata) Struktur, die die zum Ausführen der Sperrung erforderlichen Informationen enthält.
...
**Ntgdiddlock** gibt einen der folgenden Rückruf Codes zurück.
