...
ms.locfileid: "119075734"
---
# <a name="winternl"></a>Sommernl

## <a name="in-this-section"></a>In diesem Abschnitt

-   [Aufrufen interner APIs](calling-internal-apis.md)
-   [Abrufen der Sitzungs-ID der aktiven Konsole](getting-the-active-console-session-id.md)
-   [Abrufen der Sitzungs-ID des aktuellen Prozesses](getting-the-session-id-of-the-current-process.md)
-   [**IOCTL \_ TCP \_ QUERY \_ INFORMATION \_ EX**](/windows/desktop/api/Tcpioctl/ni-tcpioctl-ioctl_tcp_query_information_ex)
