---
description: Legt den Farbschlüsselwert für die angegebene Oberfläche fest.
...
Legt den Farbschlüsselwert für die angegebene Oberfläche fest.
...
Zeiger auf die [**DD \_ SURFACE \_ LOCAL-Struktur,**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local) die die Oberfläche beschreibt, der der Farbschlüssel zugeordnet werden soll.
...
Zeiger auf eine [**DD \_ SETCOLORKEYDATA-Struktur,**](/windows/win32/api/ddrawint/ns-ddrawint-dd_setcolorkeydata) die die Informationen enthält, die zum Festlegen des Farbschlüssels für die angegebene Oberfläche erforderlich sind.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

**NtGdiDdSetColorKey gibt** einen der folgenden Rückrufcodes zurück.
