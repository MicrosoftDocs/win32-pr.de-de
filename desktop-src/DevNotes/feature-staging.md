...
ms.locfileid: "119076164"
---
# <a name="feature-staging"></a>Featurestaging

Diese APIs sind nur für die Infrastrukturnutzung vorgesehen. Verwenden Sie diese APIs nicht.

## <a name="in-this-section"></a>In diesem Abschnitt

-   [**\_STATUS "FEATURE \_ AKTIVIERT"**](/windows/desktop/api/featurestagingapi/ne-featurestagingapi-feature_enabled_state)
-   [**\_FEATUREFEHLER**](/windows/desktop/api/featurestagingapi/ns-featurestagingapi-feature_error)
-   [**\_ \_ FEATUREÄNDERUNGSZEIT**](/windows/desktop/api/featurestagingapi/ne-featurestagingapi-feature_change_time)
