...
Fragt den Blit-Status der angegebenen Oberfläche ab.
...
Handle für eine [ \_ \_ lokale DD-Oberfläche](https://msdn.microsoft.com/library/ms793861.aspx) , die die Oberfläche darstellt, deren Blit-Status abgefragt wird.

</dd> <dt>

*pugetbltstatus-Daten* \[ in, out\]
</dt> <dd>

Zeiger auf eine [DD \_ getbltstatusdata](https://msdn.microsoft.com/library/ms794243.aspx) -Struktur, die die zum Ausführen der Blit-Statusabfrage erforderlichen Informationen enthält.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

**Ntgdiddgetbltstatus** gibt einen der folgenden Rückruf Codes zurück.
