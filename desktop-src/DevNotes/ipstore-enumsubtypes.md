...
Gibt eine-Schnittstelle zum Auflisten von Untertypen der Typen zurück, die derzeit in der geschützten Datenbank registriert sind.
...
Ein Zeiger auf eine [**ierumpstoretypes**](ienumpstoretypes.md) -Schnittstelle, die verwendet wird, um die Untertypen aufzuzählen.
