...
---
# <a name="ntgdiddquerymocompstatus-function"></a>Ntgdiddquerytfcompstatus-Funktion
...
Fragt den Status des letzten Rendervorgangs an die angegebene Oberfläche ab.
...
Zeiger auf eine [**\_ \_ lokale DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_motioncomp_local) -Struktur, die eine Beschreibung der angeforderten Bewegungskompensation enthält.

</dd> <dt>

*puquerymucompstatus-Daten* \[ in, out\]
</dt> <dd>

Zeiger auf eine [**DD \_ querymucompstatusdata**](/windows/win32/api/ddrawint/ns-ddrawint-dd_querymocompstatusdata) -Struktur, die die zum Abfragen des Status benötigten Informationen enthält.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

**Ntgdiddquerycocompstatus** gibt einen der folgenden Rückruf Codes zurück.
