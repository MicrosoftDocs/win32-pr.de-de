...
Das Kontrollkästchen ist ein Steuerelement, auf das der Benutzer klicken kann, um Eingaben für eine Anwendung bereitzustellen. Das-Steuerelement stellt einen visuellen UMSCHALT Zustand dar, der visuell dargestellt wird.

-   [Details](#details)
-   [Kontrollkästchen Eigenschaften](#check-box-properties)
-   [Zugehörige Themen](#related-topics)

## <a name="details"></a>Details

Das Kontrollkästchen unterstützt keinen tertiären bzw. unbestimmten Zustand.

Der folgende Screenshot veranschaulicht das Kontrollkästchen-Element des Menübands.

![Screenshot eines CheckBox-Steuer Elements im Microsoft Paint-Menüband.](images/controls/checkbox.png)

## <a name="check-box-properties"></a>Kontrollkästchen Eigenschaften

Das Menüband-Framework definiert eine Auflistung von [Eigenschafts Schlüsseln](windowsribbon-reference-properties.md) für das Kontrollkästchen-Steuerelement.

In der Regel wird eine Kontrollkästchen Eigenschaft in der Menüband-Benutzeroberfläche aktualisiert, indem der Befehl, der dem Steuerelement zugeordnet ist, durch einen Rückruf der [**iuiframework:: invalidateuicommand**](/windows/desktop/api/uiribbon/nf-uiribbon-iuiframework-invalidateuicommand) -Methode ungültig gemacht wird. Das Invalidierung-Ereignis wird durch die [**iuicommandhandler:: updateproperty**](/windows/desktop/api/uiribbon/nf-uiribbon-iuicommandhandler-updateproperty) -Rückruf Methode behandelt und die Eigenschaften Updates definiert.
...
In der folgenden Tabelle werden die Eigenschaften Schlüssel aufgelistet, die dem Kontrollkästchen-Steuerelement zugeordnet sind.
