...
---
# <a name="how-to-create-a-client-side-proxy-ui-automation-provider"></a><span data-ttu-id="69061-103">Erstellen eines Benutzeroberflächenautomatisierungs-Anbieters für Client-Side (Proxy)</span><span class="sxs-lookup"><span data-stu-id="69061-103">How to Create a Client-Side (Proxy) UI Automation Provider</span></span>

<span data-ttu-id="69061-104">Dieses Thema enthält Beispielcode, der zeigt, wie ein Client seitiger Microsoft UI Automation-Anbieter implementiert wird.</span><span class="sxs-lookup"><span data-stu-id="69061-104">This topic contains example code that shows how to implement a client-side, or proxy, Microsoft UI Automation provider.</span></span>

-   [<span data-ttu-id="69061-105">Beispiel 1: Auflisten der proxyfactory-Tabelle</span><span class="sxs-lookup"><span data-stu-id="69061-105">Example 1: Enumerating the Proxy Factory Table</span></span>](#example-1-enumerating-the-proxy-factory-table)
-   [<span data-ttu-id="69061-106">Beispiel 2: Implementieren eines einfachen Proxys für Schaltflächen-Steuerelemente</span><span class="sxs-lookup"><span data-stu-id="69061-106">Example 2: Implementing a Simple Proxy for Button Controls</span></span>](#example-2-implementing-a-simple-proxy-for-button-controls)
-   [<span data-ttu-id="69061-107">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="69061-107">Related topics</span></span>](#related-topics)

## <a name="example-1-enumerating-the-proxy-factory-table"></a><span data-ttu-id="69061-108">Beispiel 1: Auflisten der proxyfactory-Tabelle</span><span class="sxs-lookup"><span data-stu-id="69061-108">Example 1: Enumerating the Proxy Factory Table</span></span>

<span data-ttu-id="69061-109">Der folgende Beispielcode listet die Einträge in der proxyfactorytabelle auf und zeigt den Klassennamen des unterstützten Steuer Elements an.</span><span class="sxs-lookup"><span data-stu-id="69061-109">The following example code enumerates the entries in the proxy factory table and displays the class name of the supported control.</span></span> <span data-ttu-id="69061-110">Für Proxys, die nicht mit dem Betriebssystem bereitgestellt werden, wird der Bildname angezeigt.</span><span class="sxs-lookup"><span data-stu-id="69061-110">For proxies that are not supplied with the operating system, the image name is displayed.</span></span>
...
## <a name="example-2-implementing-a-simple-proxy-for-button-controls"></a><span data-ttu-id="69061-111">Beispiel 2: Implementieren eines einfachen Proxys für Schaltflächen-Steuerelemente</span><span class="sxs-lookup"><span data-stu-id="69061-111">Example 2: Implementing a Simple Proxy for Button Controls</span></span>

<span data-ttu-id="69061-112">Der folgende Beispielcode implementiert einen einfachen Proxy für Steuerelemente, die den Klassennamen "Button" aufweisen, und fügt der proxyfactorytabelle einen Eintrag für den Proxy hinzu.</span><span class="sxs-lookup"><span data-stu-id="69061-112">The following example code implements a simple proxy for controls that have the "Button" class name, and adds an entry for the proxy to the proxy factory table.</span></span> <span data-ttu-id="69061-113">In diesem Beispiel wird das Dialogfeld Schriftart von Editor verwendet, um den Proxy zu veranschaulichen.</span><span class="sxs-lookup"><span data-stu-id="69061-113">This example uses the Font dialog box of Notepad to demonstrate the proxy.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="69061-114">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="69061-114">Related topics</span></span>

<dl> <dt>

<span data-ttu-id="69061-115">**Licher**</span><span class="sxs-lookup"><span data-stu-id="69061-115">**Conceptual**</span></span>
</dt> <dt>

[<span data-ttu-id="69061-116">Implementieren eines Client-Side Benutzeroberflächenautomatisierungs-Anbieters</span><span class="sxs-lookup"><span data-stu-id="69061-116">Implementing a Client-Side UI Automation Provider</span></span>](uiauto-serversideprovider.md)
</dt> <dt>

[<span data-ttu-id="69061-117">Gewusst-wie-Themen für Benutzeroberflächenautomatisierungs-Anbieter</span><span class="sxs-lookup"><span data-stu-id="69061-117">How-To Topics for UI Automation Providers</span></span>](uiauto-howto-topics-for-uiautomation-providers.md)
</dt> </dl>
