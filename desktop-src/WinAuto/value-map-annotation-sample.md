---
title: Beispiel für eine wertmap-Anmerkung
description: Beispiel für eine wertmap-Anmerkung
...
ms.locfileid: "106337354"
---
# <a name="value-map-annotation-sample"></a><span data-ttu-id="7b0fb-103">Beispiel für eine wertmap-Anmerkung</span><span class="sxs-lookup"><span data-stu-id="7b0fb-103">Value Map Annotation Sample</span></span>

<span data-ttu-id="7b0fb-104">Schneiden, einfügen und ändern Sie das folgende Codebeispiel für Ihre eigene Verwendung.</span><span class="sxs-lookup"><span data-stu-id="7b0fb-104">Cut, paste, and modify the following code sample for your own use.</span></span> <span data-ttu-id="7b0fb-105">Befolgen Sie die Anweisungen in Kommentaren, die mit/ \* TODO/markiert sind \* .</span><span class="sxs-lookup"><span data-stu-id="7b0fb-105">Follow instructions in comments marked with /\* TODO \*/.</span></span>
