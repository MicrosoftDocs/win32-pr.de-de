...
---
# <a name="how-to-retrieve-a-virtualized-item"></a>Abrufen eines virtualisierten Elements

Dieses Thema enthält Beispielcode, in dem gezeigt wird, wie Sie Benutzeroberflächen Informationen zu virtualisierten Elementen in einem-Steuerelement suchen und abrufen können.


Im folgenden Beispiel wird ein Container nach einem Element durchsucht, das über den angegebenen Namen verfügt und die [**iuiautomationelement**](/windows/desktop/api/UIAutomationClient/nn-uiautomationclient-iuiautomationelement) -Schnittstelle für das Element abruft. Das Beispiel sucht zuerst in der Benutzeroberflächenautomatisierungs-Unterstruktur. Wenn das Element nicht vorhanden ist, wird im Beispiel die [**iuiautomationitemcontainerpattern**](/windows/desktop/api/UIAutomationClient/nn-uiautomationclient-iuiautomationitemcontainerpattern) -Container-Schnittstelle verwendet, um das Element zu suchen, und dann wird das Element mit der [**iuiautomationvirtualizeditempattern**](/windows/desktop/api/UIAutomationClient/nn-uiautomationclient-iuiautomationvirtualizeditempattern) -Schnittstelle erkannt.
