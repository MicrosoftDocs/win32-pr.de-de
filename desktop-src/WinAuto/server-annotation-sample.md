...
---
# <a name="server-annotation-sample"></a>Beispiel für eine Server Anmerkung

Im folgenden finden Sie ein Beispiel für eine Server Anmerkung. Befolgen Sie die Anweisungen in Kommentaren, die mit/ \* TODO/markiert sind \* .
