---
title: Beispiel für eine Server Anmerkung
description: Beispiel für eine Server Anmerkung
...
ms.locfileid: "106342246"
---
# <a name="server-annotation-sample"></a><span data-ttu-id="d4939-103">Beispiel für eine Server Anmerkung</span><span class="sxs-lookup"><span data-stu-id="d4939-103">Server Annotation Sample</span></span>

<span data-ttu-id="d4939-104">Im folgenden finden Sie ein Beispiel für eine Server Anmerkung.</span><span class="sxs-lookup"><span data-stu-id="d4939-104">The following is an example of server annotation.</span></span> <span data-ttu-id="d4939-105">Befolgen Sie die Anweisungen in Kommentaren, die mit/ \* TODO/markiert sind \* .</span><span class="sxs-lookup"><span data-stu-id="d4939-105">Follow instructions in comments marked with /\* TODO \*/.</span></span>
