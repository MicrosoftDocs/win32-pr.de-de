...
description: Microsoft Active Accessibility verbessert die Art und Weise, wie Barrierefreiheitshilfsprogramme (spezielle Programme, die Menschen mit Behinderungen dabei unterstützen, Computer effektiver zu verwenden) mit Anwendungen arbeiten, die auf Microsoft Windows.
...
Microsoft Active Accessibility verbessert die Art und Weise, wie Barrierefreiheitshilfsprogramme (spezielle Programme, die Menschen mit Behinderungen dabei unterstützen, Computer effektiver zu verwenden) mit Anwendungen arbeiten, die auf Microsoft Windows.
...
-   Die COM-Schnittstelle [**IAccessible**](/windows/desktop/api/oleacc/nn-oleacc-iaccessible), die Informationen zu Benutzeroberflächenelementen verfügbar macht. **IAccessible** verfügt auch über Eigenschaften und Methoden zum Abrufen von Informationen zu diesem Benutzeroberflächenelement und zum Bearbeiten dieses Benutzeroberflächenelements.
...
-   Funktionen, mit denen [](/windows/desktop/api/oleacc/nn-oleacc-iaccessible) Server einen IAccessible-Schnittstellenzeiger auf einen Client zurückgeben können (z. [**B. LresultFromObject**](/windows/desktop/api/Oleacc/nf-oleacc-lresultfromobject)).
...
-   Code, der die Standardimplementierung von [**IAccessible für**](/windows/desktop/api/oleacc/nn-oleacc-iaccessible) STANDARDMÄßIGE USER- und COMCTL-Steuerelemente bietet. Da diese **IAccessible im** Namen der Systemsteuerelemente implementieren, werden sie als *Proxys bezeichnet.*

## <a name="in-this-section"></a>In diesem Abschnitt

-   [Funktionsweise Active Accessibility](how-active-accessibility-works.md)
