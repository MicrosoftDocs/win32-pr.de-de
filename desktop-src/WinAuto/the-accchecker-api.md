...
---
# <a name="the-accchecker-api"></a>Die accchecker-API

Die accchecker-API unterstützt automatisierte Tests. Nachdem Sie eine Anwendung mithilfe von manuellen Tests mit der Benutzeroberfläche für die Zugriffs Prüfung getestet haben, können Sie automatisierte Tests schreiben, die die mit dem GUI-Tool erstellten Nachrichten-und Unterdrückungs Protokolle enthalten.

Im folgenden Codebeispiel wird veranschaulicht, wie die accesschecker-API verwendet wird, um die Tabstopps-Funktionalität in der System Steuerungsanwendung der Windows-Firewall zu testen.
