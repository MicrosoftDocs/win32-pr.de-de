...
---
# <a name="dns-wmi-provider-samplesmanaging-dns-resource-records"></a><span data-ttu-id="07fff-103">Beispiele für DNS-WMI-Anbieter – Verwalten von DNS-Ressourcen Einträgen</span><span class="sxs-lookup"><span data-stu-id="07fff-103">DNS WMI Provider Samples—Managing DNS Resource Records</span></span>

<span data-ttu-id="07fff-104">Dieser Abschnitt veranschaulicht Skript Tasks, die mit der Verwaltung von DNS-Ressourcen Einträgen verknüpft sind.</span><span class="sxs-lookup"><span data-stu-id="07fff-104">This section demonstrates scripting tasks associated with managing DNS resource records.</span></span> <span data-ttu-id="07fff-105">Die Links unten springen zu Unterroutinen in der Skriptdatei.</span><span class="sxs-lookup"><span data-stu-id="07fff-105">The links below jump to subroutines in the script file.</span></span>

-   [<span data-ttu-id="07fff-106">Auflisten von Ressourcen Einträgen</span><span class="sxs-lookup"><span data-stu-id="07fff-106">List resource records</span></span>](#list-resource-records)
-   [<span data-ttu-id="07fff-107">Hinzufügen eines Ressourcen Datensatzes</span><span class="sxs-lookup"><span data-stu-id="07fff-107">Add a resource record</span></span>](#add-a-resource-record)
-   [<span data-ttu-id="07fff-108">Löschen eines Ressourcen Datensatzes</span><span class="sxs-lookup"><span data-stu-id="07fff-108">Delete a resource record</span></span>](#delete-a-resource-record)
-   [<span data-ttu-id="07fff-109">Ändern eines Ressourcen Datensatzes</span><span class="sxs-lookup"><span data-stu-id="07fff-109">Modify a resource record</span></span>](#modify-a-resource-record)
-   [<span data-ttu-id="07fff-110">Herstellen einer Verbindung mit dem DNS-WMI-Anbieter</span><span class="sxs-lookup"><span data-stu-id="07fff-110">Connect to the DNS WMI Provider</span></span>](#connect-to-the-dns-wmi-provider)

<span data-ttu-id="07fff-111">Die allgemeine Implementierung des Skripts lautet wie folgt:</span><span class="sxs-lookup"><span data-stu-id="07fff-111">The general implementation of the script is as follows:</span></span>

1.  <span data-ttu-id="07fff-112">Eine Klasse wird für jeden Ressourcen Daten Satz Typen erstellt.</span><span class="sxs-lookup"><span data-stu-id="07fff-112">A class is created for each resource record type.</span></span>
2.  <span data-ttu-id="07fff-113">Ressourcen Daten Satz Daten werden über Benutzer Befehlszeilen Eingaben und DNS-WMI-Anbieter Informationen für jede Daten Satz Klasse bereitgestellt.</span><span class="sxs-lookup"><span data-stu-id="07fff-113">Resource record data is provided through user command-line inputs and DNS WMI Provider information for each record type class.</span></span>
3.  <span data-ttu-id="07fff-114">Allgemeine Funktionen, wie z. b. List, DELETE und Modify, werden erstellt und können für einzelne Klassen von Ressourcen Daten Satz Typen verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="07fff-114">Common functions such as list, delete, and modify are created and can be used on individual resource record type classes.</span></span>

<span data-ttu-id="07fff-115">Dieses Codebeispiel zeigt Aufgaben, die mit der Verwaltung von DNS-Ressourcen Einträgen verknüpft sind.</span><span class="sxs-lookup"><span data-stu-id="07fff-115">This code example shows tasks associated with Managing DNS resource records.</span></span>
...
## <a name="list-resource-records"></a><span data-ttu-id="07fff-116">Auflisten von Ressourcen Einträgen</span><span class="sxs-lookup"><span data-stu-id="07fff-116">List Resource Records</span></span>

<span data-ttu-id="07fff-117">Dieses Codebeispiel zeigt Aufgaben, die dem Auflisten von Ressourcen Datensätzen zugeordnet sind.</span><span class="sxs-lookup"><span data-stu-id="07fff-117">This code example shows tasks associated with listing resource records.</span></span>
...
## <a name="add-a-resource-record"></a><span data-ttu-id="07fff-118">Hinzufügen eines Ressourcen Datensatzes</span><span class="sxs-lookup"><span data-stu-id="07fff-118">Add a Resource Record</span></span>

<span data-ttu-id="07fff-119">Dieses Codebeispiel zeigt Aufgaben, die dem Hinzufügen von Ressourcen Einträgen zugeordnet sind.</span><span class="sxs-lookup"><span data-stu-id="07fff-119">This code example shows tasks associated with adding resource records.</span></span>
...
## <a name="delete-a-resource-record"></a><span data-ttu-id="07fff-120">Löschen eines Ressourcen Datensatzes</span><span class="sxs-lookup"><span data-stu-id="07fff-120">Delete a Resource Record</span></span>

<span data-ttu-id="07fff-121">Dieses Codebeispiel zeigt Aufgaben, die mit dem Löschen von Ressourcen Einträgen verknüpft sind.</span><span class="sxs-lookup"><span data-stu-id="07fff-121">This code example shows tasks associated with deleting resource records.</span></span>
...
## <a name="modify-a-resource-record"></a><span data-ttu-id="07fff-122">Ändern eines Ressourcen Datensatzes</span><span class="sxs-lookup"><span data-stu-id="07fff-122">Modify a Resource Record</span></span>

<span data-ttu-id="07fff-123">Dieses Codebeispiel zeigt Aufgaben, die mit dem Ändern von Ressourcen Einträgen verknüpft sind.</span><span class="sxs-lookup"><span data-stu-id="07fff-123">This code example shows tasks associated with changing resource records.</span></span>
...
## <a name="connect-to-the-dns-wmi-provider"></a><span data-ttu-id="07fff-124">Herstellen einer Verbindung mit dem DNS-WMI-Anbieter</span><span class="sxs-lookup"><span data-stu-id="07fff-124">Connect to the DNS WMI Provider</span></span>

<span data-ttu-id="07fff-125">Dieses Codebeispiel zeigt Aufgaben im Zusammenhang mit dem Herstellen einer Verbindung mit einem DNS-WMI-Anbieter.</span><span class="sxs-lookup"><span data-stu-id="07fff-125">This code example shows tasks associated with connecting to a DNS WMI Provider.</span></span>
