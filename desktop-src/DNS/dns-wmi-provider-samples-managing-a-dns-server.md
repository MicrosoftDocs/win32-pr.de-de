...
---
# <a name="dns-wmi-provider-samplesmanaging-a-dns-server"></a><span data-ttu-id="2db95-103">Beispiele für DNS-WMI-Anbieter – Verwalten eines DNS-Servers</span><span class="sxs-lookup"><span data-stu-id="2db95-103">DNS WMI Provider Samples—Managing a DNS Server</span></span>

> [!NOTE]
> <span data-ttu-id="2db95-104">Dieser Artikel enthält Verweise auf den Begriff Slave, einen Begriff, den Microsoft nicht mehr verwendet.</span><span class="sxs-lookup"><span data-stu-id="2db95-104">This article contains references to the term slave, a term that Microsoft no longer uses.</span></span> <span data-ttu-id="2db95-105">Sobald der Begriff aus der Software entfernt wird, wird er auch aus diesem Artikel entfernt.</span><span class="sxs-lookup"><span data-stu-id="2db95-105">When the term is removed from the software, we’ll remove it from this article.</span></span>

<span data-ttu-id="2db95-106">In diesem Abschnitt werden Skript Tasks im Zusammenhang mit der Verwaltung eines DNS-Servers veranschaulicht.</span><span class="sxs-lookup"><span data-stu-id="2db95-106">This section demonstrates scripting tasks associated with managing a DNS Server.</span></span> <span data-ttu-id="2db95-107">Die folgenden Links springen zu Unterroutinen in der Skriptdatei:</span><span class="sxs-lookup"><span data-stu-id="2db95-107">The links below jump to subroutines in the script file:</span></span>

-   [<span data-ttu-id="2db95-108">Auflisten von DNS-Server Eigenschaften</span><span class="sxs-lookup"><span data-stu-id="2db95-108">List DNS Server properties</span></span>](#list-dns-server-properties)
-   [<span data-ttu-id="2db95-109">Einen DNS-Server starten, starten oder neu starten</span><span class="sxs-lookup"><span data-stu-id="2db95-109">Stop, start, or restart a DNS Server</span></span>](#stop-start-or-restart-a-dns-server)
-   [<span data-ttu-id="2db95-110">Ändern der DNS-Server Eigenschaften</span><span class="sxs-lookup"><span data-stu-id="2db95-110">Modify DNS Server properties</span></span>](#modify-dns-server-properties)
-   [<span data-ttu-id="2db95-111">IP-Adresse hinzufügen</span><span class="sxs-lookup"><span data-stu-id="2db95-111">Add an IP address</span></span>](#add-an-ip-address)
-   [<span data-ttu-id="2db95-112">Löschen einer IP-Adresse</span><span class="sxs-lookup"><span data-stu-id="2db95-112">Delete an IP address</span></span>](#delete-an-ip-address)
-   [<span data-ttu-id="2db95-113">Auflisten von Zonen</span><span class="sxs-lookup"><span data-stu-id="2db95-113">List Zones</span></span>](#list-zones)
...
## <a name="list-dns-server-properties"></a><span data-ttu-id="2db95-114">Auflisten von DNS-Server Eigenschaften</span><span class="sxs-lookup"><span data-stu-id="2db95-114">List DNS Server properties</span></span>
...
## <a name="stop-start-or-restart-a-dns-server"></a><span data-ttu-id="2db95-115">Einen DNS-Server starten, starten oder neu starten</span><span class="sxs-lookup"><span data-stu-id="2db95-115">Stop, Start, or Restart a DNS Server</span></span>
...
## <a name="modify-dns-server-properties"></a><span data-ttu-id="2db95-116">Ändern der DNS-Server Eigenschaften</span><span class="sxs-lookup"><span data-stu-id="2db95-116">Modify DNS Server Properties</span></span>
...
## <a name="add-an-ip-address"></a><span data-ttu-id="2db95-117">IP-Adresse hinzufügen</span><span class="sxs-lookup"><span data-stu-id="2db95-117">Add an IP Address</span></span>
...
## <a name="delete-an-ip-address"></a><span data-ttu-id="2db95-118">Löschen einer IP-Adresse</span><span class="sxs-lookup"><span data-stu-id="2db95-118">Delete an IP Address</span></span>
...
## <a name="list-zones"></a><span data-ttu-id="2db95-119">Auflisten von Zonen</span><span class="sxs-lookup"><span data-stu-id="2db95-119">List Zones</span></span>
