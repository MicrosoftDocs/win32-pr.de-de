...
## <a name="modify-a-dns-zone"></a>Ändern einer DNS-Zone
...
## <a name="delete-a-zone-ip-address"></a>Löschen einer Zonen-IP-Adresse
...
## <a name="pause-a-zone"></a>Hält eine Zone an
...
## <a name="resume-a-zone"></a>Nimmt eine Zone wieder auf
...
## <a name="update-a-zone"></a>Führt eine Zonenaktualisierung aus
...
## <a name="reload-a-zone"></a>Lädt eine Zone neu
...
## <a name="refresh-a-zone"></a>Aktualisiert eine Zone
