...
---
# <a name="dns-wmi-provider-samplesmanaging-dns-zones"></a><span data-ttu-id="1bedb-104">DNS-WMI-Anbieter Beispiele – Verwalten von DNS-Zonen</span><span class="sxs-lookup"><span data-stu-id="1bedb-104">DNS WMI Provider Samples—Managing DNS Zones</span></span>

<span data-ttu-id="1bedb-105">In diesem Abschnitt werden Skript Tasks für die Verwaltung von DNS-Zonen veranschaulicht.</span><span class="sxs-lookup"><span data-stu-id="1bedb-105">This section demonstrates scripting tasks associated with managing DNS zones.</span></span> <span data-ttu-id="1bedb-106">Die folgenden Links verknüpfen mit Unterroutinen in der Skriptdatei.</span><span class="sxs-lookup"><span data-stu-id="1bedb-106">The following links link to subroutines in the script file.</span></span>

-   [<span data-ttu-id="1bedb-107">Erstellen einer DNS-Zone</span><span class="sxs-lookup"><span data-stu-id="1bedb-107">Create a DNS zone</span></span>](#create-a-dns-zone)
-   [<span data-ttu-id="1bedb-108">Ändern einer DNS-Zone</span><span class="sxs-lookup"><span data-stu-id="1bedb-108">Modify a DNS zone</span></span>](#modify-a-dns-zone)
-   [<span data-ttu-id="1bedb-109">Löschen einer DNS-Zone</span><span class="sxs-lookup"><span data-stu-id="1bedb-109">Delete a DNS zone</span></span>](#delete-a-dns-zone)
-   [<span data-ttu-id="1bedb-110">IP-Adresse für Zone hinzufügen</span><span class="sxs-lookup"><span data-stu-id="1bedb-110">Add a zone IP address</span></span>](#add-a-zone-ip-address)
-   [<span data-ttu-id="1bedb-111">Löschen einer Zonen-IP-Adresse</span><span class="sxs-lookup"><span data-stu-id="1bedb-111">Delete a zone IP address</span></span>](#delete-a-zone-ip-address)
-   [<span data-ttu-id="1bedb-112">Anhalten einer Zone</span><span class="sxs-lookup"><span data-stu-id="1bedb-112">Pause a zone</span></span>](#pause-a-zone)
-   [<span data-ttu-id="1bedb-113">Fortsetzen einer Zone</span><span class="sxs-lookup"><span data-stu-id="1bedb-113">Resume a zone</span></span>](#resume-a-zone)
-   [<span data-ttu-id="1bedb-114">Aktualisieren einer Zone</span><span class="sxs-lookup"><span data-stu-id="1bedb-114">Update a zone</span></span>](#update-a-zone)
-   [<span data-ttu-id="1bedb-115">Erneutes Laden einer Zone</span><span class="sxs-lookup"><span data-stu-id="1bedb-115">Reload a zone</span></span>](#reload-a-zone)
-   [<span data-ttu-id="1bedb-116">Zone aktualisieren</span><span class="sxs-lookup"><span data-stu-id="1bedb-116">Refresh a zone</span></span>](#refresh-a-zone)
...
## <a name="create-a-dns-zone"></a><span data-ttu-id="1bedb-117">Erstellen einer DNS-Zone</span><span class="sxs-lookup"><span data-stu-id="1bedb-117">Create a DNS Zone</span></span>
...
## <a name="modify-a-dns-zone"></a><span data-ttu-id="1bedb-118">Ändern einer DNS-Zone</span><span class="sxs-lookup"><span data-stu-id="1bedb-118">Modify a DNS Zone</span></span>
...
## <a name="delete-a-dns-zone"></a><span data-ttu-id="1bedb-119">Löschen einer DNS-Zone</span><span class="sxs-lookup"><span data-stu-id="1bedb-119">Delete a DNS Zone</span></span>
...
## <a name="add-a-zone-ip-address"></a><span data-ttu-id="1bedb-120">IP-Adresse für Zone hinzufügen</span><span class="sxs-lookup"><span data-stu-id="1bedb-120">Add a Zone IP Address</span></span>
...
## <a name="delete-a-zone-ip-address"></a><span data-ttu-id="1bedb-121">Löschen einer Zonen-IP-Adresse</span><span class="sxs-lookup"><span data-stu-id="1bedb-121">Delete a Zone IP Address</span></span>
...
## <a name="pause-a-zone"></a><span data-ttu-id="1bedb-122">Hält eine Zone an</span><span class="sxs-lookup"><span data-stu-id="1bedb-122">Pause a Zone</span></span>
...
## <a name="resume-a-zone"></a><span data-ttu-id="1bedb-123">Nimmt eine Zone wieder auf</span><span class="sxs-lookup"><span data-stu-id="1bedb-123">Resume a Zone</span></span>
...
## <a name="update-a-zone"></a><span data-ttu-id="1bedb-124">Führt eine Zonenaktualisierung aus</span><span class="sxs-lookup"><span data-stu-id="1bedb-124">Update a Zone</span></span>
...
## <a name="reload-a-zone"></a><span data-ttu-id="1bedb-125">Lädt eine Zone neu</span><span class="sxs-lookup"><span data-stu-id="1bedb-125">Reload a Zone</span></span>
...
## <a name="refresh-a-zone"></a><span data-ttu-id="1bedb-126">Aktualisiert eine Zone</span><span class="sxs-lookup"><span data-stu-id="1bedb-126">Refresh a Zone</span></span>
