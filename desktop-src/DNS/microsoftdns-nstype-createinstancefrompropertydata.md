...
---
# <a name="createinstancefrompropertydata-method-of-the-microsoftdns_nstype-class"></a>Methode "kreateinzustancefrompropertydata" der MicrosoftDNS- \_ nstype-Klasse

Die Methode " **kreateinstancefrompropertydata** " instanziiert einen Namen Server-Ressourcen Eintrag (NS).
