...
| [Shader-Strukturen](d3d11-graphics-reference-shader-structures.md)<br/>       | Strukturen werden verwendet, um Shader zu erstellen und zu verwenden.<br/>                 |
| [Shader-Enumerationen](d3d11-graphics-reference-shader-enums.md)<br/>          | Enumerationen werden verwendet, um Informationen zu Shadern anzugeben.<br/>    |
