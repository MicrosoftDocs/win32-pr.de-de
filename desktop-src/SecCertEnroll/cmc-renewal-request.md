...
---
# <a name="cmc-renewal-request"></a><span data-ttu-id="66362-105">CMC-Erneuerungs Anforderung</span><span class="sxs-lookup"><span data-stu-id="66362-105">CMC Renewal Request</span></span>

<span data-ttu-id="66362-106">Das folgende Beispiel enthält eine CMC-Erneuerungs Anforderung.</span><span class="sxs-lookup"><span data-stu-id="66362-106">The following example contains a CMC renewal request.</span></span> <span data-ttu-id="66362-107">Das Beispiel wurde mithilfe der Tools Certreq.exe und Certutil.exe generiert.</span><span class="sxs-lookup"><span data-stu-id="66362-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="66362-108">Die INF-Datei, die als Eingabe für Certreq.exe verwendet wird, enthält die folgende Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="66362-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="66362-109">Die Konfiguration gibt den Typ der Anforderung (CMC) und die Seriennummer des Zertifikats an, auf dem die Anforderung basiert.</span><span class="sxs-lookup"><span data-stu-id="66362-109">The configuration specifies the type of request (CMC) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="66362-110">Dadurch wird die folgende Ausgabe generiert.</span><span class="sxs-lookup"><span data-stu-id="66362-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="66362-111">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="66362-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="66362-112">Beispiel Anforderungen</span><span class="sxs-lookup"><span data-stu-id="66362-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
