...
---
# <a name="cmc-eobo-request"></a><span data-ttu-id="10088-105">CMC eobo-Anforderung</span><span class="sxs-lookup"><span data-stu-id="10088-105">CMC EOBO Request</span></span>

<span data-ttu-id="10088-106">Das folgende Beispiel enthält eine Anforderung von "CMC ENROLL on Name of (eobo)".</span><span class="sxs-lookup"><span data-stu-id="10088-106">The following example contains a CMC Enroll On Behalf Of (EOBO) request.</span></span> <span data-ttu-id="10088-107">Das Beispiel wurde mithilfe der Tools Certreq.exe und Certutil.exe generiert.</span><span class="sxs-lookup"><span data-stu-id="10088-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="10088-108">Die INF-Datei, die als Eingabe für Certreq.exe verwendet wird, enthält die folgende Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="10088-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="10088-109">Mit dieser Konfiguration wird die folgende Beispielausgabe generiert.</span><span class="sxs-lookup"><span data-stu-id="10088-109">This configuration generates the following sample output.</span></span> <span data-ttu-id="10088-110">Die Konfiguration gibt den Typ der Anforderung (Request, CMC), den Namen der Entität an, die die Registrierung anfordert, und den Namen der Vorlage.</span><span class="sxs-lookup"><span data-stu-id="10088-110">The configuration specifies the type of request (CMC), the name of the entity requesting the enrollment, and the name of the template.</span></span> <span data-ttu-id="10088-111">Die Benutzer Vorlage gibt Folgendes an:</span><span class="sxs-lookup"><span data-stu-id="10088-111">The User template specifies that:</span></span>

-   <span data-ttu-id="10088-112">Die Anforderung muss entweder den Kryptografieanbieter von Microsoft Base 1,0 oder den Microsoft Enhanced Cryptographic Provider 1,0 verwenden.</span><span class="sxs-lookup"><span data-stu-id="10088-112">The request must use either the Microsoft Base Cryptographic Provider 1.0 or the Microsoft Enhanced Cryptographic Provider 1.0.</span></span>
-   <span data-ttu-id="10088-113">Der Antragsteller Name muss aus Active Directory erstellt werden.</span><span class="sxs-lookup"><span data-stu-id="10088-113">The subject name must be built from Active Directory.</span></span>
-   <span data-ttu-id="10088-114">Die Anforderung enthält den Namen der Zertifikat Vorlage, die erweiterte Schlüssel Verwendung (Enhanced Key Usage, EKU) und Schlüssel Verwendungs Erweiterungen.</span><span class="sxs-lookup"><span data-stu-id="10088-114">The request includes the Certificate Template Name, Enhanced Key Usage (EKU), and Key Usage extensions.</span></span> <span data-ttu-id="10088-115">Die EKU-Erweiterung gibt an, dass das ausgestellte Zertifikat für Verschlüsselndes Dateisystem (EFS), sichere e-Mail und Client Authentifizierung verwendet werden kann.</span><span class="sxs-lookup"><span data-stu-id="10088-115">The EKU extension specifies that the issued certificate can be used for Encrypting File System (EFS), secure email, and client authentication.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="10088-116">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="10088-116">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="10088-117">Beispiel Anforderungen</span><span class="sxs-lookup"><span data-stu-id="10088-117">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
