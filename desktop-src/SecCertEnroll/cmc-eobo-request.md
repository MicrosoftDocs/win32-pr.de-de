---
description: Das folgende Beispiel enthält eine Anforderung von "CMC ENROLL on Name of (eobo)". Das Beispiel wurde mithilfe der Tools Certreq.exe und Certutil.exe generiert. Die INF-Datei, die als Eingabe für Certreq.exe verwendet wird, enthält die folgende Konfiguration.
ms.assetid: 05ec0b2c-56a5-4d9c-999b-23324134153b
title: CMC eobo-Anforderung
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103758070"
---
# <a name="cmc-eobo-request"></a>CMC eobo-Anforderung

Das folgende Beispiel enthält eine Anforderung von "CMC ENROLL on Name of (eobo)". Das Beispiel wurde mithilfe der Tools Certreq.exe und Certutil.exe generiert. Die INF-Datei, die als Eingabe für Certreq.exe verwendet wird, enthält die folgende Konfiguration.
