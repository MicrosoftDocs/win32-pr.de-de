...
---
# <a name="cmc-eobo-encoded-asn1"></a><span data-ttu-id="2f129-105">CMC eobo-codierte ASN. 1</span><span class="sxs-lookup"><span data-stu-id="2f129-105">CMC EOBO Encoded ASN.1</span></span>

<span data-ttu-id="2f129-106">Das folgende Beispiel enthält eine im ASN. 1-Format angezeigte Anforderung von "CMC ENROLL für Auftrag (eobo)".</span><span class="sxs-lookup"><span data-stu-id="2f129-106">The following example contains a CMC Enroll On Behalf Of (EOBO) request shown in ASN.1 format.</span></span> <span data-ttu-id="2f129-107">Das Beispiel wurde mithilfe der Tools Certreq.exe und Certutil.exe generiert.</span><span class="sxs-lookup"><span data-stu-id="2f129-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="2f129-108">Die INF-Datei, die als Eingabe für Certreq.exe verwendet wird, enthält die folgende Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="2f129-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="2f129-109">Mit dieser Konfiguration wird die folgende Beispielausgabe generiert.</span><span class="sxs-lookup"><span data-stu-id="2f129-109">This configuration generates the following sample output.</span></span> <span data-ttu-id="2f129-110">Die Konfiguration gibt den Typ der Anforderung (Request, CMC), den Namen der Entität an, die die Registrierung anfordert, und den Namen der Vorlage.</span><span class="sxs-lookup"><span data-stu-id="2f129-110">The configuration specifies the type of request (CMC), the name of the entity requesting the enrollment, and the name of the template.</span></span> <span data-ttu-id="2f129-111">Die Benutzer Vorlage gibt Folgendes an:</span><span class="sxs-lookup"><span data-stu-id="2f129-111">The User template specifies that:</span></span>

-   <span data-ttu-id="2f129-112">Die Anforderung muss entweder den Kryptografieanbieter von Microsoft Base 1,0 oder den Microsoft Enhanced Cryptographic Provider 1,0 verwenden.</span><span class="sxs-lookup"><span data-stu-id="2f129-112">The request must use either the Microsoft Base Cryptographic Provider 1.0 or the Microsoft Enhanced Cryptographic Provider 1.0.</span></span>
-   <span data-ttu-id="2f129-113">Der Antragsteller Name muss aus Active Directory erstellt werden.</span><span class="sxs-lookup"><span data-stu-id="2f129-113">The subject name must be built from Active Directory.</span></span>
-   <span data-ttu-id="2f129-114">Die Anforderung enthält den Namen der Zertifikat Vorlage, die erweiterte Schlüssel Verwendung (Enhanced Key Usage, EKU) und Schlüssel Verwendungs Erweiterungen.</span><span class="sxs-lookup"><span data-stu-id="2f129-114">The request includes the Certificate Template Name, Enhanced Key Usage (EKU), and Key Usage extensions.</span></span> <span data-ttu-id="2f129-115">Die EKU-Erweiterung gibt an, dass das ausgestellte Zertifikat für Verschlüsselndes Dateisystem (EFS), sichere e-Mail und Client Authentifizierung verwendet werden kann.</span><span class="sxs-lookup"><span data-stu-id="2f129-115">The EKU extension specifies that the issued certificate can be used for Encrypting File System (EFS), secure email, and client authentication.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="2f129-116">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="2f129-116">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="2f129-117">Beispiel Anforderungen</span><span class="sxs-lookup"><span data-stu-id="2f129-117">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
