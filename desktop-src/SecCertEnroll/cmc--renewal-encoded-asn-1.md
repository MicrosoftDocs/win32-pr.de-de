...
---
# <a name="cmc-renewal-encoded-asn1"></a><span data-ttu-id="1aac1-105">Mit der CMC-Erneuerung codierte ASN. 1</span><span class="sxs-lookup"><span data-stu-id="1aac1-105">CMC Renewal Encoded ASN.1</span></span>

<span data-ttu-id="1aac1-106">Das folgende Beispiel enthält eine CMC-Erneuerungs Anforderung, die im ASN. 1-Format angezeigt wird.</span><span class="sxs-lookup"><span data-stu-id="1aac1-106">The following example contains a CMC renewal request shown in ASN.1 format.</span></span> <span data-ttu-id="1aac1-107">Das Beispiel wurde mithilfe der Tools Certreq.exe und Certutil.exe generiert.</span><span class="sxs-lookup"><span data-stu-id="1aac1-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="1aac1-108">Die INF-Datei, die als Eingabe für Certreq.exe verwendet wird, enthält die folgende Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="1aac1-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="1aac1-109">Die Konfiguration gibt den Typ der Anforderung (CMC) und die Seriennummer des Zertifikats an, auf dem die Anforderung basiert.</span><span class="sxs-lookup"><span data-stu-id="1aac1-109">The configuration specifies the type of request (CMC) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="1aac1-110">Dadurch wird die folgende Ausgabe generiert.</span><span class="sxs-lookup"><span data-stu-id="1aac1-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="1aac1-111">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="1aac1-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="1aac1-112">Beispiel Anforderungen</span><span class="sxs-lookup"><span data-stu-id="1aac1-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
