...
---
# <a name="key-generation-encoded-asn1"></a><span data-ttu-id="ef9c2-103">Schlüsselgenerierung: codierte ASN. 1</span><span class="sxs-lookup"><span data-stu-id="ef9c2-103">Key Generation Encoded ASN.1</span></span>

<span data-ttu-id="ef9c2-104">Das folgende Beispiel enthält eine Schlüssel Generierungs Anforderung, die im ASN. 1-Format angezeigt wird.</span><span class="sxs-lookup"><span data-stu-id="ef9c2-104">The following example contains a key generation request shown in ASN.1 format.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="ef9c2-105">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="ef9c2-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="ef9c2-106">Beispiel Anforderungen</span><span class="sxs-lookup"><span data-stu-id="ef9c2-106">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
