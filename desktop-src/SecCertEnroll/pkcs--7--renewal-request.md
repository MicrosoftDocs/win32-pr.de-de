...
---
# <a name="pkcs-7-renewal-request"></a><span data-ttu-id="54efb-105">PKCS \# 7-Erneuerungs Anforderung</span><span class="sxs-lookup"><span data-stu-id="54efb-105">PKCS \#7 Renewal Request</span></span>

<span data-ttu-id="54efb-106">Das folgende Beispiel enthält eine PKCS \# 7-Erneuerungs Anforderung.</span><span class="sxs-lookup"><span data-stu-id="54efb-106">The following example contains a PKCS \#7 renewal request.</span></span> <span data-ttu-id="54efb-107">Das Beispiel wurde mithilfe der Tools Certreq.exe und Certutil.exe generiert.</span><span class="sxs-lookup"><span data-stu-id="54efb-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="54efb-108">Die INF-Datei, die als Eingabe für Certreq.exe verwendet wird, enthält die folgende Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="54efb-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="54efb-109">Die Konfiguration gibt den Typ der Anforderung (PKCS \# 7) und die Seriennummer des Zertifikats an, auf dem die Anforderung basiert.</span><span class="sxs-lookup"><span data-stu-id="54efb-109">The configuration specifies the type of request (PKCS \#7) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="54efb-110">Dadurch wird die folgende Ausgabe generiert.</span><span class="sxs-lookup"><span data-stu-id="54efb-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="54efb-111">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="54efb-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="54efb-112">Beispiel Anforderungen</span><span class="sxs-lookup"><span data-stu-id="54efb-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
