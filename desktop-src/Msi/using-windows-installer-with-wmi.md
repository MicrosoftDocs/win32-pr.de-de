---
description: Der Windows Installer-Anbieter ermöglicht Windows Management Instrumentation (WMI) den Zugriff auf Informationen, die von Windows Installer-Anwendungen gesammelt wurden.
ms.assetid: ffe7b6eb-b6f5-4070-9f83-91a1e76764c6
title: Verwenden Windows Installers mit WMI
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "117804072"
---
# <a name="using-windows-installer-with-wmi"></a>Verwenden Windows Installers mit WMI

Der Windows Installer-Anbieter ermöglicht Windows Management Instrumentation (WMI) den Zugriff auf Informationen, die von Windows Installer-Anwendungen gesammelt wurden.
