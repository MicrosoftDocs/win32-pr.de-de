---
description: Die Property-Eigenschaft des SummaryInfo-Objekts legt den Wert für die angegebene Eigenschaft im Zusammenfassungsinformationsstream fest oder ruft diesen ab.
...
**Standard-Zusammenfassungseigenschafts-IDs**
...
|--------------------|-------|---------------------------------------------------|
| \_PID-WÖRTERBUCH    | 0     | Spezielles Format, nicht vom SummaryInfo-Objekt unterstützt |
| \_PID-CODEPAGE      | 1     | VT \_ I2                                            |
...
| PID \_ CREATE \_ DG   | 12    | VT \_ FILETIME                                      |
| PID \_ LASTSAVE \_ DG | 13    | VT \_ FILETIME                                      |
...
| VT \_ FILETIME   | 64    | Datum/Uhrzeit (FILETIME, konvertiert in Variant time)                                          |
| VT \_ CF         | 71    | Zwischenablageformat + Daten, nicht vom [**SummaryInfo-Objekt**](summaryinfo-object.md) behandelt |
