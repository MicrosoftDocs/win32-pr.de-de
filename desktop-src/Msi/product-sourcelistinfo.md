...
Die **SourceListInfo-Eigenschaft** des [**Product-Objekts**](product-object.md) ruft die Quellinformationseigenschaften für ein Produkt ab und legt sie fest. Diese Eigenschaft ruft [**MsiSourceListGetInfo**](/windows/desktop/api/Msi/nf-msi-msisourcelistgetinfoa) oder [**MsiSourceListSetInfo**](/windows/desktop/api/Msi/nf-msi-msisourcelistsetinfoa)auf. Dies ist eine Lese- oder Schreibeigenschaft.
...
Der Name der Quellinformationseigenschaften für ein Produkt, das abgefragt oder festgelegt werden soll. Mögliche Werte finden Sie im Abschnitt Hinweise dieses Themas.
...
| LastUsedSource   | J        | Der zuletzt verwendete Quellspeicherort für das Produkt. Wenn Sie diese Eigenschaft festlegen, stellen Sie dem Quellspeicherort "n;" für eine Netzwerkquelle oder "u;" für den URL-Typ voran. Beispiel: "n; \\ \\ scratch \\ scratch \\ MySource" und "u; https://MyServer/MyFolder/MySource ". |
| LastUsedType     | N        | "n", wenn die zuletzt verwendete Quelle ein Netzwerkspeicherort ist. "u", wenn die zuletzt verwendete Quelle ein URL-Speicherort war. "m", wenn es sich bei der zuletzt verwendeten Quelle um Medien handelt. Leere Zeichenfolge (""), wenn keine zuletzt verwendete Quelle vorhanden ist.                                                                   |
| PackageName      | J        | Der Name des Windows Installer-Pakets oder -Patchpakets auf der Quelle.                                                                                                                                                                                      |
