---
description: Wilogutl.exe unterstützt die Analyse von Protokolldateien aus einer installation Windows Installer und zeigt vorgeschlagene Lösungen für Fehler an, die in einer Protokolldatei gefunden werden.
...
**Optionen** für *\[ &lt; &gt; \] \[ <source file> \] \[ &lt;wilogutl.exe&gt; \] \[ <report file directory> \]*
...
Wilogutl.exe verwendet die folgenden Befehlszeilenoptionen, bei der die Groß-/Kleinschreibung nicht beachtet wird. Ein Bindestrichtrennzeichen kann anstelle eines Schrägstrichs verwendet werden.
...
| 3     | /q wurde übergeben, es fehlt jedoch der erforderliche Schalter /l für den Protokolldateinamen. |
| 4     | "/l" wurde übergeben, es fehlt jedoch der erforderliche Schalter /q für den stillen Modus.        |
