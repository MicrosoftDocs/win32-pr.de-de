---
description: Die Reihenfolge der Aktionsausführung wird durch die Reihenfolge der Aktionen bestimmt, die in den Sequenztabellen erstellt wurden, und durch die Reihenfolge, in der das Installationsprogramm die Sequenztabellen ausgeführt.
...
| Bedingung | Ein boolescher Ausdruck, der verwendet wird, um zu bestimmen, ob die Aktion durchzuführen ist. Die Aktion wird ausgeführt, wenn dieses Feld entweder leer ist oder einen Ausdruck enthält, der trueauswertet. Die Aktion wird nicht ausgeführt, wenn der Ausdruck falseausgewertet wird. |
