---
description: Der Windows Installer installiert Common Language Runtime-Assemblys mithilfe der Microsoft-.NET Framework.
...
Beachten Sie, dass Assemblys, die von einer Installation [](installation-context.md) im Benutzerinstallationskontext im globalen Assemblycache installiert wurden, nicht durch Windows Geschützt sind. Assemblys, die durch eine Installation im Installationskontext pro Computer im globalen Assemblycache installiert werden, werden durch Windows [Resource Protection geschützt.](../wfp/windows-resource-protection-portal.md)
