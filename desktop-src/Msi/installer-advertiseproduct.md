---
description: Die AdvertiseProduct-Methode des Installer-Objekts gibt ein Installationspaket an.
...
Die **AdvertiseProduct-Methode** des [**Installer-Objekts**](installer-object.md) gibt ein Installationspaket an.
...
| Wert                                                                                                                                                                                                                                                                                                   | Bedeutung                                                                                                                                                                                                       |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="msiAdvertiseProductMachine"></span><span id="msiadvertiseproductmachine"></span><span id="MSIADVERTISEPRODUCTMACHINE"></span><dl> <dt>**msiAdvertiseProductMachine**</dt> <dt>0</dt> </dl> | Gibt die Anwendung für eine Ininstallation im Installationskontext pro Computer [an.](installation-context.md) Dadurch wird das Paket für die Installation durch alle Benutzer des Computers verfügbar.<br/> |
| <span id="msiAdvertiseProductUser"></span><span id="msiadvertiseproductuser"></span><span id="MSIADVERTISEPRODUCTUSER"></span><dl> <dt>**msiAdvertiseProductUser**</dt> <dt>1</dt> </dl>             | Gibt die Anwendung für eine Installation im Benutzerinstallationskontext [an.](installation-context.md)<br/>                                                                                   |
