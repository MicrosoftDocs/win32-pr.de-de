...
description: Gibt die grünen Komponenten der vier Texelwerte zurück, die in einem bilinealen Filtervorgang zusammen mit dem Kachelzuordnungsstatus verwendet werden. | Texture2D::GatherGreen(S,float,int2,int2,int2,int2,uint)-Funktion
