...
description: Stichproben einer 2D-Textur mithilfe eines Farbverlaufs, um die Mipebene auszuwählen. | tex2D (HLSL-Referenz)
...
Stichproben einer 2D-Textur mithilfe eines Farbverlaufs, um die Mipebene auszuwählen.
