...
description: Gibt die Alphakomponenten der vier Texelwerte zurück, die in einem bilinealen Filtervorgang verwendet werden. | Texture2DArray::GatherAlpha(S,float,int2,int2,int2,int2)-Funktion
