---
title: Texture2D::GatherCmpRed(S,float,float,int2,int2,int2,int2,int2,uint)-Funktion
description: Für vier Texelwerte, die in einem bilinearen Filtervorgang verwendet werden, gibt einen Vergleich ihrer roten Komponente mit einem Vergleichswert zusammen mit dem Kachelzuordnungsstatus zurück. | Texture2D::GatherCmpRed(S,float,float,int2,int2,int2,int2,int2,uint)-Funktion
...
ms.locfileid: "117723987"
---
# <a name="texture2dgathercmpredsfloatfloatint2int2int2int2uint-function"></a>Texture2D::GatherCmpRed(S,float,float,int2,int2,int2,int2,int2,uint)-Funktion
