...
description: Gibt die roten Komponenten der vier Texelwerte zurück, die in einem bilinealen Filtervorgang zusammen mit dem Kachelzuordnungsstatus verwendet werden. | Texture2DArray::GatherRed(S,float,int,uint)-Funktion
...
ms.locfileid: "119276440"
---
# <a name="texture2darraygatherredsfloatintuint-function"></a>Texture2DArray::GatherRed(S,float,int,uint)-Funktion
