...
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloatuint-function-for-texture3d"></a>Samplegrad:: samplegrad (S, float, float, float, int, float, uint)-Funktion für Texture3D
