...
---
# <a name="samplebiassamplebiassfloatfloatintfloatuint-function-for-texture2d"></a>Samplebias:: samplebias (S, float, float, int, float, uint)-Funktion für Texture2D

Abtast eine [**Texture2D**](sm5-object-texture2d.md), nachdem der Wert "Bias" auf die MipMap-Ebene angewendet wurde, mit einem optionalen Wert, um Sample Level-of-Detail-Werte (LOD) zu binden. Gibt den Status des Vorgangs zurück.
