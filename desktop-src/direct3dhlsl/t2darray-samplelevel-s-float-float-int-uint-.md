...
description: Samples a texture on the specified mipmap level and returns status about the operation. (Stichprobenentnahme einer Textur auf der angegebenen Mipmapebene und Rückgabe des Status des Vorgangs. Für Texture2DArray. | SampleLevel::SampleLevel(S,float,float,int,uint)-Funktion
