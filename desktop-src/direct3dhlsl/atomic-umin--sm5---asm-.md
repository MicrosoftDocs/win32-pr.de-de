...
description: Atomic unsigned integer minimum to memory(Atomarer ganzzahliger Ganzzahl ohne Vorzeichen im Arbeitsspeicher).
...
ms.locfileid: "118516782"
---
# <a name="atomic_umin-sm5---asm"></a>atomic \_ umin (sm5 - asm)

Atomic unsigned integer minimum to memory(Atomarer ganzzahliger Ganzzahl ohne Vorzeichen im Arbeitsspeicher).
...
Diese Anweisung führt einen 32-Bit-Operanden *src0* mit einer einzelnen Komponente ohne Vorzeichen in *dst* bei 32-Bit pro Komponentenadresse *dstAddress* aus und wird atomar ausgeführt.
