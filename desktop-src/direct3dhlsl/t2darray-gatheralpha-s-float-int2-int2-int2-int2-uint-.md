...
description: Gibt die Alphakomponenten der vier Texelwerte zurück, die in einem bilinealen Filtervorgang zusammen mit dem Kachelzuordnungsstatus verwendet werden. | Texture2DArray::GatherAlpha(S,float,int2,int2,int2,int2,uint) function
...
ms.locfileid: "118788953"
---
# <a name="texture2darraygatheralphasfloatint2int2int2int2uint-function"></a>Texture2DArray::GatherAlpha(S,float,int2,int2,int2,int2,uint) function
