...
description: Liest Pufferdaten und gibt den Status des Vorgangs zurück. | RWBuffer::Load(int,uint)-Funktion
...
ms.locfileid: "119672170"
---
# <a name="rwbufferloadintuint-function"></a>RWBuffer::Load(int,uint)-Funktion
