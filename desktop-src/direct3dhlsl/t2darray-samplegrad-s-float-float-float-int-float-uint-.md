...
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloatuint-function-for-texture2darray"></a>Samplegrad:: samplegrad (S, float, float, float, int, float, uint)-Funktion für Texture2DArray
