...
---
# <a name="texturecubegathercmpalphasfloatfloatuint-function"></a>Texturecube:: gathercmpalpha (S, float, float, uint)-Funktion
...
[Gathercmpalpha-Methoden](texturecube-gathercmpalpha.md)
</dt> <dt>
