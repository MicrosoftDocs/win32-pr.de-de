...
---
# <a name="texture2darraysamplesfloatintfloatuint-function"></a>Texture2DArray:: Sample (S, float, int, float, uint)-Funktion
...
[Beispiel Methoden](texture2darray-sample.md)
</dt> </dl>
