...
---
# <a name="atomic_umax-sm5---asm"></a>atomarische \_ Umax (SM5-ASM)

Atomarische Ganzzahl ohne Vorzeichen, maximal im Arbeitsspeicher.



| Atomic \_ Umax DST, dstaddress \[ . Swizzle \] , src0 \[ . Select- \_ Komponente\] |
|----------------------------------------------------------------------|
