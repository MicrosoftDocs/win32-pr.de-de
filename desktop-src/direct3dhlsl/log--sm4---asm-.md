...
Komponentenweise Protokollbasis 2.
...
|-----------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| <span id="dest"></span><span id="DEST"></span>*Dest*<br/> | \[in \] Die Adresse des Ergebnisses des Vorgangs.<br/> dest = log2(src0)<br/> |
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/> | \[in \] Der Wert für den Vorgang.<br/>                                             |
...
-   Folgt der Begrenzungstheore.
-   Fehlertoleranz: Wenn *src0* \[ 0.5..2 ist, darf absolue error nicht mehr als \] 2-21 sein. Wenn *src0* (0..0.5) oder (2..+INF) ist, darf der relative Fehler nicht mehr als \] 2-21 sein.
