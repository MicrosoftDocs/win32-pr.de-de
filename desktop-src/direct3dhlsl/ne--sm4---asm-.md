...
Nicht gleicher Vergleich für den Komponenten weisen Vektor Gleit Komma Wert.



| ne dest \[ . mask \] , \[ - \] src0 \[ \_ ABS \] \[ . Swizzle \] , \[ - \] Quelle1 \[ \_ ABS \] \[ . Swizzle\] |
|----------------------------------------------------------------------------------|
...
Denorms werden geleert, bevor der Vergleich mit der ursprünglichen Quelle unverändert registriert wird.
