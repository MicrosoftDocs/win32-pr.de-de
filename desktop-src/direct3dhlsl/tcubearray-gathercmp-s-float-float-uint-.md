...
description: Für vier Texelwerte, die in einem bilinealen Filtervorgang verwendet werden, gibt ihren Vergleich mit einem Vergleichswert zusammen mit dem Kachelzuordnungsstatus zurück. | TextureCubeArray::GatherCmp(S,float,float,uint)-Funktion
...
ms.locfileid: "118506565"
---
# <a name="texturecubearraygathercmpsfloatfloatuint-function"></a>TextureCubeArray::GatherCmp(S,float,float,uint)-Funktion
...
[GatherCmp-Methoden](texturecubearray-gathercmp.md)
</dt> <dt>
