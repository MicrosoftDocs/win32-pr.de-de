...
---
# <a name="samplecmpsamplecmpsfloatfloatintfloat-function-for-texture1d"></a>Samplecmp:: samplecmp (S, float, float, int, float)-Funktion für Texture1D
...
[Samplecmp-Methoden](texture1d-samplecmp.md)
</dt> </dl>
