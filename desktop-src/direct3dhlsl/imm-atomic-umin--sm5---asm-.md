...
description: Sofortige atomare Min. ohne Vorzeichen im Arbeitsspeicher. Gibt den Wert im Arbeitsspeicher vor dem max-Vorgang zurück.
...
ms.locfileid: "119119274"
---
# <a name="imm_atomic_umin-sm5---asm"></a>imm \_ atomic \_ umin (sm5 - asm)

Sofortige atomare Min. ohne Vorzeichen im Arbeitsspeicher. Gibt den Wert im Arbeitsspeicher vor dem max-Vorgang zurück.
...
Diese Anweisung führt einen 32-Bit-Operanden *src0* mit *dst1* mit einer 32-Bit-Komponente pro Komponentenadresse *dstAddress* aus.
...
Der Wert im *dst1-Speicher* vor min wird an *dst0* zurückgegeben.
