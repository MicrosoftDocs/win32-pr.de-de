...
---
# <a name="atomic_cmp_store-sm5---asm"></a>atomarer \_ CMP \_ -Speicher (SM5-ASM)

Atomarischer Vergleich und Schreibvorgang in den Arbeitsspeicher.



| Atomic \_ CMP \_ Store DST, dstaddress \[ . Swizzle \] , src0 \[ . Select \_ Component \] , Quelle1 \[ . Select \_ Component\] |
|--------------------------------------------------------------------------------------------------------|
...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/>                                                | \[im \] 32-Bit-Wert, der mit *DST* verglichen werden soll.<br/>                                                                                                                                 |
| <span id="src1"></span><span id="SRC1"></span>*Quelle1*<br/>                                                | \[im \] Wert, der in den Speicher geschrieben werden soll, wenn die verglichenen Werte identisch sind. <br/>                                                                                                     |
...
Diese Anweisung führt einen einzelnen 32-Bit-Komponenten Vergleich von Operanden *src0* mit *DST* um 32 Bit pro Komponenten Adresse *dstaddress* aus.

Wenn die verglichenen Werte identisch sind, wird der 32-Bit-Wert einer einzelnen Komponente in *Quelle1* in den Zielspeicher geschrieben. Andernfalls wird das Ziel nicht geändert.
...
, Wenn der Shader-Aufruf inaktiv ist, z. b. wenn das Pixel zuvor in seiner Ausführung verworfen wurde oder eine Pixel-/Beispielanweisung den *DST* -Arbeitsspeicher überhaupt nicht ändert (im Hintergrund).
