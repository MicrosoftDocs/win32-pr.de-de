...
---
# <a name="samplelevelsamplelevelsfloatfloatintuint-function-for-texture1d"></a>Samplelevel:: samplelevel (S, float, float, int, uint)-Funktion für Texture1D
...
[Samplelevel-Methoden](texture1d-samplelevel.md)
</dt> </dl>
