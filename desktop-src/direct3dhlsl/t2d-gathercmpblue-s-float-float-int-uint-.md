...
description: Für vier Texelwerte, die in einem bilinealen Filtervorgang verwendet werden, gibt einen Vergleich ihrer blauen Komponente mit einem Vergleichswert zurück. | Texture2D::GatherCmpBlue(S,float,float,int,uint)-Funktion
...
ms.locfileid: "119671170"
---
# <a name="texture2dgathercmpbluesfloatfloatintuint-function"></a>Texture2D::GatherCmpBlue(S,float,float,int,uint)-Funktion
