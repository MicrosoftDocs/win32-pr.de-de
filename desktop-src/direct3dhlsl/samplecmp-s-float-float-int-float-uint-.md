...
Stichproben [**Texture2D**](sm5-object-texture2d.md)mit einem Vergleichswert zum ablehnen von Beispielen, mit einem optionalen Wert, mit dem Samplingrate-Werte (LOD-Werte) an eine Klammer überstehen. Gibt den Status des Vorgangs zurück.
