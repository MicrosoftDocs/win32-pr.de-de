...
description: Erfahren Sie, wie diese Funktion ein Texture2D-Beispiel mithilfe eines Vergleichswerts zum Ablehnen von Stichproben mit einem optionalen Wert zum Anschließen von LoD-Werten (Sample Level-of-Detail) verwendet. Gibt den Status des Vorgangs zurück.
...
ms.locfileid: "120095230"
---
# <a name="samplecmpsamplecmpsfloatfloatintfloatuint-function-for-texture2d"></a>SampleCmp::SampleCmp(S,float,float,int,float,uint)-Funktion für Texture2D

Samples a [**Texture2D**](sm5-object-texture2d.md), using a comparison value to reject samples, with an optional value to clamp sample level-of-detail (LOD) values to . Gibt den Status des Vorgangs zurück.
