...
---
# <a name="registers---vs_2_x"></a>Register-vs \_ 2 \_ x

Dieser Abschnitt enthält Referenzinformationen zu den von Vertex Shader Version 2 x implementierten Eingabe-und Ausgabe Registern \_ .
...
| r\#      | [Temporäres Register](dx9-graphics-reference-asm-vs-registers-temporary.md)               | Siehe Hinweis 2 | R/W | 3             | Unbegrenzt       | 4         | Nein      | Keine         | Nein           |
| c\#      | [Konstantes float-Register](dx9-graphics-reference-asm-vs-registers-constant-float.md)     | Siehe Hinweis 3 | R   | 1             | 2               | 4         | a0/Al | (0, 0, 0, 0) | Nein           |
...
2.  Gleich D3DCAPS9. VS20Caps. numTemps (mindestens 12 für vs \_ 2 \_ x).
3.  Gleich D3DCAPS9. Maxvertexshaderconst (mindestens 256 für vs \_ 2 \_ x).
