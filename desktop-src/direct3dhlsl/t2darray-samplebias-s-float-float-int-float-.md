...
---
# <a name="samplebiassamplebiassfloatfloatintfloat-function-for-texture2darray"></a>Samplebias:: samplebias (S, float, float, int, float)-Funktion für Texture2DArray
