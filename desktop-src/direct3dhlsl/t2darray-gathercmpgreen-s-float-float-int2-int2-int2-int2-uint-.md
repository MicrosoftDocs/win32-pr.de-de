---
title: Texture2DArray::GatherCmpGreen(S,float,float,int2,int2,int2,int2,int2,uint)-Funktion
description: Für vier Texelwerte, die in einem bilinearen Filtervorgang verwendet werden, gibt einen Vergleich ihrer grünen Komponente mit einem Vergleichswert zusammen mit dem Kachelzuordnungsstatus zurück. | Texture2DArray::GatherCmpGreen(S,float,float,int2,int2,int2,int2,int2,uint)-Funktion
...
ms.locfileid: "119788240"
---
# <a name="texture2darraygathercmpgreensfloatfloatint2int2int2int2uint-function"></a>Texture2DArray::GatherCmpGreen(S,float,float,int2,int2,int2,int2,int2,uint)-Funktion
