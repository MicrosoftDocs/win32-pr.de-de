...
description: Gibt die grünen Komponenten der vier Texelwerte zurück, die in einem bilinealen Filtervorgang zusammen mit dem Kachelzuordnungsstatus verwendet werden. | TextureCube::GatherGreen(S,float,uint)-Funktion
...
ms.locfileid: "118284937"
---
# <a name="texturecubegathergreensfloatuint-function"></a>TextureCube::GatherGreen(S,float,uint)-Funktion
...
[GatherGreen-Methoden](texturecube-gathergreen.md)
</dt> <dt>
