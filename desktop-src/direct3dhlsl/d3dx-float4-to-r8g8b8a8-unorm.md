...
---
# <a name="d3dx_float4_to_r8g8b8a8_unorm-function"></a>D3DX \_ float4 \_ to \_ R8G8B8A8 \_ unorm-Funktion

Entpackt DXGI- \_ Format \_ R8G8B8A8 \_ unorm-Shader-Daten in eine XMFLOAT4.
