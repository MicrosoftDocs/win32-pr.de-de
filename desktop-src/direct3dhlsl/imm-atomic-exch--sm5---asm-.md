...
Direkter atomarer Austausch in den Arbeitsspeicher.
...
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| <span id="dst0"></span><span id="DST0"></span>*dst0*<br/>                                                | \[in \] enthält den Wert von *dST1* vor dem Schreibvorgang.<br/>                                                                |
...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/>                                                | \[in \] dem Wert, der in *dST1* in *dstaddress* geschrieben werden soll.<br/>                                                                   |
...
Diese Anweisung führt einen einzelnen Komponenten-32-Bit-Wert Schreiben von Operand *src0* zu *dST1* um 32 Bit pro Komponenten Adresse *dstaddress* aus.
