...
---
# <a name="samplebiassamplebiassfloatfloatintfloatuint-function-for-texture1darray"></a>Samplebias:: samplebias (S, float, float, int, float, uint)-Funktion für Texture1DArray
...
[Samplebias-Methoden](texture1darray-samplebias.md)
</dt> </dl>
