...
Unmittelbarer atomarischer Mindestwert im Arbeitsspeicher. Gibt den Wert im Arbeitsspeicher vor dem maximalen Vorgang zurück.
...
Die thisi-Anweisung führt eine einzelne Komponente mit einer Länge von mindestens 32 Bit und einem Operanden vom Typ " *src0* " mit *dST1* bei 32 Bit pro Komponenten Adresse *dstaddress* aus.
