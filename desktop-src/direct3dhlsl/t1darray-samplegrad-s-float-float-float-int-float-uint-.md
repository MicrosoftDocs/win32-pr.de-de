...
description: Erfahren Sie, wie diese Funktion eine Textur mithilfe eines Farbverlaufs abtast, um die Art und Weise zu beeinflussen, wie die Stichprobenposition berechnet wird.
...
ms.locfileid: "119043708"
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloatuint-function-for-texture1darray"></a>SampleGrad::SampleGrad(S,float,float,float,int,float,uint)-Funktion für Texture1DArray
