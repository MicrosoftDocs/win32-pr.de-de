...
Der Komponenten Weise Vergleich mit doppelter Genauigkeit größer oder gleich.



| DGE \[ \_ Sat \] dest \[ . mask \] , \[ - \] src0 \[ \_ ABS \] \[ . Swizzle \] , \[ - \] Quelle1 \[ \_ ABS \] \[ . Swizzle\] |
|--------------------------------------------------------------------------------------------|
...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/> | Die Komponenten, die mit *Quelle1* verglichen werden sollen.<br/>                |
| <span id="src1"></span><span id="SRC1"></span>*Quelle1*<br/> | Die Komponenten, die mit *src0* verglichen werden sollen.<br/>                |
