...
description: Probieren Sie eine Texture2D mit einem optionalen Wert aus, um LoD-Werte (Sample Level of Detail) zu klammern, und gibt den Status des Vorgangs zurück.
...
ms.locfileid: "118986210"
---
# <a name="samplesfloatintfloatuint-function-hlsl-reference"></a>Sample(S,float,int,float,uint)-Funktion (HLSL-Referenz)

Probieren Sie eine [**Texture2D**](sm5-object-texture2d.md) mit einem optionalen Wert aus, um LoD-Werte (Sample Level of Detail) zu klammern, und gibt den Status des Vorgangs zurück.
