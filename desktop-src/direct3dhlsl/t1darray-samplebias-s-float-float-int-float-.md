...
---
# <a name="samplebiassamplebiassfloatfloatintfloat-function-for-texture1darray"></a>Samplebias:: samplebias (S, float, float, int, float)-Funktion für Texture1DArray
