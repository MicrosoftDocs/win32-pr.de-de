...
---
# <a name="d3dx_b8g8r8a8_unorm_srgb_to_float4_inexact-function"></a>D3DX \_ B8G8R8A8 \_ UNORM \_ SRGB \_ to \_ FLOAT4 \_ inexact function
...
Diese Funktion verwendet Shaderanweisungen, die nicht hoch genug sind, um die genaue Antwort zu geben. Die alternative [**Funktion D3DX \_ B8G8R8A8 \_ UNORM SRGB zu \_ \_ \_ FLOAT4**](d3dx-r10g10b10a2-unorm-to-float4.md) verwendet eine im Shader gespeicherte Nachschlagetabelle, um eine exakte SRGB- in float-Konvertierung zu geben.
