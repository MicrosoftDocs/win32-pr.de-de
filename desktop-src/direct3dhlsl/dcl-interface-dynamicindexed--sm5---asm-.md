...
---
# <a name="dcl_interface_dynamicindexed-sm5---asm"></a>DCL \_ -Schnittstelle \_ dynamicindiziert (SM5-ASM)

Deklarieren Sie Funktionstabellen Zeiger (Schnittstellen).



| DCL- \_ Schnittstelle \_ dynamicindiziert FP \# \[ arraySize \] \[ numcallsites \] = {ft \# , ft \# ,...} |
|--------------------------------------------------------------------------------------|
