...
description: Für vier Texelwerte, die in einem bilinearen Filtervorgang verwendet werden, gibt den Vergleich mit einem Vergleichswert zurück. | TextureCube::GatherCmp(S,float,float,uint)-Funktion
...
ms.locfileid: "118506602"
---
# <a name="texturecubegathercmpsfloatfloatuint-function"></a>TextureCube::GatherCmp(S,float,float,uint)-Funktion

Für vier Texelwerte, die in einem bilinearen Filtervorgang verwendet werden, gibt den Vergleich mit einem Vergleichswert zurück.
