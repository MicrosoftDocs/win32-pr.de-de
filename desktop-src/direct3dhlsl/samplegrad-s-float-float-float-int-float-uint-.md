...
Abtast eine [**Texture2D**](sm5-object-texture2d.md)mit einem Farbverlauf, um die Art und Weise zu beeinflussen, wie der Beispiel Speicherort berechnet wird, mit einem optionalen Wert, mit dem Samplingrate-Werte (LOD) als Klammer verwendet werden Gibt den Status des Vorgangs zurück.
