...
description: Gibt die vier Texelwerte zurück, die in einem bilinearen Filtervorgang verwendet werden. | Texture2DArray::Gather(S,float,int,uint)-Funktion
...
ms.locfileid: "120023350"
---
# <a name="texture2darraygathersfloatintuint-function"></a>Texture2DArray::Gather(S,float,int,uint)-Funktion
