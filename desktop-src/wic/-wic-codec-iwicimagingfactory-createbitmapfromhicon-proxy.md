...
---
# <a name="iwicimagingfactory_createbitmapfromhicon_proxy-function"></a>IWICImagingFactory- \_ Funktion "endbitmapfromhicon" \_

Proxy Funktion für die Methode " [**kreatebitmapfromhicon**](/windows/desktop/api/Wincodec/nf-wincodec-iwicimagingfactory-createbitmapfromhicon) ".
...
Das Symbol Handle, aus dem die neue Bitmap erstellt werden soll.
