---
description: Dieses Dokument enthält GUIDs und CLSIDs -Tabellen (Class Identifiers) von Windows Imaging Component (WIC).
...
Dieses Dokument enthält GUIDs und CLSIDs -Tabellen (Class Identifiers) von Windows Imaging Component (WIC).
...
-   [Herstelleridentifikation](#vendor-identification)
-   [Zugehörige Themen](#related-topics)

## <a name="built-in-clsids"></a>Integrierte CLSIDs

In der folgenden Tabelle sind integrierte Codec-CLSIDs aufgeführt. 
...
In der folgenden Tabelle sind die integrierten Containerformat-GUIDs aufgeführt. 
...
| \_GUID-ContainerFormatJpeg | 0x19e4a5aa, 0x5662, 0x4fc5, 0xa0, 0xc0, 0x17, 0x58, 0x2, 0x8e, 0x10, 0x57  |
...
In der folgenden Tabelle sind die GUIDs der Komponentenkategorie aufgeführt. 
...
| GUID \_ MetadataFormatFormatnkiTXt          | 0xC2BEC729, 0xB68, 0x4B77, 0xAA, 0xE, 0x62, 0x95, 0xA6, 0xAC, 0x18, 0x14   |
...
| GUID \_ MetadataFormatFormatnkiCCP          | 0xEB4349AB, 0xB685, 0x450F, 0x91, 0xB5, 0xE8, 0x2, 0xE8, 0x92, 0x53, 0x6C  |
...
| GUID \_ MetadataFormatFormatFormatf               | 0x817EF3E1, 0x1288, 0x45F4, 0xA8, 0x52, 0x26, 0x0D, 0x9E, 0x7C, 0xCE, 0x83 |
...
## <a name="vendor-identification"></a>Anbieteridentifikation

Hersteller können Komponenten innerhalb ihrer Familie über die Hersteller-GUID identifizieren. Dies ist bei der Vermittlung von Drittanbieterkomponenten nützlich. 
