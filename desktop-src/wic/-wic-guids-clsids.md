---
description: Dieses Dokument enthält GUIDs und Klassenbezeichnertabellen (CLSIDs) von Windows Imaging Component (WIC).
...
ms.locfileid: "118206167"
---
# <a name="wic-guids-and-clsids"></a>WIC-GUIDs und CLSIDs

Dieses Dokument enthält GUIDs und Klassenbezeichnertabellen (CLSIDs) von Windows Imaging Component (WIC).

Dieses Thema enthält die folgenden Abschnitte:

-   [Integrierte CLSIDs](#wic-guids-and-clsids)
-   [Containerformate](#container-formats)
-   [Komponentenbezeichner](#component-identifiers)
-   [Formatkonverter](#format-converters)
-   [Metadatenhandler](#metadata-handlers)
-   [Anbieteridentifikation](#vendor-identification)
-   [Zugehörige Themen](#related-topics)

## <a name="built-in-clsids"></a>Integrierte CLSIDs

In der folgenden Tabelle sind die integrierten Codec-CLSIDs aufgeführt. 
...
| CLSID \_ WICIererDecoder | 0xe9a4a80a, 0x44fe, 0x4de4, 0x89, 0x71, 0x71, 0x50, 0Xb1, 0X0a, 0X51, 0X99 |
...
| CLSID \_ WICKraftfEncoder | 0x0dbecec1, 0x9eb3, 0x4860, 0x9c, 0x6f, 0xdd, 0xbe, 0x86, 0x63, 0x45, 0x75 |
...
## <a name="container-formats"></a>Containerformate

In der folgenden Tabelle sind die integrierten GUIDs im Containerformat aufgeführt. 
...
| GUID \_ ContainerFormatFormatFormatf  | 0xe1e62521, 0x6787, 0x405b, 0xa3, 0x39, 0x50, 0x07, 0x15, 0xb5, 0x76, 0x3f |
| GUID \_ ContainerFormatWebp  | 0xe094b0e2, 0x67f2, 0x45b3, 0xb0, 0xea, 0x11, 0x53, 0x37, 0xca, 0x7c, 0xf3 |


 

## <a name="component-identifiers"></a>Komponentenbezeichner

In der folgenden Tabelle sind die Komponentenkategorie-GUIDs aufgeführt. 
...
| CLSID \_ WICKraftfMetadataReader| 0xacddfc3f, 0x85ec, 0x41bc, 0xbd, 0xef, 0x1b, 0xc2, 0x62, 0xe4, 0xdb, 0x05 |
| CLSID \_ WICMetafMetadataWriter| 0x3ae45e79, 0x40bc, 0x4401, 0xac, 0xe5, 0xdd, 0x3c, 0xb1, 0x6e, 0x6a, 0xfe |
...
## <a name="format-converters"></a>Formatkonverter

In der folgenden Tabelle sind die Formatkonverter-GUIDs aufgeführt. 
...
In der folgenden Tabelle sind die Metadatenhandler-GUIDs aufgeführt.
...
| GUID \_ MetadataFormatJpegColorinance    | 0xF73D0DCF, 0xCEC6, 0x4F85, 0x9B, 0x0E, 0x1C, 0x39, 0x56, 0xB1, 0xBE, 0xF7 |
...
| GUID \_ MetadataFormatBrowsernkiTXt          | 0xC2BEC729, 0xB68, 0x4B77, 0xAA, 0xE, 0x62, 0x95, 0xA6, 0xAC, 0x18, 0x14   |
...
| GUID \_ MetadataFormatBrowsernkiCCP          | 0xEB4349AB, 0xB685, 0x450F, 0x91, 0xB5, 0xE8, 0x2, 0xE8, 0x92, 0x53, 0x6C  |
...
## <a name="vendor-identification"></a>Herstelleridentifikation

Anbieter können Komponenten innerhalb ihrer Familie über die Hersteller-GUID identifizieren. Dies ist nützlich bei der Vermittlung von Drittanbieterkomponenten. 

| GUID-Name                    | GUID                                                                       |
|------------------------------|----------------------------------------------------------------------------|
| \_GUID-AnbieterMicrosoft        | 0x69fd0fdc, 0xa866, 0x4108, 0xb3, 0xb2, 0x98, 0x44, 0x7f, 0xa9, 0xed, 0xd4 |
...
[Native Pixelformate](-wic-codec-native-pixel-formats.md)
</dt> </dl>
