...
---
# <a name="desktop-app-technologies"></a><span data-ttu-id="4af0f-103">Desktop-App-Technologien</span><span class="sxs-lookup"><span data-stu-id="4af0f-103">Desktop app technologies</span></span>

<span data-ttu-id="4af0f-104">Dieser Abschnitt enthält ausführliche Anleitungen und Codebeispiele zu Windows-Features, die für Desktop Anwendungen mithilfe der Win32-API verfügbar sind.</span><span class="sxs-lookup"><span data-stu-id="4af0f-104">This section provides in-depth guidance and code examples about Windows features that are available to desktop applications by using the Win32 API.</span></span>

## <a name="in-this-section"></a><span data-ttu-id="4af0f-105">In diesem Abschnitt</span><span class="sxs-lookup"><span data-stu-id="4af0f-105">In this section</span></span>

| <span data-ttu-id="4af0f-106">Thema</span><span class="sxs-lookup"><span data-stu-id="4af0f-106">Topic</span></span> | <span data-ttu-id="4af0f-107">BESCHREIBUNG</span><span class="sxs-lookup"><span data-stu-id="4af0f-107">Description</span></span>  |  
|----------------------------------|---|
| [<span data-ttu-id="4af0f-108">Bedienungshilfen</span><span class="sxs-lookup"><span data-stu-id="4af0f-108">Accessibility</span></span>](accessibility/accessibility.md) | <span data-ttu-id="4af0f-109">Bietet Anleitungen für Windows-Entwickler, die barrierefreie Anwendungen entwerfen, hilfstechnologieentwickler, die Tools wie Sprachausgabe und Bildschirmlupe erstellen, und Softwaretest Techniker, die automatisierte Skripts zum Testen von Windows-Anwendungen erstellen.</span><span class="sxs-lookup"><span data-stu-id="4af0f-109">Provides guidance for Windows developers designing accessible applications, assistive technology developers building tools such as screen readers and magnifiers, and software test engineers creating automated scripts for testing Windows applications.</span></span> |
| [<span data-ttu-id="4af0f-110">Desktop-Benutzeroberfläche</span><span class="sxs-lookup"><span data-stu-id="4af0f-110">Desktop user interface</span></span>](windows-application-ui-development.md) | <span data-ttu-id="4af0f-111">Bietet Informationen, die es Ihnen ermöglichen, grafische Benutzeroberflächen für Ihre apps zu entwickeln, einschließlich Funktionen wie Windows und Nachrichten, Ressourcen und Steuerelemente.</span><span class="sxs-lookup"><span data-stu-id="4af0f-111">Provides information that enables you to develop graphical user interfaces for your apps, including features such as windows and messages, resources, and controls.</span></span> |
| [<span data-ttu-id="4af0f-112">Desktop Umgebung</span><span class="sxs-lookup"><span data-stu-id="4af0f-112">Desktop environment</span></span>](user-interface.md) | <span data-ttu-id="4af0f-113">Enthält Anleitungen zum integrieren und Erweitern der Desktop-Benutzer seitigen Features von Windows, einschließlich der Taskleiste, des Desktops und des Datei-Explorers.</span><span class="sxs-lookup"><span data-stu-id="4af0f-113">Provides guidance for integrating and extending the desktop user-facing features of Windows, including the Taskbar, the desktop, and File Explorer.</span></span> |
| [<span data-ttu-id="4af0f-114">Anwendungsinstallation und -wartung</span><span class="sxs-lookup"><span data-stu-id="4af0f-114">Application installation and servicing</span></span>](application-installing-and-servicing.md) | <span data-ttu-id="4af0f-115">Bietet Informationen zur Verwendung von APIs und Diensten, die von Windows zur Installation, Verwaltung und Wartung Ihrer Desktop-Apps bereitgestellt werden.</span><span class="sxs-lookup"><span data-stu-id="4af0f-115">Provides information about using APIs and services provided by Windows to install, manage, and service your desktop apps.</span></span> |
| [<span data-ttu-id="4af0f-116">Audio und Video</span><span class="sxs-lookup"><span data-stu-id="4af0f-116">Audio and video</span></span>](audio-and-video.md) | <span data-ttu-id="4af0f-117">Enthält Anleitungen zur Verwendung von von Windows bereitgestellten Audiofunktionen und Videofunktionen.</span><span class="sxs-lookup"><span data-stu-id="4af0f-117">Provides guidance about using audio and video features provided by Windows.</span></span> |
| [<span data-ttu-id="4af0f-118">Datenzugriff und -speicherung</span><span class="sxs-lookup"><span data-stu-id="4af0f-118">Data access and storage</span></span>](data-access-and-storage.md) | <span data-ttu-id="4af0f-119">Bietet Informationen zu Datenzugriffs-und Speicher Features, die Sie in Ihren Desktop Anwendungen verwenden können, einschließlich Dateisystem Verwaltung und Cloud Sync Engines.</span><span class="sxs-lookup"><span data-stu-id="4af0f-119">Provides information about data access and storage features you can use in your desktop applications, including file system management and cloud sync engines.</span></span>  |
| [<span data-ttu-id="4af0f-120">Geräte</span><span class="sxs-lookup"><span data-stu-id="4af0f-120">Devices</span></span>](devices.md) | <span data-ttu-id="4af0f-121">Beschreibt APIs für die Interaktion mit Geräten und Sensoren.</span><span class="sxs-lookup"><span data-stu-id="4af0f-121">Describes APIs for interacting with devices and sensors.</span></span> |
| [<span data-ttu-id="4af0f-122">Diagnose</span><span class="sxs-lookup"><span data-stu-id="4af0f-122">Diagnostics</span></span>](diagnostics.md) | <span data-ttu-id="4af0f-123">Enthält Anleitungen zum Debuggen und zur Fehlerbehandlung, zur Leistungsprofil Erstellung, zur Netzwerküberwachung und anderen Diagnose Features.</span><span class="sxs-lookup"><span data-stu-id="4af0f-123">Provides guidance about debugging and error handling, performance profiling, network monitoring, and other diagnostics features.</span></span> |
| [<span data-ttu-id="4af0f-124">Dokumente und Drucken</span><span class="sxs-lookup"><span data-stu-id="4af0f-124">Documents and printing</span></span>](printdocs/documents-and-printing.md) | <span data-ttu-id="4af0f-125">Beschreibt die Dokumente und Druck Features von Windows, die es Anwendungen ermöglichen, zu speichern, anzuzeigen und zu drucken.</span><span class="sxs-lookup"><span data-stu-id="4af0f-125">Describes the documents and printing features of Windows that enable applications to save, view, and print.</span></span>  |
| [<span data-ttu-id="4af0f-126">Grafik und Spiele</span><span class="sxs-lookup"><span data-stu-id="4af0f-126">Graphics and gaming</span></span>](graphics-and-multimedia.md) | <span data-ttu-id="4af0f-127">Bietet Informationen zu Grafik-und Spiel Features von Windows, einschließlich DirectX und digitaler Abbild Erstellung.</span><span class="sxs-lookup"><span data-stu-id="4af0f-127">Provides information about graphics and gaming features of Windows, including DirectX and digital imaging.</span></span>  |
| [<span data-ttu-id="4af0f-128">Netzwerke und Internet</span><span class="sxs-lookup"><span data-stu-id="4af0f-128">Networking and Internet</span></span>](networking.md) | <span data-ttu-id="4af0f-129">Bietet Anleitungen zu den Netzwerk-und Internet bezogenen Features von Windows, einschließlich Netzwerkverwaltung, http-APIs und Remote Prozedur Aufruf (RPC).</span><span class="sxs-lookup"><span data-stu-id="4af0f-129">Provides guidance about the networking and Internet-related features of Windows, including network management, HTTP APIs, and Remote Procedure Call (RPC).</span></span> |
| [<span data-ttu-id="4af0f-130">Sicherheit und Identität</span><span class="sxs-lookup"><span data-stu-id="4af0f-130">Security and identity</span></span>](security.md) | <span data-ttu-id="4af0f-131">Bietet Informationen zur Authentifizierung, Autorisierung, Kryptografie und anderen Sicherheitsfeatures von Windows.</span><span class="sxs-lookup"><span data-stu-id="4af0f-131">Provides information about authentication, authorization, cryptography, and other security features of Windows.</span></span> |
| [<span data-ttu-id="4af0f-132">Systemdienste</span><span class="sxs-lookup"><span data-stu-id="4af0f-132">System services</span></span>](system-services.md) | <span data-ttu-id="4af0f-133">Bietet Anleitungen zu grundlegenden Betriebssystemfunktionen wie Prozess und Threads, Dienste, Dynamic Link Libraries, com, der Registrierung und mehr.</span><span class="sxs-lookup"><span data-stu-id="4af0f-133">Provides guidance about fundamental OS features such as process and threads, services, dynamic-link libraries, COM, the registry, and more.</span></span> |
