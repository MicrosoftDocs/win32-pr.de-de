...
Die Anzahl der Elemente in den Arrays *Strides,* *WindowSize,* *StartPadding* und *EndPadding.* Dieser Wert muss der Anzahl räumlicher Dimensionen entsprechen. Die Anzahl räumlicher Dimensionen ist 2, wenn 4D-Tensoren bereitgestellt werden, oder 3, wenn 5D-Tensoren bereitgestellt werden.
