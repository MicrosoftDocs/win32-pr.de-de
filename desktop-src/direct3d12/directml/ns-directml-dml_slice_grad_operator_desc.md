...
Die Anzahl der Elemente in den *Arrays InputWindowOffsets,* *InputWindowSizes* und *InputWindowStrides.* Dieser Wert muss dem *DimensionCount-Wert entsprechen,* der in *InputGradientTensor* und *OutputGradientTensor* bereitgestellt wird.
...
Beachten Sie, dass dieser Operator im Gegensatz **zu DML_SLICE1_OPERATOR_DESC** einen Schritt ungleich 0 (null) erfordert. Das liegt daran, dass es bei einem 0-Schritt mehrdeutig ist, welches Eingabeelement den einzelnen Ausgabeelementen zugeordnet werden soll. Daher kann keine Backpropagation durchgeführt werden. Wie **DML_SLICE1_OPERATOR_DESC** drehen negative Schritte die Richtung des Eingabefensters entlang dieser Achse.
