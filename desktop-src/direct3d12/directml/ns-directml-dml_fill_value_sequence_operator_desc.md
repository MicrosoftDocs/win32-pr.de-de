...
Füllt einen tensorflow mit einer Sequenz. Dieser Operator führt den folgenden Pseudocode aus.
...
Der Anfangswert zum Auffüllen des ersten Elements in der Ausgabe mit *valuedatatype* , das festlegt, wie das Feld interpretiert werden soll.
...
Ein Schritt, der dem Wert für jedes geschriebene Element hinzugefügt werden soll, wobei *valuedatatype* festlegt, wie das Feld interpretiert werden soll.

## <a name="examples"></a>Beispiele

### <a name="example-1-1d-ascending-step"></a>Beispiel 1: 1D aufsteigender Schritt
...
### <a name="example-2-2d-ascending-step"></a>Beispiel 2: 2D-aufsteigender Schritt
