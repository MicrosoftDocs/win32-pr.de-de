...
description: Um zu vermeiden, dass ein Deskriptor-Heap durchgehen muss, können Sie einen Deskriptor direkt in die Stammsignatur einordnen.
...
ms.locfileid: "121813230"
---
# <a name="using-descriptors-directly-in-the-root-signature"></a>Direktes Verwenden von Deskriptoren in der Stammsignatur

Um zu vermeiden, dass ein Deskriptor-Heap durchgehen muss, können Sie einen Deskriptor direkt in die Stammsignatur einordnen. Diese Deskriptoren nehmen viel Speicherplatz in der Stammsignatur ein (siehe [Grenzwerte](./root-signature-limits.md)für Stammsignaturen). Daher wird empfohlen, sie nur wenig zu verwenden.

Eine Beispielverwendung wäre, im Stammlayout eine konstante Pufferansicht (CONSTANT Buffer View, CBV) zu platzieren, die sich pro Zeichnen ändert. Dies bedeutet, dass der Deskriptor-Heapspeicher nicht von der Anwendung pro Zeichnen zugeordnet werden muss (und speichert das Verweisen auf eine Deskriptortabelle an der neuen Position im Deskriptor-Heap). Indem etwas in die Stammsignatur übernommen wird, über trägt die Anwendung lediglich die Verantwortung für die Versionserstellung an den Treiber. aber dies ist die Infrastruktur, über die Treiber bereits verfügen.
...
> [!NOTE]  
> Es gibt kein Konzept eines *Stammdeskriptorarrays* in Direct3D 12. Deskriptorarrays werden nur in Deskriptor-Heaps unterstützt.
