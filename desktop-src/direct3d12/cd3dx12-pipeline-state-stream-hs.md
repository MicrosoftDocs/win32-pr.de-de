...
description: Eine Hilfsstruktur, die verwendet wird, um einen Hüllen-Shader als einzelnes Objekt zu beschreiben, das für eine Streambeschreibung geeignet ist.
...
ms.locfileid: "120028360"
---
# <a name="cd3dx12_pipeline_state_stream_hs-structure"></a>CD3DX12 \_ PIPELINE STATE STREAM \_ \_ \_ HS-Struktur

Eine Hilfsstruktur, die verwendet wird, um einen Hüllen-Shader als einzelnes Objekt zu beschreiben, das für eine Streambeschreibung geeignet ist.
...
Erstellt eine neue, nicht initialisierte Instanz eines CD3DX12 \_ PIPELINE \_ STATE STREAM \_ \_ HS.
...
Erstellt eine neue Instanz eines CD3DX12 PIPELINE STATE STREAM HS, initialisiert mit dem Unterobjekttyp \_ \_ \_ \_ **D3D12 \_ PIPELINE \_ STATE \_ SUBOBJECT TYPE \_ \_ HS** und unterobjektdaten, die aus *i*, einer [**D3D12 \_ SHADER \_ BYTECODE-Struktur,**](/windows/desktop/api/d3d12/ns-d3d12-d3d12_shader_bytecode) kopiert wurden.
...
CD3DX12 PIPELINE STATE STREAM HS ist eine Typedef-Spezialisierung der \_ \_ VORLAGE \_ \_ [**CD3DX12 \_ PIPELINE STATE STREAM \_ \_ \_ SUBOBJECT**](cd3dx12-pipeline-state-stream-subobject.md) und wird wie folgt definiert:
