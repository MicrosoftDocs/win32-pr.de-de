...
---
# <a name="id3dx12pipelineparsercallbacksgscb-method"></a>ID3DX12PipelineParserCallbacks:: gscb-Methode

Ruft den Geometry-shadersubobject-Rückruf eines Objekts auf, das diese Schnittstelle implementiert.
...
Details zum Geometry-Shader-unter Objekt, das aus einem Pipeline Status-Stream analysiert wurde.
