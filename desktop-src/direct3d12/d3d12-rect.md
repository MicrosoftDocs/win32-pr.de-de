...
ms.locfileid: "119751730"
---
# <a name="d3d12_rect"></a>D3D12 \_ RECT

D3D12 \_ RECT wird als RECT deklariert. Weitere Informationen zu dieser GDI-Rechteckstruktur finden Sie unter [**RECT**](/previous-versions//dd162897(v=vs.85)).
...
Diese Struktur ist ein Member der [**D3D12 \_ DISCARD \_ REGION-Struktur.**](/windows/desktop/api/d3d12/ns-d3d12-d3d12_discard_region)
...
[Kernstrukturen](direct3d-12-structures.md)
</dt> <dt>
