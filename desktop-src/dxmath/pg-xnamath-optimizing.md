...
-   [Abbrüche](#denormals)
-   [Nutzen der Dualität für ganzzahlige Gleitkommazahlen](#take-advantage-of-the-integer-floating-point-duality)
...
## <a name="use-accessors-sparingly"></a>Verwenden von Accessoren mit geringer Freundlichkeit
...
Viele Funktionen verfügen über eine entsprechende Schätzfunktion, die auf Est endet. Diese Funktionen tauschen eine gewisse Genauigkeit für eine verbesserte Leistung aus. Est-Funktionen eignen sich für nicht kritische Berechnungen, bei denen die Genauigkeit auf geschwindigkeitsbezogene Ungeniert werden kann. Die genaue Menge an genauigkeits- und geschwindigkeitsbedingten Verlusten hängt von der Plattform ab.
...
Die DirectXMath-Bibliothek bietet über Variant Vector Types, Structure und Functions Zugriff auf ausgerichtete und nicht ausgerichtete Funktionen. Diese Varianten werden durch ein "A" am Ende des Namens angegeben.
...
> [!Note]  
> Bei 64-Bit-Versionen von Windows werden [SSE-Anweisungen](/previous-versions/visualstudio/visual-studio-2010/t467de55(v=vs.100)) für alle Berechnungen verwendet, nicht nur für die Vektorvorgänge. Das Ändern der Denormalbehandlung wirkt sich auf alle Gleitkommaberechnungen in Ihrem Programm aus, nicht nur auf die von DirectXMath verwendeten Vektorvorgänge.

 

## <a name="take-advantage-of-the-integer-floating-point-duality"></a>Nutzen der Dualität für ganzzahlige Gleitkommazahlen
...
Da die Anweisungssätze, die zum Implementieren der DirectXMath-Bibliothek verwendet werden, die gleichen Daten wie mehrere verschiedene Typen behandeln können, können sie beispielsweise den gleichen Vektor wie Gleitkomma- und Ganzzahldaten behandeln. Bestimmte Optimierungen können erreicht werden. Sie können diese Optimierungen abrufen, indem Sie die Initialisierungsroutinen für ganzzahlige Vektoren und bitweise Operatoren verwenden, um Gleitkommawerte zu bearbeiten.

Das binäre Format von Gleitkommazahlen mit einfacher Genauigkeit, die von der DirectXMath-Bibliothek verwendet werden, entspricht vollständig dem IEEE 764-Standard:
