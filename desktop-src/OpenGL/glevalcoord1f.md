...
ms.locfileid: "118616207"
---
# <a name="glevalcoord1f-function"></a>glEvalCoord1f-Funktion
...
Ein -Wert, der die Domänenkoordinate *u* für die Basisfunktion ist, die in einer vorherigen [**glMap1-Funktion**](glmap1.md) definiert ist.
...
Die **glEvalCoord1f-Funktion** wertet aktivierte eindimensionale Zuordnungen am Argument *u* aus. Definieren Sie Zuordnungen mit [**glMap1.**](glmap1.md) Aktivieren oder deaktivieren Sie sie mit [**glEnable**](glenable.md) und [**glDisable**](gldisable.md).
...
Die folgenden Funktionen rufen Informationen im Zusammenhang mit der **glEvalCoord1f-Funktion** ab:
