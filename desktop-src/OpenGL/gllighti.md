...
Die **gllighti** -Funktion gibt Werte für helle Quellparameter zurück.
...
Die **gllighti** -Funktion legt den Wert oder die Werte einzelner Lichtquellen Parameter fest. Der *Light* -Parameter benennt das Licht und ist ein symbolischer Name der Form GL \_ Light *i*, wobei 0 = *i* < GL \_ Max \_ Lights ist.
