...
Die **gllightmodelf** -Funktion legt Beleuchtungsmodell Parameter fest.
...
Die **gllightmodelf** -Funktion legt den Beleuchtungsmodell Parameter fest. Der Parameter " *PName* " benennt einen *Parameter und gibt* den neuen Wert an. der Wert oder die Werte einzelner Licht Quellparameter.
