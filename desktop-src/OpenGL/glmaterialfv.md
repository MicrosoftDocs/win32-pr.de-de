...
| <span id="GL_AMBIENT_AND_DIFFUSE"></span><span id="gl_ambient_and_diffuse"></span><dl> <dt>**GL \_ AMBIENT \_ UND \_ DIFFUSE**</dt> </dl> | Entspricht dem [**zweimalen Aufrufen von glMaterial**](glmaterial-functions.md) mit denselben Parameterwerten, einmal mit GL \_ AMBIENT und einmal mit GL \_ DIFFUSE. <br/>                                                                                                                                                                                                                                                                                                                                   |
| <span id="GL_COLOR_INDEXES"></span><span id="gl_color_indexes"></span><dl> <dt>**\_ \_ GL-FARBINDIZES**</dt> </dl>                    | Der Parameter params enthält drei Gleitkommawerte, die die Farbindizes für Umgebungs-, Diffuse- und Specular-Beleuchtung angeben. Diese drei Werte und GL KERNELINESS sind die einzigen Materialwerte, die von der \_ Farbindexmodus-Beleuchtungsgleichung verwendet werden. Eine Erörterung der Farbindexbeleuchtung finden Sie unter [**glLightModel.**](gllightmodel-functions.md)<br/>                                                                                                                                  |
