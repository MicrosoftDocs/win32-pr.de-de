...
description: Legt die aktuelle Farbe aus einem bereits vorhandenen Array von Farbwerten fest. | glColor4sv-Funktion (Gl.h)
...
ms.locfileid: "119061838"
---
# <a name="glcolor4sv-function"></a>glColor4sv-Funktion
