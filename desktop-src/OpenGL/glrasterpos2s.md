...
description: Gibt die Rasterposition für Pixeloperationen an. | glRasterPos2s-Funktion (Gl.h)
...
ms.locfileid: "117795125"
---
# <a name="glrasterpos2s-function"></a>glRasterPos2s-Funktion
