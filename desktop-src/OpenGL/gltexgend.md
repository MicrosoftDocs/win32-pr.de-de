...
Mit den Werten in *param* wird eine Verweis Ebene in den Augen Koordinaten definiert. Die auf Sie angewendete Modelview-Matrix darf nicht identisch sein, wenn die Polygon Scheitel Punkte transformiert werden. Diese Funktion legt ein Feld von Texturkoordinaten fest, das dynamische Konturlinien für das Verschieben von Objekten erzeugt.
