...
---
# <a name="gllightmodelfv-function"></a>gllightmodelfv-Funktion

Die [**gllightmodelfv**](gllightfv.md) -Funktion legt Beleuchtungsmodell Parameter fest.
...
Die **gllightmodelfv** -Funktion legt den Beleuchtungsmodell Parameter fest. Der Parameter " *PName* " benennt einen *Parameter und gibt* den neuen Wert an. der Wert oder die Werte einzelner Licht Quellparameter.
