...
---
# <a name="windows-rendering-context-code-sample"></a><span data-ttu-id="3976b-106">Code Beispiel für Windows-Rendering-Kontext</span><span class="sxs-lookup"><span data-stu-id="3976b-106">Windows Rendering Context Code Sample</span></span>

<span data-ttu-id="3976b-107">Das folgende Codebeispiel zeigt, wie der glx-renderingkontextcode im vorherigen Abschnitt bei der Portierung zu Windows aussieht.</span><span class="sxs-lookup"><span data-stu-id="3976b-107">The following code sample shows how the GLX rendering context code in the previous section looks when it has been ported to Windows.</span></span>
