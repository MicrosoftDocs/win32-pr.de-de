...
Die Funktion " **glindexsv** " legt den aktuellen Farbindex fest.
...
Die Funktion " **glindexsv** " aktualisiert den aktuellen Farbindex (mit einem Wert). Es wird ein Argument benötigt: der neue Wert für den aktuellen Farbindex.
