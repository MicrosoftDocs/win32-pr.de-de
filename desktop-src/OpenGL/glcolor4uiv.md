...
description: Legt die aktuelle Farbe aus einem bereits vorhandenen Array von Farbwerten fest. | glColor4uiv-Funktion (Gl.h)
...
ms.locfileid: "120081810"
---
# <a name="glcolor4uiv-function"></a>glColor4uiv-Funktion
