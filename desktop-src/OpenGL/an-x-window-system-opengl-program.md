...
---
# <a name="an-x-window-system-opengl-program"></a>Ein System eigenes OpenGL-Programm für X-Fenster

Das folgende Programm ist ein System eigenes OpenGL-Programm im X-Fenster mit dem gleichen OpenGL-Code, der in der Datei "" von "" C-Beispielprogramm, das mit dem Microsoft Platform SDK bereitgestellt wird. Vergleichen Sie dieses Programm mit dem Windows OpenGL-Programm im [Programm, das zu Windows portiert](the-program-ported-to-win32.md)wurde.
