...
---
# <a name="id2d1geometrygetbounds-methods"></a>ID2D1Geometry:: GetBounds-Methoden

Ruft die Begrenzungen der Geometrie ab.
...
|:-------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|
| [**GetBounds (D2D1 \_ Matrix \_ 3x2 \_ f&, D2D \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))   | Ruft die Begrenzungen der Geometrie ab.<br/> |
| [**GetBounds (D2D1 \_ Matrix \_ 3x2 \_ f \* , D2D1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f)) | Ruft die Begrenzungen der Geometrie ab.<br/> |



## <a name="examples"></a>Beispiele

Der folgende Code zeigt die Verwendung von **GetBounds** zum Abrufen der Begrenzungen der Geometrie.
