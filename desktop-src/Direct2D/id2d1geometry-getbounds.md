---
title: ID2D1Geometry GetBounds-Methoden (D2d1 \_ 1. h)
description: Ruft die Begrenzungen der Geometrie ab.
ms.assetid: 3932189a-7c6b-4144-9d4a-32d2aba70835
keywords:
- GetBounds-Methoden Direct2D
topic_type:
- apiref
api_location:
- D2d1.dll
...
ms.locfileid: "106370213"
---
# <a name="id2d1geometrygetbounds-methods"></a><span data-ttu-id="c1b2b-104">ID2D1Geometry:: GetBounds-Methoden</span><span class="sxs-lookup"><span data-stu-id="c1b2b-104">ID2D1Geometry::GetBounds methods</span></span>

<span data-ttu-id="c1b2b-105">Ruft die Begrenzungen der Geometrie ab.</span><span class="sxs-lookup"><span data-stu-id="c1b2b-105">Retrieves the bounds of the geometry.</span></span>

### <a name="overload-list"></a><span data-ttu-id="c1b2b-106">Überladeliste</span><span class="sxs-lookup"><span data-stu-id="c1b2b-106">Overload list</span></span>



| <span data-ttu-id="c1b2b-107">Methode</span><span class="sxs-lookup"><span data-stu-id="c1b2b-107">Method</span></span>                                                                                                                   | <span data-ttu-id="c1b2b-108">BESCHREIBUNG</span><span class="sxs-lookup"><span data-stu-id="c1b2b-108">Description</span></span>                                      |
|:-------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|
| <span data-ttu-id="c1b2b-109">[**GetBounds (D2D1 \_ Matrix \_ 3x2 \_ f&, D2D \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))</span><span class="sxs-lookup"><span data-stu-id="c1b2b-109">[**GetBounds(D2D1\_MATRIX\_3X2\_F&,D2D\_RECT\_F\*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))</span></span>   | <span data-ttu-id="c1b2b-110">Ruft die Begrenzungen der Geometrie ab.</span><span class="sxs-lookup"><span data-stu-id="c1b2b-110">Retrieves the bounds of the geometry.</span></span><br/> |
| <span data-ttu-id="c1b2b-111">[**GetBounds (D2D1 \_ Matrix \_ 3x2 \_ f \* , D2D1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f))</span><span class="sxs-lookup"><span data-stu-id="c1b2b-111">[**GetBounds(D2D1\_MATRIX\_3X2\_F\*,D2D1\_RECT\_F\*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f))</span></span> | <span data-ttu-id="c1b2b-112">Ruft die Begrenzungen der Geometrie ab.</span><span class="sxs-lookup"><span data-stu-id="c1b2b-112">Retrieves the bounds of the geometry.</span></span><br/> |



## <a name="examples"></a><span data-ttu-id="c1b2b-113">Beispiele</span><span class="sxs-lookup"><span data-stu-id="c1b2b-113">Examples</span></span>

<span data-ttu-id="c1b2b-114">Der folgende Code zeigt die Verwendung von **GetBounds** zum Abrufen der Begrenzungen der Geometrie.</span><span class="sxs-lookup"><span data-stu-id="c1b2b-114">The following code shows how to use **GetBounds** to retrieve the bounds of the geometry.</span></span>
...
## <a name="requirements"></a><span data-ttu-id="c1b2b-115">Anforderungen</span><span class="sxs-lookup"><span data-stu-id="c1b2b-115">Requirements</span></span>



| <span data-ttu-id="c1b2b-116">Anforderung</span><span class="sxs-lookup"><span data-stu-id="c1b2b-116">Requirement</span></span> | <span data-ttu-id="c1b2b-117">Wert</span><span class="sxs-lookup"><span data-stu-id="c1b2b-117">Value</span></span> |
|--------------------|--------------------------------------------------------------------------------------|
| <span data-ttu-id="c1b2b-118">Header</span><span class="sxs-lookup"><span data-stu-id="c1b2b-118">Header</span></span><br/>  | <dl> <span data-ttu-id="c1b2b-119"><dt>D2d1 \_ 1. h</dt></span><span class="sxs-lookup"><span data-stu-id="c1b2b-119"><dt>D2d1\_1.h</dt></span></span> </dl> |
| <span data-ttu-id="c1b2b-120">Bibliothek</span><span class="sxs-lookup"><span data-stu-id="c1b2b-120">Library</span></span><br/> | <dl> <span data-ttu-id="c1b2b-121"><dt>D2d1. lib</dt></span><span class="sxs-lookup"><span data-stu-id="c1b2b-121"><dt>D2d1.lib</dt></span></span> </dl>  |
| <span data-ttu-id="c1b2b-122">DLL</span><span class="sxs-lookup"><span data-stu-id="c1b2b-122">DLL</span></span><br/>     | <dl> <span data-ttu-id="c1b2b-123"><dt>D2d1.dll</dt></span><span class="sxs-lookup"><span data-stu-id="c1b2b-123"><dt>D2d1.dll</dt></span></span> </dl>  |



## <a name="see-also"></a><span data-ttu-id="c1b2b-124">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="c1b2b-124">See also</span></span>

<dl> <dt>

[<span data-ttu-id="c1b2b-125">**ID2D1Geometry**</span><span class="sxs-lookup"><span data-stu-id="c1b2b-125">**ID2D1Geometry**</span></span>](/windows/win32/api/d2d1/nn-d2d1-id2d1geometry)
</dt> </dl>
