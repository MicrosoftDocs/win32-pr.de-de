...
---
# <a name="id2d1geometrygetwidenedbounds-methods"></a>ID2D1Geometry:: getwidenedbounds-Methoden

Ruft die Begrenzungen der Geometrie ab, nachdem Sie durch die angegebene Strichbreite und den angegebenen Stil erweitert und durch die angegebene Matrix transformiert wurde.
...
|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Getwidenedbounds (float, ID2D1StrokeStyle \* , D2D1 \_ Matrix \_ 3x2 \_ f&, D2D1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f__d2d1_rect_f))              | Ruft die Begrenzungen der Geometrie ab, nachdem Sie durch die angegebene Strichbreite und den angegebenen Stil erweitert und durch die angegebene Matrix transformiert wurde.<br/> |
| [**Getwidenedbounds (float, ID2D1StrokeStyle \* , D2D1 \_ Matrix \_ 3x2 \_ f \* , D2D1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f_d2d1_rect_f))             | Ruft die Begrenzungen der Geometrie ab, nachdem Sie durch die angegebene Strichbreite und den angegebenen Stil erweitert und durch die angegebene Matrix transformiert wurde.<br/> |
| [**Getwidenedbounds (float, ID2D1StrokeStyle \* , D2D1 \_ Matrix \_ 3x2 \_ f&, float, D2D1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f__float_d2d1_rect_f))  | Ruft die Begrenzungen der Geometrie ab, nachdem Sie durch die angegebene Strichbreite und den angegebenen Stil erweitert und durch die angegebene Matrix transformiert wurde.<br/> |
| [**Getwidenedbounds (float, ID2D1StrokeStyle \* , D2D1 \_ Matrix \_ 3x2 \_ f \* , float, D2D1 \_ Rect \_ F \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f_float_d2d1_rect_f)) | Ruft die Begrenzungen der Geometrie ab, nachdem Sie durch die angegebene Strichbreite und den angegebenen Stil erweitert und durch die angegebene Matrix transformiert wurde.<br/> |



## <a name="examples"></a>Beispiele

Der folgende Code zeigt, wie **getwidenedbounds** verwendet wird, um die Grenzen der Geometrie abzurufen, nachdem Sie durch die angegebene Strichbreite und den angegebenen Stil erweitert und durch die angegebene Matrix transformiert wurde.
