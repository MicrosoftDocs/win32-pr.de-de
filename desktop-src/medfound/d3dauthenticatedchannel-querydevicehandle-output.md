...
---
# <a name="d3dauthenticatedchannel_querydevicehandle_output-structure"></a>D3DAUTHENTICATEDCHANNEL \_ querydevicehandle- \_ Ausgabestruktur

Enthält die Antwort auf eine [**D3DAUTHENTICATEDQUERY- \_ abvicehandle**](d3dauthenticatedquery-devicehandle.md) -Abfrage.
