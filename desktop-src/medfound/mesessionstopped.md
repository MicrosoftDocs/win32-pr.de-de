...
---
# <a name="mesessionstopped-event"></a>Mesessionbeendete-Ereignis

Wird ausgelöst, wenn die [**imfmediasession:: beenden**](/windows/desktop/api/mfidl/nf-mfidl-imfmediasession-stop) -Methode asynchron abgeschlossen wird.
