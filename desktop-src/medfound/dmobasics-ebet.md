...
-   Legen Sie den Eingabetyp auf dem DMO fest, um die Merkmale der nicht komprimierten Medien, die Sie an einen Encoder übergeben, DMO, und die Eigenschaften der komprimierten Medien zu vermitteln, die Sie an einen Decoder übergeben DMO.
-   Legen Sie den Ausgabetyp auf dem DMO fest, um die Merkmale der komprimierten Medien, die von einem Encoder DMO übermittelt werden, und die Merkmale der nicht komprimierten Medien zu vermitteln, die von einem Decoder DMO bereitgestellt werden.
