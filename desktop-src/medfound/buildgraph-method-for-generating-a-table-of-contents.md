---
description: Buildgraph-Funktion zum Erstellen eines Inhaltsverzeichnisses
ms.assetid: f70740ef-4c58-4944-9be6-dd056e12ad93
title: Buildgraph-Funktion zum Erstellen eines Inhaltsverzeichnisses
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104342568"
---
# <a name="buildgraph-function-for-generating-a-table-of-contents"></a><span data-ttu-id="cc3e0-103">Buildgraph-Funktion zum Erstellen eines Inhaltsverzeichnisses</span><span class="sxs-lookup"><span data-stu-id="cc3e0-103">BuildGraph Function for Generating a Table of Contents</span></span>

<span data-ttu-id="cc3e0-104">Die folgende Funktion ist eine Hilfsfunktion in einem Beispielprogramm, das unter [Automatisches Erstellen eines Inhaltsverzeichnisses](generating-a-table-of-contents-automatically.md)erläutert wird.</span><span class="sxs-lookup"><span data-stu-id="cc3e0-104">The following function is a helper function in an example program that is discussed in [Generating a Table of Contents Automatically](generating-a-table-of-contents-automatically.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="cc3e0-105">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="cc3e0-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="cc3e0-106">Automatisches Erstellen eines Inhaltsverzeichnisses</span><span class="sxs-lookup"><span data-stu-id="cc3e0-106">Generating a Table of Contents Automatically</span></span>](generating-a-table-of-contents-automatically.md)
</dt> </dl>
