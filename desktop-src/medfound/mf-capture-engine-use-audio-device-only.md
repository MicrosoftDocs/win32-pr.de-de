...
Wenn dieses Attribut **TRUE** ist, wählt die Erfassungs-Engine kein Videoaufnahmegerät aus oder verwendet es. Legen Sie dieses Attribut auf **TRUE** fest, wenn Sie Audiodaten ohne Video erfassen möchten. Der Standardwert ist **FALSE**.
