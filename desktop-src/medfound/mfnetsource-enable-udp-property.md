---
description: Gibt an, ob der UDP-Transport (User Datagram Protocol) in der Netzwerkquelle aktiviert ist.
ms.assetid: d46a59e6-8abc-484b-aecc-edf57ffff512
title: MFNETSOURCE_ENABLE_UDP-Eigenschaft (Mfidl.h)
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "118243573"
---
# <a name="mfnetsource_enable_udp-property"></a>MFNETSOURCE \_ ENABLE \_ UDP-Eigenschaft
...
Die Konstante **MFNETSOURCE \_ ENABLE \_ UDP** definiert die GUID für diesen Eigenschaftsschlüssel. Der Eigenschaftenbezeichner (PID) ist 0 (null).
