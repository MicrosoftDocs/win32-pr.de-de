...
---
# <a name="gettoc-function-for-generating-a-table-of-contents"></a><span data-ttu-id="50c9a-103">Getdec-Funktion zum Erstellen eines Inhaltsverzeichnisses</span><span class="sxs-lookup"><span data-stu-id="50c9a-103">GetToc Function for Generating a Table of Contents</span></span>

<span data-ttu-id="50c9a-104">Die folgende Funktion ist eine Hilfsfunktion in einem Beispielprogramm, das unter [Automatisches Erstellen eines Inhaltsverzeichnisses](generating-a-table-of-contents-automatically.md)erläutert wird.</span><span class="sxs-lookup"><span data-stu-id="50c9a-104">The following function is a helper function in an example program that is discussed in [Generating a Table of Contents Automatically](generating-a-table-of-contents-automatically.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="50c9a-105">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="50c9a-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="50c9a-106">Automatisches Erstellen eines Inhaltsverzeichnisses</span><span class="sxs-lookup"><span data-stu-id="50c9a-106">Generating a Table of Contents Automatically</span></span>](generating-a-table-of-contents-automatically.md)
</dt> </dl>
