---
description: Gibt die Stoppzeit für eine Topologie relativ zum Start der ersten Topologie in der Sequenz an.
...
Gibt die Stoppzeit für eine Topologie relativ zum Start der ersten Topologie in der Sequenz an.
...
Wenn die Mediensitzung mit dem [**GLOBAL \_ \_ \_ TIME-Attribut von MF SESSION**](mf-session-global-time-attribute.md) gleich **TRUE** erstellt wurde, müssen alle Topologien das **MF \_ TOPOLOGY \_ PROJECTSTART-Attribut** enthalten. Andernfalls dürfen Topologien nicht das **MF \_ TOPOLOGY \_ PROJECTSTART-Attribut** enthalten. Weitere Informationen finden Sie unter [Sequence Presentation Times](sequence-presentation-times.md).
