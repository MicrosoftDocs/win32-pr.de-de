...
---
# <a name="mf_topology_projectstart-attribute"></a>Das MF- \_ topologieprojectstart- \_ Attribut

Gibt die Endzeit für eine Topologie relativ zum Anfang der ersten Topologie in der Sequenz an.
...
Wenn die Medien Sitzung mit dem [**\_ \_ globalen \_ Zeit**](mf-session-global-time-attribute.md) Attribut der MF-Sitzung gleich **true** erstellt wurde, müssen alle Topologien das-Attribut der **MF- \_ Topologie ( \_ ProjectStart** ) enthalten. Andernfalls dürfen Topologien nicht das MF- **\_ topologieprojectstart \_** -Attribut enthalten. Weitere Informationen finden Sie unter [Sequenz Präsentations Zeiten](sequence-presentation-times.md).
