...
---
# <a name="d3dauthenticatedchannel_queryoutputid_input-structure"></a>D3DAUTHENTICATEDCHANNEL \_ queryoutputid- \_ Eingabe Struktur

Enthält Eingabedaten für eine [**D3DAUTHENTICATEDQUERY \_ OutputID**](d3dauthenticatedquery-outputid.md) -Abfrage.
