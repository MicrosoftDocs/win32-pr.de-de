...
---
# <a name="parental-controls-wmi-provider-schema"></a><span data-ttu-id="3be2d-104">Jugend Steuerungs-WMI-Anbieter Schema</span><span class="sxs-lookup"><span data-stu-id="3be2d-104">Parental Controls WMI Provider Schema</span></span>

<span data-ttu-id="3be2d-105">Der WMI-Anbieter für Eltern Steuerelemente ist eine Instanz und ein Methoden Anbieter.</span><span class="sxs-lookup"><span data-stu-id="3be2d-105">The Parental Controls WMI Provider is an instance and method provider.</span></span> <span data-ttu-id="3be2d-106">Die Instanziierung neuer Klassen Instanzen, das Lesen oder Ändern vorhandener Instanzeigenschaften und das Aufrufen von Methoden wird von der Datei wpcsprov. MOF gesteuert.</span><span class="sxs-lookup"><span data-stu-id="3be2d-106">Instantiation of new class instances, reading or modification of existing instance properties, and invocation of methods is controlled by the Wpcsprov.mof file.</span></span>

<span data-ttu-id="3be2d-107">Die folgende Syntax ist aus "Namespace. mof".</span><span class="sxs-lookup"><span data-stu-id="3be2d-107">The following syntax is from Namespace.mof</span></span>
...
<span data-ttu-id="3be2d-108">Die folgende Syntax ist von "Ratings. mof".</span><span class="sxs-lookup"><span data-stu-id="3be2d-108">The following syntax is from Ratings.mof</span></span>
...
<span data-ttu-id="3be2d-109">Die folgende Syntax wird von wpcsettings. MOF abgeleitet.</span><span class="sxs-lookup"><span data-stu-id="3be2d-109">The following syntax is from WpcSettings.mof</span></span>
...
<span data-ttu-id="3be2d-110">Die folgende Syntax wird von wpcprovider. MOF abgeleitet.</span><span class="sxs-lookup"><span data-stu-id="3be2d-110">The following syntax is from WpcProvider.mof</span></span>
