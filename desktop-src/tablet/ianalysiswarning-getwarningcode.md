...
---
# <a name="ianalysiswarninggetwarningcode-method"></a>Ianalysiswarning:: getwarningcode-Methode

Gibt den Typ der Warnung zurück, die mithilfe der [**AnalysisWarningCode**](analysiswarningcode.md) -Enumeration aufgetreten ist.
...
*pwarningcode* \[ vorgenommen\]
</dt> <dd>

Der Typ der Warnung, die aufgetreten ist.
