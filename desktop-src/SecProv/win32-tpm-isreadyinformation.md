...
---
# <a name="win32_tpmisreadyinformation-method"></a>Win32 \_ TPM:: isleseryinformation-Methode

Gibt an, ob das TPM bereit ist, und stellt zusätzliche Informationen über den Status des TPM bereit. Der Information-Parameter gibt eine Bitmaske der Informationen zu den Anforderungen zurück, die zum vollständigen Bereitstellen des TPM erforderlich sind.
...
Legen Sie diese Einstellung auf " **true** " fest, wenn TPM und System vollständig für die TPM-Verwendung bereitgestellt werden.
...
Gibt eine Bitmaske von so vielen Informationen zurück, wie verfügbar ist, was für die vollständige Bereitstellung des TPM erforderlich ist.
...
| <span id="INFORMATION_TPM_SRK_AUTH"></span><span id="information_tpm_srk_auth"></span><dl> <dt>**Informationen \_ TPM- \_ SRK \_**</dt> -Authentifizierung <dt>0x00000200</dt> </dl>                                  | Der SRK-Autorisierungs Wert (Storage Root Key) ist nicht alle Nullen.<br/>                                                                                                                                                            |
...
| <span id="INFORMATION_DEVICEID"></span><span id="information_deviceid"></span><dl> <dt>**Informationen \_**</dt>Geräte-ID <dt> 0x00800000</dt> </dl>                                                | Der Geräte Bezeichner wurde nicht erstellt.<br/>                                                                                                                                                                                 |
| <span id="INFORMATION_ATTESTATION_VULNERABILITY"></span><span id="information_attestation_vulnerability"></span><dl> <dt>**Informationen \_ Nachweis \_ Anfälligkeit**</dt> <dt> 0x01000000</dt> </dl>                                                | Das TPM hat eine Sicherheits Anfälligkeit im Zusammenhang mit dem Integritäts Nachweis.<br/>                                                                                                                                                                                 |
