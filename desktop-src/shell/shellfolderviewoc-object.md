...
Gibt die Ereignisse weiter, die von einem angegebenen [**ShellFolderView-Objekt**](shellfolderview.md) ausgelöst werden, an die entsprechenden **ShellFolderViewOC-Ereignishandler.**
