...
| [**ColorRGBToHLS**](/windows/desktop/api/Shlwapi/nf-shlwapi-colorrgbtohls)<br/>               | Konvertiert Farben von RGB in das HLS-Format (Hue-luminance-saturation).<br/>         |
| [**SHCreateShellPalette**](/windows/desktop/api/Shlwapi/nf-shlwapi-shcreateshellpalette)<br/> | Erstellt eine Halbtonpalette für den angegebenen Gerätekontext.<br/>               |
