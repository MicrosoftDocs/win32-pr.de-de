---
description: Der folgende Beispielcode veranschaulicht die Verwendung der NUMA-Funktionen "getnumahighestnodenzuber", "getnumaprocessornode" und "virtualdepcexnuma".
ms.assetid: df025b35-fb6b-4987-806e-9c76e6b130a1
title: Belegen von Speicher aus einem NUMA-Knoten
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104129372"
---
# <a name="allocating-memory-from-a-numa-node"></a><span data-ttu-id="3af62-103">Belegen von Speicher aus einem NUMA-Knoten</span><span class="sxs-lookup"><span data-stu-id="3af62-103">Allocating Memory from a NUMA Node</span></span>

<span data-ttu-id="3af62-104">Der folgende Beispielcode veranschaulicht die Verwendung der NUMA-Funktionen " [**getnumahighestnodenzuber**](/windows/win32/api/systemtopologyapi/nf-systemtopologyapi-getnumahighestnodenumber)", " [**getnumaprocessornode**](/windows/win32/api/winbase/nf-winbase-getnumaprocessornode)" und " [**virtualdepcexnuma**](/windows/win32/api/memoryapi/nf-memoryapi-virtualallocexnuma)".</span><span class="sxs-lookup"><span data-stu-id="3af62-104">The following sample code demonstrates the use of the NUMA functions [**GetNumaHighestNodeNumber**](/windows/win32/api/systemtopologyapi/nf-systemtopologyapi-getnumahighestnodenumber), [**GetNumaProcessorNode**](/windows/win32/api/winbase/nf-winbase-getnumaprocessornode), and [**VirtualAllocExNuma**](/windows/win32/api/memoryapi/nf-memoryapi-virtualallocexnuma).</span></span> <span data-ttu-id="3af62-105">Außerdem wird veranschaulicht, wie die [**queryworkingsettex**](/windows/win32/api/psapi/nf-psapi-queryworkingsetex) -Funktion verwendet wird, um den NUMA-Knoten abzurufen, auf dem Seiten zugeordnet werden.</span><span class="sxs-lookup"><span data-stu-id="3af62-105">It also demonstrates the use of the [**QueryWorkingSetEx**](/windows/win32/api/psapi/nf-psapi-queryworkingsetex) function to retrieve the NUMA node on which pages are allocated.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="3af62-106">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="3af62-106">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="3af62-107">NUMA-Unterstützung</span><span class="sxs-lookup"><span data-stu-id="3af62-107">NUMA Support</span></span>](../procthread/numa-support.md)
</dt> </dl>
