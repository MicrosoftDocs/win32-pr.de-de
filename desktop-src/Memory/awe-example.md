---
description: Das folgende Beispielprogramm veranschaulicht die Address windowingextensions.
...
ms.locfileid: "106356774"
---
# <a name="awe-example"></a><span data-ttu-id="f9de6-103">AWE-Beispiel</span><span class="sxs-lookup"><span data-stu-id="f9de6-103">AWE Example</span></span>

<span data-ttu-id="f9de6-104">Das folgende Beispielprogramm veranschaulicht die [**Address windowingextensions**](address-windowing-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="f9de6-104">The following sample program illustrates the [**Address Windowing Extensions**](address-windowing-extensions.md).</span></span>
