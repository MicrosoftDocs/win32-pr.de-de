...
---
# <a name="setting-up-a-simple-sha"></a><span data-ttu-id="0d528-103">Einrichten eines einfachen SHA</span><span class="sxs-lookup"><span data-stu-id="0d528-103">Setting Up a Simple SHA</span></span>

> [!Note]  
> <span data-ttu-id="0d528-104">Die Netzwerk Zugriffsschutz-Plattform ist ab Windows 10 nicht verfügbar.</span><span class="sxs-lookup"><span data-stu-id="0d528-104">The Network Access Protection platform is not available starting with Windows 10</span></span>

 

<span data-ttu-id="0d528-105">Im folgenden Beispiel wird ein einfacher Systemintegritäts-Agent (System Health Agent, SHA) eingerichtet, und es werden zwei optionale Aktionen angezeigt: Statement of Health (SoH)-Änderungs Benachrichtigung und leeren des SoH-Caches.</span><span class="sxs-lookup"><span data-stu-id="0d528-105">The following example sets up a simple system health agent (SHA) and shows two optional actions: Statement of Health (SoH) change notification and flushing of the SoH cache.</span></span> <span data-ttu-id="0d528-106">Beachten Sie, dass die Fehler Verarbeitung aus Gründen der Einfachheit dieses Beispiels nicht in der Main ()-Funktion enthalten ist.</span><span class="sxs-lookup"><span data-stu-id="0d528-106">Note that error processing is not included in the main() function for simplicity of this example.</span></span>

> [!Note]  
> <span data-ttu-id="0d528-107">Das NAP-SDK enthält außerdem einen vollständigen Satz von Beispielcode, der in der... \\ Beispiele für \\ netds- \\ NAP... Verzeichnis der SDK-Installation.</span><span class="sxs-lookup"><span data-stu-id="0d528-107">The NAP SDK also contains a full set of sample code, found in the ...\\Samples\\NetDS\\NAP... directory of your SDK installation.</span></span> <span data-ttu-id="0d528-108">Diese Beispiel Gruppe enthält einen SHA, System Integritäts Prüfungs Punkt (SHV) und einen Erzwingungs Client (EC).</span><span class="sxs-lookup"><span data-stu-id="0d528-108">This sample set includes an SHA, system health validator (SHV), and enforcement client (EC).</span></span> <span data-ttu-id="0d528-109">Es verfügt über vollständige funktionierende NAP-Szenarien zum Einrichten der Kommunikation zwischen SHA-SHV und SHA-ec.</span><span class="sxs-lookup"><span data-stu-id="0d528-109">It has full working NAP scenarios setting up communication between SHA-SHV and SHA-EC.</span></span>
