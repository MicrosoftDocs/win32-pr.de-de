...
---
# <a name="example-shv"></a><span data-ttu-id="58008-103">Beispiel-SHV</span><span class="sxs-lookup"><span data-stu-id="58008-103">Example SHV</span></span>

> [!Note]  
> <span data-ttu-id="58008-104">Die Netzwerk Zugriffsschutz-Plattform ist ab Windows 10 nicht verfügbar.</span><span class="sxs-lookup"><span data-stu-id="58008-104">The Network Access Protection platform is not available starting with Windows 10</span></span>

 

<span data-ttu-id="58008-105">Im folgenden Beispiel wird eine System Integritätsprüfung (System Health Prüfungs, SHV) auf einem NAP-Integritäts Richtlinien Server eingerichtet.</span><span class="sxs-lookup"><span data-stu-id="58008-105">The following example sets up a system health validator (SHV) on a NAP health policy server.</span></span>

> [!Note]  
> <span data-ttu-id="58008-106">Das NAP-SDK enthält außerdem einen vollständigen Satz von Beispielcode, der sich im... \\ Beispiele für \\ netds- \\ NAP... Verzeichnis der SDK-Installation.</span><span class="sxs-lookup"><span data-stu-id="58008-106">The NAP SDK also contains a full set of sample code that can be found in the ...\\Samples\\NetDS\\NAP... directory of your SDK installation.</span></span> <span data-ttu-id="58008-107">Diese Beispiel Gruppe umfasst und den Systemintegritäts-Agent (SHA), SHV und Erzwingungs Client (EC).</span><span class="sxs-lookup"><span data-stu-id="58008-107">This sample set includes and system health agent (SHA), SHV, and enforcement client (EC).</span></span> <span data-ttu-id="58008-108">Es verfügt über vollständige funktionierende NAP-Szenarien zum Einrichten der Kommunikation zwischen SHA-SHV und SHA-ec.</span><span class="sxs-lookup"><span data-stu-id="58008-108">It has full working NAP scenarios setting up communication between SHA-SHV and SHA-EC.</span></span>
