...
---
# <a name="reading-an-objects-objectguid-and-creating-a-string-representation-of-the-guid"></a><span data-ttu-id="f2945-103">Die objectGUID eines Objekts wird gelesen und eine Zeichen folgen Darstellung der GUID erstellt.</span><span class="sxs-lookup"><span data-stu-id="f2945-103">Reading an Object's objectGUID and Creating a String Representation of the GUID</span></span>

<span data-ttu-id="f2945-104">Die **objectGUID** -Eigenschaft jedes Objekts in Active Directory Domain Services wird im Verzeichnis als Oktett-Zeichenfolge gespeichert.</span><span class="sxs-lookup"><span data-stu-id="f2945-104">The **objectGUID** property of each object in Active Directory Domain Services is stored in the directory as an octet string.</span></span> <span data-ttu-id="f2945-105">Eine Oktett-Zeichenfolge ist ein Array von 1-Byte-Zeichen.</span><span class="sxs-lookup"><span data-stu-id="f2945-105">An octet string is an array of one-byte characters.</span></span> <span data-ttu-id="f2945-106">Verwenden Sie die [**IADs:: get- \_ GUID**](/windows/desktop/ADSI/iads-property-methods) -Methode, um die bindbare Zeichen folgen Form des **objectGUID** eines Verzeichnis Objekts abzurufen.</span><span class="sxs-lookup"><span data-stu-id="f2945-106">Use the [**IADs::get\_GUID**](/windows/desktop/ADSI/iads-property-methods) method to retrieve the bindable string form of a directory object's **objectGUID**.</span></span>

<span data-ttu-id="f2945-107">Die folgenden Codebeispiele zeigen eine Funktion, die das **objectGUID** -Attribut liest und eine Zeichen folgen Darstellung der GUID zurückgibt, die zum Binden an das-Objekt verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="f2945-107">The following code examples show a function that reads the **objectGUID** attribute and returns a string representation of the GUID used to bind to the object.</span></span>

-   [<span data-ttu-id="f2945-108">Visual Basic Beispiel</span><span class="sxs-lookup"><span data-stu-id="f2945-108">Visual Basic Example</span></span>](#visual-basic-example)
-   [<span data-ttu-id="f2945-109">C++-Beispiel</span><span class="sxs-lookup"><span data-stu-id="f2945-109">C++ Example</span></span>](#c-example)

## <a name="visual-basic-example"></a><span data-ttu-id="f2945-110">Visual Basic Beispiel</span><span class="sxs-lookup"><span data-stu-id="f2945-110">Visual Basic Example</span></span>
...
## <a name="c-example"></a><span data-ttu-id="f2945-111">C++-Beispiel</span><span class="sxs-lookup"><span data-stu-id="f2945-111">C++ Example</span></span>
