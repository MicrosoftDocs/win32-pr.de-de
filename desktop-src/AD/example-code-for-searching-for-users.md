...
---
# <a name="example-code-for-searching-for-users"></a><span data-ttu-id="f2bf4-104">Beispiel Code für die Suche nach Benutzern</span><span class="sxs-lookup"><span data-stu-id="f2bf4-104">Example Code for Searching for Users</span></span>

<span data-ttu-id="f2bf4-105">Die folgenden Codebeispiele suchen nach Benutzern in der Domäne des Benutzerkontos, unter dem der aufrufende Prozess ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="f2bf4-105">The following code examples search for users in the domain of the user account under which the calling process is running.</span></span>

-   [<span data-ttu-id="f2bf4-106">C++-Beispiel</span><span class="sxs-lookup"><span data-stu-id="f2bf4-106">C++ Example</span></span>](#c-example)
-   [<span data-ttu-id="f2bf4-107">Visual Basic Beispiel</span><span class="sxs-lookup"><span data-stu-id="f2bf4-107">Visual Basic Example</span></span>](#visual-basic-example)

## <a name="c-example"></a><span data-ttu-id="f2bf4-108">C++-Beispiel</span><span class="sxs-lookup"><span data-stu-id="f2bf4-108">C++ Example</span></span>

<span data-ttu-id="f2bf4-109">Im folgenden C++-Codebeispiel wird die aktuelle Domäne nach allen Benutzern oder einem bestimmten Benutzer basierend auf einem angegebenen Filter durchsucht.</span><span class="sxs-lookup"><span data-stu-id="f2bf4-109">The following C++ code example searches the current domain for all users, or a specific user based on a specified filter.</span></span>
...
## <a name="visual-basic-example"></a><span data-ttu-id="f2bf4-110">Visual Basic Beispiel</span><span class="sxs-lookup"><span data-stu-id="f2bf4-110">Visual Basic Example</span></span>

<span data-ttu-id="f2bf4-111">Im folgenden Visual Basic Codebeispiel wird die aktuelle Domäne nach Benutzern mit dem angegebenen Nachnamen durchsucht, und die Attribute "Name" und "- [**shedname**](/windows/desktop/ADSchema/a-distinguishedname) " werden für die gefundenen Objekte zurückgegeben.</span><span class="sxs-lookup"><span data-stu-id="f2bf4-111">The following Visual Basic code example searches the current domain for users with the specified surname and returns the name and [**distinguishedName**](/windows/desktop/ADSchema/a-distinguishedname) attributes for the objects that are found.</span></span> <span data-ttu-id="f2bf4-112">Im folgenden Codebeispiel wird ADO verwendet, um die Suche auszuführen.</span><span class="sxs-lookup"><span data-stu-id="f2bf4-112">The following code example uses ADO to perform the search.</span></span>
