...
---
# <a name="example-code-for-searching-for-schema-objects"></a><span data-ttu-id="46b86-104">Beispiel Code für die Suche nach Schema Objekten</span><span class="sxs-lookup"><span data-stu-id="46b86-104">Example Code for Searching for Schema Objects</span></span>

<span data-ttu-id="46b86-105">Dieses Thema enthält ein Codebeispiel, das für die Suche nach Schema Objekten verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="46b86-105">This topic includes a code example used to search for schema objects.</span></span>

<span data-ttu-id="46b86-106">Im folgenden C++-Codebeispiel wird gezeigt, wie nach Schema Objekten gesucht werden kann, deren Bits im **systemFlags** -Attribut festgelegt ist.</span><span class="sxs-lookup"><span data-stu-id="46b86-106">The following C++ code example shows how to search for schema objects that have bits set in the **systemFlags** attribute.</span></span>
...
<span data-ttu-id="46b86-107">Im folgenden C-und C++-Codebeispiel wird gezeigt, wie nach Schema Objekten gesucht wird, die im globalen Katalog repliziert werden.</span><span class="sxs-lookup"><span data-stu-id="46b86-107">The following C and C++ code example shows how to search for schema objects replicated to the global catalog.</span></span>
...
<span data-ttu-id="46b86-108">Im folgenden C-und C++-Codebeispiel wird gezeigt, wie nach indizierten Schema Objekten gesucht wird.</span><span class="sxs-lookup"><span data-stu-id="46b86-108">The following C and C++ code example shows how to search for indexed schema objects.</span></span>
