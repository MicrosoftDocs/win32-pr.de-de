---
title: Beispiel Code für das Festlegen von Leseeigenschaften rechten für ein Objekt
description: Das folgende Codebeispiel enthält eine Funktion, die einen ACE erstellt, der dem angegebenen Vertrauens nehmer Lesezugriff auf alle Eigenschaften des Objekts zuweist.
ms.assetid: 343538d7-fef4-492d-a385-37433ce1250b
ms.tgt_platform: multiple
keywords:
- Active Directory Beispiele Active Directory, Festlegen der Berechtigung zum Lesen von Eigenschaften für ein Objekt
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103707637"
---
# <a name="example-code-for-setting-read-property-rights-on-an-object"></a><span data-ttu-id="138da-104">Beispiel Code für das Festlegen von Leseeigenschaften rechten für ein Objekt</span><span class="sxs-lookup"><span data-stu-id="138da-104">Example Code for Setting Read Property Rights on an Object</span></span>

<span data-ttu-id="138da-105">Das folgende Codebeispiel enthält eine Funktion, die einen ACE erstellt, der dem angegebenen Vertrauens nehmer Lesezugriff auf alle Eigenschaften des Objekts zuweist.</span><span class="sxs-lookup"><span data-stu-id="138da-105">The following code example contains a function that creates an ACE that assigns read access to all properties of the object to the specified trustee.</span></span>
