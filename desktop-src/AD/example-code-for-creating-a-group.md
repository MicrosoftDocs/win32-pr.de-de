---
title: Beispiel Code für das Erstellen einer Gruppe
description: Dieses Thema enthält einen Codebeispiel Code, der eine Gruppe erstellt.
ms.assetid: f6bba6fc-fec2-4dd9-b7f2-da7782a6caa5
ms.tgt_platform: multiple
keywords:
- Active Directory Beispiele Active Directory, Erstellen einer Gruppe
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104470893"
---
# <a name="example-code-for-creating-a-group"></a><span data-ttu-id="3570c-104">Beispiel Code für das Erstellen einer Gruppe</span><span class="sxs-lookup"><span data-stu-id="3570c-104">Example Code for Creating a Group</span></span>

<span data-ttu-id="3570c-105">Das folgende C++-Codebeispiel enthält eine Funktion, die eine Gruppe erstellt, die nur die wesentlichen Eigenschaften explizit festgelegt hat (**CN**, **samAccountType**, **GroupType**) und keine Member enthält.</span><span class="sxs-lookup"><span data-stu-id="3570c-105">The following C++ code example contains a function that creates a group with only the essential properties explicitly set (**cn**, **sAMAccountType**, **groupType**) and containing no members.</span></span>
...
<span data-ttu-id="3570c-106">Im folgenden Visual Basic Codebeispiel wird eine Gruppe erstellt, die nur die wesentlichen Eigenschaften explizit festgelegt hat (**CN**, **samAccountType**, **GroupType**) und keine Member enthält.</span><span class="sxs-lookup"><span data-stu-id="3570c-106">The following Visual Basic code example creates a group with only the essential properties explicitly set (**cn**, **sAMAccountType**, **groupType**) and containing no members.</span></span>
