...
---
# <a name="example-code-for-binding-to-well-known-objects"></a><span data-ttu-id="f9c91-104">Beispiel Code für die Bindung an bekannte Objekte</span><span class="sxs-lookup"><span data-stu-id="f9c91-104">Example Code for Binding to Well Known Objects</span></span>

<span data-ttu-id="f9c91-105">Im folgenden C++-Codebeispiel wird gezeigt, wie mithilfe der wkguid-Bindungs Zeichenfolge eine Bindung an ein bekanntes Objekt hergestellt wird.</span><span class="sxs-lookup"><span data-stu-id="f9c91-105">The following C++ code example shows how to bind to a well-known object using the WKGUID binding string.</span></span>
