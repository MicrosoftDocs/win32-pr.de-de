...
---
# <a name="example-code-for-determining-the-operation-mode"></a><span data-ttu-id="b3708-104">Beispiel Code für die Bestimmung des Betriebsmodus</span><span class="sxs-lookup"><span data-stu-id="b3708-104">Example Code for Determining the Operation Mode</span></span>

<span data-ttu-id="b3708-105">Dieses Thema enthält ein Codebeispiel, in dem die **nTMixedDomain** -Eigenschaft einer Domäne gelesen und der Betriebsmodus bestimmt wird.</span><span class="sxs-lookup"><span data-stu-id="b3708-105">This topic includes a code example that reads the **ntMixedDomain** property of a domain and determines the operation mode.</span></span>

<span data-ttu-id="b3708-106">Im folgenden C++-Codebeispiel wird die **nTMixedDomain** -Eigenschaft einer Domäne gelesen und der Betriebsmodus bestimmt.</span><span class="sxs-lookup"><span data-stu-id="b3708-106">The following C++ code example reads the **ntMixedDomain** property of a domain and determines the operation mode.</span></span>
...
<span data-ttu-id="b3708-107">Im folgenden Visual Basic Codebeispiel wird die **nTMixedDomain** -Eigenschaft einer Domäne gelesen und der Betriebsmodus bestimmt.</span><span class="sxs-lookup"><span data-stu-id="b3708-107">The following Visual Basic code example reads the **ntMixedDomain** property of a domain and determines the operation mode.</span></span>
...
<span data-ttu-id="b3708-108">Im folgenden Visual Basic Scripting Edition Codebeispiel wird die **nTMixedDomain** -Eigenschaft einer Domäne gelesen und der Betriebsmodus bestimmt.</span><span class="sxs-lookup"><span data-stu-id="b3708-108">The following Visual Basic Scripting Edition code example reads the **ntMixedDomain** property of a domain and determines the operation mode.</span></span>
