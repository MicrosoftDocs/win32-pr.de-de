---
title: Beispiel Code zum Entfernen des RNR-Verbindungs Punkts
description: Das folgende Codebeispiel wird vom Winsock-Dienst Codebeispiel verwendet, um die Registrierung des RNR-Verbindungs Punkts für den-Dienst aufzuheben.
ms.assetid: eee9b8b0-8566-442a-9a46-b6469e5bb1fc
ms.tgt_platform: multiple
keywords:
- Beispiel Code zum Entfernen des RNR-Verbindungspunkt-AD
- Windows Sockets-Registrierungs-und Auflösungs-AD, Beispiel Code, Entfernen des RNR-Verbindungs Punkts
- Entfernen der RNR-Verbindungspunkt Anzeige, Beispiel Code
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104387977"
---
# <a name="example-code-for-removing-the-rnr-connection-point"></a><span data-ttu-id="ccfd1-106">Beispiel Code zum Entfernen des RNR-Verbindungs Punkts</span><span class="sxs-lookup"><span data-stu-id="ccfd1-106">Example Code for Removing the RnR Connection Point</span></span>

<span data-ttu-id="ccfd1-107">Das folgende Codebeispiel wird vom Winsock-Dienst Codebeispiel verwendet, um die Registrierung des RNR-Verbindungs Punkts für den-Dienst aufzuheben.</span><span class="sxs-lookup"><span data-stu-id="ccfd1-107">The following code example is used by the Winsock service code example to unregister the RnR connection point for the service.</span></span>
