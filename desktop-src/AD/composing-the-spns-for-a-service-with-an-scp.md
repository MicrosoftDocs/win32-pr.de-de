---
title: Zusammenstellen der SPNs für einen Dienst mit einem SCP
description: Im folgenden Codebeispiel wird ein SPN für einen Dienst erstellt, der einen Dienstverbindungspunkt (Service Connection Point, SCP) verwendet.
ms.assetid: cbaa11ba-d32b-46cf-86a4-9050bb1be3a6
ms.tgt_platform: multiple
keywords:
- Zusammenstellen der SPNs für einen Dienst mit einem SCP AD
- Dienstprinzipalname AD , Zusammenstellen von SPNs für einen Dienst mit einem SCP
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118022220"
---
# <a name="composing-the-spns-for-a-service-with-an-scp"></a>Zusammenstellen der SPNs für einen Dienst mit einem SCP
...
" &lt; service class " and " service name " entsprechen den &gt; &lt; &gt; *Parametern pszDNofSCP* und *pszServiceClass.* " &lt; host " verwendet standardmäßig den &gt; DNS-Namen des lokalen Computers.
