...
---
# <a name="example-code-for-extending-the-schema-programmatically"></a><span data-ttu-id="59cf7-105">Beispiel Code für die programmgesteuerte Erweiterung des Schemas</span><span class="sxs-lookup"><span data-stu-id="59cf7-105">Example Code for Extending the Schema Programmatically</span></span>

<span data-ttu-id="59cf7-106">Dieses Thema enthält ein C++-Codebeispiel, das das Active Directory Schema Programm gesteuert erweitert.</span><span class="sxs-lookup"><span data-stu-id="59cf7-106">This topic includes a C++ code example that programmatically extends the Active Directory Schema.</span></span>
