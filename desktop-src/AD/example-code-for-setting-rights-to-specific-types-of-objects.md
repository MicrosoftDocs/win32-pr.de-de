...
---
# <a name="example-code-for-setting-rights-to-specific-types-of-objects"></a><span data-ttu-id="b4476-104">Beispiel Code für das Festlegen von Rechten für bestimmte Objekttypen</span><span class="sxs-lookup"><span data-stu-id="b4476-104">Example Code for Setting Rights to Specific Types of Objects</span></span>

<span data-ttu-id="b4476-105">Im folgenden C/C++-Codebeispiel wird ein ACE erstellt, der Rechte zuweist, die vom angegebenen Objekttyp geerbt werden, aber nicht für das aktuelle Objekt gültig sind.</span><span class="sxs-lookup"><span data-stu-id="b4476-105">The following C/C++ code example creates an ACE that assigns rights that are inherited by the specified type of object, but are not effective on the current object.</span></span>
