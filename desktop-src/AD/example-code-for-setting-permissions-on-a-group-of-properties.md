---
title: Beispiel Code für das Festlegen von Berechtigungen für eine Gruppe von Eigenschaften
description: In den folgenden C-und C++-Codebeispielen wird ein ACE erstellt, der dem angegebenen Vertrauens nehmer Lese-und Schreibzugriff auf die Attribute des Eigenschaften Satzes für persönliche Informationen von Benutzer Objekten zuweist.
...
ms.locfileid: "103948572"
---
# <a name="example-code-for-setting-permissions-on-a-group-of-properties"></a><span data-ttu-id="c0de5-104">Beispiel Code für das Festlegen von Berechtigungen für eine Gruppe von Eigenschaften</span><span class="sxs-lookup"><span data-stu-id="c0de5-104">Example Code for Setting Permissions on a Group of Properties</span></span>

<span data-ttu-id="c0de5-105">In den folgenden C-und C++-Codebeispielen wird ein ACE erstellt, der dem angegebenen Vertrauens nehmer Lese-und Schreibzugriff auf die Attribute des Eigenschaften Satzes für [**persönliche Informationen**](/windows/desktop/ADSchema/r-personal-information) von Benutzer Objekten zuweist.</span><span class="sxs-lookup"><span data-stu-id="c0de5-105">The following C and C++ code examples create an ACE that assigns read and write access to the attributes of the [**Personal Information**](/windows/desktop/ADSchema/r-personal-information) property set of user objects to the specified trustee.</span></span>
