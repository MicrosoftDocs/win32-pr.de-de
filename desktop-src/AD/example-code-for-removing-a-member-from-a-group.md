...
---
# <a name="example-code-for-removing-a-member-from-a-group"></a>Beispiel Code zum Entfernen eines Mitglieds aus einer Gruppe

Das folgende Codebeispiel enthält eine Funktion, mit der ein Mitglied aus einer Gruppe entfernt wird.
