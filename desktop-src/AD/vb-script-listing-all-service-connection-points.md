---
title: VB-Skript, das alle Dienst Verbindungspunkte auflistet
ms.assetid: 7a76f872-3e4e-4bb7-8f2d-e30b1246369f
ms.tgt_platform: multiple
description: 'Weitere Informationen: VB-Skript Auflistung aller Dienst Verbindungspunkte'
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "104483003"
---
# <a name="vb-script-listing-all-service-connection-points"></a><span data-ttu-id="aa30d-103">VB-Skript, das alle Dienst Verbindungspunkte auflistet</span><span class="sxs-lookup"><span data-stu-id="aa30d-103">VB Script Listing all Service Connection Points</span></span>

<span data-ttu-id="aa30d-104">Dienst Verbindungspunkte können mithilfe von VB-Skripts verwaltet werden.</span><span class="sxs-lookup"><span data-stu-id="aa30d-104">Service Connection Points can be managed using VB Script.</span></span> <span data-ttu-id="aa30d-105">Der folgende Beispielcode zeigt, wie alle Dienst Verbindungspunkte auf dem Domänen Namen in der Befehlszeile aufgelistet werden:</span><span class="sxs-lookup"><span data-stu-id="aa30d-105">The following sample code shows how to list all Service Connection Points on the domain name provided on the command line:</span></span>
