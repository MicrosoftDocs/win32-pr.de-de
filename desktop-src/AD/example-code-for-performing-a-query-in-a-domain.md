---
title: Beispiel Code für die Suche nach Gruppen in einer Domäne
description: Dieses Thema enthält ein Codebeispiel, in dem die Teilstruktur des angegebenen Containers nach allen Gruppen Objekten durchsucht wird, die über den angegebenen Gruppentyp verfügen.
ms.assetid: 07b27324-4f59-42c2-a42f-8c2cef138928
ms.tgt_platform: multiple
keywords:
- Active Directory Beispiele Active Directory, suchen nach Gruppen in einer Domäne
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103947388"
---
# <a name="example-code-for-searching-for-groups-in-a-domain"></a><span data-ttu-id="48bf4-104">Beispiel Code für die Suche nach Gruppen in einer Domäne</span><span class="sxs-lookup"><span data-stu-id="48bf4-104">Example Code for Searching for Groups in a Domain</span></span>

<span data-ttu-id="48bf4-105">Im folgenden C/C++-Codebeispiel wird die Teilstruktur des angegebenen Containers nach allen Gruppen Objekten, die über den angegebenen Gruppentyp verfügen, durchsucht.</span><span class="sxs-lookup"><span data-stu-id="48bf4-105">The following C/C++ code example searches the subtree of the specified container for all group objects that have the specified group type.</span></span>
...
<span data-ttu-id="48bf4-106">Im folgenden Visual Basic Codebeispiel wird die Teilstruktur des angegebenen Containers nach allen Gruppen Objekten durchsucht, die den angegebenen Gruppentyp aufweisen.</span><span class="sxs-lookup"><span data-stu-id="48bf4-106">The following Visual Basic code example searches the subtree of the specified container for all group objects that have the specified group type.</span></span>
