---
title: Beispiel Code für das Auflisten von lokalen Gruppen
description: Dieses Thema enthält ein Codebeispiel, das alle Objekte einer angegebenen Klasse auflistet.
ms.assetid: d113d132-24cf-4319-826b-0d3d10e432f6
ms.tgt_platform: multiple
keywords:
- Active Directory Beispiele Active Directory, Auflisten von lokalen Gruppen
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103724529"
---
# <a name="example-code-for-enumerating-local-groups"></a><span data-ttu-id="3b203-104">Beispiel Code für das Auflisten von lokalen Gruppen</span><span class="sxs-lookup"><span data-stu-id="3b203-104">Example Code for Enumerating Local Groups</span></span>

<span data-ttu-id="3b203-105">Dieses Thema enthält ein Codebeispiel, das alle Objekte einer angegebenen Klasse auflistet.</span><span class="sxs-lookup"><span data-stu-id="3b203-105">This topic includes a code example that enumerates all objects of a specified class.</span></span>

<span data-ttu-id="3b203-106">Im folgenden C++-Codebeispiel werden alle Objekte einer angegebenen Klasse mithilfe von ADSI aufgelistet.</span><span class="sxs-lookup"><span data-stu-id="3b203-106">The following C++ code example enumerates all objects of a specified class using ADSI.</span></span>
...
<span data-ttu-id="3b203-107">Im folgenden Visual Basic Codebeispiel werden lokale Gruppen mithilfe der [**IADsContainer**](/windows/desktop/api/iads/nn-iads-iadscontainer) -Schnittstelle und der [**IADsGroup**](/windows/desktop/api/iads/nn-iads-iadsgroup) -Schnittstelle aufgelistet.</span><span class="sxs-lookup"><span data-stu-id="3b203-107">The following Visual Basic code example enumerates local groups using the [**IADsContainer**](/windows/desktop/api/iads/nn-iads-iadscontainer) and [**IADsGroup**](/windows/desktop/api/iads/nn-iads-iadsgroup) interfaces.</span></span>
