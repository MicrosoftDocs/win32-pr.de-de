...
---
# <a name="example-code-for-enumerating-schema-classes-attributes-and-syntaxes"></a><span data-ttu-id="4172b-104">Beispiel Code für das Auflisten von Schema Klassen, Attributen und Syntaxen</span><span class="sxs-lookup"><span data-stu-id="4172b-104">Example Code for Enumerating Schema Classes, Attributes, and Syntaxes</span></span>

<span data-ttu-id="4172b-105">Im folgenden C++ Beispiel wird gezeigt, wie die Klassen, Attribute und Syntaxen im abstrakten Schema aufgelistet werden.</span><span class="sxs-lookup"><span data-stu-id="4172b-105">The following C++ example shows how to enumerate the classes, attributes, and syntaxes in the abstract schema.</span></span>
...
<span data-ttu-id="4172b-106">Im folgenden Visual Basic Codebeispiel wird das abstrakte Schema zum Aufzählen der Struktur-, abstrakten und hilfsobjektklassen gelesen.</span><span class="sxs-lookup"><span data-stu-id="4172b-106">The following Visual Basic code example reads the abstract schema to enumerate the structural, abstract, and auxiliary object classes.</span></span> <span data-ttu-id="4172b-107">Im Beispiel werden dann die einwertigen und mehrwertigen Attribut Klassen aufgelistet.</span><span class="sxs-lookup"><span data-stu-id="4172b-107">The example then enumerates the single-valued and multi-valued attribute classes.</span></span>
