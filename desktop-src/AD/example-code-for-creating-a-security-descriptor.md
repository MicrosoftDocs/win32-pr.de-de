...
---
# <a name="example-code-for-creating-a-security-descriptor"></a><span data-ttu-id="db841-104">Beispiel Code zum Erstellen einer Sicherheits Beschreibung</span><span class="sxs-lookup"><span data-stu-id="db841-104">Example Code for Creating a Security Descriptor</span></span>

<span data-ttu-id="db841-105">Dieses Thema enthält ein Visual Basic Codebeispiel, in dem veranschaulicht wird, wie Sie ein Sicherheits beschreibungerobjekt für ein ADSI-Objekt erstellen.</span><span class="sxs-lookup"><span data-stu-id="db841-105">This topic includes a Visual Basic code example that shows you how to create a security descriptor object for an ADSI object.</span></span>
