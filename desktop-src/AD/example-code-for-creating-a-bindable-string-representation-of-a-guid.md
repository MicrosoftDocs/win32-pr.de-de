...
---
# <a name="example-code-for-creating-a-bindable-string-representation-of-a-guid"></a><span data-ttu-id="ab079-104">Beispiel Code zum Erstellen einer bindbaren Zeichen folgen Darstellung einer GUID</span><span class="sxs-lookup"><span data-stu-id="ab079-104">Example Code for Creating a Bindable String Representation of a GUID</span></span>

<span data-ttu-id="ab079-105">Das folgende Codebeispiel kann verwendet werden, um eine Zeichen folgen Darstellung einer GUID zurückzugeben, die zum Binden an das-Objekt verwendet werden kann.</span><span class="sxs-lookup"><span data-stu-id="ab079-105">The following code example can be used to return a string representation of a GUID that can be used to bind to the object.</span></span>
