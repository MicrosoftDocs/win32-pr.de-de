...
---
# <a name="modifying-the-defaultsecuritydescriptor-for-an-object-class"></a><span data-ttu-id="396b5-106">Ändern von defaultSecurityDescriptor für eine Objektklasse</span><span class="sxs-lookup"><span data-stu-id="396b5-106">Modifying the defaultSecurityDescriptor for an Object Class</span></span>

<span data-ttu-id="396b5-107">Im folgenden Codebeispiel wird die Standard Sicherheits Beschreibung für eine Objektklasse abgerufen, ein ACE der DACL hinzugefügt und dann die geänderte Sicherheits Beschreibung für die Objektklasse festgelegt.</span><span class="sxs-lookup"><span data-stu-id="396b5-107">The following code example retrieves the default security descriptor for an object class, adds an ACE to the DACL, and then sets the modified security descriptor on the object class.</span></span>

<span data-ttu-id="396b5-108">Beachten Sie, dass die Schema Änderung standardmäßig auf allen Windows 2000-Domänen Controllern deaktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="396b5-108">Be aware that schema modification is disabled, by default, on all Windows 2000 domain controllers.</span></span> <span data-ttu-id="396b5-109">Um die Schema Änderung an einem bestimmten Domänen Controller zu aktivieren, legen Sie \_ unter dem folgenden Registrierungsschlüssel einen reg DWORD-Wert mit dem Namen "Schema Update zulässig" fest:</span><span class="sxs-lookup"><span data-stu-id="396b5-109">To enable schema modification at a particular DC, set a REG\_DWORD value named "Schema Update Allowed" under the following registry key:</span></span>

<span data-ttu-id="396b5-110">**HKEY \_ Lokales \_ Computer** \\ **System** \\ **CurrentControlSet** \\ **Services** \\ **NTDS**- \\ **Parameter**</span><span class="sxs-lookup"><span data-stu-id="396b5-110">**HKEY\_LOCAL\_MACHINE**\\**System**\\**CurrentControlSet**\\**Services**\\**NTDS**\\**Parameters**</span></span>

<span data-ttu-id="396b5-111">Fügen Sie diesen Wert hinzu, wenn er nicht bereits vorhanden ist.</span><span class="sxs-lookup"><span data-stu-id="396b5-111">Add this value if it does not already exist.</span></span> <span data-ttu-id="396b5-112">Legen Sie diesen Wert auf 1 fest, um die Schema Änderung zu aktivieren.</span><span class="sxs-lookup"><span data-stu-id="396b5-112">Set this value to 1 to enable schema modification.</span></span> <span data-ttu-id="396b5-113">Wenn dieser Wert 0 (null) ist, ist die Schema Änderung deaktiviert.</span><span class="sxs-lookup"><span data-stu-id="396b5-113">If this value is zero, schema modification is disabled.</span></span> <span data-ttu-id="396b5-114">Das MMC-Snap-in "Schema-Manager" stellt ein Kontrollkästchen bereit, mit dem dieser Registrierungsschlüssel ausgewählt oder gelöscht wird.</span><span class="sxs-lookup"><span data-stu-id="396b5-114">The Schema Manager MMC snap-in provides a check box that selects or clears this registry key.</span></span>
