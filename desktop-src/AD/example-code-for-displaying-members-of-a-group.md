---
title: Beispiel Code zum Anzeigen von Mitgliedern einer Gruppe
description: Dieses Thema enthält Codebeispiele, in denen Mitglieder einer Gruppe angezeigt werden.
ms.assetid: 0c066bf2-65ab-47fd-bf1e-0b3192d3b4c4
ms.tgt_platform: multiple
keywords:
- Active Directory Beispiele Active Directory, Anzeigen von Mitgliedern einer Gruppe
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104038754"
---
# <a name="example-code-for-displaying-members-of-a-group"></a><span data-ttu-id="486f4-104">Beispiel Code zum Anzeigen von Mitgliedern einer Gruppe</span><span class="sxs-lookup"><span data-stu-id="486f4-104">Example Code for Displaying Members of a Group</span></span>

<span data-ttu-id="486f4-105">Dieses Thema enthält Codebeispiele, in denen Mitglieder einer Gruppe angezeigt werden.</span><span class="sxs-lookup"><span data-stu-id="486f4-105">This topic includes code examples that display members of a group.</span></span>

<span data-ttu-id="486f4-106">Im folgenden C++-Codebeispiel werden die Member einer Gruppe mithilfe der [**IADsGroup**](/windows/desktop/api/iads/nn-iads-iadsgroup) -Klasse und der [**iadsmembers**](/windows/desktop/api/iads/nn-iads-iadsmembers) -Klasse angezeigt.</span><span class="sxs-lookup"><span data-stu-id="486f4-106">The following C++ code example uses the [**IADsGroup**](/windows/desktop/api/iads/nn-iads-iadsgroup) and [**IADsMembers**](/windows/desktop/api/iads/nn-iads-iadsmembers) classes to display the members of a group.</span></span>
...
<span data-ttu-id="486f4-107">Im folgenden Visual Basic Codebeispiel wird die [**IADs**](/windows/desktop/api/iads/nn-iads-iads) -Klasse verwendet, um die Gruppenmitglieder anzuzeigen.</span><span class="sxs-lookup"><span data-stu-id="486f4-107">The following Visual Basic code example uses the [**IADs**](/windows/desktop/api/iads/nn-iads-iads) class to display the group members.</span></span>
