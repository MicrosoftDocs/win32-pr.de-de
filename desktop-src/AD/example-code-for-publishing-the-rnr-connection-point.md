...
---
# <a name="example-code-for-publishing-the-rnr-connection-point"></a><span data-ttu-id="fa9c7-106">Beispiel Code zum Veröffentlichen des RNR-Verbindungs Punkts</span><span class="sxs-lookup"><span data-stu-id="fa9c7-106">Example Code for Publishing the RnR Connection Point</span></span>

<span data-ttu-id="fa9c7-107">Das folgende Codebeispiel wird vom Winsock-Dienst verwendet, um den RNR-Verbindungspunkt für den Dienst zu registrieren.</span><span class="sxs-lookup"><span data-stu-id="fa9c7-107">The following code example is used by the Winsock service to register the RnR connection point for the service.</span></span>
