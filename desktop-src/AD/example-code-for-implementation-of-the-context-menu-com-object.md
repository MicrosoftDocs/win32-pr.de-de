...
---
# <a name="example-code-for-implementation-of-the-context-menu-com-object"></a>Beispiel Code für die Implementierung des Kontextmenü-com-Objekts

Das folgende Codebeispiel kann verwendet werden, um eine Active Directory Kontextmenüerweiterung zu implementieren. Mit dem Kontextmenü Element wird ein Meldungs Feld angezeigt, das den ADsPath der einzelnen ausgewählten Elemente enthält.

## <a name="ishellextinit-implementation"></a>Ishellextinit-Implementierung

Das folgende Codebeispiel kann verwendet werden, um die [**ishellextinit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) -Methoden zu implementieren.
...
## <a name="icontextmenu-implementation"></a>IContextMenu-Implementierung

Das folgende Codebeispiel kann verwendet werden, um die [**IContextMenu**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-icontextmenu) -Methoden zu implementieren.
