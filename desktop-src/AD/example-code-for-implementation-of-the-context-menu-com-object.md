---
title: Beispiel Code für die Implementierung des Kontextmenü-com-Objekts
description: Das folgende Codebeispiel kann verwendet werden, um eine Active Directory Kontextmenüerweiterung zu implementieren. Mit dem Kontextmenü Element wird ein Meldungs Feld angezeigt, das den ADsPath der einzelnen ausgewählten Elemente enthält.
ms.assetid: dc8f2c31-6031-4c7d-a173-5cedcedbfb26
ms.tgt_platform: multiple
keywords:
- Active Directory AD, Beispielcode C/C++, Implementierung des Kontextmenü-com-Objekts
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104038753"
---
# <a name="example-code-for-implementation-of-the-context-menu-com-object"></a><span data-ttu-id="f2a30-105">Beispiel Code für die Implementierung des Kontextmenü-com-Objekts</span><span class="sxs-lookup"><span data-stu-id="f2a30-105">Example Code for Implementation of the Context Menu COM Object</span></span>

<span data-ttu-id="f2a30-106">Das folgende Codebeispiel kann verwendet werden, um eine Active Directory Kontextmenüerweiterung zu implementieren.</span><span class="sxs-lookup"><span data-stu-id="f2a30-106">The following code example can be used to implement an Active Directory context menu extension.</span></span> <span data-ttu-id="f2a30-107">Mit dem Kontextmenü Element wird ein Meldungs Feld angezeigt, das den ADsPath der einzelnen ausgewählten Elemente enthält.</span><span class="sxs-lookup"><span data-stu-id="f2a30-107">The single context menu item will display a message box that contains the ADsPath of each item selected.</span></span>

## <a name="ishellextinit-implementation"></a><span data-ttu-id="f2a30-108">Ishellextinit-Implementierung</span><span class="sxs-lookup"><span data-stu-id="f2a30-108">IShellExtInit Implementation</span></span>

<span data-ttu-id="f2a30-109">Das folgende Codebeispiel kann verwendet werden, um die [**ishellextinit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) -Methoden zu implementieren.</span><span class="sxs-lookup"><span data-stu-id="f2a30-109">The following code example can be used to implement the [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) methods.</span></span>
...
## <a name="icontextmenu-implementation"></a><span data-ttu-id="f2a30-110">IContextMenu-Implementierung</span><span class="sxs-lookup"><span data-stu-id="f2a30-110">IContextMenu Implementation</span></span>

<span data-ttu-id="f2a30-111">Das folgende Codebeispiel kann verwendet werden, um die [**IContextMenu**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-icontextmenu) -Methoden zu implementieren.</span><span class="sxs-lookup"><span data-stu-id="f2a30-111">The following code example can be used to implement the [**IContextMenu**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-icontextmenu) methods.</span></span>
