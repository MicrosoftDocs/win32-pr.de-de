---
title: Beispiel Code für das Löschen einer Anwendungsverzeichnis Partition
description: Dieses Thema enthält Codebeispiele, die zum Löschen einer Anwendungsverzeichnis Partition verwendet werden.
ms.assetid: 74eb46a1-9300-452a-86b6-a19aff58a4f0
ms.tgt_platform: multiple
keywords:
- Beispielcode für das Löschen einer Anwendungsverzeichnis Partition Active Directory
- Anwendungsverzeichnis Partitionen Active Directory, Beispielcode für das Löschen
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103858147"
---
# <a name="example-code-for-deleting-an-application-directory-partition"></a><span data-ttu-id="0a42a-105">Beispiel Code für das Löschen einer Anwendungsverzeichnis Partition</span><span class="sxs-lookup"><span data-stu-id="0a42a-105">Example Code for Deleting an Application Directory Partition</span></span>

<span data-ttu-id="0a42a-106">Das folgende C++-Codebeispiel kann verwendet werden, um eine Anwendungsverzeichnis Partition mithilfe von ADSI zu löschen.</span><span class="sxs-lookup"><span data-stu-id="0a42a-106">The following C++ code example can be used to delete an application directory partition using ADSI.</span></span> <span data-ttu-id="0a42a-107">In diesem Beispiel wird eine der **getpartitionsdn \*** -Beispiel Funktionen verwendet, [die im Beispiel Code für die Suche nach dem Partitions Container](example-code-for-locating-the-partitions-container.md)beschrieben werden.</span><span class="sxs-lookup"><span data-stu-id="0a42a-107">This example uses one of the **GetPartitionsDN\*** example functions described in [Example Code for Locating the Partitions Container](example-code-for-locating-the-partitions-container.md).</span></span>
...
<span data-ttu-id="0a42a-108">Das folgende Visual Basic Scripting Edition Codebeispiel kann verwendet werden, um eine Anwendungsverzeichnis Partition mithilfe von ADSI zu löschen.</span><span class="sxs-lookup"><span data-stu-id="0a42a-108">The following Visual Basic Scripting Edition code example can be used to delete an application directory partition using ADSI.</span></span> <span data-ttu-id="0a42a-109">In diesem Beispiel wird eine der **getpartitionsdn \*** -Beispiel Funktionen verwendet, [die im Beispiel Code für die Suche nach dem Partitions Container](example-code-for-locating-the-partitions-container.md)beschrieben werden.</span><span class="sxs-lookup"><span data-stu-id="0a42a-109">This example uses one of the **GetPartitionsDN\*** example functions described in [Example Code for Locating the Partitions Container](example-code-for-locating-the-partitions-container.md).</span></span>
...
<span data-ttu-id="0a42a-110">Das folgende c#-Codebeispiel kann verwendet werden, um eine Anwendungsverzeichnis Partition mithilfe von [System. directoriyservices](/dotnet/api/system.directoryservices)zu löschen.</span><span class="sxs-lookup"><span data-stu-id="0a42a-110">The following C# code example can be used to delete an application directory partition using [System.DirectoryServices](/dotnet/api/system.directoryservices).</span></span> <span data-ttu-id="0a42a-111">In diesem Beispiel wird eine der **getpartitionsdn \*** -Beispiel Funktionen verwendet, [die im Beispiel Code für die Suche nach dem Partitions Container](example-code-for-locating-the-partitions-container.md)beschrieben werden.</span><span class="sxs-lookup"><span data-stu-id="0a42a-111">This example uses one of the **GetPartitionsDN\*** example functions described in [Example Code for Locating the Partitions Container](example-code-for-locating-the-partitions-container.md).</span></span>
...
<span data-ttu-id="0a42a-112">Das folgende Visual Basic .NET-Codebeispiel kann verwendet werden, um eine Anwendungsverzeichnis Partition mithilfe von [System. directoriyservices](/dotnet/api/system.directoryservices)zu löschen.</span><span class="sxs-lookup"><span data-stu-id="0a42a-112">The following Visual Basic .NET code example can be used to delete an application directory partition using [System.DirectoryServices](/dotnet/api/system.directoryservices).</span></span> <span data-ttu-id="0a42a-113">In diesem Beispiel wird eine der **getpartitionsdn \*** -Beispiel Funktionen verwendet, [die im Beispiel Code für die Suche nach dem Partitions Container](example-code-for-locating-the-partitions-container.md)beschrieben werden.</span><span class="sxs-lookup"><span data-stu-id="0a42a-113">This example uses one of the **GetPartitionsDN\*** example functions described in [Example Code for Locating the Partitions Container](example-code-for-locating-the-partitions-container.md).</span></span>
