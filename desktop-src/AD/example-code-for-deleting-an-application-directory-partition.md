...
---
# <a name="example-code-for-deleting-an-application-directory-partition"></a>Beispiel Code für das Löschen einer Anwendungsverzeichnis Partition

Das folgende C++-Codebeispiel kann verwendet werden, um eine Anwendungsverzeichnis Partition mithilfe von ADSI zu löschen. In diesem Beispiel wird eine der **getpartitionsdn \*** -Beispiel Funktionen verwendet, [die im Beispiel Code für die Suche nach dem Partitions Container](example-code-for-locating-the-partitions-container.md)beschrieben werden.
...
Das folgende Visual Basic Scripting Edition Codebeispiel kann verwendet werden, um eine Anwendungsverzeichnis Partition mithilfe von ADSI zu löschen. In diesem Beispiel wird eine der **getpartitionsdn \*** -Beispiel Funktionen verwendet, [die im Beispiel Code für die Suche nach dem Partitions Container](example-code-for-locating-the-partitions-container.md)beschrieben werden.
...
Das folgende c#-Codebeispiel kann verwendet werden, um eine Anwendungsverzeichnis Partition mithilfe von [System. directoriyservices](/dotnet/api/system.directoryservices)zu löschen. In diesem Beispiel wird eine der **getpartitionsdn \*** -Beispiel Funktionen verwendet, [die im Beispiel Code für die Suche nach dem Partitions Container](example-code-for-locating-the-partitions-container.md)beschrieben werden.
...
Das folgende Visual Basic .NET-Codebeispiel kann verwendet werden, um eine Anwendungsverzeichnis Partition mithilfe von [System. directoriyservices](/dotnet/api/system.directoryservices)zu löschen. In diesem Beispiel wird eine der **getpartitionsdn \*** -Beispiel Funktionen verwendet, [die im Beispiel Code für die Suche nach dem Partitions Container](example-code-for-locating-the-partitions-container.md)beschrieben werden.
