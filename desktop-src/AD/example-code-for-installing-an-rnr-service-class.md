...
---
# <a name="example-code-for-installing-an-rnr-service-class"></a><span data-ttu-id="546c8-105">Beispiel Code für die Installation einer RNR-Dienstklasse</span><span class="sxs-lookup"><span data-stu-id="546c8-105">Example Code for Installing an RnR Service Class</span></span>

<span data-ttu-id="546c8-106">Mit dem folgenden Programm wird eine RNR-Dienstklasse installiert.</span><span class="sxs-lookup"><span data-stu-id="546c8-106">The following program installs an RnR Service class.</span></span>
