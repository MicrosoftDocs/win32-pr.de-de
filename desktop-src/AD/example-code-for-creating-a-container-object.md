...
---
# <a name="example-code-for-creating-a-container-object"></a>Beispiel Code für das Erstellen eines Container Objekts

Im folgenden Codebeispiel werden zwei-Objekte erstellt. Zuerst ein Container Objekt und, ein zweites, ein unter Container Objekt. Ein Wert für das unter Container Objekt wird der [**otherWellKnownObjects**](/windows/desktop/ADSchema/a-otherwellknownobjects) -Eigenschaft des Container Objekts hinzugefügt. Das Codebeispiel bindet mithilfe der wkguid-Bindung an das unter Container Objekt und zeigt seinen ADsPath an. Anschließend wird das unter Container Objekt umbenannt und mithilfe derselben wkguid-Bindung wieder gebunden.
