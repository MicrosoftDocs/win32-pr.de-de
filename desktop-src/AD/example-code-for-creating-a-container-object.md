---
title: Beispiel Code für das Erstellen eines Container Objekts
description: Im folgenden Codebeispiel werden zwei-Objekte erstellt.
ms.assetid: bd9a8d62-c8e8-4ee5-86d8-bda5ddeb6e2c
ms.tgt_platform: multiple
keywords:
- Active Directory Beispiele Active Directory, Erstellen eines Container Objekts
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103948577"
---
# <a name="example-code-for-creating-a-container-object"></a><span data-ttu-id="fded2-104">Beispiel Code für das Erstellen eines Container Objekts</span><span class="sxs-lookup"><span data-stu-id="fded2-104">Example Code for Creating a Container Object</span></span>

<span data-ttu-id="fded2-105">Im folgenden Codebeispiel werden zwei-Objekte erstellt.</span><span class="sxs-lookup"><span data-stu-id="fded2-105">The following code example creates two objects.</span></span> <span data-ttu-id="fded2-106">Zuerst ein Container Objekt und, ein zweites, ein unter Container Objekt.</span><span class="sxs-lookup"><span data-stu-id="fded2-106">First, a container object and, second, a sub-container object.</span></span> <span data-ttu-id="fded2-107">Ein Wert für das unter Container Objekt wird der [**otherWellKnownObjects**](/windows/desktop/ADSchema/a-otherwellknownobjects) -Eigenschaft des Container Objekts hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="fded2-107">A value for the sub-container object is added to the [**otherWellKnownObjects**](/windows/desktop/ADSchema/a-otherwellknownobjects) property of the container object.</span></span> <span data-ttu-id="fded2-108">Das Codebeispiel bindet mithilfe der wkguid-Bindung an das unter Container Objekt und zeigt seinen ADsPath an.</span><span class="sxs-lookup"><span data-stu-id="fded2-108">The code example binds to the sub-container object using the WKGUID binding and displays its ADsPath.</span></span> <span data-ttu-id="fded2-109">Anschließend wird das unter Container Objekt umbenannt und mithilfe derselben wkguid-Bindung wieder gebunden.</span><span class="sxs-lookup"><span data-stu-id="fded2-109">It then renames the sub-container object and binds again using the same WKGUID binding.</span></span>
