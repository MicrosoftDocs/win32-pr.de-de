...
---
# <a name="example-code-for-creating-a-user"></a><span data-ttu-id="bb84f-104">Beispiel Code zum Erstellen eines Benutzers</span><span class="sxs-lookup"><span data-stu-id="bb84f-104">Example Code for Creating a User</span></span>

<span data-ttu-id="bb84f-105">Dieses Thema enthält Codebeispiele, in denen ein Benutzer in einer Domäne erstellt wird, die von Active Directory Domain Services gesteuert wird.</span><span class="sxs-lookup"><span data-stu-id="bb84f-105">This topic includes code examples that create a user in a domain controlled by Active Directory Domain Services.</span></span>
