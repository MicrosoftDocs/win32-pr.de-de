...
---
# <a name="example-code-for-enumerating-the-acl-of-an-object-in-active-directory-domain-services"></a><span data-ttu-id="70090-104">Beispiel Code für das Auflisten der ACL eines Objekts in Active Directory Domain Services</span><span class="sxs-lookup"><span data-stu-id="70090-104">Example Code for Enumerating the ACL of an Object in Active Directory Domain Services</span></span>

<span data-ttu-id="70090-105">Die folgenden Codebeispiele können zum Auflisten der Zugriffs Steuerungs Liste (Access Control List, ACL) eines Objekts in Active Directory Domain Services verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="70090-105">The following code examples can be used to enumerate the access control list (ACL) of an object in Active Directory Domain Services.</span></span>

<span data-ttu-id="70090-106">Das folgende Codebeispiel zeigt eine Funktion, die den Treuhänder eines Objekts auflistet.</span><span class="sxs-lookup"><span data-stu-id="70090-106">The following code example shows a function that enumerates the trustees of an object .</span></span>
...
<span data-ttu-id="70090-107">Das folgende Codebeispiel zeigt eine Funktion, die den Treuhänder eines Objekts auflistet.</span><span class="sxs-lookup"><span data-stu-id="70090-107">The following code example shows a function that enumerates the trustees of an object.</span></span>
