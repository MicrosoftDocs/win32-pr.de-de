...
---
# <a name="example-code-for-setting-permissions-on-child-object-operations"></a><span data-ttu-id="17583-104">Beispiel Code für das Festlegen von Berechtigungen für untergeordnete Objekt Vorgänge</span><span class="sxs-lookup"><span data-stu-id="17583-104">Example Code for Setting Permissions on Child Object Operations</span></span>

<span data-ttu-id="17583-105">Im folgenden C-und C++-Codebeispiel wird ein ACE erstellt, der dem angegebenen Vertrauens nehmer Erstellungs Rechte für Benutzer Objekte zuweist.</span><span class="sxs-lookup"><span data-stu-id="17583-105">The following C and C++ code example creates an ACE that assigns creation rights for user objects to the specified trustee.</span></span>
