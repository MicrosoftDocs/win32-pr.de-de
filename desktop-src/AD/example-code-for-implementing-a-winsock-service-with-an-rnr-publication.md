---
title: Beispiel Code für die Implementierung eines Winsock-Dienstanbieter mit einer RNR-Veröffentlichung
description: Im folgenden Codebeispiel wird der Winsock-Beispiel Dienst mit der RNR-Veröffentlichung implementiert.
ms.assetid: 8800ba76-f24c-4aa7-ba31-97eaf884130c
ms.tgt_platform: multiple
keywords:
- Windows Sockets-Registrierungs-und Auflösungs-AD, Beispiel Code, Implementieren eines Winsock-Dienstanbieter mit einer RNR-Veröffentlichung
- Implementieren eines Winsock-Dienstanbieter mit einer RNR-Veröffentlichungs Anzeige, Beispiel Code
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103707649"
---
# <a name="example-code-for-implementing-a-winsock-service-with-an-rnr-publication"></a><span data-ttu-id="8e384-105">Beispiel Code für die Implementierung eines Winsock-Dienstanbieter mit einer RNR-Veröffentlichung</span><span class="sxs-lookup"><span data-stu-id="8e384-105">Example Code for Implementing a Winsock Service with an RnR Publication</span></span>

<span data-ttu-id="8e384-106">Im folgenden Codebeispiel wird der Winsock-Beispiel Dienst mit der RNR-Veröffentlichung implementiert.</span><span class="sxs-lookup"><span data-stu-id="8e384-106">The following code example implements the example Winsock service with RnR publication.</span></span>

<span data-ttu-id="8e384-107">In diesem Beispiel wird die im [Beispielcode zum Veröffentlichen des RNR-Verbindungspunkt](example-code-for-publishing-the-rnr-connection-point.md) Themas definierte **serverregister** -Funktion und die im [Beispielcode zum Entfernen des RNR-Verbindungspunkt](example-code-for-removing-the-rnr-connection-point.md) Themas definierte Funktion " **serverunregister** " verwendet.</span><span class="sxs-lookup"><span data-stu-id="8e384-107">This sample uses the **serverRegister** function defined in the [Example Code for Publishing the RnR Connection Point](example-code-for-publishing-the-rnr-connection-point.md) topic and the **serverUnregister** function defined in the [Example Code for Removing the RnR Connection Point](example-code-for-removing-the-rnr-connection-point.md) topic.</span></span>
