---
title: Beispiel Code für die Suche nach einem Steuerungs Zugriffsrecht in einem ACE
description: Im folgenden C++-Codebeispiel wird ein angegebenes Steuerelement Zugriffsrecht in einem ACE in der ACL des angegebenen Objekts überprüft.
ms.assetid: 03a96c99-eefb-4de5-a4ab-526eca7875cc
ms.tgt_platform: multiple
keywords:
- Beispiel Code für die Überprüfung des Zugriffs auf ein Zugriffsrecht in einer ACE AD
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104036373"
---
# <a name="example-code-for-checking-for-a-control-access-right-in-an-ace"></a><span data-ttu-id="0aa28-104">Beispiel Code für die Suche nach einem Steuerungs Zugriffsrecht in einem ACE</span><span class="sxs-lookup"><span data-stu-id="0aa28-104">Example Code for Checking for a Control Access Right in an ACE</span></span>

<span data-ttu-id="0aa28-105">Im folgenden C++-Codebeispiel wird ein angegebenes Steuerelement Zugriffsrecht in einem ACE in der ACL des angegebenen Objekts überprüft.</span><span class="sxs-lookup"><span data-stu-id="0aa28-105">The following C++ code example verifies a specified control access right in an ACE in the ACL of the specified object.</span></span>
