...
---
# <a name="example-code-for-locating-a-service-using-an-rnr-query"></a><span data-ttu-id="ff370-106">Beispiel Code für die Suche nach einem Dienst mithilfe einer RNR-Abfrage</span><span class="sxs-lookup"><span data-stu-id="ff370-106">Example Code for Locating a Service Using an RnR Query</span></span>

<span data-ttu-id="ff370-107">Im folgenden Codebeispiel wird der Winsock-Beispiel Dienst und eine Verbindung mit dem Beispiel angezeigt.</span><span class="sxs-lookup"><span data-stu-id="ff370-107">The following code example locates the example Winsock service and connects to it.</span></span>
