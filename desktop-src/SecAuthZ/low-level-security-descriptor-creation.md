...
| [**GetSecurityDescriptorGroup**](/windows/win32/api/securitybaseapi/nf-securitybaseapi-getsecuritydescriptorgroup)     | Ruft die Sicherheits-ID (SID) der [*primären*](/windows/desktop/SecGloss/s-gly) Gruppe aus einem Sicherheitsdeskriptor ab. |
