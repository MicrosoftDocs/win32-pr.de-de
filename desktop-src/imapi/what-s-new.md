...
ms.topic: article
ms.date: 05/31/2018
ms.openlocfilehash: 696537e9a27883b35b058e4542b36a63662758094c4f262e07415f38faf9709c
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 08/11/2021
ms.locfileid: "120115030"
---
...
<tr class="odd">
<td>Version 2.0</td>
<td>Ein Großteil der API wurde umgestaltet. Die meisten Funktionen von Version 1.0 sind in Version 2.0 weiterhin verfügbar. Personen, die Imagemasteranwendungen schreiben oder die Entwicklung neuer Geräte und Formate durchführen, sollten version 2.0 anstelle von Version 1.0 verwenden.<br/> IMAPI 2.0 ist in Windows Vista enthalten. Das Aktivieren der gleichen Funktionalität für Windows XP und Windows Server 2003 erfordert die Installation des <a href="https://support.microsoft.com/kb/932716">Updatepakets KB932716.</a><br/> Point-Release Hinweise:<br/>
<ul>
<li>Ein Update, das Multistartunterstützung über die <a href="/windows/desktop/api/imapi2fs/nn-imapi2fs-ifilesystemimage2"><strong>IFileSystemImage2-Schnittstelle</strong></a> bietet, wurde in Windows Vista mit Service Pack 1 (SP1) und Windows Server 2008 eingeführt.<br/></li>
<li>Ein Featureupdate, das mastering-Unterstützung für das BD-R\BD-RE-Format, die Erstellung von UN-CD-Datenträgern beim Einmaligen Erstellen von Images sowie die Überprüfung des Burnings bietet, wurde im <a href="https://www.microsoft.com/downloads/details.aspx?FamilyID=63ab51ea-99c9-45c0-980a-c556746fcf05">Windows Feature Pack für Storage</a>enthalten. Dieses Featureupdate wird auf Windows Vista mit SP1, Windows XP mit Service Pack 2 (SP2) und höher und Windows Server 2003 mit Service Pack 1 (SP1) und höher unterstützt. Darüber hinaus sind diese Features in Windows 7 und Windows Server 2008 enthalten.<br/></li>
<li>ImAPI 2.0-Features, die für Windows 7 und Windows Server 2008 nativ sind, umfassen "GaplessRaps" für Audio-CDs und die Beseitigung von "Double Stashing" bei Burn-Vorgängen. Double Stashing ist ein Prozess innerhalb des größeren Burn-Vorgangs, bei dem jede Datei stasht wird, bevor sie auf den Datenträger geworfen wird. Mit der neuesten Version von IMAPI 2.0 werden Dateien selektiv für das Stashing ausgewählt, sodass die verbleibenden Dateien (größtenteils große Dateien) nicht stasht werden. Das Endergebnis ist gespeicherter Speicherplatz und die Betriebszeit.<br/></li>
</ul></td>
</tr>
<tr class="even">
<td>Version 1.0</td>
<td>Erste Veröffentlichung Ermöglicht es einer Anwendung, ein einfaches Audio- oder Datenbild auf CD-R- und CD-RW-Geräten zu verarbeiten und zu verwerten. Die API unterstützt das Joliet- und ISO 9660-Format für Redbook-Audio- und Datendatenträger. Informationen zu Version 1.0 finden Sie unter <a href="imapiv1.md">IMAPIv1-Unterstützung.</a> In Windows XP enthalten.<br/></td>
</tr>
</tbody>
</table>
...
-   Der Zugriff auf einen Aufzeichnungsdatenträger wird verweigert, wenn der Aufzeichnungsaufzeichnung Informationen auf den Datenträger schreibt. Andernfalls ist die Aufzeichnung für andere Clients verfügbar.
