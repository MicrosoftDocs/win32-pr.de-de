...
---
# <a name="checking-drive-support"></a>Überprüfen der Laufwerk Unterstützung

Im folgenden Beispiel werden die Eigenschaften von Festplatten Geräten überprüft, die unabhängig von den Medien sind, die im Gerät eingefügt wurden. Genauer gesagt, werden Listen mit unterstützten Features, unterstützten Profilen und unterstützten Modus-Seiten sowie die aktuellen Featureeinstellungen und Profile abgerufen.
...
[**IMAPI \_ - \_ Funktions \_ Seitentyp**](/windows/desktop/api/imapi2/ne-imapi2-imapi_feature_page_type)
</dt> <dt>

[**Bild \_ \_ Seitentyp IMAPI-Modus \_**](/windows/desktop/api/imapi2/ne-imapi2-imapi_mode_page_type)
</dt> <dt>

[**IMAPI \_ - \_ Profiltyp**](/windows/desktop/api/imapi2/ne-imapi2-imapi_profile_type)
</dt> </dl>
