---
title: Überprüfen der Medien Unterstützung
description: Das folgende Skript überprüft die Merkmale der auf dem Festplattengerät geladenen Medien.
...
ms.locfileid: "104206600"
---
# <a name="checking-media-support"></a><span data-ttu-id="6d7d2-103">Überprüfen der Medien Unterstützung</span><span class="sxs-lookup"><span data-stu-id="6d7d2-103">Checking Media Support</span></span>

<span data-ttu-id="6d7d2-104">Das folgende Skript überprüft die Merkmale der auf dem Festplattengerät geladenen Medien.</span><span class="sxs-lookup"><span data-stu-id="6d7d2-104">The following script examines characteristics of the media loaded in the disc device.</span></span> <span data-ttu-id="6d7d2-105">Genauer gesagt, werden der Medientyp und der aktuelle Zustand der Medien sowie die Aufzeichnung und die Medienkompatibilität überprüft.</span><span class="sxs-lookup"><span data-stu-id="6d7d2-105">More specifically, it checks the media type and the current state of the media, as well as recorder and media compatibility.</span></span> <span data-ttu-id="6d7d2-106">Dieses Skript kann angepasst werden, um Kompatibilitäts-und Zustands Probleme vor der Verwendung der Medien zu überprüfen.</span><span class="sxs-lookup"><span data-stu-id="6d7d2-106">This script can be adapted to verify compatibility and state issues before using the media.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="6d7d2-107">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="6d7d2-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="6d7d2-108">Verwenden von IMAPI</span><span class="sxs-lookup"><span data-stu-id="6d7d2-108">Using IMAPI</span></span>](using-imapi.md)
</dt> <dt>

[<span data-ttu-id="6d7d2-109">**\_ \_ physischer \_ Typ des IMAPI-Mediums**</span><span class="sxs-lookup"><span data-stu-id="6d7d2-109">**IMAPI\_MEDIA\_PHYSICAL\_TYPE**</span></span>](/windows/desktop/api/imapi2/ne-imapi2-imapi_media_physical_type)
</dt> <dt>

[<span data-ttu-id="6d7d2-110">**IDiscMaster2**</span><span class="sxs-lookup"><span data-stu-id="6d7d2-110">**IDiscMaster2**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscmaster2)
</dt> <dt>

[<span data-ttu-id="6d7d2-111">**IDiscRecorder2**</span><span class="sxs-lookup"><span data-stu-id="6d7d2-111">**IDiscRecorder2**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscrecorder2)
</dt> <dt>

[<span data-ttu-id="6d7d2-112">**IDiscFormat2Data**</span><span class="sxs-lookup"><span data-stu-id="6d7d2-112">**IDiscFormat2Data**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscformat2data)
</dt> </dl>
