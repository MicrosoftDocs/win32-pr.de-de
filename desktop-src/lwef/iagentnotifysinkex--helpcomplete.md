...
Benachrichtigt eine Clientanwendung, wenn der Benutzer einen Befehl oder ein Zeichen auswählt, um den Hilfemodus abzuschließen.
...
Die Ursache für das Ereignis, die möglicherweise die folgenden Werte sind:
...
| **const unsigned short** **CSHELPCAUSE \_ OPENCOMMANDSWINDOW = 3;**<br/>  | Der Benutzer hat den Befehl "Open Voice Commands" ausgewählt.                                   |
...
Dieses Ereignis wird nur an die Clientanwendung gesendet, die das Zeichen in den Hilfemodus versetzt.
