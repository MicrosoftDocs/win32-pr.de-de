...
| <span id="MPUPDATE_OPTION_ASYNC"></span><span id="mpupdate_option_async"></span><dl> <dt>**MPUPDATE \_ OPTION \_ ASYNC**</dt> </dl>             | Der Aktualisierungsvorgang soll asynchron sein, wobei **MpUpdateStart** sofort nach der erfolgreichen Initiierung des Signaturupdates zurückgegeben wird. (Standardmäßig ist der Updatevorgang synchron, d.h. **MpUpdateStart** gibt erst nach Abschluss des Signaturupdates zurück.)<br/> |
...
| <span id="MPUPDATE_OPTION_UNMANAGED"></span><span id="mpupdate_option_unmanaged"></span><dl> <dt>**\_MPUPDATE-OPTION \_ NICHT VERWALTET**</dt> </dl> | Führt die Signaturaktualisierung mithilfe des nicht verwalteten Diensts MU/WU aus.<br/>                                                                                                                                                                                                                          |
...
| <span id="MPNOTIFY_SIGUPDATE_INSTALL_START"></span><span id="mpnotify_sigupdate_install_start"></span><dl> <dt>**MPNOTIFY \_ SIGUPDATE \_ INSTALL \_ START**</dt> </dl>             | Die Installation des Updates wurde gestartet.<br/>                                                                                                                            |
