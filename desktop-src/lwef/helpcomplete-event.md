...
Gibt an, dass der kontextsensitive Hilfemodus beendet wurde.
...
| *Ursache*       | Gibt einen Wert zurück, der angibt, was den Abschluss des Hilfemodus verursacht hat. 1 Der Benutzer hat einen von Ihrer Anwendung bereitgestellten Befehl ausgewählt.<br/> 2 Der Benutzer hat das [**Commands-Objekt**](/windows/desktop/lwef/the-commands-collection-object) eines anderen Clients ausgewählt.<br/> 3 Der Benutzer hat den Befehl Open Voice Commands (Sprachbefehle öffnen) ausgewählt.<br/> 4 Der Benutzer hat den Befehl Sprachbefehle schließen ausgewählt.<br/> 5 Der Benutzer hat den Befehl *Zeichenname anzeigen* ausgewählt.<br/> 6 Der Benutzer hat den Befehl *Zeichenname ausblenden* ausgewählt.<br/> 7 Der Benutzer hat das Zeichen ausgewählt (geklickt).<br/> |
...
Wenn der Server Name als leere Zeichenfolge ("") zurückgibt, bedeutet dies, dass der Benutzer einen vom Server bereitgestellten Befehl ausgewählt hat.
