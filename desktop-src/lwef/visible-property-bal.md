...
| Teil      | BESCHREIBUNG                                                                                                                                                             |
|-----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *boolean* | Ein boolescher Ausdruck, der an gibt, ob das Wort Balloon sichtbar ist.<br/> **True** Die Sprechblase ist sichtbar.<br/> **False** Der Sprechblasen ist ausgeblendet.<br/> |
