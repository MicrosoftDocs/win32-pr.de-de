...
| **GetAttention**          | **GetAttentionReturn**   | Ja               | **Nein**        | Keine                                         | Wellenwaffen                                                 |
| **GetAttentionContinued** | **GetAttentionReturn**   | Ja               | **Nein**        | Keine                                         | Wellensenknappen                                           |
| **GetAttentionReturn**    | Keine                     | Nein                | **Nein**        | Keine                                         | Zurück zur neutralen Position                                |
| **Greet**                 | Ja, Verwenden von Exitbranches | Ja               | **Nein**        | Keine                                         | Hält die Hand                                              |
| **Hörvermögen \_ 1**            | Ja, Verwenden von Exitbranches | Nein                | **Nein**        | **Hörvermögen**                                  | Kippt den Kopf nach rechts \* (Schleifenanimation)                     |
| **Hörvermögen \_ 2**            | Ja, Verwenden von Exitbranches | Nein                | **Nein**        | **Hörvermögen**                                  | Kippt den Kopf nach links \* (Schleifenanimation)                      |
| **Hörvermögen \_ 3**            | Ja, Verwenden von Exitbranches | Nein                | **Nein**        | **Hörvermögen**                                  | Cocks head left \* (Loopinganimation)                      |
| **Hörvermögen \_ 4**            | Ja, Verwenden von Exitbranches | Nein                | **Nein**        | **Hörvermögen**                                  | Kippt den Kopf nach unten \* (Schleifenanimation)                      |
| **Ausblenden**                  | Keine                     | Nein                | **Ja**       | **Versteckt**                                   | Verschwindet durch die Tür                                    |
| **Idle1 \_ 1**              | Keine                     | Nein                | **Nein**        | **IdlingLevel1** **IdlingLevel2**<br/> | Blicke nach rechts                                              |
...
| **Idle2 \_ 1**              | Keine                     | Nein                | **Nein**        | **IdlingLevel2**                             | Folds-Arme                                                 |
| **Idle2 \_ 2**              | Keine                     | Nein                | **Ja**       | **IdlingLevel2**                             | Entfernt den Kopf und nimmt Anpassungen vor.                          |
...
| **Movedown**              | Ja, Verwenden von Exitbranches | Nein                | **Ja**       | **MovingDown**                               | Nach unten                                                 |
| **MoveLeft**              | Ja, Verwenden von Exitbranches | Nein                | **Ja**       | **MovingLeft**                               | Linken Linken                                                 |
| **MoveRight**             | Ja, Verwenden von Exitbranches | Nein                | **Ja**       | **MovingRight**                              | Rechts von Einem                                                |
| **MoveUp**                | Ja, Verwenden von Exitbranches | Nein                | **Ja**       | **MovingUp**                                 | Nach oben                                                   |
| **Zufrieden**               | Ja, Verwenden von Exitbranches | Ja               | **Ja**       | Keine                                         | Lächeln und Begradigen                                  |
| **Process**               | Nein                       | Nein                | **Ja**       | Keine                                         | Drückt Schaltflächen, druckt, liest und wirft dann den Ausdruck.       |
| **Verarbeitung**            | Ja, Verwenden von Exitbranches | Nein                | **Ja**       | Keine                                         | Drückt Schaltflächen, druckt, liest und wirft dann den Druck       |
...
| **Aktuell gelesen**               | Ja, Verwenden von Exitbranches | Nein                | **Ja**       | Keine                                         | Druckt, liest und sucht ( \* Schleifenanimation)          |
...
| **Suche**             | Ja, Verwenden von Exitbranches | Nein                | **Ja**       | Keine                                         | Zeigt toolbox an und entfernt Tools ( \* Schleifenanimation)    |
| **Anzeigen**                  | Keine                     | Nein                | **Ja**       | **Anzeige**                                  | Wird durch die Tür angezeigt                                    |
| **StartListening**        | Ja, Verwenden von Exitbranches | Ja               | **Nein**        | Keine                                         | Hand ans Hand-An-Hand-Tor                                           |
| **StopListening**         | Ja, Verwenden von Exitbranches | Ja               | **Nein**        | Keine                                         | Übergibt die Hände                                       |
...
| **Berechnung**              | Nein                       | Nein                | **Ja**       | Keine                                         | Scratches head ( looping animation) (Kopf ab \* scratcht (Schleifenanimation))                       |
