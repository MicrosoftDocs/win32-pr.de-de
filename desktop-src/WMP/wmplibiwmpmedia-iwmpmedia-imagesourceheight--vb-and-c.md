...
---
# <a name="iwmpmediaimagesourceheight-property"></a>Iwmpmedia:: imagesourceheight (Eigenschaft)
...
Ein **System. Int32** -Wert, der die Höhe des Medien Elements ist.
...
Im folgenden Beispiel wird **imagesourceheight** verwendet, um die Bildgröße des aktuellen Medien Elements in einem Textfeld in Pixel anzuzeigen. Das **AxWMPLib. AxWindowsMediaPlayer** -Objekt wird durch die Variable mit dem Namen "Player" dargestellt.
