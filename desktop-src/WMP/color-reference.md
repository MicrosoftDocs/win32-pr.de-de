...
| -dalmond ( \# FFEBCD)  | blue ( \# 0000FF)             | blueviolet ( \# 8A2BE2)           | brown ( \# A52A2A)             |
| -lywood ( \# DEB887)       | cadetblue ( \# 5F9EA0)        | chartreuse ( \# 7FFF00)           | chocolate ( \# D2691E)         |
| coral ( \# FF7F50)           | flowerblue ( \# 6495ED)   | kornsilk ( \# FFF8DC)             | crimson ( \# DC143C)           |
| cyan ( \# 00FFFF)            | darkblue ( \# 00008B)         | darkcyan ( \# 008B8B)             | darkppeenrod ( \# B8860B)     |
| darkgray \# (A9A9A9)        | darkgreen ( \# 006400)        | darkunkowki \# (BDB76B)            | darkmagenta ( \# 8B008B)       |
...
| indigo ( \# 4B0082)          | ivory ( \# FFFFF0)            | charki \# (F0E68C)                | klavender ( \# E6E6FA)          |
| klavenderblush ( \# FFF0F5)   | lawngreen ( \# 7CFC00)        | chiffon ( \# FFFACD)         | lightblue ( \# ADD8E6)         |
| lightcoral ( \# F08080)      | lightcyan ( \# E0FFFF)        | lightglühenrodyellow ( \# FAFAD2) | lightgreen ( \# 90EE90)        |
...
| orangered \# (FF4500)       | ( \# DA70D6)           | ohne Zudenrod ( \# EEE8AA)        | -green ( \# 98FB98)         |
| -turquoise ( \# AFEEEE)   | violetred ( \# DB7093)    | yawhip ( \# FFEFD5)           | peachpuff ( \# FFDAB9)         |
| dc ( \# CD853F)            | rosa ( \# FFC0CB)             | plum ( \# DDA0DD)                 | blue ( \# B0E0E6)        |
| purple ( \# 800080)          | red ( \# FF0000)              | rosybrown ( \# BC8F8F)            | blue ( \# 4169E1)         |
| zubrown ( \# 8B4513)     | lass ( \# FA8072)           | breakbrown ( \# F4A460)           | seagreen ( \# 2E8B57)          |
