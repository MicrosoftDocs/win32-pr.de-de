...
description: Das Playlist-Objekt bietet eine Möglichkeit, Medienelemente in einer Liste zu organisieren, um die Bearbeitung mit den folgenden Eigenschaften und Methoden zu vereinfachen.
ms.assetid: c2d2f265-b207-4b82-bb76-aee467f00659
keywords:
- Windows Media Player von Wiedergabelistenobjekten
topic_type:
- apiref
api_name:
- Playlist Object
...
Das **Playlist-Objekt** bietet eine Möglichkeit, Medienelemente in einer Liste zu organisieren, um die Bearbeitung mit den folgenden Eigenschaften und Methoden zu vereinfachen.
...
| [isIdentical](playlist-isidentical.md) | Ruft einen Wert ab, der angibt, ob das angegebene **Wiedergabelistenobjekt** mit dem aktuellen identisch ist. |
...
| [MediaCollection](mediacollection-object.md)       | [getAll](mediacollection-getall.md), [getByKategorie](mediacollection-getbyalbum.md), [getByAttribute](mediacollection-getbyattribute.md), [getByAuthor](mediacollection-getbyauthor.md), [getByGenre](mediacollection-getbygenre.md), [getByName](mediacollection-getbyname.md) |
...
Da dies die gängigste Zugriffshilfe ist, *player*. **currentPlaylist** wird zur Veranschaulichung in den Abschnitten zur Referenzsyntax verwendet.
