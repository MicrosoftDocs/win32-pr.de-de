...
---
# <a name="example-serviceinfo-document-for-a-type-1-online-store"></a><span data-ttu-id="38031-114">Beispiel eines serviceInfo-Dokuments für einen Online Store vom Typ 1</span><span class="sxs-lookup"><span data-stu-id="38031-114">Example ServiceInfo Document for a Type 1 Online Store</span></span>

<span data-ttu-id="38031-115">Das folgende Codebeispiel zeigt ein umfassendes ServiceInfo.xml Dokument.</span><span class="sxs-lookup"><span data-stu-id="38031-115">The following code example shows a complete ServiceInfo.xml document.</span></span> <span data-ttu-id="38031-116">Sie können diesen XML-Code als Ausgangspunkt für Ihr eigenes serviceInfo-Dokument verwenden.</span><span class="sxs-lookup"><span data-stu-id="38031-116">You can use this XML as a starting point for your own ServiceInfo document.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="38031-117">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="38031-117">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="38031-118">**Programmier Handbuch für den Typ 1 Online Stores**</span><span class="sxs-lookup"><span data-stu-id="38031-118">**Programming Guide for Type 1 Online Stores**</span></span>](programming-guide-for-type-1-online-stores.md)
</dt> <dt>

[<span data-ttu-id="38031-119">**ServiceInfo-Dokument für einen Typ-1-Online Store**</span><span class="sxs-lookup"><span data-stu-id="38031-119">**ServiceInfo Document for a Type 1 Online Store**</span></span>](serviceinfo-document-for-a-type-1-online-store.md)
</dt> <dt>

[<span data-ttu-id="38031-120">**Servicinfo-Dokument**</span><span class="sxs-lookup"><span data-stu-id="38031-120">**ServiceInfo Document**</span></span>](serviceinfo-document.md)
</dt> </dl>
