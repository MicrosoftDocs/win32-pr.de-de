...
---
# <a name="enumerating-the-media-items"></a><span data-ttu-id="ff3d3-116">Auflisten der Medienelemente</span><span class="sxs-lookup"><span data-stu-id="ff3d3-116">Enumerating the Media Items</span></span>

<span data-ttu-id="ff3d3-117">Der folgende Code zeigt die Medienelemente an, die in einer einzelnen Wiedergabeliste enthalten sind.</span><span class="sxs-lookup"><span data-stu-id="ff3d3-117">The following code displays the media items contained in an individual playlist.</span></span> <span data-ttu-id="ff3d3-118">Dieser Code wird ausgeführt, wenn der Benutzer auf eine Wiedergabeliste im ListView-Steuerelement klickt, das von IDC \_ plview identifiziert wird.</span><span class="sxs-lookup"><span data-stu-id="ff3d3-118">This code runs when the user clicks a playlist in the ListView control identified by IDC\_PLVIEW.</span></span>
...
<span data-ttu-id="ff3d3-119">Informationen zur Implementierung der getpartnershipsyncstate-Funktion finden Sie unter [bestimmen des Synchronisierungs Status der Wiedergabeliste](determining-playlist-synchronization-state.md).</span><span class="sxs-lookup"><span data-stu-id="ff3d3-119">For the implementation of the GetPartnershipSyncState function, see [Determining Playlist Synchronization State](determining-playlist-synchronization-state.md).</span></span>

## <a name="related-topics"></a><span data-ttu-id="ff3d3-120">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="ff3d3-120">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="ff3d3-121">**Iwmpmedia-Schnittstelle**</span><span class="sxs-lookup"><span data-stu-id="ff3d3-121">**IWMPMedia Interface**</span></span>](/previous-versions/windows/desktop/api/wmp/nn-wmp-iwmpmedia)
</dt> <dt>

[<span data-ttu-id="ff3d3-122">**Iwmpwiedergabe-Schnittstelle**</span><span class="sxs-lookup"><span data-stu-id="ff3d3-122">**IWMPPlaylist Interface**</span></span>](/previous-versions/windows/desktop/api/wmp/nn-wmp-iwmpplaylist)
</dt> <dt>

[<span data-ttu-id="ff3d3-123">**Synchronisierungs Wiedergabelisten**</span><span class="sxs-lookup"><span data-stu-id="ff3d3-123">**Managing Synchronization Playlists**</span></span>](managing-synchronization-playlists.md)
</dt> </dl>
