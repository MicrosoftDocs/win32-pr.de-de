...
---
# <a name="implementing-iscesvcattachmentpersistinfo"></a>Implementieren von iscesvplattachmentpersistinfo

Anlagen-Snap-in-Erweiterungen müssen die [**iscesvplattachmentpersistinfo**](/windows/desktop/api/Scesvc/nn-scesvc-iscesvcattachmentpersistinfo) -Schnittstelle implementieren. Mithilfe der Sicherheitskonfigurations-Snap-Ins wird diese Schnittstelle regelmäßig abgefragt, z. b. wenn die Konfiguration gespeichert oder das Snap-in geschlossen wird. Dadurch kann die Snap-in-Erweiterung alle Änderungen speichern, die der Benutzer möglicherweise an der Inspektions Datenbank oder der zugeordneten Konfiguration vorgenommen hat.

Das folgende Beispiel zeigt eine Möglichkeit zum Implementieren von [**iscesvplattachmentpersistinfo**](/windows/desktop/api/Scesvc/nn-scesvc-iscesvcattachmentpersistinfo).
