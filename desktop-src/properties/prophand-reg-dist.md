...
Nachdem der Eigenschaftenhandler implementiert wurde, muss er registriert werden, und seine Dateierweiterung muss dem Handler zugeordnet werden. Im folgenden Beispiel mit der .recipe-Erweiterung werden die erforderlichen Registrierungseinträge dafür veranschaulicht.
...
-   **Datei parallelität**
    ...
    Für Schreibzugriff **geöffnete** Eigenschaftenhandler (GPS \_ READWRITE) verweigern anderen Readern und Writern. Handler können ein Verhalten aktivieren, das Lesern ermöglicht, indem sie das Flag `EnableShareDenyWrite` (impliziert, lesen aktivieren) in seiner Registrierung angeben.
