---
description: 'Diensttypteil des DNS-SD-Dienstinstanznamens. (Beispiel: &\# 0034; \_ http. \_ tcp&\# 0034; in &\# 0034;myservice. \_ http. \_ tcp.local&\# 0034;).'
...
ms.locfileid: "120010680"
---
# <a name="systemdevicesdnssdservicename"></a>System.Devices.Dnssd.ServiceName

Diensttypteil des DNS-SD-Dienstinstanznamens. (z.B. " \_ http. \_ tcp" in "myservice. \_ http. \_ tcp.local")
