---
description: Gibt den Breitengrad an.
...
ms.locfileid: "120091210"
---
# <a name="systemgpslatitude"></a>System.GPS.Latitude

Gibt den Breitengrad an. Dies ist ein Array von drei Werten, wie folgt: Index 0 ist der Grad, Index 1 ist die Minuten, Index 2 ist die Sekunden. Jede wird anhand der Werte in PKEY \_ GPS \_ LatitudeNumerator und PKEY \_ GPS \_ LatitudeDenominator berechnet.
...
Die Anforderung eines bestimmten indirekten Zeichenfolgenverweis für das `label` **Attribut labelInfo** wurde für Windows Vista mit Service Pack 1 (SP1) hinzugefügt.
