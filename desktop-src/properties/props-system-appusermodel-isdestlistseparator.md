---
description: Fügt ein Trennzeichen in den Abschnitt Tasks eines -Sprungliste.
...
ms.locfileid: "118970869"
---
# <a name="systemappusermodelisdestlistseparator"></a>System.AppUserModel.IsDestListSeparator

Fügt ein Trennzeichen in den **Abschnitt Tasks** eines Sprungliste. Legen Sie diese Eigenschaft für ein [**IShellLink-Objekt**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishelllinka) fest, und übergeben Sie sie [**an ICustomDestinationList::AddUserTasks**](/windows/win32/api/shobjidl_core/nf-shobjidl_core-icustomdestinationlist-addusertasks).
