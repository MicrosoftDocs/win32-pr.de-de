---
title: Anzeigen des aktuellen Status
description: Der folgende Beispielcode veranschaulicht, wie alle Filter gefunden werden, die sich auf eine Serveranwendung auswirken können.
...
ms.locfileid: "106337360"
---
# <a name="viewing-current-state"></a><span data-ttu-id="bd7d7-103">Anzeigen des aktuellen Status</span><span class="sxs-lookup"><span data-stu-id="bd7d7-103">Viewing Current State</span></span>

<span data-ttu-id="bd7d7-104">Der folgende Beispielcode veranschaulicht, wie alle Filter gefunden werden, die sich auf eine Serveranwendung auswirken können.</span><span class="sxs-lookup"><span data-stu-id="bd7d7-104">The following sample code demonstrates how to find all filters that might affect a server application.</span></span>

> [!Note]  
> <span data-ttu-id="bd7d7-105">Die Filterbedingungen sind identisch mit denen, die von der kompatible **isportallowed** -API unterstützt werden.</span><span class="sxs-lookup"><span data-stu-id="bd7d7-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
