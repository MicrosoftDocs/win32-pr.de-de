...
---
# <a name="monitoring-filter-changes"></a><span data-ttu-id="af2a1-103">Überwachen von Filter Änderungen</span><span class="sxs-lookup"><span data-stu-id="af2a1-103">Monitoring Filter Changes</span></span>

<span data-ttu-id="af2a1-104">Der folgende Beispielcode veranschaulicht, wie Sie das Hinzufügen und Löschen von Filtern überwachen, die sich auf eine Serveranwendung auswirken können.</span><span class="sxs-lookup"><span data-stu-id="af2a1-104">The following sample code demonstrates how to monitor the addition and deletion of filters that might affect a server application.</span></span>

> [!Note]  
> <span data-ttu-id="af2a1-105">Die Filterbedingungen sind identisch mit denen, die von der kompatible **isportallowed** -API unterstützt werden.</span><span class="sxs-lookup"><span data-stu-id="af2a1-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
