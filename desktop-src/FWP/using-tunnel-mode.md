---
title: Verwenden des Tunnel Modus
description: Der folgende Beispielcode veranschaulicht, wie ein Punkt-zu-Punkt-IPSec-Tunnel mithilfe der Windows-Filter Plattform (WFP)-API konfiguriert wird.
...
ms.locfileid: "104036463"
---
# <a name="using-tunnel-mode"></a><span data-ttu-id="3265f-103">Verwenden des Tunnel Modus</span><span class="sxs-lookup"><span data-stu-id="3265f-103">Using Tunnel Mode</span></span>

<span data-ttu-id="3265f-104">Der folgende Beispielcode veranschaulicht, wie ein Punkt-zu-Punkt-IPSec-Tunnel mithilfe der Windows-Filter Plattform (WFP)-API konfiguriert wird.</span><span class="sxs-lookup"><span data-stu-id="3265f-104">The following sample code demonstrates how to configure a point-to-point IPsec tunnel using the Windows Filtering Platform (WFP) API.</span></span>
