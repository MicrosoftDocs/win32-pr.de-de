...
---
# <a name="manual-sa-keying"></a>Manuelle SA-Schlüssel Erstellung

Der folgende Beispielcode veranschaulicht das Erstellen von Sicherheits Zuordnungen (SA) mithilfe der Windows-Filter Plattform.
