---
title: Manuelle SA-Schlüssel Erstellung
description: Der folgende Beispielcode veranschaulicht das Erstellen von Sicherheits Zuordnungen (SA) mithilfe der Windows-Filter Plattform.
...
ms.locfileid: "104515434"
---
# <a name="manual-sa-keying"></a><span data-ttu-id="e4411-103">Manuelle SA-Schlüssel Erstellung</span><span class="sxs-lookup"><span data-stu-id="e4411-103">Manual SA Keying</span></span>

<span data-ttu-id="e4411-104">Der folgende Beispielcode veranschaulicht das Erstellen von Sicherheits Zuordnungen (SA) mithilfe der Windows-Filter Plattform.</span><span class="sxs-lookup"><span data-stu-id="e4411-104">The following sample code demonstrates how to create Security Associations (SA) using Windows Filtering Platform.</span></span>
