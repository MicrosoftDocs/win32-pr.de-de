...
---
# <a name="reserving-ports"></a><span data-ttu-id="2a1fa-103">Reservieren von Ports</span><span class="sxs-lookup"><span data-stu-id="2a1fa-103">Reserving Ports</span></span>

<span data-ttu-id="2a1fa-104">Der folgende Beispielcode veranschaulicht, wie die Ressourcen Zuweisungs Ebenen verwendet werden, um einen Bereich von Ports für Administratoren zu reservieren.</span><span class="sxs-lookup"><span data-stu-id="2a1fa-104">The following sample code demonstrates how to use the resource assignment layers to reserve a range of ports for administrators.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="2a1fa-105">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="2a1fa-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="2a1fa-106">**Filterbedingungen, die auf jeder Filter Ebene verfügbar sind**</span><span class="sxs-lookup"><span data-stu-id="2a1fa-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
