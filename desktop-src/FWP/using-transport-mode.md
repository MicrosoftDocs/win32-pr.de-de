...
---
# <a name="using-transport-mode"></a>Verwenden des Transport Modus

Der folgende Beispielcode veranschaulicht, wie der IPSec-Transportmodus mithilfe von AuthIP mit Benutzerauthentifizierung und Aushandlung der Aushandlung konfiguriert wird.
