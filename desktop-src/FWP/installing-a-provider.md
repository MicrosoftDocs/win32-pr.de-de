---
title: Installieren eines Anbieters
description: Der folgende Beispielcode veranschaulicht den Installationsvorgang des Anbieters der Windows-Filter Plattform.
...
ms.locfileid: "103855851"
---
# <a name="installing-a-provider"></a><span data-ttu-id="85025-103">Installieren eines Anbieters</span><span class="sxs-lookup"><span data-stu-id="85025-103">Installing a Provider</span></span>

<span data-ttu-id="85025-104">Der folgende Beispielcode veranschaulicht den Installationsvorgang des Anbieters der Windows-Filter Plattform.</span><span class="sxs-lookup"><span data-stu-id="85025-104">The following sample code demonstrates the provider installation operation of the Windows Filtering Platform.</span></span>
