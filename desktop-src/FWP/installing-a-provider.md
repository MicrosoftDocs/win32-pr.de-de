...
---
# <a name="installing-a-provider"></a>Installieren eines Anbieters

Der folgende Beispielcode veranschaulicht den Installationsvorgang des Anbieters der Windows-Filter Plattform.
