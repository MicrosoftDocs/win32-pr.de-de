...
---
# <a name="populating-filter-conditions"></a><span data-ttu-id="c5872-103">Auffüllen von Filter Bedingungen</span><span class="sxs-lookup"><span data-stu-id="c5872-103">Populating Filter Conditions</span></span>

<span data-ttu-id="c5872-104">Der folgende Beispielcode veranschaulicht, wie Filterbedingungen aufgefüllt werden, die von einer Serveranwendung verwendet werden, um Filter und Ereignisse zu suchen, die sich auf die Anwendung auswirken.</span><span class="sxs-lookup"><span data-stu-id="c5872-104">The following sample code demonstrates how to populate filter conditions used by a server application to find filters and events that affect it.</span></span>

> [!Note]  
> <span data-ttu-id="c5872-105">Diese Bedingungen sind identisch mit denen, die von der kompatible **isportallowed** -API unterstützt werden.</span><span class="sxs-lookup"><span data-stu-id="c5872-105">These conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
