---
title: Deinstallieren eines Anbieters
description: Der folgende Beispielcode veranschaulicht den Prozess, der zum Entfernen einer Anbieter Installation erforderlich ist.
...
ms.locfileid: "103712972"
---
# <a name="uninstalling-a-provider"></a><span data-ttu-id="673e3-103">Deinstallieren eines Anbieters</span><span class="sxs-lookup"><span data-stu-id="673e3-103">Uninstalling a Provider</span></span>

<span data-ttu-id="673e3-104">Der folgende Beispielcode veranschaulicht den Prozess, der zum Entfernen einer Anbieter Installation erforderlich ist.</span><span class="sxs-lookup"><span data-stu-id="673e3-104">The following sample code demonstrates the process required to remove a provider installation.</span></span>
