...
---
# <a name="using-classify-options"></a><span data-ttu-id="89389-103">Verwenden von klassifizier Optionen</span><span class="sxs-lookup"><span data-stu-id="89389-103">Using Classify Options</span></span>

<span data-ttu-id="89389-104">In den folgenden Codebeispielen wird veranschaulicht, wie Filter klassifizier Optionen verwendet werden, um den Filterprozess zu ändern.</span><span class="sxs-lookup"><span data-stu-id="89389-104">The following code samples demonstrate how to use filter classify options in order to alter the filtering process.</span></span>

## <a name="enable-loose-source-mapping-for-a-remote-udp-port"></a><span data-ttu-id="89389-105">Aktivieren der losen Quell Zuordnung für einen UDP-Remote Port</span><span class="sxs-lookup"><span data-stu-id="89389-105">Enable Loose Source Mapping for a Remote UDP Port</span></span>
...
## <a name="modify-the-idle-lifetimes-for-ale-flows"></a><span data-ttu-id="89389-106">Ändern der Leerlauf Lebensdauer für ALE Flows</span><span class="sxs-lookup"><span data-stu-id="89389-106">Modify the Idle Lifetimes for ALE Flows</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="89389-107">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="89389-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="89389-108">**Filterbedingungen, die auf jeder Filter Ebene verfügbar sind**</span><span class="sxs-lookup"><span data-stu-id="89389-108">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
