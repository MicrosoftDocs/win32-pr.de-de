...
---
# <a name="hindering-filter-deletion"></a>Verhindern der Löschung von Filtern

Im folgenden Beispielcode wird veranschaulicht, wie ein Filter schwierig zu löschen ist, indem eine DACL festgelegt wird.
