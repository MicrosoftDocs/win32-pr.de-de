---
title: Verhindern der Löschung von Filtern
description: Der folgende Beispielcode veranschaulicht, wie ein Filter schwierig zu löschen ist, indem eine DACL festgelegt wird.
...
ms.locfileid: "104310524"
---
# <a name="hindering-filter-deletion"></a><span data-ttu-id="1f533-103">Verhindern der Löschung von Filtern</span><span class="sxs-lookup"><span data-stu-id="1f533-103">Hindering Filter Deletion</span></span>

<span data-ttu-id="1f533-104">Im folgenden Beispielcode wird veranschaulicht, wie ein Filter schwierig zu löschen ist, indem eine DACL festgelegt wird.</span><span class="sxs-lookup"><span data-stu-id="1f533-104">The following example code demonstrates how to make a filter difficult to delete by setting a DACL.</span></span>
