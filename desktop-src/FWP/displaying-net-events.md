...
---
# <a name="displaying-net-events"></a><span data-ttu-id="8bc86-103">Anzeigen von NET-Ereignissen</span><span class="sxs-lookup"><span data-stu-id="8bc86-103">Displaying Net Events</span></span>

<span data-ttu-id="8bc86-104">Der folgende Beispielcode veranschaulicht, wie eine Serveranwendung aktuelle NET-Ereignisse ermitteln kann, die möglicherweise betroffen sind.</span><span class="sxs-lookup"><span data-stu-id="8bc86-104">The following sample code demonstrates how a server application could locate recent net events that might have affected it.</span></span>

> [!Note]  
> <span data-ttu-id="8bc86-105">Die Filterbedingungen sind identisch mit denen, die von der kompatible **isportallowed** -API unterstützt werden.</span><span class="sxs-lookup"><span data-stu-id="8bc86-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
