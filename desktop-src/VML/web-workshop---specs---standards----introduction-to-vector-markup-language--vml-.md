...
- Vektorgrafiken,About
- Vektorgrafik,Vector Markup Language (VML)
...
-   Antworten auf häufig gestellte Fragen zu VML finden Sie unter Häufig gestellte Fragen [zu VML.](frequently-asked-questions-about-vml.yml)
-   Ein Tutorial zur Verwendung von VML auf Webseiten finden Sie unter [How to Use VML on Web Pages](web-workshop---specs---standards----how-to-use-vml-on-web-pages.md)(Verwenden von VML auf Webseiten), das die an den W3C übermittelte [VML-Spezifikation](https://www.w3.org/TR/NOTE-datetime.html) ergänzt.
