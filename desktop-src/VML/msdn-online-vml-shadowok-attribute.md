...
---
# <a name="vml-shadowok-attribute"></a>VML shadowok-Attribut
...
<v: *Element* shadowok = " *Ausdruck* " >

**Skript Syntax**

*Element* . shadowok = "*Ausdruck*"

*Ausdruck* = *Element*. shadowok

**Anmerkungen**

Wenn der Wert **false** ist, kann der Pfad keinen Schatten enthalten. Der Standardwert ist **True**. Dieses Attribut überschreibt alle anderen Schatten Attribute im Parent-oder **Shadow** -Element.

*VML-Standard Attribut*

**Beispiel**

Die Form hat keinen Schatten.
