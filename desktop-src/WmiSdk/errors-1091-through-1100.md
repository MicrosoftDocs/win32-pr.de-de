---
description: Beschreibt die Fehler 1091 bis 1100 des WMI-SNMP-Anbieters.
...
ms.locfileid: "122880089"
---
# <a name="errors-1091-through-1100"></a>Fehler 1091 bis 1100

Beschreibt die Fehler 1091 bis 1100 des WMI-SNMP-Anbieters.
...
**OBJECT-TYPE-Makroaufruf:** SNMPv2C-spezifische Modulsemantikwarnung. Das IMPLIED-Schlüsselwort kann nur für ein Objekt mit einer Syntax variabler Länge wie OBJECT IDENTIFIER oder OCTET STRING variabler Länge in der INDEX-Klausel vorhanden sein.
...
<span id="_1092__Fatal_____fileName___line___IMPLIED_clause_not_allowed_for_potentially_zero-length_objects_"></span><span id="_1092__fatal_____filename___line___implied_clause_not_allowed_for_potentially_zero-length_objects_"></span><span id="_1092__FATAL_____FILENAME___LINE___IMPLIED_CLAUSE_NOT_ALLOWED_FOR_POTENTIALLY_ZERO-LENGTH_OBJECTS_"></span>**<1092, Fatal>: " &lt; fileName &gt; :<line \#> IMPLIED clause not allowed for potentially zero-length objects"**
 ...
 OBJECT-TYPE-MakroaufrufSNMPv2C-spezifischer Modulsemantikfehler. Die IMPLIED-Klausel kann nicht für ein Objekt variabler Länge verwendet werden, wenn dieses Objekt eine Länge von 0 (null) aufweisen kann.
...
<span id="_1093._Fatal_____fileName__line____Only_the_type__INTEGER__can_be_enumerated_according_to_the_V1_SMI_"></span><span id="_1093._fatal_____filename__line____only_the_type__integer__can_be_enumerated_according_to_the_v1_smi_"></span><span id="_1093._FATAL_____FILENAME__LINE____ONLY_THE_TYPE__INTEGER__CAN_BE_ENUMERATED_ACCORDING_TO_THE_V1_SMI_"></span>**<1093. Fatal>: " &lt; fileName &gt;<line \#>: Only the type "INTEGER" can enumerated according to the V1 SMI" (Dateiname<Zeile>: Nur der Typ "INTEGER" kann gemäß der V1-SMI aufzählen.**
</dt> <dd>

Typzuweisung, semantischer SNMPv1-spezifischer Modulfehler. Eine SNMPv1 MIB-Enumeration kann nur den Typ INTEGER verwenden.
...
<span id="_1094._Fatal_____fileName__line____The_type_used_in_the_enumeration_does_not_resolve_to_one_of_the_allowed_types_"></span><span id="_1094._fatal_____filename__line____the_type_used_in_the_enumeration_does_not_resolve_to_one_of_the_allowed_types_"></span><span id="_1094._FATAL_____FILENAME__LINE____THE_TYPE_USED_IN_THE_ENUMERATION_DOES_NOT_RESOLVE_TO_ONE_OF_THE_ALLOWED_TYPES_"></span>**<1094. Schwerwiegende>: &lt; "fileName &gt;<Zeile \#>: Der in der Enumeration verwendete Typ wird nicht in einen der zulässigen Typen aufgelöst."**
</dt> <dd>

Typzuweisung, semantischer SNMPv2C-spezifischer Modulfehler. Der in einer Enumeration verwendete Typ muss INTEGER oder ein gleichwertiger Typ oder eine andere Enumeration sein.
...
Typzuweisung, semantischer SNMPv2C-spezifischer Modulfehler. Wenn eine andere Enumeration verwendet wird, muss ihr Satz von Elementen eine Teilmenge der Elemente der übergeordneten Enumeration sein.
...
<span id="_1097__Fatal_____fileName__line____identifier__name__does_not_resolve_to_an_integer_value_"></span><span id="_1097__fatal_____filename__line____identifier__name__does_not_resolve_to_an_integer_value_"></span><span id="_1097__FATAL_____FILENAME__LINE____IDENTIFIER__NAME__DOES_NOT_RESOLVE_TO_AN_INTEGER_VALUE_"></span>**<1097, Fatal>: " &lt; fileName &gt;<line>: identifier name does not resolve to an integer value" (Dateiname<Zeile \#>: Bezeichnername &lt; wird nicht in einen &gt; ganzzahligen Wert aufgelöst)**
</dt> <dd>

Typzuweisung, semantischer SNMPv2C-spezifischer Modulfehler. Die Werte im BITS-Typ müssen ganzzahlige Werte sein.
...
<span id="_1098__Fatal_____fileName__line____Duplicate_value__value__in_BITS_construct_"></span><span id="_1098__fatal_____filename__line____duplicate_value__value__in_bits_construct_"></span><span id="_1098__FATAL_____FILENAME__LINE____DUPLICATE_VALUE__VALUE__IN_BITS_CONSTRUCT_"></span>**<1098, Fatal>: " &lt; fileName &gt;<line>: Duplicate value value in BITS construct" (Dateiname<Zeile \#>: Doppelter &lt; &gt; Wertwert im BITS-Konstrukt)**
</dt> <dd>

Typzuweisung, semantischer SNMPv2C-spezifischer Modulfehler. In einem BITS-Konstrukt dürfen keine doppelten Namen und Werte vorhanden sein. Die <Zeile \#> Parameter ist die Position der Wiederholung des Namens/Werts.
