---
description: Ruft einen Wert ab, der die Monatskomponente des datetime-Werts darstellt, oder legt diesen fest.
ms.assetid: 05818f0a-7e15-4ddd-a6a7-9d16ae82cd3c
ms.tgt_platform: multiple
title: SWbemDateTime.Month-Eigenschaft (Wbemdisp.h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118992180"
---
# <a name="swbemdatetimemonth-property"></a>SWbemDateTime.Month (Eigenschaft)

Die **Month-Eigenschaft** des [**SWbemDateTime-Objekts**](swbemdatetime.md) ruft einen Wert ab, der die Month-Komponente des datetime-Werts darstellt, oder legt diesen fest. Die Zahl muss im Bereich von 01 bis 12 liegen, oder der Fehler **wbemValueOutOfRange** wird zurückgegeben.
