...
---
# <a name="swbemobjectpathpath-property"></a>Errbemubjectpath. Path-Eigenschaft

Die **path** -Eigenschaft des " [**errbemubjectpath**](swbemobjectpath.md) "-Objekts enthält den absoluten Pfad. Dies entspricht der [ \_ \_ path](wmi-system-properties.md) -Eigenschaft in der com-API. Dies ist die Standard Eigenschaft dieses Objekts.
