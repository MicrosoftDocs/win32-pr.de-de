...
-   [**Suchen von Methoden**](/windows/win32/api/chstring/nf-chstring-chstring-find(wchar))
-   [**FindOneOf-Methode**](/windows/desktop/api/ChString/nf-chstring-chstring-findoneof)
-   [**Formatmethoden**](/windows/desktop/api/ChString/nf-chstring-chstring-format(uint_---))
...
-   [**Linke Methode**](/windows/desktop/api/ChString/nf-chstring-chstring-left)
