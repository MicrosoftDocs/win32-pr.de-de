---
description: Beschreibt die Fehler 1081 bis 1090 des WMI-SNMP-Anbieters.
...
ms.locfileid: "122879707"
---
# <a name="errors-1081-through-1090"></a>Fehler 1081 bis 1090

Beschreibt die Fehler 1081 bis 1090 des WMI-SNMP-Anbieters.
...
Modulsemantikfehler beim Querverweisen, der weder für SNMPv1 noch für SNMPv2C spezifisch ist. Ein aus einem Modul importiertes Symbol wird in diesem Modul nicht aufgelöst. Wenn in mib tatsächlich auf dieses Symbol verwiesen wird, tritt dieser Fehler auf.
...
**OBJECT-IDENTITY-Makroaufruf,** semantischer SNMPv2C-spezifischer Modulfehler. Die **STATUS-Klausel eines OBJECT-IDENTITY-Aufrufs** muss "current", "deprecated" oder "obsolete" sein.
...
**MODULE-IDENTITY-Makroaufruf,** SNMPv2C-spezifischer Modulsemantikfehler. In einem SNMPv2C-MIB darf unmittelbar nach dem Imports-Abschnitt nur ein **MODULE-IDENTITY-Aufruf** vorhanden sein.
...
<span id="_1085__Warning_____fileName__line____No_groups_found_in_module__name_._Could_not_fabricate_MODULE-IDENTITY._Attempt_to_load_the_module_into_the_SMIR_will_fail_"></span><span id="_1085__warning_____filename__line____no_groups_found_in_module__name_._could_not_fabricate_module-identity._attempt_to_load_the_module_into_the_smir_will_fail_"></span><span id="_1085__WARNING_____FILENAME__LINE____NO_GROUPS_FOUND_IN_MODULE__NAME_._COULD_NOT_FABRICATE_MODULE-IDENTITY._ATTEMPT_TO_LOAD_THE_MODULE_INTO_THE_SMIR_WILL_FAIL_"></span>**<1085, Warning>: " &lt; fileName &gt;<line \#>: No groups found in module name &lt; &gt; . MODULE-IDENTITY konnte nicht fabrict werden. Der Versuch, das Modul in den SMIR zu laden, schlägt fehl.**
</dt> <dd>

Modulsemantik: SNMPv1-spezifische Warnung. Dieser Fehler wird generiert, wenn in einem Modul keine Objektgruppen gefunden werden.
...
<span id="_1087._Fatal_____fileName__line____Invalid_STATUS_clause__clause__for_a_TEXTUAL-CONVENTION_macro_"></span><span id="_1087._fatal_____filename__line____invalid_status_clause__clause__for_a_textual-convention_macro_"></span><span id="_1087._FATAL_____FILENAME__LINE____INVALID_STATUS_CLAUSE__CLAUSE__FOR_A_TEXTUAL-CONVENTION_MACRO_"></span>**<1087. Schwerwiegende>: &lt; "fileName &gt;<Zeile \#>: Ungültige &lt; &gt; STATUS-Klauselklausel für ein TEXTUAL-CONVENTION-Makro"**
</dt> <dd>

Typzuweisung, semantischer SNMPv2C-spezifischer Modulfehler. Die Statusklausel eines **TEXTUAL-CONVENTION-Makroaufrufs** muss "current", "deprecated" oder "obsolete" sein.
...
<span id="_1089__Fatal_____fileName___line____Symbol__identifier__in_AUGMENTS_clause_does_not_resolve_to_a_row_OBJECT-TYPE_"></span><span id="_1089__fatal_____filename___line____symbol__identifier__in_augments_clause_does_not_resolve_to_a_row_object-type_"></span><span id="_1089__FATAL_____FILENAME___LINE____SYMBOL__IDENTIFIER__IN_AUGMENTS_CLAUSE_DOES_NOT_RESOLVE_TO_A_ROW_OBJECT-TYPE_"></span><**1089, Fatal>: " &lt; fileName &gt; :<line \#>: Symbol &lt; identifier in &gt; AUGMENTS clause does not resolve to a row OBJECT-TYPE"**
 ...
 OBJECT-TYPE-MakroaufrufSNMPv2C-spezifischer Modulsemantikfehler. Wenn eine AUGMENTS-Klausel vorhanden ist, muss der Bezeichner in der AUGMENTS-Klausel in eine OBJECT-TYPE-Tabelle aufgelöst werden.
...
<span id="_1090__Fatal_____fileName___line___IMPLIED_clause_is_useful_only_for_the_last_INDEX_object_"></span><span id="_1090__fatal_____filename___line___implied_clause_is_useful_only_for_the_last_index_object_"></span><span id="_1090__FATAL_____FILENAME___LINE___IMPLIED_CLAUSE_IS_USEFUL_ONLY_FOR_THE_LAST_INDEX_OBJECT_"></span>**<1090, Fatal>: " &lt; fileName &gt; :<line \#> IMPLIED clause is useful only for the last INDEX object"**
 ...
 OBJECT-TYPE-MakroaufrufSNMPv2C-spezifischer Modulsemantikfehler. Die IMPLIED-Klausel kann nur dem letzten Objekt in der INDEX-Klausel zugeordnet werden.
