...
title: Indikatortypen des Timeralgorithmus
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="timer-algorithm-counter-types"></a>Indikatortypen des Timeralgorithmus
...
| [PERF \_ 100NSEC \_ TIMER](/previous-versions/windows/it-pro/windows-server-2003/cc785636(v=ws.10))<br/> Dezimalzahlen 542180608<br/>             | Die aktive Zeit einer Komponente als Prozentsatz der insgesamt verstrichenen Zeit in Einheiten von 100 ns des Stichprobenintervalls.<br/>                                                                                                                                                                                                                                                                          |
...
| [PERF \_ COUNTER \_ MULTI \_ TIMER](/previous-versions/windows/it-pro/windows-server-2003/cc785636(v=ws.10))<br/> Dezimalzahlen 574686464<br/>      | Die aktive Zeit einer oder mehrere Komponenten als Prozentsatz der Gesamtzeit des Stichprobenintervalls. Dieser Indikatortyp unterscheidet sich von **PERF \_ 100NSEC \_ MULTI \_ TIMER** dadurch, dass er die Zeit in Einheiten von Ticks des Systemleistungszeiters misst, anstatt in Einheiten von 100ns.<br/> Dieser Indikatortyp erfordert eine Basiseigenschaft mit dem **PERF \_ COUNTER MULTI \_ \_ BASE-Indikatortyp.**<br/>        |
