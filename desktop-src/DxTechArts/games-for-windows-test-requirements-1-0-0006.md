...
ms.locfileid: "122886424"
---
# <a name="games-for-windows-test-cases-best-practices-for-games-on-windows-xp-windows-vista-windows-7-and-windows-8"></a>Games for Windows Test Cases: Best Practices for Games on Windows XP, Windows Vista, Windows 7 und Windows 8
...
Jede Testanforderung in diesem Dokument besteht aus vier Hauptabschnitten: einem Titel und einer Tabelle mit drei wichtigen Abschnitten (linke Spalte, rechts oben, rechts unten).
...
Details des tatsächlichen Testfalls.
...
Dieser Abschnitt ist ein Beispiel für die Sequenz, der ein typischer Testdurchlauf folgen würde, wenn die Testanforderungen als Leitfaden verwendet würden.

</dd> <dt>

<span id="Test_Tool_Notes"></span><span id="test_tool_notes"></span><span id="TEST_TOOL_NOTES"></span>**Testtoolhinweise**
</dt> <dd>

Dieser Abschnitt enthält ausführliche Hinweise zu den einzelnen Testtools, die zum Überprüfen der Bestehens- oder Fehlerbedingungen in den Testanforderungen verwendet werden.
...
<td>Das Spiel muss im Games Explorer auf Windows Vista und Windows 7 sichtbar sein. Wenn diese Option ausgewählt ist, muss das Spiel auch die richtigen Metadaten anzeigen. Die Installation darf keine Verknüpfung erstellen, um das Spiel auf dem Desktop, im Startmenü oder an einem anderen Ort zu starten. Aufgaben und Verknüpfungen zum Entfernen dürfen nicht erstellt werden.</td>
</tr>
<tr class="even">

<td><ol>
<li>Öffnen Sie nach der Installation des Spiels den Spiele-Explorer.</li>
<li>Überprüfen Sie, ob das Spielsymbol im Spiele-Explorer angezeigt wird.</li>
...
<li>Vergewissern Sie sich, dass das Spielsymbol Windows Wei-Informationen (Experience Index) im Spiele-Explorer anzeigt.</li>
<li>Vergewissern Sie sich, dass Spiellinks für Metadaten im Spiele-Explorer ordnungsgemäß funktionieren. (Wenn keine Hyperlinks angezeigt werden, ist dies ein mögliches Zeichen dafür, dass die EXE-Datei nicht signiert ist; siehe <a href="#23-sign-files">Abschnitt 2.3</a>.)</li>
<li>Vergewissern Sie sich, dass das Spiel im Spiele-Explorer eine genaue Bewertung der Elternsteuerung anzeigt. (Wenn unrated angezeigt wird, überprüfen Sie, ob es sich um ein nicht geprüftes Spiel handelt. Andernfalls ist dies ein Indikator dafür, dass die EXE-Datei nicht signiert ist; siehe <a href="#23-sign-files">Abschnitt 2.3</a>.)</li>
<li>Stellen Sie sicher, dass das Spiel keine Startverknüpfungen auf dem Benutzerdesktop abgibt.</li>
<li>Klicken Sie auf Start -> Alle Programme.</li>
<li>Vergewissern Sie sich, dass das Spiel keine Startverknüpfungen im Startmenü platzieren kann.</li>
<li>Stellen Sie sicher, dass das Spiel keine Verknüpfungen zum Deinstallieren im Startmenü außerhalb Systemsteuerung.</li>
<li>Wenn das Spiel digital verteilt wird, überprüfen Sie, ob der Dienstanbieter in Windows Games Explorer angezeigt wird.</li>
</ol>
<br/></td>
</tr>
</tbody>
...
<tr class="odd">
<td>Windows 7<br/> Windows Vista<br/></td>
<td>Das Spiel muss im Kontext eines &quot; Standardbenutzers ausgeführt &quot; werden. Die Jugendschutzmaßnahmen müssen in der Lage sein, das Spiel zu blockieren. Vergewissern Sie sich, dass gdf exe-Namen hat.</td>
</tr>
<tr class="even">

<td><ol>
<li>Erstellen Sie ein Standardbenutzerkonto in Windows Vista oder Windows 7 namens Toby. Starten Sie -> Systemsteuerung -> Benutzerkonten hinzufügen oder entfernen > Neues Konto erstellen.</li>
<li>Als Jane richten Sie über das Administratorkonto die Jugendschutzmechanismen für das Spiel ein. Start -> Systemsteuerung -> Einrichten von Jugendschutzfunktionen für alle Benutzer > Toby
<ol>
<li>Vergewissern Sie sich, dass das Spiel über das Symbol "Spiele-Explorer" gestartet wird.</li>
<li>Vergewissern Sie sich, dass das Spiel unter dem Spieltitel im Systemsteuerung Jugendschutz eine genaue Bewertung der Jugendschutzprüfung anzeigt.</li>
<li>Stellen Sie vor dem Anwenden von Jugendschutz sicher, dass das Spiel beim Start nicht zur Eingabe von Administratoranmeldeinformationen auffordert.</li>
<li>Legen Sie Jugendschutz auf &quot; Ein &quot; fest.</li>
<li>Klicken Sie im Abschnitt Windows Einstellungen auf Spiele.</li>
<li>Klicken Sie auf OK (Einstellung sollte jetzt &quot; AO/alle Spiele &quot; sein).</li>
<li>Vergewissern Sie sich, dass das Spiel mit diesen Einstellungen als Benutzer jane ausgeführt wird.</li>
<li>Melden Sie sich als Jane und als Toby an.</li>
<li>Vergewissern Sie sich, dass das Spiel mit diesen Einstellungen als User Toby ausgeführt wird.</li>
<li>Melden Sie sich als Toby an, und melden Sie sich als Jane an.</li>
<li>Kehren Sie zum vorherigen Bildschirm zurück, und wählen &quot; Sie Spielbewertungen festlegen &quot; aus.</li>
<li><p>Wählen Sie eine Bewertung aus, die niedriger als die ESRB-Bewertung des Spiels ist.</p>
<blockquote>
[!Note]<br />
Wenn das Spiel nicht bewertet wird, überspringen Sie diesen Schritt, und fahren Sie mit dem nächsten Teil dieses Tests fort. Abhängig vom Gebietsschema der getesteten SKU kann es erforderlich sein, ein anderes Bewertungssystem auszuwählen, um eine Spielbewertung zu finden.
</blockquote>
<p><br/></p></li>
<li>Melden Sie sich als Jane und als Toby an.</li>
<li>Vergewissern Sie sich, dass das Spiel nicht für User Toby gestartet wird, wenn ESRB von Benutzer Jane blockiert wird.</li>
<li>Melden Sie sich als Toby an, und melden Sie sich als Jane an.</li>
<li>Wenn sie zuvor geändert wurden, stellen Sie die ESRB-Einstellungen wieder her.</li>
<li>Wenn keine ESRB-Einstellungen vorhanden sind, wählen Sie &quot; Bestimmte Spiele blockieren oder zulassen &quot; aus, und wählen Sie das Spiel anhand des Namens aus.</li>
<li>Melden Sie sich als Jane und als Toby an.</li>
<li>Vergewissern Sie sich, dass das Spiel nicht für User Toby gestartet wird, wenn EXE/Name von Benutzer Jane blockiert wird.</li>
<li>Melden Sie sich als Toby und wieder als Jane an.</li>
<li>Öffnen Sie als Jane Benutzersteuerelemente -> Anwendungseinschränkungen.</li>
<li>Klicken Sie auf &quot; Toby kann nur die Programme verwenden, die ich zulässt, &quot; und klicken Sie auf OK (d. h. keine EXE-Datei zulassen).</li>
<li>Wechseln Sie zu Benutzersteuerelemente | Spiele Steuert und lässt das jeweilige Spiel mit der ESRB-Bewertung zu.</li>
<li>Melden Sie sich als Jane an, melden Sie sich als Toby an, und versuchen Sie, das Spiel zu spielen.</li>
<li>Vergewissern Sie sich, dass das Spiel NICHT blockiert ist und dass Toby es spielen kann, wenn &quot; keine EXE-Dateien &quot; festgelegt sind.</li>
</ol></li>
</ol>
<br/></td>
</tr>
...
<td>Spiele, die Gamepadcontroller unterstützen, müssen die Xbox 360 Controller für Windows mithilfe der XInput-API unterstützen. Alle Verweise auf allgemeine Controllertrigger und Schaltflächen müssen die Xbox 360 Namen verwenden.</td>
</tr>
<tr class="even">
...
<li>Überprüfen Sie, ob das Spiel Xbox 360 Controller für Windows als Eingabegerät erkennt.</li>
<li>Spielen Sie das Spiel, und überprüfen Sie, ob das Spiel- und Menüsystem mit Xbox 360 Controller für Windows gesteuert werden kann.</li>
<li>Vergewissern Sie sich, dass sich die Xbox 360 Controller für Windows gemäß den akzeptierten Standards verhält. (B für zurück, A für akzeptieren, Start für im Spielmenü/Anhalten oder Akzeptieren usw.)</li>
<li>Stellen Sie mithilfe von Xbox 360 Namen sicher, dass das Spiel auf die Controllerschaltflächen und Trigger verweist.</li>
</ol>
<br/>
<blockquote>
[!Note]<br />
Wenn das Spiel keinen Spielcontroller unterstützt und/oder nur Tastatur/Maus unterstützt, überspringen Sie diesen Testfall.
</blockquote>
<br/> ** Einstellungen für den Controller befindet sich möglicherweise außerhalb des Spiels. <br/></td>
</tr>
</tbody>
</table>
...
<ul>
<li>Normal 4:3 &quot; &quot; (800 600 oder 1024 768)</li>
...
<td>Suchen Sie die Videooptionen für das Spiel (dies ist möglicherweise nicht mehr im Spiel).<br/>
<blockquote>
[!Note]<br />
Die folgenden Tests müssen auf einem Widescreenmonitor ausgeführt werden.
</blockquote>
<br/>
<ol>
<li>Wählen Sie im Abschnitt video resolution (Videoauflösung) 800 600 oder 1024 768 aus.</li>
<li>Vergewissern Sie sich, dass das Spiel mit einer Seitenverhältnisauflösung von 4:3 ausgeführt wird.</li>
<li>Wählen Sie im Abschnitt video resolution (Videoauflösung) die Option 1280 720 aus.</li>
<li>Vergewissern Sie sich, dass das Spiel mit einer Seitenverhältnisauflösung von 16:9 ausgeführt wird.</li>
<li>Wählen Sie im Abschnitt Videoauflösung die Option 1680 1050, 800 480 oder 1152 720 aus.</li>
<li>Vergewissern Sie sich, dass das Spiel mit einer Seitenverhältnisauflösung von 16:10 ausgeführt wird.</li>
<li>Stellen Sie sicher, dass das Spiel das Bild nicht gestreckt und wiederum einen breiteren Ansichtsbereich darstellt.</li>
<li>Vergewissern Sie sich, dass das Spiel den Benutzer auffordert, wenn eine Änderung an der Auflösung vorgenommen wird.</li>
<li>Wenn der Benutzer nicht innerhalb von 15 Sekunden akzeptiert, überprüfen Sie, ob die Anzeige auf die vorherige Einstellung zurückgesetzt wird.</li>
<li>Vergewissern Sie sich, dass das Spiel links und rechts vom Spielbereich keine schwarzen Balken hinzufüge. (In diesem Fall wird der Spielbereich in der Mitte des Bildschirms noch im Verhältnis 4:3 angezeigt.)</li>
</ol>
<br/></td>
</tr>
</tbody>
...
| OS                                                                    | Anforderung                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|---------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Windows 7<br/> Windows Vista<br/> Windows XP<br/> | Wenn das Spiel Direct3D verwendet, muss direct3D 9 als Mindestversion unterstützt werden, und Direct3D muss die Standardversion für jede Anzeigekonfigurationsoption sein.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|     <dl> <dt><span id="Manual"></span><span id="manual"></span><span id="MANUAL"></span>Manuell</dt> <dd> Starten Sie das Spiel. Überprüfen Sie in den Videooptionen, ob Renderoptionen( D3D und/oder OpenGL) vorhanden sind. Falls vorhanden, überprüfen Sie, ob die Spielrenderoptionen standardmäßig Direct3D sind. Wenn Sie nicht überprüfen können, ob D3D9 die verwendete DirectX-Version ist, fahren Sie mit automatisiertem Test fort. <br/> </dd> <dt><span id="Automated_Test"></span><span id="automated_test"></span><span id="AUTOMATED_TEST"></span>Automatisierter Test</dt> <dd> Tool verwenden: Depends.exe <br/> </dd> </dl> |
...
<ol>
<li>Legen Sie das System auf DPI 150 % fest: <br/> Windows Vista: Systemsteuerung: Personalisierung, Schriftgrad anpassen (DPI), Benutzerdefinierter DPI. Legen Sie auf 150 % fest.<br/> Windows 7: Systemsteuerung: Display, Set to Larger - 150%.<br/></li>
<li>Führen Sie den Installationsvorgang und das Spiel aus, um sicherzustellen, dass keine Probleme mit abgeschnittenen Bildschirmen oder Dialogfeldern vorliegen.</li>
</ol>
</dd> <dt><span id="Automated_Test"></span><span id="automated_test"></span><span id="AUTOMATED_TEST"></span>Automatisierter Test</dt> <dd> Vergewissern Sie sich, dass das &lt; Element dpiAware &gt; true im </dpiAware> eingebetteten Manifest enthalten ist.<br/> Tool verwenden: Mt.exe <br/> </dd> </dl></td>
</tr>
</tbody>
</table>
...
<blockquote>
[!Note]<br />
Für Spiele und Spieleinstallationsprogramme sollte uiAccess immer auf FALSE festgelegt &quot; &quot; werden.
</blockquote>
<br/></td>
</tr>
<tr class="even">
...
<li>Überprüfen Sie, ob das ausführbare Dateimanifest des Spiels requestedExecutionLevel &quot; asInvoker &quot; ist.</li>
</ol>
...
<ul>
<li>Titel und Titelinstallationsprogramme dürfen keinen 16-Bit-Code enthalten und dürfen keine 16-Bit-Komponente verwenden.</li>
...
<ol>
<li>Führen Sie das Spiel in 64-Bit-Editionen von Windows aus. Stellen Sie sicher, dass der Spielinstallationsvorgang normal in 64-Bit-Editionen von Windows Vista oder Windows 7 ausgeführt wird.</li>
<li>Vergewissern Sie sich, dass beim Spiel kein Fehler aufgrund von ausführbaren 16-Bit-Dateien in 64-Bit-Editionen von Windows Vista oder Windows 7 auftritt. Im Fehlerfenster wird die 16-Bit-Anwendung erwähnt.</li>
<li>Wenn das Spiel über eine native ausführbare 64-Bit-Datei verfügt, verwenden Sie diese ebenfalls.</li>
</ol></td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td>Windows 7<br/> Windows Vista<br/> Windows XP<br/></td>
<td>Alle ausführbaren Codedateien (z. B. .exe und .dll Erweiterungen) müssen mit einem Authenticode-Zertifikat signiert werden. <br/> Wenn Sie Windows Installer verwenden, müssen die Paketdateien (.msi Dateien) des Installationsprogramms signiert werden. <br/></td>
</tr>
<tr class="even">
...
<li>Klicken Sie in jeder Datei mit der rechten Maustaste auf Eigenschaften.</li>
...
<tr class="odd">
<td>Windows 7<br/> Windows Vista<br/> Windows XP<br/></td>
<td>Alle Kernelmodustreiber, die vom Spiel installiert werden, müssen mit einem öffentlich gültigen Authenticode-Zertifikat signiert werden. <br/> Jeder Hardwaregerätetreiber im Kernelmodus, der vom Spiel installiert wird, muss über eine Microsoft-Signatur verfügen, die über das Windows Hardware Quality Labs -Programm (WHQL) oder DASS-Programm (Driver Reliability Signature) abgerufen wird. <br/></td>
</tr>
<tr class="even">
...
<li>Vergewissern Sie sich, dass im Spielinstallationsprozess keine Dialogfelder für nicht signierte Treiber angezeigt werden.</li>
</ol></td>
</tr>
</tbody>
</table>
...
### <a name="25-perform-version-checking-properly"></a>2.5 Durchführen einer ordnungsgemäßen Versionsprüfung
...
<tr class="odd">
<td>Windows 7<br/> Windows Vista<br/> Windows XP<br/></td>
<td>Spiele dürfen nicht unter zukünftigen Betriebssystemen ausgeführt werden, wie durch Änderungen an der Windows Versionsnummer angegeben, es sei denn, der Endbenutzer-Lizenzvertrag untersagt die Verwendung auf zukünftigen Betriebssystemen. Wenn das Spiel fehlschlagen soll, muss es ordnungsgemäß erfolgen, indem dem Benutzer eine Meldung angezeigt wird.</td>
</tr>
<tr class="even">

<td><dl> <dt><span id="Manual"></span><span id="manual"></span><span id="MANUAL"></span>Manuell</dt> <dd>
<ol>
<li>Installieren Sie das Spiel auf Windows XP, in 32-Bit-Editionen von Windows Vista und Windows 7 sowie in 64-Bit-Editionen von Windows Vista und Windows 7.</li>
<li>Vergewissern Sie sich, dass bei der Spieleinstallation kein Fehler in Bezug auf die Betriebssystemversion auftritt.</li>
</ol>
...
<li>Aktivieren Sie den Test Compatibility:HighVersionLie, nachdem Sie die INSTALL.EXE ausgewählt haben.</li>
...
<li>Aktivieren Sie den Test Compatibility:HighVersionLie, nachdem Sie die GAME.EXE ausgewählt haben.</li>
...
<tr class="odd">
<td>Windows 7<br/> Windows Vista<br/> Windows XP<br/></td>
<td>Spiele müssen Standard-Windows Multitaskingszenarien unterstützen.</td>
</tr>
<tr class="even">

<td>Erstellen Sie ein Standardbenutzerkonto in Windows Vista oder Windows 7 namens Toby. Starten Sie -> Systemsteuerung -> Benutzerkonten hinzufügen oder entfernen > Neues Konto erstellen. <br/>
<ol>
<li>Starten Sie das Spiel als Benutzerin Jane.</li>
<li>ALT+TAB zurück zum Desktop.</li>
<li>Vergewissern Sie sich, dass das Spiel ordnungsgemäß ALT+TABs für den Windows Desktop ist.</li>
...
<li>Vergewissern Sie sich, dass während des Benutzerwechselvorgangs keine Fehler für Benutzer Toby oder Benutzer Jane auftreten.</li>
<li>Wenn Sie eine andere Spielsitzung starten können, überprüfen Sie, ob Sie keine Audiodaten aus der ursprünglichen Spielsitzung hören können.</li>
...
<tr class="odd">
<td>Windows 7<br/> Windows Vista<br/> Windows XP<br/></td>
<td>Wenn ein Spiel das Speichern von Dateien unterstützt, muss es Dateien mit langen Namen und Pfaden speichern können. Das Spiel muss spezielle Dateisystemzeichen wie \ / : * ? ordnungsgemäß verarbeiten. &quot; < oder > in allen Benutzereingabefeldern, die zum Erstellen von Dateinamen oder Pfaden verwendet werden.</td>
</tr>
<tr class="even">
...
<li>Speichern Sie das Spiel. Überprüfen Sie während des Speicherns, ob das Spiel mit dem Speichernamen My First Save Game (Mein erstes Spiel speichern) gespeichert wird.</li>
<li>Kehren Sie zum Hauptmenü zurück.</li>
<li>Versuchen Sie, das neu gespeicherte Spiel zu laden.</li>
<li>Stellen Sie sicher, dass beim Behandeln von nicht unterstützten Dateisystemzeichen keine Fehler auftreten, z. B. \ / : * ? &quot; < oder > Wenn das Spiel ihnen zulässt, nennen Sie das gespeicherte Spiel.</li>
<li>Wenn der Benutzer sein Profil und/oder Zeichen benennen oder Spiele speichern darf, stellen Sie sicher, dass für das Spiel keine Fehler auftreten, wenn auch hier lange Dateinamen verwendet werden.</li>
</ol></td>
</tr>
</tbody>
</table>
...
<td><ol>
<li>Fügen Sie den Spieldatenträger ein.</li>
<li>Vergewissern Sie sich, dass im Spiel nicht mehr als ein End-User Lizenzvertrag (EULA) angezeigt wird.</li>
...
<li>Stellen Sie sicher, dass die Option Standardinstallation alle Benutzereingabeauswahlen für den Installationsprozess umgeht (Auswahl des Installationsordners, Komponentenauswahl usw.).</li>
<li>Stellen Sie sicher, dass der Spielinstallationsvorgang nicht zur Einrichtung von Betriebssystemkomponenten auffordert (DirectX-Setup, Visual C-Runtimes usw.).</li>
<li>Vergewissern Sie sich, dass der Spielinstallationsvorgang nicht zur Eingabe einer Firewallinteraktion auffordert.</li>
<li>Stellen Sie sicher, dass das Spiel automatisch ausgeführt wird oder dass am Ende des Installationsvorgangs ein Startmenü vorhanden ist.</li>
<li>Vergewissern Sie sich, dass beim Deinstallationsvorgang des Spiels alle installierten, nicht neu verteilten Betriebssystemkomponentendateien entfernt werden und alle Einstellungen gelöscht werden. Das Bereinigen aller Benutzereinstellungen und -daten (z. B. gespeicherte Spiele) ist nicht erforderlich.</li>
</ol></td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td>Windows 7<br/> Windows Vista<br/></td>
<td>Das Spielinstallationsprogramm darf nicht davon ausgehen, dass es im selben Kontext wie der Benutzer ausgeführt wird. Spiele müssen daher benutzerspezifische Aufgaben bei der ersten Ausführung separat von der Installation ausführen.</td>
</tr>
<tr class="even">

<td><ol>
<li>Vergewissern Sie sich, dass Sie das Spiel als Benutzerin Jane installieren können. (Dies erfordert erhöhte Rechte während des Setup-/Installationsvorgangs.)</li>
<li>Vergewissern Sie sich, dass der Spielinstallationsvorgang Benutzer Jane auffordert, die Rechte über Administratoranmeldeinformationen zu erhöhen. (Die Aufforderung zum Erhöhen der Rechte wird angezeigt, wenn der Benutzer versucht, zu installieren.)</li>
<li>Entscheiden Sie sich dafür, das Spiel am Ende der Installation zu autormieren, falls dies noch nicht erfolgt ist, oder starten Sie es über das angezeigte Menü.</li>
<li>Erstellen Sie nach dem Spiel ein neues Profil, und speichern Sie ein Spiel.</li>
<li>Beenden Sie das Spiel.</li>
<li>Starten Sie das Spiel neu, und vergewissern Sie sich, dass das Benutzerkonto Jane auf Benutzerprofile und gespeicherte Spiele zugreifen kann.</li>
</ol></td>
</tr>
</tbody>
</table>
...
<td><ol>
<li>Installieren Sie das Spiel mit dem Standardinstallationstyp.</li>
<li>Vergewissern Sie sich, dass das Spiel in Programme installiert wurde.</li>
</ol>
<blockquote>
[!Note]<br />
...
<tr class="odd">
<td>Windows 7<br/> Windows Vista<br/> Windows XP<br/></td>
<td>Anwendungen dürfen nicht versuchen, Dateien oder Registrierungsschlüssel zu installieren, die durch Windows Resource Protection (WRP) geschützt sind.</td>
</tr>
<tr class="even">

<td><ul>
<li>Vergewissern Sie sich, dass während des Installationsvorgangs keine Windows Resource Protection WRP-Dialogfelder angezeigt werden.</li>
</ul></td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td>Windows 7<br/> Windows Vista<br/> Windows XP<br/></td>
<td>Das Spielinstallationsprogramm sollte nicht davon ausgehen, dass die Installation von Windows Komponenten aus Weiterverteilungspaketen einen Neustart erfordert, es sei denn, der Neustart wird durch ein Rückgabeergebnis oder die Microsoft-Dokumentation angegeben.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td>Windows 7<br/> Windows Vista<br/> Windows XP<br/></td>
<td>Das Spielinstallationsprogramm muss ordnungsgemäß überprüfen, um sicherzustellen, dass die neuesten Dateiversionen installiert sind. Die Installation eines Spiels darf niemals Dateien zurückstellen, die Sie nicht erstellen oder die von Anwendungen gemeinsam genutzt werden, die Sie nicht erstellen.</td>
</tr>
<tr class="even">

<td><ol>
<li>Erstellen Sie vor der Installation des Spiels eine Vorinstallationsmomentaufnahme von System32.<br/>
<ol>
<li>Erstellen Sie ein Verzeichnis namens G4Wtest.</li>
...
<li>Windows Vista oder Windows 7: Vergewissern Sie sich, dass das Spiel Autorun-Programm selbst Benutzerin Jane nicht auffordert, die Rechte über Administratoranmeldeinformationen zu erhöhen.</li>
...
<li>Wählen Sie im &quot; Abschnitt Tests unter den Kategorien Grundlagen und &quot; Sonstiges die oben aufgeführten Tests aus &quot; &quot; &quot; &quot; (deaktivieren Sie ThreadPool und TimeRollOver), und stellen Sie sicher, dass alle anderen Tests nicht ausgewählt sind.</li>
<li>Starten Sie das Spiel.</li>
<li>Stellen Sie sicher, dass das Spiel keine Fehler generiert, wenn es unter Application Verifier ausgeführt wird.</li>
</ol>
<blockquote>
[!Note]<br />
...
<tr class="odd">
<td>Windows 7<br/> Windows Vista<br/> Windows XP<br/></td>
<td>Spiele dürfen nur bekannte und erwartete Ausnahmen behandeln, und Windows-Fehlerberichterstattung dürfen nicht deaktiviert werden. Wenn ein Fehler (z. B. eine Zugriffsverletzung) in ein Spiel eingefügt wird, muss es Windows-Fehlerberichterstattung ermöglichen, den Absturz zu melden.</td>
</tr>
<tr class="even">
...
<li>Windows XP: Klicken Sie auf die Registerkarte <strong>Version.</strong> Stellen Sie sicher, dass die Felder Produktname, Unternehmensname und Dateiversion ordnungsgemäß aufgefüllt sind.</li>
<li>Windows Vista oder Windows 7: Klicken Sie auf die Registerkarte <strong>Details.</strong> Stellen Sie sicher, dass die Felder Produktname und Dateiversion ordnungsgemäß ausgefüllt sind. Der Unternehmensname ist auf der Eigenschaftenseite Windows Vista oder Windows 7 nicht sichtbar.</li>
</ol>
</dd> <dt><span id="Automated_test_"></span><span id="automated_test_"></span><span id="AUTOMATED_TEST_"></span>Automatisierter Test:</dt> <dd>
<ul>
<li>Verwenden Sie das Testtool Microsoft Games for Windows. siehe <a href="#64-microsoft-games-for-windows-test-tool">Abschnitt 6.4.</a></li>
</ul>
</dd> </dl></td>
</tr>
</tbody>
...
<td><ul>
<li>Stellen Sie nach dem Spielen für eine normale Spielsitzung sicher, dass das Spiel beim Beenden keine Fehler generiert.</li>
</ul></td>
</tr>
</tbody>
</table>
...
Dies ist ein Beispiel für einen typischen Testdurchlauf, bei dem die oben genannten Testanforderungen als Leitfaden verwendet werden.
...
7.  Stellen Sie sicher, dass die Option Standard/Einfache Installation alle Benutzereingabeauswahlen für den Installationsvorgang umgeht (Auswahl des Installationsordners, Komponentenauswahl usw.). \[ 3.1\]
...
12. Vergewissern Sie sich, dass während des Installationsvorgangs 3.4 keine Windows Resource Protection-Dialoge (WRP) angezeigt werden. \[\]
...
5.  Vergewissern Sie sich, dass das Spielsymbol Windows Wei-Informationen (Experience Index) in Windows Games Explorer \[ 1.1 anzeigt.\]
6.  Vergewissern Sie sich, dass Spiellinks für Metadaten in Windows Games Explorer \[ 1.1 ordnungsgemäß funktionieren.\]
7.  Überprüfen Sie, ob das Spiel in Windows Games Explorer 1.1 eine genaue Bewertung der Elternsteuerung anzeigt. \[\]
8.  Erstellen einer Momentaufnahme nach der Installation von System32
...
1.  RUNTIME 1: Wenn das Startmenü vorhanden ist, starten Sie das Spiel von dort aus. Führen Sie folgende Schritte aus, wenn das Spiel nach der Installation automatisch ausgeführt oder über das Startmenü des Spiels gestartet wurde: Falls nicht, fahren Sie mit RUNTIME 2:
...
2.  RUNTIME 2: Wenn das Spiel nicht automatisch ausgeführt wurde oder einen Start über das Startmenü des Spiels anzeigte, ist dies ein Fehler von \[ 3.1. Der \] Test kann jedoch normal fortgesetzt werden:
...
3.  RUNTIME 3: Wenn das Spiel ein Spielpad unterstützt, überprüfen Sie, ob das Spiel Xbox 360 Controller für Windows als Eingabegerät \[ 1.4 erkennt.\]
    ...
    3.  Vergewissern Sie sich, dass das Spiel- und Menüsystem mit dem Xbox 360 Controller für Windows
...
4.  Legen Sie das Video auf \[ 1.5 \] fest:
    ...
    5.  Vergewissern Sie sich, dass die Anzeige auf die vorherige Einstellung zurückgesetzt wird, wenn Sie nicht innerhalb von 15 Sekunden akzeptieren.
...
7.  Starten Sie ein neues Spiel, erstellen Sie ein Spiel, und überprüfen Sie, ob beim Behandeln nicht unterstützter Dateisystemzeichen 2.7 keine Fehler auftreten. \[\]
8.  Vergewissern Sie sich, dass das Spiel ordnungsgemäß ALT+TABs für die Windows Desktop \[ 2.6 ist.\]

    1.  Wechseln Sie Benutzer mit dem ausgeführten Spiel, indem Sie auf Start -> Switch User (Benutzer wechseln) klicken.
    2.  Anmelden als Toby
...
1.  Vergewissern Sie sich, dass das Spiel beim Beenden von 4.3 keine Fehler generiert. \[\]
2.  Vergewissern Sie sich, dass das Spiel in Programme \[ 3.3 installiert ist.\]
...
2.  Vergewissern Sie sich, dass das Spiel unter dem Spieltitel in Jugendschutz Systemsteuerung 1.2 eine genaue Bewertung der Jugendschutzsteuerung anzeigt. \[\]
3.  Die folgenden Tests finden Sie unter Testfall \[ 1.2: \]
    ...
    10. Falls zuvor geändert, stellen Sie die ESRB-Einstellungen wieder her.
    ...
    20. Vergewissern Sie sich, dass das Spiel NICHT blockiert ist und dass Toby es spielen kann, wenn "Keine Exes zulassen" \[ auf 1.2 festgelegt ist.\]
...
2.  Stellen Sie sicher, dass der Spielinstallationsvorgang normal in 64-Bit-Editionen von Windows Vista und/oder Windows 7 \[ 2.3 ausgeführt wird.\]
...
4.  Erzwingen Des Absturzes der Anwendung beim Testen, und überprüfen Sie, ob das Spiel Windows-Fehlerberichterstattung ordnungsgemäß anzeigt und Absturzdaten \[ 4.3 sammelt.\]
5.  Sicherstellen der richtigen Dateizusammenfassungen \[ 4.3\]
    ...
    4.  Für jede Datei: Klicken Sie mit der rechten Maustaste auf die Datei, und klicken Sie auf Eigenschaften.
        ...
        -   Klicken Sie in Windows Vista und Windows 7 auf die Registerkarte Details. Stellen Sie sicher, dass die Felder Produktname und Dateiversion ordnungsgemäß ausgefüllt sind. Der Unternehmensname ist auf der Eigenschaftenseite 4.3 Windows Vista oder Windows 7 nicht sichtbar. \[\]
...
6.  Starten Sie das Spiel.
    ...
    4.  Vergewissern Sie sich, dass das Herunterfahren nicht blockiert wird \[ 3.1\]
...
11. Wählen Sie in AppVerifier die Option View -> Logs (Anzeigen > Protokolle) aus.
...
Dieses Tool befindet sich im DirectX SDK. Sobald das SDK auf einem Computer installiert ist, kann das Installationsprogramm für das Games for Windows TestTool auf dem Testcomputer platziert und installiert werden.

Suchen Sie das Installationsprogramm microsoft Games for Windows Test Tool auf dem Entwicklungscomputer, auf dem das DirectX SDK installiert ist. Standardmäßig wird sie an folgendem Speicherort platziert:
...
4.  Ersetzen Sie im Feld **Project Liste** create new **Project durch** Ihren Titelnamen, und klicken Sie auf **Neu erstellen.**
...
7.  Beginnen Sie oben, durchlaufen Sie die Testfälle, und klicken Sie je nach Bedarf auf **Erfolgreich** oder **Fehler.**
...
4.  Fügen Sie dem Feld Erwartetes Verhalten das erwartete Verhalten (im Gegensatz zu einer Beschreibung des Problems) **hinzu.**
5.  Fügen Sie dem Feld Reproduktionsschritte eine ausführliche Beschreibung zum Reproduzieren des **Problems** hinzu.
...
Dieser Vorgang ist mit dem Klicken auf Fehler **identisch,** mit Ausnahme der automatisch aufgefüllten Dropdownliste. Wählen Sie in diesem Fall entweder den entsprechenden TCR-Fehlertyp aus, oder wählen Sie **\* \* \* \* Nicht-TR-Problem** für Fehler aus, die außerhalb des TR-Bereichs liegen, aber weiterhin gemeldet werden sollen.

## <a name="resources"></a>Ressourcen

<dl> <dt>

<span id="Games_for_Windows__Technical_Requirements"></span><span id="games_for_windows__technical_requirements"></span><span id="GAMES_FOR_WINDOWS__TECHNICAL_REQUIREMENTS"></span>Games for Windows: Technische Anforderungen
</dt> <dd>

[Games for Windows Technical Requirements: Best Practices for Games on Windows XP, Windows Vista und Windows 7](./games-for-windows-technical-requirements-1-1-0006.md)
...
[Windows Anforderungen an die Vista-Anwendungsentwicklung für die Kompatibilität der Benutzerkontensteuerung](/previous-versions/dotnet/articles/bb530410(v=msdn.10))

</dd> <dt>

<span id="Windows_Installer_Information"></span><span id="windows_installer_information"></span><span id="WINDOWS_INSTALLER_INFORMATION"></span>Windows Informationen zum Installationsprogramm
</dt> <dd>
