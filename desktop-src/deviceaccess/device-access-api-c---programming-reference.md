...
| Thema | BESCHREIBUNG |
|---|---|
| [Funktionen](functions.md)<br/>           | Funktionen im Gerätezugriffs-API.<br/>                               |
| [COM-Schnittstellen](com-interfaces.md)<br/> | Component Object Model -Schnittstellen (COM) im Gerätezugriffs-API.<br/> |
