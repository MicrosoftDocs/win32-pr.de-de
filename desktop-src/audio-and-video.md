...
| [Windows Media Center Software Development Kit](/previous-versions/aa286546(v=msdn.10))<br/>                                          | Mit dem Windows Media Center Software Development Kit (SDK) können Entwickler Rich Media-Anwendungen und -Dienste für die Verwendung mit Maus, Tastatur und Remotesteuerung auf einem Media Center-PC erstellen.<br/>                        |
...
| [Windows Media Rights Manager 10.1.2 SDK](/previous-versions//bb649422(v=vs.85))<br/> | Unterstützt digital rights management (DRM) zum Schutz von Windows Mediendateien.<br/>                                                                                                                                            |
