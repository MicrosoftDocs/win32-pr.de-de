---
title: Asynchrone Beispielanwendung
description: Im folgenden Beispiel wird das asynchrone Senden einer Anforderung veranschaulicht.
...
ms.locfileid: "104206920"
---
# <a name="asynchronous-example-application"></a><span data-ttu-id="b8dd7-103">Asynchrone Beispielanwendung</span><span class="sxs-lookup"><span data-stu-id="b8dd7-103">Asynchronous Example Application</span></span>

<span data-ttu-id="b8dd7-104">Im folgenden Beispiel wird das asynchrone Senden einer Anforderung veranschaulicht.</span><span class="sxs-lookup"><span data-stu-id="b8dd7-104">The following example demonstrated sending a request asynchronously.</span></span>
