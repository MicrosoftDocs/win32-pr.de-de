...
---
# <a name="asynchronous-example-header"></a><span data-ttu-id="9a91f-103">Asynchroner Beispiel Header</span><span class="sxs-lookup"><span data-stu-id="9a91f-103">Asynchronous Example Header</span></span>

<span data-ttu-id="9a91f-104">Im folgenden finden Sie die Header Datei für die [asynchrone Beispielanwendung](asynchronous-example-application.md).</span><span class="sxs-lookup"><span data-stu-id="9a91f-104">The following is the header file for the [asynchronous example application](asynchronous-example-application.md).</span></span>
