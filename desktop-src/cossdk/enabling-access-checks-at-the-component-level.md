...
Wenn Ihre Anwendung eine Komponente enthält, die keine Sicherheitsüberprüfungen benötigt, können Sie die Rollenüberprüfungen für diese Komponente deaktivieren, um die Leistung zu verbessern. Oder beim Debuggen kann es hilfreich sein, die Sicherheit zu deaktivieren, damit Sie sich auf andere Aspekte der Programmfunktionalität konzentrieren können.

Wenn Sie eine Komponente installieren, werden standardmäßig Zugriffsüberprüfungen auf Komponentenebene aktiviert. Dies wird jedoch [](enabling-access-checks-for-an-application.md) nur wirksam, wenn Zugriffsüberprüfungen [](setting-a-security-level-for-access-checks.md) auf Anwendungsebene aktiviert sind und die Sicherheitsebene auf Ausführen von Zugriffsüberprüfungen auf Prozess- und **Komponentenebene festgelegt ist.**

**So aktivieren oder deaktivieren Sie Zugriffsüberprüfungen auf Komponentenebene**

1.  Suchen Sie in der Konsolenstruktur des Komponentendienste-Verwaltungstools die COM+-Anwendung, die die Komponente enthält, für die Sie Rollenüberprüfungen deaktivieren (oder aktivieren) möchten. Erweitern Sie die Ansicht in der Struktur, um die Komponenten im Ordner **Komponenten** anzeigen zu können.
...
> [!Note]  
> Ab Windows Server 2003 sind Zugriffsüberprüfungen auf Komponentenebene beim Erstellen einer COM+-Anwendung standardmäßig deaktiviert. Zugriffsüberprüfungen sind standardmäßig auf Anwendungsebene aktiviert und standardmäßig auf Komponentenebene deaktiviert. Zuvor wurden Zugriffsüberprüfungen standardmäßig auf Anwendungsebene deaktiviert und standardmäßig auf Komponentenebene aktiviert.
