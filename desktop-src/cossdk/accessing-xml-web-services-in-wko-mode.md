---
description: Sie können auf jeden XML-Webdienst zugreifen und diesen verwenden, auch wenn dieser XML-Webdienst nicht mit COM+ oder sogar Microsoft Windows erstellt wurde, solange der XML-Webdienst eine WSDL-Beschreibung seiner Syntax veröffentlicht.
...
Wenn auf einen XML-Webdienst zum ersten Mal im WKO-Modus zugegriffen wird, generiert COM+ einen Proxyclient und kompiliert ihn im Hintergrund. Diese Laufzeitgenerierung und das Fehlen persistenter Verbindungen im WKO-Modus führen im Vergleich zum CAO-Modus zu einer erheblich geringeren Leistung.
