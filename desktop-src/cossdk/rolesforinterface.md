...
---
# <a name="rolesforinterface-collection"></a>Rolesforinterface-Auflistung

Enthält ein-Objekt für jede Rolle, die der-Schnittstelle zugewiesen ist, mit der die Auflistung verknüpft ist. Die Rollen müssen bereits auf Anwendungsebene zugewiesen sein.
...
Die **rolesforinterface** -Auflistung erbt von der [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown) -Schnittstelle, verfügt jedoch nicht über zusätzliche Member.
