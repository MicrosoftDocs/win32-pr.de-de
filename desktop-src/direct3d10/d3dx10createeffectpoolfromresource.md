...
Erstellen Sie einen Effekt Pool aus einer Ressource.
...
Ein Handle für das Ressourcen Modul, das den Effekt enthält. HMODULE kann mit der [GetModuleHandle-Funktion](/windows/win32/api/libloaderapi/nf-libloaderapi-getmodulehandlea)abgerufen werden.
