...
---
# <a name="d3dxvec3transform-function-d3dx10mathh"></a>D3DXVec3Transform-Funktion (D3DX10Math.h)

Transformiert vektor (x, y, z, 1) durch eine angegebene Matrix.
...
Zeiger auf die [**D3DXVECTOR3-Quelle.**](d3d10-d3dxvector3.md)
