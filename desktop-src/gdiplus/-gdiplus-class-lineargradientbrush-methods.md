---
description: In diesem Thema werden die Methoden der LinearGradientBrush-Klasse aufgelistet. Eine vollständige Klassenauflistung finden Sie unter LinearGradientBrush-Klasse.
ms.assetid: fbbc4cca-6337-4429-b35f-ef9de951ea12
title: LinearGradientBrush-Methoden
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "118249494"
---
# <a name="lineargradientbrush-methods"></a>LinearGradientBrush-Methoden

In diesem Thema werden die Methoden der [**LinearGradientBrush-Klasse**](/windows/desktop/api/gdiplusbrush/nl-gdiplusbrush-lineargradientbrush) aufgelistet. Eine vollständige Klassenauflistung finden Sie unter **LinearGradientBrush-Klasse.**

-   [**Klon**](/windows/desktop/api/Gdiplusbrush/nf-gdiplusbrush-brush-clone)
...
-   [**Graphics.multiplytransform**](/windows/desktop/api/Gdiplusbrush/nf-gdiplusbrush-lineargradientbrush-multiplytransform)
...
-   [**SetBlendShape**](/windows/desktop/api/Gdiplusbrush/nf-gdiplusbrush-lineargradientbrush-setblendbellshape)
-   [**Lineargradientbrush.setblendtriangularshape**](/windows/desktop/api/Gdiplusbrush/nf-gdiplusbrush-lineargradientbrush-setblendtriangularshape)
