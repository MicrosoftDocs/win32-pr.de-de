---
description: In diesem Thema werden die Methoden der PathGradientBrush-Klasse aufgeführt. Eine vollständige Klassenauflistung finden Sie unter PathGradientBrushXX-Klasse.
ms.assetid: 17dc4bef-a8ee-4ff2-ade0-ff5cdb0633df
title: PathGradientBrush-Methoden
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "118067779"
---
# <a name="pathgradientbrush-methods"></a>PathGradientBrush-Methoden

In diesem Thema werden die Methoden der [**PathGradientBrush-Klasse**](/windows/desktop/api/gdipluspath/nl-gdipluspath-pathgradientbrush) aufgeführt. Eine vollständige Klassenauflistung finden Sie unter **PathGradientBrushXX-Klasse**.
...
-   [**Graphics.multiplytransform**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-pathgradientbrush-multiplytransform)
...
-   [**SetBlendShapeShape**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-pathgradientbrush-setblendbellshape)
-   [**Lineargradientbrush.setblendtriangularshape**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-pathgradientbrush-setblendtriangularshape)
