...
Die Server Core-Installationsoption für Windows Server 2008 R2 enthält jetzt eine Teilmenge der .NET Framework 2.0. Die Teilmenge ist die Funktionalität in .NET 2.0, die mit der Funktionalität in Server Core übereinstimmt. der Server Core-Basis wurden keine Binärdateien hinzugefügt, damit jeder Teil von .NET 2.0 funktioniert.

Die Server Core-Installationsoption für Windows Server 2008 wurde von .NET nicht unterstützt.

## <a name="manifestation-of-impact"></a>Wirkungserz weiter

Dadurch können einige .NET 2.0-basierte Anwendungen unter Server Core unter Windows Server 2008 R2 ausgeführt werden.
