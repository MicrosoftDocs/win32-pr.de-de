...
---
# <a name="using-tdhformatproperty-to-consume-event-data"></a><span data-ttu-id="02164-103">Verwenden von tdhformatproperty zum Verarbeiten von Ereignisdaten</span><span class="sxs-lookup"><span data-stu-id="02164-103">Using TdhFormatProperty to Consume Event Data</span></span>

<span data-ttu-id="02164-104">Im folgenden Beispiel wird gezeigt, wie Ereignisdaten mithilfe der [**tdhformatproperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) -Funktion verarbeitet werden.</span><span class="sxs-lookup"><span data-stu-id="02164-104">The following example shows how to consume event data using the [**TdhFormatProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) function.</span></span>
