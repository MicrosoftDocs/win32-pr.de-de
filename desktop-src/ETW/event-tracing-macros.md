...
---
# <a name="event-tracing-macros"></a>Ereignis Ablauf Verfolgungs Makros

Etw definiert die folgenden bequeme Makros, die Sie verwenden können, um auf Member der Ereignis \_ deskriptorstruktur zuzugreifen.
