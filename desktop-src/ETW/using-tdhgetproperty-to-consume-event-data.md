...
---
# <a name="using-tdhgetproperty-to-consume-event-data"></a>Verwenden von tdhgetproperty zum Verarbeiten von Ereignisdaten

Im folgenden Beispiel wird gezeigt, wie Ereignisdaten mithilfe der [**tdhgetproperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) -Funktion verarbeitet werden.
