---
description: Das folgende Beispiel zeigt, wie Ereignisdaten mithilfe der TdhGetProperty-Funktion verwendet werden.
ms.assetid: 16b36718-087f-4be9-9ca2-fc083358017b
title: Verwenden von TdhGetProperty zum Nutzen von Ereignisdaten
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "120083110"
---
# <a name="using-tdhgetproperty-to-consume-event-data"></a>Verwenden von TdhGetProperty zum Nutzen von Ereignisdaten

Das folgende Beispiel zeigt, wie Ereignisdaten mithilfe der [**TdhGetProperty-Funktion verwendet**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) werden.
