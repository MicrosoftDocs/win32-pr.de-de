---
description: Im folgenden Beispiel wird gezeigt, wie Ereignisdaten mithilfe der tdhgetproperty-Funktion verarbeitet werden.
ms.assetid: 16b36718-087f-4be9-9ca2-fc083358017b
title: Verwenden von tdhgetproperty zum Verarbeiten von Ereignisdaten
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103753033"
---
# <a name="using-tdhgetproperty-to-consume-event-data"></a><span data-ttu-id="b96ef-103">Verwenden von tdhgetproperty zum Verarbeiten von Ereignisdaten</span><span class="sxs-lookup"><span data-stu-id="b96ef-103">Using TdhGetProperty to Consume Event Data</span></span>

<span data-ttu-id="b96ef-104">Im folgenden Beispiel wird gezeigt, wie Ereignisdaten mithilfe der [**tdhgetproperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) -Funktion verarbeitet werden.</span><span class="sxs-lookup"><span data-stu-id="b96ef-104">The following example shows how to consume event data using the [**TdhGetProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) function.</span></span>
