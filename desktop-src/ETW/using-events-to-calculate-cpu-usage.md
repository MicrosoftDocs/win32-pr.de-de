...
---
# <a name="using-events-to-calculate-cpu-usage"></a>Verwenden von Ereignissen zur Berechnung der CPU-Auslastung

Im folgenden Beispiel wird gezeigt, wie Ereignisse verwendet werden, um die CPU-Auslastung für eine Reihe von Anweisungen zu berechnen. In diesem Beispiel wird davon ausgegangen, dass der Anbieter den Anweisungs Satz mit einem Start Ereignistyp und einem endereignistyp umschließt
