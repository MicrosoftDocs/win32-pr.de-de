---
description: Im folgenden Beispiel wird gezeigt, wie Ereignisse verwendet werden, um die CPU-Auslastung für eine Reihe von Anweisungen zu berechnen. In diesem Beispiel wird davon ausgegangen, dass der Anbieter den Anweisungs Satz mit einem Start Ereignistyp und einem endereignistyp umschließt
ms.assetid: 7bc15ed3-d299-40dd-9838-520f896921e3
title: Verwenden von Ereignissen zur Berechnung der CPU-Auslastung
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104977785"
---
# <a name="using-events-to-calculate-cpu-usage"></a><span data-ttu-id="64454-104">Verwenden von Ereignissen zur Berechnung der CPU-Auslastung</span><span class="sxs-lookup"><span data-stu-id="64454-104">Using Events to Calculate CPU Usage</span></span>

<span data-ttu-id="64454-105">Im folgenden Beispiel wird gezeigt, wie Ereignisse verwendet werden, um die CPU-Auslastung für eine Reihe von Anweisungen zu berechnen.</span><span class="sxs-lookup"><span data-stu-id="64454-105">The following example shows you how to use events to calculate the CPU usage for a set of instructions.</span></span> <span data-ttu-id="64454-106">In diesem Beispiel wird davon ausgegangen, dass der Anbieter den Anweisungs Satz mit einem Start Ereignistyp und einem endereignistyp umschließt</span><span class="sxs-lookup"><span data-stu-id="64454-106">This example assumes the provider wraps the instruction set with a start event type and an end event type.</span></span>
