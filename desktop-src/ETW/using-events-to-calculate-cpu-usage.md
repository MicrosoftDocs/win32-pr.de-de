---
description: Im folgenden Beispiel wird gezeigt, wie Sie ereignisse verwenden, um die CPU-Auslastung für eine Reihe von Anweisungen zu berechnen. In diesem Beispiel wird davon ausgegangen, dass der Anbieter den Anweisungssatz mit einem Startereignistyp und einem Endereignistyp umschließt.
ms.assetid: 7bc15ed3-d299-40dd-9838-520f896921e3
title: Berechnen der CPU-Auslastung mithilfe von Ereignissen
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119069280"
---
# <a name="using-events-to-calculate-cpu-usage"></a>Berechnen der CPU-Auslastung mithilfe von Ereignissen

Im folgenden Beispiel wird gezeigt, wie Sie ereignisse verwenden, um die CPU-Auslastung für eine Reihe von Anweisungen zu berechnen. In diesem Beispiel wird davon ausgegangen, dass der Anbieter den Anweisungssatz mit einem Startereignistyp und einem Endereignistyp umschließt.
