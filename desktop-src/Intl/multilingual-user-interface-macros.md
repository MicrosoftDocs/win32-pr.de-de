---
description: 'DIE stellt die folgenden Makros zum Abrufen von Informationen aus einer FILEMUIINFO-Struktur zur Verfügung:'
ms.assetid: d910d922-33f5-48ff-be0a-1ac11a13383a
title: mehrsprachige Benutzeroberfläche Makros
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118390803"
---
# <a name="multilingual-user-interface-macros"></a>mehrsprachige Benutzeroberfläche Makros

DIE stellt die folgenden Makros zum Abrufen von Informationen aus einer [**FILEMUIINFO-Struktur**](/windows/desktop/api/Winnls/ns-winnls-filemuiinfo) zur Verfügung:
