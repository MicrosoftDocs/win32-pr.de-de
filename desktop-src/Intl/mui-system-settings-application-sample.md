---
description: 'MUI: System Settings-Anwendungsbeispiel'
ms.assetid: 34cfd3a8-20b2-4a57-bc43-8da410cf9ae9
title: 'MUI: System Settings-Anwendungsbeispiel'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106360109"
---
# <a name="mui-system-settings-application-sample"></a><span data-ttu-id="a6561-103">MUI: System Settings-Anwendungsbeispiel</span><span class="sxs-lookup"><span data-stu-id="a6561-103">MUI: System Settings Application Sample</span></span>

<span data-ttu-id="a6561-104">Die in diesem Thema beschriebene Beispielanwendung ist eine einfache Hello MUI-Anwendung, die Systemeinstellungen für die Sprachen der Benutzeroberfläche unterstützt.</span><span class="sxs-lookup"><span data-stu-id="a6561-104">The sample application described in this topic is a simple Hello MUI application that supports system settings for its user interface languages.</span></span>
