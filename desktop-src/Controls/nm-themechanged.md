...
---
# <a name="nm_themechanged-notification-code"></a>Der von nm \_ gemechanter Benachrichtigungs Code

Benachrichtigt das übergeordnete Fenster eines Steuer Elements, dass sich das Design geändert hat. Dieser Benachrichtigungs Code wird in Form einer WM- [**\_ Benachrichtigungs**](wm-notify.md) Meldung gesendet.
