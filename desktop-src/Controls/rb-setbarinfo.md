...
Zeiger auf eine [**REBARINFO-Struktur,**](/windows/win32/api/commctrl/ns-commctrl-rebarinfo) die die festzulegenden Informationen enthält. Sie müssen den **cbSize-Member** dieser Struktur auf **sizeof**(REBARINFO) festlegen, bevor Sie diese Nachricht senden.
