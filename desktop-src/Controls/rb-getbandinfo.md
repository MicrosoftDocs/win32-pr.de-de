---
title: RB_GETBANDINFO (Commctrl.h)
...
keywords:
- RB_GETBANDINFO von Windows-Steuerelementen
topic_type:
- apiref
api_name:
- RB_GETBANDINFO
...
---
# <a name="rb_getbandinfo-message"></a>RB \_ GETBANDINFO-Nachricht
...
Nullbasierter Index des Bandes, für das die Informationen abgerufen werden.
...
Zeiger auf eine [**REBARBANDINFO-Struktur,**](/windows/win32/api/commctrl/ns-commctrl-rebarbandinfoa) die die angeforderten Bandinformationen erhält. Vor dem Senden dieser Nachricht müssen Sie das **cbSize-Element** dieser Struktur auf die Größe der **REBARBANDINFO-Struktur** und das **fMask-Element** auf die Elemente festlegen, die Sie abrufen möchten. Darüber hinaus müssen Sie den **cch-Member** der **REBARBANDINFO-Struktur** auf die Größe des **lpText-Puffers** festlegen, wenn RBBIM \_ TEXT angegeben wird.
