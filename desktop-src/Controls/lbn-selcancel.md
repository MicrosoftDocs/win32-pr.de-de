...
---
# <a name="lbn_selcancel-notification-code"></a>LBN \_ selcancel-Benachrichtigungs Code

Benachrichtigt die Anwendung, dass der Benutzer die Auswahl in einem Listenfeld abgebrochen hat. Das übergeordnete Fenster des Listen Felds empfängt diesen Benachrichtigungs Code über die [**WM- \_ Befehls**](/windows/desktop/menurc/wm-command) Meldung.
