...
---
# <a name="wm_vscroll-trackbar-notification-code"></a>WM- \_ VScroll-Benachrichtigungs Code (TrackBar)

Die **WM- \_ VScroll** -Nachricht wird an den Besitzer eines vertikalen TrackBar-Steuer Elements gesendet, wenn die Position des Schiebereglers geändert wird.
...
Beachten Sie, dass die **WM- \_ VScroll** -Nachricht nur 16 Bits an Positionsdaten enthält. Daher haben Anwendungen, die ausschließlich auf **WM \_ VScroll** (und [**WM \_ HScroll**](wm-hscroll--trackbar-.md)) für Schieberegler-Positionsdaten basieren, einen praktischen maximalen Positionswert von 65.535.
