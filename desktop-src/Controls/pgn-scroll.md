...
description: Benachrichtigt das übergeordnete Fenster eines Pagersteuerelements, dass das enthaltene Fenster gerade gescrollt werden soll. Diese Benachrichtigung wird in Form einer WM \_ NOTIFY-Nachricht gesendet.
ms.assetid: 3d40e75e-c445-4885-b807-8cfcb92cb2d9
keywords:
- PGN_SCROLL Benachrichtigungscode Windows-Steuerelemente
topic_type:
- apiref
api_name:
- PGN_SCROLL
...
Benachrichtigt das übergeordnete Fenster eines Pagersteuerelements, dass das enthaltene Fenster gerade gescrollt werden soll. Diese Benachrichtigung wird in Form einer [**WM \_ NOTIFY-Nachricht**](wm-notify.md) gesendet.
