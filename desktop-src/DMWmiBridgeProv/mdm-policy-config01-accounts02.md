...
description: Die MDM \_ Policy \_ Config01 \_ Accounts02-Klasse stellt Richtlinien im Zusammenhang mit Konten dar.
...
ms.locfileid: "119503400"
---
# <a name="mdm_policy_config01_accounts02-class"></a>MDM \_ Policy \_ Config01 \_ Accounts02-Klasse

\[Einige Informationen beziehen sich auf Vorabversionen, die vor der kommerziellen Freigabe grundlegend geändert werden können. Microsoft übernimmt keine Garantie, weder ausdrücklich noch stillschweigend, für die hier bereitgestellten Informationen.\]

Die **MDM \_ Policy \_ Config01 \_ Accounts02-Klasse** stellt Richtlinien im Zusammenhang mit Konten dar.
...
Die **MDM \_ Policy \_ Config01 \_ Accounts02-Klasse** verfügt über diese Typen von Membern:

-   [Eigenschaften](#properties)

### <a name="properties"></a>Eigenschaften

Die **MDM \_ Policy \_ Config01 \_ Accounts02-Klasse** verfügt über diese Eigenschaften.
...
[AllowMicrosoftAccountSignInAccountant](/windows/client-management/mdm/policy-csp-accounts#accounts-allowmicrosoftaccountsigninassistant)
</dt> <dd> <dl> <dt>
...
Identifiziert den Namen des übergeordneten Knotens. Für diese Klasse lautet die Zeichenfolge "Accounts".
