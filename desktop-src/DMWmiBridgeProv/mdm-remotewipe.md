...
Die **MDM- \_ RemoteWipe** -Klasse ermöglicht eine Remote Löschung eines Geräts.
...
|:----------------------------------------------------|:---------------------------------------------------------|
| [**dowipeer Method**](mdm-remotewipe-dowipemethod.md) | Hiermit wird das Gerät ausgelöst, um die Remote Löschung zu starten.<br/> |
...
Gibt den Namen des übergeordneten Knotens an. Bei dieser Klasse ist die Zeichenfolge "RemoteWipe".
...
Im folgenden Beispiel wird veranschaulicht, wie RemoteWipe verwendet und die dowipeer-Methode aufgerufen wird.

> [!Note]  
> Dieses Beispiel muss unter "lokaler Systembenutzer" ausgeführt werden. Laden Sie hierzu das PsExec-Tool von herunter, und führen Sie es über <https://technet.microsoft.com/sysinternals/bb897553.aspx> `psexec.exe -i -s cmd.exe` eine Eingabeaufforderung mit erhöhten Rechten aus.
