---
description: Vorgehensweise beim Hinzufügen oder Entfernen von permanenten Laufwerksbuchstaben Zuweisungen. Diese Laufwerk Buchstaben Zuweisungen bleiben durch das Herunterfahren des Systems erhalten.
ms.assetid: 17a6df9d-07df-42f7-89c9-72a1d02141f6
title: Bearbeiten von Laufwerk Buchstaben Zuweisungen
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106360631"
---
# <a name="editing-drive-letter-assignments"></a><span data-ttu-id="adbfb-104">Bearbeiten von Laufwerk Buchstaben Zuweisungen</span><span class="sxs-lookup"><span data-stu-id="adbfb-104">Editing Drive Letter Assignments</span></span>

<span data-ttu-id="adbfb-105">Das Codebeispiel in diesem Thema zeigt Ihnen, wie Sie persistente Laufwerk Buchstaben Zuweisungen hinzufügen oder entfernen.</span><span class="sxs-lookup"><span data-stu-id="adbfb-105">The code example in this topic shows you how to add or remove persistent drive letter assignments.</span></span> <span data-ttu-id="adbfb-106">Diese Laufwerk Buchstaben Zuweisungen bleiben durch das Herunterfahren des Systems erhalten.</span><span class="sxs-lookup"><span data-stu-id="adbfb-106">These drive letter assignments persist through system shutdown.</span></span> <span data-ttu-id="adbfb-107">Weitere Informationen finden Sie unter [Zuweisen eines Laufwerk Buchstabens zu einem Volume](assigning-a-drive-letter-to-a-volume.md).</span><span class="sxs-lookup"><span data-stu-id="adbfb-107">For more information, see [Assigning a Drive Letter to a Volume](assigning-a-drive-letter-to-a-volume.md).</span></span>

<span data-ttu-id="adbfb-108">Im Codebeispiel werden die folgenden Funktionen verwendet: [**definedosdevice**](/windows/desktop/api/FileAPI/nf-fileapi-definedosdevicew), [**DeleteVolumeMountPoint**](/windows/desktop/api/FileAPI/nf-fileapi-deletevolumemountpointw), [**getvolumenameforvolumemountpoint**](/windows/desktop/api/FileAPI/nf-fileapi-getvolumenameforvolumemountpointw)und [**setvolumemountpoint**](/windows/desktop/api/WinBase/nf-winbase-setvolumemountpointa).</span><span class="sxs-lookup"><span data-stu-id="adbfb-108">The code example uses the following functions: [**DefineDosDevice**](/windows/desktop/api/FileAPI/nf-fileapi-definedosdevicew), [**DeleteVolumeMountPoint**](/windows/desktop/api/FileAPI/nf-fileapi-deletevolumemountpointw), [**GetVolumeNameForVolumeMountPoint**](/windows/desktop/api/FileAPI/nf-fileapi-getvolumenameforvolumemountpointw), and [**SetVolumeMountPoint**](/windows/desktop/api/WinBase/nf-winbase-setvolumemountpointa).</span></span>
