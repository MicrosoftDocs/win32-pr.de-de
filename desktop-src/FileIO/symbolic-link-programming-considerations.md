---
description: Programmierüberlegungen für die Arbeit mit symbolischen Verknüpfungen.
...
Beachten Sie bei der Arbeit mit symbolischen Verknüpfungen die folgenden Überlegungen zur Programmierung:
...
-   Symbolische Verknüpfungen sind Aufbereitungspunkte. Weitere Informationen finden Sie unter [Bestimmen, ob ein Verzeichnis ein bereitgestellter Ordner ist.](determining-whether-a-directory-is-a-volume-mount-point.md)
-   In einem bestimmten Pfad sind maximal 63 Reparsepunkte (und damit symbolische Verknüpfungen) zulässig.

    **Windows Server 2003 und Windows XP:** Es gibt einen Grenzwert von 31 Reparsepunkten für jeden angegebenen Pfad.
