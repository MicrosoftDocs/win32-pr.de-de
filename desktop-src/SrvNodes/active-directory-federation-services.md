...
[ADFS-Klassenbibliothek](/previous-versions/windows/desktop/active-directory-federation-services/ms681631(v=vs.85))
</dt> <dd>

APIs, die zum Entwickeln von Anwendungen verwendet werden, die AD FS verwenden.
