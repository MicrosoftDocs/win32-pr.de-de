...
---
# <a name="performing-file-io-on-riff-files"></a><span data-ttu-id="9ff1d-112">Ausführen von Datei-e/a für Riff Dateien</span><span class="sxs-lookup"><span data-stu-id="9ff1d-112">Performing File I/O on RIFF Files</span></span>

<span data-ttu-id="9ff1d-113">Im folgenden Beispiel wird gezeigt, wie Sie eine Riff Datei für gepufferte e/a-Vorgänge öffnen, und wie Sie "Riff"-Blöcke absteigend, aufsteigende und lesen können.</span><span class="sxs-lookup"><span data-stu-id="9ff1d-113">The following example shows how to open a RIFF file for buffered I/O, as well as how to descend, ascend, and read "RIFF" chunks.</span></span>
