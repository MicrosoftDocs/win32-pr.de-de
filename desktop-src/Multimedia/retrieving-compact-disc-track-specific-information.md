...
---
# <a name="retrieving-compact-disc-track-specific-information"></a>Informationen zu Compact Disk Track-Specific werden abgerufen.

Für CD-Audiogeräte können Sie den Start Speicherort und die Länge einer Spur durch Angabe des MCI- \_ laufverfolgungsflags und durch Festlegen des **dwtrack** -Members von [**MCI-Status- \_ \_ Parametern**](mci-status-parms.md) auf die gewünschte Nachverfolgung erhalten. Um die Startposition eines Titels abzurufen, legen Sie den Wert für das **dwitem** -Element auf die MCI- \_ Status \_ Position fest. Um die Länge eines Titels abzurufen, legen Sie **dwitem** auf MCI- \_ Status \_ Länge fest. Im folgenden Beispiel wird z. b. die Gesamtzahl der Titel auf der Compact Disk und die Startposition der einzelnen Spuren abgerufen. Anschließend wird die [MessageBox](/windows/win32/api/winuser/nf-winuser-messagebox) -Funktion verwendet, um die Startpositionen der Spuren zu melden.
