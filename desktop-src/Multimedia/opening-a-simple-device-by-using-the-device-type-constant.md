...
---
# <a name="opening-a-simple-device-by-using-the-device-type-constant"></a><span data-ttu-id="0e453-104">Öffnen eines einfachen Geräts mithilfe der Device-Type-Konstante</span><span class="sxs-lookup"><span data-stu-id="0e453-104">Opening a Simple Device by Using the Device-Type Constant</span></span>

<span data-ttu-id="0e453-105">Im folgenden Beispiel wird ein CD-Audiogerät geöffnet, indem eine Gerätetyp Konstante mithilfe der [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) -Funktion angegeben wird.</span><span class="sxs-lookup"><span data-stu-id="0e453-105">The following example opens a CD audio device by specifying a device-type constant using the [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) function.</span></span>
