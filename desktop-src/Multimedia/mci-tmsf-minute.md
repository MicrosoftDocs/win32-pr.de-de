...
---
# <a name="mci_tmsf_minute-macro"></a>MCI \_ TMSF- \_ Minuten Makro

Das **MCI \_ TMSF \_ Minute** -Makro ruft die Minuten Komponente von einem Parameter ab, der gepackte Spuren/Minuten/Sekunden/Frames (TMSF) enthält.
...
Gibt die Minuten Komponente der angegebenen TMSF-Informationen zurück.
...
Das **MCI \_ TMSF \_ Minute** -Makro wird wie folgt definiert:
