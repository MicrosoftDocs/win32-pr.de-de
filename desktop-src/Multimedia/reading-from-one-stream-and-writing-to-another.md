---
title: Lesen aus einem Stream und Schreiben in einen anderen Stream
description: Lesen aus einem Stream und Schreiben in einen anderen Stream
...
ms.locfileid: "106338007"
---
# <a name="reading-from-one-stream-and-writing-to-another"></a><span data-ttu-id="dde6d-103">Lesen aus einem Stream und Schreiben in einen anderen Stream</span><span class="sxs-lookup"><span data-stu-id="dde6d-103">Reading from One Stream and Writing to Another</span></span>

<span data-ttu-id="dde6d-104">Im folgenden Beispiel werden Daten aus einem Stream gelesen, etwas mit den Daten erledigt und die komprimierten Daten in einen Stream einer neuen Datei geschrieben.</span><span class="sxs-lookup"><span data-stu-id="dde6d-104">The following example reads data from a stream, does something with the data, and writes the compressed data into a stream of a new file.</span></span>
