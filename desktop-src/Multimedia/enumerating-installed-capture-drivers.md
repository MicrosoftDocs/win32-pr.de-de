...
---
# <a name="enumerating-installed-capture-drivers"></a>Auflisten installierter Erfassungs Treiber

Im folgenden Beispiel wird die Funktion [**capgetdriverdescription**](/windows/desktop/api/Vfw/nf-vfw-capgetdriverdescriptiona) zum Abrufen der Namen und Versionen der installierten Erfassungs Treiber verwendet.
