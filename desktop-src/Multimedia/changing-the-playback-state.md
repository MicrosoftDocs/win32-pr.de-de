...
---
# <a name="changing-the-playback-state"></a><span data-ttu-id="c6a60-103">Ändern des Wiedergabe Zustands</span><span class="sxs-lookup"><span data-stu-id="c6a60-103">Changing the Playback State</span></span>

<span data-ttu-id="c6a60-104">In den folgenden Beispielen wird gezeigt, wie die Befehle anhalten, fort [**setzen,**](resume.md) [**Anhalten**](stop.md)und [**Suchen**](seek.md) in der [**mciSendString**](/previous-versions//dd757161(v=vs.85)) -Funktion [**verwendet werden.**](pause.md)</span><span class="sxs-lookup"><span data-stu-id="c6a60-104">The following examples show how to use the [**pause**](pause.md), [**resume**](resume.md), [**stop**](stop.md), and [**seek**](seek.md) commands in the [**mciSendString**](/previous-versions//dd757161(v=vs.85)) function.</span></span>
...
<span data-ttu-id="c6a60-105">Im folgenden Beispiel wird gezeigt, wie der Suchmodus geändert wird:</span><span class="sxs-lookup"><span data-stu-id="c6a60-105">The following example shows how to change the seek mode:</span></span>
