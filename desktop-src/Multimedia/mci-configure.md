...
---
# <a name="mci_configure-command"></a>MCI- \_ Befehl "configure"

Mit dem Befehl MCI \_ configure wird ein Dialogfeld zum Festlegen der Betriebs Optionen angezeigt. Dieser Befehl wird von Digital-Video-Geräten erkannt.
