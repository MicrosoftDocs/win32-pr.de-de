...
keywords:
- Multimediaaudio, Wellenformfunktionen
- audio,waveform-Funktionen
- Waveform-Audio, Funktionen
- Waveform-Audioreferenz,Funktionen
- Referenz für Wavefore-Audio, Funktionen
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119781480"
---
# <a name="waveform-functions"></a>Waveform-Funktionen

Die folgenden Funktionen werden mit Waveform-Audio verwendet.
