...
ms.locfileid: "119806750"
---
# <a name="multimedia-structures"></a>Multimediastrukturen

Die folgenden Strukturen werden mit Multimedia verwendet.
...
-   [**PITCAPS**](/windows/win32/api/joystickapi/ns-joystickapi-joycaps)
-   [**ÜBER DIE NSSINFO**](/windows/win32/api/joystickapi/ns-joystickapi-joyinfo)
-   [**INFOEX (IN DER INFO-DATEI)**](/windows/win32/api/joystickapi/ns-joystickapi-joyinfoex)
...
-   [**\_GENERISCHES \_ MCI-PARMS**](mci-generic-parms.md)
...
[Multimediareferenz](multimedia-reference.md)
</dt> </dl>
