...
---
# <a name="opening-the-playback-window"></a>Öffnen des Wiedergabe Fensters

Im folgenden Beispiel wird gezeigt, wie Sie mit dem Befehl zum [**\_ Öffnen von MCI**](mci-open.md) ein übergeordnetes Fenster festlegen und ein untergeordnetes Element dieses Fensters erstellen.
