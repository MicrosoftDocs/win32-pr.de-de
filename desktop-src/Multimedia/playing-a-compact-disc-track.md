...
---
# <a name="playing-a-compact-disc-track"></a>Wiedergabe einer Compact Disk Track

Im folgenden Beispiel wird ein CD-Audiogerät geöffnet, der durch den *btrack* -Parameter angegebene Track abgespielt und das Gerät nach Abschluss der Wiedergabe geschlossen. Er verwendet die [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) -Funktion.
...
Zum Angeben einer Position in Bezug auf eine Spur auf einer Compact Disk müssen Sie das Zeitformat Track/Minute/Second/Frame (TMSF) verwenden.
