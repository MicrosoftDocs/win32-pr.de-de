...
---
# <a name="example-of-writing-waveform-data"></a>Beispiel für das Schreiben von Waveform-Daten

Das folgende Beispiel veranschaulicht die Schritte, die erforderlich sind, um eine [**wavehdr**](/windows/win32/api/mmeapi/ns-mmeapi-wavehdr) -Struktur zuzuordnen und einzurichten und einen Datenblock in ein Wellenform-Ausgabegerät zu schreiben.
