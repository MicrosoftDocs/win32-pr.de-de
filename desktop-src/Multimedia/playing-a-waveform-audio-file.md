...
---
# <a name="playing-a-waveform-audio-file"></a><span data-ttu-id="cfa20-103">Wiedergeben einer Waveform-Audio Datei</span><span class="sxs-lookup"><span data-stu-id="cfa20-103">Playing a Waveform-Audio File</span></span>

<span data-ttu-id="cfa20-104">Im folgenden Beispiel wird ein Waveform-Audiogerät geöffnet, und die durch den *lpszwavefilename* -Parameter angegebene Waveform-Audiodatei wird mit der [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) -Funktion wiedergegeben.</span><span class="sxs-lookup"><span data-stu-id="cfa20-104">The following example opens a waveform-audio device and plays the waveform-audio file specified by the *lpszWAVEFileName* parameter using the [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) function.</span></span>
