...
---
# <a name="using-the-editing-functions-and-putting-a-file-on-the-clipboard"></a><span data-ttu-id="4bc14-106">Verwenden der Bearbeitungsfunktionen und Ablegen einer Datei in die Zwischenablage</span><span class="sxs-lookup"><span data-stu-id="4bc14-106">Using the Editing Functions and Putting a File on the Clipboard</span></span>

<span data-ttu-id="4bc14-107">Im folgenden Beispiel werden Segmente aus einem Array von Streams gekürzt, kopiert oder gelöscht.</span><span class="sxs-lookup"><span data-stu-id="4bc14-107">The following example cuts, copies, or deletes segments from an array of streams.</span></span> <span data-ttu-id="4bc14-108">Die ausgeschnittenen und kopierten Streams werden in einer neuen Datei zusammengeführt und in der Zwischenablage abgelegt.</span><span class="sxs-lookup"><span data-stu-id="4bc14-108">The cut and copied streams are merged into a new file and placed on the clipboard.</span></span> <span data-ttu-id="4bc14-109">Zu den verwendeten Funktionen gehören [**editstreamclone**](/windows/desktop/api/Vfw/nf-vfw-editstreamclone), [**editstreamcopy**](/windows/desktop/api/Vfw/nf-vfw-editstreamcopy)und [**editstreamcut**](/windows/desktop/api/Vfw/nf-vfw-editstreamcut).</span><span class="sxs-lookup"><span data-stu-id="4bc14-109">The functions used include [**EditStreamClone**](/windows/desktop/api/Vfw/nf-vfw-editstreamclone), [**EditStreamCopy**](/windows/desktop/api/Vfw/nf-vfw-editstreamcopy), and [**EditStreamCut**](/windows/desktop/api/Vfw/nf-vfw-editstreamcut).</span></span>
