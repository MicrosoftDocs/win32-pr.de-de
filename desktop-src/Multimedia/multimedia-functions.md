...
keywords:
- Windows Multimediafunktionen
- Multimedia, Funktionen
- Multimediareferenz,Funktionen
- Referenz zu Multimediafunktionen
...
-   [**beiconfigChanged**](/windows/desktop/api/joystickapi/nf-joystickapi-joyconfigchanged)
...
-   [**beigetPos**](/windows/win32/api/joystickapi/nf-joystickapi-joygetpos)
-   [**beigetPosEx**](/windows/win32/api/joystickapi/nf-joystickapi-joygetposex)
-   [**–getThreshold**](/windows/win32/api/joystickapi/nf-joystickapi-joygetthreshold)
-   [**-ReleaseCapture**](/windows/win32/api/joystickapi/nf-joystickapi-joyreleasecapture)
-   [**beisetCapture**](/windows/win32/api/joystickapi/nf-joystickapi-joysetcapture)
-   [**beisetThreshold**](/windows/win32/api/joystickapi/nf-joystickapi-joysetthreshold)
...
-   [**ohne Verbindung**](/windows/win32/api/mmeapi/nf-mmeapi-midiconnect)
-   [**müssen Sie sich mit "disconnect" verbinden.**](/windows/win32/api/mmeapi/nf-mmeapi-mididisconnect)
-   [**bluInAddBuffer**](/windows/win32/api/mmeapi/nf-mmeapi-midiinaddbuffer)
-   [**keyboardInClose**](/windows/win32/api/mmeapi/nf-mmeapi-midiinclose)
-   [**mussinGetDevCaps**](/windows/win32/api/mmeapi/nf-mmeapi-midiingetdevcaps)
-   [**keyboardInGetErrorText**](/windows/win32/api/mmeapi/nf-mmeapi-midiingeterrortext)
-   [**mussinGetID sein.**](/windows/win32/api/mmeapi/nf-mmeapi-midiingetid)
-   [**beiinGetNumDevs**](/windows/win32/api/mmeapi/nf-mmeapi-midiingetnumdevs)
-   [**mussinMessage**](/windows/win32/api/mmeapi/nf-mmeapi-midiinmessage)
-   [**bei unsInOpen**](/windows/win32/api/mmeapi/nf-mmeapi-midiinopen)
-   [**keyboardInPrepareHeader**](/windows/win32/api/mmeapi/nf-mmeapi-midiinprepareheader)
-   [**KeyboardInProc**](/previous-versions//dd798460(v=vs.85))
-   [**keyboardInReset**](/windows/win32/api/mmeapi/nf-mmeapi-midiinreset)
-   [**durchstartenInStart**](/windows/win32/api/mmeapi/nf-mmeapi-midiinstart)
-   [**keyboardInStop**](/windows/win32/api/mmeapi/nf-mmeapi-midiinstop)
-   [**keyboardInUnprepareHeader**](/windows/win32/api/mmeapi/nf-mmeapi-midiinunprepareheader)
-   [**ohneCacheDrumPatches**](/windows/win32/api/mmeapi/nf-mmeapi-midioutcachedrumpatches)
-   [**ohneCachePatches**](/windows/win32/api/mmeapi/nf-mmeapi-midioutcachepatches)
-   [**dateiOutClose**](/windows/win32/api/mmeapi/nf-mmeapi-midioutclose)
-   [**ohneGetDevCaps**](/windows/win32/api/mmeapi/nf-mmeapi-midioutgetdevcaps)
-   [**textOutGetErrorText**](/windows/win32/api/mmeapi/nf-mmeapi-midioutgeterrortext)
-   [**ohneGetID**](/windows/win32/api/mmeapi/nf-mmeapi-midioutgetid)
-   [**ohneGetNumDevs**](/windows/win32/api/mmeapi/nf-mmeapi-midioutgetnumdevs)
-   [**ohneGetVolume**](/windows/win32/api/mmeapi/nf-mmeapi-midioutgetvolume)
-   [**ohneLongMsg**](/windows/win32/api/mmeapi/nf-mmeapi-midioutlongmsg)
...
-   [**mixerÖffnen**](/windows/win32/api/mmeapi/nf-mmeapi-mixeropen)
