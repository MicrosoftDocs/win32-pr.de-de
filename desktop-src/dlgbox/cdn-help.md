...
---
# <a name="cdn_help-notification-code"></a>CDN- \_ Hilfe-Benachrichtigungs Code
...
Wird von einem Explorer-Dialogfeld " **Öffnen** " oder " **Speichern** unter" gesendet, wenn der Benutzer auf die Schaltfläche **Hilfe** klickt.
...
Ein Zeiger auf eine [**ofnotify**](/windows/desktop/api/Commdlg/ns-commdlg-ofnotifya) -Struktur. Die **ofnotify** -Struktur enthält eine [**NMHDR**](/windows/win32/api/richedit/ns-richedit-nmhdr) -Struktur, deren **Codemember** die **CDN- \_ Hilfe** Benachrichtigungs Meldung angibt.
