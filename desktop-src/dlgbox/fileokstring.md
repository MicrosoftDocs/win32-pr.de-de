...
description: Ein Dialogfeld Öffnen oder Speichern unter sendet die registrierte FILEOKSTRING-Nachricht an Ihre Hookprozedur OFNHookProc, wenn der Benutzer einen Dateinamen angibt und auf die Schaltfläche OK klickt.
...
ms.locfileid: "119741760"
---
# <a name="fileokstring-message"></a>FILEOKSTRING-Meldung
...
Die Hookprozedur muss die **FILEOKSTRING-Konstante** in einem Aufruf der [**RegisterWindowMessage-Funktion**](/windows/desktop/api/winuser/nf-winuser-registerwindowmessagea) angeben, um den Bezeichner für die vom Dialogfeld gesendete Nachricht zu erhalten.
