---
description: Bei ergänzenden Telefoniediensten handelt es sich um die Sammlung aller dienste, die von der API definiert werden, mit Denen, die nicht in der Teilmenge "Basic-Telefonie" enthalten sind.
...
Bei ergänzenden Telefoniediensten handelt es sich um die Sammlung aller dienste, die von der API definiert werden, mit Denen, die nicht in der Teilmenge "Basic-Telefonie" enthalten sind. Sie enthält alle so genannten ergänzenden Features, die auf modernen PBX-Dateien zu finden sind, z. B. Hold, Transfer, Conference, Park und so weiter. Alle ergänzenden Features werden als optional betrachtet. Das heißt, der Dienstanbieter entscheidet, welche dieser Dienste er bietet oder nicht.
