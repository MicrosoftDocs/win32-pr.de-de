...
In den folgenden Tabellen finden Sie eine alphabetische Kurzauflistung der TAPI-Funktionen und -Strukturen sowie die den einzelnen -Element zugeordneten TAPI-Versionen.



TAPI-Funktion

Verwenden mit TAPI-Versionen
