---
description: Im folgenden finden Sie die komplette Auflistung des Manifest-Datei Schemas.
ms.assetid: 5a4040a4-66ed-44ea-a07f-6410f88d1446
title: Manifest-Datei Schema
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106367337"
---
# <a name="manifest-file-schema"></a><span data-ttu-id="635be-103">Manifest-Datei Schema</span><span class="sxs-lookup"><span data-stu-id="635be-103">Manifest File Schema</span></span>

<span data-ttu-id="635be-104">Im folgenden finden Sie die komplette Auflistung des Manifest-Datei Schemas.</span><span class="sxs-lookup"><span data-stu-id="635be-104">The following is the complete listing of the manifest file schema.</span></span>
