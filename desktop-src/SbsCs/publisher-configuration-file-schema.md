...
---
# <a name="publisher-configuration-file-schema"></a><span data-ttu-id="d0621-103">Schema der Verleger Konfigurationsdatei</span><span class="sxs-lookup"><span data-stu-id="d0621-103">Publisher Configuration File Schema</span></span>

<span data-ttu-id="d0621-104">Im folgenden finden Sie die komplette Auflistung des Schema der Verleger Konfigurationsdatei.</span><span class="sxs-lookup"><span data-stu-id="d0621-104">The following is the complete listing of the publisher configuration file schema.</span></span>
