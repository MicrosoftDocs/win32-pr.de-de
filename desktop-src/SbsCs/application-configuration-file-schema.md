---
description: Im folgenden finden Sie die komplette Auflistung des Schemas für die Anwendungs Konfigurationsdatei.
ms.assetid: c673dbff-cb64-4e90-88a8-c5f2c259f1d3
title: Schema der Anwendungs Konfigurationsdatei
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104216345"
---
# <a name="application-configuration-file-schema"></a><span data-ttu-id="c9c2c-103">Schema der Anwendungs Konfigurationsdatei</span><span class="sxs-lookup"><span data-stu-id="c9c2c-103">Application Configuration File Schema</span></span>

<span data-ttu-id="c9c2c-104">Im folgenden finden Sie die komplette Auflistung des Schemas für die Anwendungs Konfigurationsdatei.</span><span class="sxs-lookup"><span data-stu-id="c9c2c-104">The following is the complete listing of the application configuration file schema.</span></span>
