...
---
# <a name="example-code-for-using-iadsproperty-interfaces-to-access-the-property-cache"></a><span data-ttu-id="a5e14-105">Beispiel Code für die Verwendung von iadsproperty-Schnittstellen für den Zugriff auf den Eigenschaften Cache</span><span class="sxs-lookup"><span data-stu-id="a5e14-105">Example Code for Using IADsProperty Interfaces to Access the Property Cache</span></span>

<span data-ttu-id="a5e14-106">Im folgenden Codebeispiel wird gezeigt, wie die Schnittstellen [**IADsPropertyList**](/windows/desktop/api/Iads/nn-iads-iadspropertylist), [**iadspropertyentry**](/windows/desktop/api/Iads/nn-iads-iadspropertyentry)und [**iadspropertyvalue**](/windows/desktop/api/Iads/nn-iads-iadspropertyvalue) mit C++ und ADSI verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="a5e14-106">The following code example shows how to use the [**IADsPropertyList**](/windows/desktop/api/Iads/nn-iads-iadspropertylist), [**IADsPropertyEntry**](/windows/desktop/api/Iads/nn-iads-iadspropertyentry), and [**IADsPropertyValue**](/windows/desktop/api/Iads/nn-iads-iadspropertyvalue) interfaces with C++ and ADSI.</span></span>
...
<span data-ttu-id="a5e14-107">Im folgenden Codebeispiel wird gezeigt, wie die Schnittstellen [**IADsPropertyList**](/windows/desktop/api/Iads/nn-iads-iadspropertylist), [**iadspropertyentry**](/windows/desktop/api/Iads/nn-iads-iadspropertyentry)und [**iadspropertyvalue**](/windows/desktop/api/Iads/nn-iads-iadspropertyvalue) mithilfe von Visual Basic und ADSI verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="a5e14-107">The following code example shows how to use the [**IADsPropertyList**](/windows/desktop/api/Iads/nn-iads-iadspropertylist), [**IADsPropertyEntry**](/windows/desktop/api/Iads/nn-iads-iadspropertyentry), and [**IADsPropertyValue**](/windows/desktop/api/Iads/nn-iads-iadspropertyvalue) interfaces using Visual Basic and ADSI.</span></span>
