...
Dieses wohlgeformte Active Directory-Objekt wird nun nach dem Schnittstellenbezeichner abgefragt, der für den anfänglichen [**ADsGetObject-Aufruf**](/windows/desktop/api/Adshlp/nf-adshlp-adsgetobject) angefordert wurde, und ein Zeiger auf diese Schnittstelle wird abgerufen (7) und über den ADSI-Server an den Client übergeben (8&9). Von da an arbeitet der Client direkt mit der Anbieterkomponente über die Schnittstellenmethoden, bis die erste Anforderung erfüllt ist (10).
