...
---
# <a name="code-example-for-working-with-adsi-error-messages"></a><span data-ttu-id="6656b-104">Code Beispiel für das Arbeiten mit ADSI-Fehlermeldungen</span><span class="sxs-lookup"><span data-stu-id="6656b-104">Code Example for Working with ADSI Error Messages</span></span>

<span data-ttu-id="6656b-105">Im folgenden Codebeispiel wird gezeigt, wie eine ADSI-Fehlermeldung abgerufen wird.</span><span class="sxs-lookup"><span data-stu-id="6656b-105">The following code example shows how to retrieve an ADSI error message.</span></span>
