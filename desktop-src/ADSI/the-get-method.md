...
keywords:
- Abrufen von ADSI mithilfe von IADs Get
- ADSI ADSI mithilfe der Get-Methode von IADs
ms.topic: article
ms.date: 05/31/2018
...
In Automation-Sprachen kann auch direkt über die Punkt notation auf benannte Attribute zugegriffen werden. Beispiel: **-Objekt. Get("distinguishedName")** ist identisch mit **object.distinguishedName**.

Das folgende Codebeispiel ist identisch mit dem vorherigen Beispiel, außer dass auf das **DistinguishedName-Attribut** mithilfe der Punkt notation zugegriffen wird.
...
Wenn für das Objekt kein Wert festgelegt ist, gibt die [**IADs::Get-Methode**](/windows/desktop/api/Iads/nf-iads-iads-get) den Fehler "Property not found in cache" (Eigenschaft wurde nicht im Cache gefunden) zurück.
