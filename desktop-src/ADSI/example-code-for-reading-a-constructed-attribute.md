...
---
# <a name="example-code-for-reading-a-constructed-attribute"></a><span data-ttu-id="1d15f-104">Beispiel Code für das Lesen eines konstruierten Attributs</span><span class="sxs-lookup"><span data-stu-id="1d15f-104">Example Code for Reading a Constructed Attribute</span></span>

<span data-ttu-id="1d15f-105">Das folgende Codebeispiel zeigt eine-Methode, die zum Abrufen eines Attribut Werts verwendet werden kann, der mit allen Attributtypen verwendet werden kann.</span><span class="sxs-lookup"><span data-stu-id="1d15f-105">The following code example shows a method that can be used to retrieve an attribute value that will work with all attributes types.</span></span>
...
<span data-ttu-id="1d15f-106">Das folgende Codebeispiel zeigt eine-Methode, die zum Abrufen eines Attribut Werts verwendet werden kann, der mit allen Attributtypen verwendet werden kann.</span><span class="sxs-lookup"><span data-stu-id="1d15f-106">The following code example shows a method that can be used to retrieve an attribute value that will work with all attributes types.</span></span>
