---
title: Beispiel Code für das Hinzufügen eines ACE zu einer Datei
description: Im folgenden Codebeispiel wird gezeigt, wie Sie die iadssecurityutility-Schnittstelle verwenden, um einer Datei einen ACE hinzuzufügen.
ms.assetid: d47d3ebe-cc14-412d-be27-841e25b43c3a
ms.tgt_platform: multiple
keywords:
- Beispiel Code für das Hinzufügen eines ACE zu einer Datei-ADSI
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106338562"
---
# <a name="example-code-for-adding-an-ace-to-a-file"></a><span data-ttu-id="5befc-104">Beispiel Code für das Hinzufügen eines ACE zu einer Datei</span><span class="sxs-lookup"><span data-stu-id="5befc-104">Example Code for Adding an ACE to a File</span></span>

<span data-ttu-id="5befc-105">Im folgenden Codebeispiel wird gezeigt, wie Sie die [**iadssecurityutility**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) -Schnittstelle verwenden, um einer Datei einen ACE hinzuzufügen.</span><span class="sxs-lookup"><span data-stu-id="5befc-105">The following code example shows how to use the [**IADsSecurityUtility**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) interface to add an ACE to a file.</span></span>
