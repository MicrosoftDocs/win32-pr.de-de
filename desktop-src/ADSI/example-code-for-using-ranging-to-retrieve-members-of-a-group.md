...
---
# <a name="example-code-for-using-ranging-to-retrieve-members-of-a-group"></a><span data-ttu-id="1f125-105">Beispiel Code für die Verwendung von Bereichen zum Abrufen von Mitgliedern einer Gruppe</span><span class="sxs-lookup"><span data-stu-id="1f125-105">Example Code for Using Ranging to Retrieve Members of a Group</span></span>

<span data-ttu-id="1f125-106">Im folgenden Codebeispiel wird der Bereich mit den ActiveX-Verzeichnis Objekten (ADO) verwendet, um die Mitglieder einer Gruppe abzurufen.</span><span class="sxs-lookup"><span data-stu-id="1f125-106">The following code example uses ranging with ActiveX Directory Objects (ADO) to retrieve the members of a group.</span></span>

<span data-ttu-id="1f125-107">Der folgende Code Ausschnitt erfordert einen Verweis auf die Microsoft ActiveX Data Objects 6,0-Bibliothek.</span><span class="sxs-lookup"><span data-stu-id="1f125-107">The following code snippet requires a reference to Microsoft ActiveX Data Objects 6.0 Library.</span></span>
