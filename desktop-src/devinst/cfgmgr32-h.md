...
<td>Die BUSNUMBER_RESOURCE-Struktur gibt entweder eine Ressourcenliste oder eine Ressourcenanforderungenliste an, in der die Nutzung der Busnummer für eine Geräteinstanz beschrieben wird. Weitere Informationen zu Ressourcenlisten und Ressourcenanforderungen finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen</a>.<br/></td>
</tr>
<tr class="even">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_add_empty_log_conf"><strong>stattdessen CM_Add_Empty_Log_Conf.</strong></a>
</blockquote>
<br/> Die <strong>CM_Add_Empty_Log_Conf_Ex</strong> erstellt eine leere <a href="/windows-hardware/drivers/kernel/hardware-resources"></a>logische Konfiguration für einen angegebenen Konfigurationstyp und eine angegebene Geräteinstanz auf dem lokalen computer oder einem Remotecomputer.<br/></td>
</tr>
<tr class="even">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_add_idw"><strong>stattdessen CM_Add_ID.</strong></a>
</blockquote>
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_add_res_des"><strong>CM_Add_Res_Des.</strong></a>
</blockquote>
...
<td>Die <strong>CM_Enumerate_Classes-Funktion,</strong> wenn sie wiederholt aufgerufen wird, enumeriert die installierten Geräteklassen des lokalen Computers, indem die GUID jeder Klasse übergeben wird. <a href="/windows-hardware/drivers/"></a><br/></td>
</tr>
<tr class="even">
...
<br/> Die <strong></strong> CM_Enumerate_Classes_Ex-Funktion, wenn sie wiederholt aufgerufen wird, enumeriert die installierten Geräteklassen eines lokalen computers oder eines Remotecomputers, <a href="/windows-hardware/drivers/"></a>indem die GUID jeder Klasse übergeben wird.<br/></td>
</tr>
<tr class="odd">
...
<td>Die <strong>CM_Enumerate_Enumerators-Funktion</strong> aufzählt die Geräteenumeratoren des lokalen Computers, indem der Name jedes Enumerators übergeben wird.<br/></td>
</tr>
<tr class="even">
...
<br/> Die <strong>CM_Enumerate_Enumerators_Ex-Funktion</strong> aufzählt einen lokalen oder die Geräteenumeratoren eines Remotecomputers, indem der Name jedes Enumerators übergeben wird.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_free_log_conf"><strong>CM_Free_Log_Conf</strong></a><br/></td>
<td>Die <strong>CM_Free_Log_Conf-Funktion</strong> entfernt eine <a href="/windows-hardware/drivers/kernel/hardware-resources">logische Konfiguration</a> und alle zugeordneten <a href="/windows-hardware/drivers/">Ressourcendeskriptoren</a> vom lokalen Computer.<br/></td>
</tr>
<tr class="even">
...
<br/> Die <strong>CM_Free_Log_Conf_Ex-Funktion</strong> entfernt eine <a href="/windows-hardware/drivers/kernel/hardware-resources">logische</a> Konfiguration und alle zugeordneten <a href="/windows-hardware/drivers/">Ressourcendeskriptoren</a> von einem lokalen computer oder einem Remotecomputer.<br/></td>
</tr>
<tr class="odd">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_free_res_des"><strong>stattdessen CM_Free_Res_Des.</strong></a>
</blockquote>
<br/> Die <strong>CM_Free_Res_Des_Ex-Funktion</strong> entfernt einen Ressourcendeskriptor <a href="/windows-hardware/drivers/kernel/hardware-resources"></a> aus einer logischen Konfiguration auf einem lokalen computer oder einem Remotecomputer. <a href="/windows-hardware/drivers/"></a><br/></td>
</tr>
<tr class="even">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_child"><strong>stattdessen CM_Get_Child.</strong></a>
</blockquote>
...
<td>Die <strong>CM_Get_Class_Registry_Property-Funktion</strong> ruft eine <a href="/windows-hardware/drivers/install/accessing-device-setup-class-properties">Geräteeinrichtungsklasseneigenschaft</a>ab.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_depth"><strong>CM_Get_Depth</strong></a><br/></td>
<td>Die <strong>CM_Get_Depth-Funktion</strong> wird verwendet, um die Tiefe eines angegebenen Geräteknotens (<a href="/windows-hardware/drivers/">devnode</a>) innerhalb der <a href="/windows-hardware/drivers/kernel/device-tree">Gerätestruktur</a>des lokalen Computers abzurufen.<br/></td>
</tr>
<tr class="even">
...
<td>Die <strong>CM_Get_Device_ID</strong> Funktion ruft die <a href="/windows-hardware/drivers/install/device-instance-ids">Geräteinstanz-ID</a> für eine angegebene <a href="/windows-hardware/drivers/">Geräteinstanz</a> auf dem lokalen Computer ab.<br/></td>
</tr>
<tr class="even">
...
<br/> Die <strong>CM_Get_Device_ID_List_Size_Ex-Funktion</strong> ruft die Puffergröße ab, die erforderlich ist, um eine Liste der <a href="/windows-hardware/drivers/install/device-instance-ids">Geräteinstanz-IDs</a> für die <a href="/windows-hardware/drivers/">Geräteinstanzen</a>eines lokalen oder Remotecomputers aufzunehmen.<br/></td>
</tr>
<tr class="odd">
...
<td>Die <strong>CM_Get_Device_Interface_Alias</strong> Funktion gibt den Alias der angegebenen Geräteschnittstelleninstanz zurück, sofern der Alias vorhanden ist.<br/></td>
</tr>
<tr class="even">
...
<td>Die <strong>CM_Get_Device_Interface_List</strong> Funktion ruft eine Liste von Geräteschnittstelleninstanzen ab, die zu einer angegebenen <a href="/windows-hardware/drivers/install/device-interface-classes">Geräteschnittstellenklasse</a>gehören.<br/></td>
</tr>
<tr class="odd">
...
<td>Die <strong>CM_Get_Device_Interface_List_Size-Funktion</strong> ruft die Puffergröße ab, die an die <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_device_interface_lista"><strong>CM_Get_Device_Interface_List</strong></a> Funktion übergeben werden muss.<br/></td>
</tr>
<tr class="even">
...
<br/> Die <strong>CM_Get_Device_Interface_Property_Keys_ExW</strong> Funktion ruft ein Array von Geräteeigenschaftsschlüsseln ab, die die Geräteeigenschaften darstellen, die für eine Geräteschnittstelle festgelegt sind.<br/></td>
</tr>
<tr class="even">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_next_log_conf"><strong>CM_Get_Next_Log_Conf.</strong></a>
</blockquote>
<br/> Die <strong>CM_Get_Next_Log_Conf_Ex-Funktion</strong> erhält die nächste <a href="/windows-hardware/drivers/kernel/hardware-resources">logische</a> Konfiguration, <a href="/windows-hardware/drivers/"></a> die einer bestimmten Geräteinstanz auf einem lokalen oder einem Remotecomputer zugeordnet ist.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_next_res_des"><strong>CM_Get_Next_Res_Des</strong></a><br/></td>
<td>Die <strong>CM_Get_Next_Res_Des-Funktion</strong> erhält ein Handle für den nächsten Ressourcendeskriptor eines angegebenen Ressourcentyps für eine logische Konfiguration auf dem lokalen Computer. <a href="/windows-hardware/drivers/"></a> <a href="/windows-hardware/drivers/kernel/hardware-resources"></a><br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_next_res_des_ex"><strong>CM_Get_Next_Res_Des_Ex</strong></a><br/></td>
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_next_res_des"><strong>stattdessen CM_Get_Next_Res_Des.</strong></a>
</blockquote>
<br/> Die <strong>CM_Get_Next_Res_Des_Ex-Funktion</strong> erhält ein Handle für den nächsten Ressourcendeskriptor eines angegebenen Ressourcentyps für eine logische Konfiguration auf einem lokalen oder einem Remotecomputer. <a href="/windows-hardware/drivers/"></a> <a href="/windows-hardware/drivers/kernel/hardware-resources"></a><br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_parent"><strong>CM_Get_Parent</strong></a><br/></td>
<td>Die <strong>CM_Get_Parent-Funktion</strong> erhält ein Geräteinstanzhandles für den übergeordneten Knoten eines angegebenen Geräteknotens (<a href="/windows-hardware/drivers/">devnode</a>) in der Gerätestruktur des lokalen Computers.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_parent_ex"><strong>CM_Get_Parent_Ex</strong></a><br/></td>
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_parent"><strong>stattdessen CM_Get_Parent.</strong></a>
</blockquote>
<br/> Die <strong>CM_Get_Parent_Ex-Funktion</strong> erhält ein Geräteinstanzhandles für den übergeordneten Knoten eines angegebenen Geräteknotens (<a href="/windows-hardware/drivers/">devnode</a>) in einer lokalen oder der Gerätestruktur eines <a href="/windows-hardware/drivers/kernel/device-tree">Remotecomputers.</a><br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_res_des_data"><strong>CM_Get_Res_Des_Data</strong></a><br/></td>
<td>Die <strong>CM_Get_Res_Des_Data</strong> ruft die informationen ab, die in einem <a href="/windows-hardware/drivers/">Ressourcendeskriptor</a> auf dem lokalen Computer gespeichert sind.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_res_des_data_ex"><strong>CM_Get_Res_Des_Data_Ex</strong></a><br/></td>
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_res_des_data"><strong>CM_Get_Res_Des_Data.</strong></a>
</blockquote>
<br/> Die <strong>CM_Get_Res_Des_Data_Ex-Funktion</strong> ruft die informationen ab, die in einem <a href="/windows-hardware/drivers/">Ressourcendeskriptor</a> auf einem lokalen oder einem Remotecomputer gespeichert sind.<br/></td>
</tr>
<tr class="odd">
...
<td>Die <strong>CM_Get_Res_Des_Data_Size-Funktion</strong> erhält die Puffergröße, die erforderlich ist, um die In einem angegebenen <a href="/windows-hardware/drivers/">Ressourcendeskriptor</a> auf dem lokalen Computer enthaltenen Informationen zu enthalten.<br/></td>
</tr>
<tr class="even">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_res_des_data_size"><strong>stattdessen CM_Get_Res_Des_Data_Size.</strong></a>
</blockquote>
<br/> Die <strong>CM_Get_Res_Des_Data_Size_Ex-Funktion</strong> erhält die Puffergröße, die erforderlich ist, um die In einem angegebenen <a href="/windows-hardware/drivers/">Ressourcendeskriptor</a> enthaltenen Informationen auf einem lokalen computer oder einem Remotecomputer zu enthalten.<br/></td>
</tr>
<tr class="odd">
...
<td>Die <strong>CM_Get_Resource_Conflict_Count-Funktion</strong> erhält die Anzahl der Konflikte, die in einer angegebenen Ressourcenkonfliktliste enthalten sind.<br/></td>
</tr>
<tr class="even">
...
<td>Die <strong>CM_Get_Resource_Conflict_Details-Funktion</strong> erhält die Details zu einem der Ressourcenkonflikte in einer Konfliktliste.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_sibling"><strong>CM_Get_Sibling</strong></a><br/></td>
<td>Die <strong>CM_Get_Sibling-Funktion</strong> erhält ein Geräteinstanzhandles für den nächsten gleichgeordneten Knoten eines angegebenen Geräteknotens (<a href="/windows-hardware/drivers/">devnode</a>) in der Gerätestruktur des <a href="/windows-hardware/drivers/kernel/device-tree">lokalen Computers.</a><br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_sibling_ex"><strong>CM_Get_Sibling_Ex</strong></a><br/></td>
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_sibling"><strong>stattdessen CM_Get_Sibling.</strong></a>
</blockquote>
<br/> Die <strong>CM_Get_Sibling_Ex-Funktion</strong> erhält ein Geräteinstanzhandles für den nächsten nebengeordneten Knoten eines angegebenen Geräteknotens in einer lokalen oder der Gerätestruktur eines <a href="/windows-hardware/drivers/kernel/device-tree">Remotecomputers.</a><br/></td>
</tr>
<tr class="odd">
...
<td>Die <strong>CM_Is_Dock_Station_Present</strong> identifiziert, ob eine <a href="/windows-hardware/drivers/">Andockstation</a> auf einem lokalen Computer vorhanden ist.<br/></td>
</tr>
<tr class="even">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_is_dock_station_present"><strong>stattdessen CM_Is_Dock_Station_Present.</strong></a>
</blockquote>
<br/> Die <strong>CM_Is_Dock_Station_Present_Ex</strong> identifiziert, ob eine <a href="/windows-hardware/drivers/">Andockstation</a> auf einem lokalen computer oder einem Remotecomputer vorhanden ist.<br/></td>
</tr>
<tr class="odd">
...
<td>Die <strong>CM_Locate_DevNode-Funktion</strong> erhält ein Geräteinstanzhandles für den Geräteknoten, der einer angegebenen Geräteinstanz-ID auf dem lokalen Computer zugeordnet ist. <a href="/windows-hardware/drivers/install/device-instance-ids"></a><br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_locate_devnode_exw"><strong>CM_Locate_DevNode_Ex</strong></a><br/></td>
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_locate_devnodea"><strong>CM_Locate_DevNode.</strong></a>
</blockquote>
<br/> Die <strong>CM_Locate_DevNode_Ex-Funktion</strong> erhält ein Geräteinstanzhandles für den Geräteknoten, der einer angegebenen Geräteinstanz-ID zugeordnet ist, auf einem lokalen Computer oder einem Remotecomputer. <a href="/windows-hardware/drivers/install/device-instance-ids"></a><br/></td>
</tr>
<tr class="odd">
...
<td>Die <strong>CM_Modify_Res_Des</strong> ändert einen angegebenen Ressourcendeskriptor auf dem lokalen Computer.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_modify_res_des_ex"><strong>CM_Modify_Res_Des_Ex</strong></a><br/></td>
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_modify_res_des"><strong>CM_Modify_Res_Des.</strong></a>
</blockquote>
<br/> Die <strong>CM_Modify_Res_Des_Ex-Funktion</strong> ändert einen angegebenen Ressourcendeskriptor auf einem lokalen computer oder einem Remotecomputer.<br/></td>
</tr>
<tr class="even">
...
<td>Dies ist eine Datenstruktur für Gerätebenachrichtigungsereignis.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/ns-cfgmgr32-cm_notify_filter"><strong>CM_NOTIFY_FILTER</strong></a><br/></td>
<td>Filterstruktur für Gerätebenachrichtigungen<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_open_class_keyw"><strong>CM_Open_Class_Key</strong></a><br/></td>
<td>Die <strong>CM_Open_Class_Key</strong> öffnet den Registrierungsschlüssel der Geräteeinrichtungsklasse, den Registrierungsschlüssel der Geräteschnittstellenklasse oder einen bestimmten Unterschlüssel einer Klasse.<br/></td>
</tr>
<tr class="even">
...
<td>Die <strong>CM_Open_Device_Interface_Key</strong> öffnet den Registrierungsunterschlüssel, der von Anwendungen und Treibern verwendet wird, um spezifische Informationen für eine Geräteschnittstelle zu speichern.<br/></td>
</tr>
<tr class="odd">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/cfgmgr32/nf-cfgmgr32-cm_open_device_interface_keyw"><strong>CM_Open_Device_Interface_Key.</strong></a>
</blockquote>
<br/> Die <strong>CM_Open_Device_Interface_Key_ExA</strong> öffnet den Registrierungsunterschlüssel, der von Anwendungen und Treibern verwendet wird, um informationen zu speichern, die für eine Geräteschnittstelle spezifisch sind.<br/></td>
</tr>
<tr class="even">
...
<br/> Die <strong>CM_Open_Device_Interface_Key_ExW-Funktion</strong> öffnet den Registrierungsunterschlüssel, der von Anwendungen und Treibern verwendet wird, um spezifische Informationen für eine Geräteschnittstelle zu speichern.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_open_devnode_key"><strong>CM_Open_DevNode_Key</strong></a><br/></td>
<td>Die <strong>CM_Open_DevNode_Key</strong> öffnet einen Registrierungsschlüssel für gerätespezifische Konfigurationsinformationen.<br/></td>
</tr>
<tr class="even">
...
<td>Die <strong>CM_Query_And_Remove_SubTree-Funktion</strong> überprüft, ob eine Geräteinstanz und die zugehörigen unteren Instanzen entfernt werden können, und entfernt sie in diesem Fall.<br/></td>
</tr>
<tr class="odd">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_query_and_remove_subtreew"><strong>stattdessen CM_Query_And_Remove_SubTree.</strong></a>
</blockquote>
<br/> Die <strong>CM_Query_And_Remove_SubTree_Ex-Funktion</strong> überprüft, ob eine Geräteinstanz und die zugehörigen unteren Instanzen entfernt werden können, und entfernt sie in diesem Fall.<br/></td>
</tr>
<tr class="even">
...
<td>Die <strong>CM_Query_Resource_Conflict_List-Funktion</strong> identifiziert Geräteinstanzen mit Ressourcenanforderungen, die mit der Ressourcenbeschreibung einer angegebenen Geräteinstanz in Konflikt stehen.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_reenumerate_devnode"><strong>CM_Reenumerate_DevNode</strong></a><br/></td>
<td>Die <strong>CM_Reenumerate_DevNode-Funktion</strong> aufzählt die Geräte, die durch einen angegebenen Geräteknoten und alle seine unteren Knoten identifiziert werden.<br/></td>
</tr>
<tr class="even">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_reenumerate_devnode"><strong>CM_Reenumerate_DevNode.</strong></a>
</blockquote>
<br/> Die <strong>CM_Reenumerate_DevNode_Ex-Funktion</strong> aufzählt die Geräte, die durch einen angegebenen Geräteknoten und alle seine unteren Knoten identifiziert werden.<br/></td>
</tr>
<tr class="odd">
...
<td>Verwenden <a href="/windows/desktop/api/winuser/nf-winuser-registerdevicenotificationa"><strong>Sie RegisterDeviceNotification</strong></a> anstelle von <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_register_notification"><strong>CM_Register_Notification,</strong></a> wenn Ihr Code auf Windows 7 oder frühere Versionen von Windows. Aufrufer des Kernelmodus sollten stattdessen <a href="/windows-hardware/drivers/ddi/content/wdm/nf-wdm-ioregisterplugplaynotification"><strong>IoRegisterPlugPlayNotification</strong></a> verwenden.<br/> Die <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_register_notification"><strong>CM_Register_Notification</strong></a> registriert eine Anwendungsrückrufroutine, die aufgerufen wird, wenn ein PnP-Ereignis des angegebenen Typs auftritt.<br/></td>
</tr>
<tr class="even">
...
<td>Die <strong>CM_Request_Device_Eject-Funktion</strong> bereitet eine lokale Geräteinstanz für das sichere Entfernen vor, wenn das Gerät wechselbar ist. Wenn das Gerät physisch ausjiziert werden kann, ist es .<br/></td>
</tr>
<tr class="odd">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_request_device_ejectw"><strong>stattdessen CM_Request_Device_Eject.</strong></a>
</blockquote>
<br/> Die <strong>CM_Request_Device_Eject_Ex-Funktion</strong> bereitet eine lokale oder eine Remotegeräteinstanz für das sichere Entfernen vor, wenn das Gerät wechselbar ist. Wenn das Gerät physisch ausjiziert werden kann, ist es .<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_request_eject_pc"><strong>CM_Request_Eject_PC</strong></a><br/></td>
<td>Die <strong>CM_Request_Eject_PC</strong> fordert an, dass ein portabler PC, der in eine lokale Andockstation eingefügt <a href="/windows-hardware/drivers/">wird,</a>ausjiziert wird.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_request_eject_pc_ex"><strong>CM_Request_Eject_PC_Ex</strong></a><br/></td>
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_request_eject_pc"><strong>stattdessen CM_Request_Eject_PC.</strong></a>
</blockquote>
<br/> Die <strong>CM_Request_Eject_PC_Ex</strong> fordert an, dass ein portabler PC, der in eine lokale oder eine Remote-Dockingstation eingefügt wird, ausjiziert wird. <a href="/windows-hardware/drivers/"></a><br/></td>
</tr>
<tr class="even">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_set_class_propertyw"><strong>CM_Set_Class_Property.</strong></a>
</blockquote>
...
<td>Die <strong>CM_Set_Class_Registry_Property-Funktion</strong> legt eine Eigenschaft einer Geräteeinrichtungsklasse fest <a href="/windows-hardware/drivers/install/device-setup-classes">oder löscht sie.</a><br/></td>
</tr>
<tr class="odd">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_set_device_interface_propertyw"><strong>CM_Set_Device_Interface_Property.</strong></a>
</blockquote>
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_set_devnode_problem"><strong>CM_Set_DevNode_Problem.</strong></a>
</blockquote>
<br/> Die <strong>CM_Set_DevNode_Problem_Ex-Funktion</strong> legt einen Problemcode für ein Gerät fest, das auf einem lokalen computer oder einem Remotecomputer installiert ist.<br/></td>
</tr>
<tr class="odd">
...
<td><blockquote>
[!Note]<br />
Ab Windows 8 und Windows Server 2012 ist diese Funktion veraltet. Verwenden Sie <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_set_devnode_propertyw"><strong>CM_Set_DevNode_Property.</strong></a>
</blockquote>
...
<td>Die <strong>CM_Setup_DevNode-Funktion</strong> startet eine Geräteinstanz neu, die nicht ausgeführt wird, da ein Problem mit der Gerätekonfiguration vor liegt.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_uninstall_devnode"><strong>CM_Uninstall_DevNode</strong></a><br/></td>
<td>Die <strong>CM_Uninstall_DevNode-Funktion</strong> entfernt alle persistenten Status, die einer Geräteinstanz zugeordnet sind.<br/></td>
</tr>
<tr class="even">
...
<td>Verwenden <a href="/windows/desktop/api/winuser/nf-winuser-unregisterdevicenotification"><strong>Sie UnregisterDeviceNotification</strong></a> anstelle von <strong>CM_Unregister_Notification,</strong> wenn Ihr Code auf Windows 7 oder frühere Versionen von Windows.<br/> Die <strong>CM_Unregister_Notification</strong> schließt das angegebene HCMNOTIFICATION-Handle.<br/></td>
</tr>
<tr class="odd">
...
<td>Die <strong>CMP_WaitNoPendingInstallEvents-Funktion</strong> wartet, bis keine ausstehenden Geräteinstallationsaktivitäten für den PnP-Manager abgeschlossen sind.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/cfgmgr32/ns-cfgmgr32-conflict_details_a"><strong>CONFLICT_DETAILS</strong></a><br/></td>
<td>Die CONFLICT_DETAILS-Struktur wird als Parameter für die CM_Get_Resource_Conflict_Details <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_resource_conflict_detailsw"><strong>verwendet.</strong></a><br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/win32/api/cfgmgr32/ns-cfgmgr32-cs_des"><strong>CS_DES</strong></a><br/></td>
<td>Die CS_DES-Struktur wird verwendet, um eine Ressourcenliste anzugeben, die die geräteklassenspezifische Ressourcennutzung für eine Geräteinstanz beschreibt. Weitere Informationen zu Ressourcenlisten finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen.</a><br/></td>
</tr>
<tr class="even">
<td><a href="/windows/win32/api/cfgmgr32/ns-cfgmgr32-cs_resource"><strong>CS_RESOURCE</strong></a><br/></td>
<td>Die CS_RESOURCE-Struktur wird verwendet, um eine Ressourcenliste anzugeben, die die geräteklassenspezifische Ressourcennutzung für eine Geräteinstanz beschreibt. Weitere Informationen zu Ressourcenlisten finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen.</a><br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/win32/api/cfgmgr32/ns-cfgmgr32-dma_des"><strong>DMA_DES</strong></a><br/></td>
<td>Die DMA_DES-Struktur wird verwendet, um entweder eine Ressourcenliste oder eine Ressourcenanforderungenliste anzugeben, die die Verwendung des DMA-Kanals (Direct Memory Access) für eine Geräteinstanz beschreibt. Weitere Informationen zu Ressourcenlisten und Ressourcenanforderungen finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen</a>.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/win32/api/cfgmgr32/ns-cfgmgr32-dma_range"><strong>DMA_RANGE</strong></a><br/></td>
<td>Die DMA_RANGE-Struktur gibt eine Ressourcenanforderungenliste an, die die DMA-Kanalnutzung für eine Geräteinstanz beschreibt. Weitere Informationen zu Ressourcenanforderungen finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen.</a><br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/win32/api/cfgmgr32/ns-cfgmgr32-dma_resource"><strong>DMA_RESOURCE</strong></a><br/></td>
<td>Die DMA_RESOURCE-Struktur wird verwendet, um entweder eine Ressourcenliste oder eine Ressourcenanforderungenliste anzugeben, die die Verwendung des DMA-Kanals für eine Geräteinstanz beschreibt. Weitere Informationen zu Ressourcenlisten und Ressourcenanforderungen finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen</a>.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/win32/api/cfgmgr32/ns-cfgmgr32-io_des"><strong>IO_DES</strong></a><br/></td>
<td>Die IO_DES-Struktur wird verwendet, um entweder eine Ressourcenliste oder eine Ressourcenanforderungenliste anzugeben, die die Verwendung von E/A-Ports für eine Geräteinstanz beschreibt. Weitere Informationen zu Ressourcenlisten und Ressourcenanforderungen finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen</a>.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/win32/api/cfgmgr32/ns-cfgmgr32-io_range"><strong>IO_RANGE</strong></a><br/></td>
<td>Die IO_RANGE-Struktur gibt eine Ressourcenanforderungenliste an, in der die Verwendung von E/A-Ports für eine Geräteinstanz beschrieben wird. Weitere Informationen zu Ressourcenanforderungen finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen.</a><br/></td>
</tr>
<tr class="even">
<td><a href="/windows/win32/api/cfgmgr32/ns-cfgmgr32-io_resource"><strong>IO_RESOURCE</strong></a><br/></td>
<td>Die IO_RESOURCE-Struktur wird verwendet, um entweder eine Ressourcenliste oder eine Ressourcenanforderungenliste anzugeben, die die Verwendung von E/A-Ports für eine Geräteinstanz beschreibt. Weitere Informationen zu Ressourcenlisten und Ressourcenanforderungen finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen</a>.<br/></td>
</tr>
<tr class="odd">
...
<td>Die IRQ_RANGE-Struktur gibt eine Ressourcenanforderungsliste an, die die IRQ-Zeilennutzung für eine Geräteinstanz beschreibt. Weitere Informationen zu Ressourcenanforderungen finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen.</a><br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/win32/api/cfgmgr32/ns-cfgmgr32-irq_resource_64"><strong>IRQ_RESOURCE</strong></a><br/></td>
<td>Die IRQ_RESOURCE-Struktur wird verwendet, um entweder eine Ressourcenliste oder eine Ressourcenanforderungsliste anzugeben, die die IRQ-Zeilennutzung für eine Geräteinstanz beschreibt. Weitere Informationen zu Ressourcenlisten und Ressourcenanforderungen finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen</a>.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/win32/api/cfgmgr32/ns-cfgmgr32-mem_des"><strong>MEM_DES</strong></a><br/></td>
<td>Die MEM_DES-Struktur wird verwendet, um entweder eine Ressourcenliste oder eine Ressourcenanforderungenliste anzugeben, die die Speicherauslastung für eine Geräteinstanz beschreibt. Weitere Informationen zu Ressourcenlisten und Ressourcenanforderungen finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen</a>.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/win32/api/cfgmgr32/ns-cfgmgr32-mem_range"><strong>MEM_RANGE</strong></a><br/></td>
<td>Die MEM_RANGE-Struktur gibt eine Ressourcenanforderungenliste an, in der die Speicherauslastung für eine Geräteinstanz beschrieben wird. Weitere Informationen zu Ressourcenanforderungen finden Sie unter <a href="/windows-hardware/drivers/kernel/hardware-resources">Hardwareressourcen.</a><br/></td>
</tr>
<tr class="even">
