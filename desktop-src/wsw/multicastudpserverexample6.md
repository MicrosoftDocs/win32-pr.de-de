...
description: Dieses Beispiel zeigt einen UDP-Server, der auf eine Multicast Adresse lauscht und auf Anforderungen antwortet, die an diese Adresse gesendet werden. In diesem Beispiel wird IPv6 verwendet.
ms.assetid: 9e2a254c-dbfc-4b73-a1a5-6a1db1ac5921
keywords:
- MulticastUdpServerExample6 Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106338162"
---
# <a name="multicastudpserverexample6"></a><span data-ttu-id="00fa0-107">MulticastUdpServerExample6</span><span class="sxs-lookup"><span data-stu-id="00fa0-107">MulticastUdpServerExample6</span></span>

<span data-ttu-id="00fa0-108">Dieses Beispiel zeigt einen UDP-Server, der auf eine Multicast Adresse lauscht und auf Anforderungen antwortet, die an diese Adresse gesendet werden.</span><span class="sxs-lookup"><span data-stu-id="00fa0-108">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span> <span data-ttu-id="00fa0-109">In diesem Beispiel wird IPv6 verwendet.</span><span class="sxs-lookup"><span data-stu-id="00fa0-109">This example uses IPv6.</span></span>

-   [<span data-ttu-id="00fa0-110">MulticastUdpServer6. cpp</span><span class="sxs-lookup"><span data-stu-id="00fa0-110">MulticastUdpServer6.cpp</span></span>](#multicastudpserver6cpp)
-   [<span data-ttu-id="00fa0-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="00fa0-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="00fa0-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="00fa0-112">Makefile</span></span>](#makefile)

## <a name="multicastudpserver6cpp"></a><span data-ttu-id="00fa0-113">MulticastUdpServer6. cpp</span><span class="sxs-lookup"><span data-stu-id="00fa0-113">MulticastUdpServer6.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="00fa0-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="00fa0-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="00fa0-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="00fa0-115">Makefile</span></span>
