---
title: "\"Read Write Items bytesxmlexample\""
description: In diesem Beispiel werden Binärdaten mithilfe der MTOM-Codierung geschrieben und zurückgelesen.
ms.assetid: 6b80846e-6959-4c38-bf1b-17827ecb9d1a
keywords:
- "\"Read-tebytesxmlexample\"-Webdienste für Windows"
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106342027"
---
# <a name="readwritebytesxmlexample"></a><span data-ttu-id="fbe1f-106">"Read Write Items bytesxmlexample"</span><span class="sxs-lookup"><span data-stu-id="fbe1f-106">ReadWriteBytesXmlExample</span></span>

<span data-ttu-id="fbe1f-107">In diesem Beispiel werden Binärdaten mithilfe der MTOM-Codierung geschrieben und zurückgelesen.</span><span class="sxs-lookup"><span data-stu-id="fbe1f-107">This example writes binary data using the MTOM encoding and reads it back out.</span></span>

## <a name="readwritebytesxmlcpp"></a><span data-ttu-id="fbe1f-108">"Read Write-bytesxml. cpp"</span><span class="sxs-lookup"><span data-stu-id="fbe1f-108">ReadWriteBytesXml.cpp</span></span>
