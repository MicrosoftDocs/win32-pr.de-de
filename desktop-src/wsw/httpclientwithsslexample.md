...
---
# <a name="httpclientwithsslexample"></a><span data-ttu-id="b98b6-106">Httpclientwithsslexample</span><span class="sxs-lookup"><span data-stu-id="b98b6-106">HttpClientWithSslExample</span></span>

<span data-ttu-id="b98b6-107">Dieses Beispiel zeigt einen HTTP-Client, der Anforderungs-/Antwort-Nachrichten mit SSL-Transportsicherheit sendet.</span><span class="sxs-lookup"><span data-stu-id="b98b6-107">This example shows a HTTP client that sends request-reply messages, with SSL transport security.</span></span>

-   [<span data-ttu-id="b98b6-108">Httpclientwithssl. cpp</span><span class="sxs-lookup"><span data-stu-id="b98b6-108">HttpClientWithSsl.cpp</span></span>](#httpclientwithsslcpp)
-   [<span data-ttu-id="b98b6-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="b98b6-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="b98b6-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="b98b6-110">Makefile</span></span>](#makefile)

## <a name="httpclientwithsslcpp"></a><span data-ttu-id="b98b6-111">Httpclientwithssl. cpp</span><span class="sxs-lookup"><span data-stu-id="b98b6-111">HttpClientWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="b98b6-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="b98b6-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="b98b6-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="b98b6-113">Makefile</span></span>
