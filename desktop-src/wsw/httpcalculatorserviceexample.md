...
---
# <a name="httpcalculatorserviceexample"></a><span data-ttu-id="3ab5d-106">Httpcalculatorserviceexample</span><span class="sxs-lookup"><span data-stu-id="3ab5d-106">HttpCalculatorServiceExample</span></span>

<span data-ttu-id="3ab5d-107">In diesem Beispiel wird gezeigt, wie der Dienst Host zum Hosten eines Rechner Diensts über HTTP verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="3ab5d-107">This example shows how to use service host for hosting a calculator service over HTTP.</span></span>

-   [<span data-ttu-id="3ab5d-108">Httpcalculatorservice. cpp</span><span class="sxs-lookup"><span data-stu-id="3ab5d-108">HttpCalculatorService.cpp</span></span>](#httpcalculatorservicecpp)
-   [<span data-ttu-id="3ab5d-109">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="3ab5d-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="3ab5d-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="3ab5d-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorservicecpp"></a><span data-ttu-id="3ab5d-111">Httpcalculatorservice. cpp</span><span class="sxs-lookup"><span data-stu-id="3ab5d-111">HttpCalculatorService.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="3ab5d-112">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="3ab5d-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="3ab5d-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="3ab5d-113">Makefile</span></span>
