...
---
# <a name="httpcalculatorwithbasicoversslclientexample"></a><span data-ttu-id="6688c-106">Httpcalculatorwithbasicoversslcliumtexample</span><span class="sxs-lookup"><span data-stu-id="6688c-106">HttpCalculatorWithBasicOverSslClientExample</span></span>

<span data-ttu-id="6688c-107">In diesem Beispiel wird gezeigt, wie der Dienst Proxy für die Kommunikation mit einem Rechner Dienst mit SSL-Transportsicherheit und HTTP-Header-Standard Authentifizierung verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="6688c-107">This example shows how to use the service proxy to talk to a calculator service, with SSL transport security and HTTP header basic authentication.</span></span> <span data-ttu-id="6688c-108">In diesem Setup wird die Transport Verbindung von SSL geschützt (signiert, verschlüsselt), der auch die Server Authentifizierung bereitstellt.</span><span class="sxs-lookup"><span data-stu-id="6688c-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="6688c-109">Die Client Authentifizierung wird durch ein paar aus Benutzername und Kennwort bereitgestellt, das in HTTP-Headern mit dem grundlegenden Schema</span><span class="sxs-lookup"><span data-stu-id="6688c-109">Client authentication is provided by a username/password pair supplied in HTTP headers using the basic scheme.</span></span>

-   [<span data-ttu-id="6688c-110">Httpcalculatorwithbasicoversslclient. cpp</span><span class="sxs-lookup"><span data-stu-id="6688c-110">HttpCalculatorWithBasicOverSslClient.cpp</span></span>](#httpcalculatorwithbasicoversslclientcpp)
-   [<span data-ttu-id="6688c-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="6688c-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="6688c-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="6688c-112">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithbasicoversslclientcpp"></a><span data-ttu-id="6688c-113">Httpcalculatorwithbasicoversslclient. cpp</span><span class="sxs-lookup"><span data-stu-id="6688c-113">HttpCalculatorWithBasicOverSslClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="6688c-114">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="6688c-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="6688c-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="6688c-115">Makefile</span></span>
