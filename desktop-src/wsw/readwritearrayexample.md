---
title: "\"Read Beschreib tearrayexample\""
...
keywords:
- Read-tearrayexample-Webdienste für Windows
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106340809"
---
# <a name="readwritearrayexample"></a><span data-ttu-id="82afd-106">"Read Beschreib tearrayexample"</span><span class="sxs-lookup"><span data-stu-id="82afd-106">ReadWriteArrayExample</span></span>

<span data-ttu-id="82afd-107">In diesem Beispiel wird ein Array von-Elementen gelesen und geschrieben.</span><span class="sxs-lookup"><span data-stu-id="82afd-107">This example reads and writes an array of elements.</span></span>

## <a name="readwritearraycpp"></a><span data-ttu-id="82afd-108">"Read-tearray. cpp"</span><span class="sxs-lookup"><span data-stu-id="82afd-108">ReadWriteArray.cpp</span></span>
