...
---
# <a name="httpcalculatorclientexample"></a>Httpcalculatorclieintexample

In diesem Beispiel wird gezeigt, wie der Dienst Proxy verwendet wird, um mit einem HTTP-basierten Rechner Dienst zu kommunizieren.
