---
title: Httpcalculatorclieintexample
description: In diesem Beispiel wird gezeigt, wie der Dienst Proxy verwendet wird, um mit einem HTTP-basierten Rechner Dienst zu kommunizieren.
ms.assetid: dd97613d-3bb7-427c-a292-220d1efed96c
keywords:
- Httpcalculatorclieintexample-Webdienste für Windows
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106337394"
---
# <a name="httpcalculatorclientexample"></a><span data-ttu-id="4497b-106">Httpcalculatorclieintexample</span><span class="sxs-lookup"><span data-stu-id="4497b-106">HttpCalculatorClientExample</span></span>

<span data-ttu-id="4497b-107">In diesem Beispiel wird gezeigt, wie der Dienst Proxy verwendet wird, um mit einem HTTP-basierten Rechner Dienst zu kommunizieren.</span><span class="sxs-lookup"><span data-stu-id="4497b-107">This example show how to use the service proxy to talk to an HTTP based calculator service.</span></span>

-   [<span data-ttu-id="4497b-108">Httpcalculatorclient. cpp</span><span class="sxs-lookup"><span data-stu-id="4497b-108">HttpCalculatorClient.cpp</span></span>](#httpcalculatorclientcpp)
-   [<span data-ttu-id="4497b-109">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="4497b-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="4497b-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="4497b-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorclientcpp"></a><span data-ttu-id="4497b-111">Httpcalculatorclient. cpp</span><span class="sxs-lookup"><span data-stu-id="4497b-111">HttpCalculatorClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="4497b-112">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="4497b-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="4497b-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="4497b-113">Makefile</span></span>
