...
description: In diesem Beispiel wird ein TCP-Server gezeigt, der einen Kanal akzeptiert und Nachrichten mit dem Benutzernamen über SSL-Sicherheit im gemischten Modus empfängt und antwortet.
ms.assetid: d70ae988-0d7c-4494-a54d-1cd73ab8a8ce
keywords:
- Httpserverwithusernameoversslexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106340861"
---
# <a name="httpserverwithusernameoversslexample"></a><span data-ttu-id="1350c-106">Httpserverwithusernameoversslexample</span><span class="sxs-lookup"><span data-stu-id="1350c-106">HttpServerWithUsernameOverSslExample</span></span>

<span data-ttu-id="1350c-107">In diesem Beispiel wird ein TCP-Server gezeigt, der einen Kanal akzeptiert und Nachrichten mit dem Benutzernamen über SSL-Sicherheit im gemischten Modus empfängt und antwortet.</span><span class="sxs-lookup"><span data-stu-id="1350c-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="1350c-108">In diesem Setup wird die Transport Verbindung von SSL geschützt (signiert, verschlüsselt), der auch die Server Authentifizierung bereitstellt.</span><span class="sxs-lookup"><span data-stu-id="1350c-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="1350c-109">Die Client Authentifizierung wird von einem Paar aus Benutzername und Kennwort in einem WS-Security-Header in der Nachricht bereitgestellt.</span><span class="sxs-lookup"><span data-stu-id="1350c-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="1350c-110">Httpserverwithusernameoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="1350c-110">HttpServerWithUsernameOverSsl.cpp</span></span>](#httpserverwithusernameoversslcpp)
-   [<span data-ttu-id="1350c-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="1350c-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="1350c-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="1350c-112">Makefile</span></span>](#makefile)

## <a name="httpserverwithusernameoversslcpp"></a><span data-ttu-id="1350c-113">Httpserverwithusernameoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="1350c-113">HttpServerWithUsernameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="1350c-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="1350c-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="1350c-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="1350c-115">Makefile</span></span>
