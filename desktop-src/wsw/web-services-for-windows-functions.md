---
title: Windows Webdienstfunktionen
description: Die Windows Webdienstfunktionen unterstützen das methodenbasierte Programmiermodell der Windows-Webdienst-API.
...
ms.locfileid: "118192410"
---
# <a name="windows-web-services-functions"></a>Windows Webdienstfunktionen

Die Windows Webdienstfunktionen unterstützen das methodenbasierte Programmiermodell der Windows-Webdienst-API. Die Laufzeitumgebung des [Diensthosts](service-host.md) der [Dienstmodell-API-Ebene](service-model-layer-overview.md) stellt das serverseitige Programmiermodell bereit. Eine serverseitige Anwendung wird geöffnet, geschlossen und gibt eine Diensthostressource nach Bedarf frei, um Clientanforderungen zu verarbeiten. Der Dienstproxy stellt das clientseitige API-Programmiermodell bereit. Clientseitige Anwendungen können Nachrichten über einen Kanal über den Dienstproxy als Methodenaufrufe senden und empfangen.

Die Windows Web Services-API umfasst die folgenden Funktionen:

-   [**WsAboanCall**](/windows/desktop/api/WebServices/nf-webservices-wsabandoncall)
-   [**WsAbtaxinMessage**](/windows/desktop/api/WebServices/nf-webservices-wsabandonmessage)
...
-   [**WsReadEnveoraEnd**](/windows/desktop/api/WebServices/nf-webservices-wsreadenvelopeend)
-   [**WsReadEnvevesStart**](/windows/desktop/api/WebServices/nf-webservices-wsreadenvelopestart)
...
-   [**WsWriteEnvevesStart**](/windows/desktop/api/WebServices/nf-webservices-wswriteenvelopestart)
