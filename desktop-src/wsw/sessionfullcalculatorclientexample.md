---
title: Sessionfullcalculatorclieintexample
description: Client Anwendung für die Kommunikation mit einem Sitzungs basierten Rechner Dienst.
ms.assetid: 0981474c-cb87-4069-ab84-7662776c182e
keywords:
- Sessionfullcalculatorclieintexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103710229"
---
# <a name="sessionfullcalculatorclientexample"></a><span data-ttu-id="3e396-106">Sessionfullcalculatorclieintexample</span><span class="sxs-lookup"><span data-stu-id="3e396-106">SessionfullCalculatorClientExample</span></span>

<span data-ttu-id="3e396-107">Client Anwendung für die Kommunikation mit einem Sitzungs basierten Rechner Dienst.</span><span class="sxs-lookup"><span data-stu-id="3e396-107">Client application to talk to a sessionful calculator service.</span></span>

-   [<span data-ttu-id="3e396-108">Sessionfullcalculatorclient. cpp</span><span class="sxs-lookup"><span data-stu-id="3e396-108">SessionfullCalculatorClient.cpp</span></span>](#sessionfullcalculatorclientcpp)
-   [<span data-ttu-id="3e396-109">Sessionbasedcalculatorservice. WSDL</span><span class="sxs-lookup"><span data-stu-id="3e396-109">SessionBasedCalculatorService.wsdl</span></span>](#sessionbasedcalculatorservicewsdl)
-   [<span data-ttu-id="3e396-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="3e396-110">Makefile</span></span>](#makefile)

## <a name="sessionfullcalculatorclientcpp"></a><span data-ttu-id="3e396-111">Sessionfullcalculatorclient. cpp</span><span class="sxs-lookup"><span data-stu-id="3e396-111">SessionfullCalculatorClient.cpp</span></span>
...
## <a name="sessionbasedcalculatorservicewsdl"></a><span data-ttu-id="3e396-112">Sessionbasedcalculatorservice. WSDL</span><span class="sxs-lookup"><span data-stu-id="3e396-112">SessionBasedCalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="3e396-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="3e396-113">Makefile</span></span>
