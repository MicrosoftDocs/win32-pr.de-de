...
---
# <a name="xmlbufferexample"></a><span data-ttu-id="8df69-106">Xmlbufferexample</span><span class="sxs-lookup"><span data-stu-id="8df69-106">XmlBufferExample</span></span>

<span data-ttu-id="8df69-107">Dieses Beispiel zeigt die Verwendung der XML-Puffer-APIs.</span><span class="sxs-lookup"><span data-stu-id="8df69-107">This example shows some use of the xml buffer APIs.</span></span>

## <a name="xmlbuffercpp"></a><span data-ttu-id="8df69-108">Xmlbuffer. cpp</span><span class="sxs-lookup"><span data-stu-id="8df69-108">XmlBuffer.cpp</span></span>
