---
title: Httprawcliumtexample
description: Dieses Beispiel ist die Clientseite, die unformatierte HTTP-Anforderungen sendet.
ms.assetid: bc9e108e-d4a0-4bdd-82c2-5486ea46364b
keywords:
- Httprawcliumtexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103856456"
---
# <a name="httprawclientexample"></a><span data-ttu-id="2ff2a-106">Httprawcliumtexample</span><span class="sxs-lookup"><span data-stu-id="2ff2a-106">HttpRawClientExample</span></span>

<span data-ttu-id="2ff2a-107">Dieses Beispiel ist die Clientseite, die unformatierte HTTP-Anforderungen sendet.</span><span class="sxs-lookup"><span data-stu-id="2ff2a-107">This example is the client side that sends raw HTTP requests.</span></span>

## <a name="httprawclientcpp"></a><span data-ttu-id="2ff2a-108">Httprawclient. cpp</span><span class="sxs-lookup"><span data-stu-id="2ff2a-108">HttpRawClient.cpp</span></span>
