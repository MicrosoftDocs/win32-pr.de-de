---
title: "\"Read-terawxmlexample\""
description: Dieses Beispiel zeigt das Lesen und Schreiben von XML mithilfe der rohcodierung.
ms.assetid: e13e6add-f58b-468a-a472-f0aa29d030b3
keywords:
- Windows-Webdienste-API von "leserschreiterawxmlexample"
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104036277"
---
# <a name="readwriterawxmlexample"></a><span data-ttu-id="c543e-106">"Read-terawxmlexample"</span><span class="sxs-lookup"><span data-stu-id="c543e-106">ReadWriteRawXmlExample</span></span>

<span data-ttu-id="c543e-107">Dieses Beispiel zeigt das Lesen und Schreiben von XML mithilfe der rohcodierung.</span><span class="sxs-lookup"><span data-stu-id="c543e-107">This example shows reading and writing of xml using the raw encoding.</span></span>

## <a name="readwriterawxmlcpp"></a><span data-ttu-id="c543e-108">"Read-terawxml. cpp"</span><span class="sxs-lookup"><span data-stu-id="c543e-108">ReadWriteRawXml.cpp</span></span>
