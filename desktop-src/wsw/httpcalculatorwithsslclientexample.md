...
---
# <a name="httpcalculatorwithsslclientexample"></a>Httpcalculatorwithsslclieintexample

In diesem Beispiel wird gezeigt, wie der Dienst Proxy für die Kommunikation mit einem Rechner Dienst mit SSL-Transportsicherheit verwendet wird.
