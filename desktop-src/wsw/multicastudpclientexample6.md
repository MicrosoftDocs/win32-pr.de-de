...
description: Dieses Beispiel zeigt einen UDP-Client, der eine Anforderung multiumwandelt und dann mithilfe von IPv6 auf Antwort Nachrichten von Servern wartet.
ms.assetid: bd19bd5f-0617-4524-aa48-3d0c28c97747
keywords:
- MulticastUdpClientExample6 Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104309460"
---
# <a name="multicastudpclientexample6"></a><span data-ttu-id="0f0e1-106">MulticastUdpClientExample6</span><span class="sxs-lookup"><span data-stu-id="0f0e1-106">MulticastUdpClientExample6</span></span>

<span data-ttu-id="0f0e1-107">Dieses Beispiel zeigt einen UDP-Client, der eine Anforderung multiumwandelt und dann mithilfe von IPv6 auf Antwort Nachrichten von Servern wartet.</span><span class="sxs-lookup"><span data-stu-id="0f0e1-107">This example shows a UDP client that multicasts a request and then waits for reply messages from servers, using IPv6.</span></span>

-   [<span data-ttu-id="0f0e1-108">MulticastUdpClient6. cpp</span><span class="sxs-lookup"><span data-stu-id="0f0e1-108">MulticastUdpClient6.cpp</span></span>](#multicastudpclient6cpp)
-   [<span data-ttu-id="0f0e1-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="0f0e1-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="0f0e1-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="0f0e1-110">Makefile</span></span>](#makefile)

## <a name="multicastudpclient6cpp"></a><span data-ttu-id="0f0e1-111">MulticastUdpClient6. cpp</span><span class="sxs-lookup"><span data-stu-id="0f0e1-111">MulticastUdpClient6.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="0f0e1-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="0f0e1-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0f0e1-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="0f0e1-113">Makefile</span></span>
