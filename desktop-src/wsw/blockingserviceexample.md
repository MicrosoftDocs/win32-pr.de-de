...
description: Beispiel für eine Dienst Anwendung, die einen serverseitigen Abbruch aufruft.
ms.assetid: a0a862bc-521a-477a-854d-58642d497109
keywords:
- 'Blockingserviceexample: Native Webdienste'
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104037041"
---
# <a name="blockingserviceexample"></a><span data-ttu-id="f2d85-106">Blockingserviceexample</span><span class="sxs-lookup"><span data-stu-id="f2d85-106">BlockingServiceExample</span></span>

<span data-ttu-id="f2d85-107">Beispiel für eine Dienst Anwendung, die einen serverseitigen Abbruch aufruft.</span><span class="sxs-lookup"><span data-stu-id="f2d85-107">Example service application demonstrating server side call cancellation.</span></span>

-   [<span data-ttu-id="f2d85-108">Cancellingservice. cpp</span><span class="sxs-lookup"><span data-stu-id="f2d85-108">CancellingService.cpp</span></span>](#cancellingservicecpp)
-   [<span data-ttu-id="f2d85-109">Blockunblockservice. WSDL</span><span class="sxs-lookup"><span data-stu-id="f2d85-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="f2d85-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="f2d85-110">Makefile</span></span>](#makefile)

## <a name="cancellingservicecpp"></a><span data-ttu-id="f2d85-111">Cancellingservice. cpp</span><span class="sxs-lookup"><span data-stu-id="f2d85-111">CancellingService.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="f2d85-112">Blockunblockservice. WSDL</span><span class="sxs-lookup"><span data-stu-id="f2d85-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f2d85-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="f2d85-113">Makefile</span></span>
