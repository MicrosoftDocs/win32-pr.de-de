...
description: Dieses Beispiel zeigt einen TCP-Server, der einen Channel annimmt und unidirektionale Nachrichten in einem Streamingmodus liest.
ms.assetid: 0b9c6fba-9dee-4409-b715-7827793a5522
keywords:
- Native streamingtcpserverexample-Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104388202"
---
# <a name="streamingtcpserverexample"></a><span data-ttu-id="d5d6a-106">Streamingtcpserverexample</span><span class="sxs-lookup"><span data-stu-id="d5d6a-106">StreamingTcpServerExample</span></span>

<span data-ttu-id="d5d6a-107">Dieses Beispiel zeigt einen TCP-Server, der einen Channel annimmt und unidirektionale Nachrichten in einem Streamingmodus liest.</span><span class="sxs-lookup"><span data-stu-id="d5d6a-107">This example shows a TCP server that accepts a channel, and reads one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="d5d6a-108">Streamingtcpserver. cpp</span><span class="sxs-lookup"><span data-stu-id="d5d6a-108">StreamingTcpServer.cpp</span></span>](#streamingtcpservercpp)
-   [<span data-ttu-id="d5d6a-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="d5d6a-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="d5d6a-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="d5d6a-110">Makefile</span></span>](#makefile)

## <a name="streamingtcpservercpp"></a><span data-ttu-id="d5d6a-111">Streamingtcpserver. cpp</span><span class="sxs-lookup"><span data-stu-id="d5d6a-111">StreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="d5d6a-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="d5d6a-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d5d6a-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="d5d6a-113">Makefile</span></span>
