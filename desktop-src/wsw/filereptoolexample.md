...
---
# <a name="filereptoolexample"></a><span data-ttu-id="d12c2-106">Filereptoolexample</span><span class="sxs-lookup"><span data-stu-id="d12c2-106">FileRepToolExample</span></span>

<span data-ttu-id="d12c2-107">Dies ist das Befehlszeilen Tool, das den [filerep-Dienst](filerepserviceexample.md)steuert.</span><span class="sxs-lookup"><span data-stu-id="d12c2-107">This is the command line tool that drives the [FileRep service](filerepserviceexample.md).</span></span> <span data-ttu-id="d12c2-108">Eine ausführlichere Beschreibung dieses Beispiels finden Sie hier.</span><span class="sxs-lookup"><span data-stu-id="d12c2-108">A more detailed description of this sample can be found there.</span></span>

<span data-ttu-id="d12c2-109">Die Befehlszeilenparameter lauten wie folgt:</span><span class="sxs-lookup"><span data-stu-id="d12c2-109">The command line parameters are as follows:</span></span>

<span data-ttu-id="d12c2-110">WsFileRep.exe <Client Service Url> <Server Service Url> <Source File> <Destination File> \[ /Encoding: <Binary/Text/MTOM>\] \[ /Sync\]</span><span class="sxs-lookup"><span data-stu-id="d12c2-110">WsFileRep.exe <Client Service Url> <Server Service Url> <Source File> <Destination File> \[/encoding:<binary/text/MTOM>\] \[/sync\]</span></span>

<span data-ttu-id="d12c2-111">Client Dienst-URL: obligatorisch.</span><span class="sxs-lookup"><span data-stu-id="d12c2-111">Client Service Url: Mandatory.</span></span> <span data-ttu-id="d12c2-112">Die URL des Client Dienstanbieter.</span><span class="sxs-lookup"><span data-stu-id="d12c2-112">Url of the client service.</span></span>

<span data-ttu-id="d12c2-113">URL des Server Dienstanbieter: obligatorisch.</span><span class="sxs-lookup"><span data-stu-id="d12c2-113">Server Service Url: Mandatory.</span></span> <span data-ttu-id="d12c2-114">Die URL des Server Dienstanbieter.</span><span class="sxs-lookup"><span data-stu-id="d12c2-114">Url of the server service.</span></span>

<span data-ttu-id="d12c2-115">Quelldatei: obligatorisch.</span><span class="sxs-lookup"><span data-stu-id="d12c2-115">Source File: Mandatory.</span></span> <span data-ttu-id="d12c2-116">Der voll qualifizierte lokale Name der Quelldatei.</span><span class="sxs-lookup"><span data-stu-id="d12c2-116">Fully qualified local name of the source file.</span></span> <span data-ttu-id="d12c2-117">Die Datei befindet sich auf dem Computer, auf dem der Server Dienst ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="d12c2-117">The file is located on the machine where the server service runs.</span></span>

<span data-ttu-id="d12c2-118">Zieldatei: obligatorisch.</span><span class="sxs-lookup"><span data-stu-id="d12c2-118">Destination file: Mandatory.</span></span> <span data-ttu-id="d12c2-119">Der voll qualifizierte lokale Name der Zieldatei.</span><span class="sxs-lookup"><span data-stu-id="d12c2-119">Fully qualified local name of the destination file.</span></span> <span data-ttu-id="d12c2-120">Die Datei befindet sich auf dem Computer, auf dem der Client Dienst ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="d12c2-120">The file will be located on the machine where the client service runs.</span></span>

<span data-ttu-id="d12c2-121">Codierung: optional.</span><span class="sxs-lookup"><span data-stu-id="d12c2-121">Encoding: Optional.</span></span> <span data-ttu-id="d12c2-122">Gibt die Nachrichten Codierung für die zwischen den Client-und Server Diensten gesendeten Nachrichten an.</span><span class="sxs-lookup"><span data-stu-id="d12c2-122">Specifies the message encoding for the messages sent between the client and server services.</span></span> <span data-ttu-id="d12c2-123">Die für die Kommunikation zwischen dem Befehlszeilen Tool und dem Client Dienst verwendete Codierung kann aus Gründen der Einfachheit nicht geändert werden.</span><span class="sxs-lookup"><span data-stu-id="d12c2-123">The encoding used for the communication between the command line tool and the client service cannot be changed for simplicity reasons.</span></span> <span data-ttu-id="d12c2-124">Gültige Parameter sind Binary, Text und MTOM.</span><span class="sxs-lookup"><span data-stu-id="d12c2-124">Valid parameters are binary, text and MTOM.</span></span> <span data-ttu-id="d12c2-125">Wenn der-Parameter nicht angegeben wird, wird die Standard Codierung für den Transport verwendet.</span><span class="sxs-lookup"><span data-stu-id="d12c2-125">If the parameter is not specified the default encoding for transport is used.</span></span>

<span data-ttu-id="d12c2-126">Sync: optional.</span><span class="sxs-lookup"><span data-stu-id="d12c2-126">Sync: Optional.</span></span> <span data-ttu-id="d12c2-127">Wenn festgelegt, wird die Anforderung synchron abgeschlossen.</span><span class="sxs-lookup"><span data-stu-id="d12c2-127">When set, the request completes synchronously.</span></span> <span data-ttu-id="d12c2-128">Andernfalls wird die Anforderung asynchron ausgeführt.</span><span class="sxs-lookup"><span data-stu-id="d12c2-128">Otherwise the request will complete asynchronously.</span></span>

-   [<span data-ttu-id="d12c2-129">Tool. cpp</span><span class="sxs-lookup"><span data-stu-id="d12c2-129">Tool.cpp</span></span>](#toolcpp)
-   [<span data-ttu-id="d12c2-130">Common. h</span><span class="sxs-lookup"><span data-stu-id="d12c2-130">common.h</span></span>](#commonh)
-   [<span data-ttu-id="d12c2-131">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="d12c2-131">Related topics</span></span>](#related-topics)

## <a name="toolcpp"></a><span data-ttu-id="d12c2-132">Tool. cpp</span><span class="sxs-lookup"><span data-stu-id="d12c2-132">Tool.cpp</span></span>
...
## <a name="commonh"></a><span data-ttu-id="d12c2-133">common.h</span><span class="sxs-lookup"><span data-stu-id="d12c2-133">common.h</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="d12c2-134">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="d12c2-134">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="d12c2-135">Filerepserviceexample</span><span class="sxs-lookup"><span data-stu-id="d12c2-135">FileRepServiceExample</span></span>](filerepserviceexample.md)
</dt> </dl>
