...
---
# <a name="policytemplateexample"></a><span data-ttu-id="cfc42-106">Policytemplateexample</span><span class="sxs-lookup"><span data-stu-id="cfc42-106">PolicyTemplateExample</span></span>

<span data-ttu-id="cfc42-107">In diesem Beispiel wird veranschaulicht, wie eine Richtlinien Beschreibung manuell erstellt und zum Erstellen des Dienst Proxys verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="cfc42-107">This example illustrates how to manually create policy description and use it to create service proxy.</span></span>

-   [<span data-ttu-id="cfc42-108">Policytemplate. cpp</span><span class="sxs-lookup"><span data-stu-id="cfc42-108">PolicyTemplate.cpp</span></span>](#policytemplatecpp)
-   [<span data-ttu-id="cfc42-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="cfc42-109">Makefile</span></span>](#makefile)

## <a name="policytemplatecpp"></a><span data-ttu-id="cfc42-110">Policytemplate. cpp</span><span class="sxs-lookup"><span data-stu-id="cfc42-110">PolicyTemplate.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="cfc42-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="cfc42-111">Makefile</span></span>
