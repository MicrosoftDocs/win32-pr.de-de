...
---
# <a name="httppurchaseorderwithkerberosoversslclientexample"></a><span data-ttu-id="c506a-106">Httppurchaseorderwithkerberosoversslclieintexample</span><span class="sxs-lookup"><span data-stu-id="c506a-106">HttpPurchaseOrderWithKerberosOverSslClientExample</span></span>

<span data-ttu-id="c506a-107">Dieses Beispiel zeigt einen HTTP-Client, der den Dienst Proxy verwendet, um mit einem PurchaseOrder-Dienst zu kommunizieren, mit Kerberos über SSL-Sicherheit im gemischten Modus.</span><span class="sxs-lookup"><span data-stu-id="c506a-107">This example shows a HTTP client that uses service proxy to talk to a PurchaseOrder service, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="c506a-108">In diesem Setup wird die Transport Verbindung von SSL geschützt (signiert, verschlüsselt), der auch die Server Authentifizierung bereitstellt.</span><span class="sxs-lookup"><span data-stu-id="c506a-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="c506a-109">Die Client Authentifizierung wird von einem Kerberos apreq-Ticket in einem WS-Security-Header in der Nachricht bereitgestellt.</span><span class="sxs-lookup"><span data-stu-id="c506a-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="c506a-110">Purchaseorderclientkerberosoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="c506a-110">PurchaseOrderClientKerberosOverSsl.cpp</span></span>](#purchaseorderclientkerberosoversslcpp)
-   [<span data-ttu-id="c506a-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="c506a-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="c506a-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="c506a-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderclientkerberosoversslcpp"></a><span data-ttu-id="c506a-113">Purchaseorderclientkerberosoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="c506a-113">PurchaseOrderClientKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="c506a-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="c506a-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="c506a-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="c506a-115">Makefile</span></span>
