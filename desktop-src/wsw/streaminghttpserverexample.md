...
description: Dieses Beispiel zeigt einen HTTP-Server, der einen Kanal akzeptiert und die Anforderung-Antwort-Verarbeitung in streamingweise durchführt.
ms.assetid: c108a5b3-923c-439c-8d86-7003a76ff45d
keywords:
- Native streaminghttpserverexample-Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103857039"
---
# <a name="streaminghttpserverexample"></a><span data-ttu-id="1d026-106">Streaminghttpserverexample</span><span class="sxs-lookup"><span data-stu-id="1d026-106">StreamingHttpServerExample</span></span>

<span data-ttu-id="1d026-107">Dieses Beispiel zeigt einen HTTP-Server, der einen Kanal akzeptiert und die Anforderung-Antwort-Verarbeitung in streamingweise durchführt.</span><span class="sxs-lookup"><span data-stu-id="1d026-107">This example shows an HTTP server that accepts a channel, and does request-reply processing in a streaming fashion.</span></span>

-   [<span data-ttu-id="1d026-108">Streaminghttpserver. cpp</span><span class="sxs-lookup"><span data-stu-id="1d026-108">StreamingHttpServer.cpp</span></span>](#streaminghttpservercpp)
-   [<span data-ttu-id="1d026-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="1d026-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="1d026-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="1d026-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpservercpp"></a><span data-ttu-id="1d026-111">Streaminghttpserver. cpp</span><span class="sxs-lookup"><span data-stu-id="1d026-111">StreamingHttpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="1d026-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="1d026-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="1d026-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="1d026-113">Makefile</span></span>
