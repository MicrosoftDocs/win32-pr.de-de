...
description: Überprüfen Sie ein HTTP-Clientbeispiel, in dem die Windows Web Services-API (WWSAPI) verwendet wird. Dieses Beispiel zeigt einen HTTP-Client, der Anforderung-Antwort-Nachrichten sendet.
...
ms.locfileid: "119026458"
---
# <a name="httpclientexample"></a>HttpClientExample

Dieses Beispiel zeigt einen HTTP-Client, der Anforderung-Antwort-Nachrichten sendet.
