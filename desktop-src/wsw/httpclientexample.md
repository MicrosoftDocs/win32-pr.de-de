...
description: Überprüfen Sie ein HTTP-Clientbeispiel, das die Windows-Webdienst-API (WWSAPI) verwendet. Dieses Beispiel zeigt einen HTTP-Client, der Anforderung-Antwort-Nachrichten sendet.
...
ms.locfileid: "112404133"
---
# <a name="httpclientexample"></a><span data-ttu-id="93b09-107">HttpClientExample</span><span class="sxs-lookup"><span data-stu-id="93b09-107">HttpClientExample</span></span>

<span data-ttu-id="93b09-108">Dieses Beispiel zeigt einen HTTP-Client, der Anforderung-Antwort-Nachrichten sendet.</span><span class="sxs-lookup"><span data-stu-id="93b09-108">This example shows a HTTP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="93b09-109">HttpClient.cpp</span><span class="sxs-lookup"><span data-stu-id="93b09-109">HttpClient.cpp</span></span>](#httpclientcpp)
-   [<span data-ttu-id="93b09-110">PurchaseOrder.wsdl</span><span class="sxs-lookup"><span data-stu-id="93b09-110">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="93b09-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="93b09-111">Makefile</span></span>](#makefile)

## <a name="httpclientcpp"></a><span data-ttu-id="93b09-112">HttpClient.cpp</span><span class="sxs-lookup"><span data-stu-id="93b09-112">HttpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="93b09-113">PurchaseOrder.wsdl</span><span class="sxs-lookup"><span data-stu-id="93b09-113">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="93b09-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="93b09-114">Makefile</span></span>
