...
keywords:
- Httpclieintexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104388093"
---
# <a name="httpclientexample"></a><span data-ttu-id="5915f-106">Httpclieintexample</span><span class="sxs-lookup"><span data-stu-id="5915f-106">HttpClientExample</span></span>

<span data-ttu-id="5915f-107">Dieses Beispiel zeigt einen HTTP-Client, der Anforderungs-Antwort-Nachrichten sendet.</span><span class="sxs-lookup"><span data-stu-id="5915f-107">This example shows a HTTP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="5915f-108">HttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="5915f-108">HttpClient.cpp</span></span>](#httpclientcpp)
-   [<span data-ttu-id="5915f-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="5915f-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="5915f-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="5915f-110">Makefile</span></span>](#makefile)

## <a name="httpclientcpp"></a><span data-ttu-id="5915f-111">HttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="5915f-111">HttpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="5915f-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="5915f-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="5915f-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="5915f-113">Makefile</span></span>
