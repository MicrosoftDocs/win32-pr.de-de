...
description: Dieses Beispiel veranschaulicht das Importieren von Metadaten von einem Endpunkt, der die Verwendung eines ausgestellten Tokens unterstützt, das vom ausstellenden Sicherheitstokendienst (STS) mithilfe von wsrequestsecuritytoken abgerufen und dem Dienst mithilfe der WS- \_ XML- \_ \_ tokennachrichtensicherheitsbindung \_ \_ mit WS \_ SSL- \_ Transport \_ Sicherheits \_ Bindung angezeigt wird Weitere Informationen finden Sie unter Federation.
ms.assetid: 31d1386a-1733-4e7a-add1-9050528075c8
keywords:
- MetadataImportWithIssuedTokenOverSslExample Windows-Webdienste-API
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104388059"
---
# <a name="metadataimportwithissuedtokenoversslexample"></a><span data-ttu-id="c85d3-107">MetadataImportWithIssuedTokenOverSslExample</span><span class="sxs-lookup"><span data-stu-id="c85d3-107">MetadataImportWithIssuedTokenOverSslExample</span></span>

<span data-ttu-id="c85d3-108">Dieses Beispiel veranschaulicht das Importieren von Metadaten von einem Endpunkt, der die Verwendung eines ausgestellten Tokens unterstützt, das vom ausstellenden Sicherheitstokendienst (STS) mithilfe von [**wsrequestsecuritytoken**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) abgerufen und dem Dienst mithilfe der [**WS-XML- \_ \_ \_ tokennachrichtensicherheitsbindung \_ \_**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) mit [**WS \_ SSL- \_ Transport \_ Sicherheits \_ Bindung**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)angezeigt wird</span><span class="sxs-lookup"><span data-stu-id="c85d3-108">This example illustrates importing metadata from an endpoint that supports using an issued token that is obtained from the issuing security token service (STS) using [**WsRequestSecurityToken**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) and presented to the service using [**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span> <span data-ttu-id="c85d3-109">Weitere Informationen finden Sie unter [Federation](federation.md) .</span><span class="sxs-lookup"><span data-stu-id="c85d3-109">See [Federation](federation.md) for more information.</span></span>

## <a name="metadataimportwithissuedtokenoversslexamplecpp"></a><span data-ttu-id="c85d3-110">MetadataImportWithIssuedTokenOverSslExample. cpp</span><span class="sxs-lookup"><span data-stu-id="c85d3-110">MetadataImportWithIssuedTokenOverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="c85d3-111">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="c85d3-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="c85d3-112">**Wsrequestsecuritytoken**</span><span class="sxs-lookup"><span data-stu-id="c85d3-112">**WsRequestSecurityToken**</span></span>](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken)
</dt> <dt>

[<span data-ttu-id="c85d3-113">**WS- \_ XML- \_ \_ tokennachrichtensicherheitsbindung \_ \_**</span><span class="sxs-lookup"><span data-stu-id="c85d3-113">**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding)
</dt> <dt>

[<span data-ttu-id="c85d3-114">**WS \_ SSL- \_ Transport \_ Sicherheits \_ Bindung**</span><span class="sxs-lookup"><span data-stu-id="c85d3-114">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> <dt>

[<span data-ttu-id="c85d3-115">Verbund</span><span class="sxs-lookup"><span data-stu-id="c85d3-115">Federation</span></span>](federation.md)
</dt> </dl>
