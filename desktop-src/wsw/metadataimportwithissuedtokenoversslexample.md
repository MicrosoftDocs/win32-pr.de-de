...
Dieses Beispiel veranschaulicht das Importieren von Metadaten von einem Endpunkt, der die Verwendung eines ausgestellten Tokens unterstützt, das vom ausstellenden Sicherheitstokendienst (STS) mithilfe von [**wsrequestsecuritytoken**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) abgerufen und dem Dienst mithilfe der [**WS-XML- \_ \_ \_ tokennachrichtensicherheitsbindung \_ \_**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) mit [**WS \_ SSL- \_ Transport \_ Sicherheits \_ Bindung**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)angezeigt wird Weitere Informationen finden Sie unter [Federation](federation.md) .
