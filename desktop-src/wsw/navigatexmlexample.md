...
description: Überprüfen Sie ein XML-Navigationsbeispiel, das Windows Web Services-API (WWSAPI) verwendet. In diesem Beispiel wird XML in einen XML-Puffer geschrieben und anschließend zurückgelesen.
