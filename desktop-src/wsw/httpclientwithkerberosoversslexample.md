...
---
# <a name="httpclientwithkerberosoversslexample"></a><span data-ttu-id="bd896-106">Httpclientwithkerberosoversslexample</span><span class="sxs-lookup"><span data-stu-id="bd896-106">HttpClientWithKerberosOverSslExample</span></span>

<span data-ttu-id="bd896-107">Dieses Beispiel zeigt einen HTTP-Client, der Anforderungs-/Antwort-Nachrichten mit Kerberos über SSL-Sicherheit im gemischten Modus sendet.</span><span class="sxs-lookup"><span data-stu-id="bd896-107">This example shows a HTTP client that sends request-reply messages, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="bd896-108">In diesem Setup wird die Transport Verbindung von SSL geschützt (signiert, verschlüsselt), der auch die Server Authentifizierung bereitstellt.</span><span class="sxs-lookup"><span data-stu-id="bd896-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="bd896-109">Die Client Authentifizierung wird von einem Kerberos apreq-Ticket in einem WS-Security-Header in der Nachricht bereitgestellt.</span><span class="sxs-lookup"><span data-stu-id="bd896-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="bd896-110">Httpclientwithkerberosoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="bd896-110">HttpClientWithKerberosOverSsl.cpp</span></span>](#httpclientwithkerberosoversslcpp)
-   [<span data-ttu-id="bd896-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="bd896-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="bd896-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="bd896-112">Makefile</span></span>](#makefile)

## <a name="httpclientwithkerberosoversslcpp"></a><span data-ttu-id="bd896-113">Httpclientwithkerberosoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="bd896-113">HttpClientWithKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="bd896-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="bd896-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="bd896-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="bd896-115">Makefile</span></span>
