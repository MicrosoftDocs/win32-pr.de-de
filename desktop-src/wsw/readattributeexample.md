...
---
# <a name="readattributeexample"></a><span data-ttu-id="fd67c-106">"Read attributeexample"</span><span class="sxs-lookup"><span data-stu-id="fd67c-106">ReadAttributeExample</span></span>

<span data-ttu-id="fd67c-107">In diesem Beispiel wird ein Attribut gelesen.</span><span class="sxs-lookup"><span data-stu-id="fd67c-107">This example reads an attribute.</span></span>

## <a name="readattributecpp"></a><span data-ttu-id="fd67c-108">"Read Attribute. cpp"</span><span class="sxs-lookup"><span data-stu-id="fd67c-108">ReadAttribute.cpp</span></span>
