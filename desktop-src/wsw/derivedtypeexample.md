...
---
# <a name="derivedtypeexample"></a><span data-ttu-id="619aa-107">Derivedtypeexample</span><span class="sxs-lookup"><span data-stu-id="619aa-107">DerivedTypeExample</span></span>

<span data-ttu-id="619aa-108">In diesem Beispiel werden abgeleitete Typen mithilfe der von wsutil generierten C++-Hilfsfunktionen geschrieben und gelesen.</span><span class="sxs-lookup"><span data-stu-id="619aa-108">This example writes and reads derived types using Wsutil generated C++ helper functions.</span></span> <span data-ttu-id="619aa-109">Weitere Informationen zu abgeleiteten Typbeschreibungen finden Sie unter [**\_ \_ Attribut \_ Feld \_ Zuordnung von WS Type**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) .</span><span class="sxs-lookup"><span data-stu-id="619aa-109">See [**WS\_TYPE\_ATTRIBUTE\_FIELD\_MAPPING**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) for more about derived type descriptions.</span></span>

-   [<span data-ttu-id="619aa-110">DerivedType. cpp</span><span class="sxs-lookup"><span data-stu-id="619aa-110">DerivedType.cpp</span></span>](#derivedtypecpp)
-   [<span data-ttu-id="619aa-111">DerivedType. xsd</span><span class="sxs-lookup"><span data-stu-id="619aa-111">DerivedType.xsd</span></span>](#derivedtypexsd)
-   [<span data-ttu-id="619aa-112">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="619aa-112">Related topics</span></span>](#related-topics)

## <a name="derivedtypecpp"></a><span data-ttu-id="619aa-113">DerivedType. cpp</span><span class="sxs-lookup"><span data-stu-id="619aa-113">DerivedType.cpp</span></span>
...
## <a name="derivedtypexsd"></a><span data-ttu-id="619aa-114">DerivedType. xsd</span><span class="sxs-lookup"><span data-stu-id="619aa-114">DerivedType.xsd</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="619aa-115">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="619aa-115">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="619aa-116">**\_ \_ Attribut \_ Feld \_ Zuordnung von "WS Type"**</span><span class="sxs-lookup"><span data-stu-id="619aa-116">**WS\_TYPE\_ATTRIBUTE\_FIELD\_MAPPING**</span></span>](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping)
</dt> </dl>
