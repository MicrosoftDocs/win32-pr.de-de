---
title: Onewayudpcliumtexample
description: Dieses Beispiel zeigt einen UDP-Client, der unidirektionale Nachrichten sendet.
ms.assetid: 245876f7-dc79-4ecd-b510-cf5e60eaa9fc
keywords:
- Onewayudpclieintexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103948014"
---
# <a name="onewayudpclientexample"></a><span data-ttu-id="f55c5-106">Onewayudpcliumtexample</span><span class="sxs-lookup"><span data-stu-id="f55c5-106">OneWayUdpClientExample</span></span>

<span data-ttu-id="f55c5-107">Dieses Beispiel zeigt einen UDP-Client, der unidirektionale Nachrichten sendet.</span><span class="sxs-lookup"><span data-stu-id="f55c5-107">This example shows a UDP client that sends a one-way messages.</span></span>

-   [<span data-ttu-id="f55c5-108">Onewayudpclient. cpp</span><span class="sxs-lookup"><span data-stu-id="f55c5-108">OneWayUdpClient.cpp</span></span>](#onewayudpclientcpp)
-   [<span data-ttu-id="f55c5-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="f55c5-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="f55c5-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="f55c5-110">Makefile</span></span>](#makefile)

## <a name="onewayudpclientcpp"></a><span data-ttu-id="f55c5-111">Onewayudpclient. cpp</span><span class="sxs-lookup"><span data-stu-id="f55c5-111">OneWayUdpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="f55c5-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="f55c5-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f55c5-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="f55c5-113">Makefile</span></span>
