---
title: Httppurchaseorderwithsslcliumtexample
description: In diesem Beispiel wird gezeigt, wie der Dienst Proxy für die Kommunikation mit einem PurchaseOrder-Dienst mit SSL-Transportsicherheit verwendet wird.
ms.assetid: afa73250-5f1c-4151-a2e0-4a5ccc91b63f
keywords:
- Httppurchaseorderwithsslcliumtexample Native-Web-Services
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106341869"
---
# <a name="httppurchaseorderwithsslclientexample"></a><span data-ttu-id="e58e2-106">Httppurchaseorderwithsslcliumtexample</span><span class="sxs-lookup"><span data-stu-id="e58e2-106">HttpPurchaseOrderWithSslClientExample</span></span>

<span data-ttu-id="e58e2-107">In diesem Beispiel wird gezeigt, wie der Dienst Proxy für die Kommunikation mit einem PurchaseOrder-Dienst mit SSL-Transportsicherheit verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="e58e2-107">This example show how to use the service proxy to talk to a PurchaseOrder service, with SSL transport security.</span></span>

-   [<span data-ttu-id="e58e2-108">Httppurchaseorderclientwithssl. cpp</span><span class="sxs-lookup"><span data-stu-id="e58e2-108">HttpPurchaseOrderClientWithSsl.cpp</span></span>](#httppurchaseorderclientwithsslcpp)
-   [<span data-ttu-id="e58e2-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="e58e2-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="e58e2-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="e58e2-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderclientwithsslcpp"></a><span data-ttu-id="e58e2-111">Httppurchaseorderclientwithssl. cpp</span><span class="sxs-lookup"><span data-stu-id="e58e2-111">HttpPurchaseOrderClientWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="e58e2-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="e58e2-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="e58e2-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="e58e2-113">Makefile</span></span>
