...
---
# <a name="httppurchaseorderwithsslclientexample"></a>Httppurchaseorderwithsslcliumtexample

In diesem Beispiel wird gezeigt, wie der Dienst Proxy für die Kommunikation mit einem PurchaseOrder-Dienst mit SSL-Transportsicherheit verwendet wird.
