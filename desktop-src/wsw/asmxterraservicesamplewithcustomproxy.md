---
title: AsmxMultiServiceSampleWithCustomProxy
description: In diesem Beispiel wird gezeigt, wie der Dienstproxy mit einem ASMX TerraService-Dienst mithilfe der \_ \_ benutzerdefinierten Kanaleigenschaft WS-HTTP-PROXYEINSTELLUNGSMODUS \_ \_ \_ spricht.
ms.assetid: 200dfcbc-ad16-4ac8-ab16-76291344a980
keywords:
- AsmxProxyServiceSampleWithCustomProxy Native-Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119805840"
---
# <a name="asmxterraservicesamplewithcustomproxy"></a>AsmxMultiServiceSampleWithCustomProxy

In diesem Beispiel wird gezeigt, wie der Dienstproxy mit einem ASMX TerraService-Dienst mithilfe der benutzerdefinierten Kanaleigenschaft [**\_ WS-HTTP-PROXYEINSTELLUNGSMODUS \_ \_ \_ \_**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) spricht.

-   [AsmxCustomProxyClient.cpp](#asmxcustomproxyclientcpp)
-   [terraservicechild.com.wsdl](#terraserviceusacomwsdl)
...
## <a name="terraserviceusacomwsdl"></a>terraservicechild.com.wsdl
...
[**\_ \_ BENUTZERDEFINIERTER WS-HTTP-PROXYEINSTELLUNGSMODUS \_ \_ \_**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode)
</dt> </dl>
