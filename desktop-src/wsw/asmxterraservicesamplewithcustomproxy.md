...
Diese Beispiele zeigen, wie der Dienst Proxy mit einem ASMX-TerraService-Dienst unter Verwendung der [**\_ \_ \_ \_ \_ benutzerdefinierten Channeleigenschaft des WS-HTTP-Proxys**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode)
...
[**WS- \_ http- \_ Proxy \_ Einstellungs \_ Modus \_ Benutzer definiert**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode)
</dt> </dl>
