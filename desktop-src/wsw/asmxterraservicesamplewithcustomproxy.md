...
description: Diese Beispiele zeigen, wie der Dienst Proxy mit einem ASMX-TerraService-Dienst unter Verwendung der \_ \_ \_ \_ \_ benutzerdefinierten Channeleigenschaft des WS-HTTP-Proxys
ms.assetid: 200dfcbc-ad16-4ac8-ab16-76291344a980
keywords:
- Asmxterraservicesamplewithcustomproxy Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104310299"
---
# <a name="asmxterraservicesamplewithcustomproxy"></a><span data-ttu-id="fdad5-106">Asmxterraservicesamplewithcustomproxy</span><span class="sxs-lookup"><span data-stu-id="fdad5-106">AsmxTerraServiceSampleWithCustomProxy</span></span>

<span data-ttu-id="fdad5-107">Diese Beispiele zeigen, wie der Dienst Proxy mit einem ASMX-TerraService-Dienst unter Verwendung der [**\_ \_ \_ \_ \_ benutzerdefinierten Channeleigenschaft des WS-HTTP-Proxys**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode)</span><span class="sxs-lookup"><span data-stu-id="fdad5-107">This examples shows service proxy talking to a ASMX TerraService service using [**WS\_HTTP\_PROXY\_SETTING\_MODE\_CUSTOM**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) channel property.</span></span>

-   [<span data-ttu-id="fdad5-108">Asmxcustomproxyclient. cpp</span><span class="sxs-lookup"><span data-stu-id="fdad5-108">AsmxCustomProxyClient.cpp</span></span>](#asmxcustomproxyclientcpp)
-   [<span data-ttu-id="fdad5-109">terraserviceusa. com. WSDL</span><span class="sxs-lookup"><span data-stu-id="fdad5-109">terraserviceusa.com.wsdl</span></span>](#terraserviceusacomwsdl)
-   [<span data-ttu-id="fdad5-110">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="fdad5-110">Related topics</span></span>](#related-topics)

## <a name="asmxcustomproxyclientcpp"></a><span data-ttu-id="fdad5-111">Asmxcustomproxyclient. cpp</span><span class="sxs-lookup"><span data-stu-id="fdad5-111">AsmxCustomProxyClient.cpp</span></span>
...
## <a name="terraserviceusacomwsdl"></a><span data-ttu-id="fdad5-112">terraserviceusa. com. WSDL</span><span class="sxs-lookup"><span data-stu-id="fdad5-112">terraserviceusa.com.wsdl</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="fdad5-113">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="fdad5-113">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="fdad5-114">**WS- \_ http- \_ Proxy \_ Einstellungs \_ Modus \_ Benutzer definiert**</span><span class="sxs-lookup"><span data-stu-id="fdad5-114">**WS\_HTTP\_PROXY\_SETTING\_MODE\_CUSTOM**</span></span>](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode)
</dt> </dl>
