...
description: In diesem Beispiel wird eine Meldung codiert und decodiert.
ms.assetid: b1f0a1df-22be-4c86-9a7a-0a4d4f363206
keywords:
- MessageEncodingExample-Webdienste für Windows
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104037029"
---
# <a name="messageencodingexample"></a><span data-ttu-id="3b7a8-106">MessageEncodingExample</span><span class="sxs-lookup"><span data-stu-id="3b7a8-106">MessageEncodingExample</span></span>

<span data-ttu-id="3b7a8-107">In diesem Beispiel wird eine Meldung codiert und decodiert.</span><span class="sxs-lookup"><span data-stu-id="3b7a8-107">This example encodes and decodes a message.</span></span>

-   [<span data-ttu-id="3b7a8-108">MessageEncoding. cpp</span><span class="sxs-lookup"><span data-stu-id="3b7a8-108">MessageEncoding.cpp</span></span>](#messageencodingcpp)
-   [<span data-ttu-id="3b7a8-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="3b7a8-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="3b7a8-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="3b7a8-110">Makefile</span></span>](#makefile)

## <a name="messageencodingcpp"></a><span data-ttu-id="3b7a8-111">MessageEncoding. cpp</span><span class="sxs-lookup"><span data-stu-id="3b7a8-111">MessageEncoding.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="3b7a8-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="3b7a8-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="3b7a8-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="3b7a8-113">Makefile</span></span>
