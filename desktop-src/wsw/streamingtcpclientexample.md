---
title: Streamingtcpcliumtexample
description: Dieses Beispiel zeigt einen TCP-Client, der unidirektionale Nachrichten per Streaming sendet.
ms.assetid: 29e9e08a-2cff-4467-b889-608a34d4b07e
keywords:
- Native streamingtcpclieintexample-Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104037560"
---
# <a name="streamingtcpclientexample"></a><span data-ttu-id="70e3f-106">Streamingtcpcliumtexample</span><span class="sxs-lookup"><span data-stu-id="70e3f-106">StreamingTcpClientExample</span></span>

<span data-ttu-id="70e3f-107">Dieses Beispiel zeigt einen TCP-Client, der unidirektionale Nachrichten per Streaming sendet.</span><span class="sxs-lookup"><span data-stu-id="70e3f-107">This example shows a TCP client that sends one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="70e3f-108">Streamingtcpclient. cpp</span><span class="sxs-lookup"><span data-stu-id="70e3f-108">StreamingTcpClient.cpp</span></span>](#streamingtcpclientcpp)
-   [<span data-ttu-id="70e3f-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="70e3f-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="70e3f-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="70e3f-110">Makefile</span></span>](#makefile)

## <a name="streamingtcpclientcpp"></a><span data-ttu-id="70e3f-111">Streamingtcpclient. cpp</span><span class="sxs-lookup"><span data-stu-id="70e3f-111">StreamingTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="70e3f-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="70e3f-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="70e3f-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="70e3f-113">Makefile</span></span>
