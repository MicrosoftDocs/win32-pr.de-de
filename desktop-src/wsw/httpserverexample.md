...
description: Sehen Sie sich ein BEISPIEL für einen HTTP-Server an, der die Windows Web Services-API verwendet. Dieses Beispiel zeigt einen TCP-Server, der einen Kanal akzeptiert und Nachrichten empfängt und antwortet.
