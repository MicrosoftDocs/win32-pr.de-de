...
description: In diesem Beispiel wird eine Nachricht weitergeleitet.
ms.assetid: bedaa7f3-2a43-45f4-a623-c0e41b5113a4
keywords:
- Forwardmessageexample-Webdienste für Windows
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104037139"
---
# <a name="forwardmessageexample"></a><span data-ttu-id="f9b7b-106">Forwardmessageexample</span><span class="sxs-lookup"><span data-stu-id="f9b7b-106">ForwardMessageExample</span></span>

<span data-ttu-id="f9b7b-107">In diesem Beispiel wird eine Nachricht weitergeleitet.</span><span class="sxs-lookup"><span data-stu-id="f9b7b-107">This example forwards a message.</span></span>

-   [<span data-ttu-id="f9b7b-108">ForwardMessage. cpp</span><span class="sxs-lookup"><span data-stu-id="f9b7b-108">ForwardMessage.cpp</span></span>](#forwardmessagecpp)
-   [<span data-ttu-id="f9b7b-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="f9b7b-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="f9b7b-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="f9b7b-110">Makefile</span></span>](#makefile)

## <a name="forwardmessagecpp"></a><span data-ttu-id="f9b7b-111">ForwardMessage. cpp</span><span class="sxs-lookup"><span data-stu-id="f9b7b-111">ForwardMessage.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="f9b7b-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="f9b7b-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f9b7b-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="f9b7b-113">Makefile</span></span>
