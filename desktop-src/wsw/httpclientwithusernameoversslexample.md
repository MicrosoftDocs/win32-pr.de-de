...
---
# <a name="httpclientwithusernameoversslexample"></a><span data-ttu-id="61dc3-106">Httpclientwithusernameoversslexample</span><span class="sxs-lookup"><span data-stu-id="61dc3-106">HttpClientWithUsernameOverSslExample</span></span>

<span data-ttu-id="61dc3-107">Dieses Beispiel zeigt einen HTTP-Client, der Anforderungs-/Antwort-Nachrichten mit einem Benutzernamen über SSL-Sicherheit im gemischten Modus sendet.</span><span class="sxs-lookup"><span data-stu-id="61dc3-107">This example shows a HTTP client that sends request-reply messages, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="61dc3-108">In diesem Setup wird die Transport Verbindung von SSL geschützt (signiert, verschlüsselt), der auch die Server Authentifizierung bereitstellt.</span><span class="sxs-lookup"><span data-stu-id="61dc3-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="61dc3-109">Die Client Authentifizierung wird von einem Paar aus Benutzername und Kennwort in einem WS-Security-Header in der Nachricht bereitgestellt.</span><span class="sxs-lookup"><span data-stu-id="61dc3-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="61dc3-110">Httpclientwithusernameoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="61dc3-110">HttpClientWithUsernameOverSsl.cpp</span></span>](#httpclientwithusernameoversslcpp)
-   [<span data-ttu-id="61dc3-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="61dc3-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="61dc3-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="61dc3-112">Makefile</span></span>](#makefile)

## <a name="httpclientwithusernameoversslcpp"></a><span data-ttu-id="61dc3-113">Httpclientwithusernameoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="61dc3-113">HttpClientWithUsernameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="61dc3-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="61dc3-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="61dc3-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="61dc3-115">Makefile</span></span>
