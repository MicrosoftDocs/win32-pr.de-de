...
---
# <a name="untypedserviceexample"></a><span data-ttu-id="6065e-107">Untypedserviceexample</span><span class="sxs-lookup"><span data-stu-id="6065e-107">UnTypedServiceExample</span></span>

<span data-ttu-id="6065e-108">Dieses Beispiel zeigt, wie ein nicht typisierter Dienst mit dem Dienstmodell implementiert wird.</span><span class="sxs-lookup"><span data-stu-id="6065e-108">This sample shows how implement an untyped service with Service Model.</span></span> <span data-ttu-id="6065e-109">Das Dienstmodell in diesem Fall stellt die Infrastruktur für die kesselplatte bereit.</span><span class="sxs-lookup"><span data-stu-id="6065e-109">Service Model in this case provides the boiler plate infrastructure.</span></span>

-   [<span data-ttu-id="6065e-110">Untypedservice. cpp</span><span class="sxs-lookup"><span data-stu-id="6065e-110">UnTypedService.cpp</span></span>](#untypedservicecpp)
-   [<span data-ttu-id="6065e-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6065e-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="6065e-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="6065e-112">Makefile</span></span>](#makefile)

## <a name="untypedservicecpp"></a><span data-ttu-id="6065e-113">Untypedservice. cpp</span><span class="sxs-lookup"><span data-stu-id="6065e-113">UnTypedService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="6065e-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6065e-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="6065e-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="6065e-115">Makefile</span></span>
