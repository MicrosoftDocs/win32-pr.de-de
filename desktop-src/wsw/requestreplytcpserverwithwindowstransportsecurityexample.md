---
title: Requestreplytcpserverwithwindowstransportsecurity-Beispiel
description: Dieses Beispiel zeigt einen TCP-Server, der einen Channel annimmt und Nachrichten empfängt und auf diese antwortet, wobei die Sicherheit von der Windows SSPI-basierten Transportsicherheit bereitgestellt wird.
ms.assetid: 690fa5cd-228b-4099-bd2b-cbf9c8d70c53
keywords:
- Requestreplytcpserverwithwindowstransportsecurityexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104101146"
---
# <a name="requestreplytcpserverwithwindowstransportsecurity-example"></a><span data-ttu-id="fe116-106">Requestreplytcpserverwithwindowstransportsecurity-Beispiel</span><span class="sxs-lookup"><span data-stu-id="fe116-106">RequestReplyTcpServerWithWindowsTransportSecurity example</span></span>

<span data-ttu-id="fe116-107">Dieses Beispiel zeigt einen TCP-Server, der einen Channel annimmt und Nachrichten empfängt und auf diese antwortet, wobei die Sicherheit von der Windows SSPI-basierten Transportsicherheit bereitgestellt wird.</span><span class="sxs-lookup"><span data-stu-id="fe116-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with security provided by Windows SSPI-based transport security.</span></span>

-   [<span data-ttu-id="fe116-108">Requestreplytcpserverwithwindowstransportsecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="fe116-108">RequestReplyTcpServerWithWindowsTransportSecurity.cpp</span></span>](#requestreplytcpserverwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="fe116-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="fe116-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="fe116-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="fe116-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpserverwithwindowstransportsecuritycpp"></a><span data-ttu-id="fe116-111">Requestreplytcpserverwithwindowstransportsecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="fe116-111">RequestReplyTcpServerWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="fe116-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="fe116-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="fe116-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="fe116-113">Makefile</span></span>
