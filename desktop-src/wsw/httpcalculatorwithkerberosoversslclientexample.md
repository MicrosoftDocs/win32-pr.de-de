...
---
# <a name="httpcalculatorwithkerberosoversslclientexample"></a><span data-ttu-id="0a5d9-106">Httpcalculatorwithkerberosoversslcliumtexample</span><span class="sxs-lookup"><span data-stu-id="0a5d9-106">HttpCalculatorWithKerberosOverSslClientExample</span></span>

<span data-ttu-id="0a5d9-107">Dieses Beispiel zeigt einen HTTP-Client, der den Dienst Proxy verwendet, um mit einem Rechner Dienst zu kommunizieren, mit Kerberos über SSL-Sicherheit im gemischten Modus.</span><span class="sxs-lookup"><span data-stu-id="0a5d9-107">This example shows a HTTP client that uses service proxy to talk to a calculator service, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="0a5d9-108">In diesem Setup wird die Transport Verbindung von SSL geschützt (signiert, verschlüsselt), der auch die Server Authentifizierung bereitstellt.</span><span class="sxs-lookup"><span data-stu-id="0a5d9-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="0a5d9-109">Die Client Authentifizierung wird von einem Kerberos apreq-Ticket in einem WS-Security-Header in der Nachricht bereitgestellt.</span><span class="sxs-lookup"><span data-stu-id="0a5d9-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="0a5d9-110">Calculatorclientkerberosoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="0a5d9-110">CalculatorClientKerberosOverSsl.cpp</span></span>](#calculatorclientkerberosoversslcpp)
-   [<span data-ttu-id="0a5d9-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="0a5d9-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="0a5d9-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="0a5d9-112">Makefile</span></span>](#makefile)

## <a name="calculatorclientkerberosoversslcpp"></a><span data-ttu-id="0a5d9-113">Calculatorclientkerberosoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="0a5d9-113">CalculatorClientKerberosOverSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="0a5d9-114">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="0a5d9-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0a5d9-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="0a5d9-115">Makefile</span></span>
