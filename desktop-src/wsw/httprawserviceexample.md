...
description: Dieses Beispiel zeigt, wie Sie den Dienst Host verwenden, um unformatierte HTTP-Anforderungen (nicht SOAP) zu verarbeiten.
ms.assetid: fbe5ad9c-f3f4-40c2-86e0-03b945aab89f
keywords:
- Httprawserviceexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103712246"
---
# <a name="httprawserviceexample"></a><span data-ttu-id="aa52f-106">Httprawserviceexample</span><span class="sxs-lookup"><span data-stu-id="aa52f-106">HttpRawServiceExample</span></span>

<span data-ttu-id="aa52f-107">Dieses Beispiel zeigt, wie Sie den Dienst Host verwenden, um unformatierte HTTP-Anforderungen (nicht SOAP) zu verarbeiten.</span><span class="sxs-lookup"><span data-stu-id="aa52f-107">This example shows how to use service host to handle raw (non-SOAP) HTTP requests.</span></span>

## <a name="httprawservicecpp"></a><span data-ttu-id="aa52f-108">Httprawservice. cpp</span><span class="sxs-lookup"><span data-stu-id="aa52f-108">HttpRawService.cpp</span></span>
