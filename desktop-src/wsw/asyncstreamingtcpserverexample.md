...
description: Dieses Beispiel zeigt einen TCP-Server, der unidirektionale Nachrichten in einem asynchronen Streamingverfahren empfängt.
ms.assetid: 8b79735b-f238-4d49-8977-2935fc208d48
keywords:
- Asyncstreamingtcpserverexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106341452"
---
# <a name="asyncstreamingtcpserverexample"></a><span data-ttu-id="10224-106">Asyncstreamingtcpserverexample</span><span class="sxs-lookup"><span data-stu-id="10224-106">AsyncStreamingTcpServerExample</span></span>

<span data-ttu-id="10224-107">Dieses Beispiel zeigt einen TCP-Server, der unidirektionale Nachrichten in einem asynchronen Streamingverfahren empfängt.</span><span class="sxs-lookup"><span data-stu-id="10224-107">This example shows a TCP server that receives one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="10224-108">Asyncstreamingtcpserver. cpp</span><span class="sxs-lookup"><span data-stu-id="10224-108">AsyncStreamingTcpServer.cpp</span></span>](#asyncstreamingtcpservercpp)
-   [<span data-ttu-id="10224-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="10224-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="10224-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="10224-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpservercpp"></a><span data-ttu-id="10224-111">Asyncstreamingtcpserver. cpp</span><span class="sxs-lookup"><span data-stu-id="10224-111">AsyncStreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="10224-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="10224-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="10224-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="10224-113">Makefile</span></span>
