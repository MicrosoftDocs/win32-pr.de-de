...
---
# <a name="asynchronous-function-example"></a><span data-ttu-id="1a339-106">Beispiel für eine asynchrone Funktion</span><span class="sxs-lookup"><span data-stu-id="1a339-106">Asynchronous Function Example</span></span>

<span data-ttu-id="1a339-107">Dieses Beispiel veranschaulicht das Implementieren und Aufrufen von asynchronen Funktionen.</span><span class="sxs-lookup"><span data-stu-id="1a339-107">This example illustrates implementing and calling asynchronous functions.</span></span>

<span data-ttu-id="1a339-108">Das Beispiel besteht aus den folgenden Teilen:</span><span class="sxs-lookup"><span data-stu-id="1a339-108">The example consists of the following parts:</span></span>

-   <span data-ttu-id="1a339-109">Die Add-Funktion, mit der zwei Zahlen synchron oder asynchron addiert werden.</span><span class="sxs-lookup"><span data-stu-id="1a339-109">The Add function which will add two numbers synchronously or asynchronously.</span></span> <span data-ttu-id="1a339-110">Es wird ein Thread als Implementierungsdetail für den asynchronen Fall erstellt.</span><span class="sxs-lookup"><span data-stu-id="1a339-110">It creates a thread as an implementation detail for the asynchronous case.</span></span>
-   <span data-ttu-id="1a339-111">Die calladdsync-Funktion Ruft die Funktionen zum Hinzufügen synchron auf.</span><span class="sxs-lookup"><span data-stu-id="1a339-111">The CallAddSync function invokes the Add functions synchronously.</span></span>
-   <span data-ttu-id="1a339-112">Die calladdasync-Funktion Ruft die Add-Funktionen asynchron auf.</span><span class="sxs-lookup"><span data-stu-id="1a339-112">The CallAddAsync function invokes the Add functions asynchronously.</span></span>

## <a name="asyncmodelcpp"></a><span data-ttu-id="1a339-113">Asyncmodel. cpp</span><span class="sxs-lookup"><span data-stu-id="1a339-113">AsyncModel.cpp</span></span>
