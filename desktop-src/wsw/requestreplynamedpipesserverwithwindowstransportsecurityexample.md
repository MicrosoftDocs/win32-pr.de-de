...
description: Dieses Beispiel zeigt einen Named Pipes-Server, der einen Kanal akzeptiert und Nachrichten mit der von der Windows SSPI-Transportsicherheit bereitgestellten Sicherheit empfängt und antwortet.
...
ms.locfileid: "104036272"
---
# <a name="requestreplynamedpipesserverwithwindowstransportsecurityexample"></a><span data-ttu-id="ded7c-103">Requestreplynamedpipesserverwithwindowstransportsecurityexample</span><span class="sxs-lookup"><span data-stu-id="ded7c-103">RequestReplyNamedPipesServerWithWindowsTransportSecurityExample</span></span>

<span data-ttu-id="ded7c-104">Dieses Beispiel zeigt einen Named Pipes-Server, der einen Kanal akzeptiert und Nachrichten mit der von der Windows SSPI-Transportsicherheit bereitgestellten Sicherheit empfängt und antwortet.</span><span class="sxs-lookup"><span data-stu-id="ded7c-104">This example shows a named pipes server that accepts a channel, and receives and replies to messages with security provided by Windows SSPI transport security.</span></span>

-   [<span data-ttu-id="ded7c-105">Requestreplynamedpipesserverwithwindowstransportsecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="ded7c-105">RequestReplyNamedPipesServerWithWindowsTransportSecurity.cpp</span></span>](#requestreplynamedpipesserverwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="ded7c-106">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="ded7c-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="ded7c-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="ded7c-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesserverwithwindowstransportsecuritycpp"></a><span data-ttu-id="ded7c-108">Requestreplynamedpipesserverwithwindowstransportsecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="ded7c-108">RequestReplyNamedPipesServerWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="ded7c-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="ded7c-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="ded7c-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="ded7c-110">Makefile</span></span>
