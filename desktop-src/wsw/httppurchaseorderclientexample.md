---
title: Httppurchaseorderclieintexample
description: In diesem Beispiel wird gezeigt, wie der Dienst Proxy für die Kommunikation mit einem HTTP-basierten PurchaseOrder-Dienst verwendet wird.
ms.assetid: e577b06c-28b1-4f8f-a6af-025b9672cf27
keywords:
- Httppurchaseorderclieintexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104037152"
---
# <a name="httppurchaseorderclientexample"></a><span data-ttu-id="7eabf-106">Httppurchaseorderclieintexample</span><span class="sxs-lookup"><span data-stu-id="7eabf-106">HttpPurchaseOrderClientExample</span></span>

<span data-ttu-id="7eabf-107">In diesem Beispiel wird gezeigt, wie der Dienst Proxy für die Kommunikation mit einem HTTP-basierten PurchaseOrder-Dienst verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="7eabf-107">This example show how to use the service proxy to talk to an HTTP based PurchaseOrder service.</span></span>

-   [<span data-ttu-id="7eabf-108">Httppurchaseorderclient. cpp</span><span class="sxs-lookup"><span data-stu-id="7eabf-108">HttpPurchaseOrderClient.cpp</span></span>](#httppurchaseorderclientcpp)
-   [<span data-ttu-id="7eabf-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7eabf-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="7eabf-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="7eabf-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderclientcpp"></a><span data-ttu-id="7eabf-111">Httppurchaseorderclient. cpp</span><span class="sxs-lookup"><span data-stu-id="7eabf-111">HttpPurchaseOrderClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="7eabf-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7eabf-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="7eabf-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="7eabf-113">Makefile</span></span>
