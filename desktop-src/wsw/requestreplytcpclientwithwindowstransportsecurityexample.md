...
description: Dieses Beispiel zeigt einen TCP-Client, der Anforderungs-/Antwort-Nachrichten mit der von der Windows SSPI-Transportsicherheit bereitgestellten Sicherheit sendet. Außerdem wird erläutert, wie der Client mithilfe von sicherheitstokeneigenschaften die zulässige Identitätswechsel Ebene von der Standardeinstellung aus ändern kann.
ms.assetid: 8419e861-dc7f-41ca-96a4-b7c6d380a210
keywords:
- Requestreplytcpclientwithwindowstransportsecurityexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104309175"
---
# <a name="requestreplytcpclientwithwindowstransportsecurityexample"></a><span data-ttu-id="c92b7-107">Requestreplytcpclientwithwindowstransportsecurityexample</span><span class="sxs-lookup"><span data-stu-id="c92b7-107">RequestReplyTcpClientWithWindowsTransportSecurityExample</span></span>

<span data-ttu-id="c92b7-108">Dieses Beispiel zeigt einen TCP-Client, der Anforderungs-/Antwort-Nachrichten mit der von der Windows SSPI-Transportsicherheit bereitgestellten Sicherheit sendet.</span><span class="sxs-lookup"><span data-stu-id="c92b7-108">This example shows a TCP client that sends request-reply messages, with security provided by Windows SSPI transport security.</span></span> <span data-ttu-id="c92b7-109">Außerdem wird erläutert, wie der Client mithilfe von sicherheitstokeneigenschaften die zulässige Identitätswechsel Ebene von der Standardeinstellung aus ändern kann.</span><span class="sxs-lookup"><span data-stu-id="c92b7-109">It also illustrates the client using security token properties to modify the allowed impersonation level from the default.</span></span>

-   [<span data-ttu-id="c92b7-110">Requestreplytcpclientwithwindowstransportsecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="c92b7-110">RequestReplyTcpClientWithWindowsTransportSecurity.cpp</span></span>](#requestreplytcpclientwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="c92b7-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="c92b7-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="c92b7-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="c92b7-112">Makefile</span></span>](#makefile)

## <a name="requestreplytcpclientwithwindowstransportsecuritycpp"></a><span data-ttu-id="c92b7-113">Requestreplytcpclientwithwindowstransportsecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="c92b7-113">RequestReplyTcpClientWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="c92b7-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="c92b7-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="c92b7-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="c92b7-115">Makefile</span></span>
