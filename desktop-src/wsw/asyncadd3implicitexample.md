...
---
# <a name="asyncadd3implicitexample"></a><span data-ttu-id="e21f4-106">AsyncAdd3ImplicitExample</span><span class="sxs-lookup"><span data-stu-id="e21f4-106">AsyncAdd3ImplicitExample</span></span>

<span data-ttu-id="e21f4-107">In diesem Beispiel wird die Implementierung einer komplexen asynchronen Funktion mit [**wsasyncexecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute)veranschaulicht.</span><span class="sxs-lookup"><span data-stu-id="e21f4-107">This example illustrates implementing a complex asynchronous function using [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).</span></span>

<span data-ttu-id="e21f4-108">Im Beispiel wird eine asynchrone Funktion "addthree" implementiert, die drei ganze Zahlen addiert, indem Sie auf einer vorhandenen Add-Funktion aufbaut, die zwei ganze Zahlen asynchron hinzufügen kann.</span><span class="sxs-lookup"><span data-stu-id="e21f4-108">The example implements an asynchronous function 'AddThree' which adds three integers together by building upon an existing Add function which can add two integers asynchronously.</span></span>

## <a name="asyncadd3implicitcpp"></a><span data-ttu-id="e21f4-109">AsyncAdd3Implicit. cpp</span><span class="sxs-lookup"><span data-stu-id="e21f4-109">AsyncAdd3Implicit.cpp</span></span>
