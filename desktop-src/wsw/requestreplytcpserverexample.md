...
description: Sehen Sie sich ein Beispiel für eine Anforderung und Antwort an den TCP-Server an, in dem die Windows Web Services-API (WWSAPI) verwendet wird. Dieses Beispiel akzeptiert einen Kanal und empfängt Nachrichten und antwortet darauf.
