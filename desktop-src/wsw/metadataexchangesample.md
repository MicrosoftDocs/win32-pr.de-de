...
In diesem Beispiel wird gezeigt, wie der Dienst Host zum Hosten eines PurchaseOrder-Diensts über TCP verwendet wird. Der Dienst unterstützt auch WS-MetadataExchange.
