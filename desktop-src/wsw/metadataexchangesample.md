...
description: In diesem Beispiel wird gezeigt, wie der Dienst Host zum Hosten eines PurchaseOrder-Diensts über TCP verwendet wird. Der Dienst unterstützt auch WS-MetadataExchange.
ms.assetid: 8f14e6a8-ccb9-4556-b04f-df08c6c80adf
keywords:
- MetadataExchangeSample Windows-Webdienste-API
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104036544"
---
# <a name="metadataexchangesample"></a><span data-ttu-id="6b30c-107">MetadataExchangeSample</span><span class="sxs-lookup"><span data-stu-id="6b30c-107">MetadataExchangeSample</span></span>

<span data-ttu-id="6b30c-108">In diesem Beispiel wird gezeigt, wie der Dienst Host zum Hosten eines PurchaseOrder-Diensts über TCP verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="6b30c-108">This example shows how to use service host for hosting a PurchaseOrder service over TCP.</span></span> <span data-ttu-id="6b30c-109">Der Dienst unterstützt auch WS-MetadataExchange.</span><span class="sxs-lookup"><span data-stu-id="6b30c-109">The service also supports WS-MetadataExchange.</span></span>

-   [<span data-ttu-id="6b30c-110">Mexservice. cpp</span><span class="sxs-lookup"><span data-stu-id="6b30c-110">MexService.cpp</span></span>](#mexservicecpp)
-   [<span data-ttu-id="6b30c-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6b30c-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="6b30c-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="6b30c-112">Makefile</span></span>](#makefile)

## <a name="mexservicecpp"></a><span data-ttu-id="6b30c-113">Mexservice. cpp</span><span class="sxs-lookup"><span data-stu-id="6b30c-113">MexService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="6b30c-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6b30c-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="6b30c-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="6b30c-115">Makefile</span></span>
