...
description: In diesem Beispiel wird gezeigt, wie der Dienst Host zum Hosten eines Rechner Diensts über HTTP mit SSL-Transportsicherheit verwendet wird.
ms.assetid: 15e61f32-73b5-4359-957d-9694fe947b1e
keywords:
- Httpcalculatorwithsslserviceexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106340415"
---
# <a name="httpcalculatorwithsslserviceexample"></a><span data-ttu-id="50516-106">Httpcalculatorwithsslserviceexample</span><span class="sxs-lookup"><span data-stu-id="50516-106">HttpCalculatorWithSslServiceExample</span></span>

<span data-ttu-id="50516-107">In diesem Beispiel wird gezeigt, wie der Dienst Host zum Hosten eines Rechner Diensts über HTTP mit SSL-Transportsicherheit verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="50516-107">This example shows how to use service host for hosting a calculator service over HTTP, with SSL transport security.</span></span>

-   [<span data-ttu-id="50516-108">Httpcalculatorservicewithssl. cpp</span><span class="sxs-lookup"><span data-stu-id="50516-108">HttpCalculatorServiceWithSsl.cpp</span></span>](#httpcalculatorservicewithsslcpp)
-   [<span data-ttu-id="50516-109">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="50516-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="50516-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="50516-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorservicewithsslcpp"></a><span data-ttu-id="50516-111">Httpcalculatorservicewithssl. cpp</span><span class="sxs-lookup"><span data-stu-id="50516-111">HttpCalculatorServiceWithSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="50516-112">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="50516-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="50516-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="50516-113">Makefile</span></span>
