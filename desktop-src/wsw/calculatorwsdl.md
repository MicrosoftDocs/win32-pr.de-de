...
description: Dies ist ein Beispiel für ein WSDL/Schema für die Rechner Dienst Beispiele.
ms.assetid: 6dbea7dc-2d5c-4e6d-9941-9a93943e1914
keywords:
- Calculatorwsdl-Webdienste für Windows
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103719964"
---
# <a name="calculatorwsdl"></a><span data-ttu-id="0b55c-106">Calculatorwsdl</span><span class="sxs-lookup"><span data-stu-id="0b55c-106">CalculatorWsdl</span></span>

<span data-ttu-id="0b55c-107">Dies ist ein Beispiel für ein WSDL/Schema für die Rechner Dienst Beispiele.</span><span class="sxs-lookup"><span data-stu-id="0b55c-107">This is an example wsdl/schema for the calculator service samples.</span></span>

## <a name="calculatorwsdl"></a><span data-ttu-id="0b55c-108">Rechner. WSDL</span><span class="sxs-lookup"><span data-stu-id="0b55c-108">Calculator.wsdl</span></span>
