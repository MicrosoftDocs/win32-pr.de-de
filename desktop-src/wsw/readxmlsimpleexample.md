...
---
# <a name="readxmlsimpleexample"></a>"Read xmlsimpleexample"

In diesem Beispiel wird ein einfaches XML-Dokument gelesen.

## <a name="readxmlsimplecpp"></a>"Read xmlsimple. cpp"
