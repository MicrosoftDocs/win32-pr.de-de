...
description: In diesem Beispiel wird gezeigt, wie ein Element in einen XML-Puffer eingefügt wird.
ms.assetid: 98fed487-77f8-4224-9a73-b20afcb01d47
keywords:
- Insertelementexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104515902"
---
# <a name="insertelementexample"></a><span data-ttu-id="05b30-106">Insertelementexample</span><span class="sxs-lookup"><span data-stu-id="05b30-106">InsertElementExample</span></span>

<span data-ttu-id="05b30-107">In diesem Beispiel wird gezeigt, wie ein Element in einen XML-Puffer eingefügt wird.</span><span class="sxs-lookup"><span data-stu-id="05b30-107">This example shows how to insert an element in an xml buffer.</span></span>

## <a name="insertelementcpp"></a><span data-ttu-id="05b30-108">Insertelements. cpp</span><span class="sxs-lookup"><span data-stu-id="05b30-108">InsertElement.cpp</span></span>
