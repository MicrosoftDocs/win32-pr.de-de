...
---
# <a name="httppurchaseorderwithusernameoversslclientexample"></a><span data-ttu-id="b19bd-106">Httppurchaseorderwithusernameoversslcliumtexample</span><span class="sxs-lookup"><span data-stu-id="b19bd-106">HttpPurchaseOrderWithUsernameOverSslClientExample</span></span>

<span data-ttu-id="b19bd-107">Dieses Beispiel zeigt einen HTTP-Client, der den Dienst Proxy für die Kommunikation mit einem PurchaseOrder-Dienst verwendet, mit dem Benutzernamen über SSL-Sicherheit im gemischten Modus.</span><span class="sxs-lookup"><span data-stu-id="b19bd-107">This example shows a HTTP client that uses service proxy to talk to a PurchaseOrder service, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="b19bd-108">In diesem Setup wird die Transport Verbindung von SSL geschützt (signiert, verschlüsselt), der auch die Server Authentifizierung bereitstellt.</span><span class="sxs-lookup"><span data-stu-id="b19bd-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="b19bd-109">Die Client Authentifizierung wird von einem Paar aus Benutzername und Kennwort in einem WS-Security-Header in der Nachricht bereitgestellt.</span><span class="sxs-lookup"><span data-stu-id="b19bd-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="b19bd-110">Purchaseorderclientusernameoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="b19bd-110">PurchaseOrderClientUserNameOverSsl.cpp</span></span>](#purchaseorderclientusernameoversslcpp)
-   [<span data-ttu-id="b19bd-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="b19bd-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="b19bd-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="b19bd-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderclientusernameoversslcpp"></a><span data-ttu-id="b19bd-113">Purchaseorderclientusernameoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="b19bd-113">PurchaseOrderClientUserNameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="b19bd-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="b19bd-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="b19bd-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="b19bd-115">Makefile</span></span>
