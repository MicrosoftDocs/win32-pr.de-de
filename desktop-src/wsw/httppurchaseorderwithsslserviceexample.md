...
---
# <a name="httppurchaseorderwithsslserviceexample"></a><span data-ttu-id="151a0-106">Httppurchaseorderwithsslserviceexample</span><span class="sxs-lookup"><span data-stu-id="151a0-106">HttpPurchaseOrderWithSslServiceExample</span></span>

<span data-ttu-id="151a0-107">In diesem Beispiel wird gezeigt, wie der Dienst Host zum Hosten eines PurchaseOrder-Diensts über HTTP mit SSL-Transportsicherheit verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="151a0-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with SSL transport security.</span></span>

-   [<span data-ttu-id="151a0-108">Httppurchaseorderservicewithssl. cpp</span><span class="sxs-lookup"><span data-stu-id="151a0-108">HttpPurchaseOrderServiceWithSsl.cpp</span></span>](#httppurchaseorderservicewithsslcpp)
-   [<span data-ttu-id="151a0-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="151a0-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="151a0-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="151a0-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderservicewithsslcpp"></a><span data-ttu-id="151a0-111">Httppurchaseorderservicewithssl. cpp</span><span class="sxs-lookup"><span data-stu-id="151a0-111">HttpPurchaseOrderServiceWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="151a0-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="151a0-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="151a0-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="151a0-113">Makefile</span></span>
