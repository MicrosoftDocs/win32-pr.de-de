...
description: In diesem Beispiel wird gezeigt, wie ein benutzerdefinierter Header hinzugefügt und abgerufen wird.
ms.assetid: 9c0cabee-4645-4b2d-a132-4494911f05b3
keywords:
- Customheaderexample-Webdienste für Windows
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106338620"
---
# <a name="customheaderexample"></a><span data-ttu-id="a93d0-106">Customheaderexample</span><span class="sxs-lookup"><span data-stu-id="a93d0-106">CustomHeaderExample</span></span>

<span data-ttu-id="a93d0-107">In diesem Beispiel wird gezeigt, wie ein benutzerdefinierter Header hinzugefügt und abgerufen wird.</span><span class="sxs-lookup"><span data-stu-id="a93d0-107">This example shows how to add and retrieve a custom header.</span></span>

-   [<span data-ttu-id="a93d0-108">CustomHeader. cpp</span><span class="sxs-lookup"><span data-stu-id="a93d0-108">CustomHeader.cpp</span></span>](#customheadercpp)
-   [<span data-ttu-id="a93d0-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="a93d0-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="a93d0-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="a93d0-110">Makefile</span></span>](#makefile)

## <a name="customheadercpp"></a><span data-ttu-id="a93d0-111">CustomHeader. cpp</span><span class="sxs-lookup"><span data-stu-id="a93d0-111">CustomHeader.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="a93d0-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="a93d0-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="a93d0-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="a93d0-113">Makefile</span></span>
