...
description: Dieses Beispiel veranschaulicht das Importieren von Metadaten von einem Endpunkt, der die WS \_ username \_ Message \_ Security \_ Binding mit WS \_ SSL- \_ Transport \_ \_ Sicherheitsbindung unterstützt.
ms.assetid: 1bce97e2-a841-4c4b-af5e-f747c3fb6e8d
keywords:
- MetadataImportWithUsernameOverSslExample Windows-Webdienste-API
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106338163"
---
# <a name="metadataimportwithusernameoversslexample"></a><span data-ttu-id="61847-106">MetadataImportWithUsernameOverSslExample</span><span class="sxs-lookup"><span data-stu-id="61847-106">MetadataImportWithUsernameOverSslExample</span></span>

<span data-ttu-id="61847-107">Dieses Beispiel veranschaulicht das Importieren von Metadaten von einem Endpunkt, der die [**WS \_ username \_ Message \_ Security \_ Binding**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) mit [**WS \_ SSL- \_ Transport \_ \_ Sicherheitsbindung**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)unterstützt.</span><span class="sxs-lookup"><span data-stu-id="61847-107">This example illustrates importing metadata from an endpoint that supports [**WS\_USERNAME\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span>

## <a name="metadataimportwithusernameoversslexamplecpp"></a><span data-ttu-id="61847-108">MetadataImportWithUsernameOverSslExample. cpp</span><span class="sxs-lookup"><span data-stu-id="61847-108">MetadataImportWithUsernameOverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="61847-109">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="61847-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="61847-110">**WS \_ username \_ Message- \_ Sicherheits \_ Bindung**</span><span class="sxs-lookup"><span data-stu-id="61847-110">**WS\_USERNAME\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding)
</dt> <dt>

[<span data-ttu-id="61847-111">**WS \_ SSL- \_ Transport \_ Sicherheits \_ Bindung**</span><span class="sxs-lookup"><span data-stu-id="61847-111">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> </dl>
