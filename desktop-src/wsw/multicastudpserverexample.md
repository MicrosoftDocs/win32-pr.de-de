...
description: Dieses Beispiel zeigt einen UDP-Server, der auf eine Multicast Adresse lauscht und auf Anforderungen antwortet, die an diese Adresse gesendet werden.
ms.assetid: 9688756b-3c5e-42ca-a9da-f258d4be2360
keywords:
- Multicastudpserverexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106340817"
---
# <a name="multicastudpserverexample"></a><span data-ttu-id="66058-106">Multicastudpserverexample</span><span class="sxs-lookup"><span data-stu-id="66058-106">MulticastUdpServerExample</span></span>

<span data-ttu-id="66058-107">Dieses Beispiel zeigt einen UDP-Server, der auf eine Multicast Adresse lauscht und auf Anforderungen antwortet, die an diese Adresse gesendet werden.</span><span class="sxs-lookup"><span data-stu-id="66058-107">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span>

-   [<span data-ttu-id="66058-108">Multicastudpserver. cpp</span><span class="sxs-lookup"><span data-stu-id="66058-108">MulticastUdpServer.cpp</span></span>](#multicastudpservercpp)
-   [<span data-ttu-id="66058-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="66058-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="66058-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="66058-110">Makefile</span></span>](#makefile)

## <a name="multicastudpservercpp"></a><span data-ttu-id="66058-111">Multicastudpserver. cpp</span><span class="sxs-lookup"><span data-stu-id="66058-111">MulticastUdpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="66058-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="66058-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="66058-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="66058-113">Makefile</span></span>
