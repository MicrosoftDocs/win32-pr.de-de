...
description: Dieses Beispiel zeigt einen UDP-Server, der einen Channel annimmt und unidirektionale Nachrichten empfängt.
ms.assetid: 45317e45-03d5-4d17-89cd-9108f81490ff
keywords:
- Onewayudpserverexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103713866"
---
# <a name="onewayudpserverexample"></a><span data-ttu-id="04999-106">Onewayudpserverexample</span><span class="sxs-lookup"><span data-stu-id="04999-106">OneWayUdpServerExample</span></span>

<span data-ttu-id="04999-107">Dieses Beispiel zeigt einen UDP-Server, der einen Channel annimmt und unidirektionale Nachrichten empfängt.</span><span class="sxs-lookup"><span data-stu-id="04999-107">This example shows a UDP server that accepts a channel and receives one-way messages.</span></span>

-   [<span data-ttu-id="04999-108">Onewayudpserver. cpp</span><span class="sxs-lookup"><span data-stu-id="04999-108">OneWayUdpServer.cpp</span></span>](#onewayudpservercpp)
-   [<span data-ttu-id="04999-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="04999-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="04999-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="04999-110">Makefile</span></span>](#makefile)

## <a name="onewayudpservercpp"></a><span data-ttu-id="04999-111">Onewayudpserver. cpp</span><span class="sxs-lookup"><span data-stu-id="04999-111">OneWayUdpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="04999-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="04999-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="04999-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="04999-113">Makefile</span></span>
