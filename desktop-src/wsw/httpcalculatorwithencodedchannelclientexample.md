...
description: In diesem Beispiel wird gezeigt, wie der Dienstproxy verwendet wird, um mit einem HTTP-basierten Rechnerdienst über einen benutzerdefinierten Kanal zu sprechen. Der Kanal verwendet einen benutzerdefinierten Encoder.
...
ms.locfileid: "119026518"
---
# <a name="httpcalculatorwithencodedchannelclientexample"></a>HttpCalculatorWithEncodedChannelClientExample

In diesem Beispiel wird gezeigt, wie der Dienstproxy verwendet wird, um mit einem HTTP-basierten Rechnerdienst über einen benutzerdefinierten Kanal zu sprechen. Der Kanal verwendet einen benutzerdefinierten Encoder.
