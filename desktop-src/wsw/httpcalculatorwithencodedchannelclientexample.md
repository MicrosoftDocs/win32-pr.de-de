---
title: Httpcalculatorwithencodecodchannelclieintexample
description: In diesem Beispiel wird gezeigt, wie der Dienst Proxy verwendet wird, um mit einem HTTP-basierten Rechner Dienst über einen benutzerdefinierten Kanal zu kommunizieren. Der Kanal verwendet einen benutzerdefinierten Encoder.
ms.assetid: cef3db1d-6362-4599-a4bf-f43079848691
keywords:
- Httpcalculatorwithencodecodchannelclieintexample Native-Web-Services
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103948081"
---
# <a name="httpcalculatorwithencodedchannelclientexample"></a><span data-ttu-id="db42e-107">Httpcalculatorwithencodecodchannelclieintexample</span><span class="sxs-lookup"><span data-stu-id="db42e-107">HttpCalculatorWithEncodedChannelClientExample</span></span>

<span data-ttu-id="db42e-108">In diesem Beispiel wird gezeigt, wie der Dienst Proxy verwendet wird, um mit einem HTTP-basierten Rechner Dienst über einen benutzerdefinierten Kanal zu kommunizieren.</span><span class="sxs-lookup"><span data-stu-id="db42e-108">This example show how to use the service proxy to talk to an HTTP based calculator service using a custom channel.</span></span> <span data-ttu-id="db42e-109">Der Kanal verwendet einen benutzerdefinierten Encoder.</span><span class="sxs-lookup"><span data-stu-id="db42e-109">The channel is uses a custom encoder.</span></span>

-   [<span data-ttu-id="db42e-110">Httpcalculatorwithencodedchannelclient. cpp</span><span class="sxs-lookup"><span data-stu-id="db42e-110">HttpCalculatorWithEncodedChannelClient.cpp</span></span>](#httpcalculatorwithencodedchannelclientcpp)
-   [<span data-ttu-id="db42e-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="db42e-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="db42e-112">Encodedchannel. cpp</span><span class="sxs-lookup"><span data-stu-id="db42e-112">EncodedChannel.cpp</span></span>](#encodedchannelcpp)
-   [<span data-ttu-id="db42e-113">Encodchannel. h</span><span class="sxs-lookup"><span data-stu-id="db42e-113">EncodedChannel.h</span></span>](#encodedchannelh)
-   [<span data-ttu-id="db42e-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="db42e-114">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithencodedchannelclientcpp"></a><span data-ttu-id="db42e-115">Httpcalculatorwithencodedchannelclient. cpp</span><span class="sxs-lookup"><span data-stu-id="db42e-115">HttpCalculatorWithEncodedChannelClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="db42e-116">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="db42e-116">CalculatorService.wsdl</span></span>
...
## <a name="encodedchannelcpp"></a><span data-ttu-id="db42e-117">Encodedchannel. cpp</span><span class="sxs-lookup"><span data-stu-id="db42e-117">EncodedChannel.cpp</span></span>
...
## <a name="encodedchannelh"></a><span data-ttu-id="db42e-118">Encodchannel. h</span><span class="sxs-lookup"><span data-stu-id="db42e-118">EncodedChannel.h</span></span>
...
## <a name="makefile"></a><span data-ttu-id="db42e-119">Makefile</span><span class="sxs-lookup"><span data-stu-id="db42e-119">Makefile</span></span>
