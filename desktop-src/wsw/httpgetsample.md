...
---
# <a name="httpgetsample"></a><span data-ttu-id="cb884-108">Httpgetsample</span><span class="sxs-lookup"><span data-stu-id="cb884-108">HttpGetSample</span></span>

<span data-ttu-id="cb884-109">In diesem Beispiel wird gezeigt, wie der Dienst Host zum Hosten eines PurchaseOrder-Diensts über HTTP verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="cb884-109">This example shows how to use service host for hosting a PurchaseOrder service over HTTP.</span></span> <span data-ttu-id="cb884-110">Der Dienst macht Metadaten über HTTP Get und WS-Metadata Exchange v 1.1 verfügbar.</span><span class="sxs-lookup"><span data-stu-id="cb884-110">The service exposes metadata over HTTP GET and WS-Metadata Exchange v1.1.</span></span> <span data-ttu-id="cb884-111">Der Dienst zeigt außerdem, wie eine Deckseite für einen wwsapi-Dienst implementiert wird.</span><span class="sxs-lookup"><span data-stu-id="cb884-111">The service also shows how to implement a cover page for a WWSAPI service.</span></span>

-   [<span data-ttu-id="cb884-112">Httpgetservice. cpp</span><span class="sxs-lookup"><span data-stu-id="cb884-112">HttpGetService.cpp</span></span>](#httpgetservicecpp)
-   [<span data-ttu-id="cb884-113">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="cb884-113">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="cb884-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="cb884-114">Makefile</span></span>](#makefile)

## <a name="httpgetservicecpp"></a><span data-ttu-id="cb884-115">Httpgetservice. cpp</span><span class="sxs-lookup"><span data-stu-id="cb884-115">HttpGetService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="cb884-116">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="cb884-116">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="cb884-117">Makefile</span><span class="sxs-lookup"><span data-stu-id="cb884-117">Makefile</span></span>
