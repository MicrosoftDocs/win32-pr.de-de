...
description: Dieses Beispiel zeigt einen Named Pipes-Client, der Anforderung-Antwort-Nachrichten mit Sicherheit sendet, die Windows SSPI-Transportsicherheit bereitgestellt wird. Es veranschaulicht den Client mithilfe von Sicherheitstokeneigenschaften, um die zulässige Identitätswechselebene von der Standardeinstellung zu ändern.
...
Dieses Beispiel zeigt einen Named Pipes-Client, der Anforderung-Antwort-Nachrichten mit Sicherheit sendet, die Windows SSPI-Transportsicherheit bereitgestellt wird. Es veranschaulicht den Client mithilfe von Sicherheitstokeneigenschaften, um die zulässige Identitätswechselebene von der Standardeinstellung zu ändern.
