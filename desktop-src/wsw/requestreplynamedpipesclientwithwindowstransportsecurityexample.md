...
description: Dieses Beispiel zeigt einen Named Pipes-Client, der Anforderung-Antwort-Nachrichten mit der von der Windows SSPI-Transportsicherheit bereitgestellten Sicherheit sendet. Es veranschaulicht den Client, der die sicherheitstokeneigenschaften verwendet, um die zulässige Identitätswechsel Ebene von der Standardeinstellung zu ändern.
...
ms.locfileid: "104515440"
---
# <a name="requestreplynamedpipesclientwithwindowstransportsecurityexample"></a><span data-ttu-id="c6b5c-104">Requestreplynamedpipesclientwithwindowstransportsecurityexample</span><span class="sxs-lookup"><span data-stu-id="c6b5c-104">RequestReplyNamedPipesClientWithWindowsTransportSecurityExample</span></span>

<span data-ttu-id="c6b5c-105">Dieses Beispiel zeigt einen Named Pipes-Client, der Anforderung-Antwort-Nachrichten mit der von der Windows SSPI-Transportsicherheit bereitgestellten Sicherheit sendet.</span><span class="sxs-lookup"><span data-stu-id="c6b5c-105">This example shows a named pipes client that sends request-reply messages with security provided by Windows SSPI transport security.</span></span> <span data-ttu-id="c6b5c-106">Es veranschaulicht den Client, der die sicherheitstokeneigenschaften verwendet, um die zulässige Identitätswechsel Ebene von der Standardeinstellung zu ändern.</span><span class="sxs-lookup"><span data-stu-id="c6b5c-106">It illustrates the client using security token properties to modify the allowed impersonation level from the default.</span></span>

-   [<span data-ttu-id="c6b5c-107">Requestreplynamedpipesclientwithwindowstransportsecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="c6b5c-107">RequestReplyNamedPipesClientWithWindowsTransportSecurity.cpp</span></span>](#requestreplynamedpipesclientwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="c6b5c-108">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="c6b5c-108">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="c6b5c-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="c6b5c-109">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesclientwithwindowstransportsecuritycpp"></a><span data-ttu-id="c6b5c-110">Requestreplynamedpipesclientwithwindowstransportsecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="c6b5c-110">RequestReplyNamedPipesClientWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="c6b5c-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="c6b5c-111">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="c6b5c-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="c6b5c-112">Makefile</span></span>
