...
---
# <a name="httpcustomheaderpurchaseorderclientexample"></a><span data-ttu-id="e3313-106">Httpcustomheaderpurchaseordercliumtexample</span><span class="sxs-lookup"><span data-stu-id="e3313-106">HttpCustomHeaderPurchaseOrderClientExample</span></span>

<span data-ttu-id="e3313-107">In diesem Beispiel wird gezeigt, wie benutzerdefinierte Header mit dem Dienst Proxy verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="e3313-107">This examples shows how to use custom headers with service proxy.</span></span>

-   [<span data-ttu-id="e3313-108">Httpcustomheaderclient. cpp</span><span class="sxs-lookup"><span data-stu-id="e3313-108">HttpCustomHeaderClient.cpp</span></span>](#httpcustomheaderclientcpp)
-   [<span data-ttu-id="e3313-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="e3313-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="e3313-110">Ordersessionheader. xsd</span><span class="sxs-lookup"><span data-stu-id="e3313-110">OrderSessionHeader.xsd</span></span>](#ordersessionheaderxsd)
-   [<span data-ttu-id="e3313-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="e3313-111">Makefile</span></span>](#makefile)

## <a name="httpcustomheaderclientcpp"></a><span data-ttu-id="e3313-112">Httpcustomheaderclient. cpp</span><span class="sxs-lookup"><span data-stu-id="e3313-112">HttpCustomHeaderClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="e3313-113">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="e3313-113">PurchaseOrder.wsdl</span></span>
...
## <a name="ordersessionheaderxsd"></a><span data-ttu-id="e3313-114">Ordersessionheader. xsd</span><span class="sxs-lookup"><span data-stu-id="e3313-114">OrderSessionHeader.xsd</span></span>
...
## <a name="makefile"></a><span data-ttu-id="e3313-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="e3313-115">Makefile</span></span>
