...
---
# <a name="requestreplynamedpipesclientexample"></a><span data-ttu-id="09c02-103">Requestreplynamedpipesclieintexample</span><span class="sxs-lookup"><span data-stu-id="09c02-103">RequestReplyNamedPipesClientExample</span></span>

<span data-ttu-id="09c02-104">Dieses Beispiel zeigt einen Named Pipe Client, der Anforderungs-Antwort-Nachrichten sendet.</span><span class="sxs-lookup"><span data-stu-id="09c02-104">This example shows a named pipe client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="09c02-105">Requestreplynamedpipesclient. cpp</span><span class="sxs-lookup"><span data-stu-id="09c02-105">RequestReplyNamedPipesClient.cpp</span></span>](#requestreplynamedpipesclientcpp)
-   [<span data-ttu-id="09c02-106">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="09c02-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="09c02-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="09c02-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesclientcpp"></a><span data-ttu-id="09c02-108">Requestreplynamedpipesclient. cpp</span><span class="sxs-lookup"><span data-stu-id="09c02-108">RequestReplyNamedPipesClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="09c02-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="09c02-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="09c02-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="09c02-110">Makefile</span></span>
