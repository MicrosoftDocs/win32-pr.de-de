...
---
# <a name="sessionfullcalculatorserviceexample"></a><span data-ttu-id="00fb8-106">Sessionfullcalculatorserviceexample</span><span class="sxs-lookup"><span data-stu-id="00fb8-106">SessionfullCalculatorServiceExample</span></span>

<span data-ttu-id="00fb8-107">Eine Implementierung eines Sitzungs basierten Rechner Diensts, der den Dienst Host verwendet.</span><span class="sxs-lookup"><span data-stu-id="00fb8-107">An implementation of a sessionful calculator service using the Service Host.</span></span>

-   [<span data-ttu-id="00fb8-108">Sessionfullcalculatorservice. cpp</span><span class="sxs-lookup"><span data-stu-id="00fb8-108">SessionfullCalculatorService.cpp</span></span>](#sessionfullcalculatorservicecpp)
-   [<span data-ttu-id="00fb8-109">Sessionbasedcalculatorservice. WSDL</span><span class="sxs-lookup"><span data-stu-id="00fb8-109">SessionBasedCalculatorService.wsdl</span></span>](#sessionbasedcalculatorservicewsdl)
-   [<span data-ttu-id="00fb8-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="00fb8-110">Makefile</span></span>](#makefile)

## <a name="sessionfullcalculatorservicecpp"></a><span data-ttu-id="00fb8-111">Sessionfullcalculatorservice. cpp</span><span class="sxs-lookup"><span data-stu-id="00fb8-111">SessionfullCalculatorService.cpp</span></span>
...
## <a name="sessionbasedcalculatorservicewsdl"></a><span data-ttu-id="00fb8-112">Sessionbasedcalculatorservice. WSDL</span><span class="sxs-lookup"><span data-stu-id="00fb8-112">SessionBasedCalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="00fb8-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="00fb8-113">Makefile</span></span>
