---
title: Callabandon-Beispiel
description: Beispiel Client Anwendung, die das Abbrechen eines Aufrufes veranschaulicht
ms.assetid: 71253dd6-4f59-4acd-b244-c721834ca381
keywords:
- Callabandonexample (Native Webdienste)
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104388288"
---
# <a name="callabandonexample"></a><span data-ttu-id="d4ee3-106">Callabandon-Beispiel</span><span class="sxs-lookup"><span data-stu-id="d4ee3-106">CallAbandonExample</span></span>

<span data-ttu-id="d4ee3-107">Beispiel Client Anwendung, die das Abbrechen eines Aufrufes veranschaulicht</span><span class="sxs-lookup"><span data-stu-id="d4ee3-107">Example client application demonstrating abandoning a call.</span></span>

-   [<span data-ttu-id="d4ee3-108">Abandoncallclient. cpp</span><span class="sxs-lookup"><span data-stu-id="d4ee3-108">AbandonCallClient.cpp</span></span>](#abandoncallclientcpp)
-   [<span data-ttu-id="d4ee3-109">Blockunblockservice. WSDL</span><span class="sxs-lookup"><span data-stu-id="d4ee3-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="d4ee3-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="d4ee3-110">Makefile</span></span>](#makefile)

## <a name="abandoncallclientcpp"></a><span data-ttu-id="d4ee3-111">Abandoncallclient. cpp</span><span class="sxs-lookup"><span data-stu-id="d4ee3-111">AbandonCallClient.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="d4ee3-112">Blockunblockservice. WSDL</span><span class="sxs-lookup"><span data-stu-id="d4ee3-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d4ee3-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="d4ee3-113">Makefile</span></span>
