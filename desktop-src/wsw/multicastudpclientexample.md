---
title: Multicastudpcliumtexample
description: Dieses Beispiel zeigt einen UDP-Client, der eine Anforderung multiumwandelt und dann auf Antwort Nachrichten von Servern wartet.
ms.assetid: 61ca7e05-1a60-43b2-9ff7-cb355fae2f77
keywords:
- Multicastudpclieintexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104206436"
---
# <a name="multicastudpclientexample"></a><span data-ttu-id="cb435-106">Multicastudpcliumtexample</span><span class="sxs-lookup"><span data-stu-id="cb435-106">MulticastUdpClientExample</span></span>

<span data-ttu-id="cb435-107">Dieses Beispiel zeigt einen UDP-Client, der eine Anforderung multiumwandelt und dann auf Antwort Nachrichten von Servern wartet.</span><span class="sxs-lookup"><span data-stu-id="cb435-107">This example shows a UDP client that multicasts a request and then waits for reply messages from servers.</span></span>

-   [<span data-ttu-id="cb435-108">Multicastudpclient. cpp</span><span class="sxs-lookup"><span data-stu-id="cb435-108">MulticastUdpClient.cpp</span></span>](#multicastudpclientcpp)
-   [<span data-ttu-id="cb435-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="cb435-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="cb435-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="cb435-110">Makefile</span></span>](#makefile)

## <a name="multicastudpclientcpp"></a><span data-ttu-id="cb435-111">Multicastudpclient. cpp</span><span class="sxs-lookup"><span data-stu-id="cb435-111">MulticastUdpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="cb435-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="cb435-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="cb435-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="cb435-113">Makefile</span></span>
