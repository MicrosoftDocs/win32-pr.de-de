...
---
# <a name="multicastudpclientexample"></a>Multicastudpcliumtexample

Dieses Beispiel zeigt einen UDP-Client, der eine Anforderung multiumwandelt und dann auf Antwort Nachrichten von Servern wartet.
