...
---
# <a name="httpserverwithkerberosoversslexample"></a><span data-ttu-id="069cb-106">Httpserverwithkerberosoversslexample</span><span class="sxs-lookup"><span data-stu-id="069cb-106">HttpServerWithKerberosOverSslExample</span></span>

<span data-ttu-id="069cb-107">Dieses Beispiel zeigt einen TCP-Server, der einen Kanal akzeptiert und Nachrichten empfängt und mit Kerberos über SSL-Sicherheit im gemischten Modus antwortet.</span><span class="sxs-lookup"><span data-stu-id="069cb-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="069cb-108">In diesem Setup wird die Transport Verbindung von SSL geschützt (signiert, verschlüsselt), der auch die Server Authentifizierung bereitstellt.</span><span class="sxs-lookup"><span data-stu-id="069cb-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="069cb-109">Die Client Authentifizierung wird von einem Kerberos apreq-Ticket in einem WS-Security-Header in der Nachricht bereitgestellt.</span><span class="sxs-lookup"><span data-stu-id="069cb-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="069cb-110">Httpserverwithkerberosoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="069cb-110">HttpServerWithKerberosOverSsl.cpp</span></span>](#httpserverwithkerberosoversslcpp)
-   [<span data-ttu-id="069cb-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="069cb-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="069cb-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="069cb-112">Makefile</span></span>](#makefile)

## <a name="httpserverwithkerberosoversslcpp"></a><span data-ttu-id="069cb-113">Httpserverwithkerberosoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="069cb-113">HttpServerWithKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="069cb-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="069cb-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="069cb-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="069cb-115">Makefile</span></span>
