...
---
# <a name="streaminghttpclientexample"></a><span data-ttu-id="06a17-106">Streaminghttpcliumtexample</span><span class="sxs-lookup"><span data-stu-id="06a17-106">StreamingHttpClientExample</span></span>

<span data-ttu-id="06a17-107">Dieses Beispiel zeigt einen HTTP-Client, der die Anforderung/Antwort mithilfe der Streaming-APIs durchführt.</span><span class="sxs-lookup"><span data-stu-id="06a17-107">This example shows an HTTP client that does request-reply using the streaming APIs.</span></span>

-   [<span data-ttu-id="06a17-108">Streaminghttpclient. cpp</span><span class="sxs-lookup"><span data-stu-id="06a17-108">StreamingHttpClient.cpp</span></span>](#streaminghttpclientcpp)
-   [<span data-ttu-id="06a17-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="06a17-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="06a17-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="06a17-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpclientcpp"></a><span data-ttu-id="06a17-111">Streaminghttpclient. cpp</span><span class="sxs-lookup"><span data-stu-id="06a17-111">StreamingHttpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="06a17-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="06a17-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="06a17-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="06a17-113">Makefile</span></span>
