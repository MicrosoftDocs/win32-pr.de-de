---
title: Requestreplytcpcliumtexample
description: Dieses Beispiel zeigt einen TCP-Client, der Anforderungs-Antwort-Nachrichten sendet.
ms.assetid: 0d9b9581-3563-4fce-8790-af7ebb9e8175
keywords:
- Requestreplytcpclieintexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103707236"
---
# <a name="requestreplytcpclientexample"></a><span data-ttu-id="f35fc-106">Requestreplytcpcliumtexample</span><span class="sxs-lookup"><span data-stu-id="f35fc-106">RequestReplyTcpClientExample</span></span>

<span data-ttu-id="f35fc-107">Dieses Beispiel zeigt einen TCP-Client, der Anforderungs-Antwort-Nachrichten sendet.</span><span class="sxs-lookup"><span data-stu-id="f35fc-107">This example shows a TCP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="f35fc-108">Requestreplytcpclient. cpp</span><span class="sxs-lookup"><span data-stu-id="f35fc-108">RequestReplyTcpClient.cpp</span></span>](#requestreplytcpclientcpp)
-   [<span data-ttu-id="f35fc-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="f35fc-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="f35fc-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="f35fc-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpclientcpp"></a><span data-ttu-id="f35fc-111">Requestreplytcpclient. cpp</span><span class="sxs-lookup"><span data-stu-id="f35fc-111">RequestReplyTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="f35fc-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="f35fc-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f35fc-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="f35fc-113">Makefile</span></span>
