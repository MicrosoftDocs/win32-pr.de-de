...
---
# <a name="onewaytcpserverexample"></a><span data-ttu-id="4dabd-106">Onewaytcpserverexample</span><span class="sxs-lookup"><span data-stu-id="4dabd-106">OneWayTcpServerExample</span></span>

<span data-ttu-id="4dabd-107">Dieses Beispiel zeigt einen TCP-Server, der einen Channel annimmt und unidirektionale Nachrichten empfängt.</span><span class="sxs-lookup"><span data-stu-id="4dabd-107">This example shows a TCP server that accepts a channel and receives one-way messages.</span></span>

-   [<span data-ttu-id="4dabd-108">Onewaytcpserver. cpp</span><span class="sxs-lookup"><span data-stu-id="4dabd-108">OneWayTcpServer.cpp</span></span>](#onewaytcpservercpp)
-   [<span data-ttu-id="4dabd-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="4dabd-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="4dabd-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="4dabd-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpservercpp"></a><span data-ttu-id="4dabd-111">Onewaytcpserver. cpp</span><span class="sxs-lookup"><span data-stu-id="4dabd-111">OneWayTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="4dabd-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="4dabd-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="4dabd-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="4dabd-113">Makefile</span></span>
