...
description: Dieses Beispiel zeigt einen Named Pipes-Server, der einen Kanal akzeptiert und Nachrichten empfängt und darauf antwortet.
...
ms.locfileid: "103707241"
---
# <a name="requestreplynamedpipesserverexample"></a><span data-ttu-id="965cf-103">Requestreplynamedpipesserverexample</span><span class="sxs-lookup"><span data-stu-id="965cf-103">RequestReplyNamedPipesServerExample</span></span>

<span data-ttu-id="965cf-104">Dieses Beispiel zeigt einen Named Pipes-Server, der einen Kanal akzeptiert und Nachrichten empfängt und darauf antwortet.</span><span class="sxs-lookup"><span data-stu-id="965cf-104">This example shows a named pipes server that accepts a channel and receives and replies to messages.</span></span>

-   [<span data-ttu-id="965cf-105">Requestreplynamedpipesserver. cpp</span><span class="sxs-lookup"><span data-stu-id="965cf-105">RequestReplyNamedPipesServer.cpp</span></span>](#requestreplynamedpipesservercpp)
-   [<span data-ttu-id="965cf-106">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="965cf-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="965cf-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="965cf-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesservercpp"></a><span data-ttu-id="965cf-108">Requestreplynamedpipesserver. cpp</span><span class="sxs-lookup"><span data-stu-id="965cf-108">RequestReplyNamedPipesServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="965cf-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="965cf-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="965cf-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="965cf-110">Makefile</span></span>
