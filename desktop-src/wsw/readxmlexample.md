---
title: Read xmlexample
description: Dieses Beispiel liest den XML-Knoten nach Knoten.
ms.assetid: 938825f6-43dd-4e24-a04d-c46290509a64
keywords:
- Read xmlexample-Webdienste für Windows
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104206218"
---
# <a name="readxmlexample"></a><span data-ttu-id="aae82-106">Read xmlexample</span><span class="sxs-lookup"><span data-stu-id="aae82-106">ReadXmlExample</span></span>

<span data-ttu-id="aae82-107">Dieses Beispiel liest den XML-Knoten nach Knoten.</span><span class="sxs-lookup"><span data-stu-id="aae82-107">This example reads XML node by node.</span></span>

## <a name="readxmlcpp"></a><span data-ttu-id="aae82-108">"Read XML. cpp"</span><span class="sxs-lookup"><span data-stu-id="aae82-108">ReadXml.cpp</span></span>
