...
description: Dieses Beispiel zeigt einen TCP-Server, der einen Channel annimmt und Nachrichten mit SSL-Transportsicherheit empfängt und antwortet.
ms.assetid: 627b6ba8-3bb2-41f3-a456-a811eb3b8e3d
keywords:
- Httpserverwithsslexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104311280"
---
# <a name="httpserverwithsslexample"></a><span data-ttu-id="18873-106">Httpserverwithsslexample</span><span class="sxs-lookup"><span data-stu-id="18873-106">HttpServerWithSslExample</span></span>

<span data-ttu-id="18873-107">Dieses Beispiel zeigt einen TCP-Server, der einen Channel annimmt und Nachrichten mit SSL-Transportsicherheit empfängt und antwortet.</span><span class="sxs-lookup"><span data-stu-id="18873-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with SSL transport security.</span></span>

-   [<span data-ttu-id="18873-108">Httpserverwithssl. cpp</span><span class="sxs-lookup"><span data-stu-id="18873-108">HttpServerWithSsl.cpp</span></span>](#httpserverwithsslcpp)
-   [<span data-ttu-id="18873-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="18873-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="18873-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="18873-110">Makefile</span></span>](#makefile)

## <a name="httpserverwithsslcpp"></a><span data-ttu-id="18873-111">Httpserverwithssl. cpp</span><span class="sxs-lookup"><span data-stu-id="18873-111">HttpServerWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="18873-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="18873-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="18873-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="18873-113">Makefile</span></span>
