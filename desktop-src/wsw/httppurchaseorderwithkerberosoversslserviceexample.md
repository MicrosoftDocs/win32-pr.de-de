...
description: In diesem Beispiel wird gezeigt, wie der Dienst Host zum Hosten eines PurchaseOrder-Diensts über HTTP mit Kerberos über SSL-Sicherheit im gemischten Modus verwendet wird.
ms.assetid: 9fbf5577-6a54-4ce1-ad44-80b9ee91c0d3
keywords:
- Httppurchaseorderwithkerberosoversslserviceexample Native Webdienste
- Wwsapi
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106337997"
---
# <a name="httppurchaseorderwithkerberosoversslserviceexample"></a><span data-ttu-id="7d4a3-106">Httppurchaseorderwithkerberosoversslserviceexample</span><span class="sxs-lookup"><span data-stu-id="7d4a3-106">HttpPurchaseOrderWithKerberosOverSslServiceExample</span></span>

<span data-ttu-id="7d4a3-107">In diesem Beispiel wird gezeigt, wie der Dienst Host zum Hosten eines PurchaseOrder-Diensts über HTTP mit Kerberos über SSL-Sicherheit im gemischten Modus verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="7d4a3-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="7d4a3-108">In diesem Setup wird die Transport Verbindung von SSL geschützt (signiert, verschlüsselt), der auch die Server Authentifizierung bereitstellt.</span><span class="sxs-lookup"><span data-stu-id="7d4a3-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="7d4a3-109">Die Client Authentifizierung wird von einem Kerberos apreq-Ticket in einem WS-Security-Header in der Nachricht bereitgestellt.</span><span class="sxs-lookup"><span data-stu-id="7d4a3-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="7d4a3-110">Purchaseorderservicekerberosoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="7d4a3-110">PurchaseOrderServiceKerberosOverSsl.cpp</span></span>](#purchaseorderservicekerberosoversslcpp)
-   [<span data-ttu-id="7d4a3-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7d4a3-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="7d4a3-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="7d4a3-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderservicekerberosoversslcpp"></a><span data-ttu-id="7d4a3-113">Purchaseorderservicekerberosoverssl. cpp</span><span class="sxs-lookup"><span data-stu-id="7d4a3-113">PurchaseOrderServiceKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="7d4a3-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7d4a3-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="7d4a3-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="7d4a3-115">Makefile</span></span>
