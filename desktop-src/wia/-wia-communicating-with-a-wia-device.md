---
description: Wenn ein Thread aktiv mit einem WIA-Gerät (Windows Image Acquisition) kommuniziert (z. B. Übertragen von Daten oder Schreiben von Geräteeigenschaften &), sperrt&\# \# 0034; das Gerät.
