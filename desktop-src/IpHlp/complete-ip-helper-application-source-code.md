...
---
# <a name="complete-ip-helper-application-source-code"></a><span data-ttu-id="7b49e-104">Vollständiger IP-hilfsanwendungs-Quellcode</span><span class="sxs-lookup"><span data-stu-id="7b49e-104">Complete IP Helper Application Source Code</span></span>

<span data-ttu-id="7b49e-105">Im folgenden finden Sie den gesamten Quellcode für die IP-Hilfsanwendung.</span><span class="sxs-lookup"><span data-stu-id="7b49e-105">The following is the complete source code for the IP Helper application.</span></span> <span data-ttu-id="7b49e-106">Zusätzliche Fehlerüberprüfung wurde dem Quellcode hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="7b49e-106">Additional error checking has been added to source code.</span></span>
