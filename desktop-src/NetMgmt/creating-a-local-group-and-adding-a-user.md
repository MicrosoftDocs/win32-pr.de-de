---
title: Erstellen einer lokalen Gruppe und Hinzufügen eines Benutzers
description: Rufen Sie zum Erstellen einer neuen lokalen Gruppe die NetLocalGroupAdd-Funktion auf. Wenn Sie dieser Gruppe einen Benutzer hinzufügen möchten, können Sie die NetLocalGroupAddMembers-Funktion aufrufen.
...
ms.locfileid: "103947747"
---
# <a name="creating-a-local-group-and-adding-a-user"></a><span data-ttu-id="6b716-104">Erstellen einer lokalen Gruppe und Hinzufügen eines Benutzers</span><span class="sxs-lookup"><span data-stu-id="6b716-104">Creating a Local Group and Adding a User</span></span>

<span data-ttu-id="6b716-105">Rufen Sie zum Erstellen einer neuen lokalen Gruppe die [**NetLocalGroupAdd**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupadd) -Funktion auf.</span><span class="sxs-lookup"><span data-stu-id="6b716-105">To create a new local group, call the [**NetLocalGroupAdd**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupadd) function.</span></span> <span data-ttu-id="6b716-106">Wenn Sie dieser Gruppe einen Benutzer hinzufügen möchten, können Sie die [**NetLocalGroupAddMembers**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupaddmembers) -Funktion aufrufen.</span><span class="sxs-lookup"><span data-stu-id="6b716-106">To add a user to that group, call the [**NetLocalGroupAddMembers**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupaddmembers) function.</span></span>

<span data-ttu-id="6b716-107">Mit dem folgenden Programm können Sie einen Benutzer und eine lokale Gruppe erstellen und den Benutzer der lokalen Gruppe hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="6b716-107">The following program allows you to create a user and a local group and add the user to the local group.</span></span>
