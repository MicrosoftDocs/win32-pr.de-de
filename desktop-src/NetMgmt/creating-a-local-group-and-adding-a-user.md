...
---
# <a name="creating-a-local-group-and-adding-a-user"></a>Erstellen einer lokalen Gruppe und Hinzufügen eines Benutzers

Rufen Sie zum Erstellen einer neuen lokalen Gruppe die [**NetLocalGroupAdd**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupadd) -Funktion auf. Wenn Sie dieser Gruppe einen Benutzer hinzufügen möchten, können Sie die [**NetLocalGroupAddMembers**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupaddmembers) -Funktion aufrufen.

Mit dem folgenden Programm können Sie einen Benutzer und eine lokale Gruppe erstellen und den Benutzer der lokalen Gruppe hinzufügen.
