...
*textureid*   
Die ID der Textur, für die der Slice geladen werden soll.

*slicabdex*   
Der Index des zu ladenden Slice.

*formatoverride*   
Gibt das Format Überschreibung an.

*histogrammdatafilename*   
Eine com-Zeichenfolge mit dem Namen der histogrammdatendatei, die dem Textur Slice zugeordnet ist.
