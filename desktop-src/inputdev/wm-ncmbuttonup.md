...
---
# <a name="wm_ncmbuttonup-message"></a>WM- \_ ncmbuttonup-Meldung

Wird gesendet, wenn der Benutzer die mittlere Maustaste loslässt, während sich der Cursor im nicht-Client Bereich eines Fensters befindet. Diese Meldung wird an das Fenster gesendet, das den Cursor enthält. Wenn ein Fenster die Maus erfasst hat, wird diese Meldung nicht gepostet.
