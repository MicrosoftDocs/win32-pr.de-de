...
---
# <a name="wm_lbuttonup-message"></a>WM- \_ lbuttonup-Meldung

Wird gesendet, wenn der Benutzer die linke Maustaste loslässt, während sich der Cursor im Client Bereich eines Fensters befindet. Wenn die Maus nicht erfasst wird, wird die Nachricht im Fenster unterhalb des Cursors gepostet. Andernfalls wird die Nachricht an das Fenster gesendet, das die Maus erfasst hat.
