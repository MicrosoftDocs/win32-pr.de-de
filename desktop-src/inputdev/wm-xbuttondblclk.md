...
Nur Fenster im **CS \_ DBLCLKS-Stil** können **WM \_ XBUTTONDBLCLK-Meldungen** empfangen, die das System generiert, wenn der Benutzer eine X-Taste innerhalb des Zeitlimits für Doppelklicken drückt, loslässt und erneut drückt. Wenn Sie auf eine dieser Schaltflächen doppelklicken, werden tatsächlich vier Meldungen generiert: [**WM \_ XBUTTONDOWN,**](wm-xbuttondown.md) [**WM \_ XBUTTONUP,**](wm-xbuttonup.md) **WM \_ XBUTTONDBLCLK** und **WM \_ XBUTTONUP.**
