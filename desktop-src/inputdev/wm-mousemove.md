...
---
# <a name="wm_mousemove-message"></a>WM- \_ mouseelverschiebungs Meldung

Wird an ein Fenster gesendet, wenn der Cursor verschoben wird. Wenn die Maus nicht erfasst wird, wird die Meldung an das Fenster gesendet, das den Cursor enthält. Andernfalls wird die Nachricht an das Fenster gesendet, das die Maus erfasst hat.
