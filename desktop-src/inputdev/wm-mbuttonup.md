---
title: WM_MBUTTONUP (Winuser.h)
description: Wird veröffentlicht, wenn der Benutzer die mittlere Maustaste loslässt, während sich der Cursor im Clientbereich eines Fensters befindet.
ms.assetid: fb8dee71-11bd-4405-855d-a5d120442271
keywords:
- WM_MBUTTONUP der Tastatur- und Mauseingabe
topic_type:
- apiref
api_name:
- WM_MBUTTONUP
...
ms.locfileid: "119451540"
---
# <a name="wm_mbuttonup-message"></a>WM \_ MBUTTONUP-Meldung

Wird veröffentlicht, wenn der Benutzer die mittlere Maustaste loslässt, während sich der Cursor im Clientbereich eines Fensters befindet. Wenn die Maus nicht erfasst wird, wird die Nachricht an das Fenster unter dem Cursor gesendet. Andernfalls wird die Nachricht an das Fenster gesendet, in dem die Maus erfasst wurde.
...
Beachten Sie, dass koordinaten relativ zum Bildschirm und nicht zum Clientbereich sind, wenn ein Kontextmenü vorhanden (angezeigt) ist. Da [**TrackPopupMenu**](/windows/desktop/api/winuser/nf-winuser-trackpopupmenu) ein asynchroner Aufruf ist und die **WM \_ MBUTTONUP-Benachrichtigung** kein spezielles Flag enthält, das die Koordinatenableitung angibt, kann eine Anwendung nicht erkennen, ob die x,y-Koordinaten in *lParam* relativ zum Bildschirm oder clientbereich sind.
