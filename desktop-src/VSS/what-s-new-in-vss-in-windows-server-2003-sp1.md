...
title: Neues in VSS in Windows Server 2003 SP1
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="whats-new-in-vss-in-windows-server-2003-sp1"></a>Neues in VSS in Windows Server 2003 SP1
...
[*Die automatische Wiederherstellung*](vssgloss-a.md) ermöglicht Es Writern, Komponenten in einer Schattenkopie zu aktualisieren, bevor die Schattenkopie dauerhaft in schreibgeschützt geändert wird. Beispielsweise muss eine Datenbank möglicherweise für alle unvollständigen Transaktionen für alle Schattenkopien ein Rollback durchführen (der Datenbankwriter würde das **VSS \_ CF BACKUP \_ \_ RECOVERY-Flag** für die Datenbankkomponenten festlegen). Die vom Anfordernden initiierte automatische Wiederherstellung ermöglicht sowohl eine detaillierte Wiederherstellung (z. B. das Wiederherstellen einer Tabelle in einer Datenbank oder eines Ordners auf einem E-Mail-Server) als auch das Rollback zur Unterstützung von Data Mining, um Analysen durchzuführen, die für einen Produktionsserver zu langsam wären (der Anfordernde würde **VSS \_ VOLSNAP \_ ATTR \_ ROLLBACK \_ RECOVERY** zum Schattenkopiekontext hinzufügen). Die automatische Wiederherstellung ist nicht mit transportierbaren Schattenkopien kompatibel, aber die gleiche Funktionalität wird durch die Verwendung der schnellen Wiederherstellung mithilfe [transportierbarer Schattenkopievolumes unterstützt.](fast-recovery-using-transportable-shadow-copied-volumes.md)

Die folgenden Programmierelemente haben Änderungen, um die automatische Wiederherstellung zu unterstützen:
...
## <a name="shadow-copy-storage-area-management"></a>Schattenkopie-Speicherbereichsverwaltung
