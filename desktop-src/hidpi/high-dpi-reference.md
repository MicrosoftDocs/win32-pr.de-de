...
| Thema                                                                                         |Beschreibung                                                                                                                                                                   |
|------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**AdjustWindowRectExForDpi**](/windows/desktop/api/Winuser/nf-winuser-adjustwindowrectexfordpi)                             | Eine Variante von [AdjustWindowRectEx,](/windows/desktop/api/winuser/nf-winuser-adjustwindowrectex) die Werte zurückgibt, die auf einen bestimmten DPI skaliert wurden.       |
...
| [**EnableNonClientDpiScaling**](/windows/desktop/api/Winuser/nf-winuser-enablenonclientdpiscaling)                           | Aktiviert die automatische Skalierung des Nicht-Clientbereichs des angegebenen Fensters der obersten Ebene.                                                                               |
| [**GetAwarenessFromDpiAwarenessContext**](/windows/desktop/api/Winuser/nf-winuser-getawarenessfromdpiawarenesscontext)       | Ruft den [**DPI \_ AWARENESS-Wert**](/windows/desktop/api/windef/ne-windef-dpi_awareness) aus einem [**DPI \_ AWARENESS \_ CONTEXT**](dpi-awareness-context.md) ab.                                       |
...
| [**GetDpiForWindow**](/windows/desktop/api/Winuser/nf-winuser-getdpiforwindow)                                               | Gibt den aktuellen DPI für das angegebene Fenster zurück.                                                                                                                 |
...
| [**SetDialogDpiChangeBehavior**](/windows/desktop/api/winuser/nf-winuser-setdialogdpichangebehavior)                         | Überschreibt das standardmäßige DPI-Skalierungsverhalten pro Monitor eines Dialogs.                                                                                               |
| [**GetDialogDpiChangeBehavior**](/windows/desktop/api/winuser/nf-winuser-getdialogdpichangebehavior)                         | Ruft das Monitor-DPI-Skalierungsverhalten eines Dialogs ab.                                                                                                       |
...
| [**GetDialogControlDpiChangeBehavior**](/windows/desktop/api/winuser/nf-winuser-getdialogcontroldpichangebehavior)                     | Ruft alle Monitor-DPI-Skalierungsverhaltensüberschreibungen eines untergeordneten Fensters in einem Dialogfeld ab.                                                                           |
...
| [**SetThreadDpiHostingBehavior**](/windows/desktop/api/winuser/nf-winuser-setthreaddpihostingbehavior)                       | Überschreibt das Standard-DPI-Hostingverhalten des aktuellen Threads.                                                                                                 |
...
| Thema                                                                           |Beschreibung                                                                                        |
|----------------------------------------------------------------------------|----------------------------------------------------------------------------------------|
| [**\_DPI-KENNTNIS**](/windows/desktop/api/windef/ne-windef-dpi_awareness)                                    | Stellt DPI-Koordinatenvirtualisierungsmodi dar.                                        |
