...
Stellt einen Non-Uniform Memory Access (NUMA)-Knoten eines virtuellen Systems dar.
...
Die **MSVM- \_ numanode** -Klasse verfügt über diese Typen von Membern:
...
Die Anzahl der Speicherblöcke, die derzeit für die Verwendung durch virtuelle Maschinen verfügbar sind.
...
Die Gesamtanzahl der logischen Prozessorkerne in diesem Knoten.
...
Die Gesamtanzahl der Prozessorkerne in diesem NUMA-Knoten. Dies kann sich von der Anzahl der [**MSVM- \_ Prozessor**](msvm-processor.md) Objekte unterscheiden, die diesem Knoten zugeordnet sind, wenn die einzelnen Prozessorkerne mehrere computethreads unterstützen.
