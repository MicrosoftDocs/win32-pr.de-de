...
Die **Msvm \_ SCSIProtocolController-Klasse** verfügt über die folgenden Membertypen:
...
| [**RequestStateChange**](msvm-scsiprotocolcontroller-requeststatechange.md) | Fordert eine Zustandsänderung an.<br/>      |
...
Die maximale Anzahl von Einheiten, die von diesem Protokollcontroller gesteuert werden können oder auf die über diesen Protokollcontroller zugegriffen werden kann. Diese Eigenschaft wird von [**CIM \_ ProtocolController**](/previous-versions/windows/desktop/iscsitarg/cim-protocolcontroller)geerbt.
...
Gibt an, wie der Name des SCSI-Protokollcontrollers ausgewählt wird. Diese Eigenschaft wird von [**CIM \_ SCSIProtocolController**](/previous-versions/windows/desktop/iscsitarg/cim-protocolcontroller)geerbt.
...
Eine Zeichenfolge, die beschreibt, wie der Protokollcontroller identifiziert wird, wenn **nameFormat** 1 (Other) ist. Diese Eigenschaft wird von [**CIM \_ SCSIProtocolController**](/previous-versions/windows/desktop/iscsitarg/cim-protocolcontroller)geerbt.
