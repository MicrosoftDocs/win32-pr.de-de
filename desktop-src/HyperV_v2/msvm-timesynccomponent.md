...
Stellt den Status des Zeit Synchronisierungs dienstanens dar, der für die Synchronisierung der Systemzeit eines virtuellen Computers mit der Systemzeit des Betriebssystems im Verwaltungs Betriebssystem zuständig ist.
...
Die **MSVM \_ timesynccomponent** -Klasse verfügt über diese Typen von Membern:
...
| [**RequestStateChange**](msvm-timesynccomponent-requeststatechange.md) | Fordert eine Statusänderung an.<br/>      |
...
Eine Adresse oder andere identifizierende Informationen, um das logische Gerät eindeutig zu benennen. Diese Eigenschaft wird von [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)geerbt und ist immer auf "Microsoft:*VMGUID* \\ *GUID*" festgelegt, wobei *VMGUID* die **Name** -Eigenschaft der [**MSVM \_ Computersystem**](msvm-computersystem.md) -Instanz ist, die diesem Gerät zugeordnet ist.
...
Der Zugriff auf die **MSVM \_ timesynccomponent** -Klasse kann durch die UAC-Filterung eingeschränkt werden. Weitere Informationen finden Sie unter [Benutzerkontensteuerung und WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
