...
|:-----------------------------------------------------------------------|:------------------------------------------------------------------------------|
| [**ClickButton**](clickbutton-msvm-syntheticmouse.md)                 | Simuliert einen Klick auf die Schaltfläche der angegebenen Geräte Schaltfläche.<br/>           |
| **EnableDevice**                                                       | Diese Methode wird nicht unterstützt.<br/>                                      |
| [**GetButtonState**](getbuttonstate-msvm-syntheticmouse.md)           | Ruft den aktuellen Zustand der angegebenen Geräte Schaltfläche ab.<br/>        |
| **Onlinedevice**                                                       | Diese Methode wird nicht unterstützt.<br/>                                      |
| **Inaktiven Geräte**                                                      | Diese Methode wird nicht unterstützt.<br/>                                      |
| [**RequestStateChange**](msvm-syntheticmouse-requeststatechange.md)   | Fordert eine Statusänderung an.<br/>                                            |
...
| [**"Settabsoluteposition"**](setabsoluteposition-msvm-syntheticmouse.md) | Legt die horizontale und vertikale Position des Mauszeigers fest.<br/>     |
| [**SetButtonState**](setbuttonstate-msvm-syntheticmouse.md)           | Legt den aktuellen Zustand der angegebenen Geräte Schaltfläche fest.<br/>             |
| **SetPowerState**                                                      | Diese Methode wird nicht unterstützt.<br/>                                      |
| [**Setscrollposition**](setscrollposition-msvm-syntheticmouse.md)     | Legt die z-Koordinate des Steuer Elements für das Mausrad fest.<br/> |
...
Gibt an, ob das Gerät mit absoluten oder relativen Koordinaten arbeitet.



| Wert                                                                                | Bedeutung                                           |
|--------------------------------------------------------------------------------------|---------------------------------------------------|
| <dl> <dt>**Fall**</dt> </dl>  | Die Koordinaten des Geräts sind absolut.<br/> |
| <dl> <dt>**False**</dt> </dl> | Die Koordinaten des Geräts sind relativ.<br/> |
...
Die Standard-oder Startkonfiguration eines Administrators für den **enabledstate** eines Elements. Diese Eigenschaft wird von [**CIM \_ enabledlogicalelement**](/previous-versions//cc136818(v=vs.85))geerbt.
...
Die absolute x-Koordinate des Zeige Geräts.
...
Die z-Koordinaten Position des Maus Geräts.
...
Zeichen folgen, die die verschiedenen [**OperationalStatus**](msvm-bioselement.md) -Array Werte beschreiben. Diese Eigenschaft wird von [**CIM \_ ManagedSystemElement**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement)geerbt.
...
Die absolute y-Koordinate des Zeige Geräts.

</dd> </dl>

## <a name="remarks"></a>Bemerkungen

Der Zugriff auf die **MSVM \_ syntheticmouse** -Klasse kann durch die UAC-Filterung eingeschränkt werden. Weitere Informationen finden Sie unter [Benutzerkontensteuerung und WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
