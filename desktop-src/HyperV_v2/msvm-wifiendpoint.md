...
Stellt den logischen Verbindungspunkt für einen Netzwerkadapter dar. Wenn der Wi-Fi-Endpunkt mit einem Switchport verbunden ist, verfügt der Netzwerkadapter, der mit dem Wi-Fi Endpunkt verbunden ist, über eine Netzwerkverbindung.
...
Enthält die Mac-Adresse des Zugriffs Punkts, dem der Wi-Fi-Endpunkt derzeit zugeordnet ist. Wenn der Wi-Fi Endpunkt derzeit nicht zugeordnet ist, sollte **accesspointaddress** **null** sein. Die Mac-Adresse muss als zwölf hexadezimal Ziffern formatiert werden (z. b. "010203040506"), wobei jedes Paar eines der sechs Oktette der Mac-Adresse in kanonischer bidirektionale darstellt (z. b. befindet sich das Gruppen Adress Bit im unteren Bit des ersten Zeichens der Zeichenfolge).
...
Gibt an, ob der Wi-Fi Endpunkt derzeit einem Zugriffspunkt oder einer Client Station zugeordnet ist.

Enthält **true** , wenn der Wi-Fi Endpunkt einem Zugriffspunkt oder einer Client Station zugeordnet ist. andernfalls **false**.
...
<span id="Open_System"></span><span id="open_system"></span><span id="OPEN_SYSTEM"></span>**System öffnen** (2)
</dt> <dt>
...
<span id="DMTF_Reserved_"></span><span id="dmtf_reserved_"></span><span id="DMTF_RESERVED_"></span>**DMTF reserviert** (9... )
</dt> </dl>
...
Gibt den grundlegenden Service Set (BSS)-Typ des Netzwerks an, das der-Instanz entspricht. Ein grundlegender Service Satz ist eine Gruppe von Stationen, die von einer einzelnen Koordinations Funktion gesteuert werden.
...
| <span id="Independent"></span><span id="independent"></span><span id="INDEPENDENT"></span><dl> <dt>**Unabhängig**</dt> <dt>2</dt> </dl>                | Der Wi-Fi-Endpunkt wird direkt einer anderen Client Station zugeordnet.<br/>    |
| <span id="Infrastructure"></span><span id="infrastructure"></span><span id="INFRASTRUCTURE"></span><dl> <dt>**Infrastruktur**</dt> <dt>3</dt> </dl>    | Der Wi-Fi-Endpunkt wird einem Netzwerk mithilfe eines Zugriffs Punkts zugeordnet.<br/> |
| <span id="DMTF_Reserved_"></span><span id="dmtf_reserved_"></span><span id="DMTF_RESERVED_"></span><dl> <dt> **DMTF reserviert**</dt> <dt>4..</dt> </dl> |                                                                                    |
...
Gibt die verwendete Verschlüsselungsmethode zum Schutz der Vertraulichkeit von Daten an, die vom Wi-Fi Endpunkt gesendet und empfangen werden.
...
<span id="DMTF_Reserved_"></span><span id="dmtf_reserved_"></span><span id="DMTF_RESERVED_"></span>**DMTF reserviert** (6... )
</dt> </dl>
...
Enthält den EAP-Typ (Extensible Authentication Protocol) nur dann, wenn **AuthenticationMethod** 5 (WPA IEEE 802.1 x), 7 (WPA2 IEEE 802.1 x) oder 8 (CCKM IEEE 802.1 x) enthält.
...
Gibt die 802,11-Authentifizierungsmethode nur dann an, wenn **AuthenticationMethod** 1 (Sonstiges) enthält. Das Format dieser Zeichenfolge ist Anbieter spezifisch.
...
Gibt die 802,11-Verschlüsselungsmethode nur dann an, wenn " **verschlüsselungsmethod** " 1 (Sonstiges) enthält. Das Format dieser Zeichenfolge ist Anbieter spezifisch.
...
<span id="DMTF_Reserved"></span><span id="dmtf_reserved"></span><span id="DMTF_RESERVED"></span>**DMTF reserviert** (4301.32767)
</dt> <dt>
