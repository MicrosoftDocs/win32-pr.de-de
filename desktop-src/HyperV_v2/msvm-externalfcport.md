---
description: Stellt einen externen Fibre Channel Port dar.
...
ms.locfileid: "119789940"
---
# <a name="msvm_externalfcport-class"></a>Msvm \_ ExternalFcPort-Klasse
...
Stellt einen externen Fibre Channel Port dar.
...
Die **Msvm \_ ExternalFcPort-Klasse** verfügt über diese Typen von Membern:
...
Die **Msvm \_ ExternalFcPort-Klasse** verfügt über diese Methoden.
...
| [**RequestStateChange**](msvm-externalfcport-requeststatechange.md) | Fordert eine Zustandsänderung an<br/>       |
| [**Zurücksetzen**](msvm-externalfcport-reset.md)                           | Setzt das virtuelle Gerät zurück.<br/>    |
...
Die **Msvm \_ ExternalFcPort-Klasse** verfügt über diese Eigenschaften.
...
Wenn diese Eigenschaft true **ist,** kann Fibre Channel Port mit den Switches verbunden werden und so Konnektivität mit einem virtuellen Computer bereitstellen. Wenn diese Eigenschaft false **ist,** kann dieser Port nicht vom virtuellen Computer verwendet werden, Fibre Channel wird.
...
Ein Zeichenfolgenwert, der **LinkTechnology** beschreibt, wenn er auf 1(Other) festgelegt ist. Diese Eigenschaft wird von [**CIM \_ NetworkPort**](/previous-versions/windows/desktop/iscsitarg/cim-networkport)geerbt.
...
Die Verwendung dieser Eigenschaft ist anstelle der **PortType-Eigenschaft** veraltet. Diese Eigenschaft wird von [**CIM \_ NetworkPort**](/previous-versions/windows/desktop/iscsitarg/cim-networkport)geerbt.
...
Beschreibt den Typ des Moduls, wenn **PortType** auf 1 (Other) festgelegt ist. Diese Eigenschaft wird von [**CIM \_ LogicalPort**](/previous-versions//cc136869(v=vs.85))geerbt.
...
Die Portnummer. Diese Eigenschaft wird von [**CIM \_ NetworkPort**](/previous-versions/windows/desktop/iscsitarg/cim-networkport)geerbt.
...
Der spezifische Modus, der derzeit für den Port aktiviert ist. Bei Festlegung auf 1 (Other) enthält die zugehörige **OtherPortType-Eigenschaft** eine Zeichenfolgenbeschreibung des Porttyps. Diese Eigenschaft wird von [**CIM \_ LogicalPort**](/previous-versions//cc136869(v=vs.85))geerbt.
...
<span id="Vendor_Reserved_"></span><span id="vendor_reserved_"></span><span id="VENDOR_RESERVED_"></span>**Reservierter Anbieter** (16000..65535 )
</dt> </dl>
...
Der name des weltweiten Knotens für diesen Fibre Channel Port.
...
Der name des weltweiten Ports für diesen Fibre Channel Port.
