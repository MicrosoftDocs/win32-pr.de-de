...
---
# <a name="msvm_terminalconnection-class"></a>MSVM \_ terminalconnection-Klasse

Gibt den Status einer aktiven Remote Sitzung an, die mit einer virtuellen Maschine interagiert. Es kann jeweils nur eine Verbindung vorhanden sein.
...
Die **MSVM \_ terminalconnection** -Klasse verfügt über diese Typen von Membern:
...
Die **MSVM \_ terminalconnection** -Klasse verfügt über diese Methoden.



| Methode                                                                   | BESCHREIBUNG                         |
|:-------------------------------------------------------------------------|:------------------------------------|
| [**RequestStateChange**](msvm-terminalconnection-requeststatechange.md) | Fordert eine Statusänderung an.<br/> |
...
Die **MSVM \_ terminalconnection** -Klasse verfügt über diese Eigenschaften.
...
Der eindeutige Bezeichner für eine Instanz des Terminal Verbindungs Objekts. Der Bezeichner hat das Format "Microsoft:*VMID* \\ *Index*". Beispiel: "Microsoft: 67a5d397-a02d-11dB-AC13-001676aa34f 0 \\ ".
...
Der Zugriff auf die **MSVM \_ terminalconnection** -Klasse kann durch die UAC-Filterung eingeschränkt werden. Weitere Informationen finden Sie unter [Benutzerkontensteuerung und WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
