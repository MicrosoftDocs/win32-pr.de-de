...
---
# <a name="common-utilities-for-the-virtualization-samples-v2"></a><span data-ttu-id="b178d-103">Allgemeine Hilfsprogramme für die Virtualisierungsbeispiele (v2)</span><span class="sxs-lookup"><span data-stu-id="b178d-103">Common utilities for the virtualization samples (V2)</span></span>

<span data-ttu-id="b178d-104">Die folgenden Dienstprogramme werden von einigen der c#-Beispiele für die Virtualisierung verwendet.</span><span class="sxs-lookup"><span data-stu-id="b178d-104">The following utilities are used by some of the C# virtualization samples.</span></span>
