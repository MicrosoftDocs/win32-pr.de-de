---
description: Stellt den Zustand der Gastdienstschnittstellenkomponente dar, die einen Mechanismus für die Interaktion mit dem virtuellen Computer über die Verwaltungsschnittstellen auf dem Hostsystem bietet.
...
Stellt den Zustand der Gastdienstschnittstellenkomponente dar, die einen Mechanismus für die Interaktion mit dem virtuellen Computer über die Verwaltungsschnittstellen auf dem Hostsystem bietet. Diese Klasse wird von der [**CIM \_ LogicalDevice-Klasse**](/windows/desktop/CIMWin32Prov/cim-logicaldevice) ableiten.
...
Die **Msvm \_ GuestServiceInterfaceComponent-Klasse** verfügt über die folgenden Membertypen:
...
| [**SetPowerState**](/windows/desktop/CIMWin32Prov/setpowerstate-method-in-class-cim-logicaldevice)        | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand eingedrung werden soll. Nicht von WMI implementiert.<br/> |
...
| <span id="Running_Full_Power"></span><span id="running_full_power"></span><span id="RUNNING_FULL_POWER"></span><dl> <dt>**Ausführen/Vollversion von Power**</dt> <dt>3 (0x3)</dt> </dl>                                      |                                                                                                             |
...
| <span id="Off_Duty"></span><span id="off_duty"></span><span id="OFF_DUTY"></span><dl> <dt>**Off-Aufgabe**</dt> <dt>9 (0x9)</dt> </dl>                                                                              |                                                                                                             |
...
| <span id="Power_Save_-_Unknown"></span><span id="power_save_-_unknown"></span><span id="POWER_SAVE_-_UNKNOWN"></span><dl> <dt>**Energiesparen – Unbekannt**</dt> <dt>13 (0xD)</dt> </dl>                             | Es ist bekannt, dass sich das Gerät im Energiesparmodus befindet, aber sein genauer Status ist unbekannt.<br/>                 |
| <span id="Power_Save_-_Low_Power_Mode"></span><span id="power_save_-_low_power_mode"></span><span id="POWER_SAVE_-_LOW_POWER_MODE"></span><dl> <dt>**Stromsparen – Niedriger Energiemodus**</dt> <dt>14 (0xE)</dt> </dl> | Das Gerät befindet sich in einem Energiesparzustand, funktioniert aber weiterhin und kann eine beeinträchtigte Leistung zeigen.<br/> |
| <span id="Power_Save_-_Standby"></span><span id="power_save_-_standby"></span><span id="POWER_SAVE_-_STANDBY"></span><dl> <dt>**Stromsparen – Standby**</dt> <dt>15 (0xF)</dt> </dl>                             | Das Gerät funktioniert nicht, kann aber schnell voll funktionsfähig sein.<br/>                        |
| <span id="Power_Cycle"></span><span id="power_cycle"></span><span id="POWER_CYCLE"></span><dl> <dt>**Power Cycle**</dt> <dt>16 (0x10)</dt> </dl>                                                                |                                                                                                             |
| <span id="Power_Save_-_Warning"></span><span id="power_save_-_warning"></span><span id="POWER_SAVE_-_WARNING"></span><dl> <dt>**Energiesparen – Warnung**</dt> <dt>17 (0x11)</dt> </dl>                            | Das Gerät befindet sich in einem Warnzustand, jedoch auch im Energiesparmodus.<br/>                              |
...
Kurze Textbeschreibung des Objekts. Diese Eigenschaft wird von [**CIM \_ ManagedSystemElement geerbt.**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement)
...
| <dl> <dt>3 (0x3)</dt> </dl>   | Der Treiber für dieses Gerät ist möglicherweise beschädigt, oder das System hat möglicherweise wenig Arbeitsspeicher oder andere Ressourcen.<br/>                             |
...
| <dl> <dt>5 (0x5)</dt> </dl>   | Der Treiber für das Gerät erfordert eine Ressource, die Windows verwaltet werden kann.<br/>                                                         |
...
| <dl> <dt>8 (0x8)</dt> </dl>   | Das Treiberladegerät für das Gerät fehlt.<br/>                                                                                      |
| <dl> <dt>9 (0x9)</dt> </dl>   | Das Gerät funktioniert nicht ordnungsgemäß. Die steuernde Firmware berichtet fälschlicherweise die Ressourcen für das Gerät.<br/>               |
...
| <dl> <dt>14 (0xE)</dt> </dl>  | Das Gerät funktioniert erst dann ordnungsgemäß, wenn der Computer neu gestartet wird.<br/>                                                                  |
...
| <dl> <dt>19 (0x13)</dt> </dl> | Fehler beim Verwenden des VxD-Ladeers.<br/>                                                                                                 |
...
| <dl> <dt>25 (0x19)</dt> </dl> | Windows wird das Gerät weiterhin eingerichtet.<br/>                                                                                       |
| <dl> <dt>26 (0x1A)</dt> </dl> | Windows wird das Gerät weiterhin eingerichtet.<br/>                                                                                       |
...
| <dl> <dt>29 (0x1D)</dt> </dl> | Das Gerät ist deaktiviert. Die Gerätefirmware hat nicht die erforderlichen Ressourcen zur Verfügung stellt.<br/>                                               |
| <dl> <dt>30 (0x1E)</dt> </dl> | Das Gerät verwendet eine IRQ-Ressource, die ein anderes Gerät verwendet.<br/>                                                                 |
| <dl> <dt>31 (0x1F)</dt> </dl> | Das Gerät funktioniert nicht ordnungsgemäß. Windows die erforderlichen Gerätetreiber können nicht geladen werden.<br/>                                              |
...
Textbeschreibung des Objekts. Diese Eigenschaft wird von [**CIM \_ ManagedSystemElement geerbt.**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement)
...
Datum und Uhrzeit der Installation des Objekts. Diese Eigenschaft benötigt keinen Wert, um anzugeben, dass das Objekt installiert ist. Diese Eigenschaft wird von [**CIM \_ ManagedSystemElement geerbt.**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement)
...
Bezeichnung, unter der das Objekt bekannt ist. Bei Unterklassen kann diese Eigenschaft überschrieben werden, um eine Schlüsseleigenschaft zu sein. Diese Eigenschaft wird von [**CIM \_ ManagedSystemElement geerbt.**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement)
...
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Aktiviert**</dt> <dt>3 (0x3)</dt> </dl>                                                                                                                                     | Die Energieverwaltungsfeatures sind derzeit aktiviert, aber der genaue Funktionssatz ist unbekannt, oder die Informationen sind nicht verfügbar.<br/>                                                                                                                                                                                               |
...
| <span id="Power_Cycling_Supported"></span><span id="power_cycling_supported"></span><span id="POWER_CYCLING_SUPPORTED"></span><dl> <dt>**Power Bike Supported**</dt> <dt>6 (0x6)</dt> </dl>                                                                     | Die [**SetPowerState-Methode**](/windows/desktop/CIMWin32Prov/setpowerstate-method-in-class-cim-controller) kann aufgerufen werden, wenn der *PowerState-Parameter* auf 5 ("Power Cycle") festgelegt ist.<br/>                                                                                                                                                            |
| <span id="Timed_Power_On_Supported"></span><span id="timed_power_on_supported"></span><span id="TIMED_POWER_ON_SUPPORTED"></span><dl> <dt>**Timed Power On Supported**</dt> <dt>7 (0x7)</dt> </dl>                                                                 | Die [**SetPowerState-Methode**](/windows/desktop/CIMWin32Prov/setpowerstate-method-in-class-cim-controller) kann aufgerufen werden, wenn der *PowerState-Parameter* auf 5 ("Power Cycle") und *time* auf ein bestimmtes Datum und eine bestimmte Uhrzeit oder ein bestimmtes Intervall für das Ein-/Aus- festgelegt ist.<br/>                                                                                       |
...
<span id="Other"></span><span id="other"></span><span id="OTHER"></span>**Sonstiges** (1 (0x1))
</dt> <dt>
