...
Gibt den Adapterindexbezeichner an, der diesem Gerät zugeordnet ist.
...
Gibt die Menge an Videospeicher in Bytes an, die für die GPU verfügbar ist.
...
**TRUE,** wenn es für virtualisierungskompatibel ist; andernfalls **FALSE.**
...
Gibt die Menge des Systemspeichers in Bytes an, der der GPU zugeordnet ist.
...
Gibt die Menge an Videospeicher in Bytes an, die der GPU zugeordnet ist.
...
Gibt die Verison von DirectX an, die von der GPU unterstützt wird.
...
Gibt die Treibermodellversion an.
...
Gibt den Namen des Treiberanbieters an.
...
Gibt an, ob der Adapter für die Verwendung mit der RemoteFX.
...
Gibt das Pixel-Shader-Verison an, das von der GPU unterstützt wird.
...
Gibt die GPU-RemoteFX für dieses Gerät an. Diese Eigenschaft wird derzeit nicht verwendet.
...
Gibt die Menge des freigegebenen Systemspeichers in Bytes an, der für die GPU verfügbar ist.
...
Gibt die Gesamtmenge des Videospeichers in Bytes an, die auf der GPU vorhanden ist.
