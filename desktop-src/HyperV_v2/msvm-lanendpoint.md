---
description: Stellt den logischen Verbindungspunkt für einen Netzwerkadapter dar. Wenn der LAN-Endpunkt mit einem Switchport verbunden ist, verfügt der netzwerkadapter, der mit dem LAN-Endpunkt verbunden ist, über Netzwerkkonnektivität.
...
ms.locfileid: "119521930"
---
# <a name="msvm_lanendpoint-class"></a>Msvm \_ LANEndpoint-Klasse

Stellt den logischen Verbindungspunkt für einen Netzwerkadapter dar. Wenn der LAN-Endpunkt mit einem Switchport verbunden ist, verfügt der netzwerkadapter, der mit dem LAN-Endpunkt verbunden ist, über Netzwerkkonnektivität.
...
|:------------------------------------------------------------------|:------------------------------------|
| [**RequestStateChange**](msvm-lanendpoint-requeststatechange.md) | Fordert eine Zustandsänderung an.<br/> |
...
Eine kurze Beschreibung des -Objekts. Diese Eigenschaft wird von [**CIM \_ ManagedElement**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)geerbt und immer auf "LAN-Endpunkt" festgelegt.
...
Der Name der Klasse oder Unterklasse, die bei der Erstellung einer Instanz verwendet wird. Diese Eigenschaft wird von [**CIM \_ ServiceAccessPoint**](/windows/desktop/CIMWin32Prov/cim-serviceaccesspoint)geerbt und immer auf "Msvm \_ LANEndpoint" festgelegt.
...
Eine Beschreibung des -Objekts. Diese Eigenschaft wird von [**CIM \_ ManagedElement**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)geerbt und immer auf "Microsoft Virtual LAN Endpoint" festgelegt.
...
Multicastadressen, an denen der LAN-Endpunkt lauskt. Diese Eigenschaft wird von [**CIM \_ LANEndpoint geerbt.**](/previous-versions//cc136865(v=vs.85))
...
Die aktuelle Integrität des Elements. Diese Eigenschaft drückt die Integrität dieses Elements aus, aber nicht notwendigerweise die Integrität seiner Unterkomponenten. Die möglichen Werte sind 0 bis 30, wobei 5 bedeutet, dass das Element vollständig fehlerfrei ist, und 30 bedeutet, dass das Element vollständig nichtfunktional ist. Diese Eigenschaft wird von [**CIM \_ ManagedSystemElement geerbt**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement)und immer auf 5 (OK) festgelegt.
...
Eine Bezeichnung oder ein Bezeichner für das LAN-Segment, mit dem der Endpunkt verbunden ist. Wenn der Endpunkt derzeit nicht aktiv/verbunden ist oder diese Informationen nicht bekannt sind, ist diese Eigenschaft **NULL.** Diese Eigenschaft wird von [**CIM \_ LANEndpoint geerbt.**](/previous-versions//cc136865(v=vs.85))
...
Diese Eigenschaft ist veraltet statt der **ProtocolType-Eigenschaft.** Diese Eigenschaft wird von [**CIM \_ LANEndpoint geerbt.**](/previous-versions//cc136865(v=vs.85))
...
Die MAC-Adresse, die für die Kommunikation mit dem LAN-Endpunkt verwendet wird. Die MAC-Adresse ist als zwölf Hexadezimalziffern (z. B. "010203040506") formatiert, und jedes Paar repräsentiert eines der sechs Oktette der MAC-Adresse in kanonischer Bit reihenfolge gemäß RFC 2469. Diese Eigenschaft wird von [**CIM \_ LANEndpoint geerbt.**](/previous-versions//cc136865(v=vs.85))
...
Die größte Größe (in Bits) des Informationsfelds, das vom LAN-Endpunkt gesendet oder empfangen werden kann. Diese Eigenschaft wird von [**CIM \_ LANEndpoint geerbt.**](/previous-versions//cc136865(v=vs.85))
...
Enthält die Benennungshuristik, die ausgewählt wird, um sicherzustellen, dass der Wert der **Name-Eigenschaft** eindeutig ist. Diese Eigenschaft wird von [**CIM \_ ProtocolEndpoint geerbt**](/previous-versions/windows/desktop/iscsitarg/cim-protocolendpoint)und auf "Microsoft Virtual Device ID" festgelegt.
...
Diese Eigenschaft ist veraltet statt der **OtherTypeDescription-Eigenschaft.** Diese Eigenschaft wird von [**CIM \_ LANEndpoint geerbt.**](/previous-versions//cc136865(v=vs.85))
...
<span id="X.25_PLE"></span><span id="x.25_ple"></span>**X.25 DH** (40)
</dt> <dt>
...
<span id="HIPPI"></span><span id="hippi"></span>**SOLLI** (47)
</dt> <dt>
...
<span id="Proprietary_Virtual_Internal"></span><span id="proprietary_virtual_internal"></span><span id="PROPRIETARY_VIRTUAL_INTERNAL"></span>**Proprietär virtuell/intern** (53)
</dt> <dt>
...
<span id="HIPPI_Interface"></span><span id="hippi_interface"></span><span id="HIPPI_INTERFACE"></span>**INTERFACESI-Schnittstelle** (57)
</dt> <dt>
...
<span id="ATM_Emulated_LAN_for_802.3"></span><span id="atm_emulated_lan_for_802.3"></span><span id="ATM_EMULATED_LAN_FOR_802.3"></span>**Emuliertes ATM-LAN für 802.3** (59)
</dt> <dt>

<span id="ATM_Emulated_LAN_for_802.5"></span><span id="atm_emulated_lan_for_802.5"></span><span id="ATM_EMULATED_LAN_FOR_802.5"></span>**Emuliertes ATM-LAN für 802.5** (60)
</dt> <dt>

<span id="ATM_Emulated_Circuit"></span><span id="atm_emulated_circuit"></span><span id="ATM_EMULATED_CIRCUIT"></span>**Emulierte AtM-Verbindung** (61)
</dt> <dt>
...
<span id="Proprietary_Connectionless"></span><span id="proprietary_connectionless"></span><span id="PROPRIETARY_CONNECTIONLESS"></span>**Proprietäre Verbindungslos** (89)
</dt> <dt>
...
<span id="Myrinet"></span><span id="myrinet"></span><span id="MYRINET"></span>**My epht** (99)
</dt> <dt>

<span id="Voice_Receive_and_Transmit"></span><span id="voice_receive_and_transmit"></span><span id="VOICE_RECEIVE_AND_TRANSMIT"></span>**Spracheeing empfangen und übertragen** (100)
</dt> <dt>
...
<span id="PPP_Multilink_Bundle"></span><span id="ppp_multilink_bundle"></span><span id="PPP_MULTILINK_BUNDLE"></span>**BUNDLE mit mehreren Verknüpfungen** (108)
</dt> <dt>
...
<span id="Interleave_Channel"></span><span id="interleave_channel"></span><span id="INTERLEAVE_CHANNEL"></span>**Verschachtelungskanal** (124)
</dt> <dt>
...
<span id="CATV_MAC_Layer"></span><span id="catv_mac_layer"></span><span id="CATV_MAC_LAYER"></span>**CATV MAC-Schicht** (127)
</dt> <dt>
...
<span id="DTM"></span><span id="dtm"></span>**MF** (140)
</dt> <dt>
...
<span id="IF-GSN_HIPPI-6400"></span><span id="if-gsn_hippi-6400"></span>**IF-GSN/SOLLI-6400** (145)
</dt> <dt>

<span id="DVB-RCC_MAC_Layer"></span><span id="dvb-rcc_mac_layer"></span><span id="DVB-RCC_MAC_LAYER"></span>**MACINTOSH-RCC MAC Layer** (146)
</dt> <dt>

<span id="DVB-RCC_Downstream"></span><span id="dvb-rcc_downstream"></span><span id="DVB-RCC_DOWNSTREAM"></span>**DOWNSTREAM-RCC Downstream** (147)
</dt> <dt>

<span id="DVB-RCC_Upstream"></span><span id="dvb-rcc_upstream"></span><span id="DVB-RCC_UPSTREAM"></span>**MOBILE-RCC Upstream** (148)
</dt> <dt>
...
<span id="BGP_Policy_Accounting"></span><span id="bgp_policy_accounting"></span><span id="BGP_POLICY_ACCOUNTING"></span>**BGP-Richtlinienabrechnung** (162)
</dt> <dt>
...
<span id="Multi-Frequency_Signaling_Link"></span><span id="multi-frequency_signaling_link"></span><span id="MULTI-FREQUENCY_SIGNALING_LINK"></span>**Multifrequenzsignalisierungslink** (167)
</dt> <dt>
...
<span id="DVB-ASI_Input"></span><span id="dvb-asi_input"></span><span id="DVB-ASI_INPUT"></span>**AI-ASI-Eingabe** (172)
</dt> <dt>

<span id="DVB-ASI_Output"></span><span id="dvb-asi_output"></span><span id="DVB-ASI_OUTPUT"></span>**OUTPUT-ASI Output** (173)
</dt> <dt>
...
<span id="Proprietary_Wireless_MAC_Layer"></span><span id="proprietary_wireless_mac_layer"></span><span id="PROPRIETARY_WIRELESS_MAC_LAYER"></span>**Proprietäre Mac-Drahtlosschicht** (180)
</dt> <dt>

<span id="Proprietary_Wireless_Downstream"></span><span id="proprietary_wireless_downstream"></span><span id="PROPRIETARY_WIRELESS_DOWNSTREAM"></span>**Proprietärer drahtloser Downstream** (181)
</dt> <dt>

<span id="Proprietary_Wireless_Upstream"></span><span id="proprietary_wireless_upstream"></span><span id="PROPRIETARY_WIRELESS_UPSTREAM"></span>**Proprietärer Drahtloser Upstream** (182)
</dt> <dt>
...
Der Name der Erstellungsklasse des Hostingsystems. Diese Eigenschaft wird von [**CIM \_ ServiceAccessPoint**](/windows/desktop/CIMWin32Prov/cim-serviceaccesspoint)geerbt.
