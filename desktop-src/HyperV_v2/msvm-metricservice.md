...
---
# <a name="msvm_metricservice-class"></a>MSVM- \_ metricservice-Klasse

Bietet die Möglichkeit zum Verwalten von Metriken.
...
Die **MSVM \_ metricservice** -Klasse verfügt über diese Typen von Membern:
...
Die **MSVM \_ metricservice** -Klasse verfügt über diese Methoden.



| Methode                                                                    | BESCHREIBUNG                                                                             |
|:--------------------------------------------------------------------------|:----------------------------------------------------------------------------------------|
| [**Controlmetrics**](controlmetrics-msvm-metricservice.md)               | Wird verwendet, um die Sammlung von Metriken für ein verwaltetes Element oder Elemente zu steuern.<br/> |
| [**Controlmetricsbyclass**](msvm-metricservice-controlmetricsbyclass.md) | Steuert die Metriken nach Klasse.<br/>                                               |
| [**Controlsampletimes**](msvm-metricservice-controlsampletimes.md)       | Legt die Beispiel Zeiten für das Steuerelement fest.<br/>                                               |
| [**Getmetricvalues**](msvm-metricservice-getmetricvalues.md)             | Ruft die Metrikwerte ab.<br/>                                                 |
| [**Modifyservicesettings**](modifyservicesettings-msvm-metricservice.md) | Ändert die Einstellungsdaten für den Dienst.<br/>                                   |
| [**RequestStateChange**](msvm-metricservice-requeststatechange.md)       | Fordert eine Statusänderung an.<br/>                                                     |
| [**Showmetrics**](msvm-metricservice-showmetrics.md)                     | Zeigt die angegebenen Metriken an.<br/>                                                 |
| [**Showmetricsbyclass**](msvm-metricservice-showmetricsbyclass.md)       | Zeigt die Metriken nach Klasse an.<br/>                                                  |
| [**Start Service**](msvm-metricservice-startservice.md)                   | Startet den Dienst.<br/>                                                          |
| [**Stop Service**](msvm-metricservice-stopservice.md)                     | Beendet den Dienst.<br/>                                                           |
...
Die **MSVM \_ metricservice** -Klasse verfügt über diese Eigenschaften.
...
Eine kurze Beschreibung des-Objekts. Diese Eigenschaft wird von [**CIM \_ managedelta Element**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)geerbt und ist immer auf "Hyper-V Metric Service" festgelegt.
...
Der Name der Klasse oder Unterklasse, die bei der Erstellung einer-Instanz verwendet wird. Diese Eigenschaft wird vom [**CIM- \_ Dienst**](/windows/desktop/CIMWin32Prov/cim-service)geerbt und ist immer auf "MSVM \_ metricservice" festgelegt.
...
Eine Beschreibung des -Objekts. Diese Eigenschaft wird vom [**CIM- \_ managedelta**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)geerbt und ist immer auf "stellt die WMI-Verwaltung für Hyper-V-Metriken" fest.
...
Ein Anzeige Name für das-Objekt. Diese Eigenschaft wird von [**CIM \_ managedelta Element**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)geerbt und ist immer auf "Hyper-V Metric Service" festgelegt.
...
Die Bezeichnung, mit der das-Objekt bekannt ist. Diese Eigenschaft wird vom [**CIM- \_ Dienst**](/windows/desktop/CIMWin32Prov/cim-service)geerbt und ist immer auf "metricsvc" festgelegt.
