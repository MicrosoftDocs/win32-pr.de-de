...
Stellt den Status der RDV-Komponente dar, die für die Bereitstellung eines Transports für das übergeordnete zum Gast zu Konfigurations Zwecken zuständig ist.
...
Die **MSVM- \_ rdvcomponent** -Klasse verfügt über diese Typen von Membern:
...
| [**Enableendpoints**](enableendpoints-msvm-rdvcomponent.md) | Fordert das virtuelle Remotedesktopdienste virtuellen Gerät auf, eine Pipe-Verbindung mit dem virtuellen Computer zu starten. Wenn 0 (null) zurückgegeben wird, war der Vorgang erfolgreich. Jeder andere Rückgabecode weist auf eine Fehlerbedingung hin.<br/> |
