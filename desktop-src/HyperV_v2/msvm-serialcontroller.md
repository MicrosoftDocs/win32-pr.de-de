...
Stellt die Funktionen und die Verwaltung des seriellen Controllers dar. Serielle Controller sind logische Geräte, die immer auf einem virtuellen Computer vorhanden sind und daher nicht über einen Ressourcenpool zugeordnet werden. Eine serielle Controllerinstanz ist immer auf einem virtuellen Computer vorhanden. Serielle Controller verfügen über eine feste Anzahl von Portinstanzen. Diese Implementierung unterstützt zwei Ports pro Controller.

> [!Note]  
> Serielle Controller sind auf virtuellen Computern der [Generation 2 optional.](virtualization-glossary.md)
...
Die **Msvm \_ SerialController-Klasse** verfügt über die folgenden Membertypen:
...
Die **Msvm \_ SerialController-Klasse** verfügt über diese Methoden.
...
| [**RequestStateChange**](msvm-serialcontroller-requeststatechange.md) | Fordert eine Zustandsänderung an.<br/>      |
| [**Zurücksetzen**](msvm-serialcontroller-reset.md)                           | Setzt das Gerät zurück.<br/>            |
...
Die **Msvm \_ SerialController-Klasse** verfügt über diese Eigenschaften.
...
Gibt die möglichen Werte für den *RequestedState-Parameter* der **RequestStateChange-Methode** an. Diese Eigenschaft wird von [**CIM \_ EnabledLogicalElement geerbt,**](/previous-versions//cc136818(v=vs.85))aber nicht verwendet.
...
Die Pufferung und andere Funktionen des seriellen Controllers, die möglicherweise in der Chiphardware inhärent sind. Diese Eigenschaft wird von [**CIM \_ SerialController geerbt.**](/windows/desktop/CIMWin32Prov/cim-serialcontroller)
...
Ein Array von Freiformzeichenfolgen, das ausführlichere Erläuterungen zu den Features des seriellen Controllers bietet, die im **Capabilities-Array angegeben** sind. Diese Eigenschaft wird von [**CIM \_ SerialController geerbt.**](/windows/desktop/CIMWin32Prov/cim-serialcontroller)
...
Der aktivierte oder deaktivierte Zustand des Elements, wenn die **EnabledState-Eigenschaft** auf 1 (Sonstige) festgelegt ist. Diese Eigenschaft muss auf NULL **festgelegt** werden, wenn **EnabledState** ein anderer Wert als 1 ist. Diese Eigenschaft wird von [**CIM \_ EnabledLogicalElement geerbt.**](/previous-versions//cc136818(v=vs.85))
...
Die Betriebssicherheit für den Controller. Diese Eigenschaft wird von [**CIM \_ SerialController geerbt.**](/windows/desktop/CIMWin32Prov/cim-serialcontroller)
...
Das letzte Einschalten des Controllers. Diese Eigenschaft wird vom [**\_ CIM-Controller**](/windows/desktop/CIMWin32Prov/cim-controller)geerbt.
