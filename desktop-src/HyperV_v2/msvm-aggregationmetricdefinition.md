...
---
# <a name="msvm_aggregationmetricdefinition-class"></a>MSVM \_ aggregationmetricdefinition-Klasse

Stellt die Definitions Aspekte einer Metrik dar, die von einem anderen Metrikwert abgeleitet ist. Das **MSVM \_ aggregationmetricdefinition** -Objekt muss den verwalteten Elementen zugeordnet werden, auf die es angewendet wird.
...
Die **MSVM \_ aggregationmetricdefinition** -Klasse verfügt über diese Typen von Membern:

-   [Eigenschaften](#properties)

### <a name="properties"></a>Eigenschaften

Die **MSVM \_ aggregationmetricdefinition** -Klasse verfügt über diese Eigenschaften.
...
Gibt die grundlegende Berechnung an, die für eine zugrunde liegende Metrik ausgeführt wird, um den Wert dieser abgeleiteten Metrik zu erreichen Diese Eigenschaft wird von **CIM \_ aggregationmetricdefinition** geerbt und ist einer der folgenden Werte.
...
| Wert                                                                                                                                                                                                                                                                       | Bedeutung                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="Unknown"></span><span id="unknown"></span><span id="UNKNOWN"></span><dl> <dt>**Unbekannter**</dt> Wert <dt>0</dt> </dl>                                                 | Der Zeitbereich wurde vom Metrik-Designer nicht qualifiziert, oder der Anbieter ist unbekannt.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
Identifiziert die Einheiten eines Werts, z. b. "Megabytes". Diese Eigenschaft wird von **CIM \_ basemetricdefinition** geerbt.
