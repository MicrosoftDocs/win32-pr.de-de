...
ms.locfileid: "119681520"
---
# <a name="msvm_ethernetswitchport-class"></a>Msvm \_ EthernetSwitchPort-Klasse
...
Die **Msvm \_ EthernetSwitchPort-Klasse** verfügt über die folgenden Membertypen:
...
Die **Msvm \_ EthernetSwitchPort-Klasse** verfügt über diese Methoden.
...
| [**RequestStateChange**](msvm-ethernetswitchport-requeststatechange.md) | Fordert eine Zustandsänderung an.<br/>      |
...
Die **Msvm \_ EthernetSwitchPort-Klasse** verfügt über diese Eigenschaften.
...
Eine kurze Beschreibung des -Objekts. Diese Eigenschaft wird von der [**CIM \_ ManagedElement-Klasse geerbt**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement) und immer auf "Ethernet Switch Port" festgelegt.
...
Der Name der Erstellungsklasse des Bereichssystems. Diese Eigenschaft wird von [**CIM \_ LogicalDevice geerbt**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)und immer auf "Msvm \_ EthernetSwitchPort" festgelegt.
...
Eine Beschreibung des -Objekts. Diese Eigenschaft wird von [**CIM \_ ManagedElement geerbt**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)und immer auf "Microsoft Virtual Ethernet Switch Port" festgelegt.
...
Die aktuelle Nutzung der E/A-Virtualisierung (IOV) für die Ausladung an diesem Port. Die Nutzung ist die Menge der IOV-Ressourcen, die auf dem Port verwendet werden.
...
Gibt den Typ der Linktechnologie für den Port an. Wenn sie auf 1 (Other) festgelegt ist, enthält die **OtherLinkTechnology-Eigenschaft eine Zeichenfolgenbeschreibung** des Linktyps. Diese Eigenschaft wird von [**CIM \_ NetworkPort**](/previous-versions/windows/desktop/iscsitarg/cim-networkport)geerbt.
...
<span id="Infrared"></span><span id="infrared"></span><span id="INFRARED"></span>**Wird** (9)
</dt> <dt>
...
Ein Array von Zeichenfolgen, die die MAC-Adressen für den Port enthalten. Diese Eigenschaft wird von [**CIM \_ NetworkPort**](/previous-versions/windows/desktop/iscsitarg/cim-networkport)geerbt.
...
Der Name der Erstellungsklasse des Bereichssystems. Diese Eigenschaft wird von [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)geerbt und immer auf "Msvm \_ VirtualEthernetSwitch" festgelegt.
...
Die aktuelle VM-Warteschlange (VMQ), die die Nutzung an diesem Port auslasten. Die Nutzung ist die Menge der VMQ-Ressourcen, die auf dem Port verwendet werden.
