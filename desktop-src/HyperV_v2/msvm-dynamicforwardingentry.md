...
---
# <a name="msvm_dynamicforwardingentry-class"></a>MSVM \_ dynamicforwardingentry-Klasse

Stellt einen Eintrag in der Weiterleitungs Datenbank (Filter) dar, die dem transparenten Überbrückungs Dienst zugeordnet ist. Der Eintrag ist für den Dienst schwach, wie von [**MSVM \_ transparentbridgingdynamicforwarding**](msvm-transparentbridgingdynamicforwarding.md)angegeben.
...
Die **MSVM \_ dynamicforwardingentry** -Klasse verfügt über diese Typen von Membern:

-   [Eigenschaften](#properties)

### <a name="properties"></a>Eigenschaften

Die **MSVM \_ dynamicforwardingentry** -Klasse verfügt über diese Eigenschaften.
...
Der Status des Eintrags. Diese Eigenschaft wird von [**CIM \_ dynamicforwardingentry**](/previous-versions//cc136814(v=vs.85))geerbt.
...
<span id="Invalid"></span><span id="invalid"></span><span id="INVALID"></span>**Ungültig** (2)
</dt> <dt>

<span id="Learned"></span><span id="learned"></span><span id="LEARNED"></span>**Gelernt** (3)
</dt> <dt>

<span id="Self"></span><span id="self"></span><span id="SELF"></span>**Selbst** (4)
</dt> <dt>
...
Wird automatisch aufgefüllt, wenn der virtuelle Computer erstellt wird. Diese Eigenschaft wird von [**CIM \_ ManagedSystemElement**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement)geerbt.
...
Qualifizierer: **Key**, **maxlen** (12)
</dt> </dl>

Unicast-MAC-Adresse, für die der transparente Überbrückungs Dienst Weiterleitungs-und Filter Informationen hat. Die Mac-Adresse ist als zwölf hexadezimal Ziffern formatiert (z. b. "010203040506"), wobei jedes Paar eines der sechs Oktette der Mac-Adresse in "kanonischer" bitreihenfolge gemäß RFC 2469 darstellt. Diese Eigenschaft wird von [**CIM \_ dynamicforwardingentry**](/previous-versions//cc136814(v=vs.85))geerbt.
...
Diese Eigenschaft wird von [**CIM \_ ManagedSystemElement**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement)geerbt, wird jedoch nicht unterstützt.
...
Der **Name** des-Bereichs Dienstanbieter. Diese Eigenschaft wird von [**CIM \_ dynamicforwardingentry**](/previous-versions//cc136814(v=vs.85))geerbt.
...
Der " **kreationclassname**" des Bereichs Systems. Diese Eigenschaft wird von [**CIM \_ dynamicforwardingentry**](/previous-versions//cc136814(v=vs.85))geerbt.
...
Der Name des Bereichs Systems. Diese Eigenschaft wird von [**CIM \_ dynamicforwardingentry**](/previous-versions//cc136814(v=vs.85))geerbt.
...
Der diesem Eintrag zugeordnete virtuelle LAN-Bezeichner.

</dd> </dl>

## <a name="remarks"></a>Bemerkungen

Der Zugriff auf die **MSVM \_ dynamicforwardingentry** -Klasse kann durch die UAC-Filterung eingeschränkt werden. Weitere Informationen finden Sie unter [Benutzerkontensteuerung und WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
