...
---
# <a name="exporting-a-snapshot-of-a-virtual-machine"></a><span data-ttu-id="41cc4-103">Exportieren einer Momentaufnahme einer virtuellen Maschine</span><span class="sxs-lookup"><span data-stu-id="41cc4-103">Exporting a snapshot of a virtual machine</span></span>

<span data-ttu-id="41cc4-104">Die folgenden c#-und Visual Basic Scripting Edition-Beispiele (VBScript) veranschaulichen das Exportieren einer Momentaufnahme eines virtuellen Computers.</span><span class="sxs-lookup"><span data-stu-id="41cc4-104">The following C# and Visual Basic Scripting Edition (VBScript) samples demonstrate exporting a snapshot of a virtual machine.</span></span> <span data-ttu-id="41cc4-105">Beispiele, die veranschaulichen, wie Sie einen virtuellen Computer exportieren, finden Sie im Thema [**exportsystemdefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) .</span><span class="sxs-lookup"><span data-stu-id="41cc4-105">Samples that demonstrate exporting a virtual machine can be found on the [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) topic.</span></span>

<span data-ttu-id="41cc4-106">Die c#-Hilfsprogramme, auf die verwiesen wird, finden Sie unter [Allgemeine Hilfsprogramme für die Virtualisierungsbeispiele (v2)](common-utilities-for-the-virtualization-samples-v2.md).</span><span class="sxs-lookup"><span data-stu-id="41cc4-106">The referenced C# utilities can be found in [Common utilities for the virtualization samples (V2)](common-utilities-for-the-virtualization-samples-v2.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="41cc4-107">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="41cc4-107">Related topics</span></span>

[<span data-ttu-id="41cc4-108">Exportieren der Konfiguration einer virtuellen Maschine</span><span class="sxs-lookup"><span data-stu-id="41cc4-108">Exporting the configuration of a virtual machine</span></span>](exporting-the-configuration-of-a-virtual-machine.md)

[<span data-ttu-id="41cc4-109">**Exportsystemdefinition**</span><span class="sxs-lookup"><span data-stu-id="41cc4-109">**ExportSystemDefinition**</span></span>](exportsystemdefinition-msvm-virtualsystemmanagementservice.md)
