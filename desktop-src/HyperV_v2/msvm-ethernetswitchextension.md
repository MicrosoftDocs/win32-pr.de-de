...
---
# <a name="msvm_ethernetswitchextension-class"></a>MSVM \_ ethernetzwitchextension-Klasse

Stellt eine Instanz einer Erweiterungs Komponente dar, die an einen virtuellen Ethernet-Switch gebunden ist.
...
Die **MSVM-Klasse " \_ ethernetzwitchextension** " verfügt über diese Typen von Membern:
...
Die **MSVM-Klasse " \_ ethernetzwitchextension** " verfügt über diese Methoden.



| Methode                                                                        | BESCHREIBUNG                         |
|:------------------------------------------------------------------------------|:------------------------------------|
| [**RequestStateChange**](msvm-ethernetswitchextension-requeststatechange.md) | Fordert eine Statusänderung an.<br/> |
...
Die **MSVM-Klasse " \_ ethernetzwitchextension** " verfügt über diese Eigenschaften.
...
Eine kurze Beschreibung des-Objekts. Diese Eigenschaft wird vom [**CIM \_ managedelta-Element**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)geerbt und ist immer auf "Virtual Switch extension" festgelegt.
...
Der Name der Klasse oder Unterklasse, die bei der Erstellung einer-Instanz verwendet wird. Diese Eigenschaft ist immer auf "MSVM \_ ethernetzwitchextension" festgelegt.
...
Der eindeutige Name der Erweiterungs Komponente.
...
Der Name der System Erstellungs Klasse.
...
Der Name des virtuellen Switchs, an den die Erweiterungs Instanz gebunden ist.
...
Die Version der Erweiterung im Format "*Major*". *neben* Version ", z. b." 2,0 ".
