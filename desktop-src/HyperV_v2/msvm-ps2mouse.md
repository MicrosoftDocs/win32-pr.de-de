...
---
# <a name="msvm_ps2mouse-class"></a>MSVM \_ Ps2Mouse-Klasse

Stellt ein PS2-Mausgerät dar. Instanzen dieser Klasse sind logische Geräte, die immer auf einem virtuellen Computer vorhanden sind und daher nicht über einen Ressourcenpool zugeordnet werden. Eine Instanz ist immer auf einem virtuellen Computer vorhanden.
...
Die **MSVM \_ Ps2Mouse** -Klasse verfügt über diese Typen von Membern:
...
Die **MSVM- \_ Ps2Mouse** -Klasse verfügt über diese Methoden.



| Methode                                                           | BESCHREIBUNG                                                                                           |
|:-----------------------------------------------------------------|:------------------------------------------------------------------------------------------------------|
| [**ClickButton**](clickbutton-msvm-ps2mouse.md)                 | Simuliert einen Schaltflächen Klick, eine aufgeschselnde Sequenz auf der angegebenen Geräte Schaltfläche.<br/>              |
| **EnableDevice**                                                 | Diese Methode wird nicht unterstützt.<br/>                                                              |
| [**GetButtonState**](getbuttonstate-msvm-ps2mouse.md)           | Ruft den aktuellen Zustand der angegebenen Geräte Schaltfläche ab.<br/>                                |
| **Onlinedevice**                                                 | Diese Methode wird nicht unterstützt.<br/>                                                              |
| **Inaktiven Geräte**                                                | Diese Methode wird nicht unterstützt.<br/>                                                              |
| [**RequestStateChange**](msvm-ps2mouse-requeststatechange.md)   | Fordert eine Statusänderung an.<br/>                                                                   |
| [**Zurücksetzen**](msvm-ps2mouse-reset.md)                             | Setzt das Gerät zurück.<br/>                                                                         |
| **Restoreproperties**                                            | Diese Methode wird nicht unterstützt.<br/>                                                              |
| **SaveProperties**                                               | Diese Methode wird nicht unterstützt.<br/>                                                              |
| [**SetButtonState**](setbuttonstate-msvm-ps2mouse.md)           | Legt den aktuellen Zustand der angegebenen Geräte Schaltfläche fest.<br/>                                     |
| **SetPowerState**                                                | Diese Methode wird nicht unterstützt.<br/>                                                              |
| [**"Settrelativeposition"**](setrelativeposition-msvm-ps2mouse.md) | Versetzt die Position des Mauszeigers um das angegebene horizontale und vertikale Delta.<br/> |
| [**Setscrollposition**](setscrollposition-msvm-ps2mouse.md)     | Passt die z-Koordinate des Rad-Steuer Elements des Zeige Geräts an.<br/>                      |
...
Die **MSVM- \_ Ps2Mouse** -Klasse verfügt über diese Eigenschaften.
...
Gibt an, ob das Gerät mit absoluten Koordinaten arbeitet. Wenn nicht festgelegt, sind die Koordinaten des Geräts relativ.
...
Eine Adresse oder andere identifizierende Informationen, um das logische Gerät eindeutig zu benennen. Diese Eigenschaft wird von [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)geerbt und ist immer auf "Microsoft:*GUID*" festgelegt.
...
Die Konfiguration des Zeige Geräts für den rechten oder linken Vorgang. Diese Eigenschaft wird von [**CIM \_ pointingdevice**](/windows/desktop/CIMWin32Prov/cim-pointingdevice)geerbt.
...
| <dl> <dt>2</dt> </dl> | Rechter übergebenen Vorgang.<br/> |
| <dl> <dt>3</dt> </dl> | Links übergebenen Vorgang.<br/>  |
...
Ein Array von Freiform-Zeichen folgen, die Erklärungen und Details hinter den Einträgen im " [**OtherIdentifyingInfo**](msvm-keyboard.md) "-Array bereitstellen. Diese Eigenschaft wird von [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)geerbt.
...
Gibt an, ob das Gerät gesperrt ist, und verhindert Benutzereingaben oder-Ausgaben. Diese Eigenschaft wird von [**CIM \_ userdevice**](/windows/desktop/CIMWin32Prov/cim-userdevice)geerbt.
...
Die Anzahl der Schaltflächen auf dem Zeigegerät. Diese Eigenschaft wird von [**CIM \_ pointingdevice**](/windows/desktop/CIMWin32Prov/cim-pointingdevice)geerbt.
...
Der aktivierte oder deaktivierte Status des Elements, wenn die [**enabledstate**](msvm-keyboard.md) -Eigenschaft auf 1 (Sonstiges) festgelegt ist. Diese Eigenschaft muss auf **null** festgelegt werden, wenn **enabledstate** ein anderer Wert als 1 ist. Diese Eigenschaft wird von [**CIM \_ enabledlogicalelement**](/previous-versions//cc136818(v=vs.85))geerbt.
...
Der Typ des Zeige Geräts. Diese Eigenschaft wird von [**CIM \_ pointingdevice**](/windows/desktop/CIMWin32Prov/cim-pointingdevice)geerbt.
...
Die nach Verfolgungs Auflösung des Zeige Geräts in Zählungen pro Zoll. Diese Eigenschaft wird von [**CIM \_ pointingdevice**](/windows/desktop/CIMWin32Prov/cim-pointingdevice)geerbt.
...
Zeichen folgen, die die verschiedenen [**OperationalStatus**](msvm-bioselement.md) -Array Werte beschreiben. Diese Eigenschaft wird von [**CIM \_ ManagedSystemElement**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement) geerbt und ist immer auf "OK" festgelegt.
...
Der Zugriff auf die **MSVM- \_ Ps2Mouse** -Klasse kann durch die UAC-Filterung eingeschränkt werden. Weitere Informationen finden Sie unter [Benutzerkontensteuerung und WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
...
[Eingabe Klassen](input-classes.md)
</dt> </dl>
