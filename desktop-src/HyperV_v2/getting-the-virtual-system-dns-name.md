...
---
# <a name="getting-the-virtual-machine-dns-name"></a>Abrufen des DNS-Namens des virtuellen Computers

Die folgenden c#-und Visual Basic Scripting Edition-Beispiele (VBScript) rufen den DNS-Namen des virtuellen Computers ab.

Zum Ausführen dieses Beispielcodes müssen Sie die Client Integrationsdienste installieren, und das Client Betriebssystem muss ausgeführt werden.
...
[Allgemeine Hilfsprogramme für die Virtualisierungsbeispiele (v2)](common-utilities-for-the-virtualization-samples-v2.md)
