---
description: Die folgenden c#-und Visual Basic Scripting Edition-Beispiele (VBScript) rufen den DNS-Namen des virtuellen Computers ab.
ms.assetid: 1E1F7E6F-5CF6-475F-8351-6A5F56B4FC8E
title: Abrufen des DNS-Namens des virtuellen Computers
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103869299"
---
# <a name="getting-the-virtual-machine-dns-name"></a><span data-ttu-id="c7db1-103">Abrufen des DNS-Namens des virtuellen Computers</span><span class="sxs-lookup"><span data-stu-id="c7db1-103">Getting the virtual machine DNS name</span></span>

<span data-ttu-id="c7db1-104">Die folgenden c#-und Visual Basic Scripting Edition-Beispiele (VBScript) rufen den DNS-Namen des virtuellen Computers ab.</span><span class="sxs-lookup"><span data-stu-id="c7db1-104">The following C# and Visual Basic Scripting Edition (VBScript) samples retrieve the DNS name of the virtual machine.</span></span>

<span data-ttu-id="c7db1-105">Zum Ausführen dieses Beispielcodes müssen Sie die Client Integrationsdienste installieren, und das Client Betriebssystem muss ausgeführt werden.</span><span class="sxs-lookup"><span data-stu-id="c7db1-105">To run this sample code, you must install the client integration services and the client operating system must be running.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="c7db1-106">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="c7db1-106">Related topics</span></span>

[<span data-ttu-id="c7db1-107">Allgemeine Hilfsprogramme für die Virtualisierungsbeispiele (v2)</span><span class="sxs-lookup"><span data-stu-id="c7db1-107">Common utilities for the virtualization samples (V2)</span></span>](common-utilities-for-the-virtualization-samples-v2.md)

[<span data-ttu-id="c7db1-108">**MSVM \_ Computersystem**</span><span class="sxs-lookup"><span data-stu-id="c7db1-108">**Msvm\_ComputerSystem**</span></span>](msvm-computersystem.md)

[<span data-ttu-id="c7db1-109">**MSVM \_ kvpexchangecomponent**</span><span class="sxs-lookup"><span data-stu-id="c7db1-109">**Msvm\_KvpExchangeComponent**</span></span>](msvm-kvpexchangecomponent.md)
