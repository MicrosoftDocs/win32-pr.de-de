...
Stellt einen Port auf dem virtuellen Fibre Channel Switch dar.
...
Die **MSVM \_ fcswitchport** -Klasse verfügt über diese Typen von Membern:
...
| [**RequestStateChange**](msvm-fcswitchport-requeststatechange.md) | fordert eine Statusänderung an.<br/>      |
...
Beschreibt den Modultyp, wenn **portType** auf 1 (Sonstiges) festgelegt ist. Diese Eigenschaft wird von [**CIM \_ logicalport**](/previous-versions//cc136869(v=vs.85))geerbt.
