...
Stellt den Status des Diensts für das Herunterfahren dar, der einen Mechanismus zum Herunterfahren des Betriebssystems des virtuellen Computers von den Verwaltungs Schnittstellen auf dem Host System bereitstellt.
...
| [**Initiatereboot**](msvm-shutdowncomponent-initiatereboot.md)         | Initiiert einen Neustart Vorgang des Betriebssystems auf der zugeordneten untergeordneten virtuellen Maschine.<br/> |
| [**InitiateShutdown**](msvm-shutdowncomponent-initiateshutdown.md)     | Initiiert den Vorgang zum Herunterfahren des Betriebssystems auf der zugeordneten untergeordneten virtuellen Maschine.<br/>   |
| **Onlinedevice**                                                        | Diese Methode wird nicht unterstützt.<br/>                                                           |
| **Inaktiven Geräte**                                                       | Diese Methode wird nicht unterstützt.<br/>                                                           |
| [**RequestStateChange**](msvm-shutdowncomponent-requeststatechange.md) | Fordert eine Statusänderung an.<br/>                                                                |
...
Eine Adresse oder andere identifizierende Informationen, um LogicalDevice eindeutig zu benennen. Diese Eigenschaft wird von [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)geerbt und ist immer auf "Microsoft:*VMGUID* \\ *GUID*" festgelegt, wobei *VMGUID* die **Name** -Eigenschaft der [**MSVM \_ Computersystem**](msvm-computersystem.md) -Instanz ist, die diesem Gerät zugeordnet ist.
...
Der aktivierte Status des Elements. Diese Eigenschaft wird von [**CIM \_ enabledlogicalelement**](/previous-versions//cc136818(v=vs.85)) geerbt und ist entweder auf 2 (aktiviert) oder 3 (deaktiviert) festgelegt.
...
Der aktuelle Zustand des Elements. Mögliche Werte sind 0 bis 30, wobei 5 bedeutet, dass das Element vollständig fehlerfrei ist und 30 bedeutet, dass das Element vollständig nicht funktionsfähig ist. Diese Eigenschaft wird von [**CIM \_ ManagedSystemElement**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement)geerbt.
