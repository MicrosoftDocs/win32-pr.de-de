...
Stellt den synthetischen 3D-Anzeige Controller dar, der einem virtuellen Computer zugewiesen ist. Diese Klasse wird nur bei virtuellen Computern verwendet, die remotefx verwenden.

> [!IMPORTANT]
> Wenn Sie einem virtuellen Computer einen synthetischen 3D-Anzeige Controller hinzufügen, müssen Sie alle synthetischen Anzeige Controller ([**MSVM \_ syntheticdisplaycontroller**](msvm-syntheticdisplaycontroller.md)) deaktivieren, die mit diesem virtuellen Computer verbunden sind.
...
Die **MSVM \_ Synthetic3DDisplayController** -Klasse verfügt über diese Typen von Membern:
...
Die Grafiken und 3D-Funktionen des Anzeige Controllers. Diese Eigenschaft wird von [**CIM \_ Displaycontroller**](/previous-versions//cc136810(v=vs.85))geerbt.
...
Der Geräte Bezeichner. Diese Eigenschaft wird von [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)geerbt und ist immer auf "Microsoft:*GUID*" festgelegt.
...
Der aktuelle Zustand des Elements. Dieses Attribut drückt den Zustand dieses Elements aus, aber nicht notwendigerweise dessen unter Elemente. Die möglichen Werte liegen zwischen 0 und 30, wobei 5 bedeutet, dass das Element vollständig fehlerfrei ist und 30 bedeutet, dass das Element vollständig nicht funktionsfähig ist. Diese Eigenschaft wird von [**CIM \_ ManagedSystemElement**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement)geerbt.
