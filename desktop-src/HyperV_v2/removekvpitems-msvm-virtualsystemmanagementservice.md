...
---
# <a name="removekvpitems-method-of-the-msvm_virtualsystemmanagementservice-class"></a>Removekvpitems-Methode der MSVM \_ virtualsystemmanagementservice-Klasse

Entfernt vorhandene Schlüssel-Wert-Paare aus einer virtuellen Maschine.
...
Ein Array von Schlüssel-Wert-Paaren, die entfernt werden sollen (nur die Schlüssel müssen abgeglichen werden). Jedes Element des Arrays ist eine eingebettete Instanz der [**MSVM-Klasse \_ kvpexchangedataitem**](msvm-kvpexchangedataitem.md) . Diese Methode schlägt fehl, wenn eines der angegebenen Schlüssel-Wert-Paare nicht auf dem Zielsystem vorhanden ist. Dieses Array kann höchstens 128 Elemente enthalten.
...
Im folgenden c#-Beispiel werden Schlüssel-Wert-Paare von einem virtuellen Computer entfernt. Die Dienstprogramme, auf die verwiesen wird, finden Sie unter [Allgemeine Hilfsprogramme für die Virtualisierungsbeispiele (v2)](common-utilities-for-the-virtualization-samples-v2.md).
