...
---
# <a name="exporting-the-configuration-of-a-virtual-machine"></a>Exportieren der Konfiguration einer virtuellen Maschine

Die folgenden c#-und Visual Basic Scripting Edition-Beispiele (VBScript) veranschaulichen das Exportieren der Konfiguration einer virtuellen Maschine. Beispiele zum Exportieren eines virtuellen Computers finden Sie in den Themen [**exportsystemdefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) und [Exportieren einer Momentaufnahme eines virtuellen](exporting-virtual-machines.md) Computers.
...
[Exportieren einer Momentaufnahme einer virtuellen Maschine](exporting-virtual-machines.md)
