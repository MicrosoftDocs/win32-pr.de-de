---
title: Visual Index
description: Visuelle Beispiele für viele Benutzeroberflächenelemente, die im Leitfaden zur Benutzeroberfläche erläutert werden.
...
Dieser Index ist in die folgenden Abschnitte unterteilt:

-   [Steuerelemente](#controls)
-   [Befehle](#commands)
-   [Zeiger](#pointers)
-   [Windows](#windows-environment)
-   [Windows-Umgebung](#windows-environment)
-   [Visuals](#visuals)
...
| [Links](ctrl-links.md)<br/> ![Screenshot eines Befehls in blauem, unterstrichenem Text ](images/visual-index-image7.png)<br/>                                         |
| [Listenfelder](ctrl-list-boxes.md)<br/> ![Screenshot einer Liste gültiger Bildschirmauflösungen ](images/visual-index-image8.png)<br/>                               |
| [Listenansichten](ctrl-list-views.md)<br/> ![Screenshot einer Liste von Dateien ](images/visual-index-image9.png)<br/>                                                  |
| [Benachrichtigungen](mess-notif.md)<br/> ![Screenshot einer Nachricht im Benachrichtigungsbereich ](images/visual-index-image10.png)<br/>                                |
| [Statusanzeigen](progress-bars.md)<br/> ![Screenshot einer teilweise ausgefüllten Statusleiste ](images/visual-index-image11.png)<br/>                                |
| [Progressive Offenlegungskontrollen](ctrl-progressive-disclosure-controls.md)<br/> ![Screenshot mehrerer Pfeilschaltflächen ](images/visual-index-image12.png)<br/> |
...
|     &nbsp;                                                                                                                              |
|---------------------------------------------------------------------------------------------------------------------------------|
| [Menüs](cmd-menus.md)<br/> ![Screenshot des Ansichtsmenüs und seiner Untermenüs ](images/visual-index-image23.png)<br/> |
| [Symbolleisten](cmd-toolbars.md)<br/> ![Screenshot einer Symbolleiste ](images/visual-index-image24.png)<br/>                |
| [Bänder](cmd-ribbons.md)<br/> ![Screenshot des Microsoft Word-Menübands ](images/visual-index-image25.png)<br/>  |
...
|     &nbsp;                                                                                                                                              |
|-------------------------------------------------------------------------------------------------------------------------------------------------|
| [Dialogfelder](win-dialog-box.md)<br/> ![Screenshot des Dialogfelds "Windows-Hilfe" ](images/visual-index-image29.png)<br/>        |
| [Eigenschaftenfenster](win-property-win.md)<br/> ![Screenshot eines neuen Ordnereigenschaftsfensters ](images/visual-index-image30.png)<br/> |
| [Warnmeldungen](mess-warn.md)<br/> ![Screenshot einer Warnmeldung mit niedriger Akkukapazität ](images/visual-index-image31.png)<br/>       |
| [Bestätigungen](mess-confirm.md)<br/> ![Screenshot der Änderungen beim Speichern? Nachricht ](images/visual-index-image32.png)<br/>               |
...
|    &nbsp;                                                                                                                                                               |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Taskleiste](winenv-taskbar.md)<br/> ![Screenshot einer Taskleiste ](images/visual-index-image35.png)<br/>                                               |
...
|         &nbsp;                                                                                                                                           |
|--------------------------------------------------------------------------------------------------------------------------------------------------|
| [Fensterrahmen](win-window-frames.md)<br/> ![Screenshot eines Rahmens um ein Editorfenster ](images/visual-index-image38.png)<br/> |
| [Schriftarten](vis-fonts.md)<br/> ![Screenshot des Alphabets in der Windows-Systemschriftart ](images/visual-index-image39.png)<br/>             |
| [Standardsymbole](vis-std-icons.md)<br/> ![Screenshot von Fehlern, Warnungen und anderen Symbolen ](images/visual-index-image40.png)<br/>    |
