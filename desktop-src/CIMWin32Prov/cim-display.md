---
description: Die CIM \_ Display-Klasse ist eine übergeordnete Klasse zum Gruppieren verschiedener Anzeigegeräte.
...
ms.locfileid: "119321230"
---
# <a name="cim_display-class-cimwin32-wmi-providers"></a>CIM_Display-Klasse (CIMWin32-WMI-Anbieter)

Die **CIM \_ Display-Klasse** ist eine übergeordnete Klasse zum Gruppieren verschiedener Anzeigegeräte.
...
Die **CIM \_ Display-Klasse** verfügt über diese Typen von Membern:
...
Die **CIM \_ Display-Klasse** verfügt über diese Methoden.
...
Die **CIM \_ Display-Klasse** verfügt über diese Eigenschaften.
...
Freiformzeichenfolge, die Informationen zu dem Fehler liefert, der in den durchzuführenden Korrekturmaßnahmen der **LastErrorCode-Eigenschaft** aufgezeichnet wurde.
...
Die **CIM \_ Display-Klasse** wird von [**CIM \_ UserDevice**](cim-userdevice.md)abgeleitet.

WMI implementiert diese Klasse nicht. Informationen zu Klassen, die von **CIM \_ Display** abgeleitet wurden, finden Sie unter [Win32-Klassen.](win32-provider.md)
