...
Die **CIM- \_ Anzeige** Klasse ist eine übergeordnete Klasse zum Gruppieren von verschiedenen Anzeigegeräten.
...
Die **CIM- \_ Anzeige** Klasse verfügt über diese Methoden.
...
Eine frei Form Zeichenfolge, die Informationen über den Fehler bereitstellt, der in den auszuführenden Korrektur Aktionen der **LastErrorCode** -Eigenschaft aufgezeichnet wird.
...
Die **CIM- \_ Anzeige** Klasse wird von [**CIM \_ userdevice**](cim-userdevice.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu von der **CIM- \_ Anzeige** abgeleiteten Klassen finden Sie unter [Win32-Klassen](win32-provider.md)
