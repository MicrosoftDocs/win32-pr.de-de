...
---
# <a name="invoke-method-of-the-cim_filespecification-class"></a>Aufruf Methode der CIM- \_ filespecification-Klasse

Die **Aufruf** Methode der [**CIM- \_ filespecification**](cim-filespecification.md) -Klasse wertet eine bestimmte Überprüfung aus. Details darüber, wie die Methode eine bestimmte Überprüfung in einem CIM-Kontext auswertet, wird von den nicht abstrakten [**CIM- \_ Check**](cim-check.md) -Unterklassen beschrieben. Diese Methode wird von der **CIM- \_ Überprüfung** geerbt.
...
[CIM- \_ Datei Spezifikation](invoke-method-in-class-cim-filespecification.md)
</dt> <dt>
