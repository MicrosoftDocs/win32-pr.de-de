...
---
# <a name="reset-method-of-the-cim_usbdevice-class"></a>Reset-Methode der CIM- \_ Klasse "US-Gerät"

Die **Reset** -Methode der CIM- \_ Klasse "tobdevice" fordert eine zurück setzung des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[CIM-Start \_ Gerät](reset-method-in-class-cim-usbdevice.md)
</dt> <dt>
