---
description: Entpackt die logische Codecdatei (oder das Verzeichnis), die im Objektpfad angegeben ist. Diese Methode ist eine erweiterte Version der Uncompress-Methode.
...
ms.locfileid: "117834471"
---
# <a name="uncompressex-method-of-the-win32_codecfile-class"></a>UncompressEx-Methode der Win32 \_ CodecFile-Klasse

Die [WMI-Klassenmethode](/windows/desktop/WmiSdk/retrieving-a-class) **UncompressEx** entpackt die im Objektpfad angegebene logische Codecdatei (oder das Verzeichnis). Diese Methode ist eine erweiterte Version der [**Uncompress-Methode.**](uncompress-method-in-class-win32-directory.md)
...
Gibt einen ganzzahligen Wert von 0 (null) zurück, wenn die Datei erfolgreich dekomprimiert wurde, und eine beliebige andere Zahl, um einen Fehler anzugeben.
