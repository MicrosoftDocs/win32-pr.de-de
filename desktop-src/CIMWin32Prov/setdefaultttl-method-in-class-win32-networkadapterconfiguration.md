...
---
# <a name="setdefaultttl-method-of-the-win32_networkadapterconfiguration-class"></a>Setdefaultttl-Methode der Win32 \_ networkadapterconfiguration-Klasse

Die statische Methode **setdefaultttl** [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) wird verwendet, um den Standardwert für die Gültigkeitsdauer (Time to Live, TTL) im Header von ausgehenden IP-Paketen festzulegen.
...
Der Gültigkeitsdauer Wert, der im Header der ausgehenden IP-Pakete festgelegt wird. Der Standardwert ist 32; Gültiger Bereich: 1-255
...
Die Gültigkeitsdauer gibt an, wie viele Router ein IP-Paket durchlaufen kann, um das Ziel zu erreichen, bevor es verworfen wird. Jeder Router verringert die TTL-Anzahl eines Pakets um eins und verwirft die Pakete mit einer Gültigkeitsdauer von 0 (null).

## <a name="examples"></a>Beispiele

Im Beispiel [Modify the default time to Live for all Network Adapters](https://Gallery.TechNet.Microsoft.Com/scriptcenter/3a228fb8-5517-4e23-800e-2a15f427d05d) VBScript wird **setdefaultttl** verwendet, um den Standardwert für die Gültigkeitsdauer im Header der ausgehenden IP-Pakete auf 64 festzulegen.
