...
---
# <a name="reset-method-of-the-cim_volatilestorage-class"></a>Reset-Methode der CIM \_ VolatileStorage-Klasse

Die **Reset** -Methode der CIM \_ VolatileStorage-Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
