---
description: Cim PCVideoController stellt die Funktionen und die Verwaltung eines Pc-Videocontrollers dar, einem \_ Untertyp eines Videocontrollers.
...
ms.locfileid: "118678644"
---
# <a name="cim_pcvideocontroller-class"></a>CIM \_ PCVideoController-Klasse

Cim **\_ PCVideoController stellt** die Funktionen und die Verwaltung eines Pc-Videocontrollers dar, einem Untertyp eines Videocontrollers.
...
Die **CIM \_ PCVideoController-Klasse** verfügt über die folgenden Membertypen:
...
Die **CIM \_ PCVideoController-Klasse** verfügt über diese Methoden.



| Methode                                                                       | BESCHREIBUNG                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-pcvideocontroller.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcvideocontroller.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand eingedrung werden soll. Nicht von WMI implementiert.<br/> |
...
Die **CIM \_ PCVideoController-Klasse** verfügt über diese Eigenschaften.
...
Qualifizierer: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ VideoController**](cim-videocontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Grafik- und 3D-Funktionen des Videocontrollers.

Diese Eigenschaft wird von [**CIM \_ VideoController geerbt.**](cim-videocontroller.md)
...
<span id="Graphics_Accelerator"></span><span id="graphics_accelerator"></span><span id="GRAPHICS_ACCELERATOR"></span>**Grafikbeschleunigung** (2)
...
Qualifizierer: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ VideoController**](cim-videocontroller.md).**AcceleratorCapabilities**")
</dt> </dl>

Freiformzeichenfolgen, die ausführliche Erläuterungen zu Videobeschleunigungsfeatures bereitstellen, die im **AcceleratorCapabilities-Array angegeben** sind.

> [!Note]  
> Jeder Arrayeintrag bezieht sich auf den Eintrag im **AcceleratorCapabilities-Array,** der sich am gleichen Index befindet.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.12"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Bits")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.11"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Pixel")
</dt> </dl>
...
Anzahl der farben, die in den aktuellen Auflösungen unterstützt werden.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.14")
</dt> </dl>

Im Zeichenmodus die Anzahl der Spalten für den Videocontroller. Geben Sie andernfalls 0 ein.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.13")
</dt> </dl>

Im Zeichenmodus die Anzahl der Zeilen für diesen Videocontroller. Geben Sie andernfalls 0 ein.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.15"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("hertz")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.8")
</dt> </dl>

Aktueller Scanmodus. Diese Eigenschaft wird von [**CIM \_ VideoController**](cim-videocontroller.md)geerbt.
...
<span id="Non_Interlaced"></span><span id="non_interlaced"></span><span id="NON_INTERLACED"></span>**Nicht geschachtelt** (4)
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.10"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Pixel")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Bus Port \| 001.9")
</dt> </dl>

Maximale Anzahl direkt adressierbarer Entitäten, die vom Controller unterstützt werden. Der Wert 0 sollte verwendet werden, wenn die Zahl unbekannt oder unbegrenzt ist.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.5"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("hertz")
</dt> </dl>

Maximale Aktualisierungsrate des Videocontrollers in Hertz.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.4"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("hertz")
</dt> </dl>

Minimale Aktualisierungsrate des Videocontrollers in Hertz.
...
Aktuelle Anzahl von Farbebenen. Wenn dieser Wert für die aktuelle Videokonfiguration nicht gilt, geben Sie 0 ein.
...
Anzahl der unterstützten Videoseiten aufgrund der aktuellen Auflösungen und des verfügbaren Arbeitsspeichers.
...
Diese Eigenschaft wird vom [**\_ CIM-Controller**](cim-controller.md)geerbt. Gültige Werte:
...
SCSI Serial Storage Architecture (13) **(SCSI-Architektur** für serielle Storage (13))
...
Datum und Uhrzeit der letzten Zurücksetzung dieses Controllers, d. h., der Controller wurde heruntergefahren oder erneut initialisiert.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.2")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.6")
</dt> </dl>

Typ des Videospeichers.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video \| 003.3")
</dt> </dl>
...
Freiformzeichenfolge, die den Videoprozessor/Controller beschreibt.
...
Die **CIM \_ PCVideoController-Klasse** wird von [**CIM \_ VideoController**](cim-videocontroller.md)abgeleitet.

WMI implementiert diese Klasse nicht. Informationen zu WMI-Klassen, die von [**CIM \_ PCVideoController**](cim-videocontroller.md)abgeleitet werden, finden Sie unter [Win32-Klassen.](win32-provider.md)
