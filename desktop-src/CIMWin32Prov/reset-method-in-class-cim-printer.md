...
---
# <a name="reset-method-of-the-cim_printer-class"></a>Reset-Methode der CIM- \_ Drucker Klasse

Die **Reset** -Methode der CIM- \_ Drucker Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[CIM- \_ Drucker](reset-method-in-class-cim-printer.md)
</dt> <dt>
