---
description: Die GetDescriptor-Methode gibt den USB-Hubdeskriptor zurück, wie von den Eingabeparametern angegeben.
...
ms.locfileid: "119879050"
---
# <a name="getdescriptor-method-of-the-cim_usbhub-class"></a>GetDescriptor-Methode der \_ CIM-USBHub-Klasse

Die **GetDescriptor-Methode** gibt den USB-Hubdeskriptor zurück, wie von den Eingabeparametern angegeben.
...
Buffer gibt die angeforderten Deskriptorinformationen zurück. Wenn der Deskriptor nicht vorhanden ist, ist der Inhalt des Puffers nicht definiert.
