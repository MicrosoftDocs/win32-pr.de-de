...
---
# <a name="cim_cdromdrive-class-cimwin32-wmi-providers"></a>CIM_CDROMDrive-Klasse (cimwin32-WMI-Anbieter)

Die **CIM- \_ cdromdrive** -Klasse stellt ein CD-ROM-Laufwerk auf dem Computer dar.

> [!Note]  
> Der Name des Laufwerks entspricht nicht dem Buchstaben des logischen Laufwerks, das dem Gerät zugewiesen ist. Dies ist der Name des logischen Speichergeräts, das vom Laufwerk abhängig ist.
...
Die **CIM- \_ cdromdrive** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM- \_ cdromdrive** -Klasse verfügt über diese Methoden.
...
Die **CIM- \_ cdromdrive** -Klasse verfügt über diese Eigenschaften.
...
Die **CIM- \_ cdromdrive** -Klasse wird von [**CIM \_ mediaaccessdevice**](cim-mediaaccessdevice.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Weitere Informationen zu Klassen, die von **CIM \_ cdromdrive** abgeleitet sind, finden Sie unter [Win32-Klassen](win32-provider.md).
