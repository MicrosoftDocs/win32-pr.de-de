---
description: Die CIM \_ SerialController-Klasse stellt die Funktionen und die Verwaltung des logischen Seriellen Anschlussgeräts dar.
...
ms.locfileid: "119919910"
---
# <a name="cim_serialcontroller-class-cimwin32-wmi-providers"></a>CIM_SerialController -Klasse (CIMWin32-WMI-Anbieter)

Die **CIM \_ SerialController-Klasse** stellt die Funktionen und die Verwaltung des logischen Seriellen Anschlussgeräts dar.
...
Die **CIM \_ SerialController-Klasse** verfügt über diese Membertypen:
...
Die **CIM \_ SerialController-Klasse** verfügt über diese Methoden.



| Methode                                                                      | BESCHREIBUNG                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-serialcontroller.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-serialcontroller.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand eingedrung werden soll. Nicht von WMI implementiert.<br/> |
...
Qualifizierer: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Serielle \| DMTF-Ports \| 004.7"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ SerialController**.**CapabilityDescriptions**")
</dt> </dl>

Kompatibilität auf Chipebene für den seriellen Controller. Diese Eigenschaft beschreibt die Pufferung und andere Funktionen des seriellen Controllers, die der Chiphardware inhärent sein können. Diese Eigenschaft ist eine aufzählte ganze Zahl.
...
Freiformzeichenfolgen, die ausführliche Erläuterungen zu den features des seriellen Controllers bereitstellen, die im **Capabilities-Array angegeben** sind.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Serielle \| DMTF-Ports \| 004.6"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Bits pro Sekunde")
</dt> </dl>

Maximale Baudrate in Bits pro Sekunde, die vom seriellen Controller unterstützt wird.
...
Die **CIM \_ SerialController-Klasse** wird von [**CIM \_ Controller**](cim-controller.md)abgeleitet.

WMI implementiert diese Klasse nicht. Informationen zu WMI-Klassen, die von **CIM \_ SerialController** abgeleitet werden, finden Sie unter [Win32-Klassen.](win32-provider.md)
