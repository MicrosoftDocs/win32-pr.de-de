...
---
# <a name="reset-method-of-the-cim_discretesensor-class"></a>Reset-Methode der CIM \_ diskretesensor-Klasse
...
[CIM \_ diskretesensor](reset-method-in-class-cim-discretesensor.md)
</dt> <dt>
