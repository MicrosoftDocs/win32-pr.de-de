...
---
# <a name="startservice-method-of-the-win32_baseservice-class"></a>Start Service-Methode der Win32 \_ baseservice-Klasse

Die **Start Service** -Methode versucht, den Dienst in seinen Startzustand zu versetzen.
