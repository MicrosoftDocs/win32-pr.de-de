...
---
# <a name="cim_usbdevice-class-cimwin32-wmi-providers"></a>CIM_USBDevice-Klasse (cimwin32-WMI-Anbieter)

Die **CIM \_** -Klasse "-Klasse" stellt die Verwaltungsmerkmale eines USB-Geräts dar.
...
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**GetDescriptor**](getdescriptor-method-in-class-cim-usbdevice.md) | Gibt den USB-Gerätedeskriptor zurück. Wird nicht von WMI implementiert.<br/>                                                                    |
| [**Zurücksetzen**](reset-method-in-class-cim-usbdevice.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbdevice.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Konfiguration, die zurzeit für das Gerät ausgewählt ist. Wenn der Wert 0 (null) ist, wird das Gerät nicht konfiguriert.
...
Die **CIM \_** -Klasse "-Klasse" ist von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu WMI-Klassen, die CIM-Start **\_ Gerät** implementieren, finden Sie unter [Win32-Klassen](win32-provider.md).
