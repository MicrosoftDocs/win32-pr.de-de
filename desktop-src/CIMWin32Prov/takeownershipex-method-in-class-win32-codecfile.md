...
---
# <a name="takeownershipex-method-of-the-win32_codecfile-class"></a>Takebesitzshipex-Methode der Win32 \_ codecfile-Klasse

Die " **takebesitzshipex** "- [WMI-Klassen](/windows/desktop/WmiSdk/retrieving-a-class) Methode erhält den Besitz der im Objekt Pfad angegebenen logischen Codec-Datei. Diese Methode ist eine erweiterte Version der [**TakeOwnership**](takeownership-method-in-class-win32-directory.md) -Methode. Wenn die logische Datei tatsächlich ein Verzeichnis ist, wird diese Methode rekursiv durchlaufen und übernimmt den Besitz aller Dateien und Unterverzeichnisse, die das Verzeichnis enthält.
