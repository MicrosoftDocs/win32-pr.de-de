...
---
# <a name="startservice-method-of-the-cim_service-class-cimwin32-wmi-providers"></a>Start Service-Methode der CIM_Service-Klasse (cimwin32-WMI-Anbieter)
...
Gibt bei Erfolg den Wert 0 (null) zurück, und jede andere Zahl gibt einen Fehler an. In einer Unterklasse kann der Satz möglicher Rückgabecodes mit einem **ValueMap** -Qualifizierer für die-Methode angegeben werden. Die Zeichen folgen, in die der **ValueMap** -Inhalt übersetzt wird, können auch in der Unterklasse als **Werte** Array Qualifizierer angegeben werden.
...
[CIM- \_ Dienst](startservice-method-in-class-cim-service.md)
</dt> <dt>
