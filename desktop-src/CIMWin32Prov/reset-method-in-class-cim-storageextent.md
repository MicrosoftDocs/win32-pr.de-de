...
---
# <a name="reset-method-of-the-cim_storageextent-class"></a>Reset-Methode der CIM \_ storageblock-Klasse

Die **Reset** -Methode der CIM \_ storageblock-Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[CIM- \_ storageblock](reset-method-in-class-cim-storageextent.md)
</dt> <dt>
