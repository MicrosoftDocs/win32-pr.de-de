...
Diese Klasse wird von WMI nicht implementiert. Informationen zu Klassen, die von [**CIM \_ diskettedrive**](cim-diskettedrive.md)abgeleitet sind, finden Sie unter [Win32 Classes](win32-provider.md).
...
[CIM- \_ Diskettelaufwerk](setpowerstate-method-in-class-cim-diskettedrive.md)
</dt> <dt>
