...
---
# <a name="cim_remotefilesystem-class"></a>CIM- \_ remotefile System-Klasse

Die **CIM- \_ remotefile** System-Klasse stellt ein Remote Dateisystem dar, auf das über einen netzwerkbezogenen Dienst zugegriffen wird. In diesem Fall wird der Dateispeicher von einem Computer gehostet, der als Dateiserver fungiert. Der Dateispeicher für ein NFS-Dateisystem befindet sich z. b. in der Regel nicht auf den lokal kontrollierten Medien eines Computer Systems, und der Zugriff darauf erfolgt nicht direkt über einen Gerätetreiber. Unterklassen von **CIM \_ remotefile** System enthalten Client seitige Konfigurationsinformationen, die sich auf den Zugriff auf das Dateisystem beziehen.
...
Die **CIM- \_ remotefile System** -Klasse verfügt über diese Typen von Membern:

-   [Eigenschaften](#properties)

### <a name="properties"></a>Eigenschaften

Die **CIM- \_ remotefile System** -Klasse verfügt über diese Eigenschaften.
...
Die Menge des freien Speicherplatzes für das Dateisystem in Bytes. Wenn unbekannt, geben Sie 0 ein.
...
Größe (in Bytes) der Blöcke, die den Speicherblock bilden. Wenn unbekannt, oder wenn ein Block Konzept nicht gültig ist (z. b. für Aggregat Blöcke, Arbeitsspeicher oder logische Datenträger), geben Sie 1 (eins) ein.
...
Vom Dateisystem Unterstützte Zeichensätze oder Codierungen. Diese Eigenschaft wird vom [**CIM- \_ Dateisystem**](cim-filesystem.md)geerbt.
...
Maximale Länge eines Datei namens innerhalb des Dateisystems. Der Wert 0 gibt an, dass die Länge des Datei namens unbegrenzt ist.
...
Die **CIM- \_ remotefile System** -Klasse wird vom [**CIM- \_ Dateisystem**](cim-filesystem.md)abgeleitet.
