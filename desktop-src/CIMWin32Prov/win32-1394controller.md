...
---
# <a name="win32_1394controller-class"></a>Win32- \_ Klasse "1394controller"

Die Win32- [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) " **\_ 1394controller** " stellt die Funktionen und die Verwaltung eines 1394-Controllers dar. IEEE 1394 ist eine Spezifikation für einen hoch Geschwindigkeits seriellen Bus.
...
Die Win32-Klasse " **\_ 1394controller** " verfügt über diese Typen von Membern:
...
Die Win32-Klasse " **\_ 1394controller** " verfügt über diese Methoden.
...
Die Win32-Klasse " **\_ 1394controller** " verfügt über diese Eigenschaften.
...
Die Win32-Klasse " **\_ 1394controller** " wird vom [**CIM- \_ Controller**](cim-controller.md)abgeleitet.

## <a name="examples"></a>Beispiele

Das folgende PowerShell-Codebeispiel ruft Controller Informationen ab.
