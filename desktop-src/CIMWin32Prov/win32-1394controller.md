...
ms.locfileid: "119546590"
---
# <a name="win32_1394controller-class"></a>Win32 \_ 1394Controller-Klasse

Die [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) **Win32 \_ 1394Controller** stellt die Funktionen und die Verwaltung eines 1394-Controllers dar. IEEE 1394 ist eine Spezifikation für einen seriellen Hochgeschwindigkeitsbus.
...
Die **Win32 \_ 1394Controller-Klasse** verfügt über folgende Typen von Membern:
...
Die **Win32 \_ 1394Controller-Klasse** verfügt über diese Methoden.



| Methode            | Beschreibung                                                                                                                                                                                                |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie in der Dokumentation zur [**Reset-Methode**](reset-method-in-class-cim-controller.md) in [**CIM \_ Controller.**](cim-controller.md)<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie in der Dokumentation zur [**SetPowerState-Methode**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ Controller.**](cim-controller.md)<br/> |
...
Die **Win32 \_ 1394Controller-Klasse** verfügt über diese Eigenschaften.
...
Eindeutiger Bezeichner dieses Controllers.
...
Der Datums- und Uhrzeitcontroller wurde zuletzt zurückgesetzt. Dies kann bedeuten, dass der Controller ausgeschaltet oder erneut initialisiert wurde.
...
Die **Win32 \_ 1394Controller-Klasse** wird vom [**\_ CIM-Controller abgeleitet.**](cim-controller.md)

## <a name="examples"></a>Beispiele

Im folgenden PowerShell-Codebeispiel werden Controllerinformationen abgerufen.
