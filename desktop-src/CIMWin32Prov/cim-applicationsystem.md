...
Die **CIM- \_ applicationsystem** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM- \_ applicationsystem** -Klasse wird vom [**CIM- \_ System**](cim-system.md)abgeleitet.
