---
description: Die CIM \_ UninterruptiblePowerSupply-Klasse stellt die Funktionen und die Verwaltung einer unterbrechungslosen Stromversorgung (USV) dar.
...
ms.locfileid: "119817560"
---
# <a name="cim_uninterruptiblepowersupply-class"></a>CIM \_ UninterruptiblePowerSupply-Klasse

Die **CIM \_ UninterruptiblePowerSupply-Klasse** stellt die Funktionen und die Verwaltung einer unterbrechungslosen Stromversorgung (USV) dar. Die Eigenschaften des UPS-Geräts geben an, wann die eingehende Stromversorgung gekürzt oder verstärkt wird, und die aggregierten Informationen der Akkus, Generatoren usw., aus denen das Gerät besteht. Die einzelnen Komponenten (z. B. mehrere Akkus) können auch unabhängig modelliert und dem USV zugeordnet werden.
...
Die **CIM \_ UninterruptiblePowerSupply-Klasse** verfügt über diese Typen von Membern:
...
Die **CIM \_ UninterruptiblePowerSupply-Klasse** verfügt über diese Methoden.



| Methode                                                                                | BESCHREIBUNG                                                                                                                              |
|:--------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-uninterruptiblepowersupply.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-uninterruptiblepowersupply.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand versetzt werden soll. Nicht von WMI implementiert.<br/> |
...
Die **CIM \_ UninterruptiblePowerSupply-Klasse** verfügt über diese Eigenschaften.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|DMTF-Stromversorgung \| 002.15")
</dt> </dl>

Der Eingangsspannungsbereich wird derzeit verwendet. Wenn die Stromversorgung derzeit keine Stromversorgung aufzeichnet, kann der Wert 6 ("Keine") angegeben werden. Diese Informationen sind im Fall einer USV, einer Unterklasse von [**CIM \_ PowerSupply,**](cim-powersupply.md)erforderlich.

Diese Eigenschaft wird von [**CIM \_ PowerSupply**](cim-powersupply.md)geerbt.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| UPS Battery \| 001.4"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("percent")
</dt> </dl>

Prozentuale Schätzung der verbleibenden vollständigen Gebühr für eine USV, die Akkutechnologie verwendet.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| UPS Battery \| 001.3"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("minutes")
</dt> </dl>

Geschätzte Zeit in Minuten, bis der Akku, generator oder eine andere Stromquelle unter den aktuellen Auslastungsbedingungen erschöpft ist, wenn die Stromversorgung des Hilfsprogramms ausgeschaltet ist oder verloren geht und aus bleibt.
...
True **gibt an,** dass es sich bei der Stromversorgung um eine wechselförmige (nicht lineare) Stromversorgung handelt.

Diese Eigenschaft wird von [**CIM \_ PowerSupply geerbt.**](cim-powersupply.md)
...
Häufigkeit in Hertz am ende des Eingangsfrequenzbereichs der Stromversorgung 1. Der Wert 0 (null) impliziert DC.
...
Frequenz in Hertz am unteren Ende des Eingabefrequenzbereichs der Stromversorgung 1. Der Wert 0 (null) impliziert DC.
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range1InputVoltageHigh"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Millivolts")
</dt> </dl>

Wenn die Spannung in Millivolt über den wert steigt, der von der **Range1InputVoltageHigh-Eigenschaft** angegeben wird, gleicht die USV dies durch Kürzen der Spannung aus. Der Wert 0 (null) gibt an, dass die Spannung, bei der das Kürzen auftritt, unbekannt ist.
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range1InputVoltageLow"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Millivolts")
</dt> </dl>

Wenn die Potenz in Millivolt unter den wert sinkt, der von der **Range1InputVoltageLow-Eigenschaft** angegeben wird, gleicht die USV dies aus, indem sie die Potenz mithilfe ihrer Stromquellen verstärkt. Der Wert 0 gibt an, dass die Spannung, bei der eine Verstärkung auftritt, unbekannt ist.
...
Frequenz in Hertz am Ende des Eingangsfrequenzbereichs der Stromversorgung 2. Der Wert 0 (null) impliziert DC.
...
Häufigkeit in Hertz am unteren Ende des Eingabefrequenzbereichs der Stromversorgung 2. Der Wert 0 impliziert DC.
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range2InputVoltageHigh"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Millivolts")
</dt> </dl>

Wenn die Spannung in Millivolt über den wert steigt, der von der **Range2InputVoltageHigh-Eigenschaft** angegeben wird, gleicht die USV dies durch Kürzen der Spannung aus. Der Wert 0 (null) gibt an, dass die Spannung, bei der das Kürzen auftritt, unbekannt ist.
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range2InputVoltageLow"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Millivolts")
</dt> </dl>

Wenn die Potenz in Millivolt unter den wert sinkt, der von der **Range2InputVoltageLow-Eigenschaft** angegeben wird, gleicht die USV dies aus, indem sie die Potenz mithilfe ihrer Stromquellen verstärkt. Der Wert 0 (null) gibt an, dass die Spannung, bei der eine Verstärkung auftritt, unbekannt ist.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| UPS Battery \| 001.1")
</dt> </dl>

Angabe der Kapazität, die in den Akkus, Generatoren oder anderen Quellen des USV verbleibt.
...
Die verbleibenden geschätzten Minuten der Laufzeit sind größer als der vom USV definierte Energiesparzustand (in der Regel zwei Minuten).
...
Die verbleibenden geschätzten Minuten der Laufzeit sind kleiner oder gleich dem definierten Energiesparzustand der USV.
...
Der USV kann die aktuelle Last nicht aufrechterhalten, wenn der Strom des Hilfsprogramms verloren geht (einschließlich der Möglichkeit, dass der Strom des Hilfsprogramms derzeit nicht vorhanden ist).
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| UPS Battery \| 001.2"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("seconds")
</dt> </dl>

Verstrichene Zeit in Sekunden seit dem letzten Wechsel der USV zum Akku, Generator oder einer anderen Stromquelle. Oder die Zeit seit dem letzten Neustart der UPS, je nachdem, welcher Wert geringer ist. Wenn die UPS online ist, wird 0 (null) zurückgegeben.
...
Gesamtausgabeleistung der Stromversorgung in Milliwatt. Der Wert 0 (null) steht für unbekannt.
...
Typ des in der Stromversorgung implementierten Eingangs-/Spannungsbereichswechsels.
...
Die **CIM \_ UninterruptiblePowerSupply-Klasse** wird von [**CIM \_ PowerSupply**](cim-powersupply.md)abgeleitet.

WMI implementiert diese Klasse nicht. Informationen zu WMI-Klassen, die von **CIM \_ UninterruptiblePowerSupply** abgeleitet werden, finden Sie unter [Win32-Klassen.](win32-provider.md)
