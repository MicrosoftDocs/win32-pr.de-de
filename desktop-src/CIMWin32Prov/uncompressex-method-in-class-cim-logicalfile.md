---
description: Dekomprimiert die logische Datei (oder das Verzeichnis), die im Objektpfad angegeben ist. Diese Methode ist eine erweiterte Version der Uncompress-Methode.
...
ms.locfileid: "117834461"
---
# <a name="uncompressex-method-of-the-cim_logicalfile-class"></a>UncompressEx-Methode der CIM \_ LogicalFile-Klasse

Die **UncompressEx-Methode** entkomprimiert die logische Datei (oder das Verzeichnis), die im Objektpfad angegeben ist. Diese Methode ist eine erweiterte Version der [**Uncompress-Methode.**](uncompress-method-in-class-cim-logicalfile.md)
