---
description: Die Reset-Methode der CIM \_ TemperatureSensor-Klasse fordert eine Zurücksetzung des logischen Geräts an.
...
ms.locfileid: "119700770"
---
# <a name="reset-method-of-the-cim_temperaturesensor-class"></a>Reset-Methode der CIM \_ TemperatureSensor-Klasse

Die **Reset-Methode** der CIM \_ TemperatureSensor-Klasse fordert eine Zurücksetzung des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice geerbt.**](cim-logicaldevice.md)
