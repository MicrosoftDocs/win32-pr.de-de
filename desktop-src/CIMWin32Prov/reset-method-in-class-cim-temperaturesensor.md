...
Die **Reset** -Methode der CIM \_ temperaturesensor-Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[CIM- \_ Temperatursensor](reset-method-in-class-cim-temperaturesensor.md)
</dt> <dt>
