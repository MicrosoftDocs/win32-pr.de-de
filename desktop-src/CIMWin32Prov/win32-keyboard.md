...
---
# <a name="win32_keyboard-class"></a>Win32- \_ Tastatur Klasse

Die [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) der **Win32- \_ Tastatur** stellt eine Tastatur dar, die auf einem Computersystem mit Windows installiert ist.
...
Die **Win32- \_ Tastatur** Klasse verfügt über diese Typen von Membern:
...
Die **Win32- \_ Tastatur** Klasse verfügt über diese Methoden.



| Methode            | BESCHREIBUNG                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der Methode " [**Reset**](reset-method-in-class-cim-controller.md) " in der [**CIM- \_ Tastatur**](cim-keyboard.md) für die Dokumentation.<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) -Methode in der [**CIM- \_ Tastatur**](cim-keyboard.md) für die Dokumentation.<br/> |
...
Die **Win32- \_ Tastatur** Klasse verfügt über diese Eigenschaften.
...
Qualifizierer: [**außer Kraft**](/windows/desktop/WmiSdk/standard-qualifiers) Setzung ("Geräte-ID"), [**Schlüssel**](/windows/desktop/WmiSdk/key-qualifier)
</dt> </dl>
...
Weitere Informationen zu dem Fehler, der in **LastErrorCode** aufgezeichnet wurde, sowie Korrekturmaßnahmen, die möglicherweise ausgeführt werden.
...
Eine frei Form Zeichenfolge, die das Layout der Tastatur angibt.

Diese Eigenschaft wird von der [**CIM- \_ Tastatur**](cim-keyboard.md)geerbt.
...
Der Status des auf der Tastatur (Wert = 4) aktivierten Kennworts auf Hardwareebene, wodurch lokale Eingaben verhindert werden.
...
Die **Win32- \_ Tastatur** Klasse wird von der [**CIM- \_ Tastatur**](cim-keyboard.md)abgeleitet.

## <a name="examples"></a>Beispiele

Der folgende PowerShell-Code findet eine drahtlose Tastatur und Maus.
...
Im folgenden VBScript-Beispiel werden die Tastatur Eigenschaften aufgelistet.
