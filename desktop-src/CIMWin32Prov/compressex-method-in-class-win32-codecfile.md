...
Die [WMI-Klassen](/windows/desktop/WmiSdk/retrieving-a-class) Methode **CompressEx** komprimiert die im Objekt Pfad angegebene logische Codec-Datei (oder das angegebene Verzeichnis) (diese Methode ist eine erweiterte Version der Methode [**Compress**](compress-method-in-class-win32-directory.md) ).
