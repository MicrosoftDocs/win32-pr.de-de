...
---
# <a name="cim_multistatesensor-class"></a>CIM \_ multistaatensor-Klasse

Die **CIM \_ multistaatensor** -Klasse stellt eine multimember-Gruppe von binären Sensoren dar, in der jeder binäre Sensor ein boolesches Ergebnis meldet.
...
Die **CIM \_ multistaatensor** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM \_ multistaatensor** -Klasse verfügt über diese Methoden.



| Methode                                                                      | BESCHREIBUNG                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-multistatesensor.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-multistatesensor.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Die **CIM \_ multistaatensor** -Klasse verfügt über diese Eigenschaften.
...
Die **CIM \_ multistaatensor** -Klasse wird vom [**CIM- \_ Sensor**](cim-sensor.md)abgeleitet.
