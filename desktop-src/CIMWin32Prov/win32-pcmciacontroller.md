---
description: Win32 \_ PCMCIAController &\# 32; Die WMI-Klasse verwaltet die Funktionen eines PCMCIA-Controllergeräts (Personal Computer Memory Card Interface Adapter).
...
ms.locfileid: "117834160"
---
# <a name="win32_pcmciacontroller-class"></a>Win32 \_ PCMCIAController-Klasse

Die [WMI-Klasse](../wmisdk/retrieving-a-class.md) **Win32 \_ PCMCIAController** verwaltet die Funktionen eines PCMCIA-Controllergeräts (Personal Computer Memory Card Interface Adapter).
...
Die **Win32 \_ PCMCIAController-Klasse** verfügt über folgende Typen von Membern:
...
Die **Win32 \_ PCMCIAController-Klasse** verfügt über diese Methoden.



| Methode            | Beschreibung                                                                                                                                                                                          |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zum Implementieren dieser [](reset-method-in-class-cim-controller.md) Methode finden Sie unter Reset-Methode in [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie in der [**SetPowerState-Methode**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ PCMCIAController.**](cim-pcmciacontroller.md)<br/> |
...
Die **Win32 \_ PCMCIAController-Klasse** verfügt über diese Eigenschaften.
...
Qualifizierer: [**Überschreiben**](../wmisdk/standard-qualifiers.md) ("DeviceId"), [**Schlüssel**](../wmisdk/key-qualifier.md), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("WMI")
</dt> </dl>

Eindeutiger Bezeichner dieses Geräts mit anderen Peripheriegeräten unter Verwendung des Plug & Play-BIOS. Diese Eigenschaft wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)abgeleitet.
...
Diese Eigenschaft wird von [**CIM \_ PCMCIAController geerbt.**](cim-pcmciacontroller.md)
...
Diese Eigenschaft wird vom [**\_ CIM-Controller geerbt.**](cim-controller.md) Die Werte werden in der folgenden Liste angezeigt.
...
SCSI Serial Storage Architecture (13) (Architektur der seriellen **SCSI-Storage** (13))
...
Die **Win32 \_ PCMCIAController-Klasse** wird von [**CIM \_ PCMCIAController abgeleitet.**](cim-pcmciacontroller.md)
