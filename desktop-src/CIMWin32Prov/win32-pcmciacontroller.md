...
Die **Win32 \_ PCMCIAController** - [WMI-Klasse](../wmisdk/retrieving-a-class.md) verwaltet die Funktionen eines Geräteschnittstellen Adapters für PCs (PCMCIA) eines PC-Karten Controllers.
...
Die **Win32- \_ PCMCIAController** -Klasse verfügt über diese Typen von Membern:
...
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**Reset**](reset-method-in-class-cim-controller.md) -Methode in [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) -Methode in [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).<br/> |
...
Qualifizierer: [**außer Kraft**](../wmisdk/standard-qualifiers.md) Setzung ("Geräte-ID"), [**Key**](../wmisdk/key-qualifier.md), [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("WMI")
</dt> </dl>

Eindeutiger Bezeichner dieses Geräts mit anderen Peripheriegeräten, die das Plug & Play BIOS verwenden. Diese Eigenschaft wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)abgeleitet.
...
Diese Eigenschaft wird von [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md)geerbt.
...
Diese Eigenschaft wird vom [**CIM- \_ Controller**](cim-controller.md)geerbt. Die Werte werden in der folgenden Liste angezeigt.
...
Die **Win32- \_ PCMCIAController** -Klasse wird von [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md)abgeleitet.
