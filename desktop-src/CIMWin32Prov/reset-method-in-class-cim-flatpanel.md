---
description: Die Reset-Methode der CIM \_ FlatPanel-Klasse fordert eine Zurücksetzung des logischen Geräts an.
...
ms.locfileid: "119218080"
---
# <a name="reset-method-of-the-cim_flatpanel-class"></a>Reset-Methode der CIM \_ FlatPanel-Klasse

Die **Reset-Methode** der CIM \_ FlatPanel-Klasse fordert eine Zurücksetzung des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice geerbt.**](cim-logicaldevice.md)
