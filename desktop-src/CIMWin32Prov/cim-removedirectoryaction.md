...
Die **CIM \_ removedirectoryaction** -Klasse entfernt Verzeichnisse für Software Elemente.
...
Die **CIM \_ removedirectoryaction** -Klasse verfügt über diese Typen von Membern:
...
|:-------------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-removedirectoryaction.md) | Führt eine bestimmte Aktion aus. Wird nicht von WMI implementiert.<br/> |
...
Wenn der Wert **true** ist, muss das Verzeichnis leer sein, um entfernt werden zu können.
...
Die **CIM \_ removedirectoryaction** -Klasse wird von [**CIM \_ directoryaction**](cim-directoryaction.md)abgeleitet.
