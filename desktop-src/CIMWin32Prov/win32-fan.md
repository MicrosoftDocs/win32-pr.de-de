---
description: Die WMI-Klasse Win32 \_ Fan stellt die Eigenschaften eines Lüftergeräts im Computersystem dar. Beispielsweise der CPU-Lüfter für die Kühlung.
...
ms.locfileid: "120085800"
---
# <a name="win32_fan-class"></a>Win32 \_ Fan-Klasse

Die [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) **Win32 \_ Fan** stellt die Eigenschaften eines Lüftergeräts im Computersystem dar. Beispielsweise der CPU-Lüfter für die Kühlung.
...
Die **Win32 \_ Fan-Klasse** verfügt über diese Typen von Membern:
...
Die **Win32 \_ Fan-Klasse** verfügt über diese Methoden.



| Methode            | BESCHREIBUNG                                                                                                                                                                                  |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie in der Dokumentation zur [**Reset-Methode**](reset-method-in-class-cim-controller.md) in [**CIM \_ Fan.**](cim-fan.md)<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie in der Dokumentation zur [**SetPowerState-Methode**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ Fan.**](cim-fan.md)<br/> |
| **SetSpeed**      | Nicht implementiert.<br/>                                                                                                                                                                  |
...
Die **Win32 \_ Fan-Klasse** verfügt über diese Eigenschaften.
...
**True** gibt an, dass das Kühlgerät eine aktive (im Gegensatz zu passiven) Kühlung bereitstellt.

Diese Eigenschaft wird von [**CIM \_ CoolingDevice**](cim-coolingdevice.md)geerbt.
...
Qualifizierer: [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>

Derzeit angeforderte Lüftergeschwindigkeit, definiert in Umdrehungen pro Minute, wenn ein Lüfter mit variabler Geschwindigkeit unterstützt wird (**VariableSpeed** ist **TRUE**). Die aktuelle Geschwindigkeit wird durch einen Sensor ([**\_ CIM-Tachometer**](cim-tachometer.md)) bestimmt, der dem Lüfter mithilfe der [**CIM \_ AssociatedSensor-Beziehung zugeordnet**](cim-associatedsensor.md) ist.

Diese Eigenschaft wird vom [**\_ CIM-Lüfter geerbt.**](cim-fan.md)
...
Identifiziert das Lüftergerät. Diese Eigenschaft wird von [**CIM \_ LogicalDevice geerbt.**](cim-logicaldevice.md)
...
True **gibt an,** dass der Lüfter variable Geschwindigkeiten unterstützt.
...
Die **\_ Win32-Lüfterklasse** wird von [**\_ CIM-Lüfter abgeleitet.**](cim-fan.md)

## <a name="examples"></a>Beispiele

Das PowerShell-Beispiel Zum Auflisten von [Computerfächerinformationen](https://Gallery.TechNet.Microsoft.Com/d1534503-704f-4450-8dab-f3e760bf818c) ruft Informationen zu den auf einem Computer installierten Lüftern ab.

Im folgenden Beispiel werden Informationen zu den auf einem Computer installierten Lüftern abgerufen.
