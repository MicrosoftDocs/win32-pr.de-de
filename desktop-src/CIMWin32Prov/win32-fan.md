...
Die [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) für den **Win32- \_ Lüfter** stellt die Eigenschaften eines Lüfter-Geräts im Computersystem dar. Beispielsweise der CPU-Kühlungs Lüfter.
...
Die **Win32- \_ Lüfter** -Klasse verfügt über diese Typen von Membern:
...
Die **Win32- \_ Lüfter** -Klasse verfügt über diese Methoden.



| Methode            | BESCHREIBUNG                                                                                                                                                                                  |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**Reset**](reset-method-in-class-cim-controller.md) -Methode im [**CIM- \_ Lüfter**](cim-fan.md) für die Dokumentation.<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) -Methode im [**CIM- \_ Lüfter**](cim-fan.md) für die Dokumentation.<br/> |
...
Die **Win32- \_ Lüfter** -Klasse verfügt über diese Eigenschaften.
...
**True** gibt an, dass das kühl Gerät aktiv (im Gegensatz zur passiven) Kühlung bereitstellt.
...
Qualifizierer: [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Umdrehungen pro Minute")
</dt> </dl>

Aktuell angeforderte Lüfter-Geschwindigkeit (in Umdrehungen pro Minute definiert), wenn ein variabler Geschwindigkeits Lüfter unterstützt wird (**variablespeed** ist **true**). Die aktuelle Geschwindigkeit wird durch einen Sensor ([**CIM- \_ Tachometer**](cim-tachometer.md)) bestimmt, der dem Lüfter mithilfe der [**CIM \_ associatedsensor**](cim-associatedsensor.md) -Beziehung zugeordnet ist.

Diese Eigenschaft wird vom [**CIM- \_ Lüfter**](cim-fan.md)geerbt.
...
Identifiziert das Lüfter-Gerät. Diese Eigenschaft wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
**True** gibt an, dass der Lüfter Variablen Geschwindigkeiten unterstützt.
...
Die **Win32- \_ Lüfter** -Klasse wird vom [**CIM- \_ Lüfter**](cim-fan.md)abgeleitet.

## <a name="examples"></a>Beispiele

Das PowerShell-Beispiel " [List Computer Fan Information](https://Gallery.TechNet.Microsoft.Com/d1534503-704f-4450-8dab-f3e760bf818c) " Ruft Informationen zu den auf einem Computer installierten Kühlungs Lüfter ab.

Im folgenden Beispiel werden Informationen zu den auf einem Computer installierten Kühlungs Lüfter abgerufen.
