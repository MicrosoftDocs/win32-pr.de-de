...
Die **CIM \_ Diskpartition** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM \_ Diskpartition** -Klasse verfügt über diese Methoden.



| Methode                                                                   | BESCHREIBUNG                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-diskpartition.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-diskpartition.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Die **CIM \_ Diskpartition** -Klasse verfügt über diese Eigenschaften.
...
Gibt an, ob die Medien lesbar, beschreibbar oder beides sind, z. b.. Diese Eigenschaft wird von [**CIM \_ storageblock**](cim-storageextent.md)geerbt.
...
Größe (in Bytes) der Blöcke, die den Speicherblock bilden. Wenn es sich um eine Variable Blockgröße handelt, muss die maximale Blockgröße in Bytes angegeben werden. Wenn die Blockgröße unbekannt ist oder ein Block Konzept nicht gültig ist (z. b. für Aggregat Blöcke, Arbeitsspeicher oder logische Datenträger), geben Sie den Wert 1 ein.
...
Wenn der Wert **true** ist, wird die Datenträger Partition als Start fähige Bezeichnung bezeichnet. Dies bedeutet nicht, dass ein Betriebssystem auf der Partition geladen wird.
...
Eine frei Form Zeichenfolge, die weitere Informationen über den Fehler bereitstellt, der in der **LastErrorCode** -Eigenschaft aufgezeichnet wurde, sowie die auszuführenden Maßnahmen.
...
Wenn der Wert **true** ist, wird die Datenträger Partition als primäre Partition für ein Computersystem bezeichnet.
...
Beschreibt die Medien und deren Verwendung.
...
Die **CIM \_ Diskpartition** -Klasse wird von [**CIM \_ storageblock**](cim-storageextent.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu von **CIM \_ Diskpartition** abgeleiteten Klassen finden Sie unter [Win32-Klassen](win32-provider.md).
