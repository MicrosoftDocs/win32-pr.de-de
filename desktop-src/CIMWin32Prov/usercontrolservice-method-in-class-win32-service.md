...
---
# <a name="usercontrolservice-method-of-the-win32_service-class-cimwin32-wmi-providers"></a>UserControlService-Methode der Win32_Service-Klasse (cimwin32-WMI-Anbieter)

Die **UserControlService** - [WMI-Klassen](/windows/desktop/WmiSdk/retrieving-a-class) Methode versucht, einen benutzerdefinierten Steuerelement Code an den Dienst zu senden, auf den verwiesen wird.
