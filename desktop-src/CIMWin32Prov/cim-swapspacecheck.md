---
description: Die CIM \_ SwapSpaceCheck-Klasse gibt die Menge an Auslagerungsspeicherplatz an, der auf dem System verfügbar sein muss.
...
ms.locfileid: "119919120"
---
# <a name="cim_swapspacecheck-class"></a>CIM \_ SwapSpaceCheck-Klasse

Die **CIM \_ SwapSpaceCheck-Klasse** gibt die Menge an Auslagerungsspeicherplatz an, der auf dem System verfügbar sein muss. Der Betrag wird in der **SwapSpaceSize-Eigenschaft** angegeben. Details dieser Überprüfung werden mit den entsprechenden Details in einem [**CIM \_ OperatingSystem-Objekt**](cim-operatingsystem.md) verglichen, auf das von der [**CIM \_ InstalledOS-Zuordnung**](cim-installedos.md) für das [**CIM \_ ComputerSystem-Objekt**](cim-computersystem.md) verwiesen wird, das die Umgebung beschreibt. Wenn der Wert der **TotalSwapSpaceSize-Eigenschaft** größer oder gleich dem in der **SwapSpaceSize-Eigenschaft** angegebenen Wert ist, wird die Bedingung erfüllt.
...
Die **CIM \_ SwapSpaceCheck-Klasse** verfügt über diese Typen von Membern:
...
Die **CIM \_ SwapSpaceCheck-Klasse** verfügt über diese Methoden.



| Methode                                                      | BESCHREIBUNG                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-swapspacecheck.md) | Führt eine bestimmte Aktion aus. Nicht von WMI implementiert.<br/> |
...
Die **CIM \_ SwapSpaceCheck-Klasse** verfügt über diese Eigenschaften.
...
Qualifizierer: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ OperatingSystem**](cim-operatingsystem.md).**TotalSwapSpaceSize**"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Kilobytes")
</dt> </dl>

Minimale Auslagerungsspeicherplatzgröße in Kilobyte, die auf dem Zielsystem verfügbar sein muss.
