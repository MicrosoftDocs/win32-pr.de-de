...
---
# <a name="cim_swapspacecheck-class"></a>CIM- \_ Klasse "tauapspacecheck"

Die **CIM \_ swapspacecheck** -Klasse gibt die Menge an Auslagerungs Bereich an, die auf dem System verfügbar sein muss. Der Wert wird in der Eigenschaft " **Swap** -Eigenschaft" angegeben. Die Details dieser Überprüfung werden mit den entsprechenden Details in einem [**CIM- \_ OperatingSystem**](cim-operatingsystem.md) -Objekt verglichen, auf das von der [**CIM \_ installedos**](cim-installedos.md) -Zuordnung für das [**CIM \_ Computersystem**](cim-computersystem.md) -Objekt verwiesen wird, das die Umgebung beschreibt. Wenn der Wert der **totaltauapspacesize** -Eigenschaft größer oder gleich dem Wert ist, der in der Eigenschaft " **Swap** -Eigenschaft" angegeben ist, wird die Bedingung erfüllt.
...
Die CIM-Klasse " **\_ tauapspacecheck** " verfügt über diese Typen von Membern:
...
Die CIM-Klasse " **\_ tauapspacecheck** " verfügt über diese Methoden.



| Methode                                                      | BESCHREIBUNG                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-swapspacecheck.md) | Führt eine bestimmte Aktion aus. Wird nicht von WMI implementiert.<br/> |
...
Die CIM-Klasse " **\_ tauapspacecheck** " verfügt über diese Eigenschaften.
...
Qualifizierer: [**modelcorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ OperatingSystem**](cim-operatingsystem.md)".**Totaltauapspacesize**"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) (" Kilobyte ")
</dt> </dl>

Minimale Größe des Auslagerungs Raums in Kilobyte, die auf dem Zielsystem verfügbar sein muss.
