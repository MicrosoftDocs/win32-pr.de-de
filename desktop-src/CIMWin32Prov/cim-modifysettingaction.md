...
---
# <a name="cim_modifysettingaction-class"></a>CIM \_ modifysettingaction-Klasse

Die **CIM \_ modifysettingaction** -Klasse stellt die Informationen zum Ändern einer bestimmten Einstellungsdatei für einen bestimmten Eintrag mit einem bestimmten Wert dar.
...
Die **CIM \_ modifysettingaction** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM \_ modifysettingaction** -Klasse verfügt über diese Methoden.



| Methode                                                           | BESCHREIBUNG                                                 |
|:-----------------------------------------------------------------|:------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-modifysettingaction.md) | Führt eine bestimmte Aktion aus. Wird nicht von WMI implementiert.<br/> |
...
Die **CIM \_ modifysettingaction** -Klasse verfügt über diese Eigenschaften.
...
Der Typ der Aktion, die für den angegebenen Einstellungs Eintrag ausgeführt werden soll. Bei Ergänzungen wird die Groß-/Kleinschreibung beachtet. bei der Entfernung wird jedoch davon ausgegangen, dass die Groß-/Kleinschreibung

<dt>

<span id="Create"></span><span id="create"></span><span id="CREATE"></span>

<span id="Create"></span><span id="create"></span><span id="CREATE"></span>**Erstellen** (0)


</dt> <dd>

Erstellt den angegebenen Eintrag.

</dd> <dt>

<span id="Delete"></span><span id="delete"></span><span id="DELETE"></span>

<span id="Delete"></span><span id="delete"></span><span id="DELETE"></span>**Löschen** (1)
...
<span id="Append"></span><span id="append"></span><span id="APPEND"></span>**Anfügen** (2)


</dt> <dd>

Fügt am Ende des angegebenen Eintrags an.

</dd> <dt>

<span id="Remove"></span><span id="remove"></span><span id="REMOVE"></span>

<span id="Remove"></span><span id="remove"></span><span id="REMOVE"></span>**Entfernen** (3)


</dt> <dd>

Entfernt den Wert aus dem angegebenen Eintrag.
...
Der Name des Eintrags, der geändert werden soll.
...
Der Wert, der hinzugefügt, angefügt oder ersetzt werden soll.
...
Der Dateiname des Einstellungsdatei Eintrags, der geändert werden soll.
...
Der Abschnitts Schlüssel des Einstellungs Eintrags, der geändert werden soll.
...
Die **CIM- \_ modifysettingaction** -Klasse wird von der [**CIM- \_ Aktion**](cim-action.md)abgeleitet.
