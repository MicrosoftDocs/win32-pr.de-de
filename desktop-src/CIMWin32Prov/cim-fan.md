---
description: Die \_ CIM-Lüfterklasse stellt die Funktionen und die Verwaltung eines Lüfter-Kühlgeräts dar.
...
ms.locfileid: "119923870"
---
# <a name="cim_fan-class"></a>\_CIM-Lüfterklasse

Die **\_ CIM-Lüfterklasse** stellt die Funktionen und die Verwaltung eines Lüfter-Kühlgeräts dar.
...
Die **\_ CIM-Lüfterklasse** verfügt über die folgenden Membertypen:
...
Die **\_ CIM-Lüfterklasse** verfügt über diese Methoden.



| Methode                                                         | BESCHREIBUNG                                                                                                                              |
|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-fan.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-fan.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand eingedrung werden soll. Nicht von WMI implementiert.<br/> |
| [**SetSpeed**](setspeed-method-in-class-cim-fan.md)           | Legt die Lüftergeschwindigkeit fest. Nicht von WMI implementiert.<br/>                                                                                   |
...
Die **\_ CIM-Lüfterklasse** verfügt über diese Eigenschaften.
...
True **gibt an,** dass das Kühlgerät eine aktive (im Gegensatz zu passive) Kühlung bietet.

Diese Eigenschaft wird von [**CIM \_ CoolingDevice geerbt.**](cim-coolingdevice.md)
...
Angeforderte Lüftergeschwindigkeit, definiert in Umdrehungen pro Minute, wenn ein Lüfter mit variabler Geschwindigkeit unterstützt wird. Die aktuelle Geschwindigkeit wird durch einen Sensor ([**\_ CIM-Tachometer**](cim-tachometer.md)) bestimmt, der dem Lüfter mithilfe der [**CIM \_ AssociatedSensor-Beziehung zugeordnet**](cim-associatedsensor.md) ist.
...
Die **\_ CIM-Lüfterklasse** wird von [**CIM \_ CoolingDevice**](cim-coolingdevice.md)abgeleitet.

WMI implementiert diese Klasse nicht. Informationen zu Klassen, die von **CIM \_ Fan** abgeleitet werden, finden Sie unter [Win32-Klassen.](win32-provider.md)
