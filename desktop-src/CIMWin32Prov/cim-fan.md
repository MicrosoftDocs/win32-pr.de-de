...
---
# <a name="cim_fan-class"></a>CIM- \_ Fan-Klasse

Die **CIM- \_ Lüfter** -Klasse stellt die Funktionen und die Verwaltung eines Lüfter-kühl Geräts dar.
...
Die **CIM- \_ Lüfter** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM- \_ Fan** -Klasse verfügt über diese Methoden.



| Methode                                                         | BESCHREIBUNG                                                                                                                              |
|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-fan.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-fan.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
| [**SetSpeed**](setspeed-method-in-class-cim-fan.md)           | Legt die Lüfter Geschwindigkeit fest. Wird nicht von WMI implementiert.<br/>                                                                                   |
...
Die **CIM- \_ Lüfter** -Klasse verfügt über diese Eigenschaften.
...
Die angeforderte Lüfter-Geschwindigkeit in Umdrehungen pro Minute, wenn ein variabler Geschwindigkeits Lüfter unterstützt wird. Die aktuelle Geschwindigkeit wird durch einen Sensor ([**CIM- \_ Tachometer**](cim-tachometer.md)) bestimmt, der dem Lüfter mithilfe der [**CIM \_ associatedsensor**](cim-associatedsensor.md) -Beziehung zugeordnet ist.
...
Die **CIM- \_ Fan** -Klasse wird von [**CIM \_ coolingdevice**](cim-coolingdevice.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu Klassen, die vom **CIM- \_ Lüfter** abgeleitet sind [, finden Sie](win32-provider.md)unter
