...
---
# <a name="reset-method-of-the-cim_coolingdevice-class"></a>Reset-Methode der CIM \_ coolingdevice-Klasse

Die **Reset** -Methode der CIM \_ coolingdevice-Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
