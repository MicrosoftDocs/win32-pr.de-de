...
---
# <a name="setpowerstate-method-of-the-cim_discretesensor-class"></a>SetPowerState-Methode der CIM \_ diskretesensor-Klasse
...
[CIM \_ diskretesensor](setpowerstate-method-in-class-cim-discretesensor.md)
</dt> <dt>
