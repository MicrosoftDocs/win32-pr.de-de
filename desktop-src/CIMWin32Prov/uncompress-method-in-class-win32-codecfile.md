...
---
# <a name="uncompress-method-of-the-win32_codecfile-class"></a>Uncompress-Methode der Win32- \_ codecfile-Klasse

Durch die **uncompress** - [WMI-Klassen](/windows/desktop/WmiSdk/retrieving-a-class) Methode wird die im Objekt Pfad angegebene logische Codec-Datei (oder das angegebene Verzeichnis) deinstalkomprimiert.
