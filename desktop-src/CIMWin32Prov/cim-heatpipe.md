---
description: Die CIM \_ HeatPipe-Klasse stellt die Funktionen und die Verwaltung eines Wärmeleitungskühlungsgeräts dar.
...
ms.locfileid: "119923710"
---
# <a name="cim_heatpipe-class"></a>\_CIM-HeatPipe-Klasse

Die **CIM \_ HeatPipe-Klasse** stellt die Funktionen und die Verwaltung eines Wärmeleitungskühlungsgeräts dar.
...
Die **\_ CIM-HeatPipe-Klasse** verfügt über diese Methoden.



| Methode                                                              | BESCHREIBUNG                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-heatpipe.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-heatpipe.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand versetzt werden soll. Nicht von WMI implementiert.<br/> |
...
Die **\_ CIM-HeatPipe-Klasse** verfügt über diese Eigenschaften.
...
WMI implementiert diese Klasse nicht. Informationen zu Klassen, die von **CIM \_ HeatPipe** abgeleitet werden, finden Sie unter [Win32-Klassen.](win32-provider.md)
