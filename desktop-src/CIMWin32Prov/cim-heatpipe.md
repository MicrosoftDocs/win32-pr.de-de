...
---
# <a name="cim_heatpipe-class"></a>CIM- \_ Heatpipe-Klasse

Die **CIM- \_ Heatpipe** -Klasse stellt die Funktionen und die Verwaltung eines wärmepipe-kühl Geräts dar.
...
Die **CIM- \_ Heatpipe** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM- \_ Heatpipe** -Klasse verfügt über diese Methoden.



| Methode                                                              | BESCHREIBUNG                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-heatpipe.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-heatpipe.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Die **CIM- \_ Heatpipe** -Klasse verfügt über diese Eigenschaften.
...
Die **CIM- \_ Heatpipe** -Klasse wird von [**CIM \_ coolingdevice**](cim-coolingdevice.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu Klassen, die von **CIM \_ Heatpipe** abgeleitet sind, finden Sie unter [Win32 Classes](win32-provider.md).
