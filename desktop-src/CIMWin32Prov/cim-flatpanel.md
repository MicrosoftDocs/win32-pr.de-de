---
description: Die CIM \_ FlatPanel-Klasse stellt die Funktionen und die Verwaltung des logischen Flatpanelgeräts dar.
...
ms.locfileid: "119320930"
---
# <a name="cim_flatpanel-class"></a>CIM \_ FlatPanel-Klasse

Die **CIM \_ FlatPanel-Klasse** stellt die Funktionen und die Verwaltung des logischen Flatpanelgeräts dar.
...
Die **CIM \_ FlatPanel-Klasse** verfügt über die folgenden Membertypen:
...
Die **CIM \_ FlatPanel-Klasse** verfügt über diese Methoden.



| Methode                                                               | BESCHREIBUNG                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-flatpanel.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-flatpanel.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand eingedrung werden soll. Nicht von WMI implementiert.<br/> |
...
Die **CIM \_ FlatPanel-Klasse** verfügt über diese Eigenschaften.
...
Enumeration, die den Typ der Flatpanelanzeige beschreibt.
...
<span id="Passive_Matrix_LCD"></span><span id="passive_matrix_lcd"></span><span id="PASSIVE_MATRIX_LCD"></span>**Passive Matrix MATRIX MATRIX** (2)
...
<span id="Active_Matrix_LCD"></span><span id="active_matrix_lcd"></span><span id="ACTIVE_MATRIX_LCD"></span>**Active Matrix MATRIX MATRIX** (3)
...
<span id="Cholesteric_LCD"></span><span id="cholesteric_lcd"></span><span id="CHOLESTERIC_LCD"></span>**Eliesteric TRIM** (4)
...
<span id="Field_Emission_Display"></span><span id="field_emission_display"></span><span id="FIELD_EMISSION_DISPLAY"></span>**Feldanzeige** (5)
...
<span id="Electro_Luminescent_Display"></span><span id="electro_luminescent_display"></span><span id="ELECTRO_LUMINESCENT_DISPLAY"></span>**Lumi Luminescent Display** (6)
...
<span id="Gas_Plasma"></span><span id="gas_plasma"></span><span id="GAS_PLASMA"></span>**Gas(7)**
...
Qualifizierer: [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Pixel")
</dt> </dl>
...
True **gibt an,** dass das Gerät gesperrt ist, was Benutzereingaben oder -ausgaben verhindert.

Diese Eigenschaft wird von [**CIM \_ UserDevice geerbt.**](cim-userdevice.md)
...
Der Scanmodus, der z. B. einen einzelnen oder dualen Scan angibt.
...
True **gibt an,** dass das flache Panel die Farbanzeige unterstützt.
...
Die **CIM \_ FlatPanel-Klasse** wird von [**CIM Display \_ abgeleitet.**](cim-display.md)
