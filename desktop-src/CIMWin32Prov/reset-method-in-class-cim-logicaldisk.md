---
description: Die Reset-Methode der CIM \_ LogicalDisk-Klasse fordert eine Zurücksetzung des logischen Geräts an.
...
ms.locfileid: "119578580"
---
# <a name="reset-method-of-the-cim_logicaldisk-class"></a>Reset-Methode der CIM \_ LogicalDisk-Klasse

Die **Reset-Methode** der CIM \_ LogicalDisk-Klasse fordert eine Zurücksetzung des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice geerbt.**](cim-logicaldevice.md)
