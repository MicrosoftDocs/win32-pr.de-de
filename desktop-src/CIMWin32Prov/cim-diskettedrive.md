...
---
# <a name="cim_diskettedrive-class-cimwin32-wmi-providers"></a>CIM_DisketteDrive-Klasse (cimwin32-WMI-Anbieter)

Die **CIM \_ diskettedrive** -Klasse stellt die Funktionen und die Verwaltung eines Disketten Laufwerks dar.
...
Die **CIM \_ diskettedrive** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM \_ diskettedrive** -Klasse verfügt über diese Methoden.
...
Die **CIM \_ diskettedrive** -Klasse verfügt über diese Eigenschaften.
...
Array von Freiform-Zeichen folgen, die ausführliche Erläuterungen **für den Zugriff** auf Gerätefunktionen bereitstellen, die im Funktions Array angegeben sind.
...
Die **CIM \_ diskettedrive** -Klasse wird von [**CIM \_ mediaaccessdevice**](cim-mediaaccessdevice.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu Klassen, die von **CIM \_ diskettedrive** abgeleitet sind, finden Sie unter [Win32 Classes](win32-provider.md).
