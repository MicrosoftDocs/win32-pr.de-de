...
ms.locfileid: "120003780"
---
# <a name="delete-method-of-the-cim_devicefile-class"></a>Delete-Methode der CIM \_ DeviceFile-Klasse

Die **Delete-Methode** löscht die logische Datei (oder das Verzeichnis), die im Objektpfad angegeben ist. Diese Methode wird von [**CIM \_ LogicalFile geerbt.**](cim-logicalfile.md)
