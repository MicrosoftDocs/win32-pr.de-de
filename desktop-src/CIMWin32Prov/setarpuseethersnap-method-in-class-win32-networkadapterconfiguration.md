---
description: Die statische WMI-Klasse SetArpUseEtherSNAP wird verwendet, um Ethernet-Paketen die Verwendung der SNAP-Codierung 802.3 zu ermöglichen.
...
ms.locfileid: "119760180"
---
# <a name="setarpuseethersnap-method-of-the-win32_networkadapterconfiguration-class"></a>SetArpUseEtherSNAP-Methode der Win32 \_ NetworkAdapterConfiguration-Klasse

Die statische [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) **SetArpUseEtherSNAP** wird verwendet, um Ethernet-Paketen die Verwendung der SNAP-Codierung 802.3 zu ermöglichen.
...
True **ermöglicht** TCP/IP das Übertragen von Ethernet-Paketen mit 802.3-SNAP-Codierung.
...
Standardmäßig überträgt der Stapel Pakete im Ethernet-Format Digital, Intel, Xerox (DIX). Er empfängt immer beide Formate.

## <a name="examples"></a>Beispiele

Im Codebeispiel [Modify ARP Queries to Use EtherSNAP](https://Gallery.TechNet.Microsoft.Com/2fe24075-fdb1-486d-8c0b-d25075fd8f21) VBScript (Ändern von ARP-Abfragen zur Verwendung von EtherSNAP VBScript) im TechNet-Katalog wird **SetArpUseEtherSNAP** verwendet, um die Netzwerkadapter auf einem Computer für die Verwendung der SNAP-Codierung 802.3 für Ethernet-Pakete zu konfigurieren.
