...
---
# <a name="invoke-method-of-the-cim_diskspacecheck-class"></a>Aufruf Methode der CIM \_ diskspacecheck-Klasse

Die **Aufruf** Methode der [**CIM \_ diskspacecheck**](cim-diskspacecheck.md) -Klasse wertet eine bestimmte Überprüfung aus. Die Details, wie die Methode eine bestimmte Überprüfung in einem CIM-Kontext auswertet, wird von der nicht abstrakten [**CIM \_ Check**](cim-check.md) -Unterklasse beschrieben.
