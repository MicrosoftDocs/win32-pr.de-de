---
description: Die \_ CIM AssociatedAlarm-Abhängigkeit ordnet einen Alarm einem logischen Gerät zu.
...
ms.locfileid: "119439476"
---
# <a name="cim_associatedalarm-class"></a>CIM \_ AssociatedAlarm-Klasse

Die **\_ CIM AssociatedAlarm-Abhängigkeit** ordnet einen Alarm einem logischen Gerät zu.
...
Die **\_ CIM AssociatedAlarm-Klasse** verfügt über diese Eigenschaften.
...
Cim [**\_ AlarmDevice,**](cim-alarmdevice.md) das das Alarmgerät enthält.
...
Ein [**CIM \_ LogicalDevice**](cim-logicaldevice.md) mit dem logischen Gerät, das alarmiert ist.

</dd> </dl>

## <a name="remarks"></a>Hinweise

Die **CIM \_ AssociatedAlarm-Klasse** wird von [**\_ CIM-Abhängigkeit**](cim-dependency.md)abgeleitet.
