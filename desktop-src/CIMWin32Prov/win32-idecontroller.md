...
Die [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) von **Win32 \_ idecontroller** verwaltet die Funktionen eines IDE-Controller Geräts (Integrated Device Electronics).
...
Die **Win32- \_ idecontroller** -Klasse verfügt über diese Typen von Membern:
...
Die **Win32- \_ idecontroller** -Klasse verfügt über diese Methoden.
...
Eindeutiger Bezeichner des IDE-Controllers mit anderen Geräten im System.
...
Weitere Informationen zu dem in der **LastErrorCode** -Eigenschaft aufgezeichneten Fehler sowie Informationen zu ggf. durchzuführenden Korrekturmaßnahmen.
...
Hersteller des IDE-Controller Geräts.
...
Wenn der Wert **true** ist, kann das Gerät Energie gesteuert in den Unterbrechungs Modus versetzt werden usw. Die-Eigenschaft gibt nicht an, dass die Energie Verwaltungsfunktionen zurzeit aktiviert sind, sondern nur, dass das logische Gerät für die Energie Verwaltung geeignet ist.
...
Die **Win32- \_ idecontroller** -Klasse wird vom [**CIM- \_ Controller**](cim-controller.md)abgeleitet.
