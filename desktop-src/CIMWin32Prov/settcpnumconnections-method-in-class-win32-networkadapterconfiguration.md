...
---
# <a name="settcpnumconnections-method-of-the-win32_networkadapterconfiguration-class"></a>SetTcpNumConnections-Methode der Win32 \_ networkadapterconfiguration-Klasse

Die statische Methode **SetTcpNumConnections** [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) wird verwendet, um die maximale Anzahl von Verbindungen festzulegen, die TCP möglicherweise gleichzeitig geöffnet hat.
...
Maximale Anzahl von Verbindungen, die TCP möglicherweise gleichzeitig geöffnet hat. Der gültige Wertebereich ist 0-0xfffffe.
...
Im Beispiel [Ändern der zulässigen Anzahl von TCP-Verbindungen](https://Gallery.TechNet.Microsoft.Com/016d09f3-28aa-47eb-b439-100b89999bab) VBScript wird die maximal zulässige Anzahl gleichzeitig geöffneter TCP-Verbindungen auf einem Computer auf 10 festgelegt.
