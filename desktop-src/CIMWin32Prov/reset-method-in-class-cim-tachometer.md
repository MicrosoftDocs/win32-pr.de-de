...
---
# <a name="reset-method-of-the-cim_tachometer-class"></a>Reset-Methode der CIM- \_ Klasse "Tachometer"

Die **Reset** -Methode der CIM- \_ Klasse "Tachometer" fordert eine zurück setzung des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
