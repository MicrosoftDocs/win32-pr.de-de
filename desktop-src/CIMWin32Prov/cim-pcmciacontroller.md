---
description: Die CIM PCMCIAController-Klasse stellt die Funktionen und die Verwaltung eines \_ PCMCIA-Controllers (Personal Computer Memory Card International Association) dar.
...
ms.locfileid: "118678840"
---
# <a name="cim_pcmciacontroller-class"></a>CIM \_ PCMCIAController-Klasse

Die **CIM \_ PCMCIAController-Klasse** stellt die Funktionen und die Verwaltung eines PCMCIA-Controllers (Personal Computer Memory Card International Association) dar.
...
Die **CIM \_ PCMCIAController-Klasse** verfügt über die folgenden Membertypen:
...
Die **CIM \_ PCMCIAController-Klasse** verfügt über diese Methoden.



| Methode                                                                      | BESCHREIBUNG                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-pcmciacontroller.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand eingedrung werden soll. Nicht von WMI implementiert.<br/> |
...
Die **CIM \_ PCMCIAController-Klasse** verfügt über diese Eigenschaften.
...
Verfügbarkeit und Status des Geräts. Diese Eigenschaft wird von [**CIM \_ LogicalDevice geerbt.**](cim-logicaldevice.md)
...
Ausführung oder volle Leistung.
...
Es ist bekannt, dass sich das Gerät im Energiesparmodus befindet, aber sein genauer Status in diesem Modus ist unbekannt.
...
Das Gerät befindet sich in einem Warnzustand und befindet sich auch im Energiesparmodus.
...
Der PCMCIA-Controller ist nicht verfügbar.
...
Name des PCMCIA-Controllerherstellers.
...
Energieverwaltungsfeatures sind derzeit aktiviert, aber der genaue Funktionssatz ist unbekannt, oder die Informationen sind nicht verfügbar.
...
Die [**SetPowerState-Methode**](setpowerstate-method-in-class-cim-pcmciacontroller.md) wird unterstützt.
...
Die [**SetPowerState-Methode**](setpowerstate-method-in-class-cim-pcmciacontroller.md) kann aufgerufen werden, wenn der *PowerState-Parameter* auf 5 ("Power Cycle") festgelegt ist.
...
Die [**SetPowerState-Methode**](setpowerstate-method-in-class-cim-pcmciacontroller.md) kann aufgerufen werden, wenn der *PowerState-Parameter* auf 5 ("Power Cycle") und der *Time-Parameter* auf ein bestimmtes Datum und eine bestimmte Uhrzeit oder ein bestimmtes Intervall für das Ein-/Aus-Setzen festgelegt ist.
...
Datum und Uhrzeit der letzten Zurücksetzung dieses Controllers, d. h. der Controller wurde ausgeschaltet oder erneut initialisiert.
...
Die **CIM \_ PCMCIAController-Klasse** wird vom [**\_ CIM-Controller abgeleitet.**](cim-controller.md)

WMI implementiert diese Klasse nicht. Informationen zu WMI-Klassen, die von **CIM \_ PCMCIAController abgeleitet sind,** finden Sie unter [Win32-Klassen.](win32-provider.md)
