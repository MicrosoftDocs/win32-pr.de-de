...
---
# <a name="win32_pnpdevicepropertysint8-class"></a>Win32- \_ PnPDevicePropertySint8-Klasse

Stellt eine PNP-Geräte Eigenschaft vom Typ **Sint8** dar.
...
Die **Win32- \_ PnPDevicePropertySint8** -Klasse verfügt über diese Typen von Membern:

-   [Eigenschaften](#properties)

### <a name="properties"></a>Eigenschaften

Die **Win32- \_ PnPDevicePropertySint8** -Klasse verfügt über diese Eigenschaften.
