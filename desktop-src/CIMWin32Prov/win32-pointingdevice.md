...
---
# <a name="win32_pointingdevice-class"></a>Win32- \_ pointingdevice-Klasse

Die [WMI-Klasse](../wmisdk/retrieving-a-class.md) von **Win32 \_ pointingdevice** stellt ein Eingabegerät dar, das verwendet wird, um auf die Anzeige eines Computer Systems, auf dem Windows ausgeführt wird, zu zeigen und diese auszuwählen Alle Geräte, die zur Bearbeitung eines Zeigers verwendet werden, oder zeigen auf die Anzeige auf einem Computersystem, auf dem Windows ausgeführt wird, sind ein Mitglied dieser Klasse.
...
Die **Win32 \_ pointingdevice** -Klasse verfügt über diese Typen von Membern:
...
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**Reset**](reset-method-in-class-cim-controller.md) -Methode in [**CIM \_ pointingdevice**](cim-pointingdevice.md).<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) -Methode in [**CIM \_ pointingdevice**](cim-pointingdevice.md).<br/> |
...
Eindeutiger Bezeichner des Zeige Geräts mit anderen Geräten im System.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS- \| Typ 21- \| Schnittstelle")
</dt> </dl>

Der Typ der Schnittstelle, die für das Zeigegerät verwendet wird.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| System Information Functions \| SystemParametersInfo"), [**Einheiten**](../wmisdk/standard-qualifiers.md) ("Mickeys")
</dt> </dl>

Einer von zwei Beschleunigungswerten. Die Empfindlichkeit der Zeigegeräte verdoppelt sich (wechselt vom ersten zum zweiten Wert), wenn das Zeigegerät einen Abstand über diesem Schwellenwert erreicht.
...
Konfiguration des Zeige Geräts für den linken oder rechten Vorgang.

Diese Eigenschaft wird von [**CIM \_ pointingdevice**](cim-pointingdevice.md)geerbt.
...
<span id="Not_Applicable"></span><span id="not_applicable"></span><span id="NOT_APPLICABLE"></span>**Nicht zutreffend** (1)
...
<span id="Right_Handed_Operation"></span><span id="right_handed_operation"></span><span id="RIGHT_HANDED_OPERATION"></span>**Rechter übergebenen Vorgang** (2)
...
<span id="Left_Handed_Operation"></span><span id="left_handed_operation"></span><span id="LEFT_HANDED_OPERATION"></span>**Linker Vorgang** (3)
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HKEY \_ local \_ Machine \\ \\ System \\ \\ ControlSet001 \\ \\ Control \\ \\ Class \| DriverDesc")
</dt> </dl>

Der Typ der Hardware, die für das Windows-Zeigegerät verwendet wird.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HKEY \_ local \_ Machine \\ \\ System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| INFPath")
</dt> </dl>

Der Name der INF-Datei für das Windows-Zeigegerät.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HKEY \_ local \_ Machine \\ \\ System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| InfSection")
</dt> </dl>

Abschnitt der INF-Datei, die Konfigurationsinformationen für das Windows-Zeigegerät enthält.
...
**True** gibt an, dass das Gerät gesperrt ist und Benutzereingaben oder-Ausgaben verhindert.

Diese Eigenschaft wird von [**CIM \_ userdevice**](cim-userdevice.md)geerbt.
...
Der Name des Herstellers des Prozessors.
...
Anzahl der Schaltflächen auf dem Zeigegerät.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIF". DMTF \| zeigt Gerät \| 001,1 ")
</dt> </dl>

Typ des Zeige Geräts.
...
<span id="Mouse"></span><span id="mouse"></span><span id="MOUSE"></span>**Maus** (3)
...
<span id="Track_Ball"></span><span id="track_ball"></span><span id="TRACK_BALL"></span>**Ball verfolgen** (4)


</dt> <dd>

Trackballunterstützung

</dd> <dt>

<span id="Track_Point"></span><span id="track_point"></span><span id="TRACK_POINT"></span>

<span id="Track_Point"></span><span id="track_point"></span><span id="TRACK_POINT"></span>Verfolgungs **Punkt** (5)
...
<span id="Glide_Point"></span><span id="glide_point"></span><span id="GLIDE_POINT"></span>**Gleitspunkt** (6)
...
<span id="Touch_Pad"></span><span id="touch_pad"></span><span id="TOUCH_PAD"></span>**Touchpad** (7)
...
<span id="Mouse_-_Optical_Sensor"></span><span id="mouse_-_optical_sensor"></span><span id="MOUSE_-_OPTICAL_SENSOR"></span>**Maus optischer Sensor** (9)
...
Einer von zwei Beschleunigungs Schwellenwerten. Das System verdoppelt die Geschwindigkeit der Zeiger Bewegung, wenn das Zeiger Gerät einen Abstand bewegt, der größer ist als dieser Wert. Da diese Geschwindigkeitssteigerung erreicht wird, nachdem der **Double-Threshold** -Wert erreicht wurde, wird der Zeiger um das Vierfache der ursprünglichen Geschwindigkeit verschoben.
...
Qualifizierer: [**Einheiten**](../wmisdk/standard-qualifiers.md) ("Zählungen pro Zoll")
</dt> </dl>

Nach Verfolgungs Auflösung.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Samplerate"), [**Einheiten**](../wmisdk/standard-qualifiers.md) ("Hertz")
</dt> </dl>

Rate, mit der das Zeigegerät nach Eingabeinformationen abgerufen wird.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| MouseSynchIn100ns"), [**Einheiten**](../wmisdk/standard-qualifiers.md) ("100 nanoseconds")
</dt> </dl>

Die Zeitspanne, nach der der nächste Interruptzeit angenommen wird, dass der Start eines neuen gerätepakets angegeben wird (Teil Pakete werden verworfen). Wenn eine Unterbrechung verloren geht, kann der Gerätetreiber auf diese Weise die interne Darstellung des Paketstatus mit dem Hardware Status synchronisieren.
...
Die **Win32 \_ pointingdevice** -Klasse wird von [**CIM \_ pointingdevice**](cim-pointingdevice.md)abgeleitet.
