---
description: Die WMI-Klasse Win32 PointingDevice stellt ein Eingabegerät dar, das verwendet wird, um auf bereiche auf der Anzeige eines Computersystems zu zeigen und regionen auszuwählen, auf dem \_ Windows.
...
ms.locfileid: "118417056"
---
# <a name="win32_pointingdevice-class"></a>Win32 \_ PointingDevice-Klasse

Die [WMI-Klasse](../wmisdk/retrieving-a-class.md) **\_ Win32 PointingDevice** stellt ein Eingabegerät dar, das zum Verweisen auf und Auswählen von Regionen auf der Anzeige eines Computersystems verwendet wird, auf dem Windows. Jedes Gerät, das verwendet wird, um einen Zeiger zu bearbeiten oder auf die Anzeige auf einem Computersystem zu zeigen, auf dem Windows ausgeführt wird, ist ein Member dieser Klasse.
...
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie unter [**der Reset-Methode**](reset-method-in-class-cim-controller.md) in [**CIM \_ PointingDevice**](cim-pointingdevice.md).<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie unter [**der SetPowerState-Methode**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ PointingDevice**](cim-pointingdevice.md).<br/> |
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 21 \| Interface")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| Systeminformationen Functions \| SystemParametersInfo"), [**Einheiten**](../wmisdk/standard-qualifiers.md) ("mickeys")
</dt> </dl>
...
<span id="Right_Handed_Operation"></span><span id="right_handed_operation"></span><span id="RIGHT_HANDED_OPERATION"></span>**Rechtshändige Operation** (2)
...
<span id="Left_Handed_Operation"></span><span id="left_handed_operation"></span><span id="LEFT_HANDED_OPERATION"></span>**Linkshändervorgang** (3)
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HKEY \_ LOCAL MACHINE \_ SYSTEM \\ \\ \\ \\ ControlSet001 Control Class \\ \\ \\ \\ \| DriverDesc")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HKEY \_ LOCAL MACHINE \_ SYSTEM \\ \\ \\ \\ CurrentControlSet Control Class \\ \\ \\ \\ \| InfPath")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HKEY \_ LOCAL MACHINE \_ SYSTEM \\ \\ \\ \\ CurrentControlSet Control Class \\ \\ \\ \\ \| InfSection")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Pointing Device \| 001.1")
</dt> </dl>
...
<span id="Glide_Point"></span><span id="glide_point"></span><span id="GLIDE_POINT"></span>**Endpunkt** (6)
...
Einer von zwei Beschleunigungsschwellenwerten. Das System verdoppelt die Geschwindigkeit der Zeigerbewegung, wenn das Zeigergerät einen Abstand über diesem Wert bewegt. Da diese Geschwindigkeitserhöhung auftritt, nachdem der **DoubleSpeedThreshold-Wert** erreicht wurde, bewegt sich der Zeiger effektiv um das Vierfache seiner ursprünglichen Geschwindigkeit.
...
Qualifizierer: [**Einheiten**](../wmisdk/standard-qualifiers.md) ("Anzahl pro Zoll")
</dt> </dl>
...
Rate, mit der das zeigende Gerät nach Eingabeinformationen abgefragt wird.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| MouseSynchIn100ns"), [**Einheiten**](../wmisdk/standard-qualifiers.md) ("100 Nanosekunden")
</dt> </dl>
