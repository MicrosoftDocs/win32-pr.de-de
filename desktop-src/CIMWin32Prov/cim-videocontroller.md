---
description: Die CIM \_ VideoController-Klasse stellt die Funktionen und die Verwaltung des Videocontrollers dar.
...
ms.locfileid: "119817500"
---
# <a name="cim_videocontroller-class"></a>CIM \_ VideoController-Klasse

Die **CIM \_ VideoController-Klasse** stellt die Funktionen und die Verwaltung des Videocontrollers dar.
...
Die **CIM \_ VideoController-Klasse** verfügt über die folgenden Membertypen:
...
Die **CIM \_ VideoController-Klasse** verfügt über diese Methoden.



| Methode                                                                     | BESCHREIBUNG                                                                                                                              |
|:---------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-videocontroller.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-videocontroller.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand eingedrung werden soll. Nicht von WMI implementiert.<br/> |
...
Die **CIM \_ VideoController-Klasse** verfügt über diese Eigenschaften.
...
Qualifizierer: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ VideoController**.**CapabilityDescriptions**")
</dt> </dl>

Grafiken und 3D-Funktionen des Videocontrollers.
...
Qualifizierer: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ VideoController**.**AcceleratorCapabilities**")
</dt> </dl>

Freiformzeichenfolgen, die ausführliche Beschreibungen für die im AcceleratorCapabilities-Array angegebenen **Videobeschleunigungsfunktionen** bereitstellen.

> [!Note]  
> Jeder Eintrag dieses Arrays bezieht sich auf den Eintrag im **AcceleratorCapabilities-Array,** der sich am gleichen Index befindet.
...
Im Zeichenmodus die Anzahl der Zeilen für den Videocontroller. Geben Sie andernfalls 0 ein.
...
Anzahl von Videoseiten, die unter Gegebenen der aktuellen Auflösungen und des verfügbaren Arbeitsspeichers unterstützt werden.
...
Datum und Uhrzeit der letzten Zurücksetzung des Controllers, d. h. der Controller wurde heruntergefahren oder erneut initialisiert.
...
Freiformzeichenfolge, die den Videoprozessor oder Controller beschreibt.

</dd> </dl>

## <a name="remarks"></a>Hinweise

Die **CIM \_ VideoController-Klasse** wird von [**CIM \_ Controller**](cim-controller.md)abgeleitet.

WMI implementiert diese Klasse nicht. Informationen zu WMI-Klassen, die von **CIM \_ VideoController** abgeleitet werden, finden Sie unter [Win32-Klassen.](win32-provider.md)
