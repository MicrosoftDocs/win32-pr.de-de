---
description: Die CIM \_ PowerSupply-Klasse stellt die Funktionen und die Verwaltung des logischen Stromversorgungsgeräts dar.
...
ms.locfileid: "118421888"
---
# <a name="cim_powersupply-class"></a>CIM \_ PowerSupply-Klasse

Die **CIM \_ PowerSupply-Klasse** stellt die Funktionen und die Verwaltung des logischen Stromversorgungsgeräts dar.
...
Die **CIM \_ PowerSupply-Klasse** verfügt über folgende Typen von Membern:
...
Derzeit verwendeter Spannungsbereich. Wenn die Stromversorgung derzeit keine Stromversorgung aufzeichnet, kann der Wert 6 ("Keine") angegeben werden. Diese Informationen sind im Fall einer unterbrechungsfähigen Stromversorgung (USV) erforderlich, einer Unterklasse von **CIM \_ PowerSupply**.
