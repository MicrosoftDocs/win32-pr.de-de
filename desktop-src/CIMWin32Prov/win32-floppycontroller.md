---
description: Die WMI-Klasse Win32 FloppyController stellt die Funktionen und die Verwaltungskapazität eines \_ Diskettenlaufwerkcontrollers dar.
...
ms.locfileid: "119878660"
---
# <a name="win32_floppycontroller-class"></a>Win32 \_ FloppyController-Klasse

\[**Win32 \_ FloppyController** ist ab dem 1. Und Windows 10 nicht mehr Windows Server 2016.\]

Die **WMI-Klasse \_ Win32 FloppyController** stellt die Funktionen und die Verwaltungskapazität eines Diskettenlaufwerkcontrollers dar. [](/windows/desktop/WmiSdk/retrieving-a-class)
...
Die **Win32 \_ FloppyController-Klasse** verfügt über die folgenden Membertypen:
...
Stromsparen – Modus mit geringer Leistung
...
Eindeutiger Bezeichner des Diskettencontrollers.
...
Name des Herstellers des Diskettencontrollers.
...
Maximale Anzahl direkt adressierbarer Entitäten, die dieser Controller unterstützt. Wenn die Zahl unbekannt ist, sollte der Wert 0 (null) verwendet werden.
...
Bezeichnung für das -Objekt. Bei einer Unterklasse kann die Eigenschaft als Schlüsseleigenschaft überschrieben werden.
...
Windows Plug & Play Gerätebezeichner für das logische Gerät.
...
Die **Win32 \_ FloppyController-Klasse** wird vom [**\_ CIM-Controller abgeleitet,**](cim-controller.md) der von [**CIM \_ LogicalDevice abgeleitet wird.**](cim-logicaldevice.md)
