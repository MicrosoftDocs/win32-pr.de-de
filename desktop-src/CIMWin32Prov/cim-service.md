...
|:-----------------------------------------------------------------|:--------------------------------------------------------------------------------------------|
| [**Start Service**](startservice-method-in-class-cim-service.md) | Versucht, den Dienst in seinen Startzustand zu versetzen. Wird nicht von WMI implementiert.<br/>     |
| [**Stop Service**](stopservice-method-in-class-cim-service.md)   | Klassenmethode, die den Dienst in den Status "beendet" versetzt. Wird nicht von WMI implementiert.<br/> |
...
Die **CIM- \_ Dienst** Klasse wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu WMI-Klassen, die vom **CIM- \_ Dienst** abgeleitet sind, finden Sie unter [Win32-Klassen](win32-provider.md).
