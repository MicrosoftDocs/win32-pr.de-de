...
Die **CIM \_ clusteringsap** -Klasse stellt die Zugriffspunkte eines Clustering-Dienstanbieter dar.
...
Die **CIM \_ clusteringsap** -Klasse verfügt über diese Typen von Membern:
