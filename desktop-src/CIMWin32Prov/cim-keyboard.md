...
---
# <a name="cim_keyboard-class"></a>CIM- \_ Tastatur Klasse

Die **CIM- \_ Tastatur** Klasse stellt die Funktionen und die Verwaltung des logischen Tastatur Geräts dar.
...
Die **CIM- \_ Tastatur** Klasse verfügt über diese Typen von Membern:
...
Die **CIM- \_ Tastatur** Klasse verfügt über diese Methoden.



| Methode                                                              | BESCHREIBUNG                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-keyboard.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-keyboard.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Die **CIM- \_ Tastatur** Klasse verfügt über diese Eigenschaften.
...
Eine frei Form Zeichenfolge, die Informationen über den in der **LastErrorCode** -Eigenschaft aufgezeichneten Fehler und die auszuführenden Korrekturmaßnahmen bereitstellt.
...
Eine frei Form Zeichenfolge, die das Format und das Layout der Tastatur angibt.
...
Eine ganze Zahl, die angibt, ob auf der Tastatur ein Kennwort auf Hardwareebene aktiviert ist, um lokale Eingaben zu verhindern.
...
Die **CIM- \_ Tastatur** Klasse wird von [**CIM \_ userdevice**](cim-userdevice.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu von **CIM- \_ Tastatur** abgeleiteten Klassen finden Sie unter [Win32-Klassen](win32-provider.md).
