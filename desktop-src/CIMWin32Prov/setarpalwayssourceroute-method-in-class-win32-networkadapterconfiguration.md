...
---
# <a name="setarpalwayssourceroute-method-of-the-win32_networkadapterconfiguration-class"></a>Die Methode "tartarpalwayssourceroute" der Win32- \_ networkadapterconfiguration-Klasse

Die statische Methode **setarpalwayssourceroute** [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) wird verwendet, um die Übertragung von ARP-Abfragen durch TCP/IP festzulegen.
...
**True** gibt an, dass TCP/IP zum Übertragen von ARP-Abfragen mit aktiviertem Quell Routing auf Tokenringnetzwerken gezwungen ist. Standardmäßig überträgt der Stapel ARP-Abfragen ohne Quell Routing und führt dann einen Wiederholungsversuch mit aktiviertem Quell Routing aus, wenn keine Antwort empfangen wird.
