---
description: Mit der statischen WMI-Klasse SetArpAlwaysSourceRoute wird die Übertragung von ARP-Abfragen über TCP/IP festgelegt.
ms.assetid: bbff4e2e-aea6-400e-8bd8-f62aaa9fa601
ms.tgt_platform: multiple
title: SetArpAlwaysSourceRoute-Methode der Win32_NetworkAdapterConfiguration-Klasse
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119752710"
---
# <a name="setarpalwayssourceroute-method-of-the-win32_networkadapterconfiguration-class"></a>SetArpAlwaysSourceRoute-Methode der Win32 \_ NetworkAdapterConfiguration-Klasse

Mit der statischen [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) **SetArpAlwaysSourceRoute** wird die Übertragung von ARP-Abfragen über TCP/IP festgelegt.
...
True **gibt an,** dass TCP/IP gezwungen ist, ARP-Abfragen mit aktivierter Quellrouting in Token Ring-Netzwerken zu übertragen. Standardmäßig überträgt der Stapel ARP-Abfragen ohne Quellrouting und dann erneut, wenn das Quellrouting aktiviert ist, wenn keine Antwort empfangen wird.
...
Im [Beispiel Modify ARP Queries to Use Source Routing](https://Gallery.TechNet.Microsoft.Com/e0298c96-acc2-4809-9365-fce3000db00e) VBScript (Ändern von ARP-Abfragen zur Verwendung von VbScript-Quellrouting) im TechNet-Katalog wird **SetArpAlwaysSourceRoute** verwendet, um TCP/IP für die verwendung des Quellroutings in allen Tokenringnetzwerken zu konfigurieren.
