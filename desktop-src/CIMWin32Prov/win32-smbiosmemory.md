...
---
# <a name="win32_smbiosmemory-class"></a>Win32 \_ smbiosmemory-Klasse

Die abstrakte [WMI-Klasse](../wmisdk/retrieving-a-class.md) für den **Win32 \_ smbiosmemory** stellt die Eigenschaften eines Computersystem Arbeitsspeichers dar, die über die SMBIOS-Schnittstelle (Systemverwaltungs-BIOS) angezeigt werden. Die SMBIOS-Schnittstelle unterscheidet nicht zwischen nicht flüchtiger, flüchtiger und Flash-Erinnerungen. Die [**CIM- \_ Speicher**](cim-memory.md) Klasse ist die übergeordnete Klasse aller Arbeitsspeicher Typen.
...
Die **Win32 \_ smbiosmemory** -Klasse verfügt über diese Typen von Membern:
...
Die **Win32 \_ smbiosmemory** -Klasse verfügt über diese Methoden.



| Methode            | BESCHREIBUNG                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**Reset**](reset-method-in-class-cim-controller.md) -Methode in [**CIM \_ storageblock**](cim-storageextent.md).<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) -Methode in [**CIM \_ storageblock**](cim-storageextent.md).<br/> |
...
Die **Win32 \_ smbiosmemory** -Klasse verfügt über diese Eigenschaften.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIB. IETF \| Host-Resources-MIB. hrstorageallocationunits "), [**Einheiten**](../wmisdk/standard-qualifiers.md) (" Bytes ")
</dt> </dl>
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| -Typ 18 \| 32-Bit Arbeitsspeicher Fehlerinformationen \| Fehlertyp")
</dt> </dl>
...
Eindeutiger Bezeichner des logischen Geräts.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS- \| Typ 19 \| Speichergerät zugeordnete Adressen \| Endadresse")
</dt> </dl>
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| -Typ 18 \| 32-Bit Arbeitsspeicher Fehlerinformationen \| Fehler Vorgang")
</dt> </dl>
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| -Typ 18 \| 32-Bit Arbeitsspeicher Fehlerinformationen \| Fehler Adresse")
</dt> </dl>
...
Qualifizierer: [**arrayType**](../wmisdk/standard-qualifiers.md) ("indiziert"), [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS"), [**Max**](../wmisdk/standard-qualifiers.md) (64)
</dt> </dl>
...
Qualifizierer: [**modelcorrespondence**](../wmisdk/standard-qualifiers.md) ("CIM-Arbeits [**\_ Speicher**](cim-memory.md)".**Othererrordescription**"), [**mappingstrings**](../wmisdk/standard-qualifiers.md) (" SMBIOS \| -Typ 18 \| 32-Bit-Arbeitsspeicher Fehlerinformationen \| Fehlertyp ")
</dt> </dl>

Der Typ des Fehlers, der zuletzt aufgetreten ist. Die Werte 12 bis 14 werden nicht verwendet. Die korrigierende Fähigkeit wird in der Eigenschaft " **correctableerror**" angegeben.
...
Qualifizierer: [**override**](../wmisdk/standard-qualifiers.md) ("errormethod"), [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS- \| Typ 16 \| physischer Arbeitsspeicher Array- \| Fehlerkorrektur")
</dt> </dl>

Details zu den Paritäts-oder CRC-Algorithmen, ECC oder anderen verwendeten Mechanismen.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| -Typ 18 \| 32-Bit-Arbeitsspeicher Fehlerinformationen \| Fehlerbehebung"), [**Einheiten**](../wmisdk/standard-qualifiers.md) ("Bytes")
</dt> </dl>
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS"), [**Einheiten**](../wmisdk/standard-qualifiers.md) ("Bits")
</dt> </dl>

Die Größe der Datenübertragung in Bits, die den letzten Fehler verursacht hat – 0 (null) zeigt an, dass kein Fehler vorliegt. Wenn die **errorInfo** -Eigenschaft gleich 3 (OK) ist, sollte diese Eigenschaft auf 0 (null) festgelegt werden.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIB. IETF \| Host-Resources-MIB. hrstoragesize ")
</dt> </dl>
...
Qualifizierer: [**modelcorrespondence**](../wmisdk/standard-qualifiers.md) ("CIM-Arbeits [**\_ Speicher**](cim-memory.md)".**ErrorInfo**"), [**mappingstrings**](../wmisdk/standard-qualifiers.md) (" SMBIOS ")
</dt> </dl>

Eine frei Form Zeichenfolge, die weitere Informationen bereitstellt, wenn die **ErrorType** -Eigenschaft auf 1 festgelegt ist. Andernfalls hat diese Zeichenfolge keine Bedeutung.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS- \| Typ 19 \| Speichergerät zugeordnete Adressen \| Startadresse")
</dt> </dl>

Die Anfangsadresse, auf die von einer Anwendung oder einem Betriebssystem verwiesen wird und die von einem Speichercontroller für dieses Speicher Objekt zugeordnet wird. Die Startadresse wird in Kilobyte angegeben.
...
**True** gibt an, dass die Adressinformationen in der **ErrorAddress** -Eigenschaft eine Adresse auf Systemebene sind. **False** gibt an, dass es sich um eine physische Adresse handelt. Wenn die Eigenschaft **errorInfo** gleich 3 (OK) ist, hat diese Eigenschaft keine Bedeutung.
...
Die **Win32-Klasse \_ smbiosmemory** wird von [**CIM \_ storageblock**](cim-storageextent.md)abgeleitet.
