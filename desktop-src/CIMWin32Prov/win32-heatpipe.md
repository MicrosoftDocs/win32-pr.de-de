...
Die [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) für die **Win32- \_ Heatpipe** stellt die Eigenschaften eines wärmepipe-kühl Geräts dar.
...
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie in der " [**Reset**](reset-method-in-class-cim-controller.md) "-Methode in [**CIM \_ Heatpipe**](cim-heatpipe.md) für die Dokumentation.<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie in der [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) -Methode in [**CIM \_ Heatpipe**](cim-heatpipe.md) .<br/> |
...
Eindeutiger Bezeichner der wärmepipe.
...
Weitere Informationen zu dem Fehler, der in " **LastErrorCode**" aufgezeichnet wird, sowie Informationen zu allen Maßnahmen, die möglicherweise ausgeführt werden.
...
Wenn der Wert **true** ist, kann das Gerät Energie gesteuert in den Unterbrechungs Modus versetzt werden usw. Die-Eigenschaft gibt nicht an, dass die Energie Verwaltungsfunktionen derzeit aktiviert sind, sondern nur, dass das logische Gerät für die Energie Verwaltung geeignet ist.
...
Die **Win32- \_ Heatpipe** -Klasse wird von [**CIM \_ Heatpipe**](cim-heatpipe.md)abgeleitet.
