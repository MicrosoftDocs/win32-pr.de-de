...
---
# <a name="cim_magnetoopticaldrive-class"></a>CIM- \_ Klasse "magnedeopticaldrive"

Die CIM-Klasse " **\_ magnetyopticaldrive** " stellt die Funktionen und die Verwaltung eines "Magneto-Optical"-Laufwerks dar, einen Untertyp des Medien Zugriffs Geräts.
...
Die CIM-Klasse " **\_ magnetoopticaldrive** " verfügt über diese Typen von Membern:
...
Die CIM-Klasse " **\_ magneyopticaldrive** " verfügt über diese Methoden.



| Methode                                                                         | BESCHREIBUNG                                                                                                                              |
|:-------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-magnetoopticaldrive.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-magnetoopticaldrive.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Die CIM-Klasse " **\_ magnedeopticaldrive** " verfügt über diese Eigenschaften.
...
> [!Note]  
> Jeder Array Eintrag bezieht sich auf den Eintrag im Funktions **Array, der sich** am selben Index befindet.
...
Die CIM-Klasse " **\_ magneyopticaldrive** " ist von [**CIM \_ mediaaccessdevice**](cim-mediaaccessdevice.md)abgeleitet.
