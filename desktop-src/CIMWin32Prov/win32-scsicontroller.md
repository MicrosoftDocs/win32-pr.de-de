---
description: Die WMI-Klasse Win32 SCSIController stellt einen SCSI-Controller auf einem Computersystem dar, auf dem \_ Windows.
...
ms.locfileid: "119917590"
---
# <a name="win32_scsicontroller-class"></a>Win32 \_ SCSIController-Klasse

Die **WMI-Klasse Win32 \_ SCSIController** stellt einen SCSI-Controller auf einem Computersystem dar, auf dem Windows. [](../wmisdk/retrieving-a-class.md)
...
Die **Win32 \_ SCSIController-Klasse** verfügt über die folgenden Membertypen:
...
Die **Win32 \_ SCSIController-Klasse** verfügt über diese Methoden.



| Methode            | BESCHREIBUNG                                                                                                                                                                                      |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie unter [**Reset-Methode**](reset-method-in-class-cim-controller.md) in [**CIM \_ SCSIController**](cim-scsicontroller.md).<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie unter [**der SetPowerState-Methode**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ SCSIController**](cim-scsicontroller.md).<br/> |
...
Die **Win32 \_ SCSIController-Klasse** verfügt über diese Eigenschaften.
...
Anzahl von Time outs, die nach dem **TimeOfLastReset-Wert aufgetreten** sind.

Diese Eigenschaft wird von [**CIM \_ SCSIController geerbt.**](cim-scsicontroller.md)
...
Qualifizierer: [**Key**](../wmisdk/key-qualifier.md), [**Override**](../wmisdk/standard-qualifiers.md) ("DeviceId"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Hardware \\ \\ DeviceMap \\ \\ Scsi")
</dt> </dl>

Eindeutiger Bezeichner des SCSI-Controllers mit anderen Geräten im System.
...
Qualifizierer: [**VERALTET,**](../wmisdk/standard-wmi-qualifiers.md) [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Hardware \\ \\ DeviceMap \\ \\ Scsi \| ScsiPort")
</dt> </dl>

Reihenfolge, in der die Geräte mit diesem SCSI-Controller aufgeführt werden.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Services Class \\ \\ \| PortDriver")
</dt> </dl>

Treiberdateiname des SCSI-Controllers.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Enum \\ \\ Root \| HWRevision")
</dt> </dl>

Hardwareversionsnummer des SCSI-Controllers.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Hardware \\ \\ DeviceMap \\ \\ Scsi \| ScsiPort")
</dt> </dl>

Indexnummer des SCSI-Controllers in der Systemregistrierung.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Enum \\ \\ Root \| Mfg")
</dt> </dl>

Name des Herstellers des SCSI-Controllers.
...
Maximale Datenbreite (in Bits), die vom SCSI-Controller unterstützt wird.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|DMTF-Busport \| 001.9")
</dt> </dl>
...
Maximale Übertragungsrate (in Bits pro Sekunde), die vom SCSI-Controller unterstützt wird.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Storage Controller \| 001.3")
</dt> </dl>

Unterstützung des SCSI-Controllers für Redundanz oder Schutz vor Gerätefehlern.

Diese Eigenschaft wird von [**CIM \_ SCSIController**](cim-scsicontroller.md)geerbt.
...
**Geschützt durch SCC (SCSI-3-Controllerbefehl)** (5)
...
**Geschützt durch SCC-2 (SCSI-3-Controllerbefehl)** (6)
...
Diese Eigenschaft wird vom [**\_ CIM-Controller**](cim-controller.md)geerbt. Die folgende Liste zeigt die möglichen Werte.
...
Die **Win32 \_ SCSIController-Klasse** wird von [**CIM \_ SCSIController abgeleitet.**](cim-scsicontroller.md)
