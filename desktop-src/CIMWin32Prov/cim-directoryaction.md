...
---
# <a name="cim_directoryaction-class"></a>CIM- \_ directoryaction-Klasse

Die **abstrakte \_ directoryaction** -Klasse wird Verzeichnisse verwaltet. Die Verzeichnis Erstellung wird von der CIM-Klasse " [**\_ kreatedirectoryaction**](cim-createdirectoryaction.md) " verarbeitet, und die Verzeichnis Entfernung erfolgt durch die [**CIM- \_ removedirectoryaction**](cim-removedirectoryaction.md) -Klasse.
...
Die **CIM- \_ directoryaction** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM- \_ directoryaction** -Klasse verfügt über diese Methoden.



| Methode                                                       | BESCHREIBUNG                                                                  |
|:-------------------------------------------------------------|:-----------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-directoryaction.md) | Führt eine bestimmte Aktion aus. Diese Methode wird nicht von WMI implementiert.<br/> |
...
Die **CIM- \_ directoryaction** -Klasse verfügt über diese Eigenschaften.
