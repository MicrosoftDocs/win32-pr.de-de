...
---
# <a name="reset-method-of-the-cim_binarysensor-class"></a>Reset-Methode der CIM \_ BinarySensor-Klasse

Die **Reset** -Methode der CIM \_ BinarySensor-Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
