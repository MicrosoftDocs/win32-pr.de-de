---
description: Die \_ CIM-Tachometerklasse ist aus Gründen der Abwärtskompatibilität mit früheren CIM-Schemadefinitionen vorhanden.
...
ms.locfileid: "119547830"
---
# <a name="cim_tachometer-class"></a>\_CIM-Tachometerklasse

Die **\_ CIM-Tachometerklasse** ist aus Gründen der Abwärtskompatibilität mit früheren CIM-Schemadefinitionen vorhanden. Mit Ergänzungen zu den [**Klassen \_ CIM-Sensor**](cim-sensor.md) und [**CIM \_ NumericSensor**](cim-numericsensor.md) in Version 2.2 ist dies nicht mehr erforderlich. Ein Tachometer kann definiert werden, indem die **SensorType-Eigenschaft,** die vom **\_ CIM-Sensor** geerbt wird, auf 5 ("Tachometer") festgelegt wird. Andere Eigenschaften dieser Klasse sind hart codiert, um konstante Werte zu erhalten, die Definitionen in der Sensorhierarchie entsprechen.
...
Die **\_ CIM-Tachometerklasse** verfügt über die folgenden Membertypen:
...
Die **\_ CIM-Tachometerklasse** verfügt über diese Methoden.



| Methode                                                                | BESCHREIBUNG                                                                                                                              |
|:----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-tachometer.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-tachometer.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand eingedrung werden soll. Nicht von WMI implementiert.<br/> |
...
Die **\_ CIM-Tachometerklasse** verfügt über diese Eigenschaften.
...
Qualifizierer: [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Hundertstel Prozent")
</dt> </dl>
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("CurrentReading"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdCritical"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdFatal"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdNonCritical"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("MaxReadable"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("MinReadable"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("NominalReading"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMax"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMin"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("Auflösung"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Zehntel der Revolutionen pro Minute")
</dt> </dl>
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("Toleranz"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>

Toleranz des Sensors für die gemessene Eigenschaft. Diese Eigenschaft sowie die **Eigenschaften Auflösung** **und** Genauigkeit werden verwendet, um den tatsächlichen Wert der gemessenen physischen Eigenschaft zu berechnen. Die Toleranz kann variieren, je nachdem, ob das Gerät über seinen dynamischen Bereich linear ist.
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdCritical"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>
...
Qualifizierer: [**Überschreiben**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdFatal"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>
...
Qualifizierer: [**Überschreiben**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdNonCritical"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Revolutionen pro Minute")
</dt> </dl>
...
Die **CIM \_ Tachometer-Klasse** wird von [**CIM \_ NumericSensor**](cim-numericsensor.md)abgeleitet.
