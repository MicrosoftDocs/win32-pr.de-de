---
description: Die Reset-Methode der CIM \_ VolumeSet-Klasse fordert eine Zurücksetzung des logischen Geräts an.
...
ms.locfileid: "119700610"
---
# <a name="reset-method-of-the-cim_volumeset-class"></a>Reset-Methode der CIM \_ VolumeSet-Klasse

Die **Reset-Methode** der [**CIM \_ VolumeSet-Klasse**](cim-volumeset.md) fordert eine Zurücksetzung des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
