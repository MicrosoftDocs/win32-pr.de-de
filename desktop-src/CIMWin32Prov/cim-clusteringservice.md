...
Die **CIM \_ clusteringservice** -Klasse stellt die Funktionalität dar, die von einem Cluster bereitgestellt wird. Beispielsweise können Failoverfunktionen als Dienst eines Failoverclusters modelliert werden.
...
Die **CIM \_ clusteringservice** -Klasse verfügt über diese Typen von Membern:
...
|:---------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------|
| [**AddNode**](addnode-method-in-class-cim-clusteringservice.md)           | Klassenmethode, mit der ein neues Computersystem in einen Cluster integriert wird. Wird nicht von WMI implementiert.<br/>          |
| [**Evictnode**](evictnode-method-in-class-cim-clusteringservice.md)       | Klassenmethode, mit der ein Computersystem aus einem Cluster entfernt wird. Wird nicht von WMI implementiert.<br/>             |
| [**Start Service**](startservice-method-in-class-cim-clusteringservice.md) | Klassenmethode, die versucht, den Dienst in seinen Startzustand zu versetzen. Wird nicht von WMI implementiert.<br/> |
| [**Stop Service**](stopservice-method-in-class-cim-clusteringservice.md)   | Klassenmethode, die den Dienst in den Zustand "beendet" versetzt. Wird nicht von WMI implementiert.<br/>              |
...
Die Name-Eigenschaft identifiziert den Dienst eindeutig und gibt Aufschluss über die verwaltete Funktionalität. Diese Funktionalität wird in der Description-Eigenschaft des Objekts ausführlicher beschrieben.
...
Die **CIM \_ clusteringservice** -Klasse wird vom [**CIM- \_ Dienst**](cim-service.md)abgeleitet.
