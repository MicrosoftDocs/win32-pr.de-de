...
---
# <a name="reset-method-of-the-cim_magnetoopticaldrive-class"></a>Reset-Methode der CIM- \_ Klasse "magnedeopticaldrive"

Die **Reset** -Methode der CIM- \_ Klasse "magnetoopticaldrive" fordert eine zurück setzung des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[CIM- \_ Magnet Laufwerk](reset-method-in-class-cim-magnetoopticaldrive.md)
</dt> <dt>
