...
---
# <a name="win32_infrareddevice-class"></a>Win32- \_ Klasse "infrareddevice"

Die [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) " **Win32 \_ infrareddevice** " stellt die Funktionen und die Verwaltung eines Infrarot Geräts dar.
...
Die Win32-Klasse " **\_ infrareddevice** " verfügt über diese Typen von Membern:
...
Die Win32-Klasse " **\_ infrareddevice** " verfügt über diese Methoden.



| Methode            | BESCHREIBUNG                                                                                                                                                                                                                |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**Reset**](reset-method-in-class-cim-controller.md) -Methode in [**CIM \_ infraredcontroller**](cim-infraredcontroller.md) für die Dokumentation.<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie in der [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) -Methode in [**CIM \_ infraredcontroller**](cim-infraredcontroller.md) .<br/> |
...
Die Win32-Klasse " **\_ infrareddevice** " verfügt über diese Eigenschaften.
...
Eindeutiger Bezeichner des Infrarot Geräts.
...
Maximale Anzahl direkt Adressier barer Entitäten, die von diesem Gerät unterstützt werden. Wenn die Zahl unbekannt ist, sollte ein Wert von 0 (null) verwendet werden.
...
Die Win32-Klasse " **\_ infrareddevice** " ist von [**CIM " \_ infraredcontroller**](cim-infraredcontroller.md)" abgeleitet.
