...
Stellt eine PNP-Geräte Eigenschaft vom Typ **Uint8** dar.
...
Die **Win32- \_ PnPDevicePropertyUint8** -Klasse verfügt über diese Typen von Membern:

-   [Eigenschaften](#properties)

### <a name="properties"></a>Eigenschaften

Die **Win32- \_ PnPDevicePropertyUint8** -Klasse verfügt über diese Eigenschaften.
