...
---
# <a name="win32_sounddevice-class"></a>Win32 \_ Sound Device-Klasse

Die [WMI-Klasse](../wmisdk/retrieving-a-class.md) des **Win32- \_ Sound Geräts** stellt die Eigenschaften eines Sound Geräts auf einem Computersystem dar, auf dem Windows ausgeführt wird.
...
Die **Win32 \_ Sound Device** -Klasse verfügt über diese Typen von Membern:
...
Die **Win32 \_ Sound Device** -Klasse verfügt über diese Methoden.
...
Die **Win32 \_ Sound Device** -Klasse verfügt über diese Eigenschaften.
...
Qualifizierer: [**override**](../wmisdk/standard-qualifiers.md) ("Geräte-ID"), [**Key**](../wmisdk/key-qualifier.md), [**maxlen**](../wmisdk/standard-qualifiers.md) (260), [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ mediaresources Wave Geräte-ID \\ \\ \| ")
</dt> </dl>

Eindeutiger Bezeichner des Audiogeräts.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("WMI"), [**Einheiten**](../wmisdk/standard-qualifiers.md) ("Kilobyte")
</dt> </dl>

Größe des direkten Speicherzugriffs Puffers.
...
Die e/a-Startadresse, die dem MPU-401-Port des Audiogeräts zugewiesen ist.
...
Der Produktname des Audiogeräts.

Beispiel: "Creative Labs Sound blaester AWE64PNP"
...
Die **Win32 \_ Sound Device** -Klasse wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)abgeleitet.

## <a name="examples"></a>Beispiele

Das PowerShell-Beispiel zum [Auflisten von Soundkarten Eigenschaften](https://Gallery.TechNet.Microsoft.Com/scriptcenter/86550b1a-bb3f-47c3-8056-bbd57e508b7a) Ruft Informationen zu allen Sound Karten ab, die auf einem Computer installiert sind.
