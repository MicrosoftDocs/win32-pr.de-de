...
---
# <a name="reset-method-of-the-cim_aggregatepsextent-class"></a>Reset-Methode der CIM- \_ aggregatepsextent-Klasse

Die **Reset** -Methode der CIM- \_ aggregatepsextent-Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
