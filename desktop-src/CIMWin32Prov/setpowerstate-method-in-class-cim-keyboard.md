...
---
# <a name="setpowerstate-method-of-the-cim_keyboard-class"></a>SetPowerState-Methode der CIM- \_ Tastatur Klasse

Mit der **SetPowerState** -Methode der CIM \_ -Tastatur Klasse wird der gewünschte Energiezustand für ein logisches Gerät festgelegt, und wenn ein Gerät in diesen Zustand versetzt werden soll. In einer Unterklasse sollte der Satz möglicher Rückgabecodes mit einem **ValueMap** -Qualifizierer für die-Methode angegeben werden. Die Zeichen folgen, in die der **ValueMap** -Inhalt übersetzt wird, sollten in der-Unterklasse auch als **Werte** Array Qualifizierer angegeben werden. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[CIM- \_ Tastatur](setpowerstate-method-in-class-cim-keyboard.md)
</dt> <dt>
