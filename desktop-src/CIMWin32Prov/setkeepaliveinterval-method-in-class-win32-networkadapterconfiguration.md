---
description: Die statische WMI-Klasse SetKeepAliveInterval wird verwendet, um das Intervall festzulegen, das Keep Alive-Neuübertragungen trennt, bis eine Antwort empfangen wird.
ms.assetid: 83415000-124a-44a7-93cc-92ce9df143aa
ms.tgt_platform: multiple
title: SetKeepAliveInterval-Methode der Win32_NetworkAdapterConfiguration-Klasse
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119759770"
---
# <a name="setkeepaliveinterval-method-of-the-win32_networkadapterconfiguration-class"></a>SetKeepAliveInterval-Methode der Win32 \_ NetworkAdapterConfiguration-Klasse

Die statische [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) **SetKeepAliveInterval** wird verwendet, um das Intervall festzulegen, das Keep Alive-Neuübertragungen trennt, bis eine Antwort empfangen wird.
...
Wert in Millisekunden für das Intervall, das Keep Alive-Neuübertragungen trennt, bis eine Antwort empfangen wird.
...
Nachdem eine Antwort empfangen wurde, wird die Verzögerung bis zur nächsten Keep Alive-Übertragung wieder durch den Wert der [**KeepAliveTime-Eigenschaft**](win32-networkadapterconfiguration.md) gesteuert. Die Verbindung wird beendet, nachdem die Anzahl von Neuübertragungen, die von der **TcpMaxDataRetransmissions-Eigenschaft** angegeben wurden, nicht mehr beantwortet wurde.

## <a name="examples"></a>Beispiele

Im VbScript-Beispiel [Ändern des Keep Alive-Intervalls für alle Netzwerkadapter](https://Gallery.TechNet.Microsoft.Com/f6d4a0e7-5b59-42e3-888d-82a028e2bf35) wird das Keep-Alive-Intervall für alle Netzwerkadapter auf einem Computer auf 300,00 Millisekunden (5 Minuten) konfiguriert.
