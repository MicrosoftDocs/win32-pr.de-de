...
Mit der **CIM \_ removefileaction** -Klasse werden Dateien deinstalliert.
...
Die **CIM \_ removefileaction** -Klasse verfügt über diese Typen von Membern:
...
|:--------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-removefileaction.md) | Führt eine bestimmte Aktion aus. Wird nicht von WMI implementiert.<br/> |
