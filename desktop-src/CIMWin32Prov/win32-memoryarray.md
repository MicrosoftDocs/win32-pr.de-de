...
---
# <a name="win32_memoryarray-class"></a>Win32 \_ memoryarray-Klasse

Die **Win32 \_ memoryarray** - [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) stellt die Eigenschaften des Computersystem-Speicherarrays und der zugeordneten Adressen dar.
...
Die **Win32 \_ memoryarray** -Klasse verfügt über diese Typen von Membern:
...
Die **Win32 \_ memoryarray** -Klasse verfügt über diese Methoden.



| Methode            | BESCHREIBUNG                                                                                                                                                                                                        |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**Reset**](reset-method-in-class-cim-controller.md) -Methode in [**Win32 \_ smbiosmemory**](win32-smbiosmemory.md) für die Dokumentation.<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) -Methode in [**Win32 \_ smbiosmemory**](win32-smbiosmemory.md) für die Dokumentation.<br/> |
...
Die **Win32 \_ memoryarray** -Klasse verfügt über diese Eigenschaften.
...
Typ des verfügbaren Medien Zugriffs.
...
Dieser Wert stammt aus der zugeordneten Adressstruktur des **Speicherarrays** in den SMBIOS-Versionsinformationen. Für SMBIOS-Versionen 2,1 bis 2,6 wird der Wert vom **endadressmember** abgeleitet. Für SMBIOS, Version 2.7 und höher, stammt der Wert vom **erweiterten endadressmember** .
...
**4** (Arbeitsspeicher-Partitions Ebene)
...
Diese Eigenschaft wird von [**CIM \_ storageblock**](cim-storageextent.md)geerbt. Die Werte sind:

<dl> <dd>Außer</dd> <dd>Unbekannter</dd> <dd>"None"</dd> <dd>Parity</dd> <dd>"Single-Bit ECC"</dd> <dd>"Multi-Bit ECC"</dd> <dd>Lobte</dd> </dl>
...
Dieser Wert stammt aus der zugeordneten Adressstruktur des **Speicherarrays** in den SMBIOS-Versionsinformationen. Für SMBIOS-Versionen 2,1 bis 2,6 wird der Wert vom **anfangs adressmember** abgeleitet. Für SMBIOS, Version 2.7 und höher, stammt der Wert vom **erweiterten startadressmember** .
...
Die **Win32-Klasse \_ memoryarray** wird von [**Win32 \_ smbiosmemory**](win32-smbiosmemory.md)abgeleitet.
