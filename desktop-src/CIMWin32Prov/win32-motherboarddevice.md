---
description: Die \_ WMI-Klasse Win32-HauptplatineDevice stellt ein Gerät dar, das die zentralen Komponenten des Windows-Computersystems enthält.
...
ms.locfileid: "119973070"
---
# <a name="win32_motherboarddevice-class"></a>\_Win32-Klasse "MotherboardDevice"

Die [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) **Win32-HauptplatineDevice \_** stellt ein Gerät dar, das die zentralen Komponenten des Windows-Computersystems enthält.
...
Die **\_ Win32-Klasse "HauptplatineDevice"** verfügt über folgende Typen von Membern:
...
Die **\_ Win32-Klasse "HauptplatineDevice"** verfügt über diese Methoden.
...
Die **\_ Win32-Klasse "HauptplatineDevice"** verfügt über diese Eigenschaften.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ LOCAL MACHINE HARDWARE DESCRIPTION System \_ \\ \\ \\ \\ \\ \\ \\ \\ MultifunctionAdapter \| Identifier")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ LOCAL MACHINE HARDWARE DESCRIPTION \_ \\ \\ \\ \\ \\ \\ System")
</dt> </dl>
...
Sekundärer Bustyp der Hauptplatine.
...
Die **\_ Win32-Klasse "Hauptgeräte"** wird von [**CIM \_ LogicalDevice abgeleitet.**](cim-logicaldevice.md)

## <a name="examples"></a>Beispiele

Die folgenden [JavaScript-](https://Gallery.TechNet.Microsoft.Com/05bbadf8-1356-43a6-82fc-fcab40233fe5) und [PowerShell-Codebeispiele](https://Gallery.TechNet.Microsoft.Com/cb520044-836e-425c-8c12-a9586d1c0e6e) rufen Hauptplatineninformationen ab.

Im folgenden VBScript-Codebeispiel werden Hauptplatineninformationen abgerufen.
