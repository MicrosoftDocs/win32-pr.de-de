...
---
# <a name="win32_motherboarddevice-class"></a>Win32- \_ Klasse "motherboarddevice"

Die [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) des **Win32- \_ motherboardgeräts** stellt ein Gerät dar, das die zentralen Komponenten des Windows-Computer Systems enthält.
...
Die Win32-Klasse " **\_ motherboarddevice** " verfügt über diese Typen von Membern:
...
Die Win32-Klasse " **\_ motherboarddevice** " verfügt über diese Methoden.
...
Die Win32-Klasse " **\_ motherboarddevice** " verfügt über diese Eigenschaften.
...
Eindeutiger Bezeichner dieser Hauptplatine.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ local \_ Machine \\ \\ Hardware \\ \\ Description \\ \\ System \\ \\ multifunctionadapter \| Identifier")
</dt> </dl>

Primärer Bustyp der Hauptplatine.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ local \_ Machine \\ \\ Hard \\ \\ Description \\ \\ System")
</dt> </dl>

Die Revisionsnummer der Hauptplatine.
...
Der sekundäre Bustyp der Hauptplatine.
...
Die Win32-Klasse " **\_ motherboarddevice** " ist von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)abgeleitet.

## <a name="examples"></a>Beispiele

Die folgenden [JavaScript](https://Gallery.TechNet.Microsoft.Com/05bbadf8-1356-43a6-82fc-fcab40233fe5) -und [PowerShell](https://Gallery.TechNet.Microsoft.Com/cb520044-836e-425c-8c12-a9586d1c0e6e) -Codebeispiele rufen die Motherboard-Informationen ab.

Im folgenden VBScript-Codebeispiel werden die Hauptinformationen abgerufen.
