...
ms.locfileid: "119924890"
---
# <a name="cim_coolingdevice-class"></a>CIM \_ CoolingDevice-Klasse

Die **CIM \_ CoolingDevice-Klasse** stellt die Funktionen und die Verwaltung von Kühlgeräten dar.
...
Die **CIM \_ CoolingDevice-Klasse** verfügt über diese Typen von Membern:
...
Die **CIM \_ CoolingDevice-Klasse** verfügt über diese Methoden.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-coolingdevice.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand versetzt werden soll. Nicht von WMI implementiert.<br/> |
...
Die **CIM \_ CoolingDevice-Klasse** verfügt über diese Eigenschaften.
...
Die **CIM \_ CoolingDevice-Klasse** wird von [**CIM \_ LogicalDevice abgeleitet.**](cim-logicaldevice.md)

WMI implementiert diese Klasse nicht. Informationen zu Klassen, die **von CIM \_ CoolingDevice abgeleitet wurden,** finden Sie unter [Win32-Klassen.](win32-provider.md)
