...
---
# <a name="startservice-method-of-the-cim_bootservice-class"></a>Start Service-Methode der CIM- \_ Bootservice-Klasse

Die **Start Service** -Methode versetzt den Dienst in den Status "Start". In einer Unterklasse kann der Satz möglicher Rückgabecodes mit einem **ValueMap** -Qualifizierer für die-Methode angegeben werden. Die Zeichen folgen, in die der **ValueMap** -Inhalt übersetzt wird, können auch in der Unterklasse als **Werte** Array Qualifizierer angegeben werden. Diese Methode wird vom [**CIM- \_ Dienst**](cim-service.md)geerbt.
