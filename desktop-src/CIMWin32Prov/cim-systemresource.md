---
description: Die CIM \_ SystemResource-Klasse stellt eine Entität dar, die vom BIOS verwaltet wird, oder ein Betriebssystem, das für die Verwendung durch Software und logische Geräte verfügbar ist.
...
ms.locfileid: "119919040"
---
# <a name="cim_systemresource-class"></a>\_CIM-SystemResource-Klasse

Die **CIM \_ SystemResource-Klasse** stellt eine Entität dar, die vom BIOS verwaltet wird, oder ein Betriebssystem, das für die Verwendung durch Software und logische Geräte verfügbar ist.
...
Die **CIM \_ SystemResource-Klasse** verfügt über diese Typen von Membern:

-   [Eigenschaften](#properties)

### <a name="properties"></a>Eigenschaften

Die **CIM \_ SystemResource-Klasse** verfügt über diese Eigenschaften.
...
Die **CIM \_ SystemResource-Klasse** wird von [**CIM \_ LogicalElement**](cim-logicalelement.md)abgeleitet.

WMI implementiert diese Klasse nicht. Informationen zu WMI-Klassen, die von **CIM \_ SystemResource** abgeleitet werden, finden Sie unter [Win32-Klassen.](win32-provider.md)
