...
---
# <a name="cim_systemresource-class"></a>CIM- \_ systemressourcenklasse

Die **CIM- \_ systemressourcenklasse** stellt eine Entität dar, die von BIOS verwaltet wird, oder ein Betriebssystem, das für die Verwendung durch Software und logische Geräte verfügbar ist.
...
Die **CIM- \_ systemressourcenklasse** verfügt über diese Typen von Membern:

-   [Eigenschaften](#properties)

### <a name="properties"></a>Eigenschaften

Die **CIM- \_ systemressourcenklasse** verfügt über diese Eigenschaften.
...
Die **CIM- \_ systemressourcenklasse** wird von [**CIM \_ LogicalElement**](cim-logicalelement.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu WMI-Klassen, die von **CIM \_ Systemresource** abgeleitet sind, finden Sie unter [Win32](win32-provider.md)
