---
description: Die CIM \_ FileAction-Klasse ermöglicht es dem Autor, Dateien zu suchen, die bereits auf dem Computer eines Benutzers vorhanden sind, und diese Dateien dann an einen neuen Speicherort zu verschieben oder zu kopieren.
...
ms.locfileid: "122884797"
---
# <a name="cim_fileaction-class"></a>CIM \_ FileAction-Klasse

Die **CIM \_ FileAction-Klasse** ermöglicht es dem Autor, Dateien zu suchen, die bereits auf dem Computer eines Benutzers vorhanden sind, und diese Dateien dann an einen neuen Speicherort zu verschieben oder zu kopieren.
...
Die **CIM \_ FileAction-Klasse** verfügt über folgende Typen von Membern:
...
|:--------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-fileaction.md) | Führt eine bestimmte Aktion aus. Nicht von WMI implementiert.<br/> |
...
WMI implementiert diese Klasse nicht. Informationen zu Klassen, die von **CIM \_ FileAction abgeleitet wurden,** finden Sie unter [Win32-Klassen.](win32-provider.md)
