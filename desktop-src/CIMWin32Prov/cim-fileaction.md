...
---
# <a name="cim_fileaction-class"></a>CIM- \_ fileaction-Klasse

Mit der **CIM \_ fileaction** -Klasse kann der Autor Dateien suchen, die bereits auf dem Computer eines Benutzers vorhanden sind, und diese Dateien dann verschieben oder an einen neuen Speicherort kopieren.
...
Die **CIM \_ fileaction** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM \_ fileaction** -Klasse verfügt über diese Methoden.



| Methode                                                  | BESCHREIBUNG                                                   |
|:--------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-fileaction.md) | Führt eine bestimmte Aktion aus. Wird nicht von WMI implementiert.<br/> |
...
Die **CIM \_ fileaction** -Klasse verfügt über diese Eigenschaften.
...
Diese Klasse wird von WMI nicht implementiert. Informationen zu von **CIM \_ fileaction** abgeleiteten Klassen finden Sie unter [Win32-Klassen](win32-provider.md).
