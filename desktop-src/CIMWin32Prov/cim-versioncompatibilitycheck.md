---
description: Die CIM \_ VersionCompatibilityCheck-Klasse gibt an, ob es zulässig ist, den nächsten Zustand eines Softwareelements zu erstellen.
...
ms.locfileid: "118420387"
---
# <a name="cim_versioncompatibilitycheck-class"></a>CIM \_ VersionCompatibilityCheck-Klasse

Die **CIM \_ VersionCompatibilityCheck-Klasse** gibt an, ob es zulässig ist, den nächsten Zustand eines Softwareelements zu erstellen.
...
Die **CIM \_ VersionCompatibilityCheck-Klasse** verfügt über folgende Typen von Membern:
...
True gibt an, dass das Softwareelement in den nächsten Zustand übergehen kann, unabhängig davon, ob eine höhere oder letztere Version des Softwareelements bereits in der Umgebung vorhanden ist.
...
Steuert die Möglichkeit, mehrere Versionen eines Produkts auf einem System zu konfigurieren.
...
True gibt an, dass das Softwareelement in den nächsten Zustand übergehen kann, unabhängig davon, ob ein Softwareelement derselben Version bereits in der Umgebung vorhanden ist.
