---
description: Die \_ Win32 Bus-WMI-Klasse stellt einen physischen Bus dar, der von einem Computer mit einem Windows Betriebssystem erkannt wird. Jede Instanz eines Windows Bus ist ein Nachfolger (oder Member) dieser Klasse.
...
ms.locfileid: "119020318"
---
# <a name="win32_bus-class"></a>Win32 \_ Bus-Klasse

Die **Win32 \_ Bus-WMI-Klasse** stellt einen physischen Bus dar, der von einem Computer mit einem Windows Betriebssystem erkannt wird. [](/windows/desktop/WmiSdk/retrieving-a-class) Jede Instanz eines Windows Bus ist ein Nachfolger (oder Member) dieser Klasse.
...
Die **Win32 \_ Bus-Klasse** verfügt über diese Typen von Membern:
...
Die **Win32 \_ Bus-Klasse** verfügt über diese Methoden.



| Methode            | Beschreibung                                                                                                                                                                                                      |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie in der Dokumentation zur [**Reset-Methode**](reset-method-in-class-cim-controller.md) in [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie in der Dokumentation zur [**SetPowerState-Methode**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)<br/> |
...
Die **Win32 \_ Bus-Klasse** verfügt über diese Eigenschaften.
...
Logische Nummer, die dem physischen Bus zugewiesen ist.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| cHwRes \| INTERFACE \_ TYPE")
</dt> </dl>

Typ des physischen Bus. Dieser Wert ist einer der Werte in der **INTERFACE \_ TYPE-Enumeration,** die in Bus.h definiert ist.
...
**Maximaler Schnittstellentyp** (16)
...
Eindeutiger Name, der den Bus identifiziert.
...
Die **Win32 \_ Bus-Klasse** wird von [**CIM \_ LogicalDevice abgeleitet.**](cim-logicaldevice.md)
