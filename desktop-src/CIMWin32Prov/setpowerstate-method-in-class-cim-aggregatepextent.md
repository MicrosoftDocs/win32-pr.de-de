...
---
# <a name="setpowerstate-method-of-the-cim_aggregatepextent-class"></a>SetPowerState-Methode der CIM- \_ aggregatepblock-Klasse

Die **SetPowerState** -Methode legt den gewünschten Energiezustand für ein logisches Gerät fest, und wenn das Gerät in diesen Zustand versetzt werden soll. In einer Unterklasse sollte der Satz möglicher Rückgabecodes mit einem **ValueMap** -Qualifizierer für die-Methode angegeben werden. Die Zeichen folgen, in die der **ValueMap** -Inhalt übersetzt wird, sollten in der-Unterklasse auch als **Werte** Array Qualifizierer angegeben werden. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[**CIM- \_ aggregatepblock**](setpowerstate-method-in-class-cim-aggregatepextent.md)
</dt> <dt>
