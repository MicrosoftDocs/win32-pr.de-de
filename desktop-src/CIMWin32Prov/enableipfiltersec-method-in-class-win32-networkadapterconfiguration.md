...
---
# <a name="enableipfiltersec-method-of-the-win32_networkadapterconfiguration-class"></a>EnableIPFilterSec-Methode der Win32 \_ networkadapterconfiguration-Klasse

Die statische Methode " **EnableIPFilterSec** " der [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) wird verwendet, um die Internet Protokoll Sicherheit (IPSec) global über alle IP-gebundenen Netzwerkadapter hinweg zu aktivieren.
...
*Ipfiltersecurityaktiviert* \[ in\]
</dt> <dd>

**True** gibt an, dass IPSec auf allen IP-gebundenen Netzwerkadaptern global aktiviert ist. **False** gibt an, dass der gesamte Port-und Protokoll Datenverkehr ungefiltert weitergeleitet werden darf.
...
Wenn die Sicherheit aktiviert ist, können die Eigenschaften der operativen Sicherheit für einen beliebigen Netzwerkadapter mithilfe der Netzwerkadapter spezifischen [**EnableIPSec**](enableipsec-method-in-class-win32-networkadapterconfiguration.md) -Methode gesteuert werden.

## <a name="examples"></a>Beispiele

Der folgende Code, der aus dem Beispiel zum [Aktivieren der IPFilter-Sicherheit auf allen Netzwerkadaptern](https://Gallery.TechNet.Microsoft.Com/f8e56021-5a54-4554-b7b6-d76cc40d8d1d) in der TechNet Gallery stammt, aktiviert die IP-Filter Sicherheit für alle auf einem Computer installierten Netzwerkadapter.
