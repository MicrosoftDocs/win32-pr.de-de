...
Die statische Methode **setdeadgwdetect** [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) wird verwendet, um die Erkennung von unzustellbaren Gateways zu aktivieren.
...
**True** gibt an, dass die Erkennung von deadlockgateways aktiviert werden soll.
...
Wenn diese Funktion aktiviert ist, fordert TCP die IP-Adresse auf, um zu einem Sicherungs Gateway zu wechseln, wenn ein Segment mehrmals neu übermittelt wird, ohne eine Antwort zu erhalten

## <a name="examples"></a>Beispiele

Das Beispiel Aktivieren der Erkennung von unzustellbaren Gateways [für alle Netzwerkadapter](https://Gallery.TechNet.Microsoft.Com/4a24b080-1a8b-4085-9419-58d096ef8437) VBScript in der TechNet Gallery verwendet **setdeadgwdetect** , um alle Netzwerkadapter auf einem Computer so zu konfigurieren, dass unzustellbare Gateways automatisch erkannt werden.
