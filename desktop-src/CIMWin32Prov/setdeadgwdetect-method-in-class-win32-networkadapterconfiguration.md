---
description: Die statische Methode der WMI-Klasse SetDeadGWDetect wird verwendet, um die Erkennung von intakten Gateways zu aktivieren.
...
ms.locfileid: "119760080"
---
# <a name="setdeadgwdetect-method-of-the-win32_networkadapterconfiguration-class"></a>SetDeadGWDetect-Methode der Win32 \_ NetworkAdapterConfiguration-Klasse

Die statische Methode der [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) **SetDeadGWDetect** wird verwendet, um die Erkennung von intakten Gateways zu aktivieren.
...
True gibt **an,** dass die Erkennung von inaktiven Gateways aktiviert sein sollte.
...
Wenn dieses Feature aktiviert ist, fordert TCP die IP-Adresse auf, zu einem Sicherungsgateway zu wechseln, wenn es ein Segment mehrmals erneut überträgt, ohne eine Antwort zu erhalten.

## <a name="examples"></a>Beispiele

Das VBScript-Beispiel Enable [Dead Gateway Detection for All Network Adapters](https://Gallery.TechNet.Microsoft.Com/4a24b080-1a8b-4085-9419-58d096ef8437) (Erkennung von toten Gateways für alle Netzwerkadapter aktivieren) im TechNet-Katalog verwendet **SetDeadGWDetect,** um alle Netzwerkadapter auf einem Computer so zu konfigurieren, dass dead gateways automatisch erkannt werden.
