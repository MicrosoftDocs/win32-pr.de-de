---
description: Die Reset-Methode der CIM \_ NonVolatileStorage-Klasse fordert eine Zurücksetzung des logischen Geräts an.
...
ms.locfileid: "118418855"
---
# <a name="reset-method-of-the-cim_nonvolatilestorage-class"></a>Reset-Methode der CIM \_ NonVolatileStorage-Klasse

Die **Reset-Methode** der CIM \_ NonVolatileStorage-Klasse fordert eine Zurücksetzung des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice geerbt.**](cim-logicaldevice.md)
