...
---
# <a name="reset-method-of-the-cim_nonvolatilestorage-class"></a>Reset-Methode der \_ NonVolatileStorage-Klasse von CIM

Die **Reset** -Methode der \_ NonVolatileStorage-Klasse von CIM fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
