...
---
# <a name="reset-method-of-the-cim_fan-class"></a>Reset-Methode der CIM- \_ Lüfter-Klasse

Die **Reset** -Methode der CIM- \_ Lüfter-Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[CIM- \_ Lüfter](reset-method-in-class-cim-fan.md)
</dt> <dt>
