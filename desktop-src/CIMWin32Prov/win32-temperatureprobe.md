---
description: Win32 \_ TemperatureProbe&\# 32; Die WMI-Klasse stellt die Eigenschaften eines Temperatursensors (elektronisches Thermometer) dar.
...
ms.locfileid: "119827670"
---
# <a name="win32_temperatureprobe-class"></a>Win32 \_ TemperatureProbe-Klasse

Die **\_ WMI-Klasse Win32 TemperatureProbe** stellt die Eigenschaften eines Temperatursensors (elektronisches Thermometer) dar. [](../wmisdk/retrieving-a-class.md)

Die meisten Informationen, die die WMI-Klasse **\_ Win32 TemperatureProbe** bietet, stammen aus SMBIOS. Echtzeitlesewerte für die **CurrentReading-Eigenschaft** können nicht aus SMBIOS-Tabellen extrahiert werden. Aus diesem Grund füllen aktuelle Implementierungen von WMI die **CurrentReading-Eigenschaft nicht** auf. Das **Vorhandensein der CurrentReading-Eigenschaft** ist für die zukünftige Verwendung reserviert.
...
Die **Win32 \_ TemperatureProbe-Klasse** verfügt über die folgenden Membertypen:
...
|:------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie in der [**Reset-Methode**](reset-method-in-class-cim-temperaturesensor.md) in [**CIM \_ TemperatureSensor.**](cim-temperaturesensor.md)<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie in der Dokumentation zur [**SetPowerState-Methode**](setpowerstate-method-in-class-cim-temperaturesensor.md) in [**CIM \_ TemperatureSensor.**](cim-temperaturesensor.md)<br/> |
...
Kurze Beschreibung eines Objekts– eine einzeilenbasierte Zeichenfolge.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Temperature Probe \| 001.5"), [**Units**](../wmisdk/standard-qualifiers.md) ("zehntel Grad Centigrade")
</dt> </dl>

Der vom Sensor angegebene aktuelle Wert.

Aktuelle Implementierungen von WMI füllen die **CurrentReading-Eigenschaft nicht** auf. Das **Vorhandensein der CurrentReading-Eigenschaft** ist für die zukünftige Verwendung reserviert.
...
Qualifizierer: [**Schlüssel,**](../wmisdk/key-qualifier.md) [**Überschreibung**](../wmisdk/standard-qualifiers.md) ("DeviceId"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("WMI")
</dt> </dl>
...
Weitere Informationen zu dem in **LastErrorCode** aufgezeichneten Fehler und Informationen zu allen Korrekturmaßnahmen, die Sie ergreifen können.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Temperature Probe \| 001.13"), [**Units**](../wmisdk/standard-qualifiers.md) ("zehntel Grad Centigrade")
</dt> </dl>

Sensorschwellenwert, um die Bereiche (Mindest- und Höchstwerte) anzugeben, die die Sensorbetriebsbedingungen identifizieren, die normale, nicht kritische, kritische oder schwerwiegende Bedingungen sein können. Wenn **CurrentReading zwischen** **LowerThresholdCritical** und **LowerThresholdFatal** liegt, ist der aktuelle Zustand kritisch.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Temperature Probe \| 001.15"), [**Units**](../wmisdk/standard-qualifiers.md) ("zehntel Grad Centigrade")
</dt> </dl>

Sensorschwellenwert, um die Bereiche (Mindest- und Höchstwerte) anzugeben, die die Sensorbetriebsbedingungen identifizieren, die normale, nicht kritische, kritische oder schwerwiegende Bedingungen sein können. Wenn **CurrentReading unter** **LowerThresholdFatal liegt,** ist der aktuelle Zustand schwerwiegender.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Temperature Probe \| 001.11"), [**Units**](../wmisdk/standard-qualifiers.md) ("zehntel Grad Centigrade")
</dt> </dl>

Sensorschwellenwert, um die Bereiche (Mindest- und Höchstwerte) anzugeben, die die Sensorbetriebsbedingungen identifizieren, die normale, nicht kritische, kritische oder schwerwiegende Bedingungen sein können. Wenn **CurrentReading** zwischen **LowerThresholdNonCritical** und **UpperThresholdNonCritical** liegt, gibt der Sensor einen Normalwert an. Wenn **CurrentReading** zwischen **LowerThresholdNonCritical** und **LowerThresholdCritical** liegt, ist der aktuelle Zustand nichtcritical.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Temperature Probe \| 001.9"), [**Units**](../wmisdk/standard-qualifiers.md) ("zehntel Grad Centigrade")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Temperature Probe \| 001.10"), [**Units**](../wmisdk/standard-qualifiers.md) ("zehntel Grad Centigrade")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Temperature Probe \| 001.6"), [**Units**](../wmisdk/standard-qualifiers.md) ("zehntel Grad Centigrade")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Temperature Probe \| 001.7"), [**Units**](../wmisdk/standard-qualifiers.md) ("zehntel Grad Centigrade")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|DMTF-Temperaturtest \| 001,8"), [**Einheiten**](../wmisdk/standard-qualifiers.md) ("Zehntel Grad Centigrade")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Temperature Probe \| 001.17"), [**Units**](../wmisdk/standard-qualifiers.md) ("hundredths of Degrees Centigrade")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|DMTF-Temperaturtest \| 001,18"), [**Einheiten**](../wmisdk/standard-qualifiers.md) ("Zehntel Grad Centigrade")
</dt> </dl>
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Temperature Probe \| 001.16"), [**Units**](../wmisdk/standard-qualifiers.md) ("zehntel Grad Centigrade")
</dt> </dl>

Die Schwellenwerte des Sensors geben die Bereiche (Mindest- und Höchstwerte) an, die die Betriebsbedingungen des Sensors identifizieren, die normale, nicht kritische, kritische oder schwerwiegende Bedingungen sein können. Wenn **CurrentReading** über **UpperThresholdFatal** liegt, ist der aktuelle Status schwerwiegend.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Temperature Probe \| 001.12"), [**Units**](../wmisdk/standard-qualifiers.md) ("zehntel Grad Centigrade")
</dt> </dl>
...
Im folgenden Beispiel werden Temperaturtestdaten für den lokalen Computer zurückgegeben.
