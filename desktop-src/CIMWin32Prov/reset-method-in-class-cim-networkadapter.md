...
Die **Reset** -Methode der CIM- \_ netzwerkadapterklasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[CIM- \_ Netzwerkadapter](reset-method-in-class-cim-networkadapter.md)
</dt> <dt>
