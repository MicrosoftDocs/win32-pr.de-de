---
description: Gibt die Eigenschaften eines Plug & Play an.
...
ms.locfileid: "118417138"
---
# <a name="win32_pnpentity-class"></a>Win32 \_ PnPEntity-Klasse

The **Win32\_PnPEntity** [WMI class](../wmisdk/retrieving-a-class.md) represents the properties of a Plug and Play device. Plug & Play Entitäten werden als Einträge in der Geräte-Manager in der Systemsteuerung.
...
Die **Win32 \_ PnPEntity-Klasse** verfügt über die folgenden Membertypen:
...
Die **Win32 \_ PnPEntity-Klasse** verfügt über diese Methoden.



| Methode                                                             | Beschreibung                                                                                                                                                                                    |
|:-------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Deaktivieren**](disable-win32-pnpentity.md)                         | Deaktiviert dieses Plug & Play Gerät.<br/>                                                                                                                                                 |
| [**Aktivieren**](enable-win32-pnpentity.md)                           | Aktiviert dieses Plug & Play Gerät.<br/>                                                                                                                                                  |
| [**GetDeviceProperties**](getdeviceproperties-win32-pnpentity.md) | Ruft die angegebenen Eigenschaften dieses Plug & Play ab.<br/>                                                                                                                         |
| **Zurücksetzen**                                                          | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie unter [**Reset-Methode**](reset-method-in-class-cim-controller.md) in [**CIM \_ LogicalDevice**](cim-logicaldevice.md).<br/>                 |
...
Die **Win32 \_ PnPEntity-Klasse** verfügt über diese Eigenschaften.
...
GuiD (Globally Unique Identifier) dieses Plug & Play Gerät.
...
Eine vom Hersteller definierte Identifikationszeichenfolge, die vom Setup verwendet wird, um ein Gerät mit einer INF-Datei zu abordnen. Einem Gerät kann eine Liste kompatibler IDs zugeordnet sein. Die kompatiblen IDs sollten in der Reihenfolge aufgeführt werden, in der die Eignung verringert wird. Wenn setup keine INF-Datei finden kann, die einer der Hardware-IDs eines Geräts entspricht, wird eine INF-Datei mit kompatiblen IDs gefunden. Eine kompatible ID hat das gleiche Format wie eine **HardwareID.** Weitere Informationen finden Sie unter [Windows Driver Kit](https://developer.microsoft.com/windows/hardware/download-kits-windows-hardware-development).
...
Eine vom Hersteller definierte Identifikationszeichenfolge, die vom Setup verwendet wird, um ein Gerät mit einer INF-Datei zu abordnen. Normalerweise verfügt ein Gerät über eine Liste von Hardware-IDs. Eine Ausnahme ist der Bustreiber 1394, der keine Hardware-IDs verwendet. Die erste Hardware-ID in der Liste sollte die Geräte-ID sein. Die verbleibenden IDs sollten in der Reihenfolge aufgeführt werden, in der die Eignung verringert wird.

Hardware-IDs werden in einem der folgenden Formate angezeigt:

-   \\Enumerator-Enumerator-specific-device-ID

    Dies ist das gängigste Format für einzelne PnP-Geräte. Ein Beispiel für einen Enumerator ist BIOS oder ISAPNP.

-   \*Enumeratorspezifische ID

    Ein Sternchen ( \* ) gibt die Verwendung durch mehrere Enumeratoren an.
...
<dl> <dd>\\ \* Stamm-PNPOF08</dd> <dd>PC \\ VEN \_ 1000&DEV \_ 001&SUBSYS \_ 000000000&REV \_ 02</dd> </dl>

Weitere Informationen finden Sie im Windows [Driver Kit](https://developer.microsoft.com/windows/hardware/download-kits-windows-hardware-development).
...
> [!WARNING]
> Diese Eigenschaft ist in der -Klasse nicht vorhanden, obwohl sie in der MOF-Datei aufgeführt ist. Die -Eigenschaft wird hier nur der Vollständigkeit halber und zur Verdeutlichung der MOF-Datei selbst beschrieben.
...
Die **SetPowerState-Methode** wird unterstützt. Diese Methode befindet sich in der übergeordneten [**CIM \_ LogicalDevice-Klasse**](cim-logicaldevice.md) und kann implementiert werden. Weitere Informationen finden Sie unter [Entwerfen von MOF-Klassen (Managed Object Format).](../wmisdk/designing-managed-object-format--mof--classes.md)
...
Name des Diensts, der dieses Plug & Play Gerät unterstützt. Weitere Informationen finden Sie unter [**Win32 \_ SystemDriverPnPEntity**](win32-systemdriverpnpentity.md).
...
Die **Win32 \_ PnPEntity-Klasse** wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)abgeleitet.

## <a name="examples"></a>Beispiele

Das [Get-BrokenHardware.ps1](https://Gallery.TechNet.Microsoft.Com/dbb678f4-b95b-45c3-bc8b-2ae2d052448e) PowerShell-Beispiel im TechNet-Katalog verwendet **win32 \_ PnPEntity,** um eine Liste nicht funktionierender Hardware mithilfe von WMI abzurufen.
...
[Herstellen einer Verbindung mit WMI auf einem Remotecomputer](../wmisdk/connecting-to-wmi-on-a-remote-computer.md)
</dt> <dt>
