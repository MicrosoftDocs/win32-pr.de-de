...
---
# <a name="reset-method-of-the-cim_display-class"></a>Reset-Methode der CIM- \_ Anzeige Klasse

Die **Reset** -Methode der CIM- \_ Anzeige Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[CIM- \_ Anzeige](reset-method-in-class-cim-display.md)
</dt> <dt>
