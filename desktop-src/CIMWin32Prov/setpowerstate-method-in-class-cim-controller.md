---
description: 'SetPowerState-Methode der CIM_Controller-Klasse: Die SetPowerState-Methode legt den gewünschten Energiezustand für ein logisches Gerät fest und legt fest, wann ein Gerät in diesen Zustand versetzt werden soll.'
...
ms.locfileid: "119439620"
---
# <a name="setpowerstate-method-of-the-cim_controller-class"></a>SetPowerState-Methode der CIM \_ Controller-Klasse
...
Diese Methode wird derzeit nicht von WMI implementiert. Um diese Methode zu verwenden, müssen Sie sie in Ihrem eigenen Anbieter implementieren. Weitere Informationen finden Sie unter [Erstellen von WMI-Anbietern.](/windows/desktop/WmiSdk/creating-wmi-providers)
...
[\_CIM-Controller](setpowerstate-method-in-class-cim-controller.md)
</dt> <dt>
