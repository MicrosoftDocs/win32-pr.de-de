---
description: Die CIM \_ Check-Klasse stellt eine Bedingung oder ein Merkmal dar, die in einer Umgebung, die von einer Instanz einer CIM ComputerSystem-Klasse definiert oder umgrenzt wird, true sein \_ soll.
...
Bedingungen, die erfüllt sein sollen, wenn sich ein Softwareelement in einer bestimmten Umgebung befindet, werden als Zustandsbedingungen bezeichnet. Bedingungen, die erfüllt sein müssen, um das aktuelle Softwareelement in den nächsten Zustand zu übergehen, werden als Next-State-Bedingungen bezeichnet.

Ein [**CIM \_ ComputerSystem-Objekt**](cim-computersystem.md) stellt die Umgebung dar, in der ein [**CIM \_ SoftwareElement**](cim-softwareelement.md) bereits installiert ist oder in der ein **CIM \_ SoftwareElement** installiert wird. Für den Fall, dass ein Softwareelement bereits installiert ist, wird die [**CIM \_ InstalledSoftwareElement-Zuordnung**](cim-installedsoftwareelement.md) verwendet, um das **\_ CIM-ComputerSystem-Objekt** zu identifizieren, das die "Umgebung" darstellt. Wenn ein Softwareelement verteilt und auf einem anderen Computer installiert wird, ist das **CIM \_ ComputerSystem-Objekt** für das Zielsystem die Umgebung.
...
|:---------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-check.md) | Führt eine bestimmte Aktion aus. Nicht von WMI implementiert.<br/> |
