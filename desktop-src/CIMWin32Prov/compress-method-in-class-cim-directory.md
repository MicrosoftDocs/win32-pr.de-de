...
---
# <a name="compress-method-of-the-cim_directory-class"></a>Methode komprimieren der CIM- \_ Verzeichnis Klasse

Die Methode **komprimieren** komprimiert die im Objekt Pfad angegebene Datei (oder das Verzeichnis) des logischen Verzeichnisses. Diese Methode wird von [**CIM \_ LogicalFile**](cim-logicalfile.md)geerbt.
...
[CIM- \_ Verzeichnis](compress-method-in-class-cim-directory.md)
</dt> <dt>
