...
Diese Methode ist veraltet. Anwendungen sollten die Quality of Service (QoS)-API verwenden, um Typ von Dienst Bits (TOS) zu bearbeiten. Weitere Informationen finden Sie unter [Quality of Service](/previous-versions/windows/desktop/qos/qos-start-page).
...
Der Typ des Dienst Werts (TOS), der im Header von ausgehenden IP-Paketen abgelegt wurde. Eine Definition der Werte finden Sie unter RFC 791.
...
Die statische Methode **setdefaulttos** [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) wird verwendet, um den Standardwert von TOS im Header von ausgehenden IP-Paketen festzulegen.
