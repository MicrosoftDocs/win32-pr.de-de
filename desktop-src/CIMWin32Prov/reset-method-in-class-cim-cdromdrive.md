...
---
# <a name="reset-method-of-the-cim_cdromdrive-class"></a>Reset-Methode der CIM \_ cdromdrive-Klasse

Die **Reset** -Methode der CIM \_ cdromdrive-Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
