...
---
# <a name="cim_alarmdevice-class"></a>CIM \_ alarmdevice-Klasse

Die **CIM \_ alarmdevice** -Klasse ist ein Alarmgerät, das akustische oder sichtbare Anzeichen für eine Problemsituation ausgibt.
...
Die **CIM \_ alarmdevice** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM \_ alarmdevice** -Klasse verfügt über diese Methoden.



| Methode                                                                 | BESCHREIBUNG                                                                                                                             |
|:-----------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-alarmdevice.md)                 | Fordert die zurück Setzung eines logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                                     |
| [**SetPowerState**](setpowerstate-method-in-class-cim-alarmdevice.md) | Legt den gewünschten Energiezustand für ein logisches Gerät fest und gibt an, wann das Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
| [**Die Sekunden**](seturgency-method-in-class-cim-alarmdevice.md)       | Legt den gewünschten Dringlichkeits Grad für den Alarm fest. Wird nicht von WMI implementiert.<br/>                                                        |
...
Die **CIM \_ alarmdevice** -Klasse verfügt über diese Eigenschaften.
...
**True** gibt an, dass der Alarm hörbar ist.
...
Ein Enumerationswert, der die relative Häufigkeit angibt, mit der der Alarm blinkt, vibriert oder akustische Töne ausgibt.
...
<span id="Informational"></span><span id="informational"></span><span id="INFORMATIONAL"></span>**Information** (3)
...
<span id="Non-Critical"></span><span id="non-critical"></span><span id="NON-CRITICAL"></span>**Nicht kritisch** (4)
...
<span id="Unrecoverable"></span><span id="unrecoverable"></span><span id="UNRECOVERABLE"></span>**Nicht wiederherstellbar** (6)
...
**True** gibt an, dass der Alarm sichtbar ist.

</dd> </dl>

## <a name="remarks"></a>Bemerkungen

Die **CIM \_ alarmdevice** -Klasse wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)abgeleitet.
