---
description: Die WMI-Klassenmethode SetDNSDomain ermöglicht das Festlegen der DNS-Domäne.
...
Die [WMI-Klassenmethode](/windows/desktop/WmiSdk/retrieving-a-class) **SetDNSDomain** ermöglicht das Festlegen der DNS-Domäne.
...
Domäne, der das DNS zugeordnet ist, dargestellt durch einen Organisationsnamen gefolgt von einem Punkt und einer Erweiterung, die den Typ der Organisation angibt.
...
Dies ist ein instanzabhängiger Methodenaufruf, der pro Adapter angewendet wird. Die Einstellung gilt für den Zieladapter.

## <a name="examples"></a>Beispiele

Das [VbScript-Codebeispiel Zuweisen der DNS-Domäne für einen Netzwerkadapter](https://Gallery.TechNet.Microsoft.Com/6044a0a4-d320-4c18-a94b-c125796d219b) im TechNet-Katalog verwendet **SetDNSDomain,** um die DNS-Domäne für einen TCP/IP-gebundenen Netzwerkadapter festzulegen.

Das Beispiel [Ändern der TCP/IP-Konfiguration für einen](https://Gallery.TechNet.Microsoft.Com/3d5ae334-1d75-4cea-8079-78c6bd836faf) Computer-VBScript-Code im TechNet-Katalog verwendet **SetDNSDomain,** um TCP/IP-Einstellungen für einen Netzwerkadapter zu ändern.

Das Beispiel [DHCP Einstellungen auf einem Computer](https://Gallery.TechNet.Microsoft.Com/41e6ab51-78c0-4413-b086-03fde33ea125) mit VBScript aktivieren im TechNet-Katalog verwendet **SetDNSDomain,** um alle Einstellungen zu konfigurieren, die normalerweise zum Aktivieren von DHCP auf einem Computer erforderlich sind.
