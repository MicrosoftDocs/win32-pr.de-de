...
Die **SetPowerState** -Methode legt den gewünschten Energiezustand für ein logisches Gerät fest, und wenn das Gerät in diesen Zustand versetzt werden soll. Geben Sie in einer Unterklasse den Satz möglicher Rückgabecodes an, indem Sie einen **ValueMap** -Qualifizierer für die-Methode verwenden. Die Zeichen folgen, in die der **ValueMap** -Inhalt übersetzt wird, sollten in der-Unterklasse auch als **Werte** Array Qualifizierer angegeben werden. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
