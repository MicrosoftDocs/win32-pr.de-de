...
---
# <a name="geteffectivepermission-method-of-the-cim_logicalfile-class"></a>Geteffectiveberechtigungs Methode der CIM \_ LogicalFile-Klasse

Die **geteffectiveberechtigungs** Methode bestimmt, ob der Aufrufer über die aggregierten Berechtigungen für das [**CIM \_ LogicalFile**](cim-logicalfile.md) -Objekt und die Freigabe, auf der sich die Datei oder das Verzeichnis befindet, gemäß dem *Berechtigungs* Argument festgelegt hat.
