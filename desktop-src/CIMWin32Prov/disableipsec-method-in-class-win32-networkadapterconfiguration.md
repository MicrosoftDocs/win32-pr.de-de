...
---
# <a name="disableipsec-method-of-the-win32_networkadapterconfiguration-class"></a>DisableIPSec-Methode der Win32 \_ networkadapterconfiguration-Klasse

Die Methode **DisableIPSec** [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) wird verwendet, um die Internet Protokoll Sicherheit (IPSec) auf diesem TCP/IP-fähigen Netzwerkadapter zu deaktivieren.
...
Im folgenden VBScript-Beispiel wird die IP-Sicherheit auf einem Computer deaktiviert. Beachten Sie, dass der tatsächliche Rückruf von disableipaus Sicherheitsgründen auskommentiert wird.
