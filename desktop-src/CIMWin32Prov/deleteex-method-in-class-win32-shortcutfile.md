...
---
# <a name="deleteex-method-of-the-win32_shortcutfile-class"></a>DeleteEx-Methode der Win32 \_ shortcutfile-Klasse

Die **DeleteEx** [WMI-Klassen](/windows/desktop/WmiSdk/retrieving-a-class) Methode löscht die im Objekt Pfad angegebene logische Verknüpfungs Datei (oder das Verzeichnis). **DeleteEx** ist eine erweiterte Version der [**Delete**](delete-method-in-class-win32-directory.md) -Methode.
...
Der Name der Datei oder des Verzeichnisses, in der die **DeleteEx** -Methode fehlgeschlagen ist. Dieser Parameter ist **null** , wenn die Methode erfolgreich ist.
