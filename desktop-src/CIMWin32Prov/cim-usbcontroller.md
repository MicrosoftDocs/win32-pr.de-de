...
---
# <a name="cim_usbcontroller-class"></a>CIM-Klasse "- \_ Klasse"

Die **CIM \_** -Klasse "Start Controller" stellt die Funktionen und die Verwaltung eines USB-Controllers dar.
...
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-usbcontroller.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbcontroller.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Der Name des USB-Controller Herstellers.
...
Die **CIM \_** -Klasse "-Klasse" wird vom [**CIM- \_ Controller**](cim-controller.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu WMI-Klassen, die von CIM-Start **\_ Controller** abgeleitet werden, finden Sie unter [Win32-Klassen](win32-provider.md)
