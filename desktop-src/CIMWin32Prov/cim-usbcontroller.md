---
description: Die CIM \_ USBController-Klasse stellt die Funktionen und die Verwaltung eines USB-Controllers dar.
...
ms.locfileid: "118420977"
---
# <a name="cim_usbcontroller-class"></a>CIM \_ USBController-Klasse

Die **CIM \_ USBController-Klasse** stellt die Funktionen und die Verwaltung eines USB-Controllers dar.
...
Die **CIM \_ USBController-Klasse** verfügt über diese Typen von Membern:
...
Die **CIM \_ USBController-Klasse** verfügt über diese Methoden.



| Methode                                                                   | Beschreibung                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-usbcontroller.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbcontroller.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand versetzt werden soll. Nicht von WMI implementiert.<br/> |
...
Die **CIM \_ USBController-Klasse** verfügt über diese Eigenschaften.
...
Name des USB-Controllerherstellers.
...
Die **CIM \_ USBController-Klasse** wird von [**CIM \_ Controller**](cim-controller.md)abgeleitet.

WMI implementiert diese Klasse nicht. Informationen zu WMI-Klassen, die von **CIM \_ USBController** abgeleitet wurden, finden Sie unter [Win32-Klassen.](win32-provider.md)
