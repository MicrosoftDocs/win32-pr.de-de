...
---
# <a name="reset-method-of-the-cim_uninterruptiblepowersupply-class"></a>Reset-Methode der CIM- \_ Klasse uninterruptiblepowersupply

Die **Reset** -Methode der CIM- \_ Klasse uninterruptiblepowersupply fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
