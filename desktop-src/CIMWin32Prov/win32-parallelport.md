...
Die [WMI-Klasse](../wmisdk/retrieving-a-class.md) für den **Win32- \_ Parallelport** stellt die Eigenschaften eines parallelen Ports auf einem Computersystem dar, auf dem Windows ausgeführt wird.
...
Die **Win32- \_ Parallelport** -Klasse verfügt über diese Typen von Membern:
...
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**Reset**](reset-method-in-class-cim-controller.md) -Methode in [**CIM \_ parallelcontroller**](cim-parallelcontroller.md).<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) -Methode in [**CIM \_ parallelcontroller**](cim-parallelcontroller.md).<br/> |
...
Qualifizierer: [**arrayType**](../wmisdk/standard-qualifiers.md) ("indiziert"), [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIF". DMTF \| Parallele Ports \| 003,8 "), [**modelcorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ parallelcontroller**](cim-parallelcontroller.md)".**Capabilitybeschreibungen**")
</dt> </dl>
...
Qualifizierer: [**arrayType**](../wmisdk/standard-qualifiers.md) ("indiziert"), [**modelcorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ parallelcontroller**](cim-parallelcontroller.md)".**Funktionen**")
</dt> </dl>

Array ausführlicherer Erläuterungen für alle parallelen Controller Features, die im **Funktions Array angegeben** sind. Jeder Eintrag dieses Arrays bezieht sich auf den Eintrag im **Funktions Array, der sich** am selben Index befindet.
...
Der Bezeichner des parallelen Anschlusses.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIF". DMTF \| Parallele Ports \| 003,7 ")
</dt> </dl>
...
Wenn der Wert **true** ist, wird der in **LastErrorCode** gemeldete Fehler gelöscht.
...
Weitere Informationen zu dem Fehler, der in " **LastErrorCode**" aufgezeichnet wurde, sowie Informationen zu Maßnahmen, die möglicherweise durchgeführt werden.
...
**True** gibt an, dass der parallele Port vom Betriebssystem automatisch erkannt wurde. **False** gibt an, dass der Port auf andere Weise erkannt wurde (z. b. manuell über die Systemsteuerung hinzugefügt).
...
**True** gibt an, dass das Gerät Energie gesteuert werden kann. Dies bedeutet, dass es in den Unterbrechungs Modus versetzt werden kann usw. Die-Eigenschaft gibt nicht an, dass die Energie Verwaltungsfunktionen zurzeit aktiviert sind, sondern nur, dass das logische Gerät für die Energie Verwaltung geeignet ist.
...
Diese Eigenschaft wird vom [**CIM- \_ Controller**](cim-controller.md)geerbt. Werte werden in der folgenden Liste angezeigt.
...
Datum und Uhrzeit der letzten zurück setzung des Controllers. Dies könnte bedeuten, dass der Controller heruntergefahren oder erneut initialisiert wurde.
