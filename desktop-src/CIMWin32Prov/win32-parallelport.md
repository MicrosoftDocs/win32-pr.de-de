---
description: Win32 \_ ParallelPort &\# 32; Die WMI-Klasse stellt die Eigenschaften eines parallelen Ports auf einem Computersystem dar, auf dem Windows.
...
ms.locfileid: "119972250"
---
# <a name="win32_parallelport-class"></a>Win32 \_ ParallelPort-Klasse

Die **WMI-Klasse \_ Win32 ParallelPort** stellt die Eigenschaften eines parallelen Ports auf einem Computersystem dar, auf dem Windows. [](../wmisdk/retrieving-a-class.md)
...
Die **Win32 \_ ParallelPort-Klasse** verfügt über die folgenden Membertypen:
...
Die **Win32 \_ ParallelPort-Klasse** verfügt über diese Methoden.



| Methode            | BESCHREIBUNG                                                                                                                                                                                              |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie unter [**Reset-Methode**](reset-method-in-class-cim-controller.md) in [**CIM \_ ParallelController**](cim-parallelcontroller.md).<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zum Implementieren dieser Methode finden Sie unter [**der SetPowerState-Methode**](setpowerstate-method-in-class-cim-controller.md) in [**CIM \_ ParallelController**](cim-parallelcontroller.md).<br/> |
...
Die **Win32 \_ ParallelPort-Klasse** verfügt über diese Eigenschaften.
...
Qualifizierer: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Parallel Ports \| 003.8"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ ParallelController**](cim-parallelcontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Array der Funktionen des parallelen Controllers.

Diese Eigenschaft wird von [**CIM \_ ParallelController geerbt.**](cim-parallelcontroller.md)
...
Qualifizierer: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ ParallelController**](cim-parallelcontroller.md).**Funktionen**")
</dt> </dl>

Array mit ausführlicheren Erläuterungen für die im Capabilities-Array angegebenen Features des **parallelen** Controllers. Jeder Eintrag dieses Arrays bezieht sich  auf den Eintrag im Capabilities-Array, der sich am gleichen Index befindet.
...
Bezeichner des parallelen Ports.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Parallel Ports \| 003.7")
</dt> </dl>

True gibt an, dass der parallele Port DMA unterstützt.

Diese Eigenschaft wird von [**CIM \_ ParallelController**](cim-parallelcontroller.md)geerbt.
...
True gibt an, dass der in **LastErrorCode** gemeldete Fehler gelöscht wird.
...
Maximale Anzahl direkt adressierbarer Entitäten, die von diesem Controller unterstützt werden können. Wenn die Zahl unbekannt ist, sollte der Wert 0 (null) verwendet werden.
...
True gibt an, dass der parallele Port automatisch vom Betriebssystem erkannt wurde. False gibt an, dass der Port auf andere Weise erkannt wurde (z. B. manuell über die Systemsteuerung hinzugefügt).
...
True gibt an, dass das Gerät mit Strom verwaltet werden kann, d. h., es kann in den Unterbrechungsmodus versetzt werden usw. Die -Eigenschaft gibt nicht an, dass energieverwaltungsfeatures derzeit aktiviert sind, sondern nur, dass das logische Gerät energieverwaltungsfähig ist.
...
Qualifizierer: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| Bus Port \| 001.2", "MIF. DMTF \| Disks \| 003.3")
</dt> </dl>

Protokoll, das vom Controller für den Zugriff auf "kontrollierte" Geräte verwendet wird.

Diese Eigenschaft wird vom [**\_ CIM-Controller**](cim-controller.md)geerbt. Werte werden in der folgenden Liste angezeigt.
...
Datum und Uhrzeit der letzten Zurücksetzung des Controllers. Dies kann bedeuten, dass der Controller ausgeschaltet oder erneut initialisiert wurde.
...
Die **Win32 \_ ParallelPort-Klasse** wird von [**CIM \_ ParallelController**](cim-parallelcontroller.md)abgeleitet.
