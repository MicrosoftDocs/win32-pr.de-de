...
Die **CIM \_ BinarySensor** -Klasse verfügt über diese Typen von Membern:
...
|:------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-binarysensor.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-binarysensor.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und den Zeitpunkt, zu dem das Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Der "normale" Wert für den Sensor.
...
Die Beschreibung eines ' false '-Werts aus dem binären Sensor. Diese Informationen können einem Benutzer angezeigt werden.
...
Die Beschreibung eines ' true '-Werts aus dem binären Sensor. Diese Informationen können einem Benutzer angezeigt werden.
...
Die **CIM \_ BinarySensor** -Klasse wird vom [**CIM- \_ Sensor**](cim-sensor.md)abgeleitet.
