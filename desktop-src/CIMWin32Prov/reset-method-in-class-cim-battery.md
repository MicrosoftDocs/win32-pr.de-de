...
---
# <a name="reset-method-of-the-cim_battery-class"></a>Reset-Methode der CIM- \_ Akku Klasse

Die **Reset** -Methode der CIM- \_ Akku Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[CIM- \_ Akku](reset-method-in-class-cim-battery.md)
</dt> <dt>
