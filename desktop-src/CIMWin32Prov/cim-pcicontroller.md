---
description: Die CIM \_ PCIController-Klasse stellt die Eigenschaften und die Verwaltung eines PCI-Controllers dar. Die Eigenschaften in dieser Klasse und ihre Unterklassen werden in den verschiedenen PCI-Spezifikationen definiert, die vom PCI SIG veröffentlicht werden.
...
ms.locfileid: "118678960"
---
# <a name="cim_pcicontroller-class"></a>CIM \_ PCIController-Klasse

Die **CIM \_ PCIController-Klasse** stellt die Eigenschaften und die Verwaltung eines PCI-Controllers dar. Die Eigenschaften in dieser Klasse und ihre Unterklassen werden in den verschiedenen PCI-Spezifikationen definiert, die vom PCI SIG veröffentlicht werden.
...
Die **CIM \_ PCIController-Klasse** verfügt über diese Typen von Membern:
...
Die **CIM \_ PCIController-Klasse** verfügt über diese Methoden.



| Methode                                                                   | BESCHREIBUNG                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-pcicontroller.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcicontroller.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand versetzt werden soll. Nicht von WMI implementiert.<br/> |
...
Die **CIM \_ PCIController-Klasse** verfügt über diese Eigenschaften.
...
Verfügbarkeit und Status des Geräts. Diese Eigenschaft wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
Wird ausgeführt oder voll ausgedient.
...
Der PCI-Controller ist nicht verfügbar.
...
Die [**SetPowerState-Methode**](setpowerstate-method-in-class-cim-pcicontroller.md) wird unterstützt.
...
Die [**SetPowerState-Methode**](setpowerstate-method-in-class-cim-pcicontroller.md) kann aufgerufen werden, wobei der *PowerState-Parameter* auf 5 ("Power Cycle") festgelegt ist.
...
Die [**SetPowerState-Methode**](setpowerstate-method-in-class-cim-pcicontroller.md) kann aufgerufen werden, wobei der *PowerState-Parameter* auf 5 ("Power Cycle") und der *Time-Parameter* für das Einschalten auf ein bestimmtes Datum und eine bestimmte Uhrzeit oder ein bestimmtes Intervall festgelegt ist.
...
**Architektur der seriellen Storage SCSI** (13)
...
Die **CIM \_ PCIController-Klasse** wird vom [**\_ CIM-Controller abgeleitet.**](cim-controller.md)
