...
---
# <a name="cim_scsicontroller-class"></a>CIM \_ SCSIController-Klasse

Die **CIM \_ SCSIController** -Klasse stellt die Funktionen und die Verwaltung des logischen SCSI-Controller Geräts dar.
...
Die **CIM \_ SCSIController** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM \_ SCSIController** -Klasse verfügt über diese Methoden.



| Methode                                                                    | BESCHREIBUNG                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-scsicontroller.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-scsicontroller.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Die **CIM \_ SCSIController** -Klasse verfügt über diese Eigenschaften.
...
Anzahl von Timeouts für SCSI-Controller, die seit der letzten zurück Setzung aufgetreten sind.
...
Maximale Daten Breite (in Bit), die vom SCSI-Controller unterstützt wird.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF". DMTF- \| Speicher Controller \| 001,3 ")
</dt> </dl>

Gibt an, ob der SCSI-Controller Redundanz oder Schutz vor Gerätefehlern bereitstellt.
...
<span id="Unprotected"></span><span id="unprotected"></span><span id="UNPROTECTED"></span>**Ungeschützt** (3)
...
<span id="Protected"></span><span id="protected"></span><span id="PROTECTED"></span>**Geschützt** (4)
...
<span id="Protected_through_SCC__SCSI-3_Controller_Command_"></span><span id="protected_through_scc__scsi-3_controller_command_"></span><span id="PROTECTED_THROUGH_SCC__SCSI-3_CONTROLLER_COMMAND_"></span>**Geschützt durch SCC (SCSI-3 Controller-Befehl)** (5)


</dt> <dd>

Geschützt durch SCC (SCSI-3 Controller-Befehl)
...
<span id="Protected_through_SCC-2__SCSI-3_Controller_Command_"></span><span id="protected_through_scc-2__scsi-3_controller_command_"></span><span id="PROTECTED_THROUGH_SCC-2__SCSI-3_CONTROLLER_COMMAND_"></span>**Geschützt durch SCC-2 (SCSI-3 Controller-Befehl)** (6)


</dt> <dd>

Geschützt durch SCC-2 (SCSI-3 Controller-Befehl)
...
Die **CIM \_ SCSIController** -Klasse wird vom [**CIM- \_ Controller**](cim-controller.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu WMI-Klassen, die von **CIM \_ SCSIController** abgeleitet sind, finden Sie unter [Win32 Classes](win32-provider.md).
