...
Die **CIM \_ productsoftwarefeatures** -Zuordnung identifiziert die Software Features für ein bestimmtes Produkt.
...
Die **CIM \_ productsoftwarefeatures** -Klasse verfügt über diese Typen von Membern:
...
Diese Klasse wird von WMI nicht implementiert. Informationen zu WMI-Klassen, die von **CIM \_ productsoftwarefeatures** abgeleitet sind, finden Sie unter [Win32 Classes](win32-provider.md).
