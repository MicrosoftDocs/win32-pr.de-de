...
---
# <a name="invoke-method-of-the-cim_fileaction-class"></a>Aufruf Methode der CIM \_ fileaction-Klasse

Die **Aufruf** Methode der [**CIM \_ fileaction**](cim-fileaction.md) -Klasse führt eine bestimmte Aktion aus. Details zum Ausführen der Aktion durch die Methode sind Implementierungs spezifisch. Diese Methode wird von der [**CIM- \_ Aktion**](cim-action.md)geerbt.
