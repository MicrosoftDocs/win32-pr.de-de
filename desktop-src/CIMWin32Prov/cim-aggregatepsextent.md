...
---
# <a name="cim_aggregatepsextent-class"></a>CIM- \_ aggregatepsextent-Klasse

Die **CIM- \_ aggregatepsextent** -Klasse definiert die Anzahl der adressierbaren logischen Blöcke auf einem einzelnen Speichergerät, ausgenommen logische Blöcke, die als Prüfdaten zugeordnet sind. Wenn Volumesets definiert sind, sind die logischen Blöcke innerhalb eines einzelnen Volumesatzes enthalten. Dies ist eine alternative Gruppierung für [**CIM \_ protectedspaceblock**](cim-protectedspaceextent.md), wenn nur Zusammenfassungs Informationen benötigt werden oder wenn die automatische Konfiguration verwendet wird.

Die automatische Konfiguration kann dazu führen, dass Tausende von [**CIM \_ protectedspaceblock**](cim-protectedspaceextent.md) -Klassen definiert werden. Die **CIM- \_ aggregatepsextent** -Klasse wurde so definiert, dass einzelne Blöcke nicht modelliert werden müssten.
...
Die **CIM- \_ aggregatepsextent** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM- \_ aggregatepsextent** -Klasse verfügt über diese Methoden.



| Methode                                                                       | BESCHREIBUNG                                                                                                                                |
|:-----------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-aggregatepsextent.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-aggregatepsextent.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und den Zeitpunkt, zu dem das Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Die **CIM- \_ aggregatepsextent** -Klasse verfügt über diese Eigenschaften.
...
Die **CIM- \_ aggregatepsextent** -Klasse wird von [**CIM \_ storageblock**](cim-storageextent.md)abgeleitet.
