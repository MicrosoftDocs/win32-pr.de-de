...
Die [WMI-Klassen](/windows/desktop/WmiSdk/retrieving-a-class) Methode " **PauseService** " versucht, den referenzierten Dienst im angehaltenen Zustand zu platzieren.
