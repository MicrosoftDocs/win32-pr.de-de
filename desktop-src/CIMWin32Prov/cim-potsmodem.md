...
---
# <a name="cim_potsmodem-class"></a>CIM- \_ Klasse "potsmodem"

Die CIM-Klasse " **\_ potsmodem** " stellt ein Gerät dar, das binäre Daten in Wellen Modulationen für die Sound basierte Übertragung übersetzt, indem eine Verbindung mit dem reinen Telefon System ("Pots") hergestellt wird.
...
Die CIM-Klasse " **\_ potsmodem** " verfügt über diese Typen von Membern:
...
Die CIM-Klasse " **\_ potsmodem** " verfügt über diese Methoden.



| Methode                                                               | BESCHREIBUNG                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-potsmodem.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-potsmodem.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Die CIM-Klasse " **\_ potsmodem** " verfügt über diese Eigenschaften.
...
Aktuelle automatische Antwort-oder Rückruf Einstellung für das Modem.
...
Die Eigenschaften der Datenkomprimierung für das Modem.
...
Das Land oder die Region, für das das Modem aktuell programmiert ist. Wenn mehrere Länder oder Regionen unterstützt werden, definiert diese Eigenschaft, welche derzeit zur Verwendung ausgewählt ist.
...
Aktuell definierte Kenn Wörter für das Modem. Dieses Array kann aus Sicherheitsgründen leer gelassen werden.
...
Der Typ des Wählens, der verwendet wird.
...
Fehlerkorrektur Merkmale des Modem.
...
Das Zeitlimit (in Sekunden) für die automatische Trennung der Telefonleitung, wenn keine Daten ausgetauscht werden. Der Wert 0 (null) gibt an, dass dieses Feature vorhanden ist, aber nicht aktiviert ist.
...
Maximale einstellbare Kommunikationsgeschwindigkeit für den Zugriff auf das Telefonsystem.
...
Maximale einstellbare Kommunikationsgeschwindigkeit für den COM-Port für ein externes Modem. Geben Sie 0 (null) ein, wenn Sie nicht zutreffend sind.
...
Maximale Anzahl von Kenn Wörtern, die im Modem selbst definiert werden können. Wenn diese Funktion nicht unterstützt wird, geben Sie 0 (null) ein.
...
Das modulmodussystem des Modem.
...
Anzahl von Ringen, bevor das Modem einen eingehenden-Rückruf antwortet.
...
Die Volumeebene der akustischen Töne aus dem Modem. Beispielsweise kann das Volume "hoch", "Mittel" oder "niedrig" gemeldet werden.
...
Wenn **true**, synchron und asynchron, wird die Kommunikation unterstützt.
...
Die CIM-Klasse " **\_ potsmodem** " ist von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu WMI-Klassen, die von **CIM \_ potsmodem** abgeleitet sind, finden Sie unter [Win32 Classes](win32-provider.md)
