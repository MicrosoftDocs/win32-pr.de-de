---
description: Die CIM \_ CreateDirectoryAction-Klasse erstellt leere Verzeichnisse für Softwareelemente, die lokal installiert werden sollen.
...
Die **CIM \_ CreateDirectoryAction-Klasse** erstellt leere Verzeichnisse für Softwareelemente, die lokal installiert werden sollen.
...
Die **CIM \_ CreateDirectoryAction-Klasse** verfügt über folgende Typen von Membern:
...
Die **CIM \_ CreateDirectoryAction-Klasse** verfügt über diese Methoden.
...
Die **CIM \_ CreateDirectoryAction-Klasse** verfügt über diese Eigenschaften.
...
Diese Eigenschaft wird von [**CIM \_ DirectoryAction**](cim-directoryaction.md)geerbt.
