---
description: Bestimmt, ob der Benutzer über alle erforderlichen Berechtigungen verfügt, die im Permissions-Parameter für das Dateiobjekt, das Verzeichnis und die Freigabe angegeben sind, in dem sich die Verknüpfungsdatei befindet, wenn sich die Datei oder das Verzeichnis auf einer Freigabe befindet.
ms.assetid: 36f823c1-fa19-40a1-b750-41e1f73bdf01
ms.tgt_platform: multiple
title: GetEffectivePermission-Methode der Win32_ShortcutFile -Klasse (Aclui.h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119760530"
---
# <a name="geteffectivepermission-method-of-the-win32_shortcutfile-class"></a>GetEffectivePermission-Methode der Win32 \_ ShortcutFile-Klasse

Die [WMI-Klassenmethode](/windows/desktop/WmiSdk/retrieving-a-class) **GetEffectivePermission** bestimmt, ob der Benutzer über alle erforderlichen Berechtigungen verfügt, die im *Permissions-Parameter* für das Dateiobjekt, das Verzeichnis und die Freigabe angegeben sind, in dem sich die Verknüpfungsdatei befindet, wenn sich die Datei oder das Verzeichnis auf einer Freigabe befindet.
...
Gibt **TRUE zurück,** wenn der Benutzer über die angegebenen Berechtigungen verfügt, und **FALSE,** wenn der Benutzer nicht über die angegebenen Berechtigungen verfügt.
