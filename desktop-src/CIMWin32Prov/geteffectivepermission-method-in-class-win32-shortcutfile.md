...
---
# <a name="geteffectivepermission-method-of-the-win32_shortcutfile-class"></a>Geteffectiveberechtigungs Methode der Win32- \_ shortcutfile-Klasse

Die [WMI-Klassen](/windows/desktop/WmiSdk/retrieving-a-class) Methode **geteffectiveberechtigungs** Methode bestimmt, ob der Benutzer über alle erforderlichen Berechtigungen verfügt, die im *Berechtigungs* Parameter für das Datei Objekt, das Verzeichnis und die Freigabe angegeben sind, in der sich die Verknüpfungs Datei befindet, wenn sich die Datei oder das Verzeichnis auf einer Freigabe befindet.
