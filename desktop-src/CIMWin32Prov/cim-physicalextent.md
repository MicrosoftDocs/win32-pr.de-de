---
description: Die CIM \_ PhysicalExtent-Klasse stellt eine SCC RAID-Implementierung dar.
...
ms.locfileid: "118678148"
---
# <a name="cim_physicalextent-class"></a>CIM \_ PhysicalExtent-Klasse

Die **CIM \_ PhysicalExtent-Klasse** stellt eine SCC RAID-Implementierung dar. Sie definiert die aufeinander folgenden adressierbaren Blockadressen auf einem einzelnen Speichergerät, die als einzelner Speicherblock in derselben [**CIM \_ StorageRedundancyGroup-Klasse behandelt**](cim-storageredundancygroup.md) werden. Eine Alternative, wenn die automatische Konfiguration verwendet wird, ist das Instanziieren oder Erweitern der [**CIM \_ AggregatePExtent-Klasse.**](cim-aggregatepextent.md)
...
Die **CIM \_ PhysicalExtent-Klasse** verfügt über die folgenden Membertypen:
...
Die **CIM \_ PhysicalExtent-Klasse** verfügt über diese Methoden.



| Methode                                                                    | Beschreibung                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-physicalextent.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-physicalextent.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand eingedrung werden soll. Nicht von WMI implementiert.<br/> |
...
Die **CIM \_ PhysicalExtent-Klasse** verfügt über diese Eigenschaften.
...
<span id="Power_Save_-_Standby"></span><span id="power_save_-_standby"></span><span id="POWER_SAVE_-_STANDBY"></span>**Stromsparen – Standby** (15)
...
Qualifizierer: [**Außerkraftsetzung**](/windows/desktop/WmiSdk/standard-qualifiers) ("BlockSize"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. PHYSISCHER \| DMTF-Extent \| 001.4")
</dt> </dl>

Größe der Blöcke in Bytes, die den Speicherblock bilden. Bei variabler Blockgröße sollte die maximale Blockgröße in Bytes angegeben werden. Wenn die Blockgröße unbekannt ist oder ein Blockkonzept nicht gültig ist (z. B. für aggregierte Speicher, Arbeitsspeicher oder logische Datenträger), geben Sie 1 (eins) ein.
...
Eine Freiformzeichenfolge, die den Typ der vom Speicherumfang unterstützten Fehlererkennung und -korrektur beschreibt.
...
Qualifizierer: [**Überschreiben**](/windows/desktop/WmiSdk/standard-qualifiers) ("NumberOfBlocks"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Physical Extent \| 001.3")
</dt> </dl>

Gesamtanzahl aufeinanderfolgender Blöcke, die jeweils die Größe des Werts in der **BlockSize-Eigenschaft** blockieren, die diesen Speicherblock bilden. Die Gesamtgröße des Speicherblocks kann berechnet werden, indem der Wert der **BlockSize-Eigenschaft** mit dem Wert dieser Eigenschaft multipliziert wird. Wenn der Wert von **BlockSize** 1 ist, ist diese Eigenschaft die Gesamtgröße des Speicherblocks.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Physischer \| DMTF-Extent \| 001.6"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Bytes")
</dt> </dl>

Anzahl der Benutzerdatenbytes, die vor dem Starten des Check-Data-Interleaves übersprungen werden müssen.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Physischer \| DMTF-Extent \| 001.7"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Bytes")
</dt> </dl>

Anzahl der Bytes, die für Überprüfungsdaten reserviert werden sollen.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Physischer \| DMTF-Extent \| 001.8"), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) ("Bytes")
</dt> </dl>

Anzahl von Bytes, die für Benutzerdaten reserviert werden sollen.
...
Die **CIM \_ PhysicalExtent-Klasse** wird von [**CIM \_ StorageExtent abgeleitet.**](cim-storageextent.md)
