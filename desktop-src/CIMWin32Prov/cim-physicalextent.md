...
---
# <a name="cim_physicalextent-class"></a>CIM \_ physicalblock-Klasse

Die **CIM- \_ physicalblock** -Klasse stellt eine SCC RAID-Implementierung dar. Sie definiert die aufeinander folgenden adressierbaren Block Adressen auf einem einzelnen Speichergerät, die als einzelner Speicherblock in derselben [**CIM \_ storageredundancygroup**](cim-storageredundancygroup.md) -Klasse behandelt werden. Eine Alternative, wenn die automatische Konfiguration verwendet wird, besteht darin, die [**CIM- \_ aggregatepblock**](cim-aggregatepextent.md) -Klasse zu instanziieren oder zu erweitern.
...
Die **CIM- \_ physicalblock** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM \_ physicalblock** -Klasse verfügt über diese Methoden.



| Methode                                                                    | BESCHREIBUNG                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-physicalextent.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-physicalextent.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Die **CIM- \_ physicalblock** -Klasse verfügt über diese Eigenschaften.
...
Qualifizierer: über [**Schreiben**](/windows/desktop/WmiSdk/standard-qualifiers) ("BLOCKSIZE"), [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF". Physischer DMTF-Block \| \| 001,4 ")
</dt> </dl>
...
Qualifizierer: über [**Schreiben**](/windows/desktop/WmiSdk/standard-qualifiers) ("anzahlblöcke"), [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF". Physischer DMTF-Block \| \| 001,3 ")
</dt> </dl>
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF". Physischer DMTF-Block \| \| 001,6 "), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) (" Bytes ")
</dt> </dl>

Die Anzahl der zu über springenden Bytes von Benutzerdaten vor dem Start der Überprüfung.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF". Physischer DMTF-Block \| \| 001,7 "), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) (" Bytes ")
</dt> </dl>

Anzahl von Bytes, die für die Überprüfung der Daten reserviert werden sollen.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF". Physischer DMTF-Block \| \| 001,8 "), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) (" Bytes ")
</dt> </dl>
...
Die **CIM- \_ physicalblock** -Klasse wird von [**CIM \_ storageblock**](cim-storageextent.md)abgeleitet.
