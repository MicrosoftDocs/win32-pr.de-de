...
---
# <a name="reset-method-of-the-cim_desktopmonitor-class"></a>Reset-Methode der CIM \_ Desktopmonitor-Klasse

Die **Reset** -Methode der CIM \_ Desktopmonitor-Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[CIM- \_ Desktop Monitor](reset-method-in-class-cim-desktopmonitor.md)
</dt> <dt>
