...
Die **Win32 \_ diskdrive** [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) stellt ein physisches Laufwerk dar, das auf einem Computer mit dem Windows-Betriebssystem angezeigt wird.
...
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**Reset**](reset-method-in-class-cim-controller.md) -Methode in [**CIM \_ diskdrive**](cim-diskdrive.md) .<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie in der [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) -Methode in [**CIM \_ diskdrive**](cim-diskdrive.md) .<br/> |
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Device Input and Output Structures \| [**Disk \_ Geometry**](/windows/desktop/api/winioctl/ns-winioctl-disk_geometry) \| bytespersektor"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("Bytes")
</dt> </dl>
...
Array von Funktionen des Medien Zugriffs Geräts. Beispielsweise kann das Gerät zufälligen Zugriff (3), Wechselmedien (7) und automatische Bereinigung (9) unterstützen.
...
Der Ejection vor der Aufhebung der Laufwerk Aufhebung ist nicht erforderlich.
...
Liste der detaillierteren Erläuterungen für alle Zugriffsgeräte Funktionen, die im **Funktions Array angegeben** sind. Beachten Sie, dass jeder Eintrag dieses Arrays mit dem Eintrag im **Funktions Array verknüpft ist, der sich** am selben Index befindet.
...
Der Algorithmus oder das Tool, mit dem das Gerät die Komprimierung unterstützt. Diese Eigenschaft wird von [**CIM \_ mediaaccessdevice**](cim-mediaaccessdevice.md)geerbt.

Der Name des Komprimierungs Algorithmus oder eines der folgenden Werte.
...
Ob das Gerät Komprimierungs Funktionen unterstützt oder nicht, ist nicht bekannt.
...
Das Gerät unterstützt Komprimierungs Funktionen, das zugehörige Komprimierungs Schema ist jedoch nicht bekannt oder nicht offengelegt.
...
Eindeutiger Bezeichner des Laufwerks mit anderen Geräten im System.
...
Typ der Fehlererkennung und-Korrektur, die von diesem Gerät unterstützt werden.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Device Input and Output Structures \| [**Storage \_ Device \_ Descriptor**](/windows/desktop/api/winioctl/ns-winioctl-storage_device_descriptor) \| productrevisionoffset")
</dt> </dl>

Revision der Laufwerks Firmware, die vom Hersteller zugewiesen wird.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Windows 95/98 Functions \| Drive \_ map \_ Info \| btInt13Unit")
</dt> </dl>

Die Nummer des physischen Laufwerks des angegebenen Laufwerks. Diese Eigenschaft wird von der Struktur der [**Speicher \_ Geräte \_ Nummer**](/windows/desktop/api/winioctl/ns-winioctl-storage_device_number) aufgefüllt, die aus dem IOCTL-Speicher Ablaufsteuerungs-Code für [**\_ \_ \_ Geräte \_ Nummern**](/windows/desktop/api/winioctl/ni-winioctl-ioctl_storage_get_device_number) zurückgegeben wurde. Der Wert 0xFFFFFFFF gibt an, dass das angegebene Laufwerk keinem physischen Laufwerk zugeordnet ist.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Device Input and Output Functions \| [**DeviceIoControl**](/windows/desktop/api/ioapiset/nf-ioapiset-deviceiocontrol)")
</dt> </dl>

Der Schnittstellentyp des physischen Laufwerks.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ local \_ Machine \\ \\ Hardware \\ \\ DeviceMap \\ \\ SCSI \\ \\ SCSI Port \\ \\ SCSI Bus \\ \\ Target ID \\ \\ Logical Unit ID \\ \\ Identifier", "Win32Registry \| Manufacturer")
</dt> </dl>
...
Maximale Mediengröße der von diesem Gerät unterstützten Medien in Kilobyte.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Device Input and Output Structures \| [**Disk \_ Geometry**](/windows/desktop/api/winioctl/ns-winioctl-disk_geometry) \| mediaType \| fixedmedia")
</dt> </dl>

Wenn der Wert **true** ist, werden die Medien für ein Laufwerk geladen, was bedeutet, dass das Gerät über ein lesbares Dateisystem verfügt und darauf zugegriffen werden kann. Bei Festplatten Laufwerken ist diese Eigenschaft immer " **true**".
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Device Input and Output Structures \| [**Disk \_ Geometry**](/windows/desktop/api/winioctl/ns-winioctl-disk_geometry) \| MediaType")
</dt> </dl>

Typ des Mediums, das von diesem Gerät verwendet oder aufgerufen wird.
...
Wechsel **Medium** ("Wechsel Datenträger als Disketten")
...
Fest **Platte Festplatte** ("Festplatten Medium")
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ local \_ Machine \\ \\ Hardware \\ \\ DeviceMap \\ \\ SCSI \\ \\ SCSI Port \\ \\ SCSI Bus \\ \\ Target ID \\ \\ Logical Unit ID \\ \\ Identifier", "Win32Registry \| ProductID")
</dt> </dl>

Die Modellnummer des Herstellers des Laufwerks.
...
Maximale Anzahl von Medien, die unterstützt oder eingefügt werden können (wenn das Medien Zugriffsgerät mehrere einzelne Medien unterstützt).
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Device Input and Output Structures \| [**Partition \_ Information**](/windows/desktop/api/winioctl/ns-winioctl-partition_information) \| erkenzedpartition")
</dt> </dl>
...
Die SCSI-logische Gerätenummer (LUN) des Laufwerks.
...
SCSI-Bezeichnernummer des Laufwerks.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Device Input and Output Structures \| [**Disk \_ Geometry**](/windows/desktop/api/winioctl/ns-winioctl-disk_geometry) \| Sector spertrack")
</dt> </dl>
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Device Input and Output Structures \| [**Storage \_ Device \_ Descriptor**](/windows/desktop/api/winioctl/ns-winioctl-storage_device_descriptor) \| serialnummerioffset")
</dt> </dl>

Die Nummer, die vom Hersteller zum Identifizieren der physischen Medien zugewiesen wird.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Device Input and Output Structures \| [**Laufwerk \_ \_ Layoutinformationen**](/windows/desktop/api/winioctl/ns-winioctl-drive_layout_information) \| Signature")
</dt> </dl>

Datenträger Identifikation. Diese Eigenschaft kann verwendet werden, um eine freigegebene Ressource zu identifizieren.
...
Größe des Laufwerks. Er wird berechnet, indem die Gesamtzahl der Zylinder, die Spuren in den einzelnen Zylinder, die Sektoren in den einzelnen Spuren und die Bytes in den einzelnen Sektoren multipliziert werden.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Device Input and Output Structures \| [**Disk \_ Geometry**](/windows/desktop/api/winioctl/ns-winioctl-disk_geometry) \| Zylinder")
</dt> </dl>

Die Gesamtanzahl der Zylinder auf dem physischen Laufwerk. Hinweis: der Wert für diese Eigenschaft wird durch erweiterte Funktionen der BIOS-Interruptzeit 13 h abgerufen. Der Wert kann ungenau sein, wenn das Laufwerk ein Übersetzungs Schema verwendet, um Festplattengrößen mit hoher Kapazität zu unterstützen. Informieren Sie sich beim Hersteller über genaue Laufwerk Spezifikationen.
...
Qualifizierer: [**mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Device Input and Output Structures \| [**Disk \_ Geometry**](/windows/desktop/api/winioctl/ns-winioctl-disk_geometry) \| tracksperzylinder")
</dt> </dl>

Die Gesamtanzahl der Köpfe auf dem Laufwerk. Hinweis: der Wert für diese Eigenschaft wird durch erweiterte Funktionen der BIOS-Interruptzeit 13 h abgerufen. Der Wert kann ungenau sein, wenn das Laufwerk ein Übersetzungs Schema verwendet, um Festplattengrößen mit hoher Kapazität zu unterstützen. Informieren Sie sich beim Hersteller über genaue Laufwerk Spezifikationen.
...
Gesamtanzahl der Sektoren auf dem physischen Laufwerk. Hinweis: der Wert für diese Eigenschaft wird durch erweiterte Funktionen der BIOS-Interruptzeit 13 h abgerufen. Der Wert kann ungenau sein, wenn das Laufwerk ein Übersetzungs Schema verwendet, um Festplattengrößen mit hoher Kapazität zu unterstützen. Informieren Sie sich beim Hersteller über genaue Laufwerk Spezifikationen.
...
Gesamtanzahl der Spuren auf dem physischen Laufwerk. Hinweis: der Wert für diese Eigenschaft wird durch erweiterte Funktionen der BIOS-Interruptzeit 13 h abgerufen. Der Wert kann ungenau sein, wenn das Laufwerk ein Übersetzungs Schema verwendet, um Festplattengrößen mit hoher Kapazität zu unterstützen. Informieren Sie sich beim Hersteller über genaue Laufwerk Spezifikationen.
...
Anzahl der Spuren in jedem Zylinder auf dem physischen Laufwerk. Hinweis: der Wert für diese Eigenschaft wird durch erweiterte Funktionen der BIOS-Interruptzeit 13 h abgerufen. Der Wert kann ungenau sein, wenn das Laufwerk ein Übersetzungs Schema verwendet, um Festplattengrößen mit hoher Kapazität zu unterstützen. Informieren Sie sich beim Hersteller über genaue Laufwerk Spezifikationen.
...
Physische Festplattenlaufwerke sind das primäre Speichermedium für Informationen in jeder Computerumgebung. Obwohl Organisationen häufig Geräte wie Bandlaufwerke und CD-Laufwerke zum Archivieren von Daten verwenden, sind diese Geräte nicht für die alltägliche Speicherung von Benutzerdaten geeignet. Nur physische Festplatten bieten die Geschwindigkeit und Benutzerfreundlichkeit, die zum Speichern von Daten und zum Ausführen von Anwendungen und des Betriebssystems erforderlich sind.

Zur effizienten Verwaltung von Daten ist es wichtig, dass Sie über eine ausführliche Inventur aller physischen Datenträger, ihrer Fähigkeiten und ihrer Kapazitäten verfügen. Sie können diese Art von Inventur mithilfe der Win32-Klasse **\_ diskdrive** ableiten.

Jede Schnittstelle zu einem physischen Windows-Laufwerk ist ein Nachfolger (oder Mitglied) dieser Klasse. Die Funktionen des Laufwerks, das über dieses Objekt angezeigt wird, entsprechen den logischen und Verwaltungs Merkmalen des Laufwerks. In einigen Fällen wird dies möglicherweise nicht die tatsächlichen physischen Eigenschaften des Geräts widerspiegeln. Jedes Objekt, das auf einem anderen logischen Gerät basiert, ist kein Member dieser Klasse.

Aus Sicherheitsgründen muss ein Benutzer, der von einem Remote Computer aus eine Verbindung herstellt, die **SC- \_ Manager \_ Connect** -Berechtigung aktivieren, damit diese Klasse aufgelistet werden kann. Weitere Informationen finden Sie unter [Dienst Sicherheit und Zugriffsrechte](/windows/desktop/Services/service-security-and-access-rights).

Die **Win32- \_ diskdrive** -Klasse wird von CIM-Datenträger [**\_ Laufwerk**](cim-diskdrive.md) abgeleitet, das von [**CIM \_ mediaaccessdevice**](cim-mediaaccessdevice.md)abgeleitet ist. Die **CIM \_ mediaaccessdevice** -Klasse wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)abgeleitet.

## <a name="examples"></a>Beispiele

Der [Server Inventur Bericht-WMI & CIM](https://Gallery.TechNet.Microsoft.Com/Servers-Inventory-report-e79e2b24) PowerShell-Codebeispiel in der TechNet Gallery verwendet eine Reihe von Klassen, einschließlich **Win32 \_ diskdrive**, um Informationen zum Serverstatus zurückzugeben.

Mithilfe des PowerShell-Code Beispiels für das Laufwerk [Laufwerk to Laufwerk Letter using the Win32 \_ diskdrive Interface Type](https://Gallery.TechNet.Microsoft.Com/Map-Drive-to-Drive-Letter-1fff91ad) wird ein Laufwerk einem Laufwerk Buchstaben zugeordnet.
