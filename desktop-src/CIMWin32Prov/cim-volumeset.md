---
description: Die CIM \_ VolumeSet-Klasse stellt einen zusammenhängenden Bereich logischer Blöcke dar, die der Betriebsumgebung zum Lesen und Schreiben von Benutzerdaten angezeigt werden.
...
ms.locfileid: "118677045"
---
# <a name="cim_volumeset-class"></a>CIM \_ VolumeSet-Klasse

Die **CIM \_ VolumeSet-Klasse** stellt einen zusammenhängenden Bereich logischer Blöcke dar, die der Betriebsumgebung zum Lesen und Schreiben von Benutzerdaten angezeigt werden. Volumesätze dürfen sich nicht überlappen und basieren auf einem oder mehreren physischen Sätzen, geschützten Speicherplatzbereichs- oder Aggregatdehnungen (alle vom gleichen Typ). Die basierenden Zuordnungen sollten nach Bedarf instanziiert oder unterklassigt werden.
...
Die **CIM \_ VolumeSet-Klasse** verfügt über folgende Typen von Membern:
...
Die **CIM \_ VolumeSet-Klasse** verfügt über diese Methoden.



| Methode                                                               | Beschreibung                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-volumeset.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-volumeset.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand versetzt werden soll. Nicht von WMI implementiert.<br/> |
...
Die **CIM \_ VolumeSet-Klasse** verfügt über diese Eigenschaften.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|DMTF-Volumesatz \| 001.5")
</dt> </dl>

Anzahl der geschützten Leerzeichen, die als Sammelsatz gestreift werden. In SCC wird dieser Wert als die Anzahl der Stripes definiert, die gezählt werden müssen, bevor die Zuordnung in den nächsten zusammenhängenden Bereich über den aktuellen Stripe hinaus fortgesetzt wird.
...
Qualifizierer: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|DMTF-Volumesatz \| 001.4")
</dt> </dl>

Anzahl der zusammenhängenden, geschützten Speicherplatz-Extent, die gezählt werden, bevor eine Schleife zurück zum ersten geschützten Bereich des aktuellen Stripesets gezählt wird. Dies ist die Anzahl der Ausdingungen, die den Benutzerdatens stripe bilden.
...
Die **CIM \_ VolumeSet-Klasse** wird von [**CIM \_ StorageExtent abgeleitet.**](cim-storageextent.md)
