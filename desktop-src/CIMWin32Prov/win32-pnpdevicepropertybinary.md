...
---
# <a name="win32_pnpdevicepropertybinary-class"></a>Win32- \_ pnpdevicepropertybinary-Klasse

Stellt eine binäre PNP-Geräte Eigenschaft in Form eines **Uint8** -Arrays dar.
...
Die **Win32- \_ pnpdevicepropertybinary** -Klasse verfügt über die folgenden Arten von Membern:

-   [Eigenschaften](#properties)

### <a name="properties"></a>Eigenschaften

Die **Win32- \_ pnpdevicepropertybinary** -Klasse verfügt über diese Eigenschaften.
