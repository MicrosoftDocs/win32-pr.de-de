---
description: Die \_ CIM-Klasse "Controllerscontroller" stellt die Funktionen und die Verwaltung eines Bezahlcontrollers dar.
...
ms.locfileid: "119438730"
---
# <a name="cim_infraredcontroller-class"></a>\_CIM-Klasse "Cim-FähigenController"

Die **\_ CIM-Klasse "Controllerscontroller"** stellt die Funktionen und die Verwaltung eines Bezahlcontrollers dar.
...
Die **\_ CIM-Klasse "Cim-Controller"** verfügt über die folgenden Membertypen:
...
Die **\_ CIM-Klasse "Cim-Controller"** verfügt über diese Methoden.



| Methode                                                                        | Beschreibung                                                                                                                              |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-infraredcontroller.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-infraredcontroller.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand eingedrung werden soll. Nicht von WMI implementiert.<br/> |
...
Die **\_ CIM-Klasse "Cim-Controller"** verfügt über diese Eigenschaften.
...
Datum und Uhrzeit der letzten Zurücksetzung des Controllers, was bedeuten könnte, dass der Controller ausgeschaltet oder erneut initialisiert wurde.
...
Die **\_ CIM-Klasse "ControllersController"** wird von [**CIM \_ Controller**](cim-controller.md)abgeleitet.

WMI implementiert diese Klasse nicht. Informationen zu Klassen, die von **\_ CIM-Controller abgeleitet werden,** finden Sie unter [Win32-Klassen.](win32-provider.md)
