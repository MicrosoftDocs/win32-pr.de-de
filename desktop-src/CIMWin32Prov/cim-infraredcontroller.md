...
---
# <a name="cim_infraredcontroller-class"></a>CIM- \_ Klasse "infraredcontroller"

Die CIM-Klasse " **\_ infraredcontroller** " stellt die Funktionen und die Verwaltung eines Infrarot Controllers dar.
...
Die CIM-Klasse " **\_ infraredcontroller** " verfügt über diese Typen von Membern:
...
Die CIM-Klasse " **\_ infraredcontroller** " verfügt über diese Methoden.



| Methode                                                                        | BESCHREIBUNG                                                                                                                              |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-infraredcontroller.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-infraredcontroller.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Die CIM-Klasse " **\_ infraredcontroller** " verfügt über diese Eigenschaften.
...
Die CIM-Klasse " **\_ infraredcontroller** " wird vom [**CIM- \_ Controller**](cim-controller.md)abgeleitet.

Diese Klasse wird von WMI nicht implementiert. Informationen zu Klassen, die von **CIM \_ infraredcontroller** abgeleitet sind, finden Sie unter [Win32 Classes](win32-provider.md).
