...
---
# <a name="setpowerstate-method-of-the-cim_display-class"></a>SetPowerState-Methode der CIM- \_ Anzeige Klasse

Mit der **SetPowerState** -Methode der CIM \_ -Anzeige Klasse wird der gewünschte Energiezustand für ein logisches Gerät festgelegt, und wenn ein Gerät in diesen Zustand versetzt werden soll. In einer Unterklasse sollte der Satz möglicher Rückgabecodes mit einem **ValueMap** -Qualifizierer für die-Methode angegeben werden. Die Zeichen folgen, in die der **ValueMap** -Inhalt übersetzt wird, sollten in der-Unterklasse auch als **Werte** Array Qualifizierer angegeben werden.
...
[CIM- \_ Anzeige](setpowerstate-method-in-class-cim-display.md)
</dt> <dt>
