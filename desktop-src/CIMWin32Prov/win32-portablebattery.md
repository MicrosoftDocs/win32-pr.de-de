...
---
# <a name="win32_portablebattery-class"></a>Win32 \_ portableakku-Klasse

Die **Win32 \_ portableakku** - [WMI-Klasse](../wmisdk/retrieving-a-class.md) enthält die Eigenschaften, die sich auf einen tragbaren Akku beziehen, z. b. eine Notebook-Computer Batterie.
...
Die **Win32- \_ portableakku** -Klasse verfügt über diese Typen von Membern:
...
Die **Win32- \_ portableakku** -Klasse verfügt über diese Methoden.



| Methode            | BESCHREIBUNG                                                                                                                                                                        |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Zurücksetzen**         | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**Reset**](reset-method-in-class-cim-controller.md) -Methode in [**CIM \_ Akku**](cim-battery.md).<br/>                 |
| **SetPowerState** | Nicht implementiert. Informationen zur Implementierung dieser Methode finden Sie unter der [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) -Methode in [**CIM \_ Akku**](cim-battery.md).<br/> |
...
Die **Win32 \_ portableakku** -Klasse verfügt über diese Eigenschaften.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIF". DMTF \| Portable Akku \| 002,14 ")
</dt> </dl>

Die Beschreibung des Ladestatus der Batterie. Der Wert 10 (nicht definiert) ist im CIM-Schema (Common Information Model) ungültig, da er in der Desktop Management Interface (DMI) anzeigt, dass kein Akku installiert ist. In diesem Fall sollte dieses Objekt nicht instanziiert werden.

Diese Eigenschaft wird von [**CIM- \_ Akku**](cim-battery.md)geerbt.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 22- \| Entwurfs Kapazitäts Multiplikator")
</dt> </dl>

Multiplikationsfaktor des **DesignCapacity** -Werts, um sicherzustellen, dass der milliwattstunden-Stunden Wert für SBDS-Implementierungen (Smart Akku Data Specification) keinen Überlauf erzeugt.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIF". DMTF \| Portable Akku \| 002,7 ")
</dt> </dl>
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIF". DMTF \| Portable Akku \| 002,8 "), [**Einheiten**](../wmisdk/standard-qualifiers.md) (" Milliwatt Stunden ")
</dt> </dl>

Die Entwurfs Kapazität der Akkukapazität in Milliwatt Stunden. Wenn diese Eigenschaft nicht unterstützt wird, geben Sie 0 (null) ein.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIF". DMTF \| Portable Akku \| 002,9 "), [**Einheiten**](../wmisdk/standard-qualifiers.md) (" Millivolt ")
</dt> </dl>

Die Entwurfs Spannung des Akkus in Millivolt. Wenn dieses Attribut nicht unterstützt wird, geben Sie 0 (null) ein.
...
Weitere Informationen zu dem Fehler, der in " **LastErrorCode**" aufgezeichnet wurde, sowie zu den ggf. durchzuführenden Korrekturmaßnahmen.
...
Schätzung des Prozentsatzes der verbleibenden Gesamtkosten.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIF". DMTF \| Portable Akku \| 002,15 "), [**Einheiten**](../wmisdk/standard-qualifiers.md) (" Minuten ")
</dt> </dl>

Schätzen Sie die Zeit in Minuten für die Belastung der Akku Kosten unter den aktuellen Ladebedingungen ein, wenn die Stromversorgung ausfällt, verloren geht und ausfällt oder ein Laptop von einer Stromquelle getrennt ist.
...
Erwartete Lebensdauer des Akkus (in Minuten), vorausgesetzt, dass der Akku vollständig abgerechnet wird. Diese Eigenschaft stellt die erwartete Gesamtlebensdauer des Akkus dar, nicht die aktuelle verbleibende Lebensdauer, die durch die **EstimatedRunTime** -Eigenschaft angegeben wird.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIF". DMTF \| Portable Akku \| 002,11 "), [**Einheiten**](../wmisdk/standard-qualifiers.md) (" Milliwatt Stunden ")
</dt> </dl>

Volle Ladekapazität des Akkus in Milliwatt Stunden. Der Vergleich dieses Werts mit der **DesignCapacity** -Eigenschaft bestimmt, wann der Akku ersetzt werden muss. Das Ende der Lebensdauer des Akkus ist normalerweise der Fall, wenn die **FullChargeCapacity** -Eigenschaft unter 80% der **DesignCapacity** -Eigenschaft liegt. Wenn diese Eigenschaft nicht unterstützt wird, geben Sie 0 (null) ein.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 22 \| Location")
</dt> </dl>

Physischer Speicherort der Batterie. Diese Eigenschaft wird vom Computerhersteller ausgefüllt.

Beispiel: "im Hintergrund auf der linken Seite"
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 22 \| Manufacturing Date")
</dt> </dl>

Das Datum, an dem der Akku gefertigt wurde.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| Type 22- \| Hersteller")
</dt> </dl>
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS- \| Typ 22 \| maximaler Fehler in Akku Daten"), [**Einheiten**](../wmisdk/standard-qualifiers.md) ("Prozent")
</dt> </dl>

Der Unterschied zwischen der höchsten geschätzten Stromversorgung in der Akkukapazität und dem aktuellen Betrag, der durch den Akku gemeldet wird.
...
Maximale Zeit in Minuten, um den Akku vollständig zu berechnen. Diese Eigenschaft stellt die Zeit dar, die eine vollständig abgelegte Akkukapazität wieder auflädt, nicht die derzeit verbleibende Ladezeit, die in der **Timeto fullladung** -Eigenschaft angegeben ist.
...
Qualifizierer: [**maxlen**](../wmisdk/standard-qualifiers.md) (64), [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIF". DMTF \| Portable Akku \| 002,10 ")
</dt> </dl>

Von diesem Akku unterstützte Versionsnummer der Smart Akku-Daten Spezifikation. Wenn der Akku diese Funktion nicht unterstützt, sollte der Wert leer gelassen werden.
...
Verstrichene Zeit in Sekunden seit der letzten Umstellung des Computer Systems auf die Akkuleistung oder die Zeit seit dem letzten Neustart des Systems oder der UPS, je nachdem, welcher Wert kleiner ist. Wenn der Akku Online ist, wird 0 (null) zurückgegeben.
...
Qualifizierer: [**mappingstrings**](../wmisdk/standard-qualifiers.md) ("MIF". DMTF \| Portable Akku \| 002,16 "), [**Einheiten**](../wmisdk/standard-qualifiers.md) (" Minuten ")
</dt> </dl>

Verbleibende Zeit in Minuten, um den Akku vollständig mit der aktuellen Gebühr und Nutzung zu belasten.
...
Die **Win32- \_ portableakku** -Klasse wird von [**CIM- \_ Akku**](cim-battery.md)abgeleitet.
