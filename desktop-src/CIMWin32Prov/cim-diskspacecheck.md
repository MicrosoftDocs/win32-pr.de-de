...
Die **CIM \_ diskspacecheck** -Klasse verfügt über diese Typen von Membern:
...
Die **CIM \_ diskspacecheck** -Klasse verfügt über diese Methoden.



| Methode                                                      | BESCHREIBUNG                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-diskspacecheck.md) | Führt eine bestimmte Aktion aus. Wird nicht von WMI implementiert.<br/> |
...
Die **CIM \_ diskspacecheck** -Klasse verfügt über diese Eigenschaften.
...
Qualifizierer: [**modelcorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ File System**](cim-filesystem.md).**AvailableSpace** "), [**Einheiten**](/windows/desktop/WmiSdk/standard-qualifiers) (" Kilobyte ")
</dt> </dl>

Verfügbarer Datenträgerspeicherplatz.
