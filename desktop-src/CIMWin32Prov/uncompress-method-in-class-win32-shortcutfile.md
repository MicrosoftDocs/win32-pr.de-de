---
description: Dekomprimiert die logische Verknüpfungsdatei (oder das Verzeichnis), die im Objektpfad angegeben ist.
ms.assetid: e120391a-3839-4f8c-aca3-473d7f8b30bf
ms.tgt_platform: multiple
title: Unkomprimieren der Methode der Win32_ShortcutFile Klasse
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "117834515"
---
# <a name="uncompress-method-of-the-win32_shortcutfile-class"></a>Unkomprimieren der Win32 \_ ShortcutFile-Klasse

Die **Uncompress** [WMI-Klassenmethode](/windows/desktop/WmiSdk/retrieving-a-class) dekomprimiert die logische Verknüpfungsdatei (oder das Verzeichnis), die im Objektpfad angegeben ist.
