...
Die **CIM- \_ userdevice** -Klasse ist eine übergeordnete Klasse, von der andere Klassen, z. b. [**CIM- \_ Tastatur**](cim-keyboard.md) oder [**CIM \_ Desktopmonitor**](cim-desktopmonitor.md), abgeleitet werden. Benutzer Geräte sind logische Geräte, die es einem Computersystem ermöglichen, Daten einzugeben, anzuzeigen oder zu hören.
...
|:----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-userdevice.md)                 | Fordert eine zurück setzung des logischen Geräts an. Wird nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-userdevice.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und einen Zeitpunkt, zu dem ein Gerät in diesen Zustand versetzt werden soll. Wird nicht von WMI implementiert.<br/> |
...
Diese Klasse wird von WMI nicht implementiert. Informationen zu WMI-Klassen, die von **CIM \_ userdevice** abgeleitet sind, finden Sie unter [Win32 Classes](win32-provider.md)
