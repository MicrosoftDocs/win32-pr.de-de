...
---
# <a name="reset-method-of-the-cim_aggregatepextent-class"></a>Reset-Methode der CIM- \_ aggregatepblock-Klasse

Die **Reset** -Methode der CIM- \_ aggregatepblock-Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
...
[CIM- \_ aggregatepblock](reset-method-in-class-cim-aggregatepextent.md)
</dt> <dt>
