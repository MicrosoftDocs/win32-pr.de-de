...
Die [WMI-Klasse](/windows/desktop/WmiSdk/retrieving-a-class) von **Win32 \_ dcomapplication** stellt die Eigenschaften einer DCOM-Anwendung dar.
...
Die **Win32 \_ dcomapplication** -Klasse verfügt über diese Typen von Membern:
...
GUID (Global Unique Identifier) für die DCOM-Anwendung.
...
Die **Win32 \_ dcomapplication** -Klasse wird von [**Win32 \_ comapplication**](win32-comapplication.md)abgeleitet.
