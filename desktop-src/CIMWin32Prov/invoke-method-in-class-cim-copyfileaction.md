...
---
# <a name="invoke-method-of-the-cim_copyfileaction-class"></a>Aufruf Methode der CIM \_ copyfileaction-Klasse

Die **Aufruf** Methode der [**CIM \_ copyfileaction**](cim-copyfileaction.md) -Klasse führt eine bestimmte Aktion aus. Details dazu, wie die Methode die Aktion ausführt, sind Implementierungs spezifisch. Diese Methode wird von der [**CIM- \_ Aktion**](cim-action.md)geerbt.
