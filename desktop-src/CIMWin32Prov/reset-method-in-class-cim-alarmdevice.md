...
Die **Reset** -Methode der [**CIM \_ alarmdevice**](cim-alarmdevice.md) -Klasse fordert das Zurücksetzen des logischen Geräts an. Diese Methode wird von [**CIM \_ LogicalDevice**](cim-logicaldevice.md)geerbt.
