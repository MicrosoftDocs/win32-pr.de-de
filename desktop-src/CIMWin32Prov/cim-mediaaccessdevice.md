---
description: Die CIM \_ MediaAccessDevice-Klasse stellt die Möglichkeit dar, auf ein oder mehrere Medien zuzugreifen und diese dann zum Speichern und Abrufen von Daten zu verwenden.
...
ms.locfileid: "119548230"
---
# <a name="cim_mediaaccessdevice-class-cimwin32-wmi-providers"></a>CIM_MediaAccessDevice-Klasse (CIMWin32-WMI-Anbieter)

Die **CIM \_ MediaAccessDevice-Klasse** stellt die Möglichkeit dar, auf ein oder mehrere Medien zuzugreifen und diese dann zum Speichern und Abrufen von Daten zu verwenden.
...
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Zurücksetzen**](reset-method-in-class-cim-mediaaccessdevice.md)                 | Fordert eine Zurücksetzung des logischen Geräts an. Nicht von WMI implementiert.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-mediaaccessdevice.md) | Definiert den gewünschten Energiezustand für ein logisches Gerät und wann ein Gerät in diesen Zustand versetzt werden soll. Nicht von WMI implementiert.<br/> |
...
Unterscheidet ein Gerät, das auf beide Seiten von doppelseitigen Medien zugreifen kann, von einem Gerät, das nur eine Seite liest und erfordert, dass die Medien umgeschaltet werden.
...
Gibt an, dass das Medium vor dem Zugriff durch ein Auswahlelement nicht explizit vom Gerät ausgesendet werden muss.
...
Array von Freiformzeichenfolgen, die ausführliche Erläuterungen zu den im **Capabilities-Array** angegebenen Zugriffsgerätefeatures bieten.
...
Maximale Größe der von diesem Gerät unterstützten Medien in Kilobyte. Kilobytes werden als Die Anzahl der Bytes multipliziert mit 1000 interpretiert (nicht die Anzahl der Bytes multipliziert mit 1024).
...
Die **CIM \_ MediaAccessDevice-Klasse** wird von [**CIM \_ LogicalDevice abgeleitet.**](cim-logicaldevice.md)

WMI implementiert diese Klasse nicht. Informationen zu Klassen, die **von CIM \_ MediaAccessDevice abgeleitet werden,** finden Sie unter [Win32-Klassen.](win32-provider.md)
