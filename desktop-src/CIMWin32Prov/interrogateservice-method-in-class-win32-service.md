...
---
# <a name="interrogateservice-method-of-the-win32_service-class-cimwin32-wmi-providers"></a>InterrogateService-Methode der Win32_Service-Klasse (CIMWin32-WMI-Anbieter)

Die [WMI-Klassenmethode](/windows/desktop/WmiSdk/retrieving-a-class) **InterrogateService** fordert an, dass der Dienst, auf den verwiesen wird, seinen Zustand an den Dienst-Manager aktualisiert.
