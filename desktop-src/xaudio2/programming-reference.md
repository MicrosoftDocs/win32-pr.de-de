...
| [Makros](macros.md)<br/>             | Dieser Abschnitt enthält Informationen zu Makros, die von der Microsoft XAudio2-API bereitgestellt werden. <br/>      |
| [Strukturen](structures.md)<br/>     | Dieser Abschnitt enthält Informationen zu Strukturen, die von der Microsoft XAudio2-API bereitgestellt werden.<br/>   |
