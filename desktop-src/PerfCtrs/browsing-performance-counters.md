...
---
# <a name="browsing-performance-counters"></a>Durchsuchen von Leistungsindikatoren

Im folgenden Beispiel wird gezeigt, wie [**pdhbrowscounters**](/windows/desktop/api/Pdh/nf-pdh-pdhbrowsecountersa) zum Durchsuchen von Leistungsindikatoren aufgerufen wird. Das Beispiel zeigt auch, wie Sie unformatierte Leistungsdaten für die Anzeige erfassen und formatieren.
