...
---
# <a name="enumerating-process-objects"></a><span data-ttu-id="9ec53-103">Auflisten von Prozess Objekten</span><span class="sxs-lookup"><span data-stu-id="9ec53-103">Enumerating Process Objects</span></span>

<span data-ttu-id="9ec53-104">Im folgenden Beispiel wird die Funktion [**pdhenumubjectitems**](/windows/desktop/api/Pdh/nf-pdh-pdhenumobjectitemsa) aufgerufen, um die Instanzen und Leistungsindikatoren der Prozess Objekte auf dem lokalen Computer aufzulisten.</span><span class="sxs-lookup"><span data-stu-id="9ec53-104">The following example calls the [**PdhEnumObjectItems**](/windows/desktop/api/Pdh/nf-pdh-pdhenumobjectitemsa) function to enumerate the instances and counters of the process objects on the local computer.</span></span>
