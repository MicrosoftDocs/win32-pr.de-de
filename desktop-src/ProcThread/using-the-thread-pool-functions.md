...
---
# <a name="using-the-thread-pool-functions"></a>Verwenden der Thread Pool Funktionen

In diesem Beispiel wird ein benutzerdefinierter Thread Pool erstellt, ein Arbeits Element und ein Thread Pool-Timer erstellt und einer Bereinigungs Gruppe zugeordnet. Der Pool besteht aus einem persistenten Thread. Es wird die Verwendung der folgenden Thread Pool Funktionen veranschaulicht:
...
-   [**"Kreatethread Pool"**](/windows/win32/api/threadpoolapiset/nf-threadpoolapiset-createthreadpool)
-   [**"Kreatethlespoolcleanupgroup"**](/windows/win32/api/threadpoolapiset/nf-threadpoolapiset-createthreadpoolcleanupgroup)
-   [**"Kreatethread PoolTimer"**](/windows/win32/api/threadpoolapiset/nf-threadpoolapiset-createthreadpooltimer)
-   [**"Kreatethread poolwait"**](/windows/win32/api/threadpoolapiset/nf-threadpoolapiset-createthreadpoolwait)
...
-   [**Waitoffener poolwaitcallbacks**](/windows/win32/api/threadpoolapiset/nf-threadpoolapiset-waitforthreadpoolwaitcallbacks)
