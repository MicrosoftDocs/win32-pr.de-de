...
Das System verwaltet mehrere QoS-Ebenen mit jeweils unterschiedlicher Leistung und Energieeffizienz. Windows standardeinstellungen für die Planung und Prozessorleistungsverwaltung für jede QoS-Ebene. Die genaue Optimierung der einzelnen QoS-Ebene für die Prozessorleistungsverwaltung und heterogene Planung kann über die Windows geändert werden. Weitere Informationen zur Leistungsoptimierung und -bereitstellung finden Sie unter [Prozessorleistungsverwaltungsoptionen.](/windows-hardware/customize/power-settings/configure-processor-power-management-options)
...
| Heuristik | Threads, die nicht von den oben genannten Quellen klassifiziert werden, wird automatisch eine QoS-Ebene vom System zugewiesen. Diese Heuristiken umfassen (aber nicht beschränkt auf) Threadpriorität, wobei Threads, die mit einer niedrigeren Threadpriorität ausgeführt werden, eine niedrigere QoS-Ebene implizieren können. |
