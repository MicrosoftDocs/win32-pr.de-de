...
<span id="wmformat.license"></span><span id="WMFORMAT.LICENSE"></span>**Lizenz**
</dt> <dd>
...
<span id="wmformat.system_profiles"></span><span id="WMFORMAT.SYSTEM_PROFILES"></span>**Systemprofile**
</dt> <dd>

Keine Definition verfügbar.
...
Siehe Definition für: [ *User Datagram Protocol (UDP)*](/windows)
...
Siehe Definition für: [ *Variable Bitrate (VBR)*](/windows)
