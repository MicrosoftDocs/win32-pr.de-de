...
description: Aktuelle Dokumentation zu Windows Media Codecs und digitalen Signalprozessoren finden Sie unter Windows Media Audio-und Videocodec-und DSP-APIs. | Decodierung in S/PDIF (Windows Media Format 11 SDK)
ms.assetid: 5c5b6bcb-5008-4b51-9f3a-744806924f6a
keywords:
- Decodieren in das Windows Media-Format "S/PDIF"
topic_type:
- apiref
api_name:
- Decoding to S/PDIF
