...
---
# <a name="media-sample-encryption-example"></a><span data-ttu-id="c78c5-118">Beispiel für eine Beispiel Verschlüsselung für Medien</span><span class="sxs-lookup"><span data-stu-id="c78c5-118">Media Sample Encryption Example</span></span>

<span data-ttu-id="c78c5-119">Im folgenden unvollständigen Beispiel wird veranschaulicht, wie ein Medien Beispiel mithilfe der DRM-Verschlüsselung verschlüsselt wird.</span><span class="sxs-lookup"><span data-stu-id="c78c5-119">The following incomplete example demonstrates how to encrypt a media sample using DRM encryption.</span></span> <span data-ttu-id="c78c5-120">Der RC4-Verschlüsselungsalgorithmus wurde aufgrund von Speicherplatz Beschränkungen aus dem Beispiel ausgelassen.</span><span class="sxs-lookup"><span data-stu-id="c78c5-120">The RC4 encryption algorithm has been left out of the example due to space restrictions.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="c78c5-121">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="c78c5-121">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="c78c5-122">**DRM-Import Beispiele**</span><span class="sxs-lookup"><span data-stu-id="c78c5-122">**DRM Import Examples**</span></span>](drm-import-examples.md)
</dt> </dl>
