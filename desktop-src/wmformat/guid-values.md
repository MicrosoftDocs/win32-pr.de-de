---
title: GUID-Werte
description: GUID-Werte
ms.assetid: 11da870b-f222-44f3-b3ea-f80ca6c04f79
keywords:
- Windows Medienformat-SDK, GUID-Werte
- Advanced Systems Format (ASF), GUID-Werte
- ASF (Advanced Systems Format), GUID-Werte
...
|----------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------|
| [Schnittstellenbezeichner](interface-identifiers.md)       | Listet die GUID-Werte und zugeordneten Konstanten für die Schnittstellen auf, die vom Windows Media Format SDK unterstützt werden.              |
