...
---
# <a name="create-content-key-example"></a><span data-ttu-id="2df4c-119">Beispiel für das Erstellen eines Inhalts Schlüssels</span><span class="sxs-lookup"><span data-stu-id="2df4c-119">Create Content Key Example</span></span>

<span data-ttu-id="2df4c-120">Der Inhalts Schlüssel wird zum Verschlüsseln von Medien Beispielen für den Windows Media DRM-Import verwendet.</span><span class="sxs-lookup"><span data-stu-id="2df4c-120">The content key is used to encrypt media samples for Windows Media DRM Import.</span></span> <span data-ttu-id="2df4c-121">Im folgenden Codebeispiel wird veranschaulicht, wie eine Inhalts Schlüsselstruktur erstellt und initialisiert wird.</span><span class="sxs-lookup"><span data-stu-id="2df4c-121">The following code example demonstrates how to create and initialize a content key structure.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="2df4c-122">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="2df4c-122">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="2df4c-123">**DRM-Import Beispiele**</span><span class="sxs-lookup"><span data-stu-id="2df4c-123">**DRM Import Examples**</span></span>](drm-import-examples.md)
</dt> </dl>
