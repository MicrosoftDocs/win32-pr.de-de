---
title: Schnittstellenbezeichner
description: Schnittstellenbezeichner
ms.assetid: 009edcc0-34db-40a1-ae76-17492b11604a
keywords:
- Windows Medienformat-SDK, Schnittstellenbezeichner (IID)
- Advanced Systems Format (ASF), Schnittstellenbezeichner (IID)
- ASF (Advanced Systems Format), Schnittstellenbezeichner (IID)
- Schnittstellenbezeichner (INTERFACE Identifiers, IID)
- IID (Schnittstellenbezeichner)
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119808920"
---
# <a name="interface-identifiers"></a>Schnittstellenbezeichner

Sie müssen einen Schnittstellenbezeichner (Interface Identifier, IID) verwenden, wenn Sie Aufrufe der **QueryInterface-Methode** ausführen. Eine IID ist ein GUID-Wert (Globally Unique Identifier). Im Windows Media Format SDK ist die Konstante, die der IID für eine bestimmte Schnittstelle zugewiesen ist, der Schnittstellenname, dem "IID" vorangestellt \_ ist.

In der folgenden Tabelle sind die Schnittstellenbezeichner und zugeordneten Konstanten für die Schnittstellen in diesem SDK aufgeführt.
...
| **IWMReaderCallbackErweitert**   | IID \_ IWMReaderCallbackAdvanced   | 96406beb-2b2b-11d3-b36b-00c04f6108ff |
...
| **IWMReaderPlaylist Aus**       | IID \_ IWMReaderPlaylistList       | f28c0300-9baa-4477-a846-1744d9cbf533 |
