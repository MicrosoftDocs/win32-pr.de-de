...
keywords:
- Windows Medienformat-SDK, Medienbeispiele
- Windows Medienformat-SDK, Beispiele
...
Alle vom Windows Media Format SDK verwendeten Beispiele werden im Pufferobjekt gekapselt, dessen Arbeitsspeicher automatisch von den SDK-Laufzeitkomponenten belegt wird. Sie können bei Bedarf auch eigene Puffer zuordnen, indem Sie erweiterte Features des Writers und Readers verwenden.

**Hinweis** Der Begriff Sample wird in diesem SDK verwendet, um auf ein Medienbeispiel und nicht auf ein Audiobeispiel zu verweisen. Bei der Audiocodierung bezieht sich ein Beispiel auf einen einzelnen codierten Audiowert. In der Regel wird die Qualität codierter Audiodaten durch eine Reihe von Stichproben pro Sekunde angegeben. Beispielsweise wird CD-Qualitätssound mit 44.100 Stichproben pro Sekunde aufgezeichnet. Dieser Wert wird häufig mit der Hz-Notation abgekürzt, sodass 44.100 Stichproben pro Sekunde 44.100 Hz oder 44,1 kHz betragen würden.
