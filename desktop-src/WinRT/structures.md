...
ms.locfileid: "119758520"
---
# <a name="structures"></a>Strukturen

## <a name="in-this-section"></a>In diesem Abschnitt

-   [**\_REGISTRIERUNGSCOOKIE FÜR \_ DAS HERUNTERFAHREN DES \_ APARTMENTS**](/previous-versions//jj219262(v=vs.85))
...
-   [**HSTRING-HEADER \_**](/windows/win32/api/hstring/ns-hstring-hstring_header)
...
-   [**\_ \_ PDF-RENDER-PARAMS**](/windows/desktop/api/windows.data.pdf.interop/ns-windows-data-pdf-interop-pdf_render_params)
...
-   [**Größe**](/windows/win32/api/windows.foundation/ns-windows-foundation-size)
