...
---
# <a name="pageblackgenerationprocessingundercoloradditionlevel"></a>"Pgeblackgenerationprocessingundercoloradditionlevel"

Dieses Thema ist nicht aktuell. Die aktuellsten Informationen finden Sie in der [PrintSchema-Spezifikation](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Beschreibt die Menge an chromatischen Freihand (in grauen Komponenten Verhältnissen), um Bereiche hinzuzufügen, in denen GCR/UCR "blackinklimit" (oder ggf. ucastart) in den dunklen und in nahezu neutralen Bereichen generiert hat.
