...
Beschreibt die über neutrale Werte hinaus (in gitterfarbenen Farben), die gcr angewendet wird. 0 % = Austausch von einheitlichen Komponenten, 100 % = Grauer Komponentenaustausch.
