...
Beschreibt das Deckblatt "Back (End)". Jeder Auftrag verfügt über ein separates primär Blatt. Das Deckblatt sollte auf der Seite PageMediaSize und PageMediaType gedruckt werden, die für die letzte Seite des Auftrags verwendet wird. Das Deck Blatt sollte in Verarbeitungsoptionen (z. b. jobduplexalldocumentscontiguron, jobnupalldocumentscontiguron) integriert werden, wie in der angegebenen Option angegeben.
