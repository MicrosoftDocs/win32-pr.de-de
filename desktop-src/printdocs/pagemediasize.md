---
description: Erfahren Sie mehr über das benutzerkonfigurierbare PageMediaSize-Element. Dieses Thema ist nicht aktuell. Die aktuellen Informationen finden Sie unter Spezifikation des Druckschemas.
...
ms.locfileid: "112395845"
---
# <a name="pagemediasize"></a><span data-ttu-id="65557-105">Pagemediasize</span><span class="sxs-lookup"><span data-stu-id="65557-105">PageMediaSize</span></span>

<span data-ttu-id="65557-106">Dieses Thema ist nicht aktuell.</span><span class="sxs-lookup"><span data-stu-id="65557-106">This topic is not current.</span></span> <span data-ttu-id="65557-107">Die aktuellen Informationen finden Sie unter [Print Schema Specification (Spezifikation des Druckschemas).](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)</span><span class="sxs-lookup"><span data-stu-id="65557-107">For the most current information, see the [Print Schema Specification](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span></span>

<span data-ttu-id="65557-108">Beschreibt die für die Ausgabe verwendeten physischen Mediendimensionen.</span><span class="sxs-lookup"><span data-stu-id="65557-108">Describes the physical media dimensions used for the output.</span></span>

<span data-ttu-id="65557-109">Das folgende Diagramm veranschaulicht die Verwendung von PageMediaSize-Variablen (option ISOA4 wird als Beispiel verwendet).</span><span class="sxs-lookup"><span data-stu-id="65557-109">The following diagram illustrates the PageMediaSize variable usage (option ISOA4 is used as an example).</span></span>

![Diagramm, das die Seitendimensionen zeigt](images/local-1594393517-pagemediasizepic.gif)

-   [<span data-ttu-id="65557-111">Elementinformationen</span><span class="sxs-lookup"><span data-stu-id="65557-111">Element Information</span></span>](#element-information)
-   [<span data-ttu-id="65557-112">Strukturelle Inhalte</span><span class="sxs-lookup"><span data-stu-id="65557-112">Structural Content</span></span>](#structural-content)
-   [<span data-ttu-id="65557-113">Extensible Markup Language (XML)-Inhalt</span><span class="sxs-lookup"><span data-stu-id="65557-113">Extensible Markup Language (XML) Content</span></span>](#extensible-markup-language-xml-content)

## <a name="element-information"></a><span data-ttu-id="65557-114">Elementinformationen</span><span class="sxs-lookup"><span data-stu-id="65557-114">Element Information</span></span>

| <span data-ttu-id="65557-115">Name</span><span class="sxs-lookup"><span data-stu-id="65557-115">Name</span></span>                 | <span data-ttu-id="65557-116">Wert</span><span class="sxs-lookup"><span data-stu-id="65557-116">Value</span></span>        |
|----------------------|--------------|
| <span data-ttu-id="65557-117">Elementtyp</span><span class="sxs-lookup"><span data-stu-id="65557-117">Element Type</span></span> <br/>   | <span data-ttu-id="65557-118">Funktion</span><span class="sxs-lookup"><span data-stu-id="65557-118">Feature</span></span><br/> |
| <span data-ttu-id="65557-119">Bereichspräfix</span><span class="sxs-lookup"><span data-stu-id="65557-119">Scoping Prefix</span></span> <br/> | <span data-ttu-id="65557-120">Seite</span><span class="sxs-lookup"><span data-stu-id="65557-120">Page</span></span><br/>    |
| <span data-ttu-id="65557-121">Hinweise</span><span class="sxs-lookup"><span data-stu-id="65557-121">Notes</span></span> <br/>          | <span data-ttu-id="65557-122">Keine</span><span class="sxs-lookup"><span data-stu-id="65557-122">None</span></span><br/>    |

## <a name="structural-content"></a><span data-ttu-id="65557-123">Strukturelle Inhalte</span><span class="sxs-lookup"><span data-stu-id="65557-123">Structural Content</span></span>

<span data-ttu-id="65557-124">Die XML-Struktur dieses Elements ist:</span><span class="sxs-lookup"><span data-stu-id="65557-124">The XML structure of this element is:</span></span>
...
## <a name="structure-variables"></a><span data-ttu-id="65557-125">Strukturvariablen</span><span class="sxs-lookup"><span data-stu-id="65557-125">Structure Variables</span></span>

<span data-ttu-id="65557-126">In der folgenden Tabelle werden die Merkmale der Variablen beschrieben, die in der XML-Struktur definiert sind.</span><span class="sxs-lookup"><span data-stu-id="65557-126">The following table outlines the characteristics of the variables defined in the XML structure.</span></span>



| <span data-ttu-id="65557-127">Name</span><span class="sxs-lookup"><span data-stu-id="65557-127">Name</span></span>                                | <span data-ttu-id="65557-128">Datentyp</span><span class="sxs-lookup"><span data-stu-id="65557-128">Data type</span></span>          | <span data-ttu-id="65557-129">Einheit</span><span class="sxs-lookup"><span data-stu-id="65557-129">Unit</span></span>                  | <span data-ttu-id="65557-130">Unterstützte Werte</span><span class="sxs-lookup"><span data-stu-id="65557-130">Supported values</span></span>                                                                                                                                                                      | <span data-ttu-id="65557-131">Zusammenfassung</span><span class="sxs-lookup"><span data-stu-id="65557-131">Summary</span></span>                                                                                                                                                                   |
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="65557-132">\_Optionname\_</span><span class="sxs-lookup"><span data-stu-id="65557-132">\_OptionName\_</span></span><br/>           | <span data-ttu-id="65557-133">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="65557-133">string</span></span><br/>  | <span data-ttu-id="65557-134">Buchstaben</span><span class="sxs-lookup"><span data-stu-id="65557-134">characters</span></span><br/> | <span data-ttu-id="65557-135">Gültiger vollqualifizierter Name, wie durch [Namespaces in XML definiert.](https://www.w3.org/TR/1999/REC-xml-names-19990114/)</span><span class="sxs-lookup"><span data-stu-id="65557-135">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="65557-136">Wenn kein Namespace angegeben wird, wird der Standardnamespace angenommen.</span><span class="sxs-lookup"><span data-stu-id="65557-136">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="65557-137">Gibt den Namen des Mediums an.</span><span class="sxs-lookup"><span data-stu-id="65557-137">Specifies the name of the media.</span></span> <span data-ttu-id="65557-138">Die Benennung sollte die folgende Konvention verwenden: " \_ OptionNameStandard \_ "" \_ OptionNameCommonName \_ "" \_ OptionNameDescriptor \_ ".</span><span class="sxs-lookup"><span data-stu-id="65557-138">The naming should use the following convention: "\_OptionNameStandard\_""\_OptionNameCommonName\_""\_OptionNameDescriptor\_".</span></span><br/> |
| <span data-ttu-id="65557-139">\_IdentityOptionValue\_</span><span class="sxs-lookup"><span data-stu-id="65557-139">\_IdentityOptionValue\_</span></span><br/>  | <span data-ttu-id="65557-140">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="65557-140">string</span></span><br/>  | <span data-ttu-id="65557-141">–</span><span class="sxs-lookup"><span data-stu-id="65557-141">n/a</span></span><br/>        | <span data-ttu-id="65557-142">TRUE, FALSE</span><span class="sxs-lookup"><span data-stu-id="65557-142">True, False.</span></span><br/>                                                                                                                                                               | <span data-ttu-id="65557-143">Definiert eine Option, durch die diese Funktion deaktiviert wird, wenn sie ausgewählt wird.</span><span class="sxs-lookup"><span data-stu-id="65557-143">Defines an Option which when selected would disable this feature.</span></span><br/>                                                                                              |
| <span data-ttu-id="65557-144">\_OptionNameStandard\_</span><span class="sxs-lookup"><span data-stu-id="65557-144">\_OptionNameStandard\_</span></span><br/>   | <span data-ttu-id="65557-145">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="65557-145">string</span></span><br/>  | <span data-ttu-id="65557-146">Buchstaben</span><span class="sxs-lookup"><span data-stu-id="65557-146">characters</span></span><br/> | <span data-ttu-id="65557-147">"ISO", "JIS", "Japan", "NorthAmerica", "OtherMetric", "PRC", keine.</span><span class="sxs-lookup"><span data-stu-id="65557-147">'ISO', 'JIS', 'Japan', 'NorthAmerica', 'OtherMetric', 'PRC', none.</span></span><br/>                                                                                                         | <span data-ttu-id="65557-148">Gibt an, ob die Mediengröße durch einen bestimmten Standard definiert ist.</span><span class="sxs-lookup"><span data-stu-id="65557-148">Indicates if the media size is defined by a particular standard.</span></span><br/>                                                                                               |
| <span data-ttu-id="65557-149">\_OptionNameCommonName\_</span><span class="sxs-lookup"><span data-stu-id="65557-149">\_OptionNameCommonName\_</span></span><br/> | <span data-ttu-id="65557-150">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="65557-150">string</span></span><br/>  | <span data-ttu-id="65557-151">Buchstaben</span><span class="sxs-lookup"><span data-stu-id="65557-151">characters</span></span><br/> | <span data-ttu-id="65557-152">Gültiger vollqualifizierter Name, wie durch [Namespaces in XML definiert.](https://www.w3.org/TR/1999/REC-xml-names-19990114/)</span><span class="sxs-lookup"><span data-stu-id="65557-152">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="65557-153">Wenn kein Namespace angegeben wird, wird der Standardnamespace angenommen.</span><span class="sxs-lookup"><span data-stu-id="65557-153">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="65557-154">Der allgemeine Name für die Mediengröße.</span><span class="sxs-lookup"><span data-stu-id="65557-154">Common Name for the media size.</span></span><br/>                                                                                                                                |
| <span data-ttu-id="65557-155">\_OptionNameDescriptor\_</span><span class="sxs-lookup"><span data-stu-id="65557-155">\_OptionNameDescriptor\_</span></span><br/> | <span data-ttu-id="65557-156">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="65557-156">string</span></span><br/>  | <span data-ttu-id="65557-157">Buchstaben</span><span class="sxs-lookup"><span data-stu-id="65557-157">characters</span></span><br/> | <span data-ttu-id="65557-158">Big, Envelope, Extra, Plus, Rotated, Sheet, 'none'.</span><span class="sxs-lookup"><span data-stu-id="65557-158">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                              | <span data-ttu-id="65557-159">Big, Envelope, Extra, Plus, Rotated, Sheet, 'none'.</span><span class="sxs-lookup"><span data-stu-id="65557-159">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                  |
| <span data-ttu-id="65557-160">\_MediaSizeWidth\_</span><span class="sxs-lookup"><span data-stu-id="65557-160">\_MediaSizeWidth\_</span></span><br/>       | <span data-ttu-id="65557-161">integer</span><span class="sxs-lookup"><span data-stu-id="65557-161">integer</span></span><br/> | <span data-ttu-id="65557-162">Mikron</span><span class="sxs-lookup"><span data-stu-id="65557-162">microns</span></span><br/>    | <span data-ttu-id="65557-163">Größer als 0, kleiner als die maximale Unterstützungsmediengröße für das Gerät.</span><span class="sxs-lookup"><span data-stu-id="65557-163">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="65557-164">Gibt die Breite des physischen Mediums an.</span><span class="sxs-lookup"><span data-stu-id="65557-164">Specifies the width of the physical media.</span></span><br/>                                                                                                                     |
| <span data-ttu-id="65557-165">\_MediaSizeHeight\_</span><span class="sxs-lookup"><span data-stu-id="65557-165">\_MediaSizeHeight\_</span></span><br/>      | <span data-ttu-id="65557-166">integer</span><span class="sxs-lookup"><span data-stu-id="65557-166">integer</span></span><br/> | <span data-ttu-id="65557-167">Mikron</span><span class="sxs-lookup"><span data-stu-id="65557-167">microns</span></span><br/>    | <span data-ttu-id="65557-168">Größer als 0, kleiner als die maximale Unterstützungsmediengröße für das Gerät.</span><span class="sxs-lookup"><span data-stu-id="65557-168">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="65557-169">Gibt die Höhe des physischen Mediums an.</span><span class="sxs-lookup"><span data-stu-id="65557-169">Specifies the height of the physical media.</span></span><br/>                                                                                                                    |



 

## <a name="extensible-markup-language-xml-content"></a><span data-ttu-id="65557-170">Extensible Markup Language (XML)-Inhalt</span><span class="sxs-lookup"><span data-stu-id="65557-170">Extensible Markup Language (XML) Content</span></span>

<span data-ttu-id="65557-171">Die Schlüsselwörter des öffentlichen Druckschemas werden im -Namespace `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` definiert.</span><span class="sxs-lookup"><span data-stu-id="65557-171">The public Print Schema keywords are defined in the `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span></span> <span data-ttu-id="65557-172">Der öffentliche Extensible Markup Language (XML) für dieses Schlüsselwort ist unten definiert:</span><span class="sxs-lookup"><span data-stu-id="65557-172">The public Extensible Markup Language (XML) content for this keyword is defined below:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="65557-173">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="65557-173">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="65557-174">Spezifikation des Druckschemas</span><span class="sxs-lookup"><span data-stu-id="65557-174">Print Schema Specification</span></span>](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)
</dt> </dl>
