...
---
# <a name="pagemediasize"></a><span data-ttu-id="fb822-104">Pagemediasize</span><span class="sxs-lookup"><span data-stu-id="fb822-104">PageMediaSize</span></span>

<span data-ttu-id="fb822-105">Dieses Thema ist nicht aktuell.</span><span class="sxs-lookup"><span data-stu-id="fb822-105">This topic is not current.</span></span> <span data-ttu-id="fb822-106">Die aktuellsten Informationen finden Sie unter Print Schema Specification (Spezifikation des [Druckschemas).](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)</span><span class="sxs-lookup"><span data-stu-id="fb822-106">For the most current information, see the [Print Schema Specification](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span></span>

<span data-ttu-id="fb822-107">Beschreibt die physischen Mediendimensionen, die für die Ausgabe verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="fb822-107">Describes the physical media dimensions used for the output.</span></span>

<span data-ttu-id="fb822-108">Das folgende Diagramm veranschaulicht die Verwendung der PageMediaSize-Variablen (die Option ISOA4 wird als Beispiel verwendet).</span><span class="sxs-lookup"><span data-stu-id="fb822-108">The following diagram illustrates the PageMediaSize variable usage (option ISOA4 is used as an example).</span></span>

![Ein Diagramm, das die Seitendimensionen zeigt](images/local-1594393517-pagemediasizepic.gif)

-   [<span data-ttu-id="fb822-110">Elementinformationen</span><span class="sxs-lookup"><span data-stu-id="fb822-110">Element Information</span></span>](#element-information)
-   [<span data-ttu-id="fb822-111">Strukturell</span><span class="sxs-lookup"><span data-stu-id="fb822-111">Structural Content</span></span>](#structural-content)
-   [<span data-ttu-id="fb822-112">Extensible Markup Language -Inhalt (XML)</span><span class="sxs-lookup"><span data-stu-id="fb822-112">Extensible Markup Language (XML) Content</span></span>](#extensible-markup-language-xml-content)

## <a name="element-information"></a><span data-ttu-id="fb822-113">Elementinformationen</span><span class="sxs-lookup"><span data-stu-id="fb822-113">Element Information</span></span>



|                            |                    |
|----------------------------|--------------------|
| <span data-ttu-id="fb822-114">Name</span><span class="sxs-lookup"><span data-stu-id="fb822-114">Name</span></span> | <span data-ttu-id="fb822-115">Wert</span><span class="sxs-lookup"><span data-stu-id="fb822-115">Value</span></span> |
| <span data-ttu-id="fb822-116">Elementtyp</span><span class="sxs-lookup"><span data-stu-id="fb822-116">Element Type</span></span> <br/>   | <span data-ttu-id="fb822-117">Funktion</span><span class="sxs-lookup"><span data-stu-id="fb822-117">Feature</span></span><br/> |
| <span data-ttu-id="fb822-118">Bereichspräfix</span><span class="sxs-lookup"><span data-stu-id="fb822-118">Scoping Prefix</span></span> <br/> | <span data-ttu-id="fb822-119">Seite</span><span class="sxs-lookup"><span data-stu-id="fb822-119">Page</span></span><br/>    |
| <span data-ttu-id="fb822-120">Hinweise</span><span class="sxs-lookup"><span data-stu-id="fb822-120">Notes</span></span> <br/>          | <span data-ttu-id="fb822-121">Keine</span><span class="sxs-lookup"><span data-stu-id="fb822-121">None</span></span><br/>    |



 

## <a name="structural-content"></a><span data-ttu-id="fb822-122">Strukturell</span><span class="sxs-lookup"><span data-stu-id="fb822-122">Structural Content</span></span>

<span data-ttu-id="fb822-123">Die XML-Struktur dieses Elements lautet:</span><span class="sxs-lookup"><span data-stu-id="fb822-123">The XML structure of this element is:</span></span>
...
## <a name="structure-variables"></a><span data-ttu-id="fb822-124">Strukturvariablen</span><span class="sxs-lookup"><span data-stu-id="fb822-124">Structure Variables</span></span>

<span data-ttu-id="fb822-125">In der folgenden Tabelle werden die Merkmale der in der XML-Struktur definierten Variablen beschrieben.</span><span class="sxs-lookup"><span data-stu-id="fb822-125">The following table outlines the characteristics of the variables defined in the XML structure.</span></span>



| <span data-ttu-id="fb822-126">Name</span><span class="sxs-lookup"><span data-stu-id="fb822-126">Name</span></span>                                | <span data-ttu-id="fb822-127">Datentyp</span><span class="sxs-lookup"><span data-stu-id="fb822-127">Data type</span></span>          | <span data-ttu-id="fb822-128">Einheit</span><span class="sxs-lookup"><span data-stu-id="fb822-128">Unit</span></span>                  | <span data-ttu-id="fb822-129">Unterstützte Werte</span><span class="sxs-lookup"><span data-stu-id="fb822-129">Supported values</span></span>                                                                                                                                                                      | <span data-ttu-id="fb822-130">Zusammenfassung</span><span class="sxs-lookup"><span data-stu-id="fb822-130">Summary</span></span>                                                                                                                                                                   |
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="fb822-131">\_Optionname\_</span><span class="sxs-lookup"><span data-stu-id="fb822-131">\_OptionName\_</span></span><br/>           | <span data-ttu-id="fb822-132">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="fb822-132">string</span></span><br/>  | <span data-ttu-id="fb822-133">Buchstaben</span><span class="sxs-lookup"><span data-stu-id="fb822-133">characters</span></span><br/> | <span data-ttu-id="fb822-134">Gültiger vollqualifizierte Name, wie von [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/)definiert.</span><span class="sxs-lookup"><span data-stu-id="fb822-134">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="fb822-135">Wenn kein Namespace angegeben ist, wird der Standardnamespace angenommen.</span><span class="sxs-lookup"><span data-stu-id="fb822-135">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="fb822-136">Gibt den Namen des Mediums an.</span><span class="sxs-lookup"><span data-stu-id="fb822-136">Specifies the name of the media.</span></span> <span data-ttu-id="fb822-137">Die Benennung sollte die folgende Konvention verwenden: " \_ OptionNameStandard \_ "" \_ OptionNameCommonName \_ "" \_ OptionNameDescriptor \_ ".</span><span class="sxs-lookup"><span data-stu-id="fb822-137">The naming should use the following convention: "\_OptionNameStandard\_""\_OptionNameCommonName\_""\_OptionNameDescriptor\_".</span></span><br/> |
| <span data-ttu-id="fb822-138">\_IdentityOptionValue\_</span><span class="sxs-lookup"><span data-stu-id="fb822-138">\_IdentityOptionValue\_</span></span><br/>  | <span data-ttu-id="fb822-139">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="fb822-139">string</span></span><br/>  | <span data-ttu-id="fb822-140">–</span><span class="sxs-lookup"><span data-stu-id="fb822-140">n/a</span></span><br/>        | <span data-ttu-id="fb822-141">TRUE, FALSE</span><span class="sxs-lookup"><span data-stu-id="fb822-141">True, False.</span></span><br/>                                                                                                                                                               | <span data-ttu-id="fb822-142">Definiert eine Option, durch die diese Funktion deaktiviert wird, wenn sie ausgewählt wird.</span><span class="sxs-lookup"><span data-stu-id="fb822-142">Defines an Option which when selected would disable this feature.</span></span><br/>                                                                                              |
| <span data-ttu-id="fb822-143">\_OptionNameStandard\_</span><span class="sxs-lookup"><span data-stu-id="fb822-143">\_OptionNameStandard\_</span></span><br/>   | <span data-ttu-id="fb822-144">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="fb822-144">string</span></span><br/>  | <span data-ttu-id="fb822-145">Buchstaben</span><span class="sxs-lookup"><span data-stu-id="fb822-145">characters</span></span><br/> | <span data-ttu-id="fb822-146">"ISO", "JIS", "Japan", "NorthAmerica", "OtherMetric", "PRC", keine.</span><span class="sxs-lookup"><span data-stu-id="fb822-146">'ISO', 'JIS', 'Japan', 'NorthAmerica', 'OtherMetric', 'PRC', none.</span></span><br/>                                                                                                         | <span data-ttu-id="fb822-147">Gibt an, ob die Mediengröße durch einen bestimmten Standard definiert ist.</span><span class="sxs-lookup"><span data-stu-id="fb822-147">Indicates if the media size is defined by a particular standard.</span></span><br/>                                                                                               |
| <span data-ttu-id="fb822-148">\_OptionNameCommonName\_</span><span class="sxs-lookup"><span data-stu-id="fb822-148">\_OptionNameCommonName\_</span></span><br/> | <span data-ttu-id="fb822-149">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="fb822-149">string</span></span><br/>  | <span data-ttu-id="fb822-150">Buchstaben</span><span class="sxs-lookup"><span data-stu-id="fb822-150">characters</span></span><br/> | <span data-ttu-id="fb822-151">Gültiger vollqualifizierter Name, wie durch [Namespaces in XML definiert.](https://www.w3.org/TR/1999/REC-xml-names-19990114/)</span><span class="sxs-lookup"><span data-stu-id="fb822-151">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="fb822-152">Wenn kein Namespace angegeben wird, wird der Standardnamespace angenommen.</span><span class="sxs-lookup"><span data-stu-id="fb822-152">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="fb822-153">Der allgemeine Name für die Mediengröße.</span><span class="sxs-lookup"><span data-stu-id="fb822-153">Common Name for the media size.</span></span><br/>                                                                                                                                |
| <span data-ttu-id="fb822-154">\_OptionNameDescriptor\_</span><span class="sxs-lookup"><span data-stu-id="fb822-154">\_OptionNameDescriptor\_</span></span><br/> | <span data-ttu-id="fb822-155">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="fb822-155">string</span></span><br/>  | <span data-ttu-id="fb822-156">Buchstaben</span><span class="sxs-lookup"><span data-stu-id="fb822-156">characters</span></span><br/> | <span data-ttu-id="fb822-157">Big, Envelope, Extra, Plus, Rotated, Sheet, 'none'.</span><span class="sxs-lookup"><span data-stu-id="fb822-157">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                              | <span data-ttu-id="fb822-158">Big, Envelope, Extra, Plus, Rotated, Sheet, 'none'.</span><span class="sxs-lookup"><span data-stu-id="fb822-158">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                  |
| <span data-ttu-id="fb822-159">\_MediaSizeWidth\_</span><span class="sxs-lookup"><span data-stu-id="fb822-159">\_MediaSizeWidth\_</span></span><br/>       | <span data-ttu-id="fb822-160">integer</span><span class="sxs-lookup"><span data-stu-id="fb822-160">integer</span></span><br/> | <span data-ttu-id="fb822-161">Mikron</span><span class="sxs-lookup"><span data-stu-id="fb822-161">microns</span></span><br/>    | <span data-ttu-id="fb822-162">Größer als 0, kleiner als die maximale Unterstützungsmediengröße für das Gerät.</span><span class="sxs-lookup"><span data-stu-id="fb822-162">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="fb822-163">Gibt die Breite des physischen Mediums an.</span><span class="sxs-lookup"><span data-stu-id="fb822-163">Specifies the width of the physical media.</span></span><br/>                                                                                                                     |
| <span data-ttu-id="fb822-164">\_MediaSizeHeight\_</span><span class="sxs-lookup"><span data-stu-id="fb822-164">\_MediaSizeHeight\_</span></span><br/>      | <span data-ttu-id="fb822-165">integer</span><span class="sxs-lookup"><span data-stu-id="fb822-165">integer</span></span><br/> | <span data-ttu-id="fb822-166">Mikron</span><span class="sxs-lookup"><span data-stu-id="fb822-166">microns</span></span><br/>    | <span data-ttu-id="fb822-167">Größer als 0, kleiner als die maximale Unterstützungsmediengröße für das Gerät.</span><span class="sxs-lookup"><span data-stu-id="fb822-167">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="fb822-168">Gibt die Höhe des physischen Mediums an.</span><span class="sxs-lookup"><span data-stu-id="fb822-168">Specifies the height of the physical media.</span></span><br/>                                                                                                                    |



 

## <a name="extensible-markup-language-xml-content"></a><span data-ttu-id="fb822-169">Extensible Markup Language -Inhalt (XML)</span><span class="sxs-lookup"><span data-stu-id="fb822-169">Extensible Markup Language (XML) Content</span></span>

<span data-ttu-id="fb822-170">Die Schlüsselwörter für das öffentliche Druckschema werden im `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` -Namespace definiert.</span><span class="sxs-lookup"><span data-stu-id="fb822-170">The public Print Schema keywords are defined in the `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span></span> <span data-ttu-id="fb822-171">Der Inhalt des öffentlichen Extensible Markup Language (XML) für dieses Schlüsselwort ist unten definiert:</span><span class="sxs-lookup"><span data-stu-id="fb822-171">The public Extensible Markup Language (XML) content for this keyword is defined below:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="fb822-172">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="fb822-172">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="fb822-173">Spezifikation des Druckschemas</span><span class="sxs-lookup"><span data-stu-id="fb822-173">Print Schema Specification</span></span>](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)
</dt> </dl>
