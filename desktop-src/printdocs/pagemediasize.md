...
---
# <a name="pagemediasize"></a><span data-ttu-id="80876-104">PageMediaSize</span><span class="sxs-lookup"><span data-stu-id="80876-104">PageMediaSize</span></span>

<span data-ttu-id="80876-105">Dieses Thema ist nicht aktuell.</span><span class="sxs-lookup"><span data-stu-id="80876-105">This topic is not current.</span></span> <span data-ttu-id="80876-106">Die aktuellsten Informationen finden Sie in der [PrintSchema-Spezifikation](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span><span class="sxs-lookup"><span data-stu-id="80876-106">For the most current information, see the [Print Schema Specification](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span></span>

<span data-ttu-id="80876-107">Beschreibt die physischen Medien Dimensionen, die für die Ausgabe verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="80876-107">Describes the physical media dimensions used for the output.</span></span>

<span data-ttu-id="80876-108">Das folgende Diagramm veranschaulicht die Verwendung der PageMediaSize-Variablen (Option ISOA4 wird als Beispiel verwendet).</span><span class="sxs-lookup"><span data-stu-id="80876-108">The following diagram illustrates the PageMediaSize variable usage (option ISOA4 is used as an example).</span></span>

![ein Diagramm, das die Seiten Dimensionen anzeigt](images/local-1594393517-pagemediasizepic.gif)

-   [<span data-ttu-id="80876-110">Elementinformationen</span><span class="sxs-lookup"><span data-stu-id="80876-110">Element Information</span></span>](#element-information)
-   [<span data-ttu-id="80876-111">Strukturelle Inhalte</span><span class="sxs-lookup"><span data-stu-id="80876-111">Structural Content</span></span>](#structural-content)
-   [<span data-ttu-id="80876-112">Inhalt der Extensible Markup Language (XML)</span><span class="sxs-lookup"><span data-stu-id="80876-112">Extensible Markup Language (XML) Content</span></span>](#extensible-markup-language-xml-content)

## <a name="element-information"></a><span data-ttu-id="80876-113">Elementinformationen</span><span class="sxs-lookup"><span data-stu-id="80876-113">Element Information</span></span>



|                            |                    |
|----------------------------|--------------------|
| <span data-ttu-id="80876-114">Name</span><span class="sxs-lookup"><span data-stu-id="80876-114">Name</span></span>                       |                    |
| <span data-ttu-id="80876-115">Elementtyp</span><span class="sxs-lookup"><span data-stu-id="80876-115">Element Type</span></span> <br/>   | <span data-ttu-id="80876-116">Funktion</span><span class="sxs-lookup"><span data-stu-id="80876-116">Feature</span></span><br/> |
| <span data-ttu-id="80876-117">Bereichs Präfix</span><span class="sxs-lookup"><span data-stu-id="80876-117">Scoping Prefix</span></span> <br/> | <span data-ttu-id="80876-118">Seite</span><span class="sxs-lookup"><span data-stu-id="80876-118">Page</span></span><br/>    |
| <span data-ttu-id="80876-119">Hinweise</span><span class="sxs-lookup"><span data-stu-id="80876-119">Notes</span></span> <br/>          | <span data-ttu-id="80876-120">Keine</span><span class="sxs-lookup"><span data-stu-id="80876-120">None</span></span><br/>    |



 

## <a name="structural-content"></a><span data-ttu-id="80876-121">Strukturelle Inhalte</span><span class="sxs-lookup"><span data-stu-id="80876-121">Structural Content</span></span>

<span data-ttu-id="80876-122">Die XML-Struktur dieses Elements lautet:</span><span class="sxs-lookup"><span data-stu-id="80876-122">The XML structure of this element is:</span></span>
...
## <a name="structure-variables"></a><span data-ttu-id="80876-123">Strukturvariablen</span><span class="sxs-lookup"><span data-stu-id="80876-123">Structure Variables</span></span>

<span data-ttu-id="80876-124">In der folgenden Tabelle werden die Merkmale der Variablen beschrieben, die in der XML-Struktur definiert sind.</span><span class="sxs-lookup"><span data-stu-id="80876-124">The following table outlines the characteristics of the variables defined in the XML structure.</span></span>



| <span data-ttu-id="80876-125">Name</span><span class="sxs-lookup"><span data-stu-id="80876-125">Name</span></span>                                | <span data-ttu-id="80876-126">Datentyp</span><span class="sxs-lookup"><span data-stu-id="80876-126">Data type</span></span>          | <span data-ttu-id="80876-127">Einheit</span><span class="sxs-lookup"><span data-stu-id="80876-127">Unit</span></span>                  | <span data-ttu-id="80876-128">Unterstützte Werte</span><span class="sxs-lookup"><span data-stu-id="80876-128">Supported values</span></span>                                                                                                                                                                      | <span data-ttu-id="80876-129">Zusammenfassung</span><span class="sxs-lookup"><span data-stu-id="80876-129">Summary</span></span>                                                                                                                                                                   |
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="80876-130">\_Optionsname\_</span><span class="sxs-lookup"><span data-stu-id="80876-130">\_OptionName\_</span></span><br/>           | <span data-ttu-id="80876-131">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="80876-131">string</span></span><br/>  | <span data-ttu-id="80876-132">Buchstaben</span><span class="sxs-lookup"><span data-stu-id="80876-132">characters</span></span><br/> | <span data-ttu-id="80876-133">Gültiger, voll qualifizierter Name, wie von [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/)definiert.</span><span class="sxs-lookup"><span data-stu-id="80876-133">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="80876-134">Wenn kein Namespace angegeben wird, wird der Standard Namespace angenommen.</span><span class="sxs-lookup"><span data-stu-id="80876-134">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="80876-135">Gibt den Namen des Mediums an.</span><span class="sxs-lookup"><span data-stu-id="80876-135">Specifies the name of the media.</span></span> <span data-ttu-id="80876-136">Die Benennung sollte die folgende Konvention verwenden: " \_ optionnamestandard \_ " " \_ optionnamecommonname \_ " " \_ optionnamedescriptor \_ ".</span><span class="sxs-lookup"><span data-stu-id="80876-136">The naming should use the following convention: "\_OptionNameStandard\_""\_OptionNameCommonName\_""\_OptionNameDescriptor\_".</span></span><br/> |
| <span data-ttu-id="80876-137">\_Identityoptionvalue\_</span><span class="sxs-lookup"><span data-stu-id="80876-137">\_IdentityOptionValue\_</span></span><br/>  | <span data-ttu-id="80876-138">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="80876-138">string</span></span><br/>  | <span data-ttu-id="80876-139">–</span><span class="sxs-lookup"><span data-stu-id="80876-139">n/a</span></span><br/>        | <span data-ttu-id="80876-140">TRUE, FALSE</span><span class="sxs-lookup"><span data-stu-id="80876-140">True, False.</span></span><br/>                                                                                                                                                               | <span data-ttu-id="80876-141">Definiert eine Option, die diese Funktion deaktiviert, wenn Sie ausgewählt wird.</span><span class="sxs-lookup"><span data-stu-id="80876-141">Defines an Option which when selected would disable this feature.</span></span><br/>                                                                                              |
| <span data-ttu-id="80876-142">\_Optionnamestandard\_</span><span class="sxs-lookup"><span data-stu-id="80876-142">\_OptionNameStandard\_</span></span><br/>   | <span data-ttu-id="80876-143">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="80876-143">string</span></span><br/>  | <span data-ttu-id="80876-144">Buchstaben</span><span class="sxs-lookup"><span data-stu-id="80876-144">characters</span></span><br/> | <span data-ttu-id="80876-145">"ISO", "JIS", "Japan", "Northamerica", "othermetric", "PRC", "None".</span><span class="sxs-lookup"><span data-stu-id="80876-145">'ISO', 'JIS', 'Japan', 'NorthAmerica', 'OtherMetric', 'PRC', none.</span></span><br/>                                                                                                         | <span data-ttu-id="80876-146">Gibt an, ob die Mediengröße von einem bestimmten Standard definiert wird.</span><span class="sxs-lookup"><span data-stu-id="80876-146">Indicates if the media size is defined by a particular standard.</span></span><br/>                                                                                               |
| <span data-ttu-id="80876-147">\_Optionnamecommonname\_</span><span class="sxs-lookup"><span data-stu-id="80876-147">\_OptionNameCommonName\_</span></span><br/> | <span data-ttu-id="80876-148">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="80876-148">string</span></span><br/>  | <span data-ttu-id="80876-149">Buchstaben</span><span class="sxs-lookup"><span data-stu-id="80876-149">characters</span></span><br/> | <span data-ttu-id="80876-150">Gültiger, voll qualifizierter Name, wie von [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/)definiert.</span><span class="sxs-lookup"><span data-stu-id="80876-150">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="80876-151">Wenn kein Namespace angegeben wird, wird der Standard Namespace angenommen.</span><span class="sxs-lookup"><span data-stu-id="80876-151">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="80876-152">Der allgemeine Name für die Mediengröße.</span><span class="sxs-lookup"><span data-stu-id="80876-152">Common Name for the media size.</span></span><br/>                                                                                                                                |
| <span data-ttu-id="80876-153">\_Optionnamedescriptor\_</span><span class="sxs-lookup"><span data-stu-id="80876-153">\_OptionNameDescriptor\_</span></span><br/> | <span data-ttu-id="80876-154">Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="80876-154">string</span></span><br/>  | <span data-ttu-id="80876-155">Buchstaben</span><span class="sxs-lookup"><span data-stu-id="80876-155">characters</span></span><br/> | <span data-ttu-id="80876-156">Big, Umschlag, extra, plus, Postkarte, gedreht, Blatt, "keine".</span><span class="sxs-lookup"><span data-stu-id="80876-156">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                              | <span data-ttu-id="80876-157">Big, Umschlag, extra, plus, Postkarte, gedreht, Blatt, "keine".</span><span class="sxs-lookup"><span data-stu-id="80876-157">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                  |
| <span data-ttu-id="80876-158">\_Mediasizewidth\_</span><span class="sxs-lookup"><span data-stu-id="80876-158">\_MediaSizeWidth\_</span></span><br/>       | <span data-ttu-id="80876-159">integer</span><span class="sxs-lookup"><span data-stu-id="80876-159">integer</span></span><br/> | <span data-ttu-id="80876-160">Mikrometern</span><span class="sxs-lookup"><span data-stu-id="80876-160">microns</span></span><br/>    | <span data-ttu-id="80876-161">Größer als 0 (null), kleiner als der Höchstwert für die Mediengröße des Geräts.</span><span class="sxs-lookup"><span data-stu-id="80876-161">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="80876-162">Gibt die Breite des physischen Mediums an.</span><span class="sxs-lookup"><span data-stu-id="80876-162">Specifies the width of the physical media.</span></span><br/>                                                                                                                     |
| <span data-ttu-id="80876-163">\_Mediasizeheight\_</span><span class="sxs-lookup"><span data-stu-id="80876-163">\_MediaSizeHeight\_</span></span><br/>      | <span data-ttu-id="80876-164">integer</span><span class="sxs-lookup"><span data-stu-id="80876-164">integer</span></span><br/> | <span data-ttu-id="80876-165">Mikrometern</span><span class="sxs-lookup"><span data-stu-id="80876-165">microns</span></span><br/>    | <span data-ttu-id="80876-166">Größer als 0 (null), kleiner als der Höchstwert für die Mediengröße des Geräts.</span><span class="sxs-lookup"><span data-stu-id="80876-166">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="80876-167">Gibt die Höhe des physischen Mediums an.</span><span class="sxs-lookup"><span data-stu-id="80876-167">Specifies the height of the physical media.</span></span><br/>                                                                                                                    |



 

## <a name="extensible-markup-language-xml-content"></a><span data-ttu-id="80876-168">Inhalt der Extensible Markup Language (XML)</span><span class="sxs-lookup"><span data-stu-id="80876-168">Extensible Markup Language (XML) Content</span></span>

<span data-ttu-id="80876-169">Die Schlüsselwörter der öffentlichen Druck Schemas werden im- `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` Namespace definiert.</span><span class="sxs-lookup"><span data-stu-id="80876-169">The public Print Schema keywords are defined in the `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span></span> <span data-ttu-id="80876-170">Der Inhalt des öffentlichen Extensible Markup Language (XML) für dieses Schlüsselwort wird unten definiert:</span><span class="sxs-lookup"><span data-stu-id="80876-170">The public Extensible Markup Language (XML) content for this keyword is defined below:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="80876-171">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="80876-171">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="80876-172">Druck Schema Spezifikation</span><span class="sxs-lookup"><span data-stu-id="80876-172">Print Schema Specification</span></span>](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)
</dt> </dl>
