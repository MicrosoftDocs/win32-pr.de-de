...
-   [Verwenden von Fiddler mit Webauthentifizierungsbroker](#using-fiddler-with-web-authentication-broker)
...
2.  Ausführen der Social Media-Anwendung von Contoso![Ereignisanzeige mit webauth-Betriebsprotokollen](images/wab-figure15.png)
...
## <a name="using-fiddler-with-web-authentication-broker"></a>Verwenden von Fiddler mit Webauthentifizierungsbroker
