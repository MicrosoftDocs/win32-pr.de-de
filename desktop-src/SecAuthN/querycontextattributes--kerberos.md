---
description: Ermöglicht es einer Transport Anwendung, das Kerberos- [*Sicherheitspaket*](../secgloss/s-gly.md) für bestimmte Attribute eines [*Sicherheits Kontexts*](../secgloss/s-gly.md)abzufragen.
...
ms.locfileid: "104484707"
---
# <a name="querycontextattributes-kerberos-function"></a>QueryContextAttributes-Funktion (Kerberos)

Mithilfe der **QueryContextAttributes-Funktion (Kerberos)** kann eine Transport Anwendung das Kerberos- [*Sicherheitspaket*](../secgloss/s-gly.md) nach bestimmten [*Attributen*](../secgloss/a-gly.md#_security_attribute_gly) eines [*Sicherheits Kontexts*](../secgloss/s-gly.md)Abfragen.
