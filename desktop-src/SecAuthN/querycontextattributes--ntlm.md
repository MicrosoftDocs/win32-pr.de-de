...
---
# <a name="querycontextattributes-ntlm-function"></a>QueryContextAttributes (NTLM)-Funktion

Mithilfe der **QueryContextAttributes (NTLM)** -Funktion kann eine Transport Anwendung das NTLM- [*Sicherheitspaket*](../secgloss/s-gly.md) nach bestimmten [*Attributen*](../secgloss/a-gly.md#_security_attribute_gly) eines [Sicherheits Kontexts](../secgloss/s-gly.md)Abfragen.
