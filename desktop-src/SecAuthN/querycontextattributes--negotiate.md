---
description: Ermöglicht einer Transportanwendung das Abfragen des [*Sicherheitspakets*](../secgloss/s-gly.md) Negotiate nach bestimmten Attributen eines [*Sicherheitskontexts.*](../secgloss/s-gly.md)
...
ms.locfileid: "118920108"
---
# <a name="querycontextattributes-negotiate-function"></a>QueryContextAttributes (Negotiate)-Funktion

Die **QueryContextAttributes (Negotiate)-Funktion** ermöglicht einer Transportanwendung, das [*Negotiate-Sicherheitspaket*](../secgloss/s-gly.md) nach [*bestimmten Attributen*](../secgloss/a-gly.md#_security_attribute_gly) eines [*Sicherheitskontexts*](../secgloss/s-gly.md)abzufragen.
