...
---
# <a name="acquirecredentialshandle-ntlm-function"></a>AcquireCredentialsHandle (NTLM)-Funktion

Die **AcquireCredentialsHandle (NTLM)** -Funktion Ruft ein Handle für bereits vorhandene Anmelde Informationen eines [*Sicherheits Prinzipals*](../secgloss/s-gly.md)ab. Dieses Handle ist für die Funktionen [**InitializeSecurityContext (NTLM)**](initializesecuritycontext--ntlm.md) und [**akzeptsecuritycontext (NTLM)**](acceptsecuritycontext--ntlm.md) erforderlich. Hierbei kann es sich um bereits vorhandene *Anmelde* Informationen handeln, die über eine System Anmeldung eingerichtet werden, die hier nicht beschrieben wird, oder der Aufrufer kann Alternative Anmelde Informationen bereitstellen.
...
Bei Verwendung des NTLM-Pakets lauten die maximale Zeichen Länge für den Benutzernamen, das Kennwort und die Domäne 256, 256 bzw. 15.
