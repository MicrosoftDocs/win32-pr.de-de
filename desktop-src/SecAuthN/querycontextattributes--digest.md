---
description: Ermöglicht einer Transportanwendung das Abfragen des [*Digestsicherheitspakets*](../secgloss/s-gly.md) nach bestimmten Attributen eines [*Sicherheitskontexts.*](../secgloss/s-gly.md)
...
ms.locfileid: "118920209"
---
# <a name="querycontextattributes-digest-function"></a>QueryContextAttributes(Digest)-Funktion

Mit **der Funktion QueryContextAttributes (Digest)** kann eine Transportanwendung das [](../secgloss/s-gly.md) Digestsicherheitspaket nach bestimmten Attributen eines Sicherheitskontexts [*abfragen.*](../secgloss/s-gly.md) [](../secgloss/a-gly.md#_security_attribute_gly)
