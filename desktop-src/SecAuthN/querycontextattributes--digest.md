...
Mithilfe der **QueryContextAttributes-Funktion (Digest)** kann eine Transport Anwendung das Digest- [*Sicherheitspaket*](../secgloss/s-gly.md) für bestimmte [*Attribute*](../secgloss/a-gly.md#_security_attribute_gly) eines [*Sicherheits Kontexts*](../secgloss/s-gly.md)Abfragen.
