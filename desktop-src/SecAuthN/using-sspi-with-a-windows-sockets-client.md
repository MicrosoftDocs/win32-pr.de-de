...
---
# <a name="using-sspi-with-a-windows-sockets-client"></a><span data-ttu-id="e81a8-103">Verwenden von SSPI mit einem Windows Sockets-Client</span><span class="sxs-lookup"><span data-stu-id="e81a8-103">Using SSPI with a Windows Sockets Client</span></span>

<span data-ttu-id="e81a8-104">Dieses Beispielprogramm arbeitet mit dem Serverprogramm, das [SSPI mit einem Windows Sockets-Server verwendet](using-sspi-with-a-windows-sockets-server.md).</span><span class="sxs-lookup"><span data-stu-id="e81a8-104">This sample program works with the server program [Using SSPI with a Windows Sockets Server](using-sspi-with-a-windows-sockets-server.md).</span></span> <span data-ttu-id="e81a8-105">Die Client-und Server-Beispiel Programme sind so konzipiert, dass Sie zusammenarbeiten.</span><span class="sxs-lookup"><span data-stu-id="e81a8-105">The client and server sample programs are designed to work together.</span></span> <span data-ttu-id="e81a8-106">Beide Programme verwenden die Header Datei sspiexample. h, die Sie in der [Header Datei für SSPI-Client-und Server Beispiele](header-file-for-sspi-client-and-server.md)finden.</span><span class="sxs-lookup"><span data-stu-id="e81a8-106">Both programs use the header file SspiExample.h, which can be found in [Header File for SSPI Client and Server Samples](header-file-for-sspi-client-and-server.md).</span></span> <span data-ttu-id="e81a8-107">Dieses Programm umfasst Aufrufe von Funktionen in Secur32. lib und Ws2 \_ 32. lib, die in den Linkbibliotheken enthalten sein müssen.</span><span class="sxs-lookup"><span data-stu-id="e81a8-107">This program includes calls to functions in Secur32.lib and Ws2\_32.lib, which must be included among the link libraries.</span></span>

<span data-ttu-id="e81a8-108">Dieses Programm veranschaulicht Folgendes:</span><span class="sxs-lookup"><span data-stu-id="e81a8-108">This program demonstrates the following:</span></span>

-   <span data-ttu-id="e81a8-109">Einrichten einer Windows Sockets-Verbindung mit einem Server.</span><span class="sxs-lookup"><span data-stu-id="e81a8-109">Establishing a Windows Sockets connection with a server.</span></span>
-   <span data-ttu-id="e81a8-110">Initialisieren einer authentifizierten SSPI-Sitzung mit dem Aushandlungs-SSP.</span><span class="sxs-lookup"><span data-stu-id="e81a8-110">Initializing an authenticated SSPI session with the Negotiate SSP.</span></span>
-   <span data-ttu-id="e81a8-111">Herstellen einer Verbindung mit einem Server und Einrichten einer sicheren Kommunikationssitzung.</span><span class="sxs-lookup"><span data-stu-id="e81a8-111">Connecting with a server and establishing a secure communication session.</span></span>
-   <span data-ttu-id="e81a8-112">Empfangen und Entschlüsseln einer Nachricht vom Server innerhalb der sicheren Sitzung.</span><span class="sxs-lookup"><span data-stu-id="e81a8-112">Receiving and decrypt a message from the server within the secure session.</span></span>

<span data-ttu-id="e81a8-113">In diesem Beispielprogramm wird die eingeschränkte Fehlerbehandlung verwendet.</span><span class="sxs-lookup"><span data-stu-id="e81a8-113">This sample program uses limited error handling.</span></span>
