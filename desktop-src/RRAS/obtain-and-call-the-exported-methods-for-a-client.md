...
---
# <a name="obtain-and-call-the-exported-methods-for-a-client"></a><span data-ttu-id="0bbf5-103">Abrufen und Abrufen der exportierten Methoden für einen Client</span><span class="sxs-lookup"><span data-stu-id="0bbf5-103">Obtain and Call the Exported Methods for a Client</span></span>

<span data-ttu-id="0bbf5-104">Der folgende Beispielcode zeigt, wie Sie eine Liste der von einem Client exportierten Methoden abrufen und wie Sie eine Methode für diesen Client aufrufen.</span><span class="sxs-lookup"><span data-stu-id="0bbf5-104">The following sample code shows how to obtain a list of methods a client has exported, and how to invoke a method for that client.</span></span>
