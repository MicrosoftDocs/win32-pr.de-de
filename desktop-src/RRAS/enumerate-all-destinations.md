---
title: Alle Ziele auflisten
description: Der folgende Beispielcode zeigt, wie alle Ziele in der Routing Tabelle aufgelistet werden.
...
ms.locfileid: "104037016"
---
# <a name="enumerate-all-destinations"></a><span data-ttu-id="014bd-103">Alle Ziele auflisten</span><span class="sxs-lookup"><span data-stu-id="014bd-103">Enumerate All Destinations</span></span>

<span data-ttu-id="014bd-104">Der folgende Beispielcode zeigt, wie alle Ziele in der Routing Tabelle aufgelistet werden.</span><span class="sxs-lookup"><span data-stu-id="014bd-104">The following sample code shows how to enumerate all destinations in the routing table.</span></span>
