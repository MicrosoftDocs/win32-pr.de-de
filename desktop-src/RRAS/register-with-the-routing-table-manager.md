...
---
# <a name="register-with-the-routing-table-manager"></a>Registrieren beim Routing Tabellen-Manager

Der folgende Beispielcode zeigt, wie eine neue Entität mit dem Routing Tabellen-Manager registriert wird.
