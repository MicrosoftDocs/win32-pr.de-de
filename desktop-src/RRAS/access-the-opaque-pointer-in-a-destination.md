---
title: Zugreifen auf den nicht transparenten Zeiger in einem Ziel
description: Der folgende Beispielcode zeigt, wie Sie auf den nicht transparenten Zeiger in einem Ziel zugreifen.
...
ms.locfileid: "104037083"
---
# <a name="access-the-opaque-pointer-in-a-destination"></a><span data-ttu-id="096ec-103">Zugreifen auf den nicht transparenten Zeiger in einem Ziel</span><span class="sxs-lookup"><span data-stu-id="096ec-103">Access the Opaque Pointer in a Destination</span></span>

<span data-ttu-id="096ec-104">Der folgende Beispielcode zeigt, wie Sie auf den nicht transparenten Zeiger in einem Ziel zugreifen.</span><span class="sxs-lookup"><span data-stu-id="096ec-104">The following sample code shows how to access the opaque pointer in a destination.</span></span>
