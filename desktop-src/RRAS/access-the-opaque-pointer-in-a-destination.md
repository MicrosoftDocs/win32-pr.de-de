...
---
# <a name="access-the-opaque-pointer-in-a-destination"></a>Zugreifen auf den nicht transparenten Zeiger in einem Ziel

Der folgende Beispielcode zeigt, wie Sie auf den nicht transparenten Zeiger in einem Ziel zugreifen.
