...
---
# <a name="routing-table-query-flags"></a>Routingtabellen-Abfrageflags
...
| \_ \_ RTM-ÜBEREINSTIMMUNGSTREFFER | 0x00000002 | Gleicht Routen mit demselben Nachbarn ab.                                     |
| RTM \_ MATCH \_ PREF      | 0x00000004 | Entspricht Routen, die die gleiche Einstellung aufweisen.                              |
| RTM \_ MATCH \_ NEXTHOP   | 0x00000008 | Entspricht Routen, die den gleichen nächsten Hop aufweisen.                                |
