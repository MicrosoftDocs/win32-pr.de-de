...
---
# <a name="obtaining-the-mib-ii-interfaces-table"></a><span data-ttu-id="f0d16-105">Abrufen der MIB II-Schnittstellen Tabelle</span><span class="sxs-lookup"><span data-stu-id="f0d16-105">Obtaining the MIB II Interfaces Table</span></span>

<span data-ttu-id="f0d16-106">Im folgenden Code wird [**mpradminmibentryget**](/windows/desktop/api/Mprapi/nf-mprapi-mpradminmibentryget) zum Abrufen der MIB II-Schnittstellen-Tabelle vom lokalen Computer verwendet.</span><span class="sxs-lookup"><span data-stu-id="f0d16-106">The following code uses [**MprAdminMIBEntryGet**](/windows/desktop/api/Mprapi/nf-mprapi-mpradminmibentryget) to obtain the MIB II interfaces table from the local machine.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="f0d16-107">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="f0d16-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="f0d16-108">**nicht transparente MIB- \_ \_ Informationen**</span><span class="sxs-lookup"><span data-stu-id="f0d16-108">**MIB\_OPAQUE\_INFO**</span></span>](/windows/desktop/api/iprtrmib/ns-iprtrmib-mib_opaque_info)
</dt> <dt>

[<span data-ttu-id="f0d16-109">**nicht transparente MIB- \_ \_ Abfrage**</span><span class="sxs-lookup"><span data-stu-id="f0d16-109">**MIB\_OPAQUE\_QUERY**</span></span>](/windows/desktop/api/iprtrmib/ns-iprtrmib-mib_opaque_query)
</dt> <dt>

[<span data-ttu-id="f0d16-110">**Mpradminmibentryget**</span><span class="sxs-lookup"><span data-stu-id="f0d16-110">**MprAdminMIBEntryGet**</span></span>](/windows/desktop/api/Mprapi/nf-mprapi-mpradminmibentryget)
</dt> </dl>
