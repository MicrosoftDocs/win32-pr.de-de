...
---
# <a name="search-for-routes-using-a-prefix-tree"></a><span data-ttu-id="13230-103">Suchen nach Routen mithilfe eines Präfix Baums</span><span class="sxs-lookup"><span data-stu-id="13230-103">Search for Routes Using a Prefix Tree</span></span>

<span data-ttu-id="13230-104">Der folgende Beispielcode zeigt, wie Sie mit [**rtmgetarstspecificdestination**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetmostspecificdestination) und [**rtmgetlessspecificdestination**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetlessspecificdestination) die Präfix Struktur in der Routing Tabelle durchlaufen.</span><span class="sxs-lookup"><span data-stu-id="13230-104">The following sample code shows how to use [**RtmGetMostSpecificDestination**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetmostspecificdestination) and [**RtmGetLessSpecificDestination**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetlessspecificdestination) to walk up the prefix tree in the routing table.</span></span>
