---
title: Für Änderungs Benachrichtigung registrieren
description: Der folgende Beispielcode zeigt, wie Sie sich für Änderungs Benachrichtigungen in der Routing Tabelle registrieren. Das Thema \ 0034; Verwenden Sie den Ereignis Benachrichtigungs Rückruf \ 0034; veranschaulicht, wie diese Änderungs Benachrichtigungen verwendet werden.
...
ms.locfileid: "104036761"
---
# <a name="register-for-change-notification"></a><span data-ttu-id="d210e-104">Für Änderungs Benachrichtigung registrieren</span><span class="sxs-lookup"><span data-stu-id="d210e-104">Register For Change Notification</span></span>

<span data-ttu-id="d210e-105">Der folgende Beispielcode zeigt, wie Sie sich für Änderungs Benachrichtigungen in der Routing Tabelle registrieren.</span><span class="sxs-lookup"><span data-stu-id="d210e-105">The following sample code shows how to register for change notifications in the routing table.</span></span> <span data-ttu-id="d210e-106">Das Thema "[Verwenden des Ereignis Benachrichtigungs Rückrufs](use-the-event-notification-callback.md)" veranschaulicht, wie diese Änderungs Benachrichtigungen verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="d210e-106">The topic "[Use the Event Notification Callback](use-the-event-notification-callback.md)" demonstrates how to utilize those change notifications.</span></span>
