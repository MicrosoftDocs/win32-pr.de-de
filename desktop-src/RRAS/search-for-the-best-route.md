---
title: Suchen nach der optimalen Route
description: Der folgende Beispielcode zeigt, wie Sie die Routing Tabelle nach der optimalen Route durchsuchen.
...
ms.locfileid: "104388043"
---
# <a name="search-for-the-best-route"></a><span data-ttu-id="3f1dd-103">Suchen nach der optimalen Route</span><span class="sxs-lookup"><span data-stu-id="3f1dd-103">Search For the Best Route</span></span>

<span data-ttu-id="3f1dd-104">Der folgende Beispielcode zeigt, wie Sie die Routing Tabelle nach der optimalen Route durchsuchen.</span><span class="sxs-lookup"><span data-stu-id="3f1dd-104">The following sample code shows how to search the routing table for the best route.</span></span>
