...
ms.locfileid: "117836445"
---
# <a name="ms-dfs-deleted-link-v2-class"></a>ms-DFS-Deleted-Link-v2-Klasse

DFS-Link im DFS-Namespace gelöscht.
...
| Ldap-Anzeigename | msDFS-DeletedLinkv2                  |
...
| Mögliche Vorgesetzte          | [**ms-DFS-Namespace-v2**](c-msdfs-namespacev2.md)                                           |
| Zusätzlich           | \-                                                                                           |
...
| [**ms-DFS-Comment-v2**](a-msdfs-commentv2.md)                                 | Falsch     | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Last-Modified-v2**](a-msdfs-lastmodifiedv2.md)                      | Richtig      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Link-Identity-GUID-v2**](a-msdfs-linkidentityguidv2.md)             | Richtig      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Link-Path-v2**](a-msdfs-linkpathv2.md)                              | Richtig      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Namespace-Identity-GUID-v2**](a-msdfs-namespaceidentityguidv2.md)   | Richtig      | **ms-DFS-Deleted-Link-v2**      |
...
| [**ms-DFS-Short-Name-Link-Path-v2**](a-msdfs-shortnamelinkpathv2.md)          | Falsch     | **ms-DFS-Deleted-Link-v2**      |
...
| Rdn-Att-Id                  | [**Common-Name**](a-cn.md)<br/>                                                       |
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Übergeordnete          | [**ms-DFS-Namespace-v2**](c-msdfs-namespacev2.md)                                           |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
