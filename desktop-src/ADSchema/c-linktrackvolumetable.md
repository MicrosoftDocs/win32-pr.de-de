...
ms.locfileid: "119324120"
---
# <a name="link-track-volume-table-class"></a>Link-Track-Volume-Table-Klasse

Container für Link-Track-Vol-Entry-Objekte.
...
| Ldap-Anzeigename | linkTrackVolumeTable                  |
| Aktualisieren von Berechtigungen  | Dieser Wert wird vom System festgelegt.      |
| Updatehäufigkeit  | Immer dann, wenn ein Link zu einer Datei erstellt wird. |
...
| Unterklasse von                 | [**Dateiverknüpfungsnachverfolgung**](c-filelinktracking.md)<br/>                                  |
