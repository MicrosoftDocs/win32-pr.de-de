...
description: Diese Klasse stellt ein 802.3-Kabelnetzwerk Gruppenrichtlinie-Objekt dar. Diese Klasse enthält Bezeichner und Konfigurationsdaten, die für ein kabelgebundenes 802.3-Netzwerk relevant sind.
...
ms.locfileid: "118680888"
---
# <a name="ms-net-ieee-8023-grouppolicy-class"></a>ms-net-ieee-8023-GroupPolicy-Klasse

Diese Klasse stellt ein 802.3-Kabelnetzwerk Gruppenrichtlinie-Objekt dar. Diese Klasse enthält Bezeichner und Konfigurationsdaten, die für ein kabelgebundenes 802.3-Netzwerk relevant sind.
...
| Ldap-Anzeigename | ms-net-ieee-8023-GroupPolicy         |
...
| Mögliche Übergeordnete          | [**Person**](c-person.md)[**Container**](c-container.md)[**Computer**](c-computer.md)     |
| Zusätzlich           | \-                                                                                           |
...
| [**ms-net-ieee-8023-GP-PolicyData**](a-ms-net-ieee-8023-gp-policydata.md)         | Falsch     | **ms-net-ieee-8023-GroupPolicy** |
| [**ms-net-ieee-8023-GP-PolicyGUID**](a-ms-net-ieee-8023-gp-policyguid.md)         | Falsch     | **ms-net-ieee-8023-GroupPolicy** |
| [**ms-net-ieee-8023-GP-PolicyReserved**](a-ms-net-ieee-8023-gp-policyreserved.md) | Falsch     | **ms-net-ieee-8023-GroupPolicy** |
