...
description: Wird verwendet, um eine TAPI-Multicastkonferenz in Echtzeit zu veröffentlichen.
ms.assetid: cebd4789-61f7-4a03-b7bf-7ec79b7a1085
ms.tgt_platform: multiple
keywords:
- ms-TAPI-Rt-Conference-Klasse AD Schema
- msTAPI-RtConference-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879410"
---
# <a name="ms-tapi-rt-conference-class"></a>ms-TAPI-Rt-Conference-Klasse

Wird verwendet, um eine TAPI-Multicastkonferenz in Echtzeit zu veröffentlichen.
...
| Ldap-Anzeigename | msTAPI-RtConference                                                                                                                                                                                      |
| Aktualisieren von Berechtigungen  | Es sind keine besonderen Berechtigungen erforderlich.                                                                                                                                                                          |
| Updatehäufigkeit  | Die Erstellungshäufigkeit liegt nach Ermessen des Benutzers, wenn eine TAPI-Konferenz veröffentlicht werden muss. Nach derEntität kann die typische Lebensdauer eines TAPI-Konferenzobjekts im Bereich von 30 Minuten bis 1 Jahr liegen. |
...
| Mögliche Vorgesetzte          | [**Organisationseinheit**](c-organizationalunit.md)                                          |
| Zusätzlich           | \-                                                                                           |
...
| [**ms-TAPI-Conference-Blob**](a-mstapi-conferenceblob.md)                  | Falsch     | **ms-TAPI-Rt-Conference**       |
| [**ms-TAPI-Protocol-Id**](a-mstapi-protocolid.md)                          | Falsch     | **ms-TAPI-Rt-Conference**       |
| [**ms-TAPI-Unique-Identifier**](a-mstapi-uid.md)                           | Richtig      | **ms-TAPI-Rt-Conference**       |
