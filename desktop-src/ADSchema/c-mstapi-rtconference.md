...
Wird verwendet, um eine echt Zeit TAPI-Multicast Konferenz zu veröffentlichen.



| Eingabe | Wert |
|-------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CN                | MS-TAPI-RT-Konferenz                                                                                                                                                                                    |
| LDAP-Display-Name | MSTAPI-rtconference                                                                                                                                                                                      |
| Berechtigung aktualisieren  | Es sind keine besonderen Berechtigungen erforderlich.                                                                                                                                                                          |
| Aktualisierungshäufigkeit  | Die Erstellungs Häufigkeit liegt bei einem Benutzer Ermessen, wenn eine TAPI-Konferenz veröffentlicht werden muss. Nach der Erstellung kann die typische Lebensdauer eines TAPI-Konferenz Objekts zwischen 30 Minuten und 1 Jahr liegen. |
...
| Mögliche Vorgesetzten          | [**Organisationseinheit**](c-organizationalunit.md)                                          |
| Zusätzlich           | \-                                                                                           |
...
| [**MS-TAPI-Conference-BLOB**](a-mstapi-conferenceblob.md)                  | False     | **MS-TAPI-RT-Konferenz**       |
| [**MS-TAPI-Protocol-ID**](a-mstapi-protocolid.md)                          | False     | **MS-TAPI-RT-Konferenz**       |
| [**MS-TAPI-Unique-Identifier**](a-mstapi-uid.md)                           | Richtig      | **MS-TAPI-RT-Konferenz**       |
