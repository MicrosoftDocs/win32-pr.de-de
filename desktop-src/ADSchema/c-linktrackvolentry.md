...
ms.locfileid: "119834930"
---
# <a name="link-track-vol-entry-class"></a>Link-Track-Vol-Entry-Klasse

Der Eintrag für einen Link zu einer Datei auf einem Volume.
...
| Ldap-Anzeigename | linkTrackVolEntry                     |
| Aktualisieren von Berechtigungen  | Dieser Wert wird vom System festgelegt.      |
| Updatehäufigkeit  | Immer wenn ein Link zu einer Datei erstellt wird. |
...
| Mögliche Vorgesetzte          | [**Link-Track-Volume-Table**](c-linktrackvolumetable.md)                  |
| Zusätzlich           | \-                                                                         |
...
| [**Curr-Machine-Id**](a-currmachineid.md)                                | Falsch     | **Link-Track-Vol-Entry**        |
...
| [**Link-Track-Secret**](a-linktracksecret.md)                            | Falsch     | **Link-Track-Vol-Entry**        |
...
| [**Objektanzahl**](a-objectcount.md)                                     | Falsch     | **Link-Track-Vol-Entry**        |
...
| [**Seq-Notification**](a-seqnotification.md)                             | Falsch     | **Link-Track-Vol-Entry**        |
...
| [**Zeitaktualisierung**](a-timerefresh.md)                                     | Falsch     | **Link-Track-Vol-Entry**        |
| [**Time-Vol-Change**](a-timevolchange.md)                                | Falsch     | **Link-Track-Vol-Entry**        |
...
| [**Vol-Table-GUID**](a-voltableguid.md)                                  | Falsch     | **Link-Track-Vol-Entry**        |
| [**Vol-Table-Idx-GUID**](a-voltableidxguid.md)                           | Falsch     | **Link-Track-Vol-Entry**        |
...
| Unterklasse von                 | [**Leaf**](c-leaf.md)<br/>                                          |
| Mögliche Übergeordnete          | [**Link-Track-Volume-Table**](c-linktrackvolumetable.md)                  |
| Zusätzlich           | \-                                                                         |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                               |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) |
| System-Flags                | 0x00000010                                                                 |
