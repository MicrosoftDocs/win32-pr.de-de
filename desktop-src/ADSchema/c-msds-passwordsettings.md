---
title: ms-DS-Password-Einstellungen-Klasse
description: Kennworteinstellungsobjekt für Konten.
ms.assetid: 4e3a5a80-4f55-4c26-b5af-ace9dd853836
ms.tgt_platform: multiple
keywords:
- ms-DS-Password-Einstellungen AD Schema-Klasse
...
ms.locfileid: "118959779"
---
# <a name="ms-ds-password-settings-class"></a>ms-DS-Password-Einstellungen-Klasse

Kennworteinstellungsobjekt für Konten.

> [!Note]  
> Dieses classSchema-Objekt wird mit einer Liste von systemMustContain-OIDs erstellt. Dies ist eine Liste von Attributen, die ein Password Einstellungen Object (PSO) enthalten muss, da sonst die Erstellung des PSO fehlschlägt.
...
| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | ms-DS-Password-Einstellungen              |
| Ldap-Anzeigename | msDS-PasswordSettings                |
...
| Mögliche Vorgesetzte          | [**ms-DS-Password-Einstellungen-Container**](c-msds-passwordsettingscontainer.md) |
| Zusätzlich           | \-                                                                            |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                  |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)    |
...
| [**ms-DS-Lockout-Duration**](a-msds-lockoutduration.md)                                           | True      | **ms-DS-Password-Einstellungen**     |
| [**ms-DS-Lockout-Observation-Window**](a-msds-lockoutobservationwindow.md)                        | True      | **ms-DS-Password-Einstellungen**     |
| [**ms-DS-Lockout-Threshold**](a-msds-lockoutthreshold.md)                                         | True      | **ms-DS-Password-Einstellungen**     |
| [**ms-DS-Mastered-By**](a-msds-masteredby.md)                                                     | False     | [**Nach oben**](c-top.md)<br/> |
| [**ms-DS-Maximum-Password-Age**](a-msds-maximumpasswordage.md)                                    | True      | **ms-DS-Password-Einstellungen**     |
| [**ms-DS-Members-for-Az-Role-BL**](a-msds-membersforazrolebl.md)                                  | False     | [**Nach oben**](c-top.md)<br/> |
| [**ms-DS-Minimum-Password-Age**](a-msds-minimumpasswordage.md)                                    | True      | **ms-DS-Password-Einstellungen**     |
| [**ms-DS-Minimum-Password-Length**](a-msds-minimumpasswordlength.md)                              | True      | **ms-DS-Password-Einstellungen**     |
...
| [**ms-DS-Password-Complexity-Enabled**](a-msds-passwordcomplexityenabled.md)                      | True      | **ms-DS-Password-Einstellungen**     |
| [**ms-DS-Password-History-Length**](a-msds-passwordhistorylength.md)                              | True      | **ms-DS-Password-Einstellungen**     |
| [**ms-DS-Password-Reversible-Encryption-Enabled**](a-msds-passwordreversibleencryptionenabled.md) | True      | **ms-DS-Password-Einstellungen**     |
| [**ms-DS-Password-Einstellungen-Precedence**](a-msds-passwordsettingsprecedence.md)                    | True      | **ms-DS-Password-Einstellungen**     |
...
| [**ms-DS-PSO-Applies-To**](a-msds-psoappliesto.md)                                                | False     | **ms-DS-Password-Einstellungen**     |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                               |
| Mögliche Übergeordnete          | [**ms-DS-Password-Einstellungen-Container**](c-msds-passwordsettingscontainer.md) |
| Zusätzlich           | \-                                                                            |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                  |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)    |
| System-Flags                | 0x00000010                                                                    |
