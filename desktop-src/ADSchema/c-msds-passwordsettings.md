...
---
# <a name="ms-ds-password-settings-class"></a>ms-DS-Password-Settings-Klasse

Kenn Wort Einstellungs Objekt für Konten.

> [!Note]  
> Dieses classSchema-Objekt wird mit einer Liste von systemmustare-OIDs erstellt. Dies ist eine Liste der Attribute, die ein Kenn Wort Einstellungs Objekt (PSO) enthalten muss, oder andernfalls schlägt die Erstellung des PSO fehl.
...
| Schema-ID-GUID    | 3bcd9db8-b-451c-952e-6c52b81at9ec6 |
...
| Mögliche Vorgesetzten          | [**ms-DS-Password-Settings-Container**](c-msds-passwordsettingscontainer.md) |
| Zusätzlich           | \-                                                                            |
| NT-Security-Descriptor      | o:Bag: schlecht: S:                                                                  |
| Standard Sicherheits Beschreibung | D: (A;; rpwpcrccdclclorcwowdsddtsw;;;D a) (a;; Rpwpcrccdclclorcwowdsddtsw;;; Mütter    |
...
| [**ms-DS-Lockout-Dauer**](a-msds-lockoutduration.md)                                           | Richtig      | **ms-DS-Password-Settings**     |
| [**ms-DS-Lock out-Observation-Window**](a-msds-lockoutobservationwindow.md)                        | Richtig      | **ms-DS-Password-Settings**     |
| [**ms-DS-Lockout-Schwellenwert**](a-msds-lockoutthreshold.md)                                         | Richtig      | **ms-DS-Password-Settings**     |
| [**ms-DS-gemastert von**](a-msds-masteredby.md)                                                     | False     | [**Nach oben**](c-top.md)<br/> |
| [**ms-DS-Maximum-Password-Age**](a-msds-maximumpasswordage.md)                                    | Richtig      | **ms-DS-Password-Settings**     |
| [**ms-DS-Members-für-AZ-Role-BL**](a-msds-membersforazrolebl.md)                                  | False     | [**Nach oben**](c-top.md)<br/> |
| [**ms-DS-minimal-Kennwort-Alter**](a-msds-minimumpasswordage.md)                                    | Richtig      | **ms-DS-Password-Settings**     |
| [**ms-DS-minimal-Kennwort-Länge**](a-msds-minimumpasswordlength.md)                              | Richtig      | **ms-DS-Password-Settings**     |
...
| [**ms-DS-Kenn Wort Komplexität-aktiviert**](a-msds-passwordcomplexityenabled.md)                      | Richtig      | **ms-DS-Password-Settings**     |
| [**ms-DS-Password-History-length**](a-msds-passwordhistorylength.md)                              | Richtig      | **ms-DS-Password-Settings**     |
| [**ms-DS-Kennwort-Umkehr fähig-Verschlüsselung aktiviert**](a-msds-passwordreversibleencryptionenabled.md) | Richtig      | **ms-DS-Password-Settings**     |
| [**ms-DS-Password-Settings-Rangfolge**](a-msds-passwordsettingsprecedence.md)                    | Richtig      | **ms-DS-Password-Settings**     |
...
| [**ms-DS-PSO-gilt für**](a-msds-psoappliesto.md)                                                | False     | **ms-DS-Password-Settings**     |
