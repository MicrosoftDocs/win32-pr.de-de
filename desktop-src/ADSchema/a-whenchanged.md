...
---
# <a name="when-changed-attribute"></a>When-Changed-Attribut

Das Datum, an dem das Objekt zuletzt geändert wurde. Dieser Wert wird nicht repliziert und ist im globalen Katalog vorhanden.
...
| Aktualisierungshäufigkeit  | Jedes Mal, wenn das Objekt geändert wird.                              |
