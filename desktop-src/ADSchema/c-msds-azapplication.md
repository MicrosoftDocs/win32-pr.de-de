...
description: Definiert eine installierte Instanz einer Anwendung, die an einen bestimmten Richtlinienspeicher gebunden ist.
ms.assetid: 8714a351-79c0-4b5e-a160-293e4f806d6a
ms.tgt_platform: multiple
keywords:
- ms-DS-Az-Application-Klasse AD Schema
- msDS-AzApplication-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119880390"
---
# <a name="ms-ds-az-application-class"></a>ms-DS-Az-Application-Klasse

Definiert eine installierte Instanz einer Anwendung, die an einen bestimmten Richtlinienspeicher gebunden ist.
...
| Ldap-Anzeigename | msDS-AzApplication                      |
...
| Mögliche Vorgesetzte          | [**ms-DS-Az-Admin-Manager**](c-msds-azadminmanager.md)                                                                          |
| Zusätzlich           | \-                                                                                                                               |
...
| [**Beschreibung**](a-description.md)                                        | Falsch     | **ms-DS-Az-Application** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-Az-Application-Data**](a-msds-azapplicationdata.md)               | Falsch     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Application-Name**](a-msds-azapplicationname.md)               | Falsch     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Application-Version**](a-msds-azapplicationversion.md)         | Falsch     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Class-ID**](a-msds-azclassid.md)                               | Falsch     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Generate-Audits**](a-msds-azgenerateaudits.md)                 | Falsch     | **ms-DS-Az-Application**                                 |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                                                                  |
| Mögliche Übergeordnete          | [**ms-DS-Az-Admin-Manager**](c-msds-azadminmanager.md)                                                                          |
| Zusätzlich           | \-                                                                                                                               |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                                     |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; CO) |
| System-Flags                | 0x00000010                                                                                                                       |
...
| [**ms-DS-Az-Class-ID**](a-msds-azclassid.md)                                  | Falsch     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Generate-Audits**](a-msds-azgenerateaudits.md)                    | Falsch     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Generic-Data**](a-msds-azgenericdata.md)                          | Falsch     | **ms-DS-Az-Application**                                 |
| [**ms-DS-Az-Object-Guid**](a-msds-azobjectguid.md)                            | Falsch     | **ms-DS-Az-Application**                                 |
| [**MS-DS-Consistency-Child-Count**](a-ms-ds-consistencychildcount.md)         | Falsch     | [**Nach oben**](c-top.md)<br/>                          |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | Falsch     | [**Nach oben**](c-top.md)<br/>                          |
