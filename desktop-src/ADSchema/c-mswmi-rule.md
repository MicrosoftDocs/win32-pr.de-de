...
---
# <a name="ms-wmi-rule-class"></a>MS-WMI-Rule-Klasse

Definiert eine einzelne Regel in einem som.
...
|-------------------|--------------------------------------|
| CN                | MS-WMI-Regel                          |
| LDAP-Display-Name | mswap-Regel                           |
| Berechtigung aktualisieren  | Gruppenrichtlinie-Administrator           |
| Aktualisierungshäufigkeit  | \-                                   |
| Schema-ID-GUID    | 3c7e6f 83-dd0e-481b-a0c2-74cd96ef2a66 |
...
| Mögliche Vorgesetzten          | [**Container**](c-container.md)[**MS-WMI-som**](c-mswmi-som.md)                            |
| Zusätzlich           | \-                                                                                           |
...
| [**MS-WMI-Query**](a-mswmi-query.md)                                       | Richtig      | **MS-WMI-Regel**                 |
| [**MS-WMI-QueryLanguage**](a-mswmi-querylanguage.md)                       | Richtig      | **MS-WMI-Regel**                 |
| [**MS-WMI-targetNamespace**](a-mswmi-targetnamespace.md)                   | Richtig      | **MS-WMI-Regel**                 |
