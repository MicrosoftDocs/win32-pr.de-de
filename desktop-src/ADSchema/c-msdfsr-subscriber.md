---
title: ms-DFSR-Subscriber-Klasse
description: Enthält die Mitgliedschaft eines lokalen Computers einer Replikationsgruppe.
ms.assetid: 02ce34b3-2dc0-44ae-b392-b1545e92a0f7
ms.tgt_platform: multiple
keywords:
- ms-DFSR-Subscriber-Klasse AD-Schema
- msDFSR-Subscriber-Klasse AD Schema
topic_type:
- apiref
api_name:
- ms-DFSR-Subscriber
...
ms.locfileid: "118959889"
---
# <a name="ms-dfsr-subscriber-class"></a>ms-DFSR-Subscriber-Klasse

Enthält die Mitgliedschaft eines lokalen Computers einer Replikationsgruppe.
...
| Ldap-Anzeigename | msDFSR-Subscriber                    |
...
| Mögliche Vorgesetzte          | [**ms-DFSR-LocalSettings**](c-msdfsr-localsettings.md)                                                                          |
| Zusätzlich           | \-                                                                                                                               |
...
| Rdn-Att-Id                  | \-                                                                                                                               |
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                                                                  |
| Mögliche Übergeordnete          | [**ms-DFSR-LocalSettings**](c-msdfsr-localsettings.md)                                                                          |
| Zusätzlich           | \-                                                                                                                               |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                                     |
| Standardsicherheitsdeskriptor | D:(A;; RPLCLORC;;; AU)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;;D A)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; CO)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; SY) |
| System-Flags                | 0x00000000                                                                                                                       |
...
Die **ms-DFSR-Subscriber-Klasse** ist Teil der Verteiltes Dateisystem (DFS)-Replikationsdienstunterstützung.
