...
---
# <a name="ms-dfsr-subscriber-class"></a>MS-DFSR-Abonnenten Klasse

Enthält die lokale Computer Mitgliedschaft einer Replikations Gruppe.
...
|-------------------|--------------------------------------|
| CN                | MS-DFSR-Abonnent                   |
| LDAP-Display-Name | msdfsr-Abonnent                    |
...
| Mögliche Vorgesetzten          | [**MS-DFSR-LocalSettings**](c-msdfsr-localsettings.md)                                                                          |
| Zusätzlich           | \-                                                                                                                               |
...
| [**MS-DFSR-Erweiterung**](a-msdfsr-extension.md)                             | False     | **MS-DFSR-Abonnent**          |
| [**MS-DFSR-Flags**](a-msdfsr-flags.md)                                     | False     | **MS-DFSR-Abonnent**          |
| [**MS-DFSR-mitgliedsverweis**](a-msdfsr-memberreference.md)                 | Richtig      | **MS-DFSR-Abonnent**          |
| [**MS-DFSR-mitgliedreferencebl**](a-msdfsr-memberreferencebl.md)             | False     | [**Nach oben**](c-top.md)<br/> |
| [**MS-DFSR-Optionen**](a-msdfsr-options.md)                                 | False     | **MS-DFSR-Abonnent**          |
| [**MS-DFSR-replicationgroupguid**](a-msdfsr-replicationgroupguid.md)       | Richtig      | **MS-DFSR-Abonnent**          |
...
| [**MS-DFSR-mitgliedreferencebl**](a-msdfsr-memberreferencebl.md)                | False     | [**Nach oben**](c-top.md)<br/> |
| [**MS-DFSR-Optionen**](a-msdfsr-options.md)                                    | False     | **MS-DFSR-Abonnent**          |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | False     | **MS-DFSR-Abonnent**          |
| [**MS-DFSR-replicationgroupguid**](a-msdfsr-replicationgroupguid.md)          | Richtig      | **MS-DFSR-Abonnent**          |
| [**ms-DS-ca-immed-untergeordnete Elemente**](a-msds-approx-immed-subordinates.md)    | False     | [**Nach oben**](c-top.md)<br/> |
...
Die **MS-DFSR-Subscriber-** Klasse ist Teil der Unterstützung für den verteiltes Dateisystem (DFS)-Replikations Dienst.
