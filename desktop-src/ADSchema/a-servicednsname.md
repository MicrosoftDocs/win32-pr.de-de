...
---
# <a name="service-dns-name-attribute"></a>Dienst-DNS-Name-Attribut

Der DNS-Name für die Suche nach einem Server, auf dem dieser Dienst ausgeführt wird.
...
| System-ID-GUID    | 28630eb8-41d5-11d1-a9c1-0000 C1        |
