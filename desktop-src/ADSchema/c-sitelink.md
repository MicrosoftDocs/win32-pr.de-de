...
keywords:
- Site-Link Ad-Schema der Klasse
...
ms.locfileid: "119548910"
---
# <a name="site-link-class"></a>Site-Link-Klasse

Dieses Objekt stellt die Verbindung zwischen zwei Standorten dar.
...
|-------------------|----------------------------------------------------|
| CN                | Site-Link                                          |
| Ldap-Anzeigename | Sitelink                                           |
| Aktualisieren von Berechtigungen  | Domänenadministrator                               |
| Updatehäufigkeit  | Immer dann, wenn sich die mit diesem Link verbundenen Standorte ändern. |
...
| Mögliche Übergeordnete          | [**Standortübergreifender Transport**](c-intersitetransport.md)                                         |
| Zusätzlich           | \-                                                                                           |
...
| [**Kosten**](a-cost.md)                                                    | False     | **Site-Link**                   |
...
| [**Optionen**](a-options.md)                                              | False     | **Site-Link**                   |
...
| [**Zeitplan**](a-schedule.md)                                            | False     | **Site-Link**                   |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Vorgesetzte          | [**Standortübergreifender Transport**](c-intersitetransport.md)                                         |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
