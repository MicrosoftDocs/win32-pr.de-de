...
description: Ein Objekt zum Nachverfolgen der Standortlinks, die transitiv verbunden sind.
...
ms.locfileid: "119548900"
---
# <a name="site-link-bridge-class"></a>Site-Link-Bridge-Klasse

Ein Objekt zum Nachverfolgen der Standortlinks, die transitiv verbunden sind.
...
|-------------------|--------------------------------------------------------------------|
| CN                | Site-Link-Bridge                                                   |
| Ldap-Anzeigename | siteLinkBridge                                                     |
| Aktualisieren von Berechtigungen  | Domänenadministrator                                               |
| Updatehäufigkeit  | Immer dann, wenn ein Standortlink hinzugefügt oder von der Brücke entfernt werden muss. |
