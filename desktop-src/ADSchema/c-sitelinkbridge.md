...
Ein Objekt zum Nachverfolgen der transitiv verbundenen Standort Verknüpfungen.
...
| Aktualisierungshäufigkeit  | Jedes Mal, wenn eine Standort Verknüpfung hinzugefügt oder aus der Bridge entfernt werden muss. |
...
| [**Site-Link-List**](a-sitelinklist.md)                                  | Richtig      | **Site-Link-Bridge**            |
