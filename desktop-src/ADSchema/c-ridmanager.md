...
description: Enthält den RID FSMO- und den RID-Available-Pool-Speicherort, der vom RID-Manager verwendet wird. Der RID-Manager ist eine Komponente, die auf dem Domänencontroller ausgeführt wird und für das Zuordnen von Sicherheitsbezeichnern zuständig ist.
ms.assetid: 84af5d6d-a5a7-4288-a9eb-0eaaf0c23063
ms.tgt_platform: multiple
keywords:
- RID-Manager Ad-Schema der Klasse
...
ms.locfileid: "118959569"
---
# <a name="rid-manager-class"></a>RID-Manager-Klasse

Enthält den RID FSMO- und den RID-Available-Pool-Speicherort, der vom RID-Manager verwendet wird. Der RID-Manager ist eine Komponente, die auf dem Domänencontroller ausgeführt wird und für das Zuordnen von Sicherheitsbezeichnern zuständig ist.
...
|-------------------|-------------------------------------------|
| CN                | RID-Manager                               |
| Ldap-Anzeigename | rIDManager                                |
| Aktualisieren von Berechtigungen  | Dieser Wert wird vom System festgelegt.          |
| Updatehäufigkeit  | Immer dann, wenn sich die ZUORDNUNG des RID-Pools ändert. |
...
| [**RID-Available-Pool**](a-ridavailablepool.md)                          | True      | **RID-Manager**                 |
...
| Zusätzlich           | \-                                                                                                              |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                    |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU)S:(AU;SA; CRWP;;; WD) |
| System-Flags                | 0x00000010                                                                                                      |
