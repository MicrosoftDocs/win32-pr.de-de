...
Enthält den RID-und den RID-available-Pool-Speicherort, der vom RID-Manager verwendet wird. Der RID-Manager ist eine Komponente, die auf dem Domänen Controller ausgeführt wird und für die Zuordnung von Sicherheits-IDs zuständig ist.
...
| Aktualisierungshäufigkeit  | Bei jeder Änderung der RID-Pool Zuordnung. |
| Schema-ID-GUID    | 6617188d-8F c04afda-00c04f 930c9      |
...
| [**Rid-available-Pool**](a-ridavailablepool.md)                          | Richtig      | **RID-Manager**                 |
...
| Zusätzlich           | \-                                                                                                              |
| NT-Security-Descriptor      | o:Bag: schlecht: S:                                                                                                    |
| Standard Sicherheits Beschreibung | D: (A;; rpwpcrccdclclorcwowdsddtsw;;;D a) (a;; Rpwpcrccdclclorcwowdsddtsw;;; SY) (A;; Rplclorc;;; Au) S: (au; sa; Crwp;;; Zel |
| System-Flags                | 0x00000010                                                                                                      |
