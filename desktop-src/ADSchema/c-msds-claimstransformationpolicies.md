...
description: Ein Objekt dieser Klasse enthält den einen Satz von Anspruchstransformationsrichtlinien für gesamtstrukturübergreifende Anspruchstransformationen. | ms-DS-Claims-Transformation-Policies-Klasse
ms.assetid: d6e188b3-0ff2-4888-8e19-277d642de68e
ms.tgt_platform: multiple
keywords:
- MS-DS-Claims-Transformation-Policies-Klasse AD-Schema
- msDS-ClaimsTransformationPolicies-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "118680700"
---
# <a name="ms-ds-claims-transformation-policies-class"></a>ms-DS-Claims-Transformation-Policies-Klasse

Ein Objekt dieser Klasse enthält den einen Satz von Anspruchstransformationsrichtlinien für gesamtstrukturübergreifende Anspruchstransformationen.
...
| Ldap-Anzeigename | msDS-ClaimsTransformationPolicies    |
