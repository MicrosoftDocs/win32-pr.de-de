...
---
# <a name="ms-ds-claims-transformation-policies-class"></a>ms-DS-Claims-Transformation-Policies-Klasse

Ein Objekt dieser Klasse enthält einen Satz von Anspruchs Transformations Richtlinien für die Gesamtstruktur übergreifende Anspruchs Transformation.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | ms-DS-Claims-Transformation-Richtlinien |
...
| Standard Sicherheits Beschreibung | D: (A;; Rpwpcrccdclclorcwowdsddtsw;;; EA) (a;; Rpwpcrccdclclorcwowdsddtsw;;; Mütter |
