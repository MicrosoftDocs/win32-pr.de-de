...
---
# <a name="ms-sql-sqlpublication-class"></a>MS-SQL-sqlpublication-Klasse

Klasse zum Speichern von SQL Server Veröffentlichungs Eigenschaften. Ermöglicht dem Benutzer das Durchsuchen der Veröffentlichungen, die für das Abonnieren von verfügbar sind.
...
| Schema-ID-GUID    | 17c2f 64E-ccef-11d2-9993-0000f 87a57d4 |
...
| Mögliche Vorgesetzten          | [**MS-SQL-SQLServer**](c-ms-sql-sqlserver.md)                                               |
| Zusätzlich           | \-                                                                                           |
...
| [**MS-SQL-zuverteilungsabonnement**](a-ms-sql-allowanonymoussubscription.md)                 | False     | **MS-SQL-sqlpublication**       |
| [**MS-SQL-zugswimmediateupdatingabonnement**](a-ms-sql-allowimmediateupdatingsubscription.md) | False     | **MS-SQL-sqlpublication**       |
| [**MS-SQL-allowknownpullabonnement**](a-ms-sql-allowknownpullsubscription.md)                 | False     | **MS-SQL-sqlpublication**       |
| [**MS-SQL-allowqueuedupdatingabonnement**](a-ms-sql-allowqueuedupdatingsubscription.md)       | False     | **MS-SQL-sqlpublication**       |
| [**MS-SQL-allowsnapshotfilesftpdownload**](a-ms-sql-allowsnapshotfilesftpdownloading.md)     | False     | **MS-SQL-sqlpublication**       |
| [**MS-SQL-Datenbank**](a-ms-sql-database.md)                                                     | False     | **MS-SQL-sqlpublication**       |
| [**MS-SQL-Description**](a-ms-sql-description.md)                                               | False     | **MS-SQL-sqlpublication**       |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                                             | False     | **MS-SQL-sqlpublication**       |
| [**MS-SQL-Publisher**](a-ms-sql-publisher.md)                                                   | False     | **MS-SQL-sqlpublication**       |
| [**MS-SQL-Status**](a-ms-sql-status.md)                                                         | False     | **MS-SQL-sqlpublication**       |
| [**MS-SQL-thirdparty**](a-ms-sql-thirdparty.md)                                                 | False     | **MS-SQL-sqlpublication**       |
| [**MS-SQL-Type**](a-ms-sql-type.md)                                                             | False     | **MS-SQL-sqlpublication**       |
