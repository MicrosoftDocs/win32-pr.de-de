...
---
# <a name="ms-pki-enterprise-oid-class"></a>MS-PKI-Enterprise-OID-Klasse

Wird verwendet, wenn in einer Zertifikat Benutzeroberfläche ein Anzeige Name für eine Zertifikat Vorlage, die erweiterte Schlüssel Verwendung, die Anwendungs Richtlinie und die Ausstellungs Richtlinie angezeigt werden. Die UI-Komponente versucht, eine Zeichenfolge im-Attribut zu suchen, die mit dem Standard Gebiets Schema der Sprache übereinstimmt.
...
| Aktualisierungshäufigkeit  | Er wird aktualisiert, wenn der Administrator certutil.exe ausführt, um einen lokalisierten Namen für jede OID zu speichern. |
...
| Mögliche Vorgesetzten          | [**Container**](c-container.md)**MS-PKI-Enterprise-OID**                                    |
| Zusätzlich           | \-                                                                                           |
...
| [**MS-PKI-OID-Benutzer Hinweis**](a-mspki-oid-user-notice.md)                   | False     | **MS-PKI-Enterprise-OID**       |
...
| [**ms-DS-Non-Members-BL**](a-msds-nonmembersbl.md)                              | False     | [**Nach oben**](c-top.md)<br/> |
| [**ms-DS-Object-Reference-BL**](a-msds-objectreferencebl.md)                    | False     | [**Nach oben**](c-top.md)<br/> |
| [**ms-DS-oidtoidgruppenlink**](a-msds-oidtogrouplink.md)                           | False     | **MS-PKI-Enterprise-OID**       |
