...
description: Container zum Halten aller Subnetzobjekte.
ms.assetid: d63975be-584d-4f50-9a5f-27eb5cf5f504
ms.tgt_platform: multiple
keywords:
- Subnet-Container Ad-Schema der Klasse
- subnetContainer-Klasse AD-Schema
topic_type:
- apiref
api_name:
- Subnet-Container
...
ms.locfileid: "119580610"
---
# <a name="subnet-container-class"></a>Subnet-Container-Klasse

Container zum Halten aller Subnetzobjekte.
...
|-------------------|--------------------------------------|
| CN                | Subnet-Container                     |
| Ldap-Anzeigename | subnetContainer                      |
