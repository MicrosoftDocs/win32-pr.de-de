...
keywords:
- ms-COM-PartitionSet-Klasse AD Schema
- 'msCOM-PartitionSet-Klasse : AD-Schema'
topic_type:
- apiref
api_name:
- ms-COM-PartitionSet
...
ms.locfileid: "118011165"
---
# <a name="ms-com-partitionset-class"></a>ms-COM-PartitionSet-Klasse

Eine konzeptionelle Auflistung von COM+-Partitionen.
...
| Ldap-Anzeigename | msCOM-PartitionSet                   |
...
| [**ms-COM-DefaultPartitionLink**](a-mscom-defaultpartitionlink.md)         | Falsch     | **ms-COM-PartitionSet**         |
| [**ms-COM-ObjectId**](a-mscom-objectid.md)                                 | Falsch     | **ms-COM-PartitionSet**         |
| [**ms-COM-PartitionLink**](a-mscom-partitionlink.md)                       | Falsch     | **ms-COM-PartitionSet**         |
