---
title: ms-DS-Password-Einstellungen-Container-Klasse
description: Container für Kennworteinstellungsobjekte.
ms.assetid: 45e55a1d-63a9-41e5-ac54-3ed467251d3d
ms.tgt_platform: multiple
keywords:
- ms-DS-Password-Einstellungen-Container class AD Schema
...
ms.locfileid: "119879940"
---
# <a name="ms-ds-password-settings-container-class"></a>ms-DS-Password-Einstellungen-Container-Klasse

Container für Kennworteinstellungsobjekte.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | ms-DS-Password-Einstellungen-Container    |
| Ldap-Anzeigename | msDS-PasswordSettingsContainer       |
