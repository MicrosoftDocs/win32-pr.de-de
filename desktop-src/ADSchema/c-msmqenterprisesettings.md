...
---
# <a name="msmq-enterprise-settings-class"></a>MSMQ-Enterprise-Settings-Klasse

Ein Objekt mit allgemeinen MSMQ-Informationen. Sie wird unter \\ Konfigurations \\ Dienste platziert. In einer Gesamtstruktur kann nur eine davon vorhanden sein. Dieses Objekt enthält Organisations weite Konfigurationsinformationen für Message Queueing.
...
| [**MSMQ-CSP-Name**](a-msmqcspname.md)                                    | False     | **MSMQ-Enterprise-Settings**    |
| [**MSMQ-Interval1**](a-msmqinterval1.md)                                 | False     | **MSMQ-Enterprise-Settings**    |
| [**MSMQ-Interval2**](a-msmqinterval2.md)                                 | False     | **MSMQ-Enterprise-Settings**    |
| [**MSMQ-langlebig**](a-msmqlonglived.md)                                | False     | **MSMQ-Enterprise-Settings**    |
| [**MSMQ-Name-Stil**](a-msmqnamestyle.md)                                | False     | **MSMQ-Enterprise-Settings**    |
| [**MSMQ-Version**](a-msmqversion.md)                                     | False     | **MSMQ-Enterprise-Settings**    |
