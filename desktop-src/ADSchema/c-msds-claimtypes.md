...
description: Ein Container dieser Klasse kann Anspruchstypobjekte enthalten.
ms.assetid: ce140ede-915f-40e0-8ea7-243573477a10
ms.tgt_platform: multiple
keywords:
- MS-DS-Claim-Types-Klasse AD-Schema
- msDS-ClaimTypes-Klasse AD-Schema
topic_type:
- apiref
api_name:
- ms-DS-Claim-Types
...
ms.locfileid: "118422775"
---
# <a name="ms-ds-claim-types-class"></a>ms-DS-Claim-Types-Klasse

Ein Container dieser Klasse kann Anspruchstypobjekte enthalten.
...
| Ldap-Anzeigename | msDS-ClaimTypes                      |
