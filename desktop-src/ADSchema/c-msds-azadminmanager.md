...
Der Stamm der Autorisierungs Richtlinien-Speicher Instanz. Beachten Sie, dass es viele Speicher Instanzen geben kann.
...
| Berechtigung aktualisieren  | Dieser Wert wird vom Administrator azrollen festgelegt. |
...
| [**ms-DS-AZ-Generate-Überwachungen**](a-msds-azgenerateaudits.md)                 | False     | **ms-DS-AZ-Admin-Manager**                                 |
