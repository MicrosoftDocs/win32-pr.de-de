...
description: Stamm der Autorisierungsrichtlinienspeicherinstanz. Beachten Sie, dass es viele Speicherinstanzen geben kann.
ms.assetid: 4dfd7b5e-847c-4778-82e5-64b6c6525e73
ms.tgt_platform: multiple
keywords:
- MS-DS-Az-Admin-Manager-Klasse AD-Schema
- msDS-AzAdminManager-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "118422974"
---
# <a name="ms-ds-az-admin-manager-class"></a>ms-DS-Az-Admin-Manager-Klasse

Stamm der Autorisierungsrichtlinienspeicherinstanz. Beachten Sie, dass es viele Speicherinstanzen geben kann.
...
| Ldap-Anzeigename | msDS-AzAdminManager                             |
| Aktualisieren von Berechtigungen  | Dieser Wert wird vom AzRoles-Administrator festgelegt. |
...
| [**Beschreibung**](a-description.md)                                        | False     | **ms-DS-Az-Admin-Manager** [ **Top**](c-top.md)<br/> |
