...
description: Dies ist Teil der X.500-Spezifikation und wird nicht von NTDS verwendet.
ms.assetid: 3c8c8df1-25d7-4ef6-bec4-66b12318b3f0
ms.tgt_platform: multiple
keywords:
- Destination-Indicator AD-Attributschema
- destinationIndicator-Attribut AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119509000"
---
# <a name="destination-indicator-attribute"></a>Destination-Indicator-Attribut

Dies ist Teil der X.500-Spezifikation und wird nicht von NTDS verwendet.
...
| Ldap-Anzeigename | destinationIndicator                 |
| Size              | \-                                   |
