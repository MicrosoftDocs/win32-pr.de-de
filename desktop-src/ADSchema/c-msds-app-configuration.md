...
---
# <a name="ms-ds-app-configuration-class"></a>ms-DS-App-Konfigurations Klasse

Wird zum Speichern der Einstellungs Informationen für eine Anwendung verwendet. Das [**ms-DS-Settings-**](a-msds-settings.md) Attribut sollte zum Speichern der tatsächlichen Werte verwendet werden.



| Eingabe | Wert |
|-------------------|------------------------------------------------|
| CN                | ms-DS-App-Konfiguration                        |
| LDAP-Display-Name | MSDS-App-Konfiguration                         |
...
| Mögliche Vorgesetzten          | [**Container**](c-container.md)[**Computer**](c-computer.md)[**Organisationseinheit**](c-organizationalunit.md) |
| Zusätzlich           | \-                                                                                                                |
...
| [**Keywords**](a-keywords.md)                                              | False     | **ms-DS-App-Konfiguration**                                      |
| [**Letztes-bekannt/übergeordnetes Element**](a-lastknownparent.md)                              | False     | [**Nach oben**](c-top.md)<br/>                                  |
| [**Verwaltet von**](a-managedby.md)                                           | False     | **ms-DS-App-Konfiguration**                                      |
...
| [**ms-DS-Byte-Array**](a-msds-bytearray.md)                                | False     | **ms-DS-App-Konfiguration**                                      |
...
| [**ms-DS-Datum/Uhrzeit**](a-msds-datetime.md)                                  | False     | **ms-DS-App-Konfiguration**                                      |
| [**ms-DS-Integer**](a-msds-integer.md)                                     | False     | **ms-DS-App-Konfiguration**                                      |
...
| [**ms-DS-Object-Reference**](a-msds-objectreference.md)                    | False     | **ms-DS-App-Konfiguration**                                      |
...
| [**Besitzer**](a-owner.md)                                                    | False     | **ms-DS-App-Konfiguration**                                      |
