---
title: ms-DS-App-Configuration-Klasse
description: Wird verwendet, um die Einstellungsinformationen für eine Anwendung zu speichern. Das attribut ms-DS-Einstellungen sollte zum Speichern der tatsächlichen Werte verwendet werden.
ms.assetid: cbb050c8-c391-4c13-bb01-11a11635c9be
ms.tgt_platform: multiple
keywords:
- MS-DS-App-Configuration-Klasse AD-Schema
- MSDS-App-Configuration-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119880600"
---
# <a name="ms-ds-app-configuration-class"></a>ms-DS-App-Configuration-Klasse

Wird verwendet, um die Einstellungsinformationen für eine Anwendung zu speichern. Das [**attribut ms-DS-Einstellungen**](a-msds-settings.md) sollte zum Speichern der tatsächlichen Werte verwendet werden.
...
| Ldap-Anzeigename | msDS-App-Configuration                         |
...
| [**Keywords**](a-keywords.md)                                              | Falsch     | **ms-DS-App-Configuration**                                      |
| [**Last-Known-Parent**](a-lastknownparent.md)                              | Falsch     | [**Nach oben**](c-top.md)<br/>                                  |
| [**Verwaltet von**](a-managedby.md)                                           | Falsch     | **ms-DS-App-Configuration**                                      |
...
| [**ms-DS-Byte-Array**](a-msds-bytearray.md)                                | Falsch     | **ms-DS-App-Configuration**                                      |
...
| [**ms-DS-Date-Time**](a-msds-datetime.md)                                  | Falsch     | **ms-DS-App-Configuration**                                      |
| [**ms-DS-Integer**](a-msds-integer.md)                                     | Falsch     | **ms-DS-App-Configuration**                                      |
...
| [**ms-DS-Object-Reference**](a-msds-objectreference.md)                    | Falsch     | **ms-DS-App-Configuration**                                      |
...
| [**Besitzer**](a-owner.md)                                                    | Falsch     | **ms-DS-App-Configuration**                                      |
...
| Unterklasse von                 | [**Anwendungsbasierte Einstellungen**](c-applicationsettings.md)<br/>                                                  |
