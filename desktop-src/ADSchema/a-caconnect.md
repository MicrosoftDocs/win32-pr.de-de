...
---
# <a name="ca-connect-attribute"></a>CA-Connect-Attribut

Die Verbindungs Zeichenfolge für die Bindung an eine Zertifizierungsstelle.
...
|-------------------|---------------------------------------------|
| CN                | CA-Connect                                  |
| LDAP-Display-Name | caconnct                                   |
| Size              | \-                                          |
| Berechtigung aktualisieren  | \-                                          |
| Aktualisierungshäufigkeit  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.687                      |
| System-ID-GUID    | 963d2735-48be-11d1-a9c3-0000 C1        |
