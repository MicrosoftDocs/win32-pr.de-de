...
---
# <a name="sites-container-class"></a>Sites-Container-Klasse

Ein Container zum Speichern von Standort Objekten. Befindet sich im Konfigurations namens Kontext.
...
| Berechtigung aktualisieren  | Dieses Objekt wird vom System verwaltet. |
| Aktualisierungshäufigkeit  | Wenn der Verzeichnisdienst erstellt wird.   |
| Schema-ID-GUID    | 7a4117da-cd67-11D0-AFFF -0000f 80367c1     |
