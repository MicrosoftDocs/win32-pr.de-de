...
---
# <a name="ms-ds-claims-transformation-policy-type-class"></a>ms-DS-Claims-Transformation-Type-Klasse
...
| Schema-ID-GUID    | 2eeb62b3-1373-fe45-8101-387fi1676edc7    |
...
| Mögliche Vorgesetzten          | [**ms-DS-Claims-Transformation-Richtlinien**](c-msds-claimstransformationpolicies.md) |
| Zusätzlich           | \-                                                                                  |
...
| [**ms-DS-Transformation-Regeln**](a-msds-transformationrules.md)                             | False     | **ms-DS-Claims-Transformation-Policy-Type** |
| [**ms-DS-Transformation-Regeln-kompiliert**](a-msds-transformationrulescompiled.md)            | False     | **ms-DS-Claims-Transformation-Policy-Type** |
