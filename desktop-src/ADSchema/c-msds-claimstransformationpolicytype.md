---
title: ms-DS-Claims-Transformation-Policy-Type-Klasse
description: Ein Objekt dieser Klasse enthält den einen Satz von Anspruchstransformationsrichtlinie für gesamtstrukturübergreifende Anspruchstransformation. | ms-DS-Claims-Transformation-Policy-Type-Klasse
ms.assetid: 5368ea9a-0fd7-4b0e-8b49-d5c3ee3cb09c
ms.tgt_platform: multiple
keywords:
- ms-DS-Claims-Transformation-Policy-Type-Klasse AD Schema
...
ms.locfileid: "119880220"
---
# <a name="ms-ds-claims-transformation-policy-type-class"></a>ms-DS-Claims-Transformation-Policy-Type-Klasse

Ein Objekt dieser Klasse enthält den einen Satz von Anspruchstransformationsrichtlinie für gesamtstrukturübergreifende Anspruchstransformation.
...
| Ldap-Anzeigename | msDS-ClaimsTransformationPolicyType     |
...
| Mögliche Vorgesetzte          | [**ms-DS-Claims-Transformation-Policies**](c-msds-claimstransformationpolicies.md) |
| Zusätzlich           | \-                                                                                  |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                        |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; EA)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)          |
...
| [**ms-DS-Transformation-Rules**](a-msds-transformationrules.md)                             | Falsch     | **ms-DS-Claims-Transformation-Policy-Type** |
| [**ms-DS-Transformation-Rules-Compiled**](a-msds-transformationrulescompiled.md)            | Falsch     | **ms-DS-Claims-Transformation-Policy-Type** |
