...
---
# <a name="msmq-migrated-user-class"></a>MSMQ-migrierte Benutzerklasse

In MSMQ 1,0 hatten wir unsere eigenen DS, bei denen wir einige Informationen pro Benutzer aufbewahrt haben. Im Rahmen der MSMQ-Integration in Windows 2000 DS bietet MSMQ ein Migrationstool. Während der Migration wird für jeden Benutzer, der nicht in der Windows 2000-Domäne ist, ein migrierter Benutzer erstellt.



| Eingabe | Wert |
|-------------------|--------------------------------------------------------------------------------------------------|
| CN                | MSMQ-migriert-Benutzer                                                                               |
| LDAP-Display-Name | mSMQMigratedUser                                                                                 |
| Berechtigung aktualisieren  | Der Besitzer der Warteschlange.                                                                                 |
| Aktualisierungshäufigkeit  | Dieses Objekt wird vom Message Queuing Upgrade-Assistenten in einer Domänen Umgebung im gemischten Modus erstellt. |
| Schema-ID-GUID    | 50776997-3c3d-11d2-90cc-00c04f d91ab1                                                             |
...
| Mögliche Vorgesetzten          | [**BuiltIn-Domänen**](c-builtindomain.md)[**Domäne-DNS**](c-domaindns.md)-[**Organisationseinheit**](c-organizationalunit.md) |
| Zusätzlich           | \-                                                                                                                            |
...
| [**MSMQ-Digests**](a-msmqdigests.md)                                     | False     | **MSMQ-migriert-Benutzer**          |
| [**MSMQ-Digests-MiG**](a-msmqdigestsmig.md)                              | False     | **MSMQ-migriert-Benutzer**          |
| [**MSMQ-Sign-Zertifikate**](a-msmqsigncertificates.md)                  | False     | **MSMQ-migriert-Benutzer**          |
| [**MSMQ-Sign-Zertifikats-MiG**](a-msmqsigncertificatesmig.md)           | False     | **MSMQ-migriert-Benutzer**          |
| [**MSMQ-Benutzer-sid**](a-msmqusersid.md)                                    | False     | **MSMQ-migriert-Benutzer**          |
...
| [**Objekt-sid**](a-objectsid.md)                                         | False     | **MSMQ-migriert-Benutzer**          |
