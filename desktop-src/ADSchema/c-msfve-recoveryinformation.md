...
---
# <a name="ms-fve-recoveryinformation-class"></a>MS-f-Wiederherstellungsinformationsklasse

Diese Klasse enthält ein Wiederherstellungs Kennwort für die vollständige Volumeverschlüsselung mit der zugehörigen GUID.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | MS-f-Wiederherstellungsinformationen           |
| LDAP-Display-Name | MSF-Wiederherstellungsinformationen            |
...
| [**MS-f-KeyPackage**](a-msfve-keypackage.md)                                | False     | **MS-f-Wiederherstellungsinformationen**  |
| [**MS-"-wiederherstellungguid"**](a-msfve-recoveryguid.md)                            | Richtig      | **MS-f-Wiederherstellungsinformationen**  |
| [**MS-f-wiederherstellungkennwort**](a-msfve-recoverypassword.md)                    | Richtig      | **MS-f-Wiederherstellungsinformationen**  |
| [**MS-f-VolumeGuid**](a-msfve-volumeguid.md)                                | False     | **MS-f-Wiederherstellungsinformationen**  |
