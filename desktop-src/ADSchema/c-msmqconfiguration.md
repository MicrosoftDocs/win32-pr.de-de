...
---
# <a name="msmq-configuration-class"></a>MSMQ-Configuration-Klasse

Dieses Objekt enthält MSMQ-Konfigurationsparameter für einen bestimmten Computer. Die Attribute dieser Klasse sind MSMQ-spezifisch und werden für MSMQ-Routing Entscheidungen verwendet.
...
| Aktualisierungshäufigkeit  | Eine Instanz dieser Klasse wird pro Computer erstellt, der MSMQ unter dem Computer Objekt installiert. |
...
| Mögliche Vorgesetzten          | [**Computer**](c-computer.md)                                                               |
| Zusätzlich           | \-                                                                                           |
...
| [**MSMQ-Computertyp**](a-msmqcomputertype.md)                          | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-Computer-Type-Ex**](a-msmqcomputertypeex.md)                     | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-abhängige Client Dienste**](a-msmqdependentclientservices.md)   | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-DS-Dienste**](a-msmqdsservices.md)                              | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-Verschlüsselungsschlüssel**](a-msmqencryptkey.md)                              | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-Foreign**](a-msmqforeign.md)                                     | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-in-Routing-Server**](a-msmqinroutingservers.md)                 | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-Journal-Quota**](a-msmqjournalquota.md)                          | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-OS-Type**](a-msmqostype.md)                                      | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-Out-Routing-Server**](a-msmqoutroutingservers.md)               | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-Besitzer-ID**](a-msmqownerid.md)                                    | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-Kontingent**](a-msmqquota.md)                                         | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-Routing Dienste**](a-msmqroutingservices.md)                    | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-Diensttyp**](a-msmqservicetype.md)                            | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-Signierschlüssel**](a-msmqsignkey.md)                                    | False     | **MSMQ-Konfiguration**          |
| [**MSMQ-Sites**](a-msmqsites.md)                                         | False     | **MSMQ-Konfiguration**          |
