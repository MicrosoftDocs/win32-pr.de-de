...
description: Es gibt eine davon pro Domänencontroller. Sie enthält die RID-Pools, die vom DC zugeordnet wurden.
ms.assetid: b3e0eccd-63de-4950-ba1c-574be3a4019b
ms.tgt_platform: multiple
keywords:
- RID-Set Ad-Schema der Klasse
...
ms.locfileid: "118959544"
---
# <a name="rid-set-class"></a>RID-Set-Klasse

Es gibt eine davon pro Domänencontroller. Sie enthält die RID-Pools, die vom DC zugeordnet wurden.
...
| Mögliche Übergeordnete          | [](c-computer.md)[**Computercontainerbenutzer**](c-container.md)[](c-user.md)         |
| Zusätzlich           | \-                                                                                           |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Vorgesetzte          | [](c-computer.md)[**Computercontainerbenutzer**](c-container.md)[](c-user.md)         |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
