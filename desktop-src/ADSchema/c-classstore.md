...
Diese Klasse wird verwendet, um den Klassen Speicher Container zu erstellen. Der Klassen Speicher Container bietet das Framework zum Bereitstellen von Anwendungs Ressourcen in Active Directory und zur Bereitstellung der Bereitstellungs Richtlinie für Richtlinien Empfänger (d. h. Benutzer und Computer). Zugriffs-und Verwaltungs Berechtigungen werden von Standard-Access Control-Eigenschaften für das Container Objekt des Klassen Speicher gesteuert.
...
| Mögliche Vorgesetzten          | [**Container**](c-container.md)[**Domäne-DNS-**](c-domaindns.md)[**Organisationseinheiten**](c-organizationalunit.md)**Klasse-Speicher**[**Benutzer**](c-user.md)[**Gruppe**](c-group.md)[**Computer**](c-computer.md)[**Domäne-Richtlinie**](c-domainpolicy.md) |
| Zusätzlich           | \-                                                                                                                                                                                                                                                     |
...
| [**App-Schema-Version**](a-appschemaversion.md)                          | False     | **Class-Store**                 |
...
| [**Letzte Update-Sequenz**](a-lastupdatesequence.md)                      | False     | **Class-Store**                 |
...
| [**Next-Level-Store**](a-nextlevelstore.md)                              | False     | **Class-Store**                 |
...
| [**Versionsnummer**](a-versionnumber.md)                                 | False     | **Class-Store**                 |
