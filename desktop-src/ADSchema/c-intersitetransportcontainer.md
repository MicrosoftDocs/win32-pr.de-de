...
---
# <a name="inter-site-transport-container-class"></a>Inter-Site-Transport-Container-Klasse

Enthält standortübergreifende Transport Objekte.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | Standort übergreifender Transport Container       |
| LDAP-Display-Name | intersitetransportcontainer          |
| Berechtigung aktualisieren  | \-                                   |
| Aktualisierungshäufigkeit  | \-                                   |
| Schema-ID-GUID    | 26d97375-6070-11d1-a9c6-0000b80367c1 |
