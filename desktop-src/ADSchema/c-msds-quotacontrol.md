...
Eine Klasse, die verwendet wird, um Kontingent Spezifikationen für die Verzeichnis Datenbank darzustellen.
...
| Mögliche Vorgesetzten          | [**ms-DS-Quota-Container**](c-msds-quotacontainer.md)   |
| Zusätzlich           | \-                                                       |
| NT-Security-Descriptor      | o:Bag: schlecht: S:                                             |
| Standard Sicherheits Beschreibung | D: (A;; rpwpcrccdclclorcwowdsddtsw;;;D a) (a;; Rplclorc;;; Ben |
...
| [**Gemeinsamer Name**](a-cn.md)                                                 | Richtig      | **ms-DS-Quota-Control** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-Kontingent-Amount**](a-msds-quotaamount.md)                            | Richtig      | **ms-DS-Quota-Control**                                 |
| [**ms-DS-Kontingent-Treuhänder**](a-msds-quotatrustee.md)                          | Richtig      | **ms-DS-Quota-Control**                                 |
