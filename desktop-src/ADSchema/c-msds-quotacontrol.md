...
description: Eine Klasse, die verwendet wird, um Kontingentspezifikationen für die Verzeichnisdatenbank darzustellen.
ms.assetid: e37897f8-9646-4bc8-b6e6-9da4a83d66d5
ms.tgt_platform: multiple
keywords:
- MS-DS-Quota-Control-Klasse AD-Schema
- MSDS-QuotaControl-Klasse AD-Schema
topic_type:
- apiref
api_name:
- ms-DS-Quota-Control
...
ms.locfileid: "119879890"
---
# <a name="ms-ds-quota-control-class"></a>ms-DS-Quota-Control-Klasse

Eine Klasse, die verwendet wird, um Kontingentspezifikationen für die Verzeichnisdatenbank darzustellen.
...
| Ldap-Anzeigename | msDS-QuotaControl                    |
...
| Mögliche Übergeordnete          | [**ms-DS-Quota-Container**](c-msds-quotacontainer.md)   |
| Zusätzlich           | \-                                                       |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                             |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPLCLORC;;; BA) |
...
| [**Allgemeiner Name**](a-cn.md)                                                 | Richtig      | **ms-DS-Quota-Control** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-Quota-Amount**](a-msds-quotaamount.md)                            | Richtig      | **ms-DS-Quota-Control**                                 |
| [**ms-DS-Quota-Trustee**](a-msds-quotatrustee.md)                          | Richtig      | **ms-DS-Quota-Control**                                 |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                        |
| Mögliche Vorgesetzte          | [**ms-DS-Quota-Container**](c-msds-quotacontainer.md) |
| Zusätzlich           | \-                                                     |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                           |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falsch     | [**Nach oben**](c-top.md)<br/>                         |
| [**Kanonischer Name**](a-canonicalname.md)                                   | Falsch     | [**Nach oben**](c-top.md)<br/>                         |
| [**Common-Name**](a-cn.md)                                                 | Richtig      | **ms-DS-Quota-Control** [ **Top**](c-top.md)<br/> |
