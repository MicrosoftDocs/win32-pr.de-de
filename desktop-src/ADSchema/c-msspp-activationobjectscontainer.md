...
description: Container für Aktivierungsobjekte, die von der Active Directory-basierten Aktivierung verwendet werden
ms.assetid: 3e43b439-91aa-4bdf-b1af-96d908c9a3eb
ms.tgt_platform: multiple
keywords:
- MS-SPP-Activation-Objects-Container-Klasse AD-Schema
- msSPP-ActivationObjectsContainer-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879400"
---
# <a name="ms-spp-activation-objects-container-class"></a>ms-SPP-Activation-Objects-Container-Klasse

Container für Aktivierungsobjekte, die von der Active Directory-basierten Aktivierung verwendet werden
...
| Ldap-Anzeigename | msSPP-ActivationObjectsContainer     |
