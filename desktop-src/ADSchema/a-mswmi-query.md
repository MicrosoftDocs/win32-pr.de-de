...
keywords:
- ms-WMI-Query-Attribut AD-Schema
- AD-Schema des msWMI-Query-Attributs
topic_type:
- apiref
api_name:
- ms-WMI-Query
...
ms.locfileid: "119589530"
---
# <a name="ms-wmi-query-attribute"></a>ms-WMI-Query-Attribut

Eine einzelne WQL-Abfrage.
...
|-------------------|---------------------------------------------|
| CN                | ms-WMI-Query                                |
| Ldap-Anzeigename | msWMI-Query                                 |
| Size              | Weniger als 250 Zeichen.                   |
