---
title: File-Link-Tracking-Klasse
description: Container für File-Link-Tracking-Entry-Objekte.
ms.assetid: 15ed6bd8-bbd7-4d64-a02b-599bddf4492b
ms.tgt_platform: multiple
keywords:
- File-Link-Tracking-Klasse AD-Schema
- fileLinkTracking-Klasse AD-Schema
topic_type:
- apiref
api_name:
- File-Link-Tracking
...
ms.locfileid: "119922740"
---
# <a name="file-link-tracking-class"></a>File-Link-Tracking-Klasse

Container für File-Link-Tracking-Entry-Objekte.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | Dateiverknüpfungsnachverfolgung                   |
| Ldap-Anzeigename | fileLinkTracking                     |
