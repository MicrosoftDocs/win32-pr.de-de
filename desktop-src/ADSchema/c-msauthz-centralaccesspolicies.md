---
title: ms-Hz-Central-Access-Policies-Klasse
description: Ein Container dieser Klasse kann Zentrale Zugriffsrichtlinie-Objekte enthalten.
ms.assetid: 2aafe035-4666-4b9b-a354-ca1780cf476d
ms.tgt_platform: multiple
keywords:
- ms-Sollhz-Central-Access-Policies-Klasse AD-Schema
...
ms.locfileid: "118959899"
---
# <a name="ms-authz-central-access-policies-class"></a>ms-Hz-Central-Access-Policies-Klasse

Ein Container dieser Klasse kann Zentrale Zugriffsrichtlinie-Objekte enthalten.
...
| Ldap-Anzeigename | msAuthz-CentralAccessPolicies        |
