...
---
# <a name="ms-authz-central-access-policies-class"></a>MS-Authz-Central-Access-Policies-Klasse

Ein Container dieser Klasse kann zentrale Zugriffsrichtlinien Objekte enthalten.
