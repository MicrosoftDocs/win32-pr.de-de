...
---
# <a name="ms-ds-nc-repl-inbound-neighbors-attribute"></a>ms-DS-NC-repl-Inbound-Neighbors-Attribut

Replikations Partner für diese Partition. Dieser Server erhält Replikations Daten von diesen anderen Servern, die als Quellen fungieren.



| Eingabe | Wert |
|-------------------|---------------------------------------------|
| CN                | ms-DS-NC-repl-Inbound-Nachbarn             |
| LDAP-Display-Name | MSDS-nkreplinboundnachbarn                 |
| Size              | \-                                          |
