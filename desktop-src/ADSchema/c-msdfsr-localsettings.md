...
Enthält die Einstellungen für den DFS-Replikations Dienst (verteiltes Dateisystem), die für den lokalen Computer gelten.
...
| [**MS-DFSR-Erweiterung**](a-msdfsr-extension.md)                             | False     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-Flags**](a-msdfsr-flags.md)                                     | False     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-mitgliedreferencebl**](a-msdfsr-memberreferencebl.md)             | False     | [**Nach oben**](c-top.md)<br/> |
| [**MS-DFSR-Optionen**](a-msdfsr-options.md)                                 | False     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-Version**](a-msdfsr-version.md)                                 | False     | **MS-DFSR-LocalSettings**       |
...
| [**MS-DFSR-stagingcleanuptriggerinprozent**](a-msdfsr-stagingcleanuptriggerinpercent.md) | False     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-Version**](a-msdfsr-version.md)                                               | False     | **MS-DFSR-LocalSettings**       |
| [**ms-DS-ca-immed-untergeordnete Elemente**](a-msds-approx-immed-subordinates.md)               | False     | [**Nach oben**](c-top.md)<br/> |
...
Die **MS-DFSR-LocalSettings-** Klasse ist Teil der DFS-Replikation Service-Unterstützung.
