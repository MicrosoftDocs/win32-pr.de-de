...
description: Dieser Wert wird in active Directory in dem Pfad geschrieben, auf den das entsprechende Gruppenrichtlinie verweist. Sie soll die verschiedenen Objekte verknüpfen, die zum Ausdrücken der WMI-Erweiterungen mit der Gruppenrichtlinie werden.
ms.assetid: fe70fb59-7ba5-4ae1-ac3e-9a521157bc9b
ms.tgt_platform: multiple
keywords:
- ms-WMI-WMIGPO-Klasse AD Schema
- msWMI-WMIGPO-Klasse AD Schema
topic_type:
- apiref
api_name:
- ms-WMI-WMIGPO
...
ms.locfileid: "119753630"
---
# <a name="ms-wmi-wmigpo-class"></a>ms-WMI-WMIGPO-Klasse

Dieser Wert wird in active Directory in dem Pfad geschrieben, auf den das entsprechende Gruppenrichtlinie verweist. Sie soll die verschiedenen Objekte verknüpfen, die zum Ausdrücken der WMI-Erweiterungen mit der Gruppenrichtlinie werden.
...
| [**ms-WMI-intFlags1**](a-mswmi-intflags1.md)                               | Falsch     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-intFlags2**](a-mswmi-intflags2.md)                               | Falsch     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-intFlags3**](a-mswmi-intflags3.md)                               | Falsch     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-intFlags4**](a-mswmi-intflags4.md)                               | Falsch     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-Parm1**](a-mswmi-parm1.md)                                       | Falsch     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-Parm2**](a-mswmi-parm2.md)                                       | Falsch     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-Parm3**](a-mswmi-parm3.md)                                       | Falsch     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-Parm4**](a-mswmi-parm4.md)                                       | Falsch     | **ms-WMI-WMIGPO**               |
| [**ms-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Richtig      | **ms-WMI-WMIGPO**               |
