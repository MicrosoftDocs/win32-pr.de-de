...
description: Enthält Codierungsdaten für eine WMI-Klasse oder ein Instanzobjekt sowie zusätzliche Informationen zum Objekt.
ms.assetid: 8f2830f0-c427-431e-bcd2-6d7f8951792a
ms.tgt_platform: multiple
keywords:
- MS-WMI-ObjectEncoding-Klasse AD-Schema
- msWMI-ObjectEncoding-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119440290"
---
# <a name="ms-wmi-objectencoding-class"></a>ms-WMI-ObjectEncoding-Klasse

Enthält Codierungsdaten für eine WMI-Klasse oder ein Instanzobjekt sowie zusätzliche Informationen zum Objekt.
...
| Ldap-Anzeigename | msWMI-ObjectEncoding                 |
...
| [**ms-WMI-Class**](a-mswmi-class.md)                                       | Richtig      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-Genus**](a-mswmi-genus.md)                                       | Richtig      | **ms-WMI-ObjectEncoding**       |
...
| [**ms-WMI-Class**](a-mswmi-class.md)                                       | Richtig      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-Soll**](a-mswmi-genus.md)                                       | Richtig      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-ID**](a-mswmi-id.md)                                             | Richtig      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-intFlags1**](a-mswmi-intflags1.md)                               | Richtig      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-intFlags2**](a-mswmi-intflags2.md)                               | Richtig      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-intFlags3**](a-mswmi-intflags3.md)                               | Richtig      | **ms-WMI-ObjectEncoding**       |
