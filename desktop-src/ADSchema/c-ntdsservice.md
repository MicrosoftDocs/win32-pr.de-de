...
description: Diese Klasse wird für ein NTDS-Dienstobjekt verwendet, das Informationen zur Konfiguration der Verzeichnisdienst-Gesamtstruktur enthält. Dieses Objekt wird im CN-Verzeichnisdienst,CN Windows NT,CN Services,CN-Konfiguration gespeichert,... Container.
ms.assetid: 55f94e25-3871-4946-9a7e-073bec0abce5
ms.tgt_platform: multiple
keywords:
- NTDS-Service Ad-Schema der Klasse
...
ms.locfileid: "119753450"
---
# <a name="ntds-service-class"></a>NTDS-Service-Klasse

Diese Klasse wird für ein NTDS-Dienstobjekt verwendet, das Informationen zur Konfiguration der Verzeichnisdienst-Gesamtstruktur enthält. Dieses Objekt wird im Verzeichnisdienst CN=Verzeichnisdienst,CN=Windows NT,CN=Services,CN=Configuration beibehalten,... Container.
...
| [**DS-Heuristik**](a-dsheuristics.md)                                   | Falsch     | **NTDS-Service**                |
...
| [**Garbage Coll-Period**](a-garbagecollperiod.md)                        | Falsch     | **NTDS-Service**                |
...
| [**Repl-Topology-Stay-of-Execution**](a-repltopologystayofexecution.md)  | Falsch     | **NTDS-Service**                |
...
| [**SPN-Zuordnungen**](a-spnmappings.md)                                     | Falsch     | **NTDS-Service**                |
...
| [**Tombstonelebensdauer**](a-tombstonelifetime.md)                         | Falsch     | **NTDS-Service**                |
...
| [**ms-DS-Other-Einstellungen**](a-msds-other-settings.md)                       | Falsch     | **NTDS-Service**                |
...
| [**MS-DS-Consistency-Child-Count**](a-ms-ds-consistencychildcount.md)           | Falsch     | [**Nach oben**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                        | Falsch     | [**Nach oben**](c-top.md)<br/> |
| [**ms-DS-Deleted-Object-Lifetime**](a-msds-deletedobjectlifetime.md)            | Falsch     | **NTDS-Service**                |
