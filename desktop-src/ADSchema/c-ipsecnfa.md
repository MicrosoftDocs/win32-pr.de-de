...
description: Die Ipsec-NFA-Klasse ist nur zur internen Verwendung.
ms.assetid: b0fd9de1-13bb-40b4-8c03-f32962f6bb2f
ms.tgt_platform: multiple
keywords:
- AD-Schema der Ipsec-NFA-Klasse
- AD-Schema der ipsecNFA-Klasse
topic_type:
- apiref
api_name:
- Ipsec-NFA
...
ms.locfileid: "119922550"
---
# <a name="ipsec-nfa-class"></a>Ipsec-NFA-Klasse

Die **Ipsec-NFA-Klasse** ist nur zur internen Verwendung.
...
| Mögliche Vorgesetzte          | [**Computercontainer der**](c-organizationalunit.md)[**Organisationseinheit**](c-computer.md)[](c-container.md) |
| Zusätzlich           | \-                                                                                                                |
...
| [**Ipsec-Filter-Reference**](a-ipsecfilterreference.md)                        | Falsch     | **Ipsec-NFA**                                |
| [**Ipsec-ID**](a-ipsecid.md)                                                   | Falsch     | [**Ipsec-Base**](c-ipsecbase.md)<br/> |
| [**Ipsec-Name**](a-ipsecname.md)                                               | Falsch     | [**Ipsec-Base**](c-ipsecbase.md)<br/> |
| [**Ipsec-Negotiation-Policy-Reference**](a-ipsecnegotiationpolicyreference.md) | Falsch     | **Ipsec-NFA**                                |
...
| Mögliche Übergeordnete          | [**Computercontainer der Organisationseinheit**](c-organizationalunit.md)[](c-computer.md)[](c-container.md) |
| Zusätzlich           | \-                                                                                                                |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                      |
| Standardsicherheitsdeskriptor | D:                                                                                                                |
| System-Flags                | 0x00000010                                                                                                        |
