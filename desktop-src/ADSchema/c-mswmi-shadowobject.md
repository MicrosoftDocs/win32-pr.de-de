...
keywords:
- MS-WMI-ShadowObject-Klasse AD Schema
- MSWMI-ShadowObject-Klasse AD-Schema
topic_type:
- apiref
api_name:
- ms-WMI-ShadowObject
...
ms.locfileid: "118175175"
---
# <a name="ms-wmi-shadowobject-class"></a>ms-WMI-ShadowObject-Klasse

Enthält eine WMI-kompilierte Objektinstanz.
...
| Ldap-Anzeigename | msWMI-ShadowObject                   |
...
| Mögliche Übergeordnete          | [**ms-WMI-PolicyType**](c-mswmi-policytype.md)                                              |
| Zusätzlich           | \-                                                                                           |
...
| [**ms-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Richtig      | **ms-WMI-ShadowObject**         |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Vorgesetzte          | [**ms-WMI-PolicyType**](c-mswmi-policytype.md)                                              |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
