...
description: Enthält weitere zusätzliche E-Mail-Adressen in einem Formular, z. B. CCMAIL-Benachrichtigungsserver.
ms.assetid: c7e49fbc-fb3a-487e-835b-ad2c1481425a
ms.tgt_platform: multiple
keywords:
- Other-Mailbox AD-Schema
...
|-------------------|----------------------------------------------------------|
| CN                | Other-Mailbox                                            |
| Ldap-Anzeigename | otherMailbox                                             |
| Size              | \-                                                       |
| Aktualisieren von Berechtigungen  | Domänenadministrator                                     |
| Updatehäufigkeit  | Jedes Mal, wenn dem Benutzer eine zusätzliche E-Mail-Adresse ausgegeben wird. |
