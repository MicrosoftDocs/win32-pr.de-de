...
description: Definiert einen Satz von Vorgängen, die von einer bestimmten Gruppe von Benutzern innerhalb eines bestimmten Bereichs ausgeführt werden können.
ms.assetid: 1cf0c229-8e5f-4c3b-9284-50be088ecdc3
ms.tgt_platform: multiple
keywords:
- ms-DS-Az-Role-Klasse AD Schema
- MSDS-AzRole-Klasse AD-Schema
topic_type:
- apiref
api_name:
- ms-DS-Az-Role
...
ms.locfileid: "119880320"
---
# <a name="ms-ds-az-role-class"></a>ms-DS-Az-Role-Klasse

Definiert einen Satz von Vorgängen, die von einer bestimmten Gruppe von Benutzern innerhalb eines bestimmten Bereichs ausgeführt werden können.
...
| [**Beschreibung**](a-description.md)                                        | Falsch     | **ms-DS-Az-Role** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-Az-Application-Data**](a-msds-azapplicationdata.md)               | Falsch     | **ms-DS-Az-Role**                                 |
...
| [**ms-DS-Members-for-Az-Role**](a-msds-membersforazrole.md)                | Falsch     | **ms-DS-Az-Role**                                 |
...
| [**ms-DS-Operations-for-Az-Role**](a-msds-operationsforazrole.md)          | Falsch     | **ms-DS-Az-Role**                                 |
...
| [**ms-DS-Tasks-for-Az-Role**](a-msds-tasksforazrole.md)                    | Falsch     | **ms-DS-Az-Role**                                 |
...
| [**ms-DS-Az-Application-Data**](a-msds-azapplicationdata.md)                  | Falsch     | **ms-DS-Az-Role**                                 |
| [**ms-DS-Az-Generic-Data**](a-msds-azgenericdata.md)                          | Falsch     | **ms-DS-Az-Role**                                 |
| [**ms-DS-Az-Object-Guid**](a-msds-azobjectguid.md)                            | Falsch     | **ms-DS-Az-Role**                                 |
| [**MS-DS-Consistency-Child-Count**](a-ms-ds-consistencychildcount.md)         | Falsch     | [**Nach oben**](c-top.md)<br/>                   |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | Falsch     | [**Nach oben**](c-top.md)<br/>                   |
