...
ms.locfileid: "119643720"
---
# <a name="country-class"></a>Country-Klasse

Das Land/die Region in der Adresse des Benutzers. Dies ist der vollständige Name.
...
|-------------------|------------------------------------------------------------|
| CN                | Land                                                    |
| Ldap-Anzeigename | country                                                    |
| Aktualisieren von Berechtigungen  | Der Kontobesitzer oder Domänenadministrator legt diesen Wert fest. |
| Updatehäufigkeit  | Wenn sich das Land bzw. die Region des Benutzers ändert.               |
...
| [**Country-Name**](a-c.md)                                               | True      | **Country**                     |
...
| [**Search-Guide**](a-searchguide.md)                                     | False     | **Country**                     |
...
| [**Text-Country**](a-co.md)                                              | False     | **Country**                     |
...
| Rdn-Att-Id                  | [**Country-Name**](a-c.md)<br/>                                                       |
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Vorgesetzte          | [](c-organization.md)[**Organisationsdomänen-DNS**](c-domaindns.md)                      |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
...
| Rdn-Att-Id                  | [**Country-Name**](a-c.md)<br/>                                  |
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                         |
| Mögliche Übergeordnete          | [](c-organization.md)[**Domäne-DNS der** Organisation](c-domaindns.md) |
| Zusätzlich           | \-                                                                      |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                            |
