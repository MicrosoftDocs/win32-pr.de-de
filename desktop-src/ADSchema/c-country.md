...
| Berechtigung aktualisieren  | Der Konto Besitzer oder der Domänen Administrator legt diesen Wert fest. |
| Aktualisierungshäufigkeit  | Wenn das Land/die Region des Benutzers geändert wird.               |
...
| RDN-ATT-ID                  | [**Länder Name**](a-c.md)<br/>                                                       |
...
| [**Länder Name**](a-c.md)                                               | Richtig      | **Country**                     |
...
| [**Such Handbuch**](a-searchguide.md)                                     | False     | **Country**                     |
...
| RDN-ATT-ID                  | [**Länder Name**](a-c.md)<br/>                                                       |
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Vorgesetzten          | [**Organisations**](c-organization.md)[**Domäne: DNS**](c-domaindns.md)                      |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | o:Bag: schlecht: S:                                                                                 |
| Standard Sicherheits Beschreibung | D: (A;; rpwpcrccdclclorcwowdsddtsw;;;D a) (a;; Rpwpcrccdclclorcwowdsddtsw;;; SY) (A;; Rplclorc;;; Thaus |
| System-Flags                | 0x00000010                                                                                   |
