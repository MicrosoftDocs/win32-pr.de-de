...
description: Die aktuelle Priorität (eines Prozesses, eines Druckauftrags und so weiter).
ms.assetid: 89cce143-446d-444b-bda1-36ac748075d1
ms.tgt_platform: multiple
keywords:
- AD-Schema des Prioritätsattributs
- AD-Schema des Prioritätsattributs
topic_type:
- apiref
api_name:
...
ms.locfileid: "118423841"
---
# <a name="priority-attribute"></a>Priority-Attribut

Die aktuelle Priorität (eines Prozesses, eines Druckauftrags und so weiter).
