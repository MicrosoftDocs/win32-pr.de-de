...
- mS-SQL-OLAPDatabase-Klasse AD-Schema
topic_type:
- apiref
api_name:
- MS-SQL-OLAPDatabase
...
ms.locfileid: "119441210"
---
# <a name="ms-sql-olapdatabase-class"></a>MS-SQL-OLAPDatabase-Klasse

Container zum Speichern von [**MS-SQL-OLAPCube-Objekten.**](c-ms-sql-olapcube.md)
...
| Ldap-Anzeigename | mS-SQL-OLAPDatabase                  |
...
| Mögliche Übergeordnete          | [**MS-SQL-OLAPServer**](c-ms-sql-olapserver.md)                                             |
| Zusätzlich           | \-                                                                                           |
...
| [**MS-SQL-Applications**](a-ms-sql-applications.md)                      | False     | **MS-SQL-OLAPDatabase**         |
...
| [**MS-SQL-Keywords**](a-ms-sql-keywords.md)                              | False     | **MS-SQL-OLAPDatabase**         |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Vorgesetzte          | [**MS-SQL-OLAPServer**](c-ms-sql-olapserver.md)                                             |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
