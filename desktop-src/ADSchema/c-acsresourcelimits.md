...
description: Enthält Grenzwerte für beobachtbare Ressourcen für ein Subnetz. Diese Grenzwerte können für jeden ACS-Diensttyp oder für alle Diensttypen gelten.
ms.assetid: 6b1d15e8-a60b-4253-8521-db3c9ebbb69b
ms.tgt_platform: multiple
keywords:
- AD-Schema der ACS-Resource-Limits-Klasse
...
ms.locfileid: "119021878"
---
# <a name="acs-resource-limits-class"></a>ACS-Resource-Limits-Klasse

Enthält Grenzwerte für beobachtbare Ressourcen für ein Subnetz. Diese Grenzwerte können für jeden ACS-Diensttyp oder für alle Diensttypen gelten.
...
| Ldap-Anzeigename | aCSResourceLimits                              |
...
|---------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-Allocable-RSVP-Bandwidth**](a-acsallocablersvpbandwidth.md)       | Falsch     | **ACS-Resource-Limits**         |
| [**ACS-Max-Peak-Bandwidth**](a-acsmaxpeakbandwidth.md)                   | Falsch     | **ACS-Resource-Limits**         |
| [**ACS-Max-Peak-Bandwidth-per-Flow**](a-acsmaxpeakbandwidthperflow.md)   | Falsch     | **ACS-Resource-Limits**         |
| [**ACS-Max-Token-Rate-per-Flow**](a-acsmaxtokenrateperflow.md)           | Falsch     | **ACS-Resource-Limits**         |
| [**ACS-Service-Type**](a-acsservicetype.md)                              | Falsch     | **ACS-Resource-Limits**         |
