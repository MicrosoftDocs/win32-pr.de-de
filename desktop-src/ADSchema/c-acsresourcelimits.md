...
Enthält reservierbare Ressourcen Limits für ein Subnetz. Diese Grenzwerte können für jeden ACS-Diensttyp oder für alle Dienst Typen gelten.



| Eingabe | Wert |
|-------------------|------------------------------------------------|
| CN                | ACS-Ressourcen Limits                            |
| LDAP-Display-Name | acsresourcelimits                              |
| Berechtigung aktualisieren  | Dieser Wert wird vom Domänen Administrator festgelegt. |
| Aktualisierungshäufigkeit  | \-                                             |
| Schema-ID-GUID    | 2e899b04-2834-11d3-91d4-0000f 87a57d4           |
...
|---------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-Zuweisung-RSVP-Bandbreite**](a-acsallocablersvpbandwidth.md)       | False     | **ACS-Ressourcen Limits**         |
| [**ACS-Max-Spitzen Bandbreite**](a-acsmaxpeakbandwidth.md)                   | False     | **ACS-Ressourcen Limits**         |
| [**ACS-Max-Spitze-Bandbreite pro Flow**](a-acsmaxpeakbandwidthperflow.md)   | False     | **ACS-Ressourcen Limits**         |
| [**ACS-Max-Token-Rate pro Flow**](a-acsmaxtokenrateperflow.md)           | False     | **ACS-Ressourcen Limits**         |
| [**ACS-Diensttyp**](a-acsservicetype.md)                              | False     | **ACS-Ressourcen Limits**         |
