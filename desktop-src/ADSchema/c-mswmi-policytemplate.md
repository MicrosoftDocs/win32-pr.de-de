...
description: Die Richtlinienvorlage enthält eine Vorlage zum Erstellen einer Klasseninstanz im Zielnamespace.
ms.assetid: a51ab1e5-3080-48be-a18a-0714c3fbceb3
ms.tgt_platform: multiple
keywords:
- ms-WMI-PolicyTemplate-Klasse AD Schema
- msWMI-PolicyTemplate-Klasse AD Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "120005410"
---
# <a name="ms-wmi-policytemplate-class"></a>ms-WMI-PolicyTemplate-Klasse

Die Richtlinienvorlage enthält eine Vorlage zum Erstellen einer Klasseninstanz im Zielnamespace.
...
| Ldap-Anzeigename | msWMI-PolicyTemplate                 |
...
| Standardsicherheitsdeskriptor | D:(A;; RPLCLORC;;; AU)(A;; RPWPCRLCLOCCDCRCWDWOSW;;;D A)(A;; CC;;;; PA)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; SY) |
...
| [**ms-WMI-Author**](a-mswmi-author.md)                                     | Falsch     | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-ChangeDate**](a-mswmi-changedate.md)                             | Falsch     | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-CreationDate**](a-mswmi-creationdate.md)                         | Falsch     | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-ID**](a-mswmi-id.md)                                             | Richtig      | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-intFlags1**](a-mswmi-intflags1.md)                               | Falsch     | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-intFlags2**](a-mswmi-intflags2.md)                               | Falsch     | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-intFlags3**](a-mswmi-intflags3.md)                               | Falsch     | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-intFlags4**](a-mswmi-intflags4.md)                               | Falsch     | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-Name**](a-mswmi-name.md)                                         | Richtig      | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-NormalizedClass**](a-mswmi-normalizedclass.md)                   | Richtig      | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-Parm1**](a-mswmi-parm1.md)                                       | Falsch     | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-Parm2**](a-mswmi-parm2.md)                                       | Falsch     | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-Parm3**](a-mswmi-parm3.md)                                       | Falsch     | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-Parm4**](a-mswmi-parm4.md)                                       | Falsch     | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-SourceOrganization**](a-mswmi-sourceorganization.md)             | Falsch     | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Richtig      | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-TargetNameSpace**](a-mswmi-targetnamespace.md)                   | Richtig      | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-TargetPath**](a-mswmi-targetpath.md)                             | Richtig      | **ms-WMI-PolicyTemplate**       |
| [**ms-WMI-TargetType**](a-mswmi-targettype.md)                             | Falsch     | **ms-WMI-PolicyTemplate**       |
