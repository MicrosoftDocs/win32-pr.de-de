...
---
# <a name="create-time-stamp-attribute"></a>Create-Time-Stamp-Attribut

Das Datum, an dem dieses Objekt erstellt wurde. Dieser Wert wird repliziert.



| Eingabe | Wert |
|-------------------|---------------------------------------------------------------|
| CN                | Create-Zeitstempel                                             |
| LDAP-Display-Name | "kreatetimestamp"                                               |
| Size              | 8 Bytes                                                       |
| Berechtigung aktualisieren  | Dieser Wert wird vom System festgelegt.                              |
| Aktualisierungshäufigkeit  | Wenn das Objekt erstellt wird.                                   |
| Attribute-Id      | 2.5.18.1                                                      |
| System-ID-GUID    | 2df90d73-009F -11d2-aa4c-00c04f d83a                          |
