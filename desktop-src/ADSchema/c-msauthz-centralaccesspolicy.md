...
---
# <a name="ms-authz-central-access-policy-class"></a>MS-Authz-Central-Access-Policy-Klasse

Eine Klasse, die Objekte der zentralen Zugriffs Richtlinie definiert.
...
| Mögliche Vorgesetzten          | [**MS-Authz-Central-Access-Policies**](c-msauthz-centralaccesspolicies.md)                  |
| Zusätzlich           | \-                                                                                           |
