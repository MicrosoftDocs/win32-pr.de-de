---
title: ms-Takthz-Central-Access-Policy-Klasse
description: Eine Klasse, die Objekte der zentralen Zugriffsrichtlinie definiert.
ms.assetid: ea0c9f84-cb61-49ec-8128-eddc61749d7d
ms.tgt_platform: multiple
keywords:
- ms-Sollhz-Central-Access-Policy-Klasse AD-Schema
...
ms.locfileid: "119834570"
---
# <a name="ms-authz-central-access-policy-class"></a>ms-Takthz-Central-Access-Policy-Klasse

Eine Klasse, die Objekte der zentralen Zugriffsrichtlinie definiert.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | ms-Hz-Central-Access-Policy       |
| Ldap-Anzeigename | msAuthz-CentralAccessPolicy          |
...
| Mögliche Vorgesetzte          | [**ms-Authz-Central-Access-Policies**](c-msauthz-centralaccesspolicies.md)                  |
| Zusätzlich           | \-                                                                                           |
...
| [**ms-Autorehz-Central-Access-Policy-ID**](a-msauthz-centralaccesspolicyid.md)                         | False     | **ms-Autorehz-Central-Access-Policy** |
| [**ms-Authz-Member-Rules-in-Central-Access-Policy**](a-msauthz-memberrulesincentralaccesspolicy.md) | False     | **ms-Autorehz-Central-Access-Policy** |
