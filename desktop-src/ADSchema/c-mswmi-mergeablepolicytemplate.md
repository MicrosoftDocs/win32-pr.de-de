...
description: Stellt eine Richtlinienvorlage bereit, die mit anderen Vorlagen zusammengeführt werden kann.
ms.assetid: 01bb16f5-4673-4b21-96f7-9f82c05c0110
ms.tgt_platform: multiple
keywords:
- ms-WMI-MergeablePolicyTemplate-Klasse AD Schema
- msWMI-MergeablePolicyTemplate-Klasse AD Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119549280"
---
# <a name="ms-wmi-mergeablepolicytemplate-class"></a>ms-WMI-MergeablePolicyTemplate-Klasse

Stellt eine Richtlinienvorlage bereit, die mit anderen Vorlagen zusammengeführt werden kann.
...
| Ldap-Anzeigename | msWMI-MergeablePolicyTemplate        |
