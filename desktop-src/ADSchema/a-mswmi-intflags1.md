...
keywords:
- AD-Schema des ms-WMI-intFlags1-Attributs
- AD-Schema des msWMI-intFlags1-Attributs
topic_type:
- apiref
api_name:
- ms-WMI-intFlags1
...
ms.locfileid: "117837742"
---
# <a name="ms-wmi-intflags1-attribute"></a>ms-WMI-intFlags1-Attribut

Das **ms-WMI-intFlags1-Attribut** ist für die interne Verwendung reserviert.
...
|-------------------|--------------------------------------|
| CN                | ms-WMI-intFlags1                     |
| Ldap-Anzeigename | msWMI-intFlags1                      |
| Size              | 4 Bytes                              |
