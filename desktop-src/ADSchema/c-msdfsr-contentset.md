...
description: Definiert die Konfigurationsinformationen des Inhaltssets.
...
Definiert die Konfigurationsinformationen des Inhaltssets.
...
Die **ms-DFSR-ContentSet-Klasse** ist Teil der Unterstützung verteiltes Dateisystem Replikationsdiensts (DFS).
