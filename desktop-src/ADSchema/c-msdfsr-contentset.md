...
Definiert die Inhalts Satz-Konfigurationsinformationen.
...
| Schema-ID-GUID    | 4937b40 d-a6dc-4d48-97ca-06e5f |
...
| Mögliche Vorgesetzten          | [**MS-DFSR-Inhalt**](c-msdfsr-content.md)                                                                                      |
| Zusätzlich           | \-                                                                                                                               |
...
| [**MS-DFSR-directeryfilter**](a-msdfsr-directoryfilter.md)                 | False     | **MS-DFSR-contentset**                                 |
| [**MS-DFSR-Erweiterung**](a-msdfsr-extension.md)                             | False     | **MS-DFSR-contentset**                                 |
...
| [**MS-DFSR-Optionen**](a-msdfsr-options.md)                                 | False     | **MS-DFSR-contentset**                                 |
...
| [**MS-DFSR-Flags**](a-msdfsr-flags.md)                                                         | False     | **MS-DFSR-contentset**                                 |
| [**MS-DFSR-mitgliedreferencebl**](a-msdfsr-memberreferencebl.md)                                 | False     | [**Nach oben**](c-top.md)<br/>                        |
| [**MS-DFSR-ondemandexclusiondirectoriyfilter**](a-msdfsr-ondemandexclusiondirectoryfilter.md)   | False     | **MS-DFSR-contentset**                                 |
...
| [**MS-DFSR-Priorität**](a-msdfsr-priority.md)                                                   | False     | **MS-DFSR-contentset**                                 |
...
Die **MS-DFSR-contentset-** Klasse ist Teil der Unterstützung für den verteiltes Dateisystem (DFS)-Replikations Dienst.
