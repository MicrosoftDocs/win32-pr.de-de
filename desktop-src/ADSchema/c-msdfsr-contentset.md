...
description: Definiert die Konfigurationsinformationen für den Inhaltssatz.
ms.assetid: 8f148742-2f6d-41b5-84bf-670bb72a135a
ms.tgt_platform: multiple
keywords:
- ms-DFSR-ContentSet-Klasse AD-Schema
- msDFSR-ContentSet-Klasse AD-Schema
topic_type:
- apiref
api_name:
- ms-DFSR-ContentSet
...
ms.locfileid: "118423071"
---
# <a name="ms-dfsr-contentset-class"></a>ms-DFSR-ContentSet-Klasse

Definiert die Konfigurationsinformationen für den Inhaltssatz.
...
| Ldap-Anzeigename | msDFSR-ContentSet                    |
...
| Mögliche Vorgesetzte          | [**ms-DFSR-Content**](c-msdfsr-content.md)                                                                                      |
| Zusätzlich           | \-                                                                                                                               |
...
| [**Beschreibung**](a-description.md)                                        | False     | **ms-DFSR-ContentSet** [ **Top**](c-top.md)<br/> |
...
| [**ms-DFSR-Extension**](a-msdfsr-extension.md)                             | False     | **ms-DFSR-ContentSet**                                 |
| [**ms-DFSR-FileFilter**](a-msdfsr-filefilter.md)                           | False     | **ms-DFSR-ContentSet**                                 |
| [**ms-DFSR-Flags**](a-msdfsr-flags.md)                                     | False     | **ms-DFSR-ContentSet**                                 |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | False     | [**Nach oben**](c-top.md)<br/>                        |
| [**ms-DFSR-Options**](a-msdfsr-options.md)                                 | False     | **ms-DFSR-ContentSet**                                 |
...
| [**ms-DFSR-Priority**](a-msdfsr-priority.md)                                                   | False     | **ms-DFSR-ContentSet**                                 |
...
| Rdn-Att-Id                  | \-                                                                                                                               |
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                                                                  |
| Mögliche Übergeordnete          | [**ms-DFSR-Content**](c-msdfsr-content.md)                                                                                      |
| Zusätzlich           | \-                                                                                                                               |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                                     |
| Standardsicherheitsdeskriptor | D:(A;; RPLCLORC;;; AU)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;;D A)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; CO)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; SY) |
| System-Flags                | 0x00000000                                                                                                                       |
...
Die **ms-DFSR-ContentSet-Klasse** ist Teil der DfS-Replikationsdienstunterstützung (verteiltes Dateisystem).
