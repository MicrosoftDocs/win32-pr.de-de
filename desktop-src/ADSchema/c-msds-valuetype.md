...
description: Ein Werttypobjekt enthält Werttypinformationen für eine Ressourceneigenschaft.
ms.assetid: c464d53b-f0dd-42fd-8a8a-a86a270d9f1f
ms.tgt_platform: multiple
keywords:
- MS-DS-Value-Type-Klasse AD-Schema
- 'msDS-ValueType-Klasse : AD-Schema'
topic_type:
- apiref
api_name:
- ms-DS-Value-Type
...
ms.locfileid: "119879790"
---
# <a name="ms-ds-value-type-class"></a>ms-DS-Value-Type-Klasse

Ein Werttypobjekt enthält Werttypinformationen für eine Ressourceneigenschaft.
...
|-------------------|--------------------------------------|
| CN                | ms-DS-Value-Type                     |
| Ldap-Anzeigename | msDS-ValueType                       |
...
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; EA)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) |
...
| [**ms-DS-Claim-Is-Single-Valued**](a-msds-claimissinglevalued.md)                           | Richtig      | **ms-DS-Value-Type**            |
| [**ms-DS-Claim-Is-Value-Space-Restricted**](a-msds-claimisvaluespacerestricted.md)          | Richtig      | **ms-DS-Value-Type**            |
| [**ms-DS-Claim-Shares-Possible-Values-with-BL**](a-msds-claimsharespossiblevalueswithbl.md) | Falsch     | [**Nach oben**](c-top.md)<br/> |
| [**ms-DS-Claim-Value-Type**](a-msds-claimvaluetype.md)                                      | Richtig      | **ms-DS-Value-Type**            |
...
| [**ms-DS-is-possible-values-Present**](a-msds-ispossiblevaluespresent.md)                   | Richtig      | **ms-DS-Value-Type**            |
