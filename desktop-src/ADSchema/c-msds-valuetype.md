...
Ein Werttyp Objekt enthält Werttyp Informationen für eine Ressourcen Eigenschaft.
...
| [**ms-DS-Claim-ist-einwertig**](a-msds-claimissinglevalued.md)                           | Richtig      | **ms-DS-Werttyp**            |
| [**ms-DS-Claim-is-Value-Space-restricted**](a-msds-claimisvaluespacerestricted.md)          | Richtig      | **ms-DS-Werttyp**            |
| [**ms-DS-Claim-Shares-mögliche-values-with-BL**](a-msds-claimsharespossiblevalueswithbl.md) | False     | [**Nach oben**](c-top.md)<br/> |
| [**ms-DS-Claim-Value-Type**](a-msds-claimvaluetype.md)                                      | Richtig      | **ms-DS-Werttyp**            |
...
| [**ms-DS-ist-mögliche Werte-vorhanden**](a-msds-ispossiblevaluespresent.md)                   | Richtig      | **ms-DS-Werttyp**            |
