...
keywords:
- MS-DFSR-Content-Klasse AD-Schema
...
ms.locfileid: "119880690"
---
# <a name="ms-dfsr-content-class"></a>ms-DFSR-Content-Klasse

Stellt einen Container für [**ms-DFSR-ContentSet-Objekte**](c-msdfsr-contentset.md) dar.
...
|-------------------|--------------------------------------|
| CN                | ms-DFSR-Content                      |
| Ldap-Anzeigename | msDFSR-Content                       |
...
| [**ms-DFSR-Extension**](a-msdfsr-extension.md)                             | Falsch     | **ms-DFSR-Content**             |
| [**ms-DFSR-Flags**](a-msdfsr-flags.md)                                     | Falsch     | **ms-DFSR-Content**             |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | Falsch     | [**Nach oben**](c-top.md)<br/> |
| [**ms-DFSR-Options**](a-msdfsr-options.md)                                 | Falsch     | **ms-DFSR-Content**             |
...
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | Falsch     | [**Nach oben**](c-top.md)<br/> |
| [**ms-DFSR-Options**](a-msdfsr-options.md)                                    | Falsch     | **ms-DFSR-Content**             |
| [**ms-DFSR-Options2**](a-msdfsr-options2.md)                                  | Falsch     | **ms-DFSR-Content**             |
| [**ms-DS-Approx-Immed-Subordinates**](a-msds-approx-immed-subordinates.md)    | Falsch     | [**Nach oben**](c-top.md)<br/> |
...
Die **ms-DFSR-Content-Klasse** ist Teil der Unterstützung des verteiltes Dateisystem Replikationsdiensts (DFS).
