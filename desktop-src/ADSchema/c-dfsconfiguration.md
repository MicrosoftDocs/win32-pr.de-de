...
keywords:
- Dfs-Configuration AD-Schema der Klasse
- dfsConfiguration-Klasse AD-Schema
topic_type:
- apiref
api_name:
- Dfs-Configuration
...
ms.locfileid: "119324930"
---
# <a name="dfs-configuration-class"></a>Dfs-Configuration-Klasse

Enthält alle fehlertoleranten DFS-Konfigurationen.
...
| Ldap-Anzeigename | dfsConfiguration                     |
...
| Mögliche Vorgesetzte          | [**Domänen-DNS-Container**](c-domaindns.md)[](c-container.md)                            |
| Zusätzlich           | \-                                                                                           |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Übergeordnete          | [**Domänen-DNS-Container**](c-domaindns.md)[](c-container.md)                            |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
