...
---
# <a name="account-class"></a>Konto Klasse

Die Konto Objektklasse wird verwendet, um Einträge zu definieren, die Computer Konten darstellen.
...
|-------------------|--------------------------------------|
| CN                | Azure-Konto                              |
| LDAP-Display-Name | Azure-Konto                              |
| Berechtigung aktualisieren  | \-                                   |
| Aktualisierungshäufigkeit  | \-                                   |
| Schema-ID-GUID    | 2628a46a-a6ad-4ae0-b854-2b12d9fe6fi9e |
...
| [**Beschreibung**](a-description.md)                                        | False     | **Konto** [ **oben**](c-top.md)<br/> |
...
| [**Lokalitäts Name**](a-l.md)                                                | False     | **Konto**                                 |
...
| [**Organisations Einheits Name**](a-ou.md)                                    | False     | **Konto**                                 |
| [**Name der Organisation**](a-o.md)                                            | False     | **Konto**                                 |
