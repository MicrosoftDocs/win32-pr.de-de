...
---
# <a name="msmq-group-class"></a>MSMQ-Group-Klasse

Wird verwendet, um eine Gruppe von MSMQ-Warteschlangen (auch als Verteilerliste bezeichnet) zu definieren.
...
|-------------------|---------------------------------------------------------|
| CN                | MSMQ-Group                                              |
| LDAP-Display-Name | MSMQ-Gruppe                                              |
| Berechtigung aktualisieren  | Der Besitzer der Warteschlange.                                        |
| Aktualisierungshäufigkeit  | Jedes Mal, wenn ein Mitglied einer Gruppe hinzugefügt oder daraus entfernt wird. |
...
| [**Member**](a-member.md)                                                  | Richtig      | **MSMQ-Gruppe**                  |
