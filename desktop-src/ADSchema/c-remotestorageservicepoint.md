...
description: Diese Klasse enthält Informationen zum Remotespeicherort für Dateien, die offline gespeichert sind.
ms.assetid: e50959ad-720d-4ac7-a0cc-ceff5d80b774
ms.tgt_platform: multiple
keywords:
- AD-Schema der Remote-Storage-Service-Point-Klasse
- remoteStorageServicePoint-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "118959689"
---
# <a name="remote-storage-service-point-class"></a>Remote-Storage-Service-Point-Klasse

Diese Klasse enthält Informationen zum Remotespeicherort für Dateien, die offline gespeichert sind.
...
| Ldap-Anzeigename | remoteStorageServicePoint            |
...
| Mögliche Übergeordnete          | [**Computer**](c-computer.md)                                                                                                   |
| Zusätzlich           | \-                                                                                                                               |
...
| [**Remote-Storage-GUID**](a-remotestorageguid.md)                        | Falsch     | **Remote-Storage-Service-Point**                                                         |
...
| Unterklasse von                 | [**Dienstverwaltungspunkt**](c-serviceadministrationpoint.md)<br/>                                                  |
| Mögliche Vorgesetzte          | [**Computer**](c-computer.md)                                                                                                   |
| Zusätzlich           | \-                                                                                                                               |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                                     |
| Standardsicherheitsdeskriptor | D:(A;; RPLCLORC;;; AU)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;;D A)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; CO)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; SY) |
| System-Flags                | 0x00000010                                                                                                                       |
