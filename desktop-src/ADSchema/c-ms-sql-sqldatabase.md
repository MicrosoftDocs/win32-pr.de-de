...
Klasse zum Speichern von SQL Server Daten Bank Eigenschaften.
...
| Schema-ID-GUID    | 1d08694a-ccef-11d2-9993-0000f 87a57d4 |
...
| [**MS-SQL-Anwendungen**](a-ms-sql-applications.md)                      | False     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Contact**](a-ms-sql-contact.md)                                | False     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL--erationdate**](a-ms-sql-creationdate.md)                      | False     | **MS-SQL-SQLDatabase**          |
...
| [**MS-SQL-Schlüsselwörter**](a-ms-sql-keywords.md)                              | False     | **MS-SQL-SQLDatabase**          |
