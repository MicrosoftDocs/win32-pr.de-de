...
description: Klasse zum Speichern SQL Server Datenbankeigenschaften.
ms.assetid: ad1d7532-534a-4220-8e19-70f7c6f36e36
ms.tgt_platform: multiple
keywords:
- AD-Schema der MS-SQL-SQLDatabase-Klasse
- mS-SQL-SQLDatabase-Klasse AD-Schema
topic_type:
- apiref
api_name:
- MS-SQL-SQLDatabase
...
ms.locfileid: "119441190"
---
# <a name="ms-sql-sqldatabase-class"></a>MS-SQL-SQLDatabase-Klasse

Klasse zum Speichern SQL Server Datenbankeigenschaften.
...
| Ldap-Anzeigename | mS-SQL-SQLDatabase                   |
...
| Mögliche Übergeordnete          | [**MS-SQL-SQLServer**](c-ms-sql-sqlserver.md)                                               |
| Zusätzlich           | \-                                                                                           |
...
| [**MS-SQL-Alias**](a-ms-sql-alias.md)                                    | Falsch     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Applications**](a-ms-sql-applications.md)                      | Falsch     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Contact**](a-ms-sql-contact.md)                                | Falsch     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-CreationDate**](a-ms-sql-creationdate.md)                      | Falsch     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Description**](a-ms-sql-description.md)                        | Falsch     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | Falsch     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Keywords**](a-ms-sql-keywords.md)                              | Falsch     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-LastBackupDate**](a-ms-sql-lastbackupdate.md)                  | Falsch     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-LastDiagnosticDate**](a-ms-sql-lastdiagnosticdate.md)          | Falsch     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                      | Falsch     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Size**](a-ms-sql-size.md)                                      | Falsch     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Status**](a-ms-sql-status.md)                                  | Falsch     | **MS-SQL-SQLDatabase**          |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Vorgesetzte          | [**MS-SQL-SQLServer**](c-ms-sql-sqlserver.md)                                               |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
