...
---
# <a name="ms-ds-password-complexity-enabled-attribute"></a>ms-DS-Password-Komplexitäts fähiges Attribut

Der Status der Kenn Wort Komplexität für Benutzerkonten.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | ms-DS-Kenn Wort Komplexität-aktiviert    |
| LDAP-Display-Name | MSDS-passwordcomplexityaktivierte       |
| Size              | \-                                   |
