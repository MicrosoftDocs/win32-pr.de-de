...
---
# <a name="licensing-site-settings-class"></a>Licensing-Site-Settings-Klasse

Verweist auf den Lizenzierungs Server für einen Standort.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | Lizenzierung-Site-Settings              |
| LDAP-Display-Name | licensingsitesettings aus                |
...
| [**Standort-Server**](a-siteserver.md)                                       | False     | **Lizenzierung-Site-Settings**                                               |
