...
description: Parameterobjekt für Zeichenfolgensatz.
ms.assetid: dd253c7d-d968-46be-a39f-f844be6e1fcb
ms.tgt_platform: multiple
keywords:
- ms-WMI-StringSetParam-Klasse AD Schema
- msWMI-StringSetParam-Klasse AD Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119753650"
---
# <a name="ms-wmi-stringsetparam-class"></a>ms-WMI-StringSetParam-Klasse

Parameterobjekt für Zeichenfolgensatz.
...
| Ldap-Anzeigename | msWMI-StringSetParam                 |
...
| [**ms-WMI-stringDefault**](a-mswmi-stringdefault.md)                       | Richtig      | **ms-WMI-StringSetParam**                                  |
| [**ms-WMI-stringValidValues**](a-mswmi-stringvalidvalues.md)               | Falsch     | **ms-WMI-StringSetParam**                                  |
