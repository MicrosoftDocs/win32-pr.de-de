...
---
# <a name="server-class"></a>Server-Klasse

Diese Klasse stellt einen Server Computer an einem-Standort dar.
...
| Aktualisierungshäufigkeit  | Jedes Mal, wenn ein Server in einer Site definiert oder entfernt wird. |
...
| Mögliche Vorgesetzten          | [**Server-Container**](c-serverscontainer.md)                                                |
| Zusätzlich           | \-                                                                                             |
| NT-Security-Descriptor      | o:Bag: schlecht: S:                                                                                   |
| Standard Sicherheits Beschreibung | D: (A; CI; rpwpcrccdclclorcwowdsddtsw;;;D a) (a;; Rpwpcrccdclclorcwowdsddtsw;;; SY) (A;; Rplclorc;;; Thaus |
...
| [**Server Referenz**](a-serverreference.md)                             | False     | **Server**                      |
...
| [**ms-DS-ist-User-cachable-at-RODC**](a-msds-isusercachableatrodc.md)          | False     | **Server**                      |
