---
title: Application-Site-Einstellungen-Klasse
description: Enthält alle standortspezifischen Einstellungen.
ms.assetid: 9431ec9c-7647-4de8-94c0-824763ceee97
ms.tgt_platform: multiple
keywords:
- Application-Site-Einstellungen AD Schema-Klasse
...
ms.locfileid: "119703910"
---
# <a name="application-site-settings-class"></a>Application-Site-Einstellungen-Klasse
...
| Eingabe | Wert |
|-------------------|------------------------------------------------------|
| CN                | Application-Site-Einstellungen                            |
| Ldap-Anzeigename | applicationSiteSettings                              |
| Aktualisieren von Berechtigungen  | Das System legt diesen Wert fest.                          |
| Updatehäufigkeit  | Jedes Mal, wenn dieses erweiterte Recht für eine neue Klasse gilt. |
...
| [**Anwendungsname**](a-applicationname.md)                             | False     | **Application-Site-Einstellungen**   |
...
| [**Benachrichtigungsliste**](a-notificationlist.md)                           | False     | **Application-Site-Einstellungen**   |
