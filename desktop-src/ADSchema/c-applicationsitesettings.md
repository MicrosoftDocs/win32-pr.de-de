...
---
# <a name="application-site-settings-class"></a>Application-Site-Settings-Klasse

Enthält alle Website spezifischen Einstellungen.



| Eingabe | Wert |
|-------------------|------------------------------------------------------|
| CN                | Anwendungs-Site-Settings                            |
| LDAP-Display-Name | applicationsitesettings                              |
| Berechtigung aktualisieren  | Dieser Wert wird vom System festgelegt.                          |
| Aktualisierungshäufigkeit  | Jedes Mal, wenn dieses erweiterte Recht auf eine neue Klasse angewendet wird. |
| Schema-ID-GUID    | 19195a5c-6da0-11D0-afd3-00c04f 930c9                 |
...
| [**Anwendungs Name**](a-applicationname.md)                             | False     | **Anwendungs-Site-Settings**   |
...
| [**Benachrichtigungsliste**](a-notificationlist.md)                           | False     | **Anwendungs-Site-Settings**   |
