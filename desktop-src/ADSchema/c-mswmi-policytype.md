...
description: Kommunizieren Sie das Schema für Richtlinienobjekte.
ms.assetid: cf89a4cb-cf42-4f80-b16e-8c958eafb5ae
ms.tgt_platform: multiple
keywords:
- ms-WMI-PolicyType-Klasse AD Schema
- msWMI-PolicyType-Klasse AD Schema
topic_type:
- apiref
api_name:
- ms-WMI-PolicyType
...
ms.locfileid: "118422211"
---
# <a name="ms-wmi-policytype-class"></a>ms-WMI-PolicyType-Klasse

Kommunizieren Sie das Schema für Richtlinienobjekte.
...
| Ldap-Anzeigename | msWMI-PolicyType                     |
...
| [**ms-WMI-Author**](a-mswmi-author.md)                                     | False     | **ms-WMI-PolicyType**           |
