---
title: ms-DS-Claim-Type-Property-Base-Klasse
description: Eine abstrakte Klasse, die die Basisklasse für Anspruchstyp- oder Ressourceneigenschaftsklassen definiert.
ms.assetid: 85ec891b-0fdd-4b65-bc4d-6d0d2ca4e85d
ms.tgt_platform: multiple
keywords:
- MS-DS-Claim-Type-Property-Base-Klasse AD-Schema
- msDS-ClaimTypePropertyBase-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "118422785"
---
# <a name="ms-ds-claim-type-property-base-class"></a>ms-DS-Claim-Type-Property-Base-Klasse

Eine abstrakte Klasse, die die Basisklasse für Anspruchstyp- oder Ressourceneigenschaftsklassen definiert.
...
| Ldap-Anzeigename | msDS-ClaimTypePropertyBase           |
...
| [**ms-DS-Claim-Possible-Values**](a-msds-claimpossiblevalues.md)                            | False     | **ms-DS-Claim-Type-Property-Base** |
| [**ms-DS-Claim-Shares-Possible-Values-With**](a-msds-claimsharespossiblevalueswith.md)      | False     | **ms-DS-Claim-Type-Property-Base** |
