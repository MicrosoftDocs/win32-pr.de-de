...
---
# <a name="ms-ds-claim-type-property-base-class"></a>ms-DS-Claim-Type-Property-Basisklasse

Eine abstrakte Klasse, die die Basisklasse für Anspruchstyp-oder Ressourcen Eigenschaften Klassen definiert.
...
| [**Aktiviert**](a-enabled.md)                                                                 | False     | **ms-DS-Claim-Type-Property-Base** |
...
| [**ms-DS-Claim-mögliche Werte**](a-msds-claimpossiblevalues.md)                            | False     | **ms-DS-Claim-Type-Property-Base** |
| [**ms-DS-Claim-Shares-mögliche-values-with**](a-msds-claimsharespossiblevalueswith.md)      | False     | **ms-DS-Claim-Type-Property-Base** |
