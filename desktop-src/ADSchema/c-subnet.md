---
title: Subnetzklasse
description: Stellt ein bestimmtes Subnetz im Netzwerk dar, an das Server und Arbeitsstationen angefügt sind.
ms.assetid: b40aad45-8794-4bed-a053-68cd0f3aace9
ms.tgt_platform: multiple
keywords:
- Subnetzklasse AD-Schema
- Subnetzklasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119548850"
---
# <a name="subnet-class"></a>Subnetzklasse

Stellt ein bestimmtes Subnetz im Netzwerk dar, an das Server und Arbeitsstationen angefügt sind.
...
| Mögliche Vorgesetzte          | [**Subnetzcontainer**](c-subnetcontainer.md)                                                |
| Zusätzlich           | \-                                                                                           |
...
| [**Location**](a-location.md)                                            | False     | **Subnetz**                      |
...
| [**Physical-Location-Object**](a-physicallocationobject.md)              | False     | **Subnetz**                      |
...
| [**Site-Object**](a-siteobject.md)                                       | False     | **Subnetz**                      |
...
| Rdn-Att-Id                  | [**Common-Name**](a-cn.md)<br/>                                                       |
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Übergeordnete          | [**Subnetzcontainer**](c-subnetcontainer.md)                                                |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
