---
title: ms-DNS-Server-Einstellungen-Klasse
description: Ein Container zum Speichern von DNS-Servereinstellungen.
ms.assetid: 65e8bd41-8873-493e-8b1b-960c2419aa96
ms.tgt_platform: multiple
keywords:
- ms-DNS-Server-Einstellungen AD Schema-Klasse
...
ms.locfileid: "119880610"
---
# <a name="ms-dns-server-settings-class"></a>ms-DNS-Server-Einstellungen-Klasse

Ein Container zum Speichern von DNS-Servereinstellungen.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | ms-DNS-Server-Einstellungen               |
| Ldap-Anzeigename | msDNS-ServerSettings                 |
...
| [**ms-DNS-Keymaster-Zones**](a-msdns-keymasterzones.md)                                     | Falsch     | **ms-DNS-Server-Einstellungen**      |
