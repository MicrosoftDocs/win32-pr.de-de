...
---
# <a name="ms-dns-server-settings-class"></a>MS-DNS-Server-Settings-Klasse

Ein Container zum Speichern der DNS-Servereinstellungen.
...
| [**MS-DNS-keymasterzonen**](a-msdns-keymasterzones.md)                                     | False     | **MS-DNS-Server-Settings**      |
