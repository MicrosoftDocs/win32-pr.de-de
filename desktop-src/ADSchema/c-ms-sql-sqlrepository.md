...
---
# <a name="ms-sql-sqlrepository-class"></a>MS-SQL-sqlrepository-Klasse

Klasse zum Speichern von SQL Server-Repository-Eigenschaften.
...
| Schema-ID-GUID    | 11d43c5c-ccef-11d2-9993-0000f 87a57d4 |
...
| [**MS-SQL-Build**](a-ms-sql-build.md)                                    | False     | **MS-SQL-sqlrepository**        |
| [**MS-SQL-Contact**](a-ms-sql-contact.md)                                | False     | **MS-SQL-sqlrepository**        |
| [**MS-SQL-Description**](a-ms-sql-description.md)                        | False     | **MS-SQL-sqlrepository**        |
| [**MS-SQL-informationdirectory**](a-ms-sql-informationdirectory.md)      | False     | **MS-SQL-sqlrepository**        |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                      | False     | **MS-SQL-sqlrepository**        |
| [**MS-SQL-Status**](a-ms-sql-status.md)                                  | False     | **MS-SQL-sqlrepository**        |
| [**MS-SQL-Version**](a-ms-sql-version.md)                                | False     | **MS-SQL-sqlrepository**        |
