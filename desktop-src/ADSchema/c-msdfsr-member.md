...
---
# <a name="ms-dfsr-member-class"></a>MS-DFSR-Member-Klasse

Stellt ein Replikations Gruppenmitglied dar.
...
| Schema-ID-GUID    | 4229c897-C211-437c-a5ae-DBF 705b696e5 |
...
| Mögliche Vorgesetzten          | [**MS-DFSR-Topologie**](c-msdfsr-topology.md)                                                                                    |
| Zusätzlich           | \-                                                                                                                               |
...
| [**MS-DFSR-computerreference**](a-msdfsr-computerreference.md)             | Richtig      | **MS-DFSR-Member**              |
| [**MS-DFSR-computerreferencebl**](a-msdfsr-computerreferencebl.md)         | False     | [**Nach oben**](c-top.md)<br/> |
| [**MS-DFSR-Erweiterung**](a-msdfsr-extension.md)                             | False     | **MS-DFSR-Member**              |
| [**MS-DFSR-Flags**](a-msdfsr-flags.md)                                     | False     | **MS-DFSR-Member**              |
| [**MS-DFSR-Schlüsselwörter**](a-msdfsr-keywords.md)                               | False     | **MS-DFSR-Member**              |
| [**MS-DFSR-mitgliedreferencebl**](a-msdfsr-memberreferencebl.md)             | False     | [**Nach oben**](c-top.md)<br/> |
| [**MS-DFSR-Optionen**](a-msdfsr-options.md)                                 | False     | **MS-DFSR-Member**              |
...
| [**Server Referenz**](a-serverreference.md)                               | False     | **MS-DFSR-Member**              |
...
Die **MS-DFSR-Member-** Klasse ist Teil der Unterstützung für den verteiltes Dateisystem (DFS)-Replikations Dienst.
