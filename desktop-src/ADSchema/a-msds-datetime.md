...
keywords:
- MS-DS-Date-Time-Attribut AD-Schema
- MSDS-DateTime-Attribut AD-Schema
topic_type:
- apiref
api_name:
- ms-DS-Date-Time
...
ms.locfileid: "118426707"
---
# <a name="ms-ds-date-time-attribute"></a>ms-DS-Date-Time-Attribut

Ein Attribut zum Speichern eines Datums- und Uhrzeitwerts.
...
|-------------------|---------------------------------------------------------------|
| CN                | ms-DS-Date-Time                                               |
| Ldap-Anzeigename | msDS-DateTime                                                 |
| Size              | \-                                                            |
...
| In verwendete Klassen        | [**ms-DS-App-Configuration**](c-msds-app-configuration.md)<br/> [**ms-DS-App-Data**](c-msds-appdata.md)<br/> |
