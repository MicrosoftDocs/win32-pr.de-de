...
---
# <a name="msmq-sign-key-attribute"></a>MSMQ-Sign-Key-Attribut

Der öffentliche Signatur Schlüssel des Computers.



| Eingabe | Wert |
|-------------------|-------------------------------------------------------|
| CN                | MSMQ-Signierschlüssel                                         |
| LDAP-Display-Name | msmqsignkey                                           |
| Size              | \-                                                    |
