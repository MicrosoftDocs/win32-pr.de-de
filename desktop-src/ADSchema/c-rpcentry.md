...
Eine abstrakte Klasse, deren Unterklassen vom RPC-Namen Dienst (RPC Name Service, NS) verwendet werden. der Zugriff erfolgt über die RpcNs- \* Funktionen in der Win32-API.
