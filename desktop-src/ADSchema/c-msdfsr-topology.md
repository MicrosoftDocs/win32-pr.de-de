...
---
# <a name="ms-dfsr-topology-class"></a>MS-DFSR-topologieklasse

Enthält die-Objekte, die die Replikations Topologie bilden.
...
| [**MS-DFSR-Erweiterung**](a-msdfsr-extension.md)                             | False     | **MS-DFSR-Topologie**            |
...
| [**MS-DFSR-Optionen**](a-msdfsr-options.md)                                 | False     | **MS-DFSR-Topologie**            |
...
| [**MS-DFSR-mitgliedreferencebl**](a-msdfsr-memberreferencebl.md)                | False     | [**Nach oben**](c-top.md)<br/> |
| [**MS-DFSR-Optionen**](a-msdfsr-options.md)                                    | False     | **MS-DFSR-Topologie**            |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | False     | **MS-DFSR-Topologie**            |
| [**ms-DS-ca-immed-untergeordnete Elemente**](a-msds-approx-immed-subordinates.md)    | False     | [**Nach oben**](c-top.md)<br/> |
...
Die **MS-DFSR-Topology-** Klasse ist Teil der Unterstützung für den verteiltes Dateisystem (DFS)-Replikations Dienst.
