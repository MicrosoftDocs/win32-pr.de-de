...
description: Wird verwendet, um das Zertifikat des Schlüsselwiederherstellungs-Agents im CONTAINER FÜR die Schlüsselwiederherstellung zu veröffentlichen.
ms.assetid: b414a312-1613-4fe4-afda-896dff6cbfdb
ms.tgt_platform: multiple
keywords:
- ms-PKI-Private-Key-Recovery-Agent-Klasse AD Schema
- msPKI-PrivateKeyRecoveryAgent-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879800"
---
# <a name="ms-pki-private-key-recovery-agent-class"></a>ms-PKI-Private-Key-Recovery-Agent-Klasse

Wird verwendet, um das Zertifikat des Schlüsselwiederherstellungs-Agents im CONTAINER FÜR die Schlüsselwiederherstellung zu veröffentlichen.
...
| Ldap-Anzeigename | msPKI-PrivateKeyRecoveryAgent        |
...
| [**X509-Cert**](a-usercertificate.md)                                      | Richtig      | **ms-PKI-Private-Key-Recovery-Agent** |
