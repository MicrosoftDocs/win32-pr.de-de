...
---
# <a name="ms-kds-prov-serverconfiguration-class"></a>MS-KDS-Prov-serverconfiguration-Klasse

Konfiguration für den Gruppenschlüssel Verteilungsdienst.
...
| [**MS-KDS-PrivateKey-Länge**](a-mskds-privatekeylength.md)                                 | False     | **MS-KDS-Prov-serverconfiguration** |
| [**MS-KDS-PublicKey-Länge**](a-mskds-publickeylength.md)                                   | False     | **MS-KDS-Prov-serverconfiguration** |
...
| [**MS-KDS-Version**](a-mskds-version.md)                                                    | Richtig      | **MS-KDS-Prov-serverconfiguration** |
