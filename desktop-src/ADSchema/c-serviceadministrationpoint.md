---
title: Service-Administration-Point-Klasse
description: Enthält Bindungsinformationen zum Herstellen einer Verbindung mit einem Dienst, um ihn zu verwalten.
ms.assetid: 7a96881c-a223-4d9c-a0db-5d771f96d362
ms.tgt_platform: multiple
keywords:
- AD-Schema der Service-Administration-Point-Klasse
...
ms.locfileid: "119548980"
---
# <a name="service-administration-point-class"></a>Service-Administration-Point-Klasse

Enthält Bindungsinformationen zum Herstellen einer Verbindung mit einem Dienst, um ihn zu verwalten.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | Dienstverwaltungspunkt         |
| Ldap-Anzeigename | serviceAdministrationPoint           |
