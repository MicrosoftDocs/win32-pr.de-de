...
---
# <a name="service-administration-point-class"></a>Dienst-Verwaltungspunkt Klasse

Enthält Bindungs Informationen für das Herstellen einer Verbindung mit einem Dienst, um ihn zu verwalten.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | Dienst-Verwaltungspunkt         |
