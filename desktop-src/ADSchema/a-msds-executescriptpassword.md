...
description: Wird während der Umbenennung der Domäne verwendet. Dieser Wert kann nicht mitHILFE von LDAP in ldap geschrieben oder daraus gelesen werden.
ms.assetid: 381c3676-0a11-4e53-8093-f04dbf156250
ms.tgt_platform: multiple
keywords:
- MS-DS-ExecuteScriptPassword-Attribut AD-Schema
- MSDS-ExecuteScriptPassword-Attribut AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "118426753"
---
# <a name="ms-ds-executescriptpassword-attribute"></a>ms-DS-ExecuteScriptPassword-Attribut

Wird während der Umbenennung der Domäne verwendet. Dieser Wert kann nicht mitHILFE von LDAP in ldap geschrieben oder daraus gelesen werden.
...
| Ldap-Anzeigename | msDS-ExecuteScriptPassword                            |
| Size              | \-                                                    |
