---
title: ms-Takthz-Central-Access-Rule-Klasse
...
---
# <a name="ms-authz-central-access-rule-class"></a>ms-Takthz-Central-Access-Rule-Klasse
...
| Mögliche Vorgesetzte          | [**ms-Authz-Central-Access-Rules**](c-msauthz-centralaccessrules.md)                        |
| Zusätzlich           | \-                                                                                           |
...
| [**Aktiviert**](a-enabled.md)                                                                 | Falsch     | **ms-Authz-Central-Access-Rule** |
...
| [**ms-Takthz-Effective-Security-Policy**](a-msauthz-effectivesecuritypolicy.md)              | Falsch     | **ms-Authz-Central-Access-Rule** |
| [**ms-Hz-Last-Effective-Security-Policy**](a-msauthz-lasteffectivesecuritypolicy.md)     | Falsch     | **ms-Authz-Central-Access-Rule** |
| [**ms-Authz-Proposed-Security-Policy**](a-msauthz-proposedsecuritypolicy.md)                | Falsch     | **ms-Authz-Central-Access-Rule** |
| [**ms-Hz-Resource-Condition**](a-msauthz-resourcecondition.md)                           | Falsch     | **ms-Authz-Central-Access-Rule** |
