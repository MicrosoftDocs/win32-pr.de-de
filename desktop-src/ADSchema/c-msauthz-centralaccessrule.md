...
---
# <a name="ms-authz-central-access-rule-class"></a>MS-Authz-Central-Access-Rule-Klasse

Eine Klasse, die zentrale Zugriffsregeln definiert, mit denen eine zentrale Zugriffs Richtlinie erstellt wird.
...
| Mögliche Vorgesetzten          | [**MS-Authz-Central-Access-Rules**](c-msauthz-centralaccessrules.md)                        |
| Zusätzlich           | \-                                                                                           |
...
| [**MS-Authz-vorgeschlagene-Security-Policy**](a-msauthz-proposedsecuritypolicy.md)                | False     | **MS-Authz-Central-Access-Rule** |
