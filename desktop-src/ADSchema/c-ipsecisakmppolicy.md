...
description: Die Ipsec-ISAKMP-Policy-Klasse ist nur zur internen Verwendung.
ms.assetid: a40b4289-01c9-489d-a755-725978d6dfc2
ms.tgt_platform: multiple
keywords:
- AD-Schema der Ipsec-ISAKMP-Policy-Klasse
- IPSECISAKMPPolicy-Klasse AD-Schema
topic_type:
- apiref
api_name:
- Ipsec-ISAKMP-Policy
...
ms.locfileid: "119324230"
---
# <a name="ipsec-isakmp-policy-class"></a>Ipsec-ISAKMP-Policy-Klasse

Die **Ipsec-ISAKMP-Policy-Klasse** ist nur zur internen Verwendung.
...
| Ldap-Anzeigename | ipsecISAKMPPolicy                    |
