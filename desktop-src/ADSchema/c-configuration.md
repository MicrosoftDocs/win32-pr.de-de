---
title: Konfigurationsklasse
description: Dies ist ein Container, der die Konfigurationsinformationen für eine Domäne enthält.
ms.assetid: d18967e1-64f2-4d7b-b521-60145e7bc4c0
ms.tgt_platform: multiple
keywords:
- AD-Schema der Konfigurationsklasse
...
ms.locfileid: "119701930"
---
# <a name="configuration-class"></a>Konfigurationsklasse

Dies ist ein Container, der die Konfigurationsinformationen für eine Domäne enthält.
...
|-------------------|------------------------------------------------|
| CN                | Konfiguration                                  |
| Ldap-Anzeigename | Konfiguration                                  |
...
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
...
| [**Common-Name**](a-cn.md)                                               | True      | **Konfiguration** [ **oben**](c-top.md)<br/> |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | False     | [**Nach oben**](c-top.md)<br/>                   |
| [**Kanonischer Name**](a-canonicalname.md)                                   | False     | [**Nach oben**](c-top.md)<br/>                   |
| [**Allgemeiner Name**](a-cn.md)                                                 | True      | **Configuration** [ **Top**](c-top.md)<br/> |
