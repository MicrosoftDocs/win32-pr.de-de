...
description: Beschreibt einen Satz von -Objekten, die von einer Anwendung verwaltet werden.
ms.assetid: 475657d9-7d11-436f-8c0a-42a7bd26c747
ms.tgt_platform: multiple
keywords:
- MS-DS-Az-Scope-Klasse AD-Schema
- 'MSDS-AzScope-Klasse: AD-Schema'
topic_type:
- apiref
api_name:
- ms-DS-Az-Scope
...
ms.locfileid: "119880330"
---
# <a name="ms-ds-az-scope-class"></a>ms-DS-Az-Scope-Klasse

Beschreibt einen Satz von -Objekten, die von einer Anwendung verwaltet werden.
...
| Mögliche Übergeordnete          | [**ms-DS-Az-Application**](c-msds-azapplication.md)                                                                             |
| Zusätzlich           | \-                                                                                                                               |
...
| [**Beschreibung**](a-description.md)                                        | Falsch     | **ms-DS-Az-Scope** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-Az-Application-Data**](a-msds-azapplicationdata.md)               | Falsch     | **ms-DS-Az-Scope**                                 |
| [**ms-DS-Az-Scope-Name**](a-msds-azscopename.md)                           | Richtig      | **ms-DS-Az-Scope**                                 |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                                                                  |
| Mögliche Vorgesetzte          | [**ms-DS-Az-Application**](c-msds-azapplication.md)                                                                             |
| Zusätzlich           | \-                                                                                                                               |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                                                     |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; CO) |
| System-Flags                | 0x00000010                                                                                                                       |
...
| [**ms-DS-Az-Application-Data**](a-msds-azapplicationdata.md)                  | Falsch     | **ms-DS-Az-Scope**                                 |
| [**ms-DS-Az-Generic-Data**](a-msds-azgenericdata.md)                          | Falsch     | **ms-DS-Az-Scope**                                 |
| [**ms-DS-Az-Object-Guid**](a-msds-azobjectguid.md)                            | Falsch     | **ms-DS-Az-Scope**                                 |
| [**ms-DS-Az-Scope-Name**](a-msds-azscopename.md)                              | Richtig      | **ms-DS-Az-Scope**                                 |
| [**MS-DS-Consistency-Child-Count**](a-ms-ds-consistencychildcount.md)         | Falsch     | [**Nach oben**](c-top.md)<br/>                    |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | Falsch     | [**Nach oben**](c-top.md)<br/>                    |
