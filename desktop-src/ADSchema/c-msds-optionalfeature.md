---
title: ms-DS-Optional-Feature-Klasse
description: Konfiguration für ein optionales DS-Feature.
ms.assetid: 236ff60d-84a2-4c71-9759-1863e24b2a98
ms.tgt_platform: multiple
keywords:
- MS-DS-Optional-Feature-Klasse AD-Schema
- msDS-OptionalFeature-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879980"
---
# <a name="ms-ds-optional-feature-class"></a>ms-DS-Optional-Feature-Klasse

Konfiguration für ein optionales DS-Feature.
...
| Ldap-Anzeigename | msDS-OptionalFeature                 |
...
| Standardsicherheitsdeskriptor | D:(A;; RPLCLORC;;; AU)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; EA)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; CO)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; SY) |
...
| [**ms-DS-Optional-Feature-Flags**](a-msds-optionalfeatureflags.md)                    | Richtig      | **ms-DS-Optional-Feature**      |
| [**ms-DS-Optional-Feature-GUID**](a-msds-optionalfeatureguid.md)                      | Richtig      | **ms-DS-Optional-Feature**      |
...
| [**ms-DS-Required-Domain-Behavior-Version**](a-msds-requireddomainbehaviorversion.md) | Falsch     | **ms-DS-Optional-Feature**      |
| [**ms-DS-Required-Forest-Behavior-Version**](a-msds-requiredforestbehaviorversion.md) | Falsch     | **ms-DS-Optional-Feature**      |
