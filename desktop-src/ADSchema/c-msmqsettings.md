...
---
# <a name="msmq-settings-class"></a>MSMQ-Settings-Klasse

Der Zweck dieser Objekte besteht darin, eine schnelle Abfrage von MSMQ-Servern an einem bestimmten Standort zu aktivieren. Dieses Objekt enthält Informationen wie Message Queuing Dienste, die der Server bereitstellt.
...
| Aktualisierungshäufigkeit  | Dieses Objekt wird für jeden Message Queuing Server erstellt, der auf einem Windows 2000-Domänen Controller und für jeden Message Queuing Server mit Routing Diensten installiert ist. |
...
| Mögliche Vorgesetzten          | [**Servers**](c-server.md)                                                                   |
| Zusätzlich           | \-                                                                                           |
...
| [**MSMQ-abhängige-Client-Service**](a-msmqdependentclientservice.md)     | False     | **MSMQ-Einstellungen**               |
| [**MSMQ-DS-Service**](a-msmqdsservice.md)                                | False     | **MSMQ-Einstellungen**               |
| [**MSMQ-migriert**](a-msmqmigrated.md)                                   | False     | **MSMQ-Einstellungen**               |
| [**MSMQ-NT4-Flags**](a-msmqnt4flags.md)                                  | False     | **MSMQ-Einstellungen**               |
| [**MSMQ-Besitzer-ID**](a-msmqownerid.md)                                    | False     | **MSMQ-Einstellungen**               |
| [**MSMQ-sqm-ID**](a-msmqqmid.md)                                          | False     | **MSMQ-Einstellungen**               |
| [**MSMQ-Routing-Service**](a-msmqroutingservice.md)                      | False     | **MSMQ-Einstellungen**               |
| [**MSMQ-Dienste**](a-msmqservices.md)                                   | False     | **MSMQ-Einstellungen**               |
| [**MSMQ-Site-Name**](a-msmqsitename.md)                                  | False     | **MSMQ-Einstellungen**               |
| [**MSMQ-Site-Name-Ex**](a-msmqsitenameex.md)                             | False     | **MSMQ-Einstellungen**               |
