...
---
# <a name="msmq-custom-recipient-class"></a>MSMQ-Custom-Recipient-Klasse

Wird verwendet, um einen benutzerdefinierten MSMQ-Empfänger (auch als Alias Warteschlange bezeichnet) zu definieren. Definiert einen Alias für eine Warteschlange außerhalb des Unternehmens. Enthält den Format Namen der Warteschlange.
...
| [**MSMQ-Recipient-Format Name**](a-msmq-recipient-formatname.md)            | False     | **MSMQ-Custom-Recipient**       |
