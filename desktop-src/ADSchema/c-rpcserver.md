...
description: Stellt einen bestimmten Server dar, der eine oder mehrere RPC-Schnittstellen enthält.
ms.assetid: 39ab92ac-285f-4696-a41d-1278c9b17b52
ms.tgt_platform: multiple
keywords:
- RPC-Server-Klasse AD-Schema
...
ms.locfileid: "120077720"
---
# <a name="rpc-server-class"></a>rpc-Server-Klasse

Stellt einen bestimmten Server dar, der eine oder mehrere RPC-Schnittstellen enthält.
...
| [**rpc-Ns-Codeset**](a-rpcnscodeset.md)                                  | Falsch     | **rpc-Server**                                                                           |
| [**rpc-Ns-Entry-Flags**](a-rpcnsentryflags.md)                           | Falsch     | **rpc-Server**                                                                           |
| [**rpc-Ns-Object-ID**](a-rpcnsobjectid.md)                               | Falsch     | **rpc-Server**                                                                           |
