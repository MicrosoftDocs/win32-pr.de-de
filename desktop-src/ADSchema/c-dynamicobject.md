...
Diese Klasse gibt, wenn Sie in einem Eintrag vorhanden ist, an, dass dieser Eintrag eine begrenzte Lebensdauer hat und automatisch verschwinden kann, wenn die Gültigkeitsdauer 0 (null) erreicht hat. Wenn der Client keinen Wert für das entryttl-Attribut angegeben hat, stellt der Server einen Wert bereit.
...
| Schema-ID-GUID    | 66d51249-3355-4c1b24e-81s252aca23b |
...
| [**ms-DS-Entry-Time-to-be**](a-msds-entry-time-to-die.md)                 | False     | **Dynamic-Object**              |
