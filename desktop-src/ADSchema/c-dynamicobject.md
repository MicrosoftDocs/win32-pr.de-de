...
description: Wenn diese Klasse in einem Eintrag vorhanden ist, gibt sie an, dass dieser Eintrag eine begrenzte Lebensdauer hat und automatisch verschwindet, wenn die Gültigkeitsdauer 0 (0) erreicht hat. Wenn der Client keinen Wert für das entryTtl-Attribut angegeben hat, stellt der Server einen Wert zur Verfügung.
ms.assetid: 80f3597e-14ef-4427-b3e3-09128d07f331
ms.tgt_platform: multiple
keywords:
- Dynamic-Object AD-Schema der Klasse
...
ms.locfileid: "119922810"
---
# <a name="dynamic-object-class"></a>Dynamic-Object-Klasse

Wenn diese Klasse in einem Eintrag vorhanden ist, gibt sie an, dass dieser Eintrag eine begrenzte Lebensdauer hat und automatisch verschwindet, wenn die Gültigkeitsdauer 0 (0) erreicht hat. Wenn der Client keinen Wert für das entryTtl-Attribut angegeben hat, stellt der Server einen Wert zur Verfügung.
...
|-------------------|--------------------------------------|
| CN                | Dynamic-Object                       |
| Ldap-Anzeigename | Dynamicobject                        |
...
| [**Entry-TTL**](a-entryttl.md)                                             | False     | **Dynamic-Object**              |
...
| [**ms-DS-Entry-Time-To-Die**](a-msds-entry-time-to-die.md)                 | False     | **Dynamic-Object**              |
