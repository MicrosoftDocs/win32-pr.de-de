...
description: Verfolgt den Link für verschobene Objekte nach.
ms.assetid: d2b27f10-1e94-4385-a86d-6153e0eeabf6
ms.tgt_platform: multiple
keywords:
- Ad-Schema der Link-Track-OMT-Entry-Klasse
...
Verfolgt den Link für verschobene Objekte nach.
...
| Updatehäufigkeit  | Immer dann, wenn sich ein Link zu einer Datei ändert.   |
...
| Mögliche Übergeordnete          | [**Link-Track-Object-Move-Table**](c-linktrackobjectmovetable.md)                           |
| Zusätzlich           | \-                                                                                           |
...
| [**Allowed-Child-Classes**](a-allowedchildclasses.md)                      | False     | [**Nach oben**](c-top.md)<br/> |
| [**Allowed-Child-Classes-Effective**](a-allowedchildclasseseffective.md)   | False     | [**Nach oben**](c-top.md)<br/> |
| [**Geburtsdatum**](a-birthlocation.md)                                   | False     | **Link-Track-OMT-Entry**        |
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | False     | [**Nach oben**](c-top.md)<br/> |
| [**Kanonischer Name**](a-canonicalname.md)                                   | False     | [**Nach oben**](c-top.md)<br/> |
