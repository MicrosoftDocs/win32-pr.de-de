...
---
# <a name="domain-policy-class"></a>Domain-Policy-Klasse

Definiert die Richtlinie für die lokale Sicherheits Autorität für eine oder mehrere Domänen.
...
| Mögliche Vorgesetzten          | [**Container**](c-container.md)[**Domäne: DNS**](c-domaindns.md)-[**Organisationseinheit**](c-organizationalunit.md) |
| Zusätzlich           | \-                                                                                                                   |
...
| [**Authentifizierungs Optionen**](a-authenticationoptions.md)                 | False     | **Domänen Richtlinie**               |
...
| [**Default-Local-Policy-Object**](a-defaultlocalpolicyobject.md)         | False     | **Domänen Richtlinie**               |
...
| [**Domänen Zertifizierungsstellen**](a-domaincas.md)                     | False     | **Domänen Richtlinie**               |
| [**Domänen Richtlinien Referenz**](a-domainpolicyreference.md)                | False     | **Domänen Richtlinie**               |
| [**Domänen weite Richtlinie**](a-domainwidepolicy.md)                          | False     | **Domänen Richtlinie**               |
...
| [**Efspolicy**](a-efspolicy.md)                                          | False     | **Domänen Richtlinie**               |
| [**Erweiterungs Name**](a-extensionname.md)                                 | False     | [**Nach oben**](c-top.md)<br/> |
| [**Fahren**](a-flags.md)                                                  | False     | [**Nach oben**](c-top.md)<br/> |
| [**Erzwingen der Abmeldung**](a-forcelogoff.md)                                     | False     | **Domänen Richtlinie**               |
...
| [**IPSec-Richtlinien Verweis**](a-ipsecpolicyreference.md)                  | False     | **Domänen Richtlinie**               |
...
| [**Sperr Dauer**](a-lockoutduration.md)                             | False     | **Domänen Richtlinie**               |
| [**Sperr-out-Observation-Fenster**](a-lockoutobservationwindow.md)         | False     | **Domänen Richtlinie**               |
| [**Sperrungs Schwellenwert**](a-lockoutthreshold.md)                           | False     | **Domänen Richtlinie**               |
| [**Verwaltet von**](a-managedby.md)                                         | False     | **Domänen Richtlinie**               |
...
| [**Max-pwd-Age**](a-maxpwdage.md)                                        | False     | **Domänen Richtlinie**               |
| [**Max-Renew-Alter**](a-maxrenewage.md)                                    | False     | **Domänen Richtlinie**               |
| [**Max-Ticket-Age**](a-maxticketage.md)                                  | False     | **Domänen Richtlinie**               |
| [**Min-pwd-Age**](a-minpwdage.md)                                        | False     | **Domänen Richtlinie**               |
| [**Min-pwd-Länge**](a-minpwdlength.md)                                  | False     | **Domänen Richtlinie**               |
| [**Min. Ticket-Alter**](a-minticketage.md)                                  | False     | **Domänen Richtlinie**               |
...
| [**Proxy-Lebensdauer**](a-proxylifetime.md)                                 | False     | **Domänen Richtlinie**               |
| [**Public-Key-Policy**](a-publickeypolicy.md)                            | False     | **Domänen Richtlinie**               |
| [**PWD-Verlauf-Länge**](a-pwdhistorylength.md)                          | False     | **Domänen Richtlinie**               |
| [**PWD-Eigenschaften**](a-pwdproperties.md)                                 | False     | **Domänen Richtlinie**               |
| [**Quality of Service**](a-qualityofservice.md)                          | False     | **Domänen Richtlinie**               |
