...
|-------------------|--------------------------------------|
| CN                | Unter Schema                            |
| LDAP-Display-Name | unter Schema                            |
...
| [**Attributtypen**](a-attributetypes.md)                               | False     | **Unter Schema**                                 |
...
| [**DIT-Content-Rules**](a-ditcontentrules.md)                            | False     | **Unter Schema**                                 |
...
| [**Extended-Attribute-Info**](a-extendedattributeinfo.md)                | False     | **Unter Schema**                                 |
| [**Extended-Class-Info**](a-extendedclassinfo.md)                        | False     | **Unter Schema**                                 |
...
| [**Modify-Zeitstempel**](a-modifytimestamp.md)                            | False     | **Unter Schema** [ **oben**](c-top.md)<br/> |
...
| [**Objekt-Klassen**](a-objectclasses.md)                                 | False     | **Unter Schema**                                 |
