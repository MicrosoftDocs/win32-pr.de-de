...
Dictionary-Objekt für die Übersetzung Hersteller spezifischer Routing Attribute in Namen.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | RRAS-Administration: Wörterbuch       |
...
| [**MS-RRAS-Vendor-Attribute-Entry**](a-msrrasvendorattributeentry.md)    | False     | **RRAS-Administration: Wörterbuch** |
