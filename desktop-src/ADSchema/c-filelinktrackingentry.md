---
title: File-Link-Tracking-Entry-Klasse
description: Enthält die GUID und die aktuellen Computerinformationen für eine datei mit Linkverfolgung.
ms.assetid: ab537bf4-0cf7-455a-8c87-ce365af77f3d
ms.tgt_platform: multiple
keywords:
- File-Link-Tracking-Entry-Klasse AD Schema
- fileLinkTrackingEntry-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119703760"
---
# <a name="file-link-tracking-entry-class"></a>File-Link-Tracking-Entry-Klasse

Enthält die GUID und die aktuellen Computerinformationen für eine datei mit Linkverfolgung.
...
| Ldap-Anzeigename | fileLinkTrackingEntry                |
...
| Mögliche Vorgesetzte          | [**Dateiverknüpfungsnachverfolgung**](c-filelinktracking.md)                                             |
| Zusätzlich           | \-                                                                                           |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Übergeordnete          | [**Dateiverknüpfungsnachverfolgung**](c-filelinktracking.md)                                             |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
