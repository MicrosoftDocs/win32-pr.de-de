...
---
# <a name="file-link-tracking-entry-class"></a>Datei-Link-Tracking-Entry-Klasse

Enthält die GUID und die aktuellen Computer Informationen für eine mit einem Link überwachte Datei.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | Datei-Link-Nachverfolgung-Eintrag             |
| LDAP-Display-Name | filelinktrackingentry                |
| Berechtigung aktualisieren  | \-                                   |
| Aktualisierungshäufigkeit  | \-                                   |
| Schema-ID-GUID    | 8e4eb2ed-4712-11D0-a1a0-00c04ld930c9 |
