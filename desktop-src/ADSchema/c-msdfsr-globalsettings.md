...
Enthält die globalen Einstellungen, die für alle Replikations Gruppenmitglieder gelten.
...
| Schema-ID-GUID    | 7b35dbad-b3ec-486a-aad4-2fec9d6ea6f |
...
| [**MS-DFSR-Erweiterung**](a-msdfsr-extension.md)                             | False     | **MS-DFSR-globalsettings**      |
...
| [**MS-DFSR-Optionen**](a-msdfsr-options.md)                                 | False     | **MS-DFSR-globalsettings**      |
...
Die **MS-DFSR-globalsettings-** Klasse ist Teil der Unterstützung für den verteiltes Dateisystem (DFS)-Replikations Dienst.
