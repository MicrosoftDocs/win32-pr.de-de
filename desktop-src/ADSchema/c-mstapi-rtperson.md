...
Wird verwendet, um einen Benutzer der IP-Adresse des Computers zuzuordnen, bei dem der Benutzer angemeldet ist, um von TAPI-Multicast Konferenzen verwendet zu werden.
...
| Aktualisierungshäufigkeit  | Wenn ein TAPI-Client gestartet wird, nachdem er sich beim TAPI-Verzeichnis registriert hat. |
...
| Mögliche Vorgesetzten          | Organisation ( [**Organisationseinheit**](c-organizationalunit.md)[ )](c-organization.md)    |
| Zusätzlich           | \-                                                                                           |
...
| [**MS-TAPI-IP-Adresse**](a-mstapi-ipaddress.md)                            | False     | **MS-TAPI-RT-Person**           |
| [**MS-TAPI-Unique-Identifier**](a-mstapi-uid.md)                           | False     | **MS-TAPI-RT-Person**           |
