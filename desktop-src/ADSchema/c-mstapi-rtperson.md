...
description: Wird verwendet, um einen Benutzer der IP-Adresse des Computers zuzuordnen, bei dem der Benutzer zur Verwendung durch TAPI-Multicastkonferenzen angemeldet ist.
ms.assetid: 3866eb11-8719-40b6-b73c-314009db2553
ms.tgt_platform: multiple
keywords:
- MS-TAPI-Rt-Person-Klasse AD-Schema
- MSTAPI-RtPerson-Klasse AD-Schema
topic_type:
- apiref
api_name:
- ms-TAPI-Rt-Person
...
ms.locfileid: "119879380"
---
# <a name="ms-tapi-rt-person-class"></a>ms-TAPI-Rt-Person-Klasse

Wird verwendet, um einen Benutzer der IP-Adresse des Computers zuzuordnen, bei dem der Benutzer zur Verwendung durch TAPI-Multicastkonferenzen angemeldet ist.
...
| Ldap-Anzeigename | msTAPI-RtPerson                                                                   |
| Aktualisieren von Berechtigungen  | Es sind keine besonderen Berechtigungen erforderlich.                                                   |
| Updatehäufigkeit  | Jedes Mal, wenn ein TAPI-Client gestartet wird, nachdem er sich beim TAPI-Verzeichnis registriert hat. |
...
| Mögliche Übergeordnete          | [](c-organizationalunit.md)[**Organisationseinheitsorganisation**](c-organization.md)    |
| Zusätzlich           | \-                                                                                           |
...
| [**ms-TAPI-Ip-Address**](a-mstapi-ipaddress.md)                            | Falsch     | **ms-TAPI-Rt-Person**           |
| [**ms-TAPI-Unique-Identifier**](a-mstapi-uid.md)                           | Falsch     | **ms-TAPI-Rt-Person**           |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Vorgesetzte          | [**Organisation (Organisationseinheit)**](c-organizationalunit.md)[](c-organization.md)    |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
