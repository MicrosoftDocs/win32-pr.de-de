...
keywords:
- RPC-Server-Element-Klasse AD-Schema
...
ms.locfileid: "120005370"
---
# <a name="rpc-server-element-class"></a>rpc-Server-Element-Klasse

Stellt eine einzelne Schnittstelle in einem angegebenen RPC-Server dar.
...
| Ldap-Anzeigename | rpcServerElement                     |
...
| Mögliche Vorgesetzte          | [**rpc-Server**](c-rpcserver.md)                                                            |
| Zusätzlich           | \-                                                                                           |
...
| [**rpc-Ns-Bindings**](a-rpcnsbindings.md)                                | Richtig      | **rpc-Server-Element**                                                                   |
| [**rpc-Ns-Interface-ID**](a-rpcnsinterfaceid.md)                         | Richtig      | **rpc-Server-Element**                                                                   |
| [**rpc-Ns-Transfer-Syntax**](a-rpcnstransfersyntax.md)                   | Richtig      | **rpc-Server-Element**                                                                   |
...
| Unterklasse von                 | [**rpc-Entry**](c-rpcentry.md)<br/>                                                   |
| Mögliche Übergeordnete          | [**rpc-Server**](c-rpcserver.md)                                                            |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
