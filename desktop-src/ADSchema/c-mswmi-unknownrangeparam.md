...
description: Unterstützt Parametertypen, über die wir nichts wissen, sodass sie als kompilierte WMI-Objekte übertragen werden.
ms.assetid: a513da7c-8169-4f78-b5ef-a035076faa86
ms.tgt_platform: multiple
keywords:
- MS-WMI-UnknownRangeParam-Klasse AD Schema
- MSWMI-UnknownRangeParam-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119753616"
---
# <a name="ms-wmi-unknownrangeparam-class"></a>ms-WMI-UnknownRangeParam-Klasse

Unterstützt Parametertypen, über die wir nichts wissen, sodass sie als kompilierte WMI-Objekte übertragen werden.
...
| Ldap-Anzeigename | msWMI-UnknownRangeParam              |
...
| Unterklasse von                 | [**ms-WMI-RangeParam**](c-mswmi-rangeparam.md)<br/>                                   |
| Mögliche Übergeordnete          | [**ms-WMI-MergeablePolicyTemplate**](c-mswmi-mergeablepolicytemplate.md)                    |
| Zusätzlich           | \-                                                                                           |
...
| [**ms-WMI-NormalizedClass**](a-mswmi-normalizedclass.md)                   | Richtig      | **ms-WMI-UnknownRangeParam**                               |
| [**ms-WMI-PropertyName**](a-mswmi-propertyname.md)                         | Richtig      | [**ms-WMI-RangeParam**](c-mswmi-rangeparam.md)<br/> |
| [**ms-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Richtig      | [**ms-WMI-RangeParam**](c-mswmi-rangeparam.md)<br/> |
| [**ms-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Richtig      | **ms-WMI-UnknownRangeParam**                               |
| [**ms-WMI-TargetType**](a-mswmi-targettype.md)                             | Richtig      | [**ms-WMI-RangeParam**](c-mswmi-rangeparam.md)<br/> |
...
| Unterklasse von                 | [**ms-WMI-RangeParam**](c-mswmi-rangeparam.md)<br/>                                   |
| Mögliche Vorgesetzte          | [**ms-WMI-MergeablePolicyTemplate**](c-mswmi-mergeablepolicytemplate.md)                    |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
