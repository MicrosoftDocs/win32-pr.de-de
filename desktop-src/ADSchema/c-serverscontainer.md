...
description: Enthält Serverobjekte an einem Standort.
ms.assetid: 1da4d943-1196-4425-9799-3ac44f7591f2
ms.tgt_platform: multiple
keywords:
- Servers-Container AD-Schema der Klasse
...
ms.locfileid: "119533790"
---
# <a name="servers-container-class"></a>Servers-Container-Klasse

Enthält Serverobjekte an einem Standort.
...
| Ldap-Anzeigename | serversContainer                     |
| Aktualisieren von Berechtigungen  | Domänenadministrator                 |
| Updatehäufigkeit  | Wenn ein Standort erstellt wird.              |
...
| Standardsicherheitsdeskriptor | D:(A;; CC;;;; BA)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
