...
---
# <a name="ms-wmi-rangeparam-class"></a>MS-WMI-rangeparam-Klasse

Bereichs Parameter Klasse, die die Grundlage der policytemplate ist. Es beschreibt eine merladbare Eigenschaft des Ziels. Jede Unterklasse implementiert einen bestimmten Typ. Implementiert die Merge-Methode zur Unterstützung der Zusammenführung. Implementiert eine Resolve-Methode, um die endgültige Ziel Eigenschaft zu generieren.
...
| LDAP-Display-Name | mswap-rangeparam                     |
| Berechtigung aktualisieren  | \-                                   |
| Aktualisierungshäufigkeit  | \-                                   |
| Schema-ID-GUID    | 45b5a57-5018-4D0F -9056-997c8c9122d9 |
...
| [**MS-WMI-PropertyName**](a-mswmi-propertyname.md)                         | Richtig      | **MS-WMI-rangeparam**           |
| [**MS-WMI-targetclass**](a-mswmi-targetclass.md)                           | Richtig      | **MS-WMI-rangeparam**           |
| [**MS-WMI-TargetType**](a-mswmi-targettype.md)                             | Richtig      | **MS-WMI-rangeparam**           |
