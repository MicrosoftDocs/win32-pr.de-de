...
description: Gibt Informationen für eine Adressvorlage an.
ms.assetid: ddc1fe59-949d-4bbb-bb29-52d0b4b77275
ms.tgt_platform: multiple
keywords:
- Display-Template AD-Schema der Klasse
- displayTemplate-Klasse AD Schema
topic_type:
- apiref
api_name:
- Display-Template
...
ms.locfileid: "119081244"
---
# <a name="display-template-class"></a>Display-Template-Klasse

Gibt Informationen für eine Adressvorlage an.
...
|-------------------|--------------------------------------|
| CN                | Display-Template                     |
| Ldap-Anzeigename | displayTemplate                      |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)                | False     | [**Nach oben**](c-top.md)<br/>                      |
| [**Kanonischer Name**](a-canonicalname.md)                                    | False     | [**Nach oben**](c-top.md)<br/>                      |
| [**Allgemeiner Name**](a-cn.md)                                                  | True      | **Display-Template** [ **Top**](c-top.md)<br/> |
