...
---
# <a name="display-template-class"></a>Display-Template-Klasse

Gibt Informationen für eine Adress Vorlage an.
...
|-------------------|--------------------------------------|
| CN                | Display-Template                     |
| LDAP-Display-Name | Display Template                      |
| Berechtigung aktualisieren  | \-                                   |
| Aktualisierungshäufigkeit  | \-                                   |
| Schema-ID-GUID    | 5F d4250c-1262-11D0-a060-00aa006c33ed |
...
|------------------------------------------------------------------------------|-----------|------------------------------------------------------|
| [**Address-Entry-Display-Table**](a-addressentrydisplaytable.md)            | False     | **Anzeige-Vorlage**                                 |
| [**Address-Entry-Display-Table-MSDOS**](a-addressentrydisplaytablemsdos.md) | False     | **Anzeige-Vorlage**                                 |
...
| [**Gemeinsamer Name**](a-cn.md)                                                  | Richtig      | **Anzeige-Vorlage** [ **oben**](c-top.md)<br/> |
...
| [**Hilfe-Data16**](a-helpdata16.md)                                          | False     | **Anzeige-Vorlage**                                 |
| [**Hilfe-data32**](a-helpdata32.md)                                          | False     | **Anzeige-Vorlage**                                 |
| [**Hilfe-Dateiname**](a-helpfilename.md)                                     | False     | **Anzeige-Vorlage**                                 |
...
| [**Original-Display-Table**](a-originaldisplaytable.md)                     | False     | **Anzeige-Vorlage**                                 |
| [**Original-Display-Table-MSDOS**](a-originaldisplaytablemsdos.md)          | False     | **Anzeige-Vorlage**                                 |
