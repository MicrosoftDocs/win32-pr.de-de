...
description: Verfeinerung des Verwaltungsbereichs eines Gruppenrichtlinie-Objekts. Fügt eine Liste von Regeln hinzu, ausgedrückt als WQL-Abfragen, die auf dem Zielcomputer ausgeführt werden. Alle Abfragen müssen Ergebnisse zurückgeben, damit dieses SOM auf das Ziel anwendbar ist.
ms.assetid: 5ab6766d-f8ed-491c-acc8-f4924cfd1096
ms.tgt_platform: multiple
keywords:
- MS-WMI-Som-Klasse AD-Schema
- MSWMI-Som-Klasse AD-Schema
topic_type:
- apiref
api_name:
- ms-WMI-Som
...
ms.locfileid: "118175052"
---
# <a name="ms-wmi-som-class"></a>ms-WMI-Som-Klasse

Verfeinerung des Verwaltungsbereichs eines Gruppenrichtlinie-Objekts. Fügt eine Liste von Regeln hinzu, ausgedrückt als WQL-Abfragen, die auf dem Zielcomputer ausgeführt werden. Alle Abfragen müssen Ergebnisse zurückgeben, damit dieses SOM auf das Ziel anwendbar ist.
...
| [**ms-WMI-Author**](a-mswmi-author.md)                                     | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-ChangeDate**](a-mswmi-changedate.md)                             | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-CreationDate**](a-mswmi-creationdate.md)                         | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-ID**](a-mswmi-id.md)                                             | True      | **ms-WMI-Som**                  |
| [**ms-WMI-intFlags1**](a-mswmi-intflags1.md)                               | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-intFlags2**](a-mswmi-intflags2.md)                               | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-intFlags3**](a-mswmi-intflags3.md)                               | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-intFlags4**](a-mswmi-intflags4.md)                               | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-Name**](a-mswmi-name.md)                                         | Richtig      | **ms-WMI-Som**                  |
| [**ms-WMI-Parm1**](a-mswmi-parm1.md)                                       | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-Parm2**](a-mswmi-parm2.md)                                       | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-Parm3**](a-mswmi-parm3.md)                                       | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-Parm4**](a-mswmi-parm4.md)                                       | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-SourceOrganization**](a-mswmi-sourceorganization.md)             | Falsch     | **ms-WMI-Som**                  |
...
| [**ms-WMI-ChangeDate**](a-mswmi-changedate.md)                                              | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-CreationDate**](a-mswmi-creationdate.md)                                          | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-ID**](a-mswmi-id.md)                                                              | Richtig      | **ms-WMI-Som**                  |
| [**ms-WMI-intFlags1**](a-mswmi-intflags1.md)                                                | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-intFlags2**](a-mswmi-intflags2.md)                                                | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-intFlags3**](a-mswmi-intflags3.md)                                                | Falsch     | **ms-WMI-Som**                  |
| [**ms-WMI-intFlags4**](a-mswmi-intflags4.md)                                                | Falsch     | **ms-WMI-Som**                  |
