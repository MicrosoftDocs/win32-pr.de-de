...
Verfeinert den Verwaltungsbereich eines Gruppenrichtlinie Objekts. Fügt eine Liste von Regeln als WQL-Abfragen hinzu, die auf dem Bereitstellungs Zielcomputer ausgeführt werden. Alle Abfragen müssen Ergebnisse zurückgeben, damit dieses SOM auf das Ziel anwendbar ist.
...
| [**MS-WMI-Autor**](a-mswmi-author.md)                                     | False     | **MS-WMI-som**                  |
| [**MS-WMI-changeDate**](a-mswmi-changedate.md)                             | False     | **MS-WMI-som**                  |
| [**MS-WMI--erationdate**](a-mswmi-creationdate.md)                         | False     | **MS-WMI-som**                  |
