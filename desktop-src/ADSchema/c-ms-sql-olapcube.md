...
description: Klasse zum Speichern SQL Server OLAP-Cubeeigenschaften.
ms.assetid: 9ffcc94b-3866-456b-8b65-0374ae613fb5
ms.tgt_platform: multiple
keywords:
- AD-Schema der MS-SQL-OLAPCube-Klasse
- mS-SQL-OLAPCube-Klasse AD-Schema
topic_type:
- apiref
api_name:
- MS-SQL-OLAPCube
...
ms.locfileid: "119834670"
---
# <a name="ms-sql-olapcube-class"></a>MS-SQL-OLAPCube-Klasse

Klasse zum Speichern SQL Server OLAP-Cubeeigenschaften.
...
|-------------------|--------------------------------------|
| CN                | MS-SQL-OLAPCube                      |
| Ldap-Anzeigename | mS-SQL-OLAPCube                      |
...
| Mögliche Übergeordnete          | [**MS-SQL-OLAPDatabase**](c-ms-sql-olapdatabase.md)                                         |
| Zusätzlich           | \-                                                                                           |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Vorgesetzte          | [**MS-SQL-OLAPDatabase**](c-ms-sql-olapdatabase.md)                                         |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
