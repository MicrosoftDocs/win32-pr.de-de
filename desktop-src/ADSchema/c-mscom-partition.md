...
description: Ein namespace, der von COM+ verwendet wird, um zuzulassen, dass mehrere Versionen derselben COM+-Anwendung auf demselben physischen Computer vorhanden sind.
ms.assetid: 84e7af24-0202-4ae8-a278-0f390ddadbb3
ms.tgt_platform: multiple
keywords:
- MS-COM-Partition-Klasse AD-Schema
- MSCOM-Partition-Klasse AD-Schema
topic_type:
- apiref
api_name:
- ms-COM-Partition
...
ms.locfileid: "119643190"
---
# <a name="ms-com-partition-class"></a>ms-COM-Partition-Klasse

Ein namespace, der von COM+ verwendet wird, um zuzulassen, dass mehrere Versionen derselben COM+-Anwendung auf demselben physischen Computer vorhanden sind.
...
|-------------------|--------------------------------------|
| CN                | ms-COM-Partition                     |
| Ldap-Anzeigename | msCOM-Partition                      |
