...
---
# <a name="print-min-x-extent-attribute"></a>Print-min-X-Block-Attribut

Der minimale horizontale Druckbereich.



| Eingabe | Wert |
|-------------------|--------------------------------------|
| CN                | Print-min-X-Block                   |
| LDAP-Display-Name | printminxblock                      |
| Size              | 4 Bytes                              |
