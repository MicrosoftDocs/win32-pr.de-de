---
title: Inter-Site-Transport-Klasse
description: Optionales Attribut von ntdsConnection-Objekten. Enthält ggf. den DN eines interSiteTransport-Objekts im CN Inter-Site Transports,CN Sites,CN Configuration,... Container.
ms.assetid: eeeb47aa-cfe8-4ff6-86e7-b3e1727c907a
ms.tgt_platform: multiple
keywords:
- AD-Schema der Inter-Site-Transport-Klasse
- interSiteTransport-Klasse AD-Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119703680"
---
# <a name="inter-site-transport-class"></a>Inter-Site-Transport-Klasse

Optionales Attribut von ntdsConnection-Objekten. Enthält ggf. den DN eines interSiteTransport-Objekts in CN=Inter-Site Transports,CN=Sites,CN=Configuration,... Container.



| Eingabe | Wert |
|-------------------|------------------------------------------------------------------------------------------------------------------------------------|
| CN                | Standortübergreifender Transport                                                                                                               |
| Ldap-Anzeigename | interSiteTransport                                                                                                                 |
| Aktualisieren von Berechtigungen  | Dieser Wert wird vom KCC- oder Unternehmensadministrator festgelegt.                                                                          |
| Updatehäufigkeit  | Erstellt/verwaltet von der Wissenskonsistenzprüfung als Reaktion auf Änderungen in der Netzwerktopologie (einschließlich temporärer Ausfälle). |
...
| Mögliche Übergeordnete          | [**Standortübergreifender Transportcontainer**](c-intersitetransportcontainer.md)                      |
| Zusätzlich           | \-                                                                                           |
...
| [**Optionen**](a-options.md)                                              | False     | **Standortübergreifender Transport**        |
...
| [**Repl-Interval**](a-replinterval.md)                                   | False     | **Standortübergreifender Transport**        |
...
| [**Transport-Address-Attribute**](a-transportaddressattribute.md)        | True      | **Standortübergreifender Transport**        |
| [**Transport-DLL-Name**](a-transportdllname.md)                          | True      | **Standortübergreifender Transport**        |
...
| Unterklasse von                 | [**Nach oben**](c-top.md)<br/>                                                              |
| Mögliche Vorgesetzte          | [**Standortübergreifender Transportcontainer**](c-intersitetransportcontainer.md)                      |
| Zusätzlich           | \-                                                                                           |
| NT-Security-Descriptor      | O:BAG:BAD:S:                                                                                 |
| Standardsicherheitsdeskriptor | D:(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY)(A;; RPLCLORC;;; AU) |
| System-Flags                | 0x00000010                                                                                   |
