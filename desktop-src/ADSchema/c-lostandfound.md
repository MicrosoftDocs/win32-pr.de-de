...
---
# <a name="lost-and-found-class"></a>Verlorene und gefundene Klasse
...
| Eingabe | Wert |
|-------------------|-----------------------------------------------------------|
| CN                | Verloren und gefunden                                            |
| LDAP-Display-Name | lostAndFound                                              |
| Berechtigung aktualisieren  | Dieser Container wird vom System verwaltet.                  |
| Aktualisierungshäufigkeit  | Immer, wenn der Speicherort für ein Objekt nicht abgestimmt werden kann. |
| Schema-ID-GUID    | 52ab8671-5709-11d1-a9c6-0000b80367c1                      |
...
| Mögliche Vorgesetzten          | [**DMD**](c-dmd.md)[**-Domäne: DNS-**](c-domaindns.md)[**Konfiguration**](c-configuration.md) |
| Zusätzlich           | \-                                                                                            |
...
| [**Move-Tree-State**](a-movetreestate.md)                                | False     | **Verloren und gefunden**              |
