...
Aufgrund des Speicherplatzes statisch verknüpfter DLLs sollten Sie die Verwendung von Microsoft Foundation Classes (MFCs) vermeiden, um einen Experten zu schreiben. Wenn Sie jedoch den MFC verwenden, stellen Sie sicher, dass der Zugriff auf die MFC-DLL-Ressourcen gewährleistet ist, indem Sie den folgenden Code direkt nach dem Eintrag einschließen:
