...
---
# <a name="address-structure"></a>Adressstruktur

Die **Adress** Struktur ist veraltet und sollte nicht verwendet werden.
...
Ein Satz von Flags, die die Adress Eigenschaften ändern.
