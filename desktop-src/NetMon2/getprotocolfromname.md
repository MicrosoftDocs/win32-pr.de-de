...
---
# <a name="getprotocolfromname-function"></a>GetProtocolFromName-Funktion

Die **GetProtocolFromName** -Funktion gibt ein Handle für ein Protokoll mit einem bestimmten Namen zurück.
...
[*Experten*](e.md) und [*Parser*](p.md) können die **GetProtocolFromName** -Funktion aufrufen.
