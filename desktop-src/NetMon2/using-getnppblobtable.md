...
---
# <a name="using-getnppblobtable"></a><span data-ttu-id="886b9-103">Verwenden von getnppblobtable</span><span class="sxs-lookup"><span data-stu-id="886b9-103">Using GetNPPBlobTable</span></span>

<span data-ttu-id="886b9-104">Im folgenden Beispiel wird gezeigt, wie die [**getnppblobtable**](getnppblobtable.md) -Funktion verwendet wird, um eine NPP-BLOB-Tabelle abzurufen, die die registrierten Netzwerkschnittstellenkarten auf dem lokalen Computer darstellt.</span><span class="sxs-lookup"><span data-stu-id="886b9-104">The following example shows how to use the [**GetNPPBlobTable**](getnppblobtable.md) function to retrieve a NPP BLOB table that represents the registered network interface cards on the local computer.</span></span>
