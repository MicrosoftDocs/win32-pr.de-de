...
Ein Handle für den Frame, auf den ein Zeiger angezeigt werden soll.
...
Ein Rückgabepuffer, der die Quelladresse des Frames speichert.
...
Die Flags, die zum Ändern der zurückgegebenen Quelladressdaten verwendet werden.
...
|------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| <dl> <dt>**\_BHERR-PROTOKOLL \_ NICHT \_ GEFUNDEN**</dt> </dl> | Das vom *AddressType-Parameter* angegebene Protokoll ist für den Frame ungültig.<br/> |
| <dl> <dt>**BHERR \_ INVALID \_ HFRAME**</dt> </dl>      | Der *hFrame-Parameterwert* ist ungültig.<br/>                                        |
