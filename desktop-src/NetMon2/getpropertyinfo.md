...
---
# <a name="getpropertyinfo-function"></a>GetPropertyInfo-Funktion

Die **GetPropertyInfo** -Funktion gibt einen Zeiger auf die Eigenschafts Informationen eines bestimmten Protokolls zurück.
...
Handle für eine Eigenschaft.

</dd> </dl>

## <a name="return-value"></a>Rückgabewert

Wenn die Funktion erfolgreich ist, ist der Rückgabewert ein Zeiger auf die-Eigenschaft.

Wenn die Funktion nicht erfolgreich ist, ist der Rückgabewert **null**.

## <a name="remarks"></a>Bemerkungen

[*Experten*](e.md) und [*Parser*](p.md) können die **GetPropertyInfo** -Funktion aufrufen.
