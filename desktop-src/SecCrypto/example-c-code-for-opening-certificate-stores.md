...
---
# <a name="example-c-code-for-opening-certificate-stores"></a><span data-ttu-id="b08b4-104">Beispiel-C-Code zum Öffnen von Zertifikat speichern</span><span class="sxs-lookup"><span data-stu-id="b08b4-104">Example C Code for Opening Certificate Stores</span></span>

<span data-ttu-id="b08b4-105">In den folgenden Beispielen wird Code zum Öffnen einer Vielzahl allgemeiner Zertifikat Speicher bereitgestellt.</span><span class="sxs-lookup"><span data-stu-id="b08b4-105">The following examples provide code to open a variety of common certificate stores.</span></span> <span data-ttu-id="b08b4-106">Bei diesen Beispielen handelt es sich um eine Reihe von Code Fragmenten, die keine eigenständigen Programme sind.</span><span class="sxs-lookup"><span data-stu-id="b08b4-106">These examples are a series of code fragments and are not stand-alone programs.</span></span>

<span data-ttu-id="b08b4-107">Im folgenden Beispiel wird der eigene Systemspeicher geöffnet.</span><span class="sxs-lookup"><span data-stu-id="b08b4-107">The following example opens the My system store.</span></span>
...
<span data-ttu-id="b08b4-108">Im folgenden Beispiel wird ein Speicher Speicher geöffnet.</span><span class="sxs-lookup"><span data-stu-id="b08b4-108">The following example opens a memory store.</span></span>
...
<span data-ttu-id="b08b4-109">Im folgenden Beispiel wird ein Speicher vom Datenträger geöffnet.</span><span class="sxs-lookup"><span data-stu-id="b08b4-109">The following example opens a store from disk.</span></span> <span data-ttu-id="b08b4-110">Im Beispiel wird die im Thema [Creating a DACL](../secbp/creating-a-dacl.md) definierte Funktion "-Funktion" verwendet, um sicherzustellen, **dass die geöffnete** Datei mit einer ordnungsgemäßen DACL erstellt wird.</span><span class="sxs-lookup"><span data-stu-id="b08b4-110">The example uses the **CreateMyDACL** function, defined in the [Creating a DACL](../secbp/creating-a-dacl.md) topic, to ensure the open file is created with a proper DACL.</span></span>
...
<span data-ttu-id="b08b4-111">Im folgenden Beispiel wird ein Datei basierter Speicher mit dem Datei \_ Namen des Zertifikat Speicher \_ Prov geöffnet \_ .</span><span class="sxs-lookup"><span data-stu-id="b08b4-111">The following example opens a file-based store using CERT\_STORE\_PROV\_FILENAME.</span></span>
...
<span data-ttu-id="b08b4-112">Im folgenden Beispiel wird ein Sammlungs Speicher geöffnet.</span><span class="sxs-lookup"><span data-stu-id="b08b4-112">The following example opens a collection store.</span></span>
...
<span data-ttu-id="b08b4-113">Im folgenden Beispiel wird ein Register Speicher geöffnet.</span><span class="sxs-lookup"><span data-stu-id="b08b4-113">The following example opens a register store.</span></span>
...
<span data-ttu-id="b08b4-114">Im folgenden Beispiel wird ein Zertifikat Speicher auf der Grundlage einer PKCS \# 7-Nachricht geöffnet.</span><span class="sxs-lookup"><span data-stu-id="b08b4-114">The following example opens a certificate store based on a PKCS \#7 message.</span></span>
