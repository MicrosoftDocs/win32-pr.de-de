---
description: Ruft eine Zeichenfolge ab, die den Namen des Zertifikatsubjekts enthält.
ms.assetid: 95dc7e8b-6670-4dfc-9fe1-d37635fb92d6
title: Certificate.SubjectName(Eigenschaft)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119878170"
---
# <a name="certificatesubjectname-property"></a>Certificate.SubjectName(Eigenschaft)
...
Die **SubjectName-Eigenschaft** ruft eine Zeichenfolge ab, die den Namen des Zertifikatsubjekts enthält.
...
Eine Zeichenfolge, die den Namen des Zertifikatsubjekts enthält.
