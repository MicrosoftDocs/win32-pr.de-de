...
---
# <a name="example-c-program-cosigning-and-decoding-a-message"></a>Beispiel-C-Programm: cosignieren und Decodieren einer Nachricht

Sie können die Funktion " [**cryptsignmessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsignmessage) " verwenden, um eine Nachricht zu signieren. Dies erfolgt durch den Aufruf von [**cryptsignmessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsignmessage) einmal, um die ursprüngliche Nachricht zu signieren, und dann erneut **cryptsignmessage** , um die signierte Nachricht zu signieren.

Wenn Sie die Signatur einer cosignierten Nachricht überprüfen, verwenden Sie die [**cryptgetmessagesignercount**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetmessagesignercount) -Funktion, um die Anzahl der Signatur Geber der Nachricht abzurufen, und dann die [**cryptverifymessagesignature**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptverifymessagesignature) für jede Signatur. Wenn alle Signaturen überprüft werden, wissen Sie, dass die cosigned-Nachricht gültig ist.

Im folgenden Beispiel wird gezeigt, wie eine Nachricht von mehr als einer Person signiert wird (cosignieren der Nachricht), alle Signaturen überprüft und die Nachricht decodiert wird.
