---
description: In der folgenden Tabelle sind die Algorithmen aufgeführt, die vom Microsoft Advanced Encryption Standard Kryptografieanbieter (AES) unterstützt werden.
...
In der folgenden Tabelle sind die Algorithmen aufgeführt, die vom Microsoft [*Advanced Encryption Standard*](../secgloss/a-gly.md) Kryptografieanbieter (AES) unterstützt werden.
...
| CALG \_ 3DES \_ 112    | [*Triple-DES-Verschlüsselung mit zwei*](../secgloss/t-gly.md) Schlüsseln.                                                            | Schlüssellänge: 112 Bits. Standardmodus: Verschlüsselungsblockverkettung.<br/> Blockgröße: 64 Bits.<br/> Kein Salt zulässig.<br/>                          |
