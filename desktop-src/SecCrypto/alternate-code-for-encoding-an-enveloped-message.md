...
---
# <a name="alternate-code-for-encoding-an-enveloped-message"></a><span data-ttu-id="f14ef-104">Alternativer Code zum Codieren einer eingeschlossenen Nachricht</span><span class="sxs-lookup"><span data-stu-id="f14ef-104">Alternate Code for Encoding an Enveloped Message</span></span>

<span data-ttu-id="f14ef-105">Im folgenden Beispiel wird ein alternativer Prozess der Codierung einer signierten Nachricht veranschaulicht. dabei wird die signierte Nachricht als [*innerer Inhalt*](../secgloss/i-gly.md) für eine eingeschlossene Nachricht verwendet.</span><span class="sxs-lookup"><span data-stu-id="f14ef-105">The following example demonstrates an alternate process of encoding a signed message, using that signed message as the [*inner content*](../secgloss/i-gly.md) for an enveloped message.</span></span> <span data-ttu-id="f14ef-106">Zur Vorbereitung der Decodierung wird der innere Inhalt getestet, um seinen inneren Inhaltstyp zu bestimmen.</span><span class="sxs-lookup"><span data-stu-id="f14ef-106">In preparation for decoding, the inner content is tested to determine its inner-content type.</span></span>

<span data-ttu-id="f14ef-107">In diesem Beispiel werden die folgenden CryptoAPI-Funktionen veranschaulicht:</span><span class="sxs-lookup"><span data-stu-id="f14ef-107">This example illustrates the following CryptoAPI functions:</span></span>

-   [<span data-ttu-id="f14ef-108">**CryptAcquireContext**</span><span class="sxs-lookup"><span data-stu-id="f14ef-108">**CryptAcquireContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta)
-   [<span data-ttu-id="f14ef-109">**Certopeinsystemstore**</span><span class="sxs-lookup"><span data-stu-id="f14ef-109">**CertOpenSystemStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea)
-   [<span data-ttu-id="f14ef-110">**Cryptmsgcalculateencodecodlength**</span><span class="sxs-lookup"><span data-stu-id="f14ef-110">**CryptMsgCalculateEncodedLength**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgcalculateencodedlength)
-   [<span data-ttu-id="f14ef-111">**Cryptmsgopentoen-Code**</span><span class="sxs-lookup"><span data-stu-id="f14ef-111">**CryptMsgOpenToEncode**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentoencode)
-   [<span data-ttu-id="f14ef-112">**Cryptmsgupdate**</span><span class="sxs-lookup"><span data-stu-id="f14ef-112">**CryptMsgUpdate**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate)
-   [<span data-ttu-id="f14ef-113">**Cryptmsggetparam**</span><span class="sxs-lookup"><span data-stu-id="f14ef-113">**CryptMsgGetParam**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam)
-   [<span data-ttu-id="f14ef-114">**Cryptmsgopentodecode**</span><span class="sxs-lookup"><span data-stu-id="f14ef-114">**CryptMsgOpenToDecode**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentodecode)
-   [<span data-ttu-id="f14ef-115">**Certfindcertifi. Store**</span><span class="sxs-lookup"><span data-stu-id="f14ef-115">**CertFindCertificateInStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certfindcertificateinstore)
-   [<span data-ttu-id="f14ef-116">**Cryptmsgclose**</span><span class="sxs-lookup"><span data-stu-id="f14ef-116">**CryptMsgClose**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgclose)
-   [<span data-ttu-id="f14ef-117">**Certclosestore**</span><span class="sxs-lookup"><span data-stu-id="f14ef-117">**CertCloseStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore)
-   [<span data-ttu-id="f14ef-118">**Cryptreleasecontext**</span><span class="sxs-lookup"><span data-stu-id="f14ef-118">**CryptReleaseContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptreleasecontext)

<span data-ttu-id="f14ef-119">In diesem Beispiel werden auch die Funktionen [**mylenker Error**](myhandleerror.md) und [**getsignercert**](getsignercert.md)verwendet.</span><span class="sxs-lookup"><span data-stu-id="f14ef-119">This example also uses the functions [**MyHandleError**](myhandleerror.md) and [**GetSignerCert**](getsignercert.md).</span></span> <span data-ttu-id="f14ef-120">Der C-Code für diese Funktionen ist im Beispiel enthalten.</span><span class="sxs-lookup"><span data-stu-id="f14ef-120">C code for these functions is included with the example.</span></span> <span data-ttu-id="f14ef-121">Informationen zu Code, der diese und andere Hilfsfunktionen veranschaulicht, finden Sie unter [universell Functions](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="f14ef-121">For code that demonstrates these and other auxiliary functions, see [General Purpose Functions](general-purpose-functions.md).</span></span>
