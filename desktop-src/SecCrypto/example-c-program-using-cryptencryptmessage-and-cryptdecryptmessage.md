...
---
# <a name="example-c-program-using-cryptencryptmessage-and-cryptdecryptmessage"></a><span data-ttu-id="3c429-103">C-Beispielprogramm: Verwenden von CryptEncryptMessage und CryptDecryptMessage</span><span class="sxs-lookup"><span data-stu-id="3c429-103">Example C Program: Using CryptEncryptMessage and CryptDecryptMessage</span></span>

<span data-ttu-id="3c429-104">[**CryptEncryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencryptmessage) ist der einzige Funktionsaufruf, der erforderlich ist, um alle Unter [Verschlüsseln einer Nachricht aufgeführten Aufgaben auszuführen.](../secauthn/encrypting-a-message.md)</span><span class="sxs-lookup"><span data-stu-id="3c429-104">[**CryptEncryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencryptmessage) is the only function call necessary to accomplish all of the tasks listed in [Encrypting a Message](../secauthn/encrypting-a-message.md).</span></span> <span data-ttu-id="3c429-105">Die Initialisierung von Datenstrukturen ist erforderlich.</span><span class="sxs-lookup"><span data-stu-id="3c429-105">Initialization of data structures is necessary.</span></span> <span data-ttu-id="3c429-106">Die folgende Abbildung zeigt die Beziehung zwischen diesen Funktionsparametern, die auf Strukturen oder Arrays verweisen, und ihren initialisierten Daten.</span><span class="sxs-lookup"><span data-stu-id="3c429-106">The following illustration shows the relationship between those function parameters that point to structures or arrays and their initialized data.</span></span> <span data-ttu-id="3c429-107">In diesem Beispiel wird die Nachricht auch mithilfe von [**CryptDecryptMessage entschlüsselt.**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecryptmessage)</span><span class="sxs-lookup"><span data-stu-id="3c429-107">This example also decrypts the message using [**CryptDecryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecryptmessage).</span></span>

![Initialisierungszuordnung für einen Aufruf von cryptencryptmessage](images/crypenc.png)

<span data-ttu-id="3c429-109">**So verschlüsseln Sie Daten**</span><span class="sxs-lookup"><span data-stu-id="3c429-109">**To encrypt data**</span></span>

1.  <span data-ttu-id="3c429-110">Sie erhalten einen Zeiger auf den zu verschlüsselnden Inhalt.</span><span class="sxs-lookup"><span data-stu-id="3c429-110">Get a pointer to the content to be encrypted.</span></span>
2.  <span data-ttu-id="3c429-111">Bestimmen Sie die Größe des zu verschlüsselnden Inhalts.</span><span class="sxs-lookup"><span data-stu-id="3c429-111">Determine the size of the content to be encrypted.</span></span>
3.  <span data-ttu-id="3c429-112">Erwerben sie ein Handle für einen Kryptografieanbieter.</span><span class="sxs-lookup"><span data-stu-id="3c429-112">Acquire a handle to a cryptographic provider.</span></span>
4.  <span data-ttu-id="3c429-113">Öffnen Sie einen [*Zertifikatspeicher.*](../secgloss/c-gly.md)</span><span class="sxs-lookup"><span data-stu-id="3c429-113">Open a [*certificate store*](../secgloss/c-gly.md).</span></span>
5.  <span data-ttu-id="3c429-114">Erhalten Sie das Empfängerzertifikat.</span><span class="sxs-lookup"><span data-stu-id="3c429-114">Get the recipient certificate.</span></span>
6.  <span data-ttu-id="3c429-115">Erstellen Sie das Empfängerzertifikatarray.</span><span class="sxs-lookup"><span data-stu-id="3c429-115">Create the recipient certificate array.</span></span>
7.  <span data-ttu-id="3c429-116">Initialisieren Sie die [**CRYPT \_ ALGORITHM \_ IDENTIFIER-Struktur.**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_algorithm_identifier)</span><span class="sxs-lookup"><span data-stu-id="3c429-116">Initialize the [**CRYPT\_ALGORITHM\_IDENTIFIER**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_algorithm_identifier) structure.</span></span>
8.  <span data-ttu-id="3c429-117">Initialisieren Sie die [**CRYPT \_ ENCRYPT MESSAGE \_ \_ PARA-Struktur.**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_encrypt_message_para)</span><span class="sxs-lookup"><span data-stu-id="3c429-117">Initialize the [**CRYPT\_ENCRYPT\_MESSAGE\_PARA**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_encrypt_message_para) structure.</span></span>
9.  <span data-ttu-id="3c429-118">Rufen [**Sie CryptEncryptMessage auf,**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencryptmessage) um den Inhalt zu verschlüsseln und eine digital umhumhierte Nachricht zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="3c429-118">Call [**CryptEncryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencryptmessage) to encrypt the content and create a digitally enveloped message.</span></span>

<span data-ttu-id="3c429-119">Im folgenden Beispiel wird diese Prozedur implementiert.</span><span class="sxs-lookup"><span data-stu-id="3c429-119">The following example implements this procedure.</span></span>

<span data-ttu-id="3c429-120">Kommentare beziehen sich auf Codefragmente auf jeden Schritt in der Prozedur.</span><span class="sxs-lookup"><span data-stu-id="3c429-120">Comments relate code fragments to each step in the procedure.</span></span> <span data-ttu-id="3c429-121">Weitere Informationen zur -Funktion finden Sie unter [**CryptEncryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencryptmessage).</span><span class="sxs-lookup"><span data-stu-id="3c429-121">For more information about the function, see [**CryptEncryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencryptmessage).</span></span> <span data-ttu-id="3c429-122">Weitere Informationen zu den Datenstrukturen finden Sie unter [**CRYPT \_ ALGORITHM \_ IDENTIFIER**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_algorithm_identifier) und [**CRYPT \_ ENCRYPT MESSAGE \_ \_ PARA.**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_encrypt_message_para)</span><span class="sxs-lookup"><span data-stu-id="3c429-122">For more information about the data structures, see [**CRYPT\_ALGORITHM\_IDENTIFIER**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_algorithm_identifier) and [**CRYPT\_ENCRYPT\_MESSAGE\_PARA**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_encrypt_message_para).</span></span>

<span data-ttu-id="3c429-123">In diesem Beispiel werden die Funktionen [**MyHandleError**](myhandleerror.md) und [**ByteToStr verwendet.**](bytetostr.md)</span><span class="sxs-lookup"><span data-stu-id="3c429-123">This example uses the functions [**MyHandleError**](myhandleerror.md) and [**ByteToStr**](bytetostr.md).</span></span> <span data-ttu-id="3c429-124">Der Code für diese Funktion ist im Beispiel enthalten.</span><span class="sxs-lookup"><span data-stu-id="3c429-124">The code for this function is included with the sample.</span></span> <span data-ttu-id="3c429-125">Der Code für diese und andere Hilfsfunktionen ist auch unter Universell [Functions aufgeführt.](general-purpose-functions.md)</span><span class="sxs-lookup"><span data-stu-id="3c429-125">Code for this and other auxiliary functions is also listed under [General Purpose Functions](general-purpose-functions.md).</span></span>
