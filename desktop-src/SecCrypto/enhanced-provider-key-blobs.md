...
---
# <a name="enhanced-provider-key-blobs"></a>Erweiterte Anbieter Schlüssel-BLOB

Der Basis Anbieter, der starke Anbieter und der erweiterte Anbieter verwenden dieselben [*Schlüsselblob*](../secgloss/k-gly.md).
...
[*Öffentliche Schlüssel-BLOBs*](../secgloss/p-gly.md), geben Sie **PublicKeyBlob** ein, die verwendet werden, um [*öffentliche Schlüssel*](../secgloss/p-gly.md) außerhalb eines [*Kryptografiedienstanbieters*](../secgloss/c-gly.md) (CSP) zu speichern. Blobblobschlüssel für öffentliche Schlüssel des erweiterten Anbieters haben das folgende Format.
...
[*Private Schlüsselblobs*](../secgloss/p-gly.md), Typ **privatekeyblob**, werden zum Speichern [*privater Schlüssel*](../secgloss/p-gly.md) außerhalb eines CSP verwendet. Blobblobschlüssel für private Schlüssel des erweiterten Anbieters haben das folgende Format:
...
[*Einfache Schlüsselblobs*](../secgloss/s-gly.md), geben Sie **simpleblob** ein, die zum Speichern und transportieren von Sitzungs Schlüsseln außerhalb eines CSP verwendet werden. Einfache Schlüssel-blobschlüssel für erweiterte Anbieter werden immer mit einem [*öffentlichen Schlüsselaustausch*](../secgloss/k-gly.md)Schlüssel verschlüsselt. Der **pbData** -Member von **simpleblob** ist eine Folge von Bytes im folgenden Format.
...
Weitere Informationen über den Basis Anbieter und die Schlüssel-BLOB für erweiterte Anbieter finden Sie unter [Schlüssel-BLOB des Basis Anbieters](base-provider-key-blobs.md).
