---
description: Der Basisanbieter, der starke Anbieter und der erweiterte Anbieter verwenden die gleichen Schlüssel-BLOBs.
ms.assetid: f1bd347b-33bd-40bc-9a9b-c06f264f1af4
title: Erweiterte Anbieterschlüssel-BLOBs
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119874440"
---
# <a name="enhanced-provider-key-blobs"></a>Erweiterte Anbieterschlüssel-BLOBs

Der Basisanbieter, der starke Anbieter und der erweiterte Anbieter verwenden die gleichen [*Schlüssel-BLOBs.*](../secgloss/k-gly.md)
...
[*Private Schlüssel-BLOBs*](../secgloss/p-gly.md)vom Typ **PRIVATEKEYBLOB** werden verwendet, um [*private Schlüssel*](../secgloss/p-gly.md) außerhalb eines CSP zu speichern. BLOBs mit privatem Schlüssel des erweiterten Anbieters weisen das folgende Format auf.
...
Informationen zum Basisanbieter und den Schlüssel-BLOBs des erweiterten Anbieters finden Sie unter [Basisanbieterschlüssel-BLOBs.](base-provider-key-blobs.md)
