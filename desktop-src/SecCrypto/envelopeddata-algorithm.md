...
---
# <a name="envelopeddataalgorithm-property"></a>EnvelopedData. algorithmuseigenschaft
...
Die  algorithmuseigenschaft Ruft den Verschlüsselungsalgorithmus und die [*Schlüssellänge*](../secgloss/k-gly.md)ab.
...
Ein [**Algorithmusobjekt**](algorithm.md) , das den Verschlüsselungsalgorithmus und die Schlüssellänge enthält.
