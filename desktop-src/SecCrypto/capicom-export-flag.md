...
Der **CAPICOM \_ EXPORT FLAG-Enumerationstyp \_** definiert, ob Exportfehler für private Schlüssel ignoriert werden.
...
|-------------------------------------------------------------------|-----------------------------------------------------------|-------|
| **CAPICOM \_ EXPORT \_ DEFAULT**                                      | Exportfehler für private Schlüssel werden nicht ignoriert.<br/> | 0     |
| **CAPICOM \_ EXPORT \_ IGNORE \_ PRIVATE \_ KEY \_ NOT \_ EXPORTABLE \_ ERROR** | Alle Exportfehler für private Schlüssel werden ignoriert.<br/>     | 1     |
