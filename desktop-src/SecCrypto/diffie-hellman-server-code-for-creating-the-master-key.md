---
description: Das folgende Beispiel zeigt einen typischen serverseitigen Diffie-Hellman/SChannel-Code zum Erstellen eines Haupt Schlüssels.
ms.assetid: 1ef0a2ea-8684-425c-abfe-9f65d8df7bbd
title: Diffie-Hellman Server Code zum Erstellen des Haupt Schlüssels
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106349407"
---
# <a name="diffie-hellman-server-code-for-creating-the-master-key"></a><span data-ttu-id="797a0-103">Diffie-Hellman Server Code zum Erstellen des Haupt Schlüssels</span><span class="sxs-lookup"><span data-stu-id="797a0-103">Diffie-Hellman Server Code for Creating the Master Key</span></span>

<span data-ttu-id="797a0-104">Das folgende Beispiel zeigt den typischen [*Diffie-Hellman-*](../secgloss/d-gly.md)/SChannel serverseitigen Code zum Erstellen eines [*Haupt Schlüssels*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="797a0-104">The following example shows typical [*Diffie-Hellman*](../secgloss/d-gly.md)/Schannel server-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
