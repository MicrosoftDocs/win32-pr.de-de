...
---
# <a name="the-certificate-enrollment-control-instantiated-in-vbscript"></a>Die Zertifikat Registrierungs Steuerung wird in VBScript instanziiert.

Im folgenden Visual Basic Scripting Edition (VBScript)-Beispiel wird das Objekttag verwendet, um eine Instanz des Zertifikatregistrierungs-Steuerungs Objekts zu erstellen. Das Objekt wird aus dem Arbeitsspeicher freigegeben, wenn es den Gültigkeitsbereich verlässt.
