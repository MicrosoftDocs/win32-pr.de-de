...
---
# <a name="request-sample-in-c"></a>Anforderungs Beispiel in C++

Das folgende Beispiel zeigt, wie das Zertifikat Registrierungs Steuerelement mit dem [**ICertRequest**](/windows/desktop/api/Certcli/nn-certcli-icertrequest) -Objekt verwendet werden kann, um eine Zertifikat Anforderung zu erstellen und zu übermitteln.
