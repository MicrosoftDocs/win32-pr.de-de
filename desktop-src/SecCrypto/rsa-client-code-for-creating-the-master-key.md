---
description: Das folgende Beispiel zeigt den typischen Client seitigen RSA/SChannel-Code zum Erstellen eines Haupt Schlüssels.
ms.assetid: 9ce4877f-e6e6-4b94-9503-092d2702b31f
title: RSA-Client Code zum Erstellen des Haupt Schlüssels
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106368087"
---
# <a name="rsa-client-code-for-creating-the-master-key"></a><span data-ttu-id="36a41-103">RSA-Client Code zum Erstellen des Haupt Schlüssels</span><span class="sxs-lookup"><span data-stu-id="36a41-103">RSA Client Code for Creating the Master Key</span></span>

<span data-ttu-id="36a41-104">Das folgende Beispiel zeigt den typischen Client seitigen RSA/SChannel-Code zum Erstellen eines [*Haupt Schlüssels*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="36a41-104">The following example shows typical RSA/Schannel client-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
