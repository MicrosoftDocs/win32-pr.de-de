...
---
# <a name="rsa-client-code-for-creating-the-master-key"></a>RSA-Client Code zum Erstellen des Haupt Schlüssels

Das folgende Beispiel zeigt den typischen Client seitigen RSA/SChannel-Code zum Erstellen eines [*Haupt Schlüssels*](../secgloss/m-gly.md).
