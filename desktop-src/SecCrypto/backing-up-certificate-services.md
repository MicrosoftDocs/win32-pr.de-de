...
3.  Rufen [**Sie CertSrvIsServerOnline auf,**](/windows/desktop/api/Certbcli/nf-certbcli-certsrvisserveronlinew) um zu ermitteln, ob die Zertifikatdienste online sind. Die Zertifikatdienste müssen online sein, damit die Sicherungsvorgänge erfolgreich sind.
