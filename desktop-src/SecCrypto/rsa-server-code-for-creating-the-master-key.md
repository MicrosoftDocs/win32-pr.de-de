---
description: Das folgende Beispiel zeigt den typischen RSA/SChannel-serverseitigen Code zum Erstellen eines Haupt Schlüssels.
ms.assetid: 617cda1e-0619-4162-85eb-d1f5aa35fd1c
title: RSA-Server Code zum Erstellen des Haupt Schlüssels
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106348640"
---
# <a name="rsa-server-code-for-creating-the-master-key"></a><span data-ttu-id="18d7e-103">RSA-Server Code zum Erstellen des Haupt Schlüssels</span><span class="sxs-lookup"><span data-stu-id="18d7e-103">RSA Server Code for Creating the Master Key</span></span>

<span data-ttu-id="18d7e-104">Das folgende Beispiel zeigt den typischen RSA/SChannel-serverseitigen Code zum Erstellen eines [*Haupt Schlüssels*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="18d7e-104">The following example shows typical RSA/Schannel server-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
