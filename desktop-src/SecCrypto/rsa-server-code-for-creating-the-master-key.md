...
---
# <a name="rsa-server-code-for-creating-the-master-key"></a>RSA-Server Code zum Erstellen des Haupt Schlüssels

Das folgende Beispiel zeigt den typischen RSA/SChannel-serverseitigen Code zum Erstellen eines [*Haupt Schlüssels*](../secgloss/m-gly.md).
