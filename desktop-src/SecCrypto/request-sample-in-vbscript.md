...
---
# <a name="request-sample-in-vbscript"></a>Anforderungs Beispiel in VBScript

Der folgende VBScript-Beispielcode zeigt, wie das Zertifikat Registrierungs Steuerelement mit dem ccertrequest-Objekt verwendet werden kann, um eine [*Zertifikat Anforderung*](../secgloss/c-gly.md)zu erstellen und zu übermitteln.
