---
description: Der folgende VBScript-Beispielcode zeigt, wie die Zertifikatregistrierungssteuerung mit dem CCertRequest-Objekt verwendet werden kann, um eine Zertifikatanforderung zu erstellen und zu übermitteln.
ms.assetid: be1bc66a-7bc5-4369-9344-168af53fdfb9
title: Anforderungsbeispiel in VBScript
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "118900585"
---
# <a name="request-sample-in-vbscript"></a>Anforderungsbeispiel in VBScript

Der folgende VBScript-Beispielcode zeigt, wie die Zertifikatregistrierungssteuerung mit dem CCertRequest-Objekt verwendet werden kann, um eine Zertifikatanforderung zu erstellen [*und zu übermitteln.*](../secgloss/c-gly.md)
