...
---
# <a name="esentdataexception-members"></a>Esentdataexception-Member
...
Der [esentdataexception](./esentdataexception-class.md) -Typ macht die folgenden Member verfügbar.
...
<td>Initialisiert eine neue Instanz der esentdataexception-Klasse. Dieser Konstruktor wird verwendet, um eine serialisierte Ausnahme zu deserialisieren.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Geschützte Methode" alt="Protected method" /></td>
<td><a href="dn274233(v=exchg.10).md">Esentdataexception (Zeichenfolge, JET_err)</a></td>
<td>Initialisiert eine neue Instanz der esentdataexception-Klasse.</td>
</tr>
</tbody>
</table>
