---
description: 'Weitere Informationen finden Sie unter: esentdistributedtransaktionalleseryprepareddecommitexception-Member'
title: Esentdistributedtransaktionalleserypreparedtrecommitexception-Elemente
...
ms.locfileid: "104568344"
---
# <a name="esentdistributedtransactionalreadypreparedtocommitexception-members"></a>Esentdistributedtransaktionalleserypreparedtrecommitexception-Elemente

Geschützte Member einschließen  
Geerbte Member einschließen  

Basisklasse für JET_err. Distributedtransaktionalleserypreparedycommit-Ausnahmen.

Der [esentdistributedtransaktionalleseryprepareddecommitexception](./esentdistributedtransactionalreadypreparedtocommitexception-class.md) -Typ macht die folgenden Member verfügbar.
...
<td><a href="dn334492(v=exchg.10).md">Esentdistributedtransaktionalleserypreparedumcommitexception</a></td>
<td>Initialisiert eine neue Instanz der esentdistributedtransaktionalumcommitexception-Klasse.</td>
</tr>
</tbody>
</table>
...
<td>Legt beim Überschreiben in einer abgeleiteten Klasse die <a href="/dotnet/api/system.runtime.serialization.serializationinfo">SerializationInfo</a> mit Informationen zur Ausnahme fest. (Geerbt von " <a href="dn274314(v=exchg.10).md">esenterrorexception</a>".)</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Öffentliche Methode" alt="Public method" /></td>
...
[Esentdistributedtransaktionalleserypreparedtrecommitexception-Klasse](./esentdistributedtransactionalreadypreparedtocommitexception-class.md)
