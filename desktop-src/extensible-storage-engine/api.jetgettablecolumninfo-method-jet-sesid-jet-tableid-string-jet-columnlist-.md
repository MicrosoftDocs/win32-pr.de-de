...
---
# <a name="apijetgettablecolumninfo-method-jet_sesid-jet_tableid-string-jet_columnlist"></a>API. jetgettablecolumninfo-Methode (JET_SESID, JET_TABLEID, String, JET_COLUMNLIST)

Ruft Informationen zu allen Spalten in der Tabelle ab.
