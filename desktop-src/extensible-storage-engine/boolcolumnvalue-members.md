---
description: 'Weitere Informationen finden Sie hier: boolcolumnvalue-Member'
title: Boolcolumnvalue-Member
...
ms.locfileid: "104570057"
---
# <a name="boolcolumnvalue-members"></a>Boolcolumnvalue-Member
...
Der [boolcolumnvalue](./boolcolumnvalue-class.md) -Typ macht die folgenden Member verfügbar.
...
<td>Ruft den letzten Satz oder abgerufenen Wert der Spalte ab. Der Wert wird als generisches-Objekt zurückgegeben. (Überschreibt <a href="dn334226(v=exchg.10).md">columnvalueobstruct &lt; T &gt; . Valueasobject</a>.)</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Geschützte Methode" alt="Protected method" /></td>
<td><a href="dn334119(v=exchg.10).md">Getvaluefromb</a></td>
