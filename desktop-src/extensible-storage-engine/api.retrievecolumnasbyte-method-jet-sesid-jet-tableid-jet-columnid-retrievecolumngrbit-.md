---
description: Erfahren Sie mehr über die Api.RetrieveColumnAsByte-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID, RetrieveColumnGrbit).
title: Api.RetrieveColumnAsByte-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID, RetrieveColumnGrbit)
...
ms.locfileid: "118983023"
---
# <a name="apiretrievecolumnasbyte-method-jet_sesid-jet_tableid-jet_columnid-retrievecolumngrbit"></a>Api.RetrieveColumnAsByte-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID, RetrieveColumnGrbit)
