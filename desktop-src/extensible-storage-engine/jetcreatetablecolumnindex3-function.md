...
Die **JetCreateTableColumnIndex3-Funktion** erstellt eine Tabelle in einer ESE-Datenbank mit einem anfänglichen Satz von Indizes und einem anfänglichen Satz [von](./jet-tablecreate3-structure.md) Spalten aus einem Array JET_TABLECREATE3 Strukturen. Die [JET_TABLECREATE3-Struktur](./jet-tablecreate3-structure.md) ermöglicht die Angabe einer Rückruffunktion.
...
Ein Zeiger auf eine [JET_TABLECREATE3](./jet-tablecreate3-structure.md) Struktur, die die zu erstellende Tabelle definiert. Weitere [JET_TABLECREATE3](./jet-tablecreate3-structure.md) finden Sie unter .2016.
...
| <p>JET_errCannotNestDDL</p> | <p>Wenn ptablecreate- &gt; grbit JET_bitTableCreateTemplateTable, ptablecreate- &gt; szTemplateTableName ist jedoch auf NULL festgelegt.</p> | 
...
| <p>JET_errDensityInvalid</p> | <p>Dieser Fehler wird zurückgegeben, wenn der <strong>ulDensity-Member</strong> der JET_INDEXCREATE2-Struktur auf eine Zahl kleiner als 20 oder mehr als 100 festgelegt ist. <a href="gg294082(v=exchg.10).md"></a></p> | 
...
| <p>JET_errIndexTuplesNonUniqueOnly</p> | <p>Windows XP und neuere Versionen Windows. Ein Tupelindex kann nicht eindeutig sein (d. h. der <em>Grbit-Member</em> der <a href="gg294082(v=exchg.10).md">JET_INDEXCREATE2-Struktur</a> darf nicht sowohl JET_bitIndexPrimary als auch JET_bitIndexUnique haben).</p> | 
...
| <p>JET_errIndexTuplesVarSegMacNotAllowed</p> | <p>Windows XP und neuere Versionen Windows. Ein Tupelindex lässt das Festlegen des <strong>cbVarSegMac-JET_INDEXCREATE2</strong> struktur nicht zu. <a href="gg294082(v=exchg.10).md"></a></p> | 
...
| | | <p><strong>Client</strong></p> | <p>Erfordert Windows Vista oder Windows XP.</p> | | <p><strong>Server</strong></p> | <p>Erfordert Windows Server 2008 oder Windows Server 2003.</p> | | <p><strong>Header</strong></p> | <p>Deklariert in Esent.h.</p> | | <p><strong>Bibliothek</strong></p> | <p>Verwenden Sie ESENT.lib.</p> | | <p><strong>DLL</strong></p> | <p>Erfordert ESENT.dll.</p> | | <p><strong>Unicode</strong></p> | <p>Implementiert als <strong>JetCreateTableColumnIndex3W</strong> (Unicode) und <strong>JetCreateTableColumnIndex3A</strong> (ANSI).</p> | 
