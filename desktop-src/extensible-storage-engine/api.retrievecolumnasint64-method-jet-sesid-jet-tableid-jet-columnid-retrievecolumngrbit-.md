...
---
# <a name="apiretrievecolumnasint64-method-jet_sesid-jet_tableid-jet_columnid-retrievecolumngrbit"></a>API. RetrieveColumnAsInt64-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID, retrievecolenngrbit)
