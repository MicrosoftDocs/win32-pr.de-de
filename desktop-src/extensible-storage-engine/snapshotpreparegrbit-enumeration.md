...
---
# <a name="snapshotpreparegrbit-enumeration"></a>Snapshotpreparegrbit-Enumeration

Optionen für [jedessnapshotprepare (JET_OSSNAPID, snapshotpreparegrbit)](./api.jetossnapshotprepare-method.md).
...
<td>Es werden nur Protokolldateien erstellt.</td>
</tr>
<tr class="odd">
<td></td>
<td>Copysnapshot</td>
<td>Eine Kopier Momentaufnahme (normal oder inkrementell) ohne Protokoll abkürzen.</td>
</tr>
</tbody>
</table>
