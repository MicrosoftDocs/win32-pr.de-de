...
---
# <a name="apijetdeleteindex-method"></a>API. jetdelta eteindex-Methode

Löscht einen Index aus einer Datenbanktabelle.
...
<!-- end list -->
  ...
  - TableID  
    ...
    Ein Cursor für die Tabelle, aus der der Index gelöscht werden soll.
