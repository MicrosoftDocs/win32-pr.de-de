...
Lokaler Speicher für einen ESENT-handle. Wird von [jetgetls (JET_SESID, JET_TABLEID, JET_LS, lsgrbit)](./api.jetgetls-method.md) und [jetsetls (JET_SESID, JET_TABLEID, JET_LS, lsgrbit)](./api.jetsetls-method.md)verwendet.
