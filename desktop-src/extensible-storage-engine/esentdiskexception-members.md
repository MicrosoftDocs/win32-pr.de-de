---
description: Weitere Informationen finden Sie in den esentdiskexception-Membern.
title: Esentdiskexception-Member
...
ms.locfileid: "104560400"
---
# <a name="esentdiskexception-members"></a>Esentdiskexception-Member
...
Der [esentdiskexception](./esentdiskexception-class.md) -Typ macht die folgenden Member verfügbar.
...
<td>Initialisiert eine neue Instanz der esentdiskexception-Klasse. Dieser Konstruktor wird verwendet, um eine serialisierte Ausnahme zu deserialisieren.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Geschützte Methode" alt="Protected method" /></td>
<td><a href="dn274282(v=exchg.10).md">Esentdiskexception (Zeichenfolge, JET_err)</a></td>
<td>Initialisiert eine neue Instanz der esentdiskexception-Klasse.</td>
</tr>
</tbody>
</table>
