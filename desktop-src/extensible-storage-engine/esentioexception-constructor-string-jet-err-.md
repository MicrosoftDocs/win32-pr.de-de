...
---
# <a name="esentioexception-constructor-string-jet_err"></a>Esentioexception-Konstruktor (Zeichenfolge, JET_err)

Initialisiert eine neue Instanz der esentioexception-Klasse.
