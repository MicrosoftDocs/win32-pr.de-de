...
---
# <a name="jet_indexlistcolumnidccolumn-property"></a>JET_INDEXLIST. columnidccolumn (Eigenschaft)

Ruft das ColumnID der Spalte in der temporären Tabelle ab, in der die Anzahl der Spalten im Index Schlüssel gespeichert wird. Die Spalte ist vom Typ [Long](./jet-coltyp-enumeration.md).
