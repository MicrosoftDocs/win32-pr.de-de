---
description: 'Weitere Informationen finden Sie unter: JET_INDEXCREATE2 Struktur'
...
|--------------|----------------|
| <p>JET_bitIndexUnique</p> | <p>Doppelte Indexeinträge (Schlüssel) sind nicht verfügbar. Dies wird erzwungen, wenn <a href="gg269288(v=exchg.10).md">JetUpdate</a> aufgerufen wird, nicht, wenn <a href="gg294137(v=exchg.10).md">JetSetColumn</a> aufgerufen wird.</p> | 
...
| <p>JET_bitIndexDisallowNull</p> | <p>Keine der Spalten, für die der Index erstellt wird, darf einen <strong>NULL-Wert</strong> enthalten.</p> | 
