...
---
# <a name="jet_indexrange-methods"></a>JET_INDEXRANGE Methoden

Geschützte Member einschließen  
Geerbte Member einschließen  

Der [JET_INDEXRANGE](./jet-indexrange-class.md) -Typ macht die folgenden Member verfügbar.
...
<td>Gibt eine <a href="/dotnet/api/system.string">Zeichenfolge</a> zurück, die den aktuellen <a href="dn335175(v=exchg.10).md">JET_INDEXRANGE</a>darstellt. (Überschreibt <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object.-Zeichenfolge ()</a>.)</td>
</tr>
</tbody>
</table>
