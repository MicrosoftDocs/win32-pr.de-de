...
---
# <a name="apideserializeobjectfromcolumn-method-jet_sesid-jet_tableid-jet_columnid-retrievecolumngrbit"></a>API. deserializeobjectfromcolumn-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID, retrievecolenngrbit)
...
<!-- end list -->
  ...
  - grbit  
    ...
    Die zu verwendenden Abruf Optionen.
