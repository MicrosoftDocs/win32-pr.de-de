...
---
# <a name="jet_dbinfomisclgposconsistent-property"></a>JET_DBINFOMISC. lgposkonsistente-Eigenschaft

Ruft die LGPOs ab, wenn die Datenbank konsistent gemacht wurde. Dieser Wert ist NULL, wenn die Datenbank inkonsistent ist.
