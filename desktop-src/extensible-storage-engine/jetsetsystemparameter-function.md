...
| <p><strong>Unicode</strong></p> | <p>Implementiert als <strong>JetSetSystemParameterW</strong> (Unicode) und <strong>JetSetSystemParameterA</strong> (ANSI).</p> | 
