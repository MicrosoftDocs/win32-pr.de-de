...
---
# <a name="snapshottruncateloggrbit-enumeration"></a>Snapshottrungateloggrbit-Enumeration

Optionen für [jedessnapshottruneurelog (JET_OSSNAPID, snapshottrungateloggrbit)](./vistaapi.jetossnapshottruncatelog-method.md) und [jedessnapshottrungateloginstance (JET_OSSNAPID, JET_INSTANCE, snapshottruneureloggrbit)](./vistaapi.jetossnapshottruncateloginstance-method.md).
...
<td></td>
<td>Keine</td>
<td>Es erfolgt kein abschneiden.</td>
</tr>
<tr class="even">
<td></td>
<td>Alldatabasess napshot</td>
<td>Alle Datenbanken werden angefügt, sodass die Speicher-Engine die Protokoll Verkürzung berechnen und durchführen kann.</td>
</tr>
</tbody>
</table>
