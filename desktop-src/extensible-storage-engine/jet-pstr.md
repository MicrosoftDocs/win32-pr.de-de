---
description: 'Weitere Informationen zu: JET_PSTR'
title: JET_PSTR
TOCTitle: JET_PSTR
...
Der JET_PSTR Datentyp enthält eine AUF NULL endende ASCII-Zeichenfolge (char \* ).
...
NULL-terminiert, ASCII-Zeichenfolge (char \* ).
