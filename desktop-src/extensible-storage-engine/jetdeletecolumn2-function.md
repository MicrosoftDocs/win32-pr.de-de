...
| <p><strong>Unicode</strong></p> | <p>Implementiert als <strong>JetDeleteColumn2W</strong> (Unicode) und <strong>JetDeleteColumn2A</strong> (ANSI).</p> | 
