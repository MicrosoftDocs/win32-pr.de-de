...
---
# <a name="apiretrievecolumns-method"></a>API. retrievecolumschlag-Methode
...
<!-- end list -->
  ...
  - TableID  
    ...
    Der Cursor Ruft die Daten aus ab. Der Cursor muss auf einem Datensatz positioniert werden.
