...
---
# <a name="apiretrievecolumnasstring-method-jet_sesid-jet_tableid-jet_columnid-encoding"></a>API. retrievecolennasstring-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID, Codierung)
