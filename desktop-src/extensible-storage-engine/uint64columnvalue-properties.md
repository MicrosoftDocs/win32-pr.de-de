---
description: 'Weitere Informationen finden Sie hier: UInt64ColumnValue-Eigenschaften'
title: UInt64ColumnValue-Eigenschaften
...
ms.locfileid: "104347959"
---
# <a name="uint64columnvalue-properties"></a>UInt64ColumnValue-Eigenschaften

Geschützte Member einschließen  
Geerbte Member einschließen  

Der [UInt64ColumnValue](./uint64columnvalue-class.md) -Typ macht die folgenden Member verfügbar.
...
<td><a href="dn351260(v=exchg.10).md">Größe</a></td>
