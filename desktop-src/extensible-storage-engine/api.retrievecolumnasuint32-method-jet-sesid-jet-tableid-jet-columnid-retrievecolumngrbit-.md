---
description: 'Weitere Informationen finden Sie unter: Api.RetrieveColumnAsUInt32-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID, RetrieveColumnGrbit)'
title: Api.RetrieveColumnAsUInt32-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID, RetrieveColumnGrbit)
...
ms.locfileid: "119977125"
---
# <a name="apiretrievecolumnasuint32-method-jet_sesid-jet_tableid-jet_columnid-retrievecolumngrbit"></a>Api.RetrieveColumnAsUInt32-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID, RetrieveColumnGrbit)
...
Die aus der Spalte als UInt32 abgerufenen Daten. NULL, wenn die Spalte NULL ist.  
