---
description: 'Weitere Informationen finden Sie unter: Api.JetSeek-Methode'
...
ms.locfileid: "118783803"
---
# <a name="apijetseek-method"></a>Api.JetSeek-Methode

Positioniert einen Cursor effizient an einem Indexeintrag, der den durch den Suchschlüssel in diesem Cursor angegebenen Suchkriterien und der angegebenen Ungleichheit entspricht. Ein Suchschlüssel muss zuvor mit [JetMakeKey(JET_SESID, JET_TABLEID, \[ \] , Int32, MakeKeyGrbit) erstellt worden sein.](./api.jetmakekey-method.md) Siehe auch [TrySeek(JET_SESID, JET_TABLEID, SeekGrbit).](./api.tryseek-method.md)
