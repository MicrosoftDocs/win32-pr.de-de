---
description: 'Weitere Informationen finden Sie unter: InstanceParameters.EnableDbScanInRecovery-Eigenschaft'
title: InstanceParameters.EnableDbScanInRecovery (Eigenschaft)
...
ms.locfileid: "119834390"
---
# <a name="instanceparametersenabledbscaninrecovery-property"></a>InstanceParameters.EnableDbScanInRecovery (Eigenschaft)

Ruft einen Wert ab, der angibt, ob die Datenbankwartung während der Wiederherstellung ausgeführt werden soll, oder legt diesen fest.
