...
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-byte"></a>API. SetColumn-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID, Byte)
...
<!-- end list -->
  ...
  - Daten  
    Typ: [System. Byte](/dotnet/api/system.byte)  
