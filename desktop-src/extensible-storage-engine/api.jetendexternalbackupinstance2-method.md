...
---
# <a name="apijetendexternalbackupinstance2-method"></a>API. JetEndExternalBackupInstance2-Methode
...
<!-- end list -->
  ...
  - grbit  
    Typ: [Microsoft. ISAM. ESENT. Interop. endexternalbackupgrbit](./endexternalbackupgrbit-enumeration.md)  
    
    Optionen, die angeben, wie die Sicherung beendet wurde.
