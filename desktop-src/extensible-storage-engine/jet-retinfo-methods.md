---
description: Weitere Informationen finden Sie unter JET_RETINFO Methoden.
title: JET_RETINFO Methoden
...
ms.locfileid: "119038778"
---
# <a name="jet_retinfo-methods"></a>JET_RETINFO Methoden

Geschützte Member enthalten  
Geerbte Member enthalten  

Der [JET_RETINFO](./jet-retinfo-class.md) macht die folgenden Member verfügbar.
...
<td>Gibt eine <a href="/dotnet/api/system.string">Zeichenfolge</a> zurück, die die <a href="dn335277(v=exchg.10).md">aktuelle</a>JET_RETINFO. (Überschreibt <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object.ToString()</a>.)</td>
</tr>
</tbody>
</table>
