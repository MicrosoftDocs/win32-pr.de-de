---
description: 'Weitere Informationen finden Sie unter: Api.JetResetTableSequential-Methode'
...
ms.locfileid: "117902933"
---
# <a name="apijetresettablesequential-method"></a>Api.JetResetTableSequential-Methode

Benachrichtigt die Datenbank-Engine, dass die Anwendung nicht mehr den gesamten Index überprüft, auf dem der Cursor positioniert ist. Dieser Aufruf kehrt eine von [JetSetTableSequential(JET_SESID, JET_TABLEID, SetTableSequentialGrbit)](./api.jetsettablesequential-method.md)gesendete Benachrichtigung um.
...
<!-- end list -->
  ...
  - tableid  
    ...
    Der Cursor, der auf die Daten zugegriffen hat.

<!-- end list -->

  - grbit  
    Typ: [Microsoft.Isam.Esent.Interop.ResetTableSequentialGrbit](./resettablesequentialgrbit-enumeration.md)  
