---
description: Weitere Informationen finden Sie unter JetResetTableSequential-Funktion.
...
ms.locfileid: "122482796"
---
# <a name="jetresettablesequential-function"></a>JetResetTableSequential-Funktion
...
Die **JetResetTableSequential-Funktion** benachrichtigt die Datenbank-Engine, dass die Anwendung nicht mehr den gesamten aktuellen Index überprüft, der einen bestimmten Cursor enthält. Dieser Aufruf kehrt eine von [JetSetTableSequential](./jetsettablesequential-function.md)gesendete Benachrichtigung um.

**Windows XP:****JetResetTableSequential** wird in xp Windows eingeführt.   
...
Bei Erfolg ist der aktuelle Index des Cursors nicht mehr für einen sequenziellen Scan des gesamten Indexes optimiert. Es erfolgt keine Änderung des Datenbankstatus.

Bei einem Fehler erfolgt keine Änderung an der Konfiguration des Cursors. Es erfolgt keine Änderung des Datenbankstatus.

#### <a name="remarks"></a>Hinweise

Es ist sicher, diesen Aufruf für einen Cursor zu verwenden, der zuvor nicht durch einen Aufruf von [JetSetTableSequential konfiguriert wurde.](./jetsettablesequential-function.md)
