...
Die **JetResetTableSequential-Funktion** benachrichtigt die Datenbank-Engine, dass die Anwendung nicht mehr den gesamten aktuellen Index mit einem angegebenen Cursor scannt. Dieser Aufruf kehrt eine von [JetSetTableSequential](./jetsettablesequential-function.md)gesendete Benachrichtigung um.
...
Es ist sicher, diesen Aufruf für einen Cursor zu tätigen, der zuvor nicht durch einen Aufruf von [JetSetTableSequential](./jetsettablesequential-function.md)konfiguriert wurde.
