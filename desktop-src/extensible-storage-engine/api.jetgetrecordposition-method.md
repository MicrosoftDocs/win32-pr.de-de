---
description: 'Weitere Informationen finden Sie unter: Api.JetGetRecordPosition-Methode'
...
ms.locfileid: "119042558"
---
# <a name="apijetgetrecordposition-method"></a>Api.JetGetRecordPosition-Methode

Gibt die Bruchposition des aktuellen Datensatzes im aktuellen Index in Form einer [JET_RECPOS-Struktur](./jet-recpos-class.md) zurück. Siehe auch [JetGotoPosition(JET_SESID, JET_TABLEID, JET_RECPOS)](./api.jetgotoposition-method.md).
...
<!-- end list -->
  ...
  - tableid  
    ...
    Der Cursor, der auf dem Datensatz positioniert ist.
...
<!-- end list -->
  ...
  - recpos  
    ...
    Gibt die ungefähre Bruchposition des Datensatzes zurück.
