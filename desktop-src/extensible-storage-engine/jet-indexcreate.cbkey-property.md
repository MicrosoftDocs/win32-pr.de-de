---
description: 'Weitere Informationen finden Sie unter: JET_INDEXCREATE. cbkey-Eigenschaft'
title: JET_INDEXCREATE. cbkey (Eigenschaft)
...
ms.locfileid: "103759114"
---
# <a name="jet_indexcreatecbkey-property"></a>JET_INDEXCREATE. cbkey (Eigenschaft)

Ruft die Länge von szkey (in Zeichen) ab, einschließlich der beiden abschließenden Nullen, oder legt diese fest.
