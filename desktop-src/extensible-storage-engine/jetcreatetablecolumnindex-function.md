...
---
# <a name="jetcreatetablecolumnindex-function"></a>Jetkreatetablecolumnindex-Funktion
...
Die **jetkreatetablecolumnindex** -Funktion erstellt eine Tabelle in einer ESE-Datenbank mit einem anfänglichen Satz von Indizes und einem anfänglichen Satz von Spalten aus einem Array von [JET_TABLECREATE](./jet-tablecreate-structure.md) Strukturen. Der Name **jetkreatetablecolumnindex** stammt aus der Reihenfolge, in der die Objekte erstellt werden. Zuerst werden eine Tabelle, Spalten und schließlich Indizes erstellt.
...
Der Aufruf von **jetcreatetablecolumnindex** ist mit dem Aufrufen von [JetCreateTableColumnIndex2](./jetcreatetablecolumnindex2-function.md)identisch, wobei jedes Feld in der [JET_TABLECREATE2](./jet-tablecreate2-structure.md) Struktur den Wert des entsprechenden Felds [JET_TABLECREATE](./jet-tablecreate-structure.md)mit den folgenden Ausnahmen enthält:

  - JET_TABLECREATE2. cbStruct auf sizeof (JET_TABLECREATE2) festgelegt.

  - JET_TABLECREATE2. szcallback auf NULL festgelegt

  - JET_TABLECREATE2. cbyp auf "0" festgelegt.
...
<td><p>Implementiert als <strong>jetkreatetablecolumnindexw</strong> (Unicode) und <strong>jetkreatetablecolumnindexa</strong> (ANSI).</p></td>
</tr>
</tbody>
</table>
