...
---
# <a name="apijetretrievecolumn-method-jet_sesid-jet_tableid-jet_columnid-byte--int32-int32-retrievecolumngrbit-jet_retinfo"></a>API. jetretrievecolumschlag-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID, Byte, Int32, Int32, retrievecolumgengrbit, JET_RETINFO)
...
Die Funktion "retrievecolumschlag NAS" stellt DataType-spezifische Abruf Funktionen bereit.
