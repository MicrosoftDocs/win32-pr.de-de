---
description: 'Weitere Informationen finden Sie unter: BytesColumnValue.Value-Eigenschaft'
...
ms.locfileid: "117717098"
---
# <a name="bytescolumnvaluevalue-property"></a>BytesColumnValue.Value-Eigenschaft
