---
description: Weitere Informationen finden Sie unter Api.RetrieveColumnAsDouble-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID)
title: Api.RetrieveColumnAsDouble-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID)
...
ms.locfileid: "119840360"
---
# <a name="apiretrievecolumnasdouble-method-jet_sesid-jet_tableid-jet_columnid"></a>Api.RetrieveColumnAsDouble-Methode (JET_SESID, JET_TABLEID, JET_COLUMNID)

Ruft einen double-Spaltenwert aus dem aktuellen Datensatz ab. Der Datensatz ist der Datensatz, der dem Indexeintrag an der aktuellen Position des Cursors zugeordnet ist.
