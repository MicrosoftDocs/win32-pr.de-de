...
---
# <a name="bytecolumnvalue-members"></a>Bytecolumnvalue-Member

Geschützte Member einschließen  
Geerbte Member einschließen  

Ein [Byte](/dotnet/api/system.byte) Spaltenwert.

Der [bytecolumnvalue](./bytecolumnvalue-class.md) -Typ macht die folgenden Member verfügbar.
...
<td><a href="dn334116(v=exchg.10).md">Größe</a></td>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Geschützte Methode" alt="Protected method" /></td>
<td><a href="dn334114(v=exchg.10).md">Getvaluefromb</a></td>
