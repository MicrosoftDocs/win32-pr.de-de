---
description: Weitere Informationen zu ByteColumnValue-Membern
...
Ein [](/dotnet/api/system.byte) Bytespaltenwert.

Der [ByteColumnValue-Typ](./bytecolumnvalue-class.md) macht die folgenden Member verfügbar.
