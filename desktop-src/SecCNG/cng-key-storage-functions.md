---
description: 'Kryptografie-API: Next Generation (CNG) definiert die folgenden Funktionen, die zum Ausführen von CNG-Schlüsselspeichervorgängen verwendet werden.'
ms.assetid: b0fb174b-75d7-4203-88ab-8469fa85f208
title: CNG-Storage Funktionen
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118908261"
---
# <a name="cng-key-storage-functions"></a>CNG-Storage Funktionen

Kryptografie-API: Next Generation (CNG) definiert die folgenden Funktionen, die zum Ausführen von CNG-Schlüsselspeichervorgängen verwendet werden.
