---
description: 'Kryptografie-API: Next Generation (CNG) definiert die folgenden Funktionen, die mit dem CNG-Kryptografiekonfigurationssystem verwendet werden.'
...
ms.locfileid: "118908807"
---
# <a name="cng-cryptographic-configuration-functions"></a>CNG Cryptographic Configuration Functions

Kryptografie-API: Next Generation (CNG) definiert die folgenden Funktionen, die mit dem CNG-Kryptografiekonfigurationssystem verwendet werden.
