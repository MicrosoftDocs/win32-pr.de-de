---
title: WinSAT-Schema
description: Sie können das Windows-System Bewertungs Tool (WinSAT) verwenden, um gültige XPath-Abfragen für die Durchführung zu ermitteln.
...
ms.locfileid: "103855775"
---
# <a name="winsat-schema"></a><span data-ttu-id="14de1-103">WinSAT-Schema</span><span class="sxs-lookup"><span data-stu-id="14de1-103">WinSAT Schema</span></span>

<span data-ttu-id="14de1-104">\[WinSAT-Enumerationen können nach Windows 8.1 geändert oder für Releases nicht verfügbar sein.\]</span><span class="sxs-lookup"><span data-stu-id="14de1-104">\[WinSAT enumerations may be altered or unavailable for releases after Windows 8.1.\]</span></span>

<span data-ttu-id="14de1-105">Sie können das Windows-System Bewertungs Tool (WinSAT) verwenden, um gültige XPath-Abfragen für die Durchführung zu ermitteln.</span><span class="sxs-lookup"><span data-stu-id="14de1-105">You can use the Windows System Assessment Tool (WinSAT) schema to determine valid XPath queries to run.</span></span> <span data-ttu-id="14de1-106">Informationen zum Ausführen einer XPath-Abfrage finden Sie unter einer der folgenden Methoden:</span><span class="sxs-lookup"><span data-stu-id="14de1-106">To run an XPath query, see one of the following methods:</span></span>

-   [<span data-ttu-id="14de1-107">**Iqueryallwinsatassessments:: get \_ allxml**</span><span class="sxs-lookup"><span data-stu-id="14de1-107">**IQueryAllWinSATAssessments::get\_AllXML**</span></span>](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml)
-   [<span data-ttu-id="14de1-108">**Iqueryrecentwinsatassessment:: get \_ XML**</span><span class="sxs-lookup"><span data-stu-id="14de1-108">**IQueryRecentWinSATAssessment::get\_XML**</span></span>](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryrecentwinsatassessment-get_xml)

<span data-ttu-id="14de1-109">Das **WinSAT** -Element kann ein **winsatassessments** -Element als übergeordnetes Element aufweisen, wenn Sie die [**get \_ allxml**](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml) -Methode aufrufen.</span><span class="sxs-lookup"><span data-stu-id="14de1-109">The **WinSAT** element can have a **WinsatAssessments** element as a parent element when you call the [**get\_AllXML**](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml) method.</span></span>

<span data-ttu-id="14de1-110">Im folgenden finden Sie das WinSAT-Schema, das Sie verwenden können, um den XPath zu bestimmen.</span><span class="sxs-lookup"><span data-stu-id="14de1-110">The following is the WinSAT schema that you can use to determine the XPath.</span></span>
