...
---
# <a name="cc-code-example-retrieving-trigger-strings"></a>C/C++-Code Beispiel: Abrufen von auslöserzeichenfolgen

In diesem Beispiel wird eine triggerzeichenfolge für alle Trigger abgerufen, die mit einer bekannten Aufgabe verknüpft sind.
