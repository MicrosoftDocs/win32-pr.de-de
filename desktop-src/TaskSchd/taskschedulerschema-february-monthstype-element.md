---
title: February -Element (monthsType)
...
ms.locfileid: "118611922"
---
# <a name="february-monthstype-element"></a>February -Element (monthsType)
...
Das **February-Element** wird durch den komplexen [**Typ monthsType**](taskschedulerschema-monthstype-complextype.md) definiert.
...
Der folgende XML-Code definiert einen Monatskalender, in dem die Aufgabe im Februar ausgeführt wird.
