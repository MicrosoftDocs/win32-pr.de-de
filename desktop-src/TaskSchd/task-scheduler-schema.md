...
---
# <a name="task-scheduler-schema"></a><span data-ttu-id="43d6d-105">Taskplaner-Schema</span><span class="sxs-lookup"><span data-stu-id="43d6d-105">Task Scheduler Schema</span></span>

<span data-ttu-id="43d6d-106">Das Taskplaner Schema definiert gültiges XML, das zum Registrieren von Tasks beim Taskplaner-Dienst verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="43d6d-106">The Task Scheduler schema defines valid XML used to register tasks with the Task Scheduler service.</span></span> <span data-ttu-id="43d6d-107">Entwickler können Ihren eigenen XML-Code erstellen, ihn anhand dieses Schemas überprüfen und Aufgaben mit der [**ITaskFolder:: RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) -Methode registrieren.</span><span class="sxs-lookup"><span data-stu-id="43d6d-107">Developers can create their own XML, validate it against this schema, and register tasks using the [**ITaskFolder::RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) method.</span></span>

<span data-ttu-id="43d6d-108">Die Typen und Elemente des Taskplaner Schemas sind in den folgenden Abschnitten einzeln dokumentiert.</span><span class="sxs-lookup"><span data-stu-id="43d6d-108">The types and elements of the Task Scheduler schema are individually documented in the following sections.</span></span>

-   [<span data-ttu-id="43d6d-109">Schema Elemente Taskplaner</span><span class="sxs-lookup"><span data-stu-id="43d6d-109">Task Scheduler Schema Elements</span></span>](task-scheduler-schema-elements.md)
-   [<span data-ttu-id="43d6d-110">Einfache Typen von Taskplaner Schemas</span><span class="sxs-lookup"><span data-stu-id="43d6d-110">Task Scheduler Schema Simple Types</span></span>](task-scheduler-schema-simple-types.md)
-   [<span data-ttu-id="43d6d-111">Komplexe Typen von Taskplaner Schemas</span><span class="sxs-lookup"><span data-stu-id="43d6d-111">Task Scheduler Schema Complex Types</span></span>](task-scheduler-schema-complex-types.md)
-   [<span data-ttu-id="43d6d-112">Schema Gruppen Taskplaner</span><span class="sxs-lookup"><span data-stu-id="43d6d-112">Task Scheduler Schema Groups</span></span>](task-scheduler-schema-groups.md)

<span data-ttu-id="43d6d-113">Das gesamte Taskplaner Schema wird durch die folgende XSD-Datei definiert.</span><span class="sxs-lookup"><span data-stu-id="43d6d-113">The entire Task Scheduler schema is defined by the following XSD file.</span></span>
