...
---
# <a name="cc-code-example-setting-application-name"></a>C/C++-Code Beispiel: Festlegen des Anwendungs namens

In diesem Beispiel wird der Name der Anwendung festgelegt, die einer bekannten Aufgabe zugeordnet ist. In diesem Beispiel wird davon ausgegangen, dass der Task "Testaufgabe" bereits auf dem lokalen Computer vorhanden ist und der Taskplaner-Dienst ausgeführt wird.
