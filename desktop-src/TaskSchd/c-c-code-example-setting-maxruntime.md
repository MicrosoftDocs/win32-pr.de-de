...
---
# <a name="cc-code-example-setting-maxruntime"></a>C/C++-Code Beispiel: Festlegen von maxruntime

In diesem Beispiel wird die maximale Laufzeit (festgelegt in Millisekunden) einer bekannten Aufgabe festgelegt. In diesem Beispiel wird davon ausgegangen, dass der Task und die Testaufgabe bereits auf dem lokalen Computer vorhanden sind.
