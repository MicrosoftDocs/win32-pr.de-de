...
---
# <a name="cc-code-example-setting-working-directory"></a>C/C++-Code Beispiel: Festlegen des Arbeitsverzeichnisses

In diesem Beispiel wird das Arbeitsverzeichnis einer bekannten Aufgabe festgelegt. In diesem Beispiel wird davon ausgegangen, dass der Task und die Testaufgabe bereits auf dem lokalen Computer vorhanden sind.
