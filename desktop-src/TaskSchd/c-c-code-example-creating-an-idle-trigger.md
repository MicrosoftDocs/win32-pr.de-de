...
---
# <a name="cc-code-example-creating-an-idle-trigger"></a><span data-ttu-id="22dc1-104">C/C++-Code Beispiel: Erstellen eines Leerlauf-Auslösers</span><span class="sxs-lookup"><span data-stu-id="22dc1-104">C/C++ Code Example: Creating an Idle Trigger</span></span>

<span data-ttu-id="22dc1-105">In diesem Beispiel wird ein Leerlauf-Auslösung für eine vorhandene Aufgabe erstellt.</span><span class="sxs-lookup"><span data-stu-id="22dc1-105">This example creates an idle trigger for an existing task.</span></span> <span data-ttu-id="22dc1-106">Informationen zu Bedingungen im Leerlauf finden Sie unter [Aufgaben im Leerlauf](task-idle-conditions.md).</span><span class="sxs-lookup"><span data-stu-id="22dc1-106">For information about idle conditions, see [Task Idle Conditions](task-idle-conditions.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="22dc1-107">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="22dc1-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="22dc1-108">Taskplaner 1,0-Beispiele</span><span class="sxs-lookup"><span data-stu-id="22dc1-108">Task Scheduler 1.0 Examples</span></span>](task-scheduler-1-0-examples.md)
</dt> </dl>
