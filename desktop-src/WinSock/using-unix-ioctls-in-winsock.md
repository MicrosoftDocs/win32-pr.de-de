---
description: Der SIOCGIFCONF-Befehl, der von den meisten UNIX Implementierungen bereitgestellt wird, wird in Form von WSAIoctl- und WSPIoctl-Funktionen mit dem Befehl SIO \_ GET \_ INTERFACE LIST \_ unterstützt. Dieser Befehl gibt die Liste der konfigurierten Schnittstellen und deren Parameter zurück.
...
Der **SIOCGIFCONF-Befehl,** der von den meisten UNIX Implementierungen bereitgestellt wird, wird in Form von [**WSAIoctl-**](/windows/desktop/api/Winsock2/nf-winsock2-wsaioctl) und [**WSPIoctl-Funktionen**](/previous-versions/windows/hardware/network/ff566296(v=vs.85)) mit dem Befehl **SIO \_ GET INTERFACE \_ \_ LIST** unterstützt. Dieser Befehl gibt die Liste der konfigurierten Schnittstellen und deren Parameter zurück.
