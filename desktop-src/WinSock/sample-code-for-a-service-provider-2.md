...
---
# <a name="sample-code-for-a-service-provider"></a><span data-ttu-id="aef45-103">Beispiel Code für einen Dienstanbieter</span><span class="sxs-lookup"><span data-stu-id="aef45-103">Sample Code for a Service Provider</span></span>

<span data-ttu-id="aef45-104">Dieser Abschnitt enthält ein Quell Codebeispiel, das veranschaulicht, wie die **getxbyy** -Funktionen mithilfe der neuen, Protokoll unabhängigen RNR-Funktionen implementiert werden.</span><span class="sxs-lookup"><span data-stu-id="aef45-104">This section contains a source code sample that demonstrates how to implement the **GetXbyY** functions using the new, protocol-independent RNR functions.</span></span> <span data-ttu-id="aef45-105">Ein Entwickler sollte diese Funktionen als Ausgangspunkt implementieren.</span><span class="sxs-lookup"><span data-stu-id="aef45-105">A developer should implement these functions as a starting point.</span></span> <span data-ttu-id="aef45-106">Um die Windows Sockets-Spezifikation einzuhalten, werden viele weitere Funktionen benötigt.</span><span class="sxs-lookup"><span data-stu-id="aef45-106">To comply with the Windows Sockets specification, many more functions are needed.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="aef45-107">Die Kompilierung des folgenden Codes ist nicht garantiert.</span><span class="sxs-lookup"><span data-stu-id="aef45-107">The following code is not guaranteed to compile.</span></span>
