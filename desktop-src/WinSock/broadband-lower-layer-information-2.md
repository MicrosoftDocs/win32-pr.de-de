...
---
# <a name="broadband-lower-layer-information"></a><span data-ttu-id="e8d03-103">Informationen zu Informationen auf niedrigerer Ebene</span><span class="sxs-lookup"><span data-stu-id="e8d03-103">Broadband Lower Layer Information</span></span>

<span data-ttu-id="e8d03-104">In diesem Abschnitt wird die Typdefinition für die Informationen der niedrigeren Ebene für Breitband aufgeführt.</span><span class="sxs-lookup"><span data-stu-id="e8d03-104">This section lists the type definition for the broadband lower-layer information.</span></span>
