---
description: Der folgende Code ist die IP-agnostische Server. c-Datei, bei der es sich um eine IPv6-aktivierte Version der simples. c-Datei handelt.
...
ms.locfileid: "104129172"
---
# <a name="ipv6-enabled-server-code"></a><span data-ttu-id="fd227-103">IPv6-Enabled Server Code</span><span class="sxs-lookup"><span data-stu-id="fd227-103">IPv6-Enabled Server Code</span></span>

<span data-ttu-id="fd227-104">Der folgende Code ist die IP-agnostische Server. c-Datei, bei der es sich um eine IPv6-aktivierte Version der simples. c-Datei handelt.</span><span class="sxs-lookup"><span data-stu-id="fd227-104">The following code is the IP-agnostic Server.c file, which is an IPv6-enabled version of the Simples.c file.</span></span>
