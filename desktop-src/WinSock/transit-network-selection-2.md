...
---
# <a name="transit-network-selection"></a><span data-ttu-id="f0960-103">Transit Netzwerk Auswahl</span><span class="sxs-lookup"><span data-stu-id="f0960-103">Transit Network Selection</span></span>

<span data-ttu-id="f0960-104">In diesem Abschnitt sind die Werte aufgeführt, die für die Transit Netzwerk Auswahl verwendet werden</span><span class="sxs-lookup"><span data-stu-id="f0960-104">This section lists values used for the transit network selection.</span></span>
