---
description: In diesem Abschnitt werden die Werte aufgeführt, die für die Funktion Breitband Träger verwendet werden.
ms.assetid: 9e45ca17-2aec-42e5-88a5-5ef1dc4238d9
title: Breitband Träger Funktion
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104526201"
---
# <a name="broadband-bearer-capability"></a><span data-ttu-id="786f6-103">Breitband Träger Funktion</span><span class="sxs-lookup"><span data-stu-id="786f6-103">Broadband Bearer Capability</span></span>

<span data-ttu-id="786f6-104">In diesem Abschnitt werden die Werte aufgeführt, die für die Funktion Breitband Träger verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="786f6-104">This section lists the values used for the broadband bearer capability.</span></span>
