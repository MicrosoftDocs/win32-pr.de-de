---
description: Der folgende Code ist die IP-agnostische Client. c-Datei, bei der es sich um eine IPv6-aktivierte Version der simplec. c-Datei handelt.
...
ms.locfileid: "103958927"
---
# <a name="ipv6-enabled-client-code"></a><span data-ttu-id="e658b-103">IPv6-Enabled-Client Code</span><span class="sxs-lookup"><span data-stu-id="e658b-103">IPv6-Enabled Client Code</span></span>

<span data-ttu-id="e658b-104">Der folgende Code ist die IP-agnostische Client. c-Datei, bei der es sich um eine IPv6-aktivierte Version der simplec. c-Datei handelt.</span><span class="sxs-lookup"><span data-stu-id="e658b-104">The following code is the IP agnostic Client.c file, which is an IPv6-enabled version of the Simplec.c file.</span></span>
