...
---
# <a name="ipv6-enabled-client-code"></a>IPv6-Enabled-Client Code

Der folgende Code ist die IP-agnostische Client. c-Datei, bei der es sich um eine IPv6-aktivierte Version der simplec. c-Datei handelt.
