...
---
# <a name="using-secure-socket-extensions"></a><span data-ttu-id="404dd-103">Verwenden von Secure Socket Extensions</span><span class="sxs-lookup"><span data-stu-id="404dd-103">Using Secure Socket Extensions</span></span>

<span data-ttu-id="404dd-104">Der folgende Beispielcode veranschaulicht die Verwendung der Funktionen der Winsock-Secure Socket-Erweiterung.</span><span class="sxs-lookup"><span data-stu-id="404dd-104">The following example code demonstrates the usage of the Winsock secure socket extension functions.</span></span>

## <a name="securing-a-socket"></a><span data-ttu-id="404dd-105">Sichern eines Sockets</span><span class="sxs-lookup"><span data-stu-id="404dd-105">Securing a Socket</span></span>
...
## <a name="querying-the-security-on-a-socket"></a><span data-ttu-id="404dd-106">Abfragen der Sicherheit für einen Socket</span><span class="sxs-lookup"><span data-stu-id="404dd-106">Querying the Security on a Socket</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="404dd-107">Zugehörige Themen</span><span class="sxs-lookup"><span data-stu-id="404dd-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="404dd-108">Informationen zur Windows-Filter Plattform</span><span class="sxs-lookup"><span data-stu-id="404dd-108">About Windows Filtering Platform</span></span>](../fwp/about-windows-filtering-platform.md)
</dt> <dt>

[<span data-ttu-id="404dd-109">Erweiterte Winsock-Beispiele mit Secure Socket Extensions</span><span class="sxs-lookup"><span data-stu-id="404dd-109">Advanced Winsock Samples Using Secure Socket Extensions</span></span>](advanced-winsock-samples-using-secure-socket-extensions.md)
</dt> <dt>

[<span data-ttu-id="404dd-110">Durchsetzung der Anwendungsschicht (ALE)</span><span class="sxs-lookup"><span data-stu-id="404dd-110">Application Layer Enforcement (ALE)</span></span>](../fwp/application-layer-enforcement--ale-.md)
</dt> <dt>

[<span data-ttu-id="404dd-111">IPSec-Konfiguration</span><span class="sxs-lookup"><span data-stu-id="404dd-111">IPsec Configuration</span></span>](../fwp/ipsec-configuration.md)
</dt> <dt>

[<span data-ttu-id="404dd-112">IPSec-Funktionen</span><span class="sxs-lookup"><span data-stu-id="404dd-112">IPsec Functions</span></span>](../fwp/fwp-ipsec-functions.md)
</dt> <dt>

[<span data-ttu-id="404dd-113">Security Support Provider Interface (SSPI)</span><span class="sxs-lookup"><span data-stu-id="404dd-113">Security Support Provider Interface (SSPI)</span></span>](../rpc/security-support-provider-interface-sspi-.md)
</dt> <dt>

[<span data-ttu-id="404dd-114">Windows-Filterplattform</span><span class="sxs-lookup"><span data-stu-id="404dd-114">Windows Filtering Platform</span></span>](../fwp/windows-filtering-platform-start-page.md)
</dt> <dt>

[<span data-ttu-id="404dd-115">API-Funktionen der Windows-Filter Plattform</span><span class="sxs-lookup"><span data-stu-id="404dd-115">Windows Filtering Platform API Functions</span></span>](../fwp/fwp-functions.md)
</dt> <dt>

[<span data-ttu-id="404dd-116">Winsock Secure Socket Extensions</span><span class="sxs-lookup"><span data-stu-id="404dd-116">Winsock Secure Socket Extensions</span></span>](winsock-secure-socket-extensions.md)
</dt> </dl>
