...
---
# <a name="examples-of-incremental-encoding"></a>Beispiele für inkrementelle Codierung

Der folgende Abschnitt enthält ein Beispiel für die Verwendung des inkrementellen serialisierungshandles für die typcodierung.
