---
title: Beispiele für inkrementelle Codierung
description: Der folgende Abschnitt enthält ein Beispiel für die Verwendung des inkrementellen serialisierungshandles für die typcodierung.
ms.assetid: c50c0de3-aabb-4166-93dc-67b0fee66635
keywords:
- Remote Prozedur Aufruf RPC, Tasks, mit inkrementeller Codierung
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103948063"
---
# <a name="examples-of-incremental-encoding"></a><span data-ttu-id="b67ac-104">Beispiele für inkrementelle Codierung</span><span class="sxs-lookup"><span data-stu-id="b67ac-104">Examples of Incremental Encoding</span></span>

<span data-ttu-id="b67ac-105">Der folgende Abschnitt enthält ein Beispiel für die Verwendung des inkrementellen serialisierungshandles für die typcodierung.</span><span class="sxs-lookup"><span data-stu-id="b67ac-105">The following section provides an example of how to use the incremental style serializing handle for type encoding.</span></span>
...
<span data-ttu-id="b67ac-106">Der folgende Auszug stellt die relevanten Anwendungs Fragmente dar.</span><span class="sxs-lookup"><span data-stu-id="b67ac-106">The following excerpt represents the relevant application fragments.</span></span>
