...
---
# <a name="making-error-information-available-to-the-user"></a><span data-ttu-id="d461b-103">Verfügbar machung von Fehlerinformationen für den Benutzer</span><span class="sxs-lookup"><span data-stu-id="d461b-103">Making Error Information Available to the User</span></span>

<span data-ttu-id="d461b-104">Wenn ein Aufrufer einen Fehler empfängt und den Benutzer über den Fehler benachrichtigt, muss das vorhanden sein erweiterter Fehlerinformationen geprüft werden, und wenn er gefunden wird, sollte der Aufrufer den Benutzern die resultierenden Informationen zur Verfügung stellen.</span><span class="sxs-lookup"><span data-stu-id="d461b-104">When a caller receives an error and needs to notify the user of the error, the presence of extended error information should be checked, and if found, the caller should make the resulting information available to the user.</span></span> <span data-ttu-id="d461b-105">Das folgende Code Fragment ist ein Beispiel dafür, wie diese Informationen für den Benutzer verfügbar gemacht werden:</span><span class="sxs-lookup"><span data-stu-id="d461b-105">The following code fragment is an example of making this information available to the user:</span></span>
