---
description: In diesem Abschnitt werden die Formate ([**DXGI_FORMAT_)** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) angegeben, die in der Direct3D Feature Level 11.1-Hardware unterstützt werden.
...
In diesem Abschnitt werden die Formate ([**DXGI_FORMAT_)** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) angegeben, die in der Direct3D Feature Level 11.1-Hardware unterstützt werden.
...
## <a name="dxgi_format_r24g8_typelesssuppcssup-44"></a>DXGI_FORMAT_R24G8 \_ TYPLOSEN<sup>PCS</sup> (44)
| Ziel | Support |
| - | - |
| Bits pro Element (BPE) | 32 |
| Formatunterstützung | ![Erforderlich](images/letter-r.jpg) |
...
## <a name="dxgi_format_r16_typelesssuppcssup-53"></a>DXGI_FORMAT_R16 \_ <sup>TYPLOSEN PCS</sup> (53)
| Ziel | Support |
| - | - |
| Bits pro Element (BPE) | 16 |
| Formatunterstützung | ![Erforderlich](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc5_typelesssuppccsup-82"></a>DXGI_FORMAT_BC5 \_ TYPELESS<sup>PCC</sup> (82)
| Ziel | Support |
| - | - |
| Bits Per-Element (BPE) | 128 |
| Formatunterstützung | ![Erforderlich](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc7_typelesssuppccsup-97"></a>DXGI_FORMAT_BC7 \_ <sup>TYPLOSEN PCC</sup> (97)
| Ziel | Support |
| - | - |
| Bits pro Element (BPE) | 128 |
| Formatunterstützung | ![Erforderlich](images/letter-r.jpg) |
