---
description: In diesem Abschnitt werden die Formate [**(DXGI_FORMAT_** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) Werte) angegeben, die in Direct3D Feature Level 10.0-Hardware unterstützt werden.
...
ms.locfileid: "119745740"
---
# <a name="format-support-for-direct3d-feature-level-100-hardware"></a>Formatunterstützung für Direct3D 10.0-Hardware auf Featureebene

In diesem Abschnitt werden die Formate [**(DXGI_FORMAT_** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) Werte) angegeben, die in Direct3D Feature Level 10.0-Hardware unterstützt werden.
...
## <a name="dxgi_format_r8_typelesssuppcssup-60"></a>DXGI_FORMAT_R8 \_ TYPLOSE<sup>PCS</sup> (60)
| Ziel | Support |
| - | - |
...
Zurückpuffern und Scans mit dem [**DXGI \_ FORMAT \_ R16G16B16A16 \_ FLOAT-Format**](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) enthalten Linearwert-Gammadaten.
