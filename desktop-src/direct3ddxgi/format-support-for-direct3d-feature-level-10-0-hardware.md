...
In diesem Abschnitt werden die Formate ([_* DXGI_FORMAT_* * _](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) -Werte) angegeben, die auf Direct3D Feature Level 10,0-Hardware unterstützt werden.
...
Backpuffer und Scanvorgänge im [**DXGI- \_ Format \_ R16G16B16A16 \_ float**](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) -Format enthalten lineare Gamma-Daten.
