...
---
# <a name="format-support-for-direct3d-feature-10level9-91-hardware"></a>Formatunterstützung für Direct3D 9 9.1-Hardware auf Featureebene

In diesem Abschnitt werden die Formate ([_* DXGI_FORMAT_* * _](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) -Werte) angegeben, die in der Direct3D-Funktion 10level9 9,1-Hardware unterstützt werden.
