...
1.  Windows 10, Version 1607, definiert zwei neue GUIDs, die zum Aktivieren einer Audiorendering- oder Erfassungsschnittstelle mit automatischem Streamrouting verwendet werden können: [DEVINTERFACE \_ AUDIO \_ RENDER](/windows/desktop/CoreAudio/devinterface-xxx-guids) und [DEVINTERFACE \_ AUDIO \_ CAPTURE.](/windows/desktop/CoreAudio/devinterface-xxx-guids) Rufen Sie [**stringFromIID**](/windows/desktop/api/combaseapi/nf-combaseapi-stringfromiid)auf, um eine Zeichenfolgendarstellung dieser GUIDs abzurufen. Das folgende Beispiel zeigt diesen Aufruf für die Audiorender-GUID.
