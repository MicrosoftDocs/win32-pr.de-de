...
---
# <a name="idxtjpegput_offsety-method"></a>Idxtjpeg::p UT- \_ offserty-Methode
...
Die- `put_OffsetY` Methode gibt den vertikalen Offset des Ursprungs für das Löschen an.
...
Der vertikale Offset des Ursprungs der Löschung in Pixel. Der Mittelpunkt der Löschung wird um diesen Betrag versetzt.
