...
| GUID                                                                                                                                                                   | Beschreibung                                                                                                                                                  |
|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="GUID_AUDIOBREAK"></span><span id="guid_audiobreak"></span><dl> <dt>**GUID \_ AUDIOBREAK**</dt> </dl>    | Audiounterbrechungsereignis. Ereignisse dieses Typs verwenden die [**PERFINFO \_ DSHOW \_ AUDIOBREAK-Struktur**](perfinfo-dshow-audiobreak.md) für Ereignisdaten.<br/>         |
...
| <span id="GUID_VIDEOREND"></span><span id="guid_videorend"></span><dl> <dt>**GUID \_ VIDEOREND**</dt> </dl>       | Videorenderingereignis. Ereignisse dieses Typs verwenden die [**PERFINFO-DSHOW-AMILLND-Struktur \_ \_**](perfinfo-dshow-avrend.md) für Ereignisdaten.<br/>             |
