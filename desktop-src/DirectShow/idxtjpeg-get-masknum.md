...
Die- `get_MaskNum` Methode ruft den SMPTE-Code zum Löschen der Löschung ab.
...
Empfängt den Code zum Löschen von SMPTE. Eine Liste der unterstützten SMPTE-Wipes finden Sie unter [SMPTE](smpte-wipe-transition.md)-Zurücksetzungs Übergang.
