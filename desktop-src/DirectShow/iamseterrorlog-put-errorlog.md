...
---
# <a name="iamseterrorlogput_errorlog-method"></a>Iamseterrorlog::p UT \_ ErrorLog-Methode
...
Die- `put_ErrorLog` Methode gibt ein Fehlerprotokoll für das-Objekt an.
...
Zeiger auf die [**iamerrorlog**](iamerrorlog.md) -Schnittstelle des Fehler Protokolls.
