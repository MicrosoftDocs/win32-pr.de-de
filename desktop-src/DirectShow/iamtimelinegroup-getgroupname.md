...
---
# <a name="iamtimelinegroupgetgroupname-method"></a>Iamtimelinegroup:: getgroupname-Methode
...
Die `GetGroupName` -Methode ruft den von der Anwendung definierten Namen der Gruppe ab.
