...
Die- `SetMediaLength2` Methode gibt die Dauer der Quelldatei an. Diese Methode entspricht [**iamtimelinesrc:: setmedialength**](iamtimelinesrc-setmedialength.md), aber nimmt einen [**reftime**](reftime.md) -Wert an.
