...
-   **Haupttyp:** Der Haupttyp ist eine GUID, die die Gesamtkategorie der Daten definiert. Zu den Haupttypen zählen Video, Audio, unparsed byte stream, KEYBOARD data usw.
...
[Die Filter-Graph und deren Komponenten](the-filter-graph-and-its-components.md)
</dt> </dl>
