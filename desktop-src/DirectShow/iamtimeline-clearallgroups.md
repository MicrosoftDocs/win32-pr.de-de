...
---
# <a name="iamtimelineclearallgroups-method"></a>Iamtimeline:: clearallgroups-Methode
...
Die- `ClearAllGroups` Methode entfernt alle Gruppen aus der Zeitachse zusammen mit allen in diesen Gruppen enthaltenen Objekten.
