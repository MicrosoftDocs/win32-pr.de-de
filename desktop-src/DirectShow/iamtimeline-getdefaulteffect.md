...
---
# <a name="iamtimelinegetdefaulteffect-method"></a>Iamtimeline:: getdefaulteffect-Methode
...
Die- `GetDefaultEffect` Methode ruft den Standardeffekt ab. Wenn die Rendering-Engine einen Effekt nicht Renderingmodul renderten kann, ersetzt Sie den Standardeffekt
...
Empfängt die Globally Unique Identifier (GUID) des Standard Effekts.
