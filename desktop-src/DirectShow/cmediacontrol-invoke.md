...
---
# <a name="cmediacontrolinvoke-method"></a>Cmediacontrol. aufrufen-Methode
...
Der Bezeichner des Members. Verwenden Sie [**cmediacontrol:: GetIDsOfNames**](cmediacontrol-getidsofnames.md) oder die Dokumentation des Objekts, um den Dispatchbezeichner abzurufen.
...
Flags, die den Kontext des `CMediaControl::Invoke` Aufrufes beschreiben.
...
Gibt DISP \_ E \_ unknowninterface zurück, wenn *riid* nicht IID \_ NULL ist. Gibt einen der Fehlercodes aus [**cmediacontrol:: GetTypeInfo**](cmediacontrol-gettypeinfo.md) zurück, wenn der-Rückruf fehlschlägt. Andernfalls wird das **HRESULT** aus dem Aufruf von **IDispatch::** Aufruf zurückgegeben.
