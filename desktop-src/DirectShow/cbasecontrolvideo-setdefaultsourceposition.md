...
Die- `SetDefaultSourcePosition` Methode legt den Renderer mithilfe der standardmäßigen Quell Position (in der Regel mit dem systemeigenen Video) wieder auf fest.
