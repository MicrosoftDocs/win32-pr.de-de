...
Wird nicht unterstützt. Rufen Sie die [**iamtimeline:: kreateemptynode**](iamtimeline-createemptynode.md) -Methode auf, um ein neues Timeline-Objekt zu erstellen. Nachdem ein Objekt erstellt wurde, können Sie den Typ nicht mehr ändern.
