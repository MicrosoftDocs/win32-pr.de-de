...
Die- `AddFoundLocation` Methode fügt dem Verzeichnis Cache ein Verzeichnis hinzu.
...
Der medienlocator speichert einen Cache von Verzeichnis Pfaden, in denen Dateien in früheren Such Vorgängen erfolgreich gefunden wurden. Wenn eine Datei erfolgreich lokalisiert wurde, wird das Verzeichnis dem Cache hinzugefügt.
