...
Die- `GetSubObjectGUID` Methode ruft die GUID des untergeordneten Objekts ab, das diesem Zeitachsen Objekt zugeordnet ist.
...
Empfängt die GUID des unter Objekts oder GUID \_ NULL, wenn das Objekt nicht über ein untergeordnetes Objekt verfügt.
