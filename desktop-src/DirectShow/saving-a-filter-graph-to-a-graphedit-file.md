...
---
# <a name="saving-a-filter-graph-to-a-graphedit-file"></a>Speichern eines Filter Diagramms in einer GraphEdit-Datei

Im folgenden Codebeispiel wird gezeigt, wie ein Filter Diagramm in einer GraphEdit-Datei (. GRF) gespeichert wird. Dies kann beim Debuggen Ihrer Anwendungen hilfreich sein.
...
Der folgende Code erstellt z. b. ein Dateiwiedergabe Diagramm und speichert es in einer Datei mit dem Namen MYGRAPH. GRF:
...
[**Stgkreatedocfile**](/windows/win32/api/coml2api/nf-coml2api-stgcreatedocfile)
</dt> </dl>
