...
---
# <a name="idxtkeyget_luminance-method"></a>Idxtkey:: get- \_ Methode "Luminance"
...
Die- `get_Luminance` Methode ruft den Wert der Leuchtkraft ab, nach dem der Schlüssel abgerufen werden soll. Diese Eigenschaft gilt nur, wenn der Schlüsseltyp dxtkey- \_ Beleuchtung ist.
...
Empfängt den Wert für die Leuchtkraft, auf den die Taste geschrieben wird.
