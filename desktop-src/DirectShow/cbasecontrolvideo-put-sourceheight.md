...
---
# <a name="cbasecontrolvideoput_sourceheight-method"></a>Cbasecontrolvideo. Put \_ sourceHeight-Methode

Die `put_SourceHeight` Methode legt die Höhe des Quell Rechtecks fest.
