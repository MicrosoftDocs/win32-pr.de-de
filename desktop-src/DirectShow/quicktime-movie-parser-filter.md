...
| Bezeichnung | Wert |
|--------|-------|
| Filterschnittstellen | <a href="/previous-versions/windows/desktop/api/Qnetwork/nn-qnetwork-iammediacontent"><strong>IAMMediaContent</strong></a>, <a href="/windows/desktop/api/Strmif/nn-strmif-ibasefilter"> <strong>IBaseFilter</strong></a> | 
| Eingabepin-Medientypen | MEDIATYPE_Stream, MEDIASUBTYPE_QTMovie; | 
...
| Ausgabepin-Medientypen | <ul><li>MEDIATYPE_Video, MEDIASUBTYPE_NULL, FORMAT_VideoInfo</li><li>MEDIATYPE_Audio, MEDIASUBTYPE_NULL, FORMAT_WaveFormatEx</li></ul> | 
...
| Filtern der CLSID | CLSID_QuickTimeParser | 
