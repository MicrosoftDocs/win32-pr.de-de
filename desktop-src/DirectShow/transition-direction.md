...
Ein Übergang geht von Eingabe A zu Eingabe B und von Zeit t₀ zu t₁. Daher kann die *Richtung* eines Übergangs eines von zwei Dingen bedeuten:
...
-   Eingaberichtung: Standardmäßig erfolgt ein Übergang von der zusammengesetzten Ebene der Schichten mit niedrigerer Priorität zu der Ebene, die den Übergang enthält. Um diese Richtung umzukehren, rufen Sie die [**IAMTimelineTrans::SetSwapInputs-Methode auf.**](iamtimelinetrans-setswapinputs.md)
