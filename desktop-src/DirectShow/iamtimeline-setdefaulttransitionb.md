...
Die- `SetDefaultTransitionB` Methode legt den Standard Übergang fest. Diese Methode entspricht [**iamtimeline:: setdefaulttransition**](iamtimeline-setdefaulttransition.md), aber nimmt anstelle eines Zeigers auf eine GUID einen BSTR-Wert an.
...
BSTR-Wert, der die GUID des Standard Übergangs darstellt.
