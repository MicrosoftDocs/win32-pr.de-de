...
---
# <a name="wm-asf-reader-filter-directshow"></a>WM ASF-Leserfilter (DirectShow)
...
| Ausgabepinschnittstellen                    | [**IMediaSeeking,**](/windows/desktop/api/Strmif/nn-strmif-imediaseeking) [**IAMWMBufferPass,**](/previous-versions/windows/desktop/api/Dshowasf/nn-dshowasf-iamwmbufferpass) **IServiceProvider** Darüber hinaus machen die Pins die folgenden Schnittstellen des Windows Media Format SDK verfügbar: **IWMStreamConfig2** (über **IServiceProvider**)<br/>                                                                                                                                                                                                                                    |
