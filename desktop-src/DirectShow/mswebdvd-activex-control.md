...
> [!Note]  
> Diese Komponente ist veraltet. Informationen zur Wiedergabe und Navigation von DVD in DirectShow finden Sie unter [DVD-Anwendungen](dvd-applications.md).

 

Das Microsoft® MSWebDVD-ActiveX®-Steuerelement kann verwendet werden, um eine skriptbasierte DVD-Anwendung zu erstellen. Sie macht die folgenden Objekte und Ereignisse für eine Anwendung verfügbar.
