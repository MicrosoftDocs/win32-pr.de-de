...
---
# <a name="cbasecontrolvideosetdestinationposition-method"></a>Cbasecontrolvideo. setdestinationposition-Methode

Die- `SetDestinationPosition` Methode legt das Ziel Rechteck für das Video fest.
