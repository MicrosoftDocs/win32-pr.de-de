...
---
# <a name="idxtjpegget_offsety-method"></a>Idxtjpeg:: get \_ offsty-Methode
...
Die- `get_OffsetY` Methode ruft den vertikalen Offset des Ursprungs der Löschung ab.
...
Empfängt den vertikalen Offset des Ursprungs der Löschung in Pixel. Der Mittelpunkt der Löschung wird um diesen Betrag versetzt.
