...
---
# <a name="full-screen-renderer-filter"></a>Filter für Vollbildrenderer
...
Fügen Sie diesen Filter nicht manuell zum Filterdiagramm hinzu. Wenn eine Anwendung [**IVideoWindow::p ut \_ FullScreenMode**](/windows/desktop/api/Control/nf-control-ivideowindow-put_fullscreenmode)aufruft, wählt der Filtergraph-Manager automatisch den entsprechenden Videorenderer für den Vollbildmodus aus. Die Auswahl ist für die Anwendung transparent. Bei aktuellen Grafikkarten ist es unwahrscheinlich, dass der Filterdiagramm-Manager den Vollbildrenderer auswählt.
...
Der Vollbildrenderer kann nur als aktives Vordergrundfenster fungieren. Wenn der Benutzer zu einer anderen Anwendung wechselt, blendet der Vollbildrenderer das Video aus, indem das Videofenster minimiert oder verborgen wird.
