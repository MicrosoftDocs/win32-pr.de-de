...
Fügen Sie diesen Filter nicht manuell zum Filterdiagramm hinzu. Wenn eine Anwendung [**IVideoWindow::p ut \_ FullScreenMode**](/windows/desktop/api/Control/nf-control-ivideowindow-put_fullscreenmode)aufruft, wählt der Filter Graph Manager automatisch den entsprechenden Videorenderer für den Vollbildmodus aus. Die Auswahl ist für die Anwendung transparent. Bei aktuellen Grafikkarten wird der Graph-Manager wahrscheinlich nicht den Vollbildrenderer auswählen.
