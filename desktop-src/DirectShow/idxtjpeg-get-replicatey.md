...
---
# <a name="idxtjpegget_replicatey-method"></a>Idxtjpeg:: get \_ replialisiey-Methode
...
Die- `get_ReplicateY` Methode ruft die Häufigkeit ab, mit der das Muster für das Löschen vertikal repliziert wird.
...
Empfängt die Häufigkeit, mit der das Muster für das Löschen vertikal repliziert wird.
