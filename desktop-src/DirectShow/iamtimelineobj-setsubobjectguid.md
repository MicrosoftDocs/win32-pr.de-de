...
Die- `SetSubObjectGUID` Methode gibt die GUID des untergeordneten Objekts an, das diesem Objekt zugeordnet ist.
...
GUID des untergeordneten Objekts.
...
Die Rendering-Engine erstellt nach Bedarf eine Instanz des untergeordneten Objekts.
