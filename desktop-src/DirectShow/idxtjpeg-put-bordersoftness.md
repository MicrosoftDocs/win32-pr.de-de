...
---
# <a name="idxtjpegput_bordersoftness-method"></a>Idxtjpeg::p UT \_ borderweichheit-Methode
...
Die- `put_BorderSoftness` Methode gibt die Breite des unscharf-Bereichs um die Ränder des-Abbild Musters an.
...
Die Breite des unscharf-Bereichs in Pixel.
