---
description: Die folgenden Strukturen werden mit Metadateien im erweiterten Format verwendet.
ms.assetid: 6a509ed5-cea3-4318-ad17-9d20425a6e80
title: Metadateistrukturen
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119965630"
---
# <a name="metafile-structures"></a>Metadateistrukturen

Die folgenden Strukturen werden mit Metadateien im erweiterten Format verwendet.
...
Beachten Sie, [**dass die EMR-Struktur**](/windows/win32/api/wingdi/ns-wingdi-emr) als erster Member der verbleibenden Strukturen verwendet wird.  
...
## <a name="obsolete-structures"></a>Veraltete Strukturen

Die folgenden Strukturen sind veraltet. Die werden aus Kompatibilitäts- und Windows-Formatmetadateien bereitgestellt:
