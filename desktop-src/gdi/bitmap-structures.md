...
---
# <a name="bitmap-structures"></a>Bitmap-Strukturen

Die folgenden Strukturen werden mit Bitmaps verwendet:

-   [**Bitmap**](/windows/win32/api/wingdi/ns-wingdi-bitmap)
-   [**BITMAPCOREHEADER**](/windows/win32/api/wingdi/ns-wingdi-bitmapcoreheader)
-   [**Bitmapcoreingefo**](/windows/win32/api/wingdi/ns-wingdi-bitmapcoreinfo)
