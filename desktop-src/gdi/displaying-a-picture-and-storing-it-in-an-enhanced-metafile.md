...
---
# <a name="displaying-a-picture-and-storing-it-in-an-enhanced-metafile"></a>Anzeigen eines Bilds und speichern in einer erweiterten Metadatei

Dieser Abschnitt enthält ein Beispiel zur Veranschaulichung der Erstellung eines Bilds und des Prozesses, in dem die entsprechenden Datensätze in einer Metadatei gespeichert werden. Im Beispiel wird ein Bild auf die Anzeige gezeichnet oder in einer Metadatei gespeichert. Wenn ein Anzeigegeräte Kontext Handle angegeben ist, wird ein Bild mithilfe verschiedener GDI-Funktionen auf den Bildschirm gezeichnet. Wenn ein erweiterter Metadatei-Gerätekontext angegeben wird, wird das gleiche Bild in der erweiterten Metadatei gespeichert.
