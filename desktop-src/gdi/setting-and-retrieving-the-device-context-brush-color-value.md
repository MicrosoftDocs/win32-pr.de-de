...
---
# <a name="setting-and-retrieving-the-device-context-brush-color-value"></a>Festlegen und Abrufen des Farbwerts für den Gerätekontext Pinsel

Im folgenden Beispiel wird gezeigt, wie eine Anwendung die aktuelle Domänen Controller Farbe mithilfe der Funktionen [**setdcbrushcolor**](/windows/desktop/api/Wingdi/nf-wingdi-setdcbrushcolor) und [**getdcbrushcolor**](/windows/desktop/api/WinGdi/nf-wingdi-getdcbrushcolor) abrufen kann.
