...
Gibt die Einstellung für die automatische Verbindung an, die für ein mobiles Breitbandgerät verwendet werden soll.

Weitere Informationen finden Sie in der Dokumentation zum [**ConnectionMode-Element**](./schema-connectionmode-mbnprofile-element.md) v1.
