...
Gibt die Einstellung für die automatische Verbindung an, die für ein mobiles Breitband Gerät verwendet werden soll.

Weitere Informationen finden Sie in der Dokumentation für das v1 [**ConnectionMode**](./schema-connectionmode-mbnprofile-element.md) -Element.
