---
description: Mobiles Breitband Profil Schema v1.
ms.assetid: e55775d2-1166-4f14-9553-207c69202b69
title: Mobiles Breitband Profil Schema v1
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "103751944"
---
# <a name="mobile-broadband-profile-schema-v1"></a><span data-ttu-id="6a91c-103">Mobiles Breitband Profil Schema v1</span><span class="sxs-lookup"><span data-stu-id="6a91c-103">Mobile Broadband Profile Schema v1</span></span>

<span data-ttu-id="6a91c-104">Das Windows 7 Mobile-Breitband Profil Schema v1 ist im-Namespace verfügbar `https://www.microsoft.com/networking/WWAN/profile/v1` .</span><span class="sxs-lookup"><span data-stu-id="6a91c-104">The Windows 7Mobile Broadband Profile Schema v1 is available in the namespace `https://www.microsoft.com/networking/WWAN/profile/v1`.</span></span>

-   [<span data-ttu-id="6a91c-105">Mobile Breitband Profile Schema v1-Elemente</span><span class="sxs-lookup"><span data-stu-id="6a91c-105">Mobile Broadband Profile Schema v1 Elements</span></span>](schema-elements.md)
-   [<span data-ttu-id="6a91c-106">Einfache Typen für das mobile Breitband Profil Schema v1</span><span class="sxs-lookup"><span data-stu-id="6a91c-106">Mobile Broadband Profile Schema v1 Simple Types</span></span>](schema-simple-types.md)
-   [<span data-ttu-id="6a91c-107">Komplexe Typen für das mobile Breitband Profil Schema v1</span><span class="sxs-lookup"><span data-stu-id="6a91c-107">Mobile Broadband Profile Schema v1 Complex Types</span></span>](schema-complex-types.md)
