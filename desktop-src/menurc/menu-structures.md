...
ms.locfileid: "118734236"
---
# <a name="menu-structures"></a>Menüstrukturen

## <a name="in-this-section"></a>In diesem Abschnitt

-   [**MMULTIXTMENU**](/windows/win32/api/winuser/ns-winuser-mdinextmenu)
-   [**MENUBARINFO**](/windows/win32/api/winuser/ns-winuser-menubarinfo)
-   [**\_ \_ MENUEX-VORLAGENHEADER**](menuex-template-header.md)
